...
module OCI
  ...
  class GenerativeAi::Models::WorkRequestError
    # **[Required]** A machine-usable code for the error that occurred. For a list of error codes, see
    ...
    # **[Required]** The date and time that the error occurred, in the format defined by
