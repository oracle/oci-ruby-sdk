...
module OCI
  ...
  class GenerativeAi::Models::CreateDedicatedAiClusterDetails
    ...
    def hash
      [display_name, description, type, compartment_id, unit_count, unit_shape, freeform_tags, defined_tags].hash
    end
