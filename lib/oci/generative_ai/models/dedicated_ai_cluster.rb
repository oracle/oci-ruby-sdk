...
module OCI
  ...
  #
  class GenerativeAi::Models::DedicatedAiCluster
    TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the dedicated AI cluster.
    # @return [String]
    attr_accessor :id
    ...
    # @return [String]
    attr_reader :unit_shape

    # @return [OCI::GenerativeAi::Models::DedicatedAiClusterCapacity]
    attr_accessor :capacity

    # @return [OCI::GenerativeAi::Models::DedicatedAiCluster]
    ...
    # @option attributes [String] :unit_shape The value to assign to the {#unit_shape} property
    # @option attributes [OCI::GenerativeAi::Models::DedicatedAiClusterCapacity] :capacity The value to assign to the {#capacity} property
    # @option attributes [OCI::GenerativeAi::Models::DedicatedAiCluster] :previous_state The value to assign to the {#previous_state} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unit_shape Object to be assigned
    def unit_shape=(unit_shape)
      # rubocop:disable Style/ConditionalAssignment
      if unit_shape && !UNIT_SHAPE_ENUM.include?(unit_shape)
        OCI.logger.debug("Unknown value for 'unit_shape' [" + unit_shape + "]. Mapping to 'UNIT_SHAPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @unit_shape = UNIT_SHAPE_UNKNOWN_ENUM_VALUE
      else
