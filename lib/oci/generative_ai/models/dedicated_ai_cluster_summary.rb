...
module OCI
  ...
  class GenerativeAi::Models::DedicatedAiClusterSummary
    ...
    def hash
      [id, display_name, description, type, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, unit_count, unit_shape, capacity, freeform_tags, defined_tags, system_tags].hash
    end
