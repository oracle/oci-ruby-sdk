...
module OCI
  ...
  class GenerativeAi::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::GenerativeAi::Models::WorkRequestResource>]
    attr_accessor :resources

    # **[Required]** Shows the progress of the operation tracked by the work request, as a percentage of the total work
    ...
    # @option attributes [Array<OCI::GenerativeAi::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
