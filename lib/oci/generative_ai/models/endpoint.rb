...
module OCI
  ...
  #
  class GenerativeAi::Models::Endpoint
    ...
    # @return [OCI::GenerativeAi::Models::Endpoint]
    ...
    # @option attributes [OCI::GenerativeAi::Models::Endpoint] :previous_state The value to assign to the {#previous_state} property
