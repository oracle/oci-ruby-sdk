...
module OCI
  ...
  class GenerativeAi::Models::CreateModelDetails
    ...
    def hash
      [display_name, compartment_id, vendor, version, description, base_model_id, fine_tune_details, freeform_tags, defined_tags].hash
    end
