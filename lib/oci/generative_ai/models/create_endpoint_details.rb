...
module OCI
  ...
  class GenerativeAi::Models::CreateEndpointDetails
    ...
    def hash
      [display_name, description, compartment_id, model_id, dedicated_ai_cluster_id, content_moderation_config, freeform_tags, defined_tags].hash
    end
