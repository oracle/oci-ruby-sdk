...
module OCI
  ...
  class DatabaseManagement::Models::UpdateExternalDbSystemConnectorDetails
    CONNECTOR_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::UpdateExternalDbSystemMacsConnectorDetails' if type == 'MACS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::UpdateExternalDbSystemConnectorDetails'
    end
