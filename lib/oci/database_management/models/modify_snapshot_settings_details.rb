...
module OCI
  ...
  class DatabaseManagement::Models::ModifySnapshotSettingsDetails
    ...
    # @option attributes [Integer] :retention The value to assign to the {#retention} property
