...
module OCI
  ...
  class DatabaseManagement::Models::SqlTuningAdvisorTaskSummaryReportTaskInfo
    ...
    # @option attributes [Integer] :running_time The value to assign to the {#running_time} property
    def initialize(attributes = {})
      ...
      self.running_time = attributes[:'runningTime'] if attributes[:'runningTime']

      raise 'You cannot provide both :runningTime and :running_time' if attributes.key?(:'runningTime') && attributes.key?(:'running_time')

      self.running_time = attributes[:'running_time'] if attributes[:'running_time']
    end
    ...
    def hash
      [id, name, description, owner, status, time_started, time_ended, running_time].hash
    end
