...
module OCI
  ...
  #
  class DatabaseManagement::Models::RunHistoricAddmDetails
    # **[Required]** The ID number of the beginning AWR snapshot.
    # @return [Integer]
    attr_accessor :start_snapshot_id
    ...
    # @option attributes [Integer] :start_snapshot_id The value to assign to the {#start_snapshot_id} property
    ...
    def initialize(attributes = {})
      ...
      self.start_snapshot_id = attributes[:'startSnapshotId'] if attributes[:'startSnapshotId']

      raise 'You cannot provide both :startSnapshotId and :start_snapshot_id' if attributes.key?(:'startSnapshotId') && attributes.key?(:'start_snapshot_id')

      self.start_snapshot_id = attributes[:'start_snapshot_id'] if attributes[:'start_snapshot_id']
    ...
    def hash
      [start_snapshot_id, end_snapshot_id].hash
    end
