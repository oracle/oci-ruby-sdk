...
module OCI
  ...
  #
  class DatabaseManagement::Models::OptimizerStatisticsAdvisorExecutionReport
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AdvisorRule>]
    attr_accessor :rules
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AdvisorRule>] :rules The value to assign to the {#rules} property
