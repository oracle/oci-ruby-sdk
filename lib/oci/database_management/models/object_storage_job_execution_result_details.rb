...
require 'date'
require_relative 'job_execution_result_details'
...
module OCI
  ...
  #
  class DatabaseManagement::Models::ObjectStorageJobExecutionResultDetails < DatabaseManagement::Models::JobExecutionResultDetails
    ...
    def hash
      [type, namespace_name, bucket_name, object_name, row_count].hash
    end
