...
module OCI
  ...
  #
  class DatabaseManagement::Models::PatchMergeInstruction < DatabaseManagement::Models::PatchInstruction
    ...
    # @option attributes [String] :selection The value to assign to the {OCI::DatabaseManagement::Models::PatchInstruction#selection #selection} proprety
