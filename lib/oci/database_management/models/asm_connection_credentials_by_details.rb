...
require 'date'
require 'logger'
require_relative 'asm_connection_credentials'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The credentials used to connect to the ASM instance.
  class DatabaseManagement::Models::AsmConnectionCredentialsByDetails < DatabaseManagement::Models::AsmConnectionCredentials
    ROLE_ENUM = [
      ROLE_SYSASM = 'SYSASM'.freeze,
      ROLE_SYSDBA = 'SYSDBA'.freeze,
      ROLE_SYSOPER = 'SYSOPER'.freeze,
    ...
    def hash
      [credential_type, credential_name, user_name, password_secret_id, role].hash
    end
