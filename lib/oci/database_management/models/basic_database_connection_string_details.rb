...
require 'date'
require_relative 'database_connection_string_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details of the Oracle Database basic connection string.
  class DatabaseManagement::Models::BasicDatabaseConnectionStringDetails < DatabaseManagement::Models::DatabaseConnectionStringDetails
    PROTOCOL_ENUM = [
    ...
    # **[Required]** The port number used to connect to the database.
    # @return [Integer]
    attr_accessor :port
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'BASIC'
    ...
    def hash
      [connection_type, service, port, protocol].hash
    end
