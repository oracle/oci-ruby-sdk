...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseCredentialDetails
    CREDENTIAL_TYPE_ENUM = [
      CREDENTIAL_TYPE_SECRET = 'SECRET'.freeze,
      CREDENTIAL_TYPE_PASSWORD = 'PASSWORD'.freeze,
      CREDENTIAL_TYPE_NAMED_CREDENTIAL = 'NAMED_CREDENTIAL'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::DatabaseSecretCredentialDetails' if type == 'SECRET'
      return 'OCI::DatabaseManagement::Models::DatabaseNamedCredentialDetails' if type == 'NAMED_CREDENTIAL'
      return 'OCI::DatabaseManagement::Models::DatabasePasswordCredentialDetails' if type == 'PASSWORD'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::DatabaseCredentialDetails'
    end
