...
require 'date'
require_relative 'tablespace_admin_credential_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # User provides a secret OCID, which will be used to retrieve the password to connect to the database.
  #
  class DatabaseManagement::Models::TablespaceAdminSecretCredentialDetails < DatabaseManagement::Models::TablespaceAdminCredentialDetails
    ...
    # @option attributes [String] :username The value to assign to the {OCI::DatabaseManagement::Models::TablespaceAdminCredentialDetails#username #username} proprety
    # @option attributes [String] :role The value to assign to the {OCI::DatabaseManagement::Models::TablespaceAdminCredentialDetails#role #role} proprety
    # @option attributes [String] :password_secret_id The value to assign to the {#password_secret_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['tablespaceAdminCredentialType'] = 'SECRET'
    ...
    def hash
      [tablespace_admin_credential_type, username, role, password_secret_id].hash
    end
