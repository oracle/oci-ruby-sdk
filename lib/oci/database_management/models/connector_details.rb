...
module OCI
  ...
  class DatabaseManagement::Models::ConnectorDetails
    CONNECTOR_TYPE_ENUM = [
      CONNECTOR_TYPE_PE = 'PE'.freeze,
      CONNECTOR_TYPE_MACS = 'MACS'.freeze,
      CONNECTOR_TYPE_EXTERNAL = 'EXTERNAL'.freeze
    ].freeze

    # **[Required]** The list of supported connection types:
    #   - PE: Private endpoint
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::ExternalConnectorDetails' if type == 'EXTERNAL'
      return 'OCI::DatabaseManagement::Models::MacsConnectorDetails' if type == 'MACS'
      return 'OCI::DatabaseManagement::Models::PrivateEndPointConnectorDetails' if type == 'PE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::ConnectorDetails'
    end
