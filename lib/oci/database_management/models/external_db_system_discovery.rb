...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbSystemDiscovery
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system discovery.
    # @return [String]
    attr_accessor :id
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbSystemComponent>]
    attr_accessor :discovered_components
    ...
    def self.swagger_types
      {
        ...
        'agent_id': :'String',
        'grid_home': :'String',
        'discovered_components': :'Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbSystemComponent>',
        'resource_id': :'String',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DiscoveredExternalDbSystemComponent>] :discovered_components The value to assign to the {#discovered_components} property
    ...
    def initialize(attributes = {})
      ...
      self.discovered_components = attributes[:'discoveredComponents'] if attributes[:'discoveredComponents']

      raise 'You cannot provide both :discoveredComponents and :discovered_components' if attributes.key?(:'discoveredComponents') && attributes.key?(:'discovered_components')

      self.discovered_components = attributes[:'discovered_components'] if attributes[:'discovered_components']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        discovered_components == other.discovered_components &&
    ...
    def hash
      [id, display_name, compartment_id, agent_id, grid_home, discovered_components, resource_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
