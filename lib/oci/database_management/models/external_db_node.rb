...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbNode
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_db_system_id, external_connector_id, host_name, cpu_core_count, memory_size_in_gbs, additional_details, lifecycle_state, lifecycle_details, domain_name, time_created, time_updated].hash
    end
