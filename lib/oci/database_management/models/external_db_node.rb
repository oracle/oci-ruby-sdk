...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbNode
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB node.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system that the DB node is a part of.
    # @return [String]
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_db_system_id, external_connector_id, host_name, cpu_core_count, memory_size_in_gbs, additional_details, lifecycle_state, lifecycle_details, domain_name, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
