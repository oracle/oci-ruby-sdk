...
module OCI
  ...
  class DatabaseManagement::Models::AddDataFilesDetails
    ...
    def hash
      [credential_details, database_credential, file_type, data_files, file_count, file_size, is_reusable, is_auto_extensible, auto_extend_next_size, auto_extend_max_size, is_max_size_unlimited].hash
    end
