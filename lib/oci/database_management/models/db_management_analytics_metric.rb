...
module OCI
  ...
  class DatabaseManagement::Models::DbManagementAnalyticsMetric
    ...
    def hash
      [metric_name, duration_in_seconds, metadata, dimensions, start_timestamp_in_epoch_seconds, mean].hash
    end
