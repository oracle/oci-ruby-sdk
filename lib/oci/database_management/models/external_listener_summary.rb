...
module OCI
  ...
  class DatabaseManagement::Models::ExternalListenerSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system that the listener is a member of.
    # @return [String]
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_db_system_id, external_connector_id, external_db_node_id, listener_type, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
