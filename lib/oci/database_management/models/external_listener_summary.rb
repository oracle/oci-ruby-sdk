...
module OCI
  ...
  class DatabaseManagement::Models::ExternalListenerSummary
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_db_system_id, external_connector_id, external_db_node_id, listener_type, lifecycle_state, lifecycle_details, time_created, time_updated].hash
    end
