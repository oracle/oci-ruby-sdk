...
module OCI
  ...
  class DatabaseManagement::Models::ProxiedForUserCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::ProxiedForUserSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::ProxiedForUserSummary>] :items The value to assign to the {#items} property
