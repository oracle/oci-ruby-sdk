...
module OCI
  ...
  class DatabaseManagement::Models::CreateSqlJobDetails < DatabaseManagement::Models::CreateJobDetails
    ...
    def hash
      [name, description, compartment_id, managed_database_group_id, managed_database_id, database_sub_type, schedule_type, job_type, timeout, result_location, schedule_details, sql_text, in_binds, out_binds, sql_type, operation_type, user_name, password, secret_id, named_credential_id, role, freeform_tags, defined_tags].hash
    end
