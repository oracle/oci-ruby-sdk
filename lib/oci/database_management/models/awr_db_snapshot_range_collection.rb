...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbSnapshotRangeCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR snapshot range summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbSnapshotRangeSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbSnapshotRangeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbSnapshotRangeSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_SNAPSHOT_RANGE_SET'
