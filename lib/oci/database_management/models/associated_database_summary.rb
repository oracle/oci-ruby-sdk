...
module OCI
  ...
  class DatabaseManagement::Models::AssociatedDatabaseSummary
    ...
    # **[Required]** The compartment [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the database.
    # @return [String]
    ...
    def hash
      [id, name, compartment_id, time_registered].hash
    end
