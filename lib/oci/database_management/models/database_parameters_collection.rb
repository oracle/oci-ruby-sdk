...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseParametersCollection
    ...
    # **[Required]** The subtype of the Oracle Database. Indicates whether the database
    ...
    # @return [Array<OCI::DatabaseManagement::Models::DatabaseParameterSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DatabaseParameterSummary>] :items The value to assign to the {#items} property
