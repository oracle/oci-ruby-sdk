...
module OCI
  ...
  class DatabaseManagement::Models::HeatWaveFleetByCategory
    # **[Required]** The name of the HeatWave fleet category.
    # @return [String]
    attr_accessor :name

    # **[Required]** The value of the HeatWave fleet category.
    # @return [String]
    attr_accessor :value

    # **[Required]** The number of matching HeatWave clusters.
    # @return [Integer]
    attr_accessor :count
