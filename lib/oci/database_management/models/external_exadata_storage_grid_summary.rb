...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataStorageGridSummary < DatabaseManagement::Models::DbmResource
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'STORAGE_GRID_SUMMARY'
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, server_count].hash
    end
