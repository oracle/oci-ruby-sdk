...
module OCI
  ...
  class DatabaseManagement::Models::ManagedDatabaseGroup
    ...
    # @return [Array<OCI::DatabaseManagement::Models::ChildDatabase>]
    attr_accessor :managed_databases
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::ChildDatabase>] :managed_databases The value to assign to the {#managed_databases} property
