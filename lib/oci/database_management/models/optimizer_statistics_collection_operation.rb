...
module OCI
  ...
  class DatabaseManagement::Models::OptimizerStatisticsCollectionOperation
    STATUS_ENUM = [
    ...
    # @return [Array<OCI::DatabaseManagement::Models::OptimizerStatisticsOperationTask>]
    attr_accessor :tasks
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::OptimizerStatisticsOperationTask>] :tasks The value to assign to the {#tasks} property
    ...
    def hash
      [database, tasks, id, operation_name, target, job_name, status, start_time, end_time, duration_in_seconds, completed_count, in_progress_count, failed_count, timed_out_count, total_objects_count].hash
    end
