...
module OCI
  ...
  #
  class DatabaseManagement::Models::PrivateEndPointConnectorDetails < DatabaseManagement::Models::ConnectorDetails
    ...
    def hash
      [connector_type, private_end_point_id].hash
    end
