...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalDbHome < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    ...
    def initialize(attributes = {})
      ...
      attributes['componentType'] = 'DATABASE_HOME'
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, home_directory].hash
    end
