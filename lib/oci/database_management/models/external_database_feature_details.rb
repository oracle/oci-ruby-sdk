...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDatabaseFeatureDetails
    FEATURE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::ExternalDatabaseDiagnosticsAndManagementFeatureDetails' if type == 'DIAGNOSTICS_AND_MANAGEMENT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::ExternalDatabaseFeatureDetails'
    end
