...
require 'date'
require_relative 'external_database_feature_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details required to enable the Diagnostics and Management feature.
  class DatabaseManagement::Models::ExternalDatabaseDiagnosticsAndManagementFeatureDetails < DatabaseManagement::Models::ExternalDatabaseFeatureDetails
    LICENSE_MODEL_ENUM = [
    ...
    # @option attributes [OCI::DatabaseManagement::Models::ConnectorDetails] :connector_details The value to assign to the {OCI::DatabaseManagement::Models::ExternalDatabaseFeatureDetails#connector_details #connector_details} proprety
    ...
    def hash
      [feature, connector_details, license_model].hash
    end
