...
module OCI
  ...
  class DatabaseManagement::Models::SystemPrivilegeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::SystemPrivilegeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::SystemPrivilegeSummary>] :items The value to assign to the {#items} property
