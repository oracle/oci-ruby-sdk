...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbReport < DatabaseManagement::Models::AwrQueryResult
    FORMAT_ENUM = [
      FORMAT_HTML = 'HTML'.freeze,
      FORMAT_TEXT = 'TEXT'.freeze,
      FORMAT_XML = 'XML'.freeze,
    ...
    def initialize(attributes = {})
      ...
      attributes['awrResultType'] = 'AWRDB_DB_REPORT'
    ...
    def hash
      [name, version, query_key, db_query_time_in_secs, awr_result_type, content, format].hash
    end
