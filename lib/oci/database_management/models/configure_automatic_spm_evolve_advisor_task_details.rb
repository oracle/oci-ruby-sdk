...
module OCI
  ...
  #
  class DatabaseManagement::Models::ConfigureAutomaticSpmEvolveAdvisorTaskDetails
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'task_parameters': :'OCI::DatabaseManagement::Models::SpmEvolveTaskParameters',
    ...
    # @option attributes [OCI::DatabaseManagement::Models::SpmEvolveTaskParameters] :task_parameters The value to assign to the {#task_parameters} property
    ...
    def initialize(attributes = {})
      ...
      self.task_parameters = attributes[:'taskParameters'] if attributes[:'taskParameters']

      raise 'You cannot provide both :taskParameters and :task_parameters' if attributes.key?(:'taskParameters') && attributes.key?(:'task_parameters')

      self.task_parameters = attributes[:'task_parameters'] if attributes[:'task_parameters']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        task_parameters == other.task_parameters &&
    ...
    def hash
      [task_parameters, credentials, database_credential].hash
    end
