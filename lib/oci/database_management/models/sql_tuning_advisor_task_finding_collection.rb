...
module OCI
  ...
  class DatabaseManagement::Models::SqlTuningAdvisorTaskFindingCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::SqlTuningAdvisorTaskFindingSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::SqlTuningAdvisorTaskFindingSummary>] :items The value to assign to the {#items} property
