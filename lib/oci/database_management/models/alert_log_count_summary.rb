...
module OCI
  ...
  #
  class DatabaseManagement::Models::AlertLogCountSummary
    CATEGORY_ENUM = [
      CATEGORY_UNKNOWN = 'UNKNOWN'.freeze,
      CATEGORY_INCIDENT_ERROR = 'INCIDENT_ERROR'.freeze,
      CATEGORY_ERROR = 'ERROR'.freeze,
      CATEGORY_WARNING = 'WARNING'.freeze,
      CATEGORY_NOTIFICATION = 'NOTIFICATION'.freeze,
      CATEGORY_TRACE = 'TRACE'.freeze,
      CATEGORY_CRITICAL = 'CRITICAL'.freeze,
      CATEGORY_SEVERE = 'SEVERE'.freeze,
      CATEGORY_IMPORTANT = 'IMPORTANT'.freeze,
      CATEGORY_NORMAL = 'NORMAL'.freeze,
