...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbWaitEventCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR wait events.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbWaitEventSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbWaitEventSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbWaitEventSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_EVENT_SET'
