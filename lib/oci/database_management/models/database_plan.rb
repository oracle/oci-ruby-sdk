...
module OCI
  ...
  #
  class DatabaseManagement::Models::DatabasePlan
    # **[Required]** A list of DatabasePlanDirectives.
    # @return [Array<OCI::DatabaseManagement::Models::DatabasePlanDirective>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DatabasePlanDirective>] :items The value to assign to the {#items} property
