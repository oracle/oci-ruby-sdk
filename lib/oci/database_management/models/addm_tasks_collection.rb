...
module OCI
  ...
  class DatabaseManagement::Models::AddmTasksCollection
    # **[Required]** The list of ADDM task metadata.
    # @return [Array<OCI::DatabaseManagement::Models::AddmTaskSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::AddmTaskSummary>',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AddmTaskSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [items, managed_database_id].hash
    end
