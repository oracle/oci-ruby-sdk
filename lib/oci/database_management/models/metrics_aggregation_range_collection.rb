...
module OCI
  ...
  class DatabaseManagement::Models::MetricsAggregationRangeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::MetricsAggregationRange>',
        'start_time': :'String',
        'end_time': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::MetricsAggregationRange>] :items The value to assign to the {#items} property
    ...
    def hash
      [items, start_time, end_time].hash
    end
