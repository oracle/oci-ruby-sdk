...
require 'date'
require_relative 'update_external_db_system_connector_details'
...
module OCI
  ...
  #
  class DatabaseManagement::Models::UpdateExternalDbSystemMacsConnectorDetails < DatabaseManagement::Models::UpdateExternalDbSystemConnectorDetails
    ...
    def hash
      [connector_type, connection_info, freeform_tags, defined_tags].hash
    end
