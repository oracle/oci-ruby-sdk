...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbSystemSummary
    ...
    def hash
      [id, display_name, compartment_id, home_directory, database_management_config, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
