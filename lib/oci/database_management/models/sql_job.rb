...
module OCI
  ...
  class DatabaseManagement::Models::SqlJob < DatabaseManagement::Models::Job
    ...
    def hash
      [id, compartment_id, name, description, managed_database_group_id, managed_database_id, managed_databases_details, database_sub_type, schedule_type, job_type, lifecycle_state, timeout, result_location, schedule_details, submission_error_message, time_created, time_updated, sql_type, sql_text, in_binds, out_binds, operation_type, user_name, role, named_credential_id, freeform_tags, defined_tags, system_tags].hash
    end
