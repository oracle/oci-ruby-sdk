...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataStorageConnector < DatabaseManagement::Models::DbmResource
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, exadata_infrastructure_id, agent_id, connection_uri, storage_server_id, freeform_tags, defined_tags, system_tags].hash
    end
