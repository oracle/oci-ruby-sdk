...
module OCI
  ...
  class DatabaseManagement::Models::ConsumerGroupPrivilegeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::ConsumerGroupPrivilegeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::ConsumerGroupPrivilegeSummary>] :items The value to assign to the {#items} property
