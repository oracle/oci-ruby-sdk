...
module OCI
  ...
  class DatabaseManagement::Models::UpdateBasicPreferredCredentialDetails < DatabaseManagement::Models::UpdatePreferredCredentialDetails
    ROLE_ENUM = [
    ...
    def hash
      [type, user_name, role, password_secret_id].hash
    end
