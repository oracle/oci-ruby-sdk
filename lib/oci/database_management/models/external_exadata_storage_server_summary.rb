...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataStorageServerSummary < DatabaseManagement::Models::DbmResource
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, make_model, ip_address, cpu_count, memory_gb, max_hard_disk_iops, max_hard_disk_throughput, max_flash_disk_iops, max_flash_disk_throughput, connector_id, freeform_tags, defined_tags, system_tags].hash
    end
