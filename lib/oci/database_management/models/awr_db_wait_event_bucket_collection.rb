...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbWaitEventBucketCollection < DatabaseManagement::Models::AwrQueryResult
    # The total waits of the database.
    # @return [Integer]
    attr_accessor :total_waits

    # A list of AWR wait event buckets.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbWaitEventBucketSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'total_waits': :'Integer',
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbWaitEventBucketSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :total_waits The value to assign to the {#total_waits} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbWaitEventBucketSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_EVENT_HISTOGRAM_SET'
      ...
      self.total_waits = attributes[:'totalWaits'] if attributes[:'totalWaits']

      raise 'You cannot provide both :totalWaits and :total_waits' if attributes.key?(:'totalWaits') && attributes.key?(:'total_waits')

      self.total_waits = attributes[:'total_waits'] if attributes[:'total_waits']
    ...
    def hash
      [name, version, query_key, db_query_time_in_secs, awr_result_type, total_waits, items].hash
    end
