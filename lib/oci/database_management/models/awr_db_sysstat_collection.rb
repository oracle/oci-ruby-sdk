...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbSysstatCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR SYSSTAT summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbSysstatSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbSysstatSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbSysstatSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_SYSSTAT_SET'
