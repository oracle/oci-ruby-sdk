...
module OCI
  ...
  class DatabaseManagement::Models::DatabasePasswordCredentialDetails < DatabaseManagement::Models::DatabaseCredentialDetails
    ROLE_ENUM = [
    ...
    def hash
      [credential_type, password, username, role].hash
    end
