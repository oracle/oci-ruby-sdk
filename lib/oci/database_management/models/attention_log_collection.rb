...
module OCI
  ...
  class DatabaseManagement::Models::AttentionLogCollection
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AttentionLogSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AttentionLogSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AttentionLogSummary>] :items The value to assign to the {#items} property
