...
module OCI
  # Storage size.
  class DatabaseManagement::Models::TablespaceStorageSize
    UNIT_ENUM = [
      UNIT_BYTES = 'BYTES'.freeze,
      UNIT_KILOBYTES = 'KILOBYTES'.freeze,
      UNIT_MEGABYTES = 'MEGABYTES'.freeze,
      UNIT_GIGABYTES = 'GIGABYTES'.freeze,
      UNIT_TERABYTES = 'TERABYTES'.freeze
    ].freeze
