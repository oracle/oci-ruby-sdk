...
module OCI
  ...
  #
  class DatabaseManagement::Models::TableStatisticSummary
    TYPE_ENUM = [
      TYPE_NO_STATS = 'NO_STATS'.freeze,
      TYPE_STALE = 'STALE'.freeze,
      TYPE_NOT_STALE = 'NOT_STALE'.freeze,
