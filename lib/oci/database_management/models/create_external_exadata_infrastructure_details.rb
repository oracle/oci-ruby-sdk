...
module OCI
  ...
  class DatabaseManagement::Models::CreateExternalExadataInfrastructureDetails
    LICENSE_MODEL_ENUM = [
    ...
    # @return [Array<String>]
    attr_accessor :storage_server_names
    ...
    # @option attributes [Array<String>] :db_system_ids The value to assign to the {#db_system_ids} property
    # @option attributes [Array<String>] :storage_server_names The value to assign to the {#storage_server_names} property
    ...
    def hash
      [discovery_key, license_model, compartment_id, display_name, db_system_ids, storage_server_names, freeform_tags, defined_tags].hash
    end
