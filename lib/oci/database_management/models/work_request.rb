...
module OCI
  ...
  class DatabaseManagement::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_ENABLE_SQL_WATCH = 'ENABLE_SQL_WATCH'.freeze,
      OPERATION_TYPE_DISABLE_SQL_WATCH = 'DISABLE_SQL_WATCH'.freeze,
      OPERATION_TYPE_MODIFY_SQL_WATCH = 'MODIFY_SQL_WATCH'.freeze,
      OPERATION_TYPE_ENABLE_DBLM = 'ENABLE_DBLM'.freeze,
      OPERATION_TYPE_DISABLE_DBLM = 'DISABLE_DBLM'.freeze,
      OPERATION_TYPE_MODIFY_DBLM = 'MODIFY_DBLM'.freeze,
      OPERATION_TYPE_ENABLE_DBMGMT = 'ENABLE_DBMGMT'.freeze,
      OPERATION_TYPE_DISABLE_DBMGMT = 'DISABLE_DBMGMT'.freeze,
      OPERATION_TYPE_MODIFY_DBMGMT = 'MODIFY_DBMGMT'.freeze,
