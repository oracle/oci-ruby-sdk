...
module OCI
  ...
  class DatabaseManagement::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** The date and time the work request was accepted, as described in
    ...
    # @return [Array<OCI::DatabaseManagement::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [id, compartment_id, operation_type, status, percent_complete, time_accepted, time_started, time_finished, resources].hash
    end
