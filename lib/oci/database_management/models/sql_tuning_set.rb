...
module OCI
  ...
  class DatabaseManagement::Models::SqlTuningSet
    ...
    ALL_SQL_STATEMENTS_FETCHED_ENUM = [
      ALL_SQL_STATEMENTS_FETCHED_YES = 'YES'.freeze,
      ALL_SQL_STATEMENTS_FETCHED_NO = 'NO'.freeze,
      ALL_SQL_STATEMENTS_FETCHED_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_reader :all_sql_statements_fetched
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] all_sql_statements_fetched Object to be assigned
    def all_sql_statements_fetched=(all_sql_statements_fetched)
      # rubocop:disable Style/ConditionalAssignment
      if all_sql_statements_fetched && !ALL_SQL_STATEMENTS_FETCHED_ENUM.include?(all_sql_statements_fetched)
        OCI.logger.debug("Unknown value for 'all_sql_statements_fetched' [" + all_sql_statements_fetched + "]. Mapping to 'ALL_SQL_STATEMENTS_FETCHED_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @all_sql_statements_fetched = ALL_SQL_STATEMENTS_FETCHED_UNKNOWN_ENUM_VALUE
      else
        @all_sql_statements_fetched = all_sql_statements_fetched
      end
      # rubocop:enable Style/ConditionalAssignment
    end
