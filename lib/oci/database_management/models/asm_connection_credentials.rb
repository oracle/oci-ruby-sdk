...
module OCI
  ...
  class DatabaseManagement::Models::AsmConnectionCredentials
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::AsmConnectionCredentailsByName' if type == 'NAME_REFERENCE'
      return 'OCI::DatabaseManagement::Models::AsmConnectionCredentialsByDetails' if type == 'DETAILS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::AsmConnectionCredentials'
    end
