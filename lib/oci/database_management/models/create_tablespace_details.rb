...
module OCI
  ...
  class DatabaseManagement::Models::CreateTablespaceDetails
    ...
    def hash
      [credential_details, database_credential, name, type, is_bigfile, data_files, file_count, file_size, is_reusable, is_auto_extensible, auto_extend_next_size, auto_extend_max_size, is_max_size_unlimited, block_size_in_kilobytes, is_encrypted, encryption_algorithm, default_compress, status, extent_management, extent_uniform_size, segment_management, is_default].hash
    end
