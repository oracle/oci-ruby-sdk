...
require 'date'
require_relative 'job_execution_result_location'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details about Object Storage job execution result location type.
  class DatabaseManagement::Models::ObjectStorageJobExecutionResultLocation < DatabaseManagement::Models::JobExecutionResultLocation
    ...
    def hash
      [type, namespace_name, bucket_name].hash
    end
