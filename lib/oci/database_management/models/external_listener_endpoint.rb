...
module OCI
  ...
  class DatabaseManagement::Models::ExternalListenerEndpoint
    PROTOCOL_ENUM = [
      PROTOCOL_IPC = 'IPC'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::ExternalListenerTcpEndpoint' if type == 'TCP'
      return 'OCI::DatabaseManagement::Models::ExternalListenerTcpsEndpoint' if type == 'TCPS'
      return 'OCI::DatabaseManagement::Models::ExternalListenerIpcEndpoint' if type == 'IPC'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::ExternalListenerEndpoint'
    end
