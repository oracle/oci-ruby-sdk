...
module OCI
  ...
  class DatabaseManagement::Models::WorkRequestError
    ...
    # **[Required]** A machine-usable code for the error that occurred. Error codes are listed on
    ...
    # @option attributes [BOOLEAN] :is_retryable The value to assign to the {#is_retryable} property
