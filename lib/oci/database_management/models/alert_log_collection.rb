...
module OCI
  ...
  class DatabaseManagement::Models::AlertLogCollection
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AlertLogSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AlertLogSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AlertLogSummary>] :items The value to assign to the {#items} property
