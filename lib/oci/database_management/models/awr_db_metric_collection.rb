...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbMetricCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR metric summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbMetricSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbMetricSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbMetricSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_METRICS_SET'
