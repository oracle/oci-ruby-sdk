...
module OCI
  ...
  #
  class DatabaseManagement::Models::ChangeSqlPlanBaselinesAttributesDetails
    ...
    # @option attributes [BOOLEAN] :is_auto_purged The value to assign to the {#is_auto_purged} property
