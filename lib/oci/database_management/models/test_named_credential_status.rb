...
module OCI
  ...
  class DatabaseManagement::Models::TestNamedCredentialStatus
    STATUS_ENUM = [
    ...
    # **[Required]** The status of the named credential test. The status is 'SUCCEEDED' if the named credential is working or else the status is 'FAILED'.
    # @return [String]
    attr_reader :status
