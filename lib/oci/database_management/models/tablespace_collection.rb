...
module OCI
  ...
  class DatabaseManagement::Models::TablespaceCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::TablespaceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::TablespaceSummary>] :items The value to assign to the {#items} property
