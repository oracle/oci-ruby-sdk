...
module OCI
  ...
  class DatabaseManagement::Models::CreateNamedCredentialDetails
    SCOPE_ENUM = [
    ...
    # **[Required]** The name of the named credential. Valid characters are uppercase or
    ...
    def hash
      [name, description, scope, type, content, compartment_id, associated_resource, freeform_tags, defined_tags].hash
    end
