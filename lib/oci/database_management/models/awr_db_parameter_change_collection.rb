...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbParameterChangeCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR database parameter change summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbParameterChangeSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbParameterChangeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbParameterChangeSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_DB_PARAMETER_CHANGE'
    ...
    def hash
      [name, version, query_key, db_query_time_in_secs, awr_result_type, items].hash
    end
