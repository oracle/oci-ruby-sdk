...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbSnapshotCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR snapshot summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbSnapshotSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbSnapshotSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_SNAPSHOT_SET'
