...
module OCI
  ...
  class DatabaseManagement::Models::ImplementOptimizerStatisticsAdvisorRecommendationsJob
    ...
    def hash
      [name, description, compartment_id, result_location, credentials, database_credential].hash
    end
