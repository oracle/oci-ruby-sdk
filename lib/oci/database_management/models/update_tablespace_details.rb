...
module OCI
  ...
  class DatabaseManagement::Models::UpdateTablespaceDetails
    ...
    def hash
      [credential_details, database_credential, name, type, file_size, status, is_auto_extensible, auto_extend_next_size, auto_extend_max_size, is_max_size_unlimited, is_default].hash
    end
