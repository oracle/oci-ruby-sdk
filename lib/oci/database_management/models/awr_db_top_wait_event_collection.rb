...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbTopWaitEventCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR top event summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbTopWaitEventSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbTopWaitEventSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbTopWaitEventSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_TOP_EVENT_SET'
