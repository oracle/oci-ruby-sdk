...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalClusterInstance < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    NODE_ROLE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['componentType'] = 'CLUSTER_INSTANCE'
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, host_name, cluster_id, node_role, crs_base_directory, adr_home_directory, connector].hash
    end
