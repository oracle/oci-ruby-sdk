...
module OCI
  ...
  class DatabaseManagement::Models::ChangeDatabaseParametersDetails
    SCOPE_ENUM = [
      ...
      SCOPE_SPFILE = 'SPFILE'.freeze,
      SCOPE_BOTH = 'BOTH'.freeze
    ].freeze

    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::DatabaseCredentials]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::ChangeDatabaseParameterDetails>]
    ...
    # @option attributes [OCI::DatabaseManagement::Models::DatabaseCredentials] :credentials The value to assign to the {#credentials} property
    # @option attributes [String] :scope The value to assign to the {#scope} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::ChangeDatabaseParameterDetails>] :parameters The value to assign to the {#parameters} property
    ...
    def hash
      [credentials, scope, parameters].hash
    end
