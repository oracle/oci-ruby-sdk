...
require 'date'
require_relative 'external_db_system_connection_info'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details required to connect to an external ASM instance.
  class DatabaseManagement::Models::ExternalAsmConnectionInfo < DatabaseManagement::Models::ExternalDbSystemConnectionInfo
    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::AsmConnectionString]
    attr_accessor :connection_string

    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::AsmConnectionCredentials]
    ...
    def self.swagger_types
      {
        ...
        'connection_string': :'OCI::DatabaseManagement::Models::AsmConnectionString',
        'connection_credentials': :'OCI::DatabaseManagement::Models::AsmConnectionCredentials'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseManagement::Models::AsmConnectionString] :connection_string The value to assign to the {#connection_string} property
    # @option attributes [OCI::DatabaseManagement::Models::AsmConnectionCredentials] :connection_credentials The value to assign to the {#connection_credentials} property
    ...
    def hash
      [component_type, connection_string, connection_credentials].hash
    end
