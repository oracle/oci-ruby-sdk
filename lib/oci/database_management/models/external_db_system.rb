...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbSystem
    ...
    # @return [String]
    attr_accessor :db_system_discovery_id
    ...
    # @return [String]
    attr_accessor :discovery_agent_id
    ...
    # @return [OCI::DatabaseManagement::Models::ExternalDbSystemDatabaseManagementConfigDetails]
    attr_accessor :database_management_config

    # @return [OCI::DatabaseManagement::Models::ExternalDbSystemStackMonitoringConfigDetails]
    ...
    def self.swagger_types
      {
        ...
        'stack_monitoring_config': :'OCI::DatabaseManagement::Models::ExternalDbSystemStackMonitoringConfigDetails',
    ...
    # @option attributes [String] :db_system_discovery_id The value to assign to the {#db_system_discovery_id} property
    # @option attributes [String] :discovery_agent_id The value to assign to the {#discovery_agent_id} property
    ...
    # @option attributes [OCI::DatabaseManagement::Models::ExternalDbSystemDatabaseManagementConfigDetails] :database_management_config The value to assign to the {#database_management_config} property
    # @option attributes [OCI::DatabaseManagement::Models::ExternalDbSystemStackMonitoringConfigDetails] :stack_monitoring_config The value to assign to the {#stack_monitoring_config} property
    ...
    def initialize(attributes = {})
      ...
      self.db_system_discovery_id = attributes[:'dbSystemDiscoveryId'] if attributes[:'dbSystemDiscoveryId']

      raise 'You cannot provide both :dbSystemDiscoveryId and :db_system_discovery_id' if attributes.key?(:'dbSystemDiscoveryId') && attributes.key?(:'db_system_discovery_id')

      self.db_system_discovery_id = attributes[:'db_system_discovery_id'] if attributes[:'db_system_discovery_id']

      self.discovery_agent_id = attributes[:'discoveryAgentId'] if attributes[:'discoveryAgentId']

      raise 'You cannot provide both :discoveryAgentId and :discovery_agent_id' if attributes.key?(:'discoveryAgentId') && attributes.key?(:'discovery_agent_id')

      self.discovery_agent_id = attributes[:'discovery_agent_id'] if attributes[:'discovery_agent_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        db_system_discovery_id == other.db_system_discovery_id &&
        discovery_agent_id == other.discovery_agent_id &&
    ...
    def hash
      [id, display_name, compartment_id, db_system_discovery_id, discovery_agent_id, is_cluster, home_directory, database_management_config, stack_monitoring_config, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
