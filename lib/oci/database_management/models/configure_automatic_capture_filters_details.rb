...
module OCI
  ...
  #
  class DatabaseManagement::Models::ConfigureAutomaticCaptureFiltersDetails
    # **[Required]** The filters used in automatic initial plan capture.
    # @return [Array<OCI::DatabaseManagement::Models::AutomaticCaptureFilterDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'auto_capture_filters': :'Array<OCI::DatabaseManagement::Models::AutomaticCaptureFilterDetails>',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AutomaticCaptureFilterDetails>] :auto_capture_filters The value to assign to the {#auto_capture_filters} property
    ...
    def hash
      [auto_capture_filters, credentials, database_credential].hash
    end
