...
module OCI
  ...
  class DatabaseManagement::Models::ExternalAsmInstance
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_asm_id, external_db_system_id, external_db_node_id, adr_home_directory, host_name, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
