...
module OCI
  ...
  class DatabaseManagement::Models::PreferredCredential
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::NamedPreferredCredential' if type == 'NAMED_CREDENTIAL'
      return 'OCI::DatabaseManagement::Models::BasicPreferredCredential' if type == 'BASIC'
    ...
    def hash
      [type, credential_name, status, is_accessible].hash
    end
