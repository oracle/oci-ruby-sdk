...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbWaitEventBucketSummary
    ...
    # @option attributes [Float] :percentage The value to assign to the {#percentage} property
