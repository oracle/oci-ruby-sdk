...
module OCI
  ...
  #
  class DatabaseManagement::Models::AttentionLogCountSummary
    CATEGORY_ENUM = [
      ...
      CATEGORY_IMMEDIATE = 'IMMEDIATE'.freeze,
      CATEGORY_SOON = 'SOON'.freeze,
      CATEGORY_DEFERRABLE = 'DEFERRABLE'.freeze,
      CATEGORY_INFO = 'INFO'.freeze,
