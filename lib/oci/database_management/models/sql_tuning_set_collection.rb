...
module OCI
  ...
  class DatabaseManagement::Models::SqlTuningSetCollection
    ...
    # @return [Array<OCI::DatabaseManagement::Models::SqlTuningSetSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::SqlTuningSetSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::SqlTuningSetSummary>] :items The value to assign to the {#items} property
