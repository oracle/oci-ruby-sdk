...
module OCI
  ...
  #
  class DatabaseManagement::Models::DatabaseSecretCredentialDetails < DatabaseManagement::Models::DatabaseCredentialDetails
    ROLE_ENUM = [
    ...
    def hash
      [credential_type, password_secret_id, username, role].hash
    end
