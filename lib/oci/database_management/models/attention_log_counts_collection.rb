...
module OCI
  ...
  class DatabaseManagement::Models::AttentionLogCountsCollection
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AttentionLogCountSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AttentionLogCountSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AttentionLogCountSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [managed_database_id, items].hash
    end
