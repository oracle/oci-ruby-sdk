...
module OCI
  ...
  class DatabaseManagement::Models::CreateManagedDatabaseGroupDetails
    # **[Required]** The name of the Managed Database Group. Valid characters are uppercase or
    ...
    def hash
      [name, description, compartment_id].hash
    end
