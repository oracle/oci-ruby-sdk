...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseFeatureConfiguration
    FEATURE_ENUM = [
    ...
    # @return [OCI::DatabaseManagement::Models::ConnectorDetails]
    attr_accessor :connector_details

    # @return [OCI::DatabaseManagement::Models::DatabaseConnectionDetails]
    ...
    # @option attributes [String] :feature The value to assign to the {#feature} property
    # @option attributes [String] :feature_status The value to assign to the {#feature_status} property
    # @option attributes [OCI::DatabaseManagement::Models::ConnectorDetails] :connector_details The value to assign to the {#connector_details} property
    # @option attributes [OCI::DatabaseManagement::Models::DatabaseConnectionDetails] :database_connection_details The value to assign to the {#database_connection_details} property
    ...
    def feature=(feature)
      raise "Invalid value for 'feature': this must be one of the values in FEATURE_ENUM." if feature && !FEATURE_ENUM.include?(feature)

      @feature = feature
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] feature_status Object to be assigned
    def feature_status=(feature_status)
      raise "Invalid value for 'feature_status': this must be one of the values in FEATURE_STATUS_ENUM." if feature_status && !FEATURE_STATUS_ENUM.include?(feature_status)
