...
module OCI
  ...
  class DatabaseManagement::Models::ExternalClusterScanListenerConfiguration
    SCAN_PROTOCOL_ENUM = [
    ...
    # @option attributes [String] :scan_name The value to assign to the {#scan_name} property
    # @option attributes [Integer] :network_number The value to assign to the {#network_number} property
    # @option attributes [Integer] :scan_port The value to assign to the {#scan_port} property
    # @option attributes [String] :scan_protocol The value to assign to the {#scan_protocol} property
    ...
    # @param [Object] scan_protocol Object to be assigned
    def scan_protocol=(scan_protocol)
      # rubocop:disable Style/ConditionalAssignment
      if scan_protocol && !SCAN_PROTOCOL_ENUM.include?(scan_protocol)
        OCI.logger.debug("Unknown value for 'scan_protocol' [" + scan_protocol + "]. Mapping to 'SCAN_PROTOCOL_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @scan_protocol = SCAN_PROTOCOL_UNKNOWN_ENUM_VALUE
      else
