...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbParameterCollection < DatabaseManagement::Models::AwrQueryResult
    # A list of AWR database parameter summary data.
    # @return [Array<OCI::DatabaseManagement::Models::AwrDbParameterSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AwrDbParameterSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AwrDbParameterSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['awrResultType'] = 'AWRDB_DB_PARAMETER_SET'
