...
module OCI
  module DatabaseManagement::Models
    WORK_REQUEST_RESOURCE_ACTION_TYPE_ENUM = [
      ...
      WORK_REQUEST_RESOURCE_ACTION_TYPE_ACCEPTED = 'ACCEPTED'.freeze,
      WORK_REQUEST_RESOURCE_ACTION_TYPE_ENABLED = 'ENABLED'.freeze,
      WORK_REQUEST_RESOURCE_ACTION_TYPE_DISABLED = 'DISABLED'.freeze
    ].freeze
  end
end
