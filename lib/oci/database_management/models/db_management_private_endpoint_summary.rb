...
module OCI
  ...
  class DatabaseManagement::Models::DbManagementPrivateEndpointSummary
    ...
    def hash
      [id, name, compartment_id, vcn_id, subnet_id, description, time_created, lifecycle_state].hash
    end
