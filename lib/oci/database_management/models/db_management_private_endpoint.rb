...
module OCI
  ...
  class DatabaseManagement::Models::DbManagementPrivateEndpoint
    ...
    def hash
      [id, name, compartment_id, is_cluster, vcn_id, subnet_id, private_ip, description, time_created, lifecycle_state, nsg_ids, freeform_tags, defined_tags, system_tags].hash
    end
