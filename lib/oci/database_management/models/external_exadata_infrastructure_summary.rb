...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataInfrastructureSummary < DatabaseManagement::Models::DbmResource
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, rack_size, compartment_id, license_model, grid_home_path].hash
    end
