...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalPluggableDatabase < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    ...
    def initialize(attributes = {})
      ...
      attributes['componentType'] = 'PLUGGABLE_DATABASE'
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, compartment_id, container_database_id, guid, connector].hash
    end
