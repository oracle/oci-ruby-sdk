...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseFeatureDetails
    FEATURE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::DatabaseDiagnosticsAndManagementFeatureDetails' if type == 'DIAGNOSTICS_AND_MANAGEMENT'
    ...
    def hash
      [feature, database_connection_details, connector_details].hash
    end
