...
module OCI
  ...
  class DatabaseManagement::Models::NamedCredentialContent
    CREDENTIAL_TYPE_ENUM = [
      CREDENTIAL_TYPE_BASIC = 'BASIC'.freeze,
      CREDENTIAL_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of named credential. Only 'BASIC' is supported currently.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::BasicNamedCredentialContent' if type == 'BASIC'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::NamedCredentialContent'
    end
