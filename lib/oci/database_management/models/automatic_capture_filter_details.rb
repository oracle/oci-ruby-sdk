...
module OCI
  ...
  #
  class DatabaseManagement::Models::AutomaticCaptureFilterDetails
    NAME_ENUM = [
    ...
    # @return [Array<String>]
    attr_accessor :values_to_include

    # A list of filter values to exclude.
    # @return [Array<String>]
    attr_accessor :values_to_exclude
    ...
    # @option attributes [Array<String>] :values_to_include The value to assign to the {#values_to_include} property
    # @option attributes [Array<String>] :values_to_exclude The value to assign to the {#values_to_exclude} property
    ...
    def hash
      [name, values_to_include, values_to_exclude].hash
    end
