...
require 'date'
require_relative 'managed_database_credential'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # User provides a secret OCID, which will be used to retrieve the password to connect to the database.
  #
  class DatabaseManagement::Models::ManagedDatabaseSecretCredential < DatabaseManagement::Models::ManagedDatabaseCredential
    ...
    # @option attributes [String] :username The value to assign to the {OCI::DatabaseManagement::Models::ManagedDatabaseCredential#username #username} proprety
    # @option attributes [String] :role The value to assign to the {OCI::DatabaseManagement::Models::ManagedDatabaseCredential#role #role} proprety
    # @option attributes [String] :password_secret_id The value to assign to the {#password_secret_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['credentialType'] = 'SECRET'
    ...
    def hash
      [credential_type, username, role, password_secret_id].hash
    end
