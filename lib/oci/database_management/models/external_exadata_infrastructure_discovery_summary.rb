...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataInfrastructureDiscoverySummary < DatabaseManagement::Models::EntityDiscovered
    RACK_SIZE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['entityType'] = 'INFRASTRUCTURE_DISCOVER_SUMMARY'
    ...
    def rack_size=(rack_size)
      raise "Invalid value for 'rack_size': this must be one of the values in RACK_SIZE_ENUM." if rack_size && !RACK_SIZE_ENUM.include?(rack_size)
    ...
    def hash
      [id, agent_id, connector_id, display_name, version, internal_id, status, discover_status, discover_error_code, discover_error_msg, entity_type, rack_size].hash
    end
