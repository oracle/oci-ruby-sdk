...
module OCI
  ...
  class DatabaseManagement::Models::ExternalExadataDatabaseSystemSummary < DatabaseManagement::Models::DbmResource
    LICENSE_MODEL_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceType'] = 'DATABASE_SYSTEM_SUMMARY'
    ...
    def hash
      [id, display_name, version, internal_id, status, lifecycle_state, time_created, time_updated, lifecycle_details, additional_details, resource_type, compartment_id, license_model].hash
    end
