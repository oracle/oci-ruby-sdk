...
module OCI
  ...
  class DatabaseManagement::Models::AlertLogCountsCollection
    ...
    # @return [Array<OCI::DatabaseManagement::Models::AlertLogCountSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseManagement::Models::AlertLogCountSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::AlertLogCountSummary>] :items The value to assign to the {#items} property
