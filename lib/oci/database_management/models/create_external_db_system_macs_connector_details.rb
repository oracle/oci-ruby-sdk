...
require 'date'
require_relative 'create_external_db_system_connector_details'
...
module OCI
  ...
  #
  class DatabaseManagement::Models::CreateExternalDbSystemMacsConnectorDetails < DatabaseManagement::Models::CreateExternalDbSystemConnectorDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseManagement::Models::CreateExternalDbSystemConnectorDetails#display_name #display_name} proprety
    # @option attributes [String] :external_db_system_id The value to assign to the {OCI::DatabaseManagement::Models::CreateExternalDbSystemConnectorDetails#external_db_system_id #external_db_system_id} proprety
    ...
    def hash
      [connector_type, display_name, external_db_system_id, agent_id, connection_info, freeform_tags, defined_tags].hash
    end
