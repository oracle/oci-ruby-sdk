...
require 'date'
require_relative 'sql_tuning_task_credential_details'
...
module OCI
  ...
  class DatabaseManagement::Models::SqlTuningTaskSecretCredentialDetails < DatabaseManagement::Models::SqlTuningTaskCredentialDetails
    ...
    # @option attributes [String] :username The value to assign to the {OCI::DatabaseManagement::Models::SqlTuningTaskCredentialDetails#username #username} proprety
    # @option attributes [String] :role The value to assign to the {OCI::DatabaseManagement::Models::SqlTuningTaskCredentialDetails#role #role} proprety
    # @option attributes [String] :password_secret_id The value to assign to the {#password_secret_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['sqlTuningTaskCredentialType'] = 'SECRET'
    ...
    def hash
      [sql_tuning_task_credential_type, username, role, password_secret_id].hash
    end
