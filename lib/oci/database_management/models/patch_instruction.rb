...
module OCI
  ...
  class DatabaseManagement::Models::PatchInstruction
    OPERATION_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::PatchMergeInstruction' if type == 'MERGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::PatchInstruction'
    end
