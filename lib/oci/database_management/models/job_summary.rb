...
module OCI
  ...
  class DatabaseManagement::Models::JobSummary
    ...
    def hash
      [id, compartment_id, name, description, managed_database_group_id, managed_database_id, database_sub_type, schedule_type, schedule_details, job_type, lifecycle_state, timeout, submission_error_message, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
