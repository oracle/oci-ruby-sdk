...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseConnectionStringDetails
    CONNECTION_TYPE_ENUM = [
      CONNECTION_TYPE_BASIC = 'BASIC'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::BasicDatabaseConnectionStringDetails' if type == 'BASIC'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::DatabaseConnectionStringDetails'
    end
    ...
    def initialize(attributes = {})
      ...
      self.connection_type = "BASIC" if connection_type.nil? && !attributes.key?(:'connectionType') # rubocop:disable Style/StringLiterals
      ...
      self.connection_type = "BASIC" if connection_type.nil? && !attributes.key?(:'connectionType') && !attributes.key?(:'connection_type') # rubocop:disable Style/StringLiterals
    end
