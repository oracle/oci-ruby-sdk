...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbSysstatSummary
    ...
    # @option attributes [Float] :avg_value The value to assign to the {#avg_value} property
    # @option attributes [Float] :current_value The value to assign to the {#current_value} property
    def initialize(attributes = {})
      ...
      self.avg_value = attributes[:'avgValue'] if attributes[:'avgValue']

      raise 'You cannot provide both :avgValue and :avg_value' if attributes.key?(:'avgValue') && attributes.key?(:'avg_value')

      self.avg_value = attributes[:'avg_value'] if attributes[:'avg_value']

      self.current_value = attributes[:'currentValue'] if attributes[:'currentValue']

      raise 'You cannot provide both :currentValue and :current_value' if attributes.key?(:'currentValue') && attributes.key?(:'current_value')

      self.current_value = attributes[:'current_value'] if attributes[:'current_value']
    end
    ...
    def hash
      [name, category, time_begin, time_end, avg_value, current_value].hash
    end
