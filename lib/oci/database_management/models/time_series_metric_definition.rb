...
module OCI
  ...
  class DatabaseManagement::Models::TimeSeriesMetricDefinition
    ...
    # @return [Array<OCI::DatabaseManagement::Models::TimeSeriesMetricDataPoint>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'metric_name': :'String',
        'datapoints': :'Array<OCI::DatabaseManagement::Models::TimeSeriesMetricDataPoint>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::TimeSeriesMetricDataPoint>] :datapoints The value to assign to the {#datapoints} property
