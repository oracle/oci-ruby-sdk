...
module OCI
  ...
  #
  class DatabaseManagement::Models::ExternalDatabaseConnectionInfo < DatabaseManagement::Models::ExternalDbSystemConnectionInfo
    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::DatabaseConnectionString]
    attr_accessor :connection_string

    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::DatabaseConnectionCredentials]
    ...
    # @option attributes [OCI::DatabaseManagement::Models::DatabaseConnectionString] :connection_string The value to assign to the {#connection_string} property
    # @option attributes [OCI::DatabaseManagement::Models::DatabaseConnectionCredentials] :connection_credentials The value to assign to the {#connection_credentials} property
