...
module OCI
  ...
  class DatabaseManagement::Models::ExternalClusterInstance
    NODE_ROLE_ENUM = [
      NODE_ROLE_HUB = 'HUB'.freeze,
      NODE_ROLE_LEAF = 'LEAF'.freeze,
      NODE_ROLE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external cluster instance.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external cluster that the cluster instance belongs to.
    # @return [String]
    attr_accessor :external_cluster_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system that the cluster instance is a part of.
    # @return [String]
    ...
    # @return [String]
    attr_accessor :crs_base_directory
    ...
    # @option attributes [String] :external_cluster_id The value to assign to the {#external_cluster_id} property
    ...
    # @option attributes [String] :node_role The value to assign to the {#node_role} property
    # @option attributes [String] :crs_base_directory The value to assign to the {#crs_base_directory} property
    ...
    def initialize(attributes = {})
      ...
      self.external_cluster_id = attributes[:'externalClusterId'] if attributes[:'externalClusterId']

      raise 'You cannot provide both :externalClusterId and :external_cluster_id' if attributes.key?(:'externalClusterId') && attributes.key?(:'external_cluster_id')

      self.external_cluster_id = attributes[:'external_cluster_id'] if attributes[:'external_cluster_id']
      ...
      self.node_role = attributes[:'nodeRole'] if attributes[:'nodeRole']

      raise 'You cannot provide both :nodeRole and :node_role' if attributes.key?(:'nodeRole') && attributes.key?(:'node_role')

      self.node_role = attributes[:'node_role'] if attributes[:'node_role']

      self.crs_base_directory = attributes[:'crsBaseDirectory'] if attributes[:'crsBaseDirectory']

      raise 'You cannot provide both :crsBaseDirectory and :crs_base_directory' if attributes.key?(:'crsBaseDirectory') && attributes.key?(:'crs_base_directory')

      self.crs_base_directory = attributes[:'crs_base_directory'] if attributes[:'crs_base_directory']
    ...
    def node_role=(node_role)
      ...
      if node_role && !NODE_ROLE_ENUM.include?(node_role)
        OCI.logger.debug("Unknown value for 'node_role' [" + node_role + "]. Mapping to 'NODE_ROLE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @node_role = NODE_ROLE_UNKNOWN_ENUM_VALUE
      else
        @node_role = node_role
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        external_cluster_id == other.external_cluster_id &&
        ...
        node_role == other.node_role &&
        crs_base_directory == other.crs_base_directory &&
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_cluster_id, external_db_system_id, external_db_node_id, external_connector_id, host_name, node_role, crs_base_directory, adr_home_directory, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
