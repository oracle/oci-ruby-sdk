...
module OCI
  ...
  class DatabaseManagement::Models::ExternalClusterInstance
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_cluster_id, external_db_system_id, external_db_node_id, external_connector_id, host_name, node_role, crs_base_directory, adr_home_directory, lifecycle_state, lifecycle_details, time_created, time_updated].hash
    end
