...
module OCI
  ...
  class DatabaseManagement::Models::ExternalAsm
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external ASM.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system that the ASM is a part of.
    # @return [String]
    ...
    # @return [Array<OCI::DatabaseManagement::Models::ExternalAsmServicedDatabase>]
    ...
    def self.swagger_types
      {
        ...
        'serviced_databases': :'Array<OCI::DatabaseManagement::Models::ExternalAsmServicedDatabase>',
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::ExternalAsmServicedDatabase>] :serviced_databases The value to assign to the {#serviced_databases} property
    ...
    def hash
      [id, display_name, component_name, compartment_id, external_db_system_id, external_connector_id, grid_home, is_cluster, is_flex_enabled, lifecycle_state, lifecycle_details, serviced_databases, additional_details, time_created, time_updated, version, freeform_tags, defined_tags, system_tags].hash
    end
