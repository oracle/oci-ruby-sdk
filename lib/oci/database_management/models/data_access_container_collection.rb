...
module OCI
  ...
  class DatabaseManagement::Models::DataAccessContainerCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseManagement::Models::DataAccessContainerSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::DataAccessContainerSummary>] :items The value to assign to the {#items} property
