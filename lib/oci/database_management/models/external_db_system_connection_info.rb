...
module OCI
  ...
  class DatabaseManagement::Models::ExternalDbSystemConnectionInfo
    COMPONENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::ExternalAsmConnectionInfo' if type == 'ASM'
      return 'OCI::DatabaseManagement::Models::ExternalDatabaseConnectionInfo' if type == 'DATABASE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::ExternalDbSystemConnectionInfo'
    end
