...
require 'date'
require_relative 'serving_mode'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The model's serving mode is dedicated serving and has an endpoint on a dedicated AI cluster.
  class GenerativeAiInference::Models::DedicatedServingMode < GenerativeAiInference::Models::ServingMode
    ...
    def initialize(attributes = {})
      ...
      attributes['servingType'] = 'DEDICATED'
