...
module OCI
  ...
  class GenerativeAiInference::Models::EmbedTextResult
    ...
    # @option attributes [Array<Array<Float>>] :embeddings The value to assign to the {#embeddings} property
    ...
    def initialize(attributes = {})
      ...
      self.embeddings = attributes[:'embeddings'] if attributes[:'embeddings']
    ...
    def hash
      [id, inputs, embeddings, model_id, model_version].hash
    end
