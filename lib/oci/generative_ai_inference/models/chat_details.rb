...
module OCI
  ...
  class GenerativeAiInference::Models::ChatDetails
    ...
    # @return [OCI::GenerativeAiInference::Models::BaseChatRequest]
    attr_accessor :chat_request
    ...
    def self.swagger_types
      {
        ...
        'chat_request': :'OCI::GenerativeAiInference::Models::BaseChatRequest'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GenerativeAiInference::Models::BaseChatRequest] :chat_request The value to assign to the {#chat_request} property
    def initialize(attributes = {})
      ...
      self.chat_request = attributes[:'chatRequest'] if attributes[:'chatRequest']

      raise 'You cannot provide both :chatRequest and :chat_request' if attributes.key?(:'chatRequest') && attributes.key?(:'chat_request')

      self.chat_request = attributes[:'chat_request'] if attributes[:'chat_request']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        chat_request == other.chat_request
    end
    ...
    def hash
      [compartment_id, serving_mode, chat_request].hash
    end
