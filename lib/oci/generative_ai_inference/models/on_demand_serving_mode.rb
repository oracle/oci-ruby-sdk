...
module OCI
  ...
  class GenerativeAiInference::Models::OnDemandServingMode < GenerativeAiInference::Models::ServingMode
    ...
    def initialize(attributes = {})
      ...
      attributes['servingType'] = 'ON_DEMAND'
