...
module OCI
  ...
  class GenerativeAiInference::Models::ChatChoice
    # **[Required]** The index of the chat.
    # @return [Integer]
    attr_accessor :index

    # This attribute is required.
    # @return [OCI::GenerativeAiInference::Models::Message]
    ...
    # @return [OCI::GenerativeAiInference::Models::Logprobs]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'index': :'Integer',
        'message': :'OCI::GenerativeAiInference::Models::Message',
    ...
    # @option attributes [OCI::GenerativeAiInference::Models::Message] :message The value to assign to the {#message} property
    # @option attributes [String] :finish_reason The value to assign to the {#finish_reason} property
    # @option attributes [OCI::GenerativeAiInference::Models::Logprobs] :logprobs The value to assign to the {#logprobs} property
    ...
    def hash
      [index, message, finish_reason, logprobs].hash
    end
