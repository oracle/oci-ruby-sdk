...
module OCI
  ...
  class GenerativeAiInference::Models::GenericChatRequest < GenerativeAiInference::Models::BaseChatRequest
    ...
    def hash
      [api_format, messages, is_stream, num_generations, is_echo, top_k, top_p, temperature, frequency_penalty, presence_penalty, stop, log_probs, max_tokens, logit_bias].hash
    end
