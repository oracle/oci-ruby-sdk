...
module OCI
  ...
  class GenerativeAiInference::Models::CohereMessage
    ROLE_ENUM = [
      ROLE_CHATBOT = 'CHATBOT'.freeze,
      ROLE_USER = 'USER'.freeze
    ].freeze

    # **[Required]** One of CHATBOT|USER to identify who the message is coming from.
    # @return [String]
    attr_reader :role
    ...
    def initialize(attributes = {})
      ...
      self.role = "USER" if role.nil? && !attributes.key?(:'role') # rubocop:disable Style/StringLiterals
