...
module OCI
  ...
  class GenerativeAiInference::Models::Citation
    ...
    # @option attributes [Array<String>] :document_ids The value to assign to the {#document_ids} property
    def initialize(attributes = {})
      ...
      self.document_ids = attributes[:'documentIds'] if attributes[:'documentIds']

      raise 'You cannot provide both :documentIds and :document_ids' if attributes.key?(:'documentIds') && attributes.key?(:'document_ids')

      self.document_ids = attributes[:'document_ids'] if attributes[:'document_ids']
    end
    ...
    def hash
      [start, _end, text, document_ids].hash
    end
