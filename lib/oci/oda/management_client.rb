...
module OCI
  ...
  class Oda::ManagementClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/bulk_create_skill_entities.rb.html) to see an example of how to use bulk_create_skill_entities API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/cascading_delete_skill_custom_entities.rb.html) to see an example of how to use cascading_delete_skill_custom_entities API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/change_oda_private_endpoint_compartment.rb.html) to see an example of how to use change_oda_private_endpoint_compartment API.
    ...
    #   then the service might reject a retry of the original creation request.
    #
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpoint OdaPrivateEndpoint}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/create_oda_private_endpoint.rb.html) to see an example of how to use create_oda_private_endpoint API.
    ...
    #   then the service might reject a retry of the original creation request.
    #
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointAttachment OdaPrivateEndpointAttachment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/create_oda_private_endpoint_attachment.rb.html) to see an example of how to use create_oda_private_endpoint_attachment API.
    ...
    #   then the service might reject a retry of the original creation request.
    #
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointScanProxy OdaPrivateEndpointScanProxy}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/create_oda_private_endpoint_scan_proxy.rb.html) to see an example of how to use create_oda_private_endpoint_scan_proxy API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/delete_oda_private_endpoint.rb.html) to see an example of how to use delete_oda_private_endpoint API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/delete_oda_private_endpoint_attachment.rb.html) to see an example of how to use delete_oda_private_endpoint_attachment API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/delete_oda_private_endpoint_scan_proxy.rb.html) to see an example of how to use delete_oda_private_endpoint_scan_proxy API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_none_match The If-None-Match HTTP request header makes the request conditional. For GET methods, the service will return the
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpoint OdaPrivateEndpoint}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/get_oda_private_endpoint.rb.html) to see an example of how to use get_oda_private_endpoint API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointAttachment OdaPrivateEndpointAttachment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/get_oda_private_endpoint_attachment.rb.html) to see an example of how to use get_oda_private_endpoint_attachment API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointScanProxy OdaPrivateEndpointScanProxy}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/get_oda_private_endpoint_scan_proxy.rb.html) to see an example of how to use get_oda_private_endpoint_scan_proxy API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :id Unique Digital Assistant identifier.
    ...
    # GET request, include the header's value as the `page` query parameter.
    #
    # @param [String] oda_private_endpoint_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of ODA Private Endpoint.
    # @param [String] compartment_id List the ODA Private Endpoint Attachments that belong to this compartment.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :limit The maximum number of items to return per page. (default to 100)
    ...
    #   Example: `MToxMA==`
    #
    # @option opts [String] :lifecycle_state List only the ODA Private Endpoint Attachments that are in this lifecycle state.
    # @option opts [String] :sort_order Sort the results in this order, use either `ASC` (ascending) or `DESC` (descending).
    #   Allowed values are: ASC, DESC
    # @option opts [String] :sort_by Sort on this field. You can specify one sort order only. The default sort field is `TIMECREATED`.
    #
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointAttachmentCollection OdaPrivateEndpointAttachmentCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/list_oda_private_endpoint_attachments.rb.html) to see an example of how to use list_oda_private_endpoint_attachments API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :lifecycle_state List only the ODA Private Endpoint Scan Proxies that are in this lifecycle state.
    # @option opts [Integer] :limit The maximum number of items to return per page. (default to 100)
    # @option opts [String] :page The page at which to start retrieving results.
    #
    #   You get this value from the `opc-next-page` header in a previous list request.
    ...
    #   Allowed values are: TIMECREATED, DISPLAYNAME
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointScanProxyCollection OdaPrivateEndpointScanProxyCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/list_oda_private_endpoint_scan_proxies.rb.html) to see an example of how to use list_oda_private_endpoint_scan_proxies API.
    ...
    # GET request, include the header's value as the `page` query parameter.
    #
    # @param [String] compartment_id List the ODA Private Endpoints that belong to this compartment.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @option opts [String] :lifecycle_state List only the ODA Private Endpoints that are in this lifecycle state.
    # @option opts [Integer] :limit The maximum number of items to return per page. (default to 100)
    # @option opts [String] :page The page at which to start retrieving results.
    #
    #   You get this value from the `opc-next-page` header in a previous list request.
    ...
    #   Allowed values are: TIMECREATED, DISPLAYNAME
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type {OCI::Oda::Models::OdaPrivateEndpointCollection OdaPrivateEndpointCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/list_oda_private_endpoints.rb.html) to see an example of how to use list_oda_private_endpoints API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :id Unique Skill identifier.
    # @option opts [String] :category List only Bot resources with this category.
    # @option opts [String] :name List only Bot resources with this name. Names are unique and may not change.
    #
    #   Example: `MySkill`
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/train_skill.rb.html) to see an example of how to use train_skill API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing. This value is included in the opc-request-id response header.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/oda/update_oda_private_endpoint.rb.html) to see an example of how to use update_oda_private_endpoint API.
