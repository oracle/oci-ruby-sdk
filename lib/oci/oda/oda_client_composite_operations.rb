...
module OCI
  ...
  class Oda::OdaClientCompositeOperations
    ...
    # Calls {OCI::Oda::OdaClient#create_oda_instance_attachment} and then waits for the {OCI::Oda::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] oda_instance_id Unique Digital Assistant instance identifier.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Oda::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::OdaClient#create_oda_instance_attachment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Oda::Models::WorkRequest}
    def create_oda_instance_attachment_and_wait_for_state(oda_instance_id, create_oda_instance_attachment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_oda_instance_attachment(oda_instance_id, create_oda_instance_attachment_details, base_operation_opts)
      use_util = OCI::Oda::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Oda::OdaClient#delete_oda_instance_attachment} and then waits for the {OCI::Oda::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] oda_instance_id Unique Digital Assistant instance identifier.
    # @param [String] attachment_id Unique Digital Assistant instance attachment identifier.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Oda::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::OdaClient#delete_oda_instance_attachment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Oda::Models::WorkRequest}
    def delete_oda_instance_attachment_and_wait_for_state(oda_instance_id, attachment_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_oda_instance_attachment(oda_instance_id, attachment_id, base_operation_opts)
      use_util = OCI::Oda::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Oda::OdaClient#update_oda_instance_attachment} and then waits for the {OCI::Oda::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] oda_instance_id Unique Digital Assistant instance identifier.
    # @param [String] attachment_id Unique Digital Assistant instance attachment identifier.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Oda::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::OdaClient#update_oda_instance_attachment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Oda::Models::WorkRequest}
    def update_oda_instance_attachment_and_wait_for_state(oda_instance_id, attachment_id, update_oda_instance_attachment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_oda_instance_attachment(oda_instance_id, attachment_id, update_oda_instance_attachment_details, base_operation_opts)
      use_util = OCI::Oda::Util.respond_to?(:wait_on_work_request)
