...
module OCI
  ...
  class Oda::Models::CreateTestChannelResult < Oda::Models::CreateChannelResult
    ...
    def hash
      [id, name, description, category, type, session_expiry_duration_in_milliseconds, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, secret_key, webhook_url].hash
    end
