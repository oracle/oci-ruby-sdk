...
module OCI
  ...
  class Oda::Models::ExtendDigitalAssistantDetails < Oda::Models::CreateDigitalAssistantDetails
    ...
    def hash
      [kind, category, description, platform_version, multilingual_mode, primary_language_tag, freeform_tags, defined_tags, id, name, display_name, version].hash
    end
