...
module OCI
  ...
  class Oda::Models::CreateAppEventChannelDetails < Oda::Models::CreateChannelDetails
    ...
    def hash
      [name, description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, outbound_url, event_sink_bot_ids].hash
    end
