...
module OCI
  ...
  class Oda::Models::ExtendSkillDetails < Oda::Models::CreateSkillDetails
    ...
    # @option attributes [String] :dialog_version The value to assign to the {OCI::Oda::Models::CreateSkillDetails#dialog_version #dialog_version} proprety
    ...
    def hash
      [kind, category, description, platform_version, dialog_version, multilingual_mode, primary_language_tag, freeform_tags, defined_tags, id, name, display_name, version].hash
    end
