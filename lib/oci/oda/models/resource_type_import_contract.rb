...
module OCI
  ...
  class Oda::Models::ResourceTypeImportContract
    ...
    # @return [Array<OCI::Oda::Models::ParameterDefinition>]
    ...
    # @option attributes [Array<OCI::Oda::Models::ParameterDefinition>] :parameters The value to assign to the {#parameters} property
