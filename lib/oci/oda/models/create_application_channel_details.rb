...
module OCI
  ...
  class Oda::Models::CreateApplicationChannelDetails < Oda::Models::CreateChannelDetails
    ...
    def hash
      [name, description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, outbound_url, is_authenticated_user_id].hash
    end
