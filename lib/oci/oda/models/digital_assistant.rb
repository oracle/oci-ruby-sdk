...
module OCI
  ...
  class Oda::Models::DigitalAssistant
    ...
    def hash
      [id, name, version, display_name, category, description, namespace, lifecycle_state, lifecycle_details, platform_version, dialog_version, base_id, multilingual_mode, primary_language_tag, native_language_tags, time_created, time_updated, freeform_tags, defined_tags].hash
    end
