...
module OCI
  ...
  class Oda::Models::UpdateOSSChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, event_sink_bot_ids, inbound_message_topic, outbound_message_topic, bootstrap_servers, security_protocol, sasl_mechanism, tenancy_name, user_name, stream_pool_id, auth_token].hash
    end
