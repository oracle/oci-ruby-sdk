...
module OCI
  ...
  class Oda::Models::CreateChannelDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Oda::Models::CreateMSTeamsChannelDetails' if type == 'MSTEAMS'
      return 'OCI::Oda::Models::CreateWebChannelDetails' if type == 'WEB'
      return 'OCI::Oda::Models::CreateFacebookChannelDetails' if type == 'FACEBOOK'
      return 'OCI::Oda::Models::CreateApplicationChannelDetails' if type == 'APPLICATION'
      return 'OCI::Oda::Models::CreateServiceCloudChannelDetails' if type == 'SERVICECLOUD'
      return 'OCI::Oda::Models::CreateSlackChannelDetails' if type == 'SLACK'
      return 'OCI::Oda::Models::CreateOsvcChannelDetails' if type == 'OSVC'
      return 'OCI::Oda::Models::CreateAppEventChannelDetails' if type == 'APPEVENT'
      return 'OCI::Oda::Models::CreateOSSChannelDetails' if type == 'OSS'
      return 'OCI::Oda::Models::CreateCortanaChannelDetails' if type == 'CORTANA'
      return 'OCI::Oda::Models::CreateAndroidChannelDetails' if type == 'ANDROID'
      return 'OCI::Oda::Models::CreateTwilioChannelDetails' if type == 'TWILIO'
      return 'OCI::Oda::Models::CreateWebhookChannelDetails' if type == 'WEBHOOK'
      return 'OCI::Oda::Models::CreateIosChannelDetails' if type == 'IOS'
