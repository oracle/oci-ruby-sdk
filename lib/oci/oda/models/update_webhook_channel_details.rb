...
module OCI
  ...
  class Oda::Models::UpdateWebhookChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    def payload_version=(payload_version)
      raise "Invalid value for 'payload_version': this must be one of the values in PAYLOAD_VERSION_ENUM." if payload_version && !PAYLOAD_VERSION_ENUM.include?(payload_version)
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, outbound_url, payload_version, bot_id].hash
    end
