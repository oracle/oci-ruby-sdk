...
module OCI
  ...
  class Oda::Models::ApplicationChannel < Oda::Models::Channel
    ...
    def hash
      [id, name, description, category, type, session_expiry_duration_in_milliseconds, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, outbound_url, is_authenticated_user_id, webhook_url].hash
    end
