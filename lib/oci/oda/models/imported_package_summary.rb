...
module OCI
  ...
  class Oda::Models::ImportedPackageSummary
    ...
    def hash
      [oda_instance_id, current_package_id, name, display_name, version, status, time_created, time_updated, freeform_tags, defined_tags].hash
    end
