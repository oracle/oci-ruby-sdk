...
module OCI
  ...
  class Oda::Models::FacebookChannel < Oda::Models::Channel
    ...
    def hash
      [id, name, description, category, type, session_expiry_duration_in_milliseconds, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, bot_id, webhook_url].hash
    end
