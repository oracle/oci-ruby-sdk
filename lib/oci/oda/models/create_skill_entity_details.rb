...
module OCI
  ...
  class Oda::Models::CreateSkillEntityDetails
    TYPE_ENUM = [
      TYPE_COMPOSITE = 'COMPOSITE'.freeze,
      TYPE_ENUM_VALUES = 'ENUM_VALUES'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Oda::Models::CreateSkillValueListEntityDetails' if type == 'ENUM_VALUES'
      return 'OCI::Oda::Models::CreateSkillCompositeEntityDetails' if type == 'COMPOSITE'
