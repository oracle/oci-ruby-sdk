...
module OCI
  ...
  class Oda::Models::ResourceTypeMetadata
    ...
    def self.swagger_types
      {
        ...
        'properties': :'Array<OCI::Oda::Models::MetadataProperty>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Oda::Models::MetadataProperty>] :properties The value to assign to the {#properties} property
