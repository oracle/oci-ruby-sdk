...
module OCI
  ...
  class Oda::Models::OdaInstanceSummary
    SHAPE_NAME_ENUM = [
    ...
    def hash
      [id, display_name, description, compartment_id, shape_name, time_created, time_updated, lifecycle_state, lifecycle_sub_state, state_message, freeform_tags, defined_tags].hash
    end
