...
module OCI
  ...
  class Oda::Models::UpdateSlackChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    # @option attributes [String] :signing_secret The value to assign to the {#signing_secret} property
    ...
    def initialize(attributes = {})
      ...
      self.signing_secret = attributes[:'signingSecret'] if attributes[:'signingSecret']

      raise 'You cannot provide both :signingSecret and :signing_secret' if attributes.key?(:'signingSecret') && attributes.key?(:'signing_secret')

      self.signing_secret = attributes[:'signing_secret'] if attributes[:'signing_secret']
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, client_id, auth_success_url, auth_error_url, signing_secret, client_secret, bot_id].hash
    end
