...
module OCI
  ...
  class Oda::Models::TrainSkillParameter
    TYPE_ENUM = [
      TYPE_QUERY_ENTITY = 'QUERY_ENTITY'.freeze
    ].freeze

    # **[Required]** Type train skill parameter type.
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Oda::Models::TrainSkillQueryEntityParameter' if type == 'QUERY_ENTITY'
