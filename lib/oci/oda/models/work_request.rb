...
module OCI
  ...
  class Oda::Models::WorkRequest
    REQUEST_ACTION_ENUM = [
      ...
      REQUEST_ACTION_TRAIN_SKILL = 'TRAIN_SKILL'.freeze,
      REQUEST_ACTION_DELETE_SKILL_ENTITIES = 'DELETE_SKILL_ENTITIES'.freeze,
      REQUEST_ACTION_IMPORT_SKILL_ENTITIES = 'IMPORT_SKILL_ENTITIES'.freeze,
