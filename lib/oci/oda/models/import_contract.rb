...
module OCI
  ...
  class Oda::Models::ImportContract
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'import_contract': :'Array<OCI::Oda::Models::ResourceTypeImportContract>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Oda::Models::ResourceTypeImportContract>] :import_contract The value to assign to the {#import_contract} property
