...
module OCI
  ...
  class Oda::Models::CreateWebChannelResult < Oda::Models::CreateChannelResult
    ...
    def hash
      [id, name, description, category, type, session_expiry_duration_in_milliseconds, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, secret_key, max_token_expiration_time_in_minutes, is_client_authentication_enabled, allowed_domains, bot_id].hash
    end
