...
module OCI
  ...
  class Oda::Models::UpdateAppEventChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, outbound_url, event_sink_bot_ids].hash
    end
