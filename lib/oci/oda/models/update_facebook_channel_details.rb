...
module OCI
  ...
  class Oda::Models::UpdateFacebookChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, app_secret, page_access_token, bot_id].hash
    end
