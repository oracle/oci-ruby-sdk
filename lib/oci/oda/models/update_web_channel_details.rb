...
module OCI
  ...
  class Oda::Models::UpdateWebChannelDetails < Oda::Models::UpdateChannelDetails
    ...
    def hash
      [description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, max_token_expiration_time_in_minutes, is_client_authentication_enabled, allowed_domains, bot_id].hash
    end
