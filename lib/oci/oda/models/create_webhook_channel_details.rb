...
module OCI
  ...
  class Oda::Models::CreateWebhookChannelDetails < Oda::Models::CreateChannelDetails
    ...
    def hash
      [name, description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, outbound_url, payload_version, bot_id].hash
    end
