...
module OCI
  ...
  class Oda::Models::RestrictedOperation
    ...
    # @return [String]
    attr_accessor :restricting_service
    ...
    # @option attributes [String] :restricting_service The value to assign to the {#restricting_service} property
    def initialize(attributes = {})
      ...
      self.restricting_service = attributes[:'restrictingService'] if attributes[:'restrictingService']

      raise 'You cannot provide both :restrictingService and :restricting_service' if attributes.key?(:'restrictingService') && attributes.key?(:'restricting_service')

      self.restricting_service = attributes[:'restricting_service'] if attributes[:'restricting_service']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        restricting_service == other.restricting_service
    end
    ...
    def hash
      [operation_name, restricting_service].hash
    end
