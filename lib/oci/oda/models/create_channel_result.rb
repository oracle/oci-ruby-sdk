...
module OCI
  ...
  class Oda::Models::CreateChannelResult
    CATEGORY_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Oda::Models::CreateWebChannelResult' if type == 'WEB'
      return 'OCI::Oda::Models::CreateSlackChannelResult' if type == 'SLACK'
      return 'OCI::Oda::Models::CreateWebhookChannelResult' if type == 'WEBHOOK'
      return 'OCI::Oda::Models::CreateAndroidChannelResult' if type == 'ANDROID'
      return 'OCI::Oda::Models::CreateTwilioChannelResult' if type == 'TWILIO'
      return 'OCI::Oda::Models::CreateCortanaChannelResult' if type == 'CORTANA'
      return 'OCI::Oda::Models::CreateServiceCloudChannelResult' if type == 'SERVICECLOUD'
      return 'OCI::Oda::Models::CreateFacebookChannelResult' if type == 'FACEBOOK'
      return 'OCI::Oda::Models::CreateApplicationChannelResult' if type == 'APPLICATION'
      return 'OCI::Oda::Models::CreateIosChannelResult' if type == 'IOS'
      return 'OCI::Oda::Models::CreateMSTeamsChannelResult' if type == 'MSTEAMS'
      return 'OCI::Oda::Models::CreateAppEventChannelResult' if type == 'APPEVENT'
      return 'OCI::Oda::Models::CreateOsvcChannelResult' if type == 'OSVC'
      return 'OCI::Oda::Models::CreateOSSChannelResult' if type == 'OSS'
      return 'OCI::Oda::Models::CreateTestChannelResult' if type == 'TEST'
