...
module OCI
  ...
  class Oda::Models::CreateDigitalAssistantDetails
    KIND_ENUM = [
      KIND_NEW = 'NEW'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Oda::Models::CreateDigitalAssistantVersionDetails' if type == 'VERSION'
      return 'OCI::Oda::Models::CloneDigitalAssistantDetails' if type == 'CLONE'
      return 'OCI::Oda::Models::CreateNewDigitalAssistantDetails' if type == 'NEW'
      return 'OCI::Oda::Models::ExtendDigitalAssistantDetails' if type == 'EXTEND'
