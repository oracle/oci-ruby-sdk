...
module OCI
  ...
  class Oda::Models::OdaPrivateEndpointAttachmentSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ODA Private Endpoint Attachment.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the attached ODA Instance.
    # @return [String]
    attr_accessor :oda_instance_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ODA Private Endpoint.
    # @return [String]
    attr_accessor :oda_private_endpoint_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that the ODA private endpoint attachment belongs to.
    # @return [String]
    ...
    # @option attributes [String] :oda_private_endpoint_id The value to assign to the {#oda_private_endpoint_id} property
