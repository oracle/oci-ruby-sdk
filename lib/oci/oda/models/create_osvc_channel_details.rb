...
module OCI
  ...
  class Oda::Models::CreateOsvcChannelDetails < Oda::Models::CreateChannelDetails
    ...
    def hash
      [name, description, type, session_expiry_duration_in_milliseconds, freeform_tags, defined_tags, host, port, user_name, password, total_session_count, channel_service, authentication_provider_name, bot_id].hash
    end
