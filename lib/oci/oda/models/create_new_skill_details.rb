...
module OCI
  ...
  class Oda::Models::CreateNewSkillDetails < Oda::Models::CreateSkillDetails
    ...
    def hash
      [kind, category, description, platform_version, dialog_version, multilingual_mode, primary_language_tag, freeform_tags, defined_tags, name, display_name, version, native_language_tags].hash
    end
