...
module OCI
  ...
  class Oda::ManagementClientCompositeOperations
    ...
    # Calls {OCI::Oda::ManagementClient#bulk_create_skill_entities} and then waits for the {OCI::Oda::Models::WorkRequest}
    ...
    # @param [OCI::Oda::Models::BulkCreateSkillEntitiesDetails] bulk_create_skill_entities_details Property values for bulk creating a list of skill entities.
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::ManagementClient#bulk_create_skill_entities}
    ...
    def bulk_create_skill_entities_and_wait_for_state(oda_instance_id, skill_id, bulk_create_skill_entities_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_create_skill_entities(oda_instance_id, skill_id, bulk_create_skill_entities_details, base_operation_opts)
    ...
    # Calls {OCI::Oda::ManagementClient#cascading_delete_skill_custom_entities} and then waits for the {OCI::Oda::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] oda_instance_id Unique Digital Assistant instance identifier.
    # @param [String] skill_id Unique Skill identifier.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Oda::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::ManagementClient#cascading_delete_skill_custom_entities}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Oda::Models::WorkRequest}
    def cascading_delete_skill_custom_entities_and_wait_for_state(oda_instance_id, skill_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.cascading_delete_skill_custom_entities(oda_instance_id, skill_id, base_operation_opts)
      use_util = OCI::Oda::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Oda::ManagementClient#train_skill} and then waits for the {OCI::Oda::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] oda_instance_id Unique Digital Assistant instance identifier.
    # @param [String] skill_id Unique Skill identifier.
    # @param [OCI::Oda::Models::TrainSkillDetails] train_skill_details Metadata for training a skill.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Oda::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Oda::ManagementClient#train_skill}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Oda::Models::WorkRequest}
    def train_skill_and_wait_for_state(oda_instance_id, skill_id, train_skill_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.train_skill(oda_instance_id, skill_id, train_skill_details, base_operation_opts)
      use_util = OCI::Oda::Util.respond_to?(:wait_on_work_request)
