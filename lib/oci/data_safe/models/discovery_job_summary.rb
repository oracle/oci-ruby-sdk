...
module OCI
  ...
  class DataSafe::Models::DiscoveryJobSummary
    ...
    def hash
      [id, display_name, time_started, time_finished, sensitive_data_model_id, target_id, lifecycle_state, discovery_type, compartment_id, freeform_tags, defined_tags].hash
    end
