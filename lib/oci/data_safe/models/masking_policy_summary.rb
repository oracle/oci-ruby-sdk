...
module OCI
  ...
  class DataSafe::Models::MaskingPolicySummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, description, column_source, freeform_tags, defined_tags].hash
    end
