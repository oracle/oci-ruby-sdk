...
module OCI
  ...
  class DataSafe::Models::AlertAggregationItems
    ...
    # @return [OCI::DataSafe::Models::AlertsAggregationDimension]
    ...
    def self.swagger_types
      {
        ...
        'time_ended': :'DateTime',
        'count': :'Integer',
        'dimensions': :'OCI::DataSafe::Models::AlertsAggregationDimension'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::AlertsAggregationDimension] :dimensions The value to assign to the {#dimensions} property
    ...
    def hash
      [metric_name, time_started, time_ended, count, dimensions].hash
    end
