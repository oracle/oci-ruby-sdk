...
module OCI
  ...
  class DataSafe::Models::UpdateTargetDatabaseDetails
    ...
    # @return [OCI::DataSafe::Models::DatabaseDetails]
    attr_accessor :database_details

    # @return [OCI::DataSafe::Models::Credentials]
    attr_accessor :credentials

    # @return [OCI::DataSafe::Models::TlsConfig]
    ...
    # @option attributes [OCI::DataSafe::Models::DatabaseDetails] :database_details The value to assign to the {#database_details} property
    ...
    def hash
      [display_name, description, database_details, credentials, tls_config, connection_option, freeform_tags, defined_tags].hash
    end
