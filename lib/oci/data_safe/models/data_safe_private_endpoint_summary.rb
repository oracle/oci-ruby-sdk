...
module OCI
  ...
  class DataSafe::Models::DataSafePrivateEndpointSummary
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, private_endpoint_id, description, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
