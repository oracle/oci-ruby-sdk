...
module OCI
  ...
  #
  class DataSafe::Models::RegularExpressionFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The pattern that should be used to search for data.
    # @return [String]
    attr_accessor :regular_expression

    # **[Required]** The value that should be used to replace the data matching the regular
    ...
    # @option attributes [String] :replace_with The value to assign to the {#replace_with} property
