...
module OCI
  ...
  #
  class DataSafe::Models::CreateLibraryMaskingFormatDetails
    ...
    def hash
      [display_name, compartment_id, description, sensitive_type_ids, format_entries, freeform_tags, defined_tags].hash
    end
