...
module OCI
  ...
  class DataSafe::Models::UpdateReportDefinitionDetails
    ...
    def hash
      [display_name, description, column_info, column_filters, column_sortings, summary, freeform_tags, defined_tags].hash
    end
