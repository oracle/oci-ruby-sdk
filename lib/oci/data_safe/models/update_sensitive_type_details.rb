...
module OCI
  ...
  class DataSafe::Models::UpdateSensitiveTypeDetails
    ENTITY_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataSafe::Models::UpdateSensitiveCategoryDetails' if type == 'SENSITIVE_CATEGORY'
      return 'OCI::DataSafe::Models::UpdateSensitiveTypePatternDetails' if type == 'SENSITIVE_TYPE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataSafe::Models::UpdateSensitiveTypeDetails'
    end
