...
module OCI
  ...
  class DataSafe::Models::GrantSummary
    PRIVILEGE_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :grant_name

    # The type of a user grant.
    # @return [String]
    attr_reader :privilege_type

    # The privilege category.
    # @return [String]
    attr_reader :privilege_category
    ...
    # @option attributes [String] :grant_name The value to assign to the {#grant_name} property
    # @option attributes [String] :privilege_type The value to assign to the {#privilege_type} property
    # @option attributes [String] :privilege_category The value to assign to the {#privilege_category} property
    # @option attributes [Integer] :depth_level The value to assign to the {#depth_level} property
    ...
    # @param [Object] privilege_type Object to be assigned
    def privilege_type=(privilege_type)
      # rubocop:disable Style/ConditionalAssignment
      if privilege_type && !PRIVILEGE_TYPE_ENUM.include?(privilege_type)
        OCI.logger.debug("Unknown value for 'privilege_type' [" + privilege_type + "]. Mapping to 'PRIVILEGE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @privilege_type = PRIVILEGE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] privilege_category Object to be assigned
    def privilege_category=(privilege_category)
      # rubocop:disable Style/ConditionalAssignment
      if privilege_category && !PRIVILEGE_CATEGORY_ENUM.include?(privilege_category)
        OCI.logger.debug("Unknown value for 'privilege_category' [" + privilege_category + "]. Mapping to 'PRIVILEGE_CATEGORY_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @privilege_category = PRIVILEGE_CATEGORY_UNKNOWN_ENUM_VALUE
      else
