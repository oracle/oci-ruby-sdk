...
module OCI
  ...
  class DataSafe::Models::Report
    ...
    TYPE_ENUM = [
      TYPE_GENERATED = 'GENERATED'.freeze,
      TYPE_SCHEDULED = 'SCHEDULED'.freeze,
    ...
    def hash
      [id, display_name, report_definition_id, description, compartment_id, mime_type, time_generated, lifecycle_state, type, freeform_tags, defined_tags, system_tags].hash
    end
