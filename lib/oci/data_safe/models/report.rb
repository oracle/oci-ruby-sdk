...
module OCI
  ...
  class DataSafe::Models::Report
    MIME_TYPE_ENUM = [
      MIME_TYPE_PDF = 'PDF'.freeze,
      MIME_TYPE_XLS = 'XLS'.freeze,
      MIME_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :report_definition_id The value to assign to the {#report_definition_id} property
    ...
    def initialize(attributes = {})
      ...
      self.report_definition_id = attributes[:'reportDefinitionId'] if attributes[:'reportDefinitionId']

      raise 'You cannot provide both :reportDefinitionId and :report_definition_id' if attributes.key?(:'reportDefinitionId') && attributes.key?(:'report_definition_id')

      self.report_definition_id = attributes[:'report_definition_id'] if attributes[:'report_definition_id']
    ...
    def mime_type=(mime_type)
      ...
      if mime_type && !MIME_TYPE_ENUM.include?(mime_type)
        OCI.logger.debug("Unknown value for 'mime_type' [" + mime_type + "]. Mapping to 'MIME_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @mime_type = MIME_TYPE_UNKNOWN_ENUM_VALUE
      else
        @mime_type = mime_type
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        report_definition_id == other.report_definition_id &&
    ...
    def hash
      [id, display_name, report_definition_id, description, compartment_id, mime_type, time_generated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
