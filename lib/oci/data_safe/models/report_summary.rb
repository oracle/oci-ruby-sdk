...
module OCI
  ...
  class DataSafe::Models::ReportSummary
    MIME_TYPE_ENUM = [
    ...
    def hash
      [display_name, id, report_definition_id, description, mime_type, time_generated, compartment_id, lifecycle_state, freeform_tags, defined_tags].hash
    end
