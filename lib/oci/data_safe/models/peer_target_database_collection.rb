...
module OCI
  ...
  class DataSafe::Models::PeerTargetDatabaseCollection
    # **[Required]** The OCID of the compartment that contains the primary target database.
    # @return [String]
    ...
    # @return [Array<OCI::DataSafe::Models::PeerTargetDatabaseSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DataSafe::Models::PeerTargetDatabaseSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataSafe::Models::PeerTargetDatabaseSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [compartment_id, target_database_id, items].hash
    end
