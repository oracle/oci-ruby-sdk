...
module OCI
  ...
  class DataSafe::Models::TargetDatabase
    ...
    # The OCIDs of associated resources like database, Data Safe private endpoint, etc.
    # @return [Array<OCI::DataSafe::Models::PeerTargetDatabase>]
    attr_accessor :peer_target_databases
    ...
    def self.swagger_types
      {
        ...
        'peer_target_databases': :'Array<OCI::DataSafe::Models::PeerTargetDatabase>',
    ...
    # @option attributes [Array<OCI::DataSafe::Models::PeerTargetDatabase>] :peer_target_databases The value to assign to the {#peer_target_databases} property
    ...
    def initialize(attributes = {})
      ...
      self.peer_target_databases = attributes[:'peerTargetDatabases'] if attributes[:'peerTargetDatabases']

      raise 'You cannot provide both :peerTargetDatabases and :peer_target_databases' if attributes.key?(:'peerTargetDatabases') && attributes.key?(:'peer_target_databases')

      self.peer_target_databases = attributes[:'peer_target_databases'] if attributes[:'peer_target_databases']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        peer_target_databases == other.peer_target_databases &&
    ...
    def hash
      [compartment_id, id, display_name, description, database_details, credentials, tls_config, connection_option, associated_resource_ids, lifecycle_state, lifecycle_details, time_created, time_updated, peer_target_databases, freeform_tags, defined_tags, system_tags].hash
    end
