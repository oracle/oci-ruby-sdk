...
require 'date'
require_relative 'create_column_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details of the sensitive data model to be associated as the column source with a masking policy.
  class DataSafe::Models::CreateColumnSourceFromSdmDetails < DataSafe::Models::CreateColumnSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['columnSource'] = 'SENSITIVE_DATA_MODEL'
    ...
    def hash
      [column_source, sensitive_data_model_id].hash
    end
