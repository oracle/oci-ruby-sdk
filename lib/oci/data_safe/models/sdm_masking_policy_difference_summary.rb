...
module OCI
  ...
  class DataSafe::Models::SdmMaskingPolicyDifferenceSummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_creation_started, sensitive_data_model_id, masking_policy_id, lifecycle_state, difference_type, freeform_tags, defined_tags].hash
    end
