...
module OCI
  ...
  # sensitive types.
  #
  class DataSafe::Models::CreateSensitiveDataModelDetails
    ...
    # **[Required]** The OCID of the reference target database to be associated with the sensitive data model. All operations such
    ...
    def initialize(attributes = {})
      ...
      self.app_suite_name = "GENERIC" if app_suite_name.nil? && !attributes.key?(:'appSuiteName') # rubocop:disable Style/StringLiterals
      ...
      self.app_suite_name = "GENERIC" if app_suite_name.nil? && !attributes.key?(:'appSuiteName') && !attributes.key?(:'app_suite_name') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [display_name, compartment_id, target_id, app_suite_name, description, schemas_for_discovery, sensitive_type_ids_for_discovery, is_sample_data_collection_enabled, is_app_defined_relation_discovery_enabled, is_include_all_schemas, is_include_all_sensitive_types, freeform_tags, defined_tags].hash
    end
