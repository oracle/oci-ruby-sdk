...
module OCI
  ...
  class DataSafe::Models::GenerateHealthReportDetails
    CHECK_TYPE_ENUM = [
    ...
    # @option attributes [String] :check_type The value to assign to the {#check_type} property
    ...
    def check_type=(check_type)
      raise "Invalid value for 'check_type': this must be one of the values in CHECK_TYPE_ENUM." if check_type && !CHECK_TYPE_ENUM.include?(check_type)
