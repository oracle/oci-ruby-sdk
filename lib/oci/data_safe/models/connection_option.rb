...
module OCI
  ...
  class DataSafe::Models::ConnectionOption
    CONNECTION_TYPE_ENUM = [
      CONNECTION_TYPE_PRIVATE_ENDPOINT = 'PRIVATE_ENDPOINT'.freeze,
      CONNECTION_TYPE_ONPREM_CONNECTOR = 'ONPREM_CONNECTOR'.freeze,
      CONNECTION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The connection type used to connect to the database. Allowed values:
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataSafe::Models::PrivateEndpoint' if type == 'PRIVATE_ENDPOINT'
      return 'OCI::DataSafe::Models::OnPremiseConnector' if type == 'ONPREM_CONNECTOR'
