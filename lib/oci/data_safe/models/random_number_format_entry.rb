...
module OCI
  ...
  # documentation.
  #
  class DataSafe::Models::RandomNumberFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The lower bound of the range within which random numbers should be
    ...
    # **[Required]** The upper bound of the range within which random numbers should be
    ...
    # @option attributes [Integer] :start_value The value to assign to the {#start_value} property
    # @option attributes [Integer] :end_value The value to assign to the {#end_value} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'RANDOM_NUMBER'
