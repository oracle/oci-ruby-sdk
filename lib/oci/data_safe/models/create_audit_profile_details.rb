...
module OCI
  ...
  class DataSafe::Models::CreateAuditProfileDetails
    ...
    def hash
      [display_name, compartment_id, target_id, description, is_paid_usage_enabled, freeform_tags, defined_tags].hash
    end
