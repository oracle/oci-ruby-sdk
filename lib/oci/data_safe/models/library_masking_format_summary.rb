...
module OCI
  ...
  class DataSafe::Models::LibraryMaskingFormatSummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, description, sensitive_type_ids, source, freeform_tags, defined_tags].hash
    end
