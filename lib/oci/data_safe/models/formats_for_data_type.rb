...
module OCI
  ...
  class DataSafe::Models::FormatsForDataType
    # **[Required]** The data type category, which can be one of the following -
    ...
    # @return [Array<OCI::DataSafe::Models::FormatSummary>]
    ...
    # @option attributes [Array<OCI::DataSafe::Models::FormatSummary>] :masking_formats The value to assign to the {#masking_formats} property
    ...
    def hash
      [data_type, masking_formats].hash
    end
