...
module OCI
  ...
  class DataSafe::Models::AlertsAggregationDimension
    ...
    # @option attributes [Hash<String, String>] :group_by The value to assign to the {#group_by} property
