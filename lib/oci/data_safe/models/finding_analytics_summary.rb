...
module OCI
  ...
  #
  class DataSafe::Models::FindingAnalyticsSummary
    METRIC_NAME_ENUM = [
      METRIC_NAME_TOP_FINDING_STATS = 'TOP_FINDING_STATS'.freeze,
      METRIC_NAME_FINDING_STATS = 'FINDING_STATS'.freeze,
    ...
    # @return [OCI::DataSafe::Models::FindingAnalyticsDimensions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'metric_name': :'String',
        'dimensions': :'OCI::DataSafe::Models::FindingAnalyticsDimensions',
        'count': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::FindingAnalyticsDimensions] :dimensions The value to assign to the {#dimensions} property
