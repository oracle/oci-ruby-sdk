...
module OCI
  ...
  #
  class DataSafe::Models::SecurityPolicyDeploymentSummary
    ...
    def hash
      [id, compartment_id, display_name, description, target_id, security_policy_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
