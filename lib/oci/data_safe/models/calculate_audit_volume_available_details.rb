...
module OCI
  ...
  class DataSafe::Models::CalculateAuditVolumeAvailableDetails
    ...
    # @option attributes [Array<String>] :trail_locations The value to assign to the {#trail_locations} property
    def initialize(attributes = {})
      ...
      self.trail_locations = attributes[:'trailLocations'] if attributes[:'trailLocations']

      raise 'You cannot provide both :trailLocations and :trail_locations' if attributes.key?(:'trailLocations') && attributes.key?(:'trail_locations')

      self.trail_locations = attributes[:'trail_locations'] if attributes[:'trail_locations']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        trail_locations == other.trail_locations
    end
    ...
    def hash
      [audit_collection_start_time, trail_locations].hash
    end
