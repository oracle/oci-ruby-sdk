...
module OCI
  ...
  class DataSafe::Models::ScheduleReportDetails
    MIME_TYPE_ENUM = [
    ...
    # **[Required]** The schedule to generate the report periodically in the specified format:
    ...
    # **[Required]** Specifies if the report will be in Excel or PDF format
    # @return [String]
    ...
    # @return [OCI::DataSafe::Models::ReportDetails]
    ...
    # @option attributes [OCI::DataSafe::Models::ReportDetails] :report_details The value to assign to the {#report_details} property
