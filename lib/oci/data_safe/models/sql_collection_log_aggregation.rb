...
module OCI
  ...
  class DataSafe::Models::SqlCollectionLogAggregation
    ...
    # @return [OCI::DataSafe::Models::SqlCollectionLogDimensions]
    ...
    def self.swagger_types
      {
        ...
        'time_ended': :'DateTime',
        'count': :'Integer',
        'dimensions': :'OCI::DataSafe::Models::SqlCollectionLogDimensions'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::SqlCollectionLogDimensions] :dimensions The value to assign to the {#dimensions} property
