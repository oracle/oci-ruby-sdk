...
module OCI
  ...
  class DataSafe::Models::GenerateSecurityAssessmentReportDetails
    FORMAT_ENUM = [
      FORMAT_PDF = 'PDF'.freeze,
      FORMAT_XLS = 'XLS'.freeze
    ].freeze
    ...
    def initialize(attributes = {})
      ...
      self.format = "PDF" if format.nil? && !attributes.key?(:'format') # rubocop:disable Style/StringLiterals
    end
