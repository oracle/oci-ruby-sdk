...
module OCI
  ...
  #
  class DataSafe::Models::AuditPolicySummary
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, time_updated, lifecycle_state, lifecycle_details, target_id, is_data_safe_service_account_excluded, audit_specifications, time_last_provisioned, time_last_retrieved, freeform_tags, defined_tags].hash
    end
