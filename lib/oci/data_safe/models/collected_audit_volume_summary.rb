...
module OCI
  ...
  class DataSafe::Models::CollectedAuditVolumeSummary
    # **[Required]** The OCID of the audit profile resource.
    # @return [String]
    attr_accessor :audit_profile_id

    # **[Required]** Represents the month under consideration in which the aggregated audit data volume collected by Data Safe is displayed.
    ...
    # @option attributes [Integer] :online_volume The value to assign to the {#online_volume} property
    # @option attributes [Integer] :archived_volume The value to assign to the {#archived_volume} property
