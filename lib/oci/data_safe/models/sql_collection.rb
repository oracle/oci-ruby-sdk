...
module OCI
  ...
  #
  class DataSafe::Models::SqlCollection
    STATUS_ENUM = [
    ...
    def hash
      [id, compartment_id, display_name, description, target_id, status, db_user_name, time_last_started, time_last_stopped, sql_level, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
