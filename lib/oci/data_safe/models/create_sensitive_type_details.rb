...
module OCI
  ...
  class DataSafe::Models::CreateSensitiveTypeDetails
    ENTITY_TYPE_ENUM = [
      ENTITY_TYPE_SENSITIVE_TYPE = 'SENSITIVE_TYPE'.freeze,
      ENTITY_TYPE_SENSITIVE_CATEGORY = 'SENSITIVE_CATEGORY'.freeze
    ].freeze

    # **[Required]** The entity type. It can be either a sensitive type with regular expressions or a sensitive category used for
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataSafe::Models::CreateSensitiveCategoryDetails' if type == 'SENSITIVE_CATEGORY'
      return 'OCI::DataSafe::Models::CreateSensitiveTypePatternDetails' if type == 'SENSITIVE_TYPE'
    ...
    # @option attributes [String] :parent_category_id The value to assign to the {#parent_category_id} property
    ...
    def hash
      [entity_type, display_name, compartment_id, short_name, description, parent_category_id, freeform_tags, defined_tags].hash
    end
