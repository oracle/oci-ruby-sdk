...
module OCI
  ...
  class DataSafe::Models::DiscoveryJobResultSummary
    ...
    def hash
      [key, discovery_type, sensitive_columnkey, schema_name, object_name, column_name, object_type, data_type, sensitive_type_id, parent_column_keys, relation_type, estimated_data_value_count, sample_data_values, planned_action, is_result_applied, discovery_job_id].hash
    end
