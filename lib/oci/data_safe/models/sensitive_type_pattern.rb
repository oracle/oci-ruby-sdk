...
module OCI
  ...
  class DataSafe::Models::SensitiveTypePattern < DataSafe::Models::SensitiveType
    SEARCH_TYPE_ENUM = [
    ...
    def search_type=(search_type)
      ...
      if search_type && !SEARCH_TYPE_ENUM.include?(search_type)
        OCI.logger.debug("Unknown value for 'search_type' [" + search_type + "]. Mapping to 'SEARCH_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @search_type = SEARCH_TYPE_UNKNOWN_ENUM_VALUE
      else
