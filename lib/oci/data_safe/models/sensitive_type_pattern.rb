...
module OCI
  ...
  class DataSafe::Models::SensitiveTypePattern < DataSafe::Models::SensitiveType
    ...
    def hash
      [id, entity_type, display_name, compartment_id, lifecycle_state, short_name, source, time_created, time_updated, description, parent_category_id, is_common, freeform_tags, defined_tags, system_tags, name_pattern, comment_pattern, data_pattern, search_type, default_masking_format_id].hash
    end
