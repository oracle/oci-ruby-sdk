...
module OCI
  ...
  class DataSafe::Models::DiscoveryAnalyticsSummary
    METRIC_NAME_ENUM = [
      METRIC_NAME_SENSITIVE_DATA_MODEL = 'SENSITIVE_DATA_MODEL'.freeze,
      METRIC_NAME_SENSITIVE_TYPE = 'SENSITIVE_TYPE'.freeze,
      METRIC_NAME_SENSITIVE_SCHEMA = 'SENSITIVE_SCHEMA'.freeze,
      METRIC_NAME_SENSITIVE_TABLE = 'SENSITIVE_TABLE'.freeze,
      METRIC_NAME_SENSITIVE_COLUMN = 'SENSITIVE_COLUMN'.freeze,
      METRIC_NAME_SENSITIVE_DATA_VALUE = 'SENSITIVE_DATA_VALUE'.freeze,
    ...
    # @return [OCI::DataSafe::Models::Dimensions]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'metric_name': :'String',
        'dimensions': :'OCI::DataSafe::Models::Dimensions',
        'count': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataSafe::Models::Dimensions] :dimensions The value to assign to the {#dimensions} property
