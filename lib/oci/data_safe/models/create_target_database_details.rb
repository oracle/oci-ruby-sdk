...
module OCI
  ...
  class DataSafe::Models::CreateTargetDatabaseDetails
    ...
    # @return [Array<OCI::DataSafe::Models::CreatePeerTargetDatabaseDetails>]
    attr_accessor :peer_target_database_details
    ...
    # @option attributes [Array<OCI::DataSafe::Models::CreatePeerTargetDatabaseDetails>] :peer_target_database_details The value to assign to the {#peer_target_database_details} property
    ...
    def initialize(attributes = {})
      ...
      self.peer_target_database_details = attributes[:'peerTargetDatabaseDetails'] if attributes[:'peerTargetDatabaseDetails']

      raise 'You cannot provide both :peerTargetDatabaseDetails and :peer_target_database_details' if attributes.key?(:'peerTargetDatabaseDetails') && attributes.key?(:'peer_target_database_details')

      self.peer_target_database_details = attributes[:'peer_target_database_details'] if attributes[:'peer_target_database_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        peer_target_database_details == other.peer_target_database_details &&
    ...
    def hash
      [compartment_id, display_name, description, database_details, credentials, tls_config, connection_option, peer_target_database_details, freeform_tags, defined_tags].hash
    end
