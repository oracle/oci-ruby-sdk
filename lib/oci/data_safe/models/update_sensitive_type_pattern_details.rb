...
require 'date'
require_relative 'update_sensitive_type_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details to update a sensitive type with regular expressions.
  class DataSafe::Models::UpdateSensitiveTypePatternDetails < DataSafe::Models::UpdateSensitiveTypeDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#display_name #display_name} proprety
    # @option attributes [String] :short_name The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#short_name #short_name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#description #description} proprety
    # @option attributes [String] :parent_category_id The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#parent_category_id #parent_category_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::DataSafe::Models::UpdateSensitiveTypeDetails#defined_tags #defined_tags} proprety
