...
module OCI
  ...
  #
  class DataSafe::Models::SecurityPolicySummary
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
