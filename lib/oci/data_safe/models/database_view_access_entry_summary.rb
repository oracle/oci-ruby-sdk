...
module OCI
  ...
  class DataSafe::Models::DatabaseViewAccessEntrySummary
    ACCESS_TYPE_ENUM = [
    ...
    def hash
      [key, grantee, grant_from_role, access_type, privilege, target_id, privilege_grantable, privilege_type, table_schema, table_name, view_schema, view_name, view_text, column_name, grantor, is_access_constrained_by_database_vault, is_access_constrained_by_virtual_private_database, is_access_constrained_by_redaction, is_access_constrained_by_real_application_security, is_access_constrained_by_sql_firewall].hash
    end
