...
module OCI
  ...
  class DataSafe::Models::CreateColumnSourceFromTargetDetails < DataSafe::Models::CreateColumnSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['columnSource'] = 'TARGET'
