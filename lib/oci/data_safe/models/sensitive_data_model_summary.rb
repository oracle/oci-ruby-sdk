...
module OCI
  ...
  class DataSafe::Models::SensitiveDataModelSummary
    ...
    def hash
      [id, display_name, compartment_id, target_id, time_created, time_updated, lifecycle_state, app_suite_name, description, freeform_tags, defined_tags].hash
    end
