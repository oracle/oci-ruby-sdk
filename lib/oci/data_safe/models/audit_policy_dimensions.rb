...
module OCI
  ...
  class DataSafe::Models::AuditPolicyDimensions
    ...
    def audit_policy_category=(audit_policy_category)
      raise "Invalid value for 'audit_policy_category': this must be one of the values in AUDIT_POLICY_CATEGORY_ENUM." if audit_policy_category && !AUDIT_POLICY_CATEGORY_ENUM.include?(audit_policy_category)
    ...
    def hash
      [audit_policy_category, audit_policy_name].hash
    end
