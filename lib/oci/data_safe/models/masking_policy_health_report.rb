...
module OCI
  ...
  class DataSafe::Models::MaskingPolicyHealthReport
    ...
    # **[Required]** The date and time the report was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    # @return [DateTime]
    ...
    # **[Required]** Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)
    #
    ...
    def hash
      [id, masking_policy_id, target_id, compartment_id, display_name, time_created, time_updated, lifecycle_state, description, freeform_tags, defined_tags].hash
    end
