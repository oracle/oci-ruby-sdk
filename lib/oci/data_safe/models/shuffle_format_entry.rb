...
module OCI
  ...
  #
  class DataSafe::Models::ShuffleFormatEntry < DataSafe::Models::FormatEntry
    ...
    # @option attributes [Array<String>] :grouping_columns The value to assign to the {#grouping_columns} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'SHUFFLE'
      ...
      self.grouping_columns = attributes[:'groupingColumns'] if attributes[:'groupingColumns']

      raise 'You cannot provide both :groupingColumns and :grouping_columns' if attributes.key?(:'groupingColumns') && attributes.key?(:'grouping_columns')

      self.grouping_columns = attributes[:'grouping_columns'] if attributes[:'grouping_columns']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        grouping_columns == other.grouping_columns
    end
    ...
    def hash
      [type, description, grouping_columns].hash
    end
