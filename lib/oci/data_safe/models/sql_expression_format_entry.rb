...
module OCI
  ...
  #
  class DataSafe::Models::SQLExpressionFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The SQL expression to be used to generate the masked values. It can
    ...
    # @option attributes [String] :sql_expression The value to assign to the {#sql_expression} property
