...
module OCI
  ...
  class DataSafe::Models::EntryDetails
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'entryType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::DataSafe::Models::FirewallPolicyEntryDetails' if type == 'FIREWALL_POLICY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataSafe::Models::EntryDetails'
    end
    ...
    # @option attributes [String] :entry_type The value to assign to the {#entry_type} property
    ...
    def entry_type=(entry_type)
      ...
      if entry_type && !ENTRY_TYPE_ENUM.include?(entry_type)
        OCI.logger.debug("Unknown value for 'entry_type' [" + entry_type + "]. Mapping to 'ENTRY_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @entry_type = ENTRY_TYPE_UNKNOWN_ENUM_VALUE
      else
