...
module OCI
  ...
  class DataSafe::Models::SecurityFeatureAnalyticsSummary
    METRIC_NAME_ENUM = [
      METRIC_NAME_SECURITY_FEATURE_STATS = 'SECURITY_FEATURE_STATS'.freeze,
    ...
    # @return [OCI::DataSafe::Models::SecurityFeatureAnalyticsDimensions]
    ...
    # @option attributes [OCI::DataSafe::Models::SecurityFeatureAnalyticsDimensions] :dimensions The value to assign to the {#dimensions} property
