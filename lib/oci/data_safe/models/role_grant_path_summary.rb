...
module OCI
  ...
  class DataSafe::Models::RoleGrantPathSummary
    ...
    # @option attributes [String] :granted_role The value to assign to the {#granted_role} property
    ...
    def initialize(attributes = {})
      ...
      self.granted_role = attributes[:'grantedRole'] if attributes[:'grantedRole']

      raise 'You cannot provide both :grantedRole and :granted_role' if attributes.key?(:'grantedRole') && attributes.key?(:'granted_role')

      self.granted_role = attributes[:'granted_role'] if attributes[:'granted_role']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        granted_role == other.granted_role &&
    ...
    def hash
      [key, grantee, granted_role, depth_level].hash
    end
