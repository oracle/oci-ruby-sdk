...
module OCI
  ...
  class DataSafe::Models::PeerTargetDatabaseSummary
    ...
    # **[Required]** The secondary id assigned for the peer target database in Data Safe.
    # @return [Integer]
    attr_accessor :key
    ...
    def hash
      [display_name, description, key, role, database_unique_name, dataguard_association_id, time_created, lifecycle_state, lifecycle_details].hash
    end
