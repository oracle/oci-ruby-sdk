...
module OCI
  ...
  class DataSafe::Models::TargetAlertPolicyAssociationSummary
    ...
    def hash
      [id, display_name, description, policy_id, target_id, is_enabled, compartment_id, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags].hash
    end
