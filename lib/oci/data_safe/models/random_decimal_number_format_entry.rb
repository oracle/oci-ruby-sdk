...
module OCI
  ...
  #
  class DataSafe::Models::RandomDecimalNumberFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The lower bound of the range within which random decimal numbers should
    ...
    # **[Required]** The upper bound of the range within which random decimal numbers should be
    ...
    # @option attributes [Float] :start_value The value to assign to the {#start_value} property
    # @option attributes [Float] :end_value The value to assign to the {#end_value} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'RANDOM_DECIMAL_NUMBER'
      ...
      self.start_value = attributes[:'startValue'] if attributes[:'startValue']

      raise 'You cannot provide both :startValue and :start_value' if attributes.key?(:'startValue') && attributes.key?(:'start_value')

      self.start_value = attributes[:'start_value'] if attributes[:'start_value']
    ...
    def hash
      [type, description, start_value, end_value].hash
    end
