...
module OCI
  ...
  class DataSafe::Models::OnPremConnector
    ...
    def hash
      [id, display_name, compartment_id, description, time_created, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, available_version, created_version].hash
    end
