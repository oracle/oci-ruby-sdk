...
module OCI
  ...
  #
  class DataSafe::Models::SubstringFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The starting position in the original string from where the substring
    ...
    # **[Required]** The number of characters that should be there in the substring. It should
    ...
    # @option attributes [Integer] :start_position The value to assign to the {#start_position} property
