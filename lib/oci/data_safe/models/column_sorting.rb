...
module OCI
  ...
  class DataSafe::Models::ColumnSorting
    ...
    # @option attributes [Integer] :sorting_order The value to assign to the {#sorting_order} property
