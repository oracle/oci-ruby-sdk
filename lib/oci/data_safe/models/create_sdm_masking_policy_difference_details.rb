...
module OCI
  ...
  class DataSafe::Models::CreateSdmMaskingPolicyDifferenceDetails
    ...
    # **[Required]** The OCID of the masking policy. Note that if the masking policy is not associated with an SDM, CreateSdmMaskingPolicyDifference
    ...
    def initialize(attributes = {})
      ...
      self.difference_type = "ALL" if difference_type.nil? && !attributes.key?(:'differenceType') # rubocop:disable Style/StringLiterals
      ...
      self.difference_type = "ALL" if difference_type.nil? && !attributes.key?(:'differenceType') && !attributes.key?(:'difference_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [difference_type, masking_policy_id, compartment_id, display_name, freeform_tags, defined_tags].hash
    end
