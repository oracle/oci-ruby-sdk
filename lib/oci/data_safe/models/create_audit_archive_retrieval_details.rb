...
module OCI
  ...
  class DataSafe::Models::CreateAuditArchiveRetrievalDetails
    ...
    def hash
      [display_name, description, compartment_id, target_id, start_date, end_date, freeform_tags, defined_tags].hash
    end
