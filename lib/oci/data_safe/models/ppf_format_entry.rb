...
module OCI
  ...
  #
  class DataSafe::Models::PPFFormatEntry < DataSafe::Models::FormatEntry
    # **[Required]** The post processing function in SCHEMA_NAME.PACKAGE_NAME.FUNCTION_NAME
    # format. It can be a standalone or packaged function, so PACKAGE_NAME
    # is optional.
    #
    # @return [String]
    attr_accessor :post_processing_function
    ...
    # @option attributes [String] :post_processing_function The value to assign to the {#post_processing_function} property
