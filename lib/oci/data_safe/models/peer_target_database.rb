...
module OCI
  ...
  class DataSafe::Models::PeerTargetDatabase
    ...
    # @return [String]
    attr_accessor :dataguard_association_id
    ...
    # @option attributes [Integer] :key The value to assign to the {#key} property
    # @option attributes [String] :dataguard_association_id The value to assign to the {#dataguard_association_id} property
    ...
    def initialize(attributes = {})
      ...
      self.dataguard_association_id = attributes[:'dataguardAssociationId'] if attributes[:'dataguardAssociationId']

      raise 'You cannot provide both :dataguardAssociationId and :dataguard_association_id' if attributes.key?(:'dataguardAssociationId') && attributes.key?(:'dataguard_association_id')

      self.dataguard_association_id = attributes[:'dataguard_association_id'] if attributes[:'dataguard_association_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        key == other.key &&
        dataguard_association_id == other.dataguard_association_id &&
    ...
    def hash
      [display_name, description, key, dataguard_association_id, time_created, role, database_unique_name, database_details, tls_config, lifecycle_state, lifecycle_details].hash
    end
