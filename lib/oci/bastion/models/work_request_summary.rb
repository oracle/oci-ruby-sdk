...
module OCI
  ...
  class Bastion::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Bastion::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Bastion::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Bastion::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
