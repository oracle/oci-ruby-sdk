...
module OCI
  ...
  class Bastion::Models::CreatePortForwardingSessionTargetResourceDetails < Bastion::Models::CreateSessionTargetResourceDetails
    ...
    # @return [String]
    attr_accessor :target_resource_fqdn
    ...
    # @option attributes [String] :target_resource_fqdn The value to assign to the {#target_resource_fqdn} property
    ...
    def initialize(attributes = {})
      ...
      self.target_resource_fqdn = attributes[:'targetResourceFqdn'] if attributes[:'targetResourceFqdn']

      raise 'You cannot provide both :targetResourceFqdn and :target_resource_fqdn' if attributes.key?(:'targetResourceFqdn') && attributes.key?(:'target_resource_fqdn')

      self.target_resource_fqdn = attributes[:'target_resource_fqdn'] if attributes[:'target_resource_fqdn']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        target_resource_fqdn == other.target_resource_fqdn &&
    ...
    def hash
      [session_type, target_resource_id, target_resource_private_ip_address, target_resource_fqdn, target_resource_port].hash
    end
