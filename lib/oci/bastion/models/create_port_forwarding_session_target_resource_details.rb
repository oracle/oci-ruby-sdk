...
require 'date'
require_relative 'create_session_target_resource_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details about a port forwarding session for a target resource.
  class Bastion::Models::CreatePortForwardingSessionTargetResourceDetails < Bastion::Models::CreateSessionTargetResourceDetails
    ...
    # @option attributes [Integer] :target_resource_port The value to assign to the {OCI::Bastion::Models::CreateSessionTargetResourceDetails#target_resource_port #target_resource_port} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['sessionType'] = 'PORT_FORWARDING'
    ...
    def hash
      [session_type, target_resource_port, target_resource_id, target_resource_private_ip_address].hash
    end
