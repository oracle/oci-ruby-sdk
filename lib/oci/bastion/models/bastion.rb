...
module OCI
  ...
  class Bastion::Models::Bastion
    ...
    # @option attributes [String] :dns_proxy_status The value to assign to the {#dns_proxy_status} property
    ...
    # @param [Object] dns_proxy_status Object to be assigned
    def dns_proxy_status=(dns_proxy_status)
      # rubocop:disable Style/ConditionalAssignment
      if dns_proxy_status && !DNS_PROXY_STATUS_ENUM.include?(dns_proxy_status)
        OCI.logger.debug("Unknown value for 'dns_proxy_status' [" + dns_proxy_status + "]. Mapping to 'DNS_PROXY_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @dns_proxy_status = DNS_PROXY_STATUS_UNKNOWN_ENUM_VALUE
      else
