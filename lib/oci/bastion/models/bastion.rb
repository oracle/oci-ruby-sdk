...
module OCI
  ...
  class Bastion::Models::Bastion
    ...
    # @return [Integer]
    attr_accessor :max_session_ttl_in_seconds

    # The maximum number of active sessions allowed on the bastion.
    # @return [Integer]
    attr_accessor :max_sessions_allowed

    # **[Required]** The time the bastion was created. Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    ...
    # @option attributes [String] :bastion_type The value to assign to the {#bastion_type} property
    # @option attributes [String] :id The value to assign to the {#id} property
    # @option attributes [String] :name The value to assign to the {#name} property
    # @option attributes [String] :compartment_id The value to assign to the {#compartment_id} property
    # @option attributes [String] :target_vcn_id The value to assign to the {#target_vcn_id} property
    # @option attributes [String] :target_subnet_id The value to assign to the {#target_subnet_id} property
    # @option attributes [String] :phone_book_entry The value to assign to the {#phone_book_entry} property
    # @option attributes [Array<String>] :client_cidr_block_allow_list The value to assign to the {#client_cidr_block_allow_list} property
    # @option attributes [Array<String>] :static_jump_host_ip_addresses The value to assign to the {#static_jump_host_ip_addresses} property
    # @option attributes [String] :private_endpoint_ip_address The value to assign to the {#private_endpoint_ip_address} property
    # @option attributes [Integer] :max_session_ttl_in_seconds The value to assign to the {#max_session_ttl_in_seconds} property
    # @option attributes [Integer] :max_sessions_allowed The value to assign to the {#max_sessions_allowed} property
