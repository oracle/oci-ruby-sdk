...
module OCI
  ...
  class Bastion::Models::CreateSessionDetails
    KEY_TYPE_ENUM = [
    ...
    # @return [OCI::Bastion::Models::CreateSessionTargetResourceDetails]
    ...
    # @option attributes [OCI::Bastion::Models::CreateSessionTargetResourceDetails] :target_resource_details The value to assign to the {#target_resource_details} property
    ...
    def key_type=(key_type)
      raise "Invalid value for 'key_type': this must be one of the values in KEY_TYPE_ENUM." if key_type && !KEY_TYPE_ENUM.include?(key_type)
