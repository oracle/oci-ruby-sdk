...
module OCI
  ...
  class Bastion::Models::CreateBastionDetails
    ...
    def hash
      [bastion_type, name, compartment_id, target_subnet_id, phone_book_entry, static_jump_host_ip_addresses, client_cidr_block_allow_list, max_session_ttl_in_seconds, freeform_tags, defined_tags].hash
    end
