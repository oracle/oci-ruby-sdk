...
module OCI
  ...
  class Bastion::Models::CreateBastionDetails
    ...
    def dns_proxy_status=(dns_proxy_status)
      raise "Invalid value for 'dns_proxy_status': this must be one of the values in DNS_PROXY_STATUS_ENUM." if dns_proxy_status && !DNS_PROXY_STATUS_ENUM.include?(dns_proxy_status)
    ...
    def hash
      [bastion_type, name, compartment_id, target_subnet_id, phone_book_entry, static_jump_host_ip_addresses, client_cidr_block_allow_list, max_session_ttl_in_seconds, dns_proxy_status, freeform_tags, defined_tags].hash
    end
