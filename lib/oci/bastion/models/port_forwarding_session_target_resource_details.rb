...
module OCI
  ...
  class Bastion::Models::PortForwardingSessionTargetResourceDetails < Bastion::Models::TargetResourceDetails
    ...
    def hash
      [session_type, target_resource_port, target_resource_id, target_resource_private_ip_address, target_resource_display_name].hash
    end
