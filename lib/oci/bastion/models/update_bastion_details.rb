...
module OCI
  ...
  class Bastion::Models::UpdateBastionDetails
    ...
    def hash
      [max_session_ttl_in_seconds, static_jump_host_ip_addresses, client_cidr_block_allow_list, freeform_tags, defined_tags].hash
    end
