...
module OCI
  ...
  class ServiceMesh::Models::IngressGateway
    ...
    # **[Required]** Array of hostnames and their listener configuration that this gateway will bind to.
    # @return [Array<OCI::ServiceMesh::Models::IngressGatewayHost>]
    attr_accessor :hosts

    # @return [OCI::ServiceMesh::Models::IngressGatewayMutualTransportLayerSecurity]
    attr_accessor :mtls
    ...
    def self.swagger_types
      {
        ...
        'mtls': :'OCI::ServiceMesh::Models::IngressGatewayMutualTransportLayerSecurity',
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::IngressGatewayHost>] :hosts The value to assign to the {#hosts} property
    # @option attributes [OCI::ServiceMesh::Models::IngressGatewayMutualTransportLayerSecurity] :mtls The value to assign to the {#mtls} property
    ...
    def hash
      [id, name, description, mesh_id, compartment_id, time_created, time_updated, hosts, mtls, access_logging, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
