...
module OCI
  ...
  class ServiceMesh::Models::VirtualDeploymentSummary
    ...
    def hash
      [id, name, description, compartment_id, virtual_service_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
