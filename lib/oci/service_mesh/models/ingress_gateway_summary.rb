...
module OCI
  ...
  class ServiceMesh::Models::IngressGatewaySummary
    ...
    def hash
      [id, name, description, compartment_id, time_created, time_updated, mesh_id, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
