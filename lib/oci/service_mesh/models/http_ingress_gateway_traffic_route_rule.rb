...
require 'date'
require 'logger'
require_relative 'ingress_gateway_traffic_route_rule'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Rule for routing incoming ingress gateway traffic with HTTP protocol
  class ServiceMesh::Models::HttpIngressGatewayTrafficRouteRule < ServiceMesh::Models::IngressGatewayTrafficRouteRule
    PATH_TYPE_ENUM = [
    ...
    # @option attributes [OCI::ServiceMesh::Models::IngressGatewayHostRef] :ingress_gateway_host The value to assign to the {OCI::ServiceMesh::Models::IngressGatewayTrafficRouteRule#ingress_gateway_host #ingress_gateway_host} proprety
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRuleTarget>] :destinations The value to assign to the {OCI::ServiceMesh::Models::IngressGatewayTrafficRouteRule#destinations #destinations} proprety
    ...
    # @option attributes [BOOLEAN] :is_host_rewrite_enabled The value to assign to the {#is_host_rewrite_enabled} property
    # @option attributes [BOOLEAN] :is_path_rewrite_enabled The value to assign to the {#is_path_rewrite_enabled} property
