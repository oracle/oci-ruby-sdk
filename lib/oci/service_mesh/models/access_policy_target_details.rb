...
module OCI
  ...
  class ServiceMesh::Models::AccessPolicyTargetDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ServiceMesh::Models::ExternalServiceAccessPolicyTargetDetails' if type == 'EXTERNAL_SERVICE'
      return 'OCI::ServiceMesh::Models::VirtualServiceAccessPolicyTargetDetails' if type == 'VIRTUAL_SERVICE'
      return 'OCI::ServiceMesh::Models::AllVirtualServicesAccessPolicyTargetDetails' if type == 'ALL_VIRTUAL_SERVICES'
      return 'OCI::ServiceMesh::Models::IngressGatewayAccessPolicyTargetDetails' if type == 'INGRESS_GATEWAY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ServiceMesh::Models::AccessPolicyTargetDetails'
    end
