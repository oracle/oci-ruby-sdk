...
module OCI
  ...
  class ServiceMesh::Models::IngressGatewayHost
    # **[Required]** A user-friendly name for the host. The name must be unique within the same ingress gateway.
    ...
    # @return [Array<OCI::ServiceMesh::Models::IngressGatewayListener>]
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::IngressGatewayListener>] :listeners The value to assign to the {#listeners} property
