...
module OCI
  ...
  class ServiceMesh::Models::VirtualServiceRouteTable
    ...
    # @return [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRule>]
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'priority': :'Integer',
        'route_rules': :'Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRule>',
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRule>] :route_rules The value to assign to the {#route_rules} property
    ...
    def hash
      [id, compartment_id, virtual_service_id, name, description, priority, route_rules, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
