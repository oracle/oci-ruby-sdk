...
module OCI
  ...
  class ServiceMesh::Models::UpdateVirtualServiceDetails
    ...
    # @return [OCI::ServiceMesh::Models::VirtualServiceMutualTransportLayerSecurityDetails]
    attr_accessor :mtls
    ...
    # @option attributes [OCI::ServiceMesh::Models::VirtualServiceMutualTransportLayerSecurityDetails] :mtls The value to assign to the {#mtls} property
