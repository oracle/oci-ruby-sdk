...
require 'date'
require_relative 'ingress_gateway_traffic_route_rule_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Rule for routing incoming ingress gateway traffic with HTTP protocol
  class ServiceMesh::Models::HttpIngressGatewayTrafficRouteRuleDetails < ServiceMesh::Models::IngressGatewayTrafficRouteRuleDetails
    PATH_TYPE_ENUM = [
    ...
    # @option attributes [OCI::ServiceMesh::Models::IngressGatewayHostRef] :ingress_gateway_host The value to assign to the {OCI::ServiceMesh::Models::IngressGatewayTrafficRouteRuleDetails#ingress_gateway_host #ingress_gateway_host} proprety
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRuleTargetDetails>] :destinations The value to assign to the {OCI::ServiceMesh::Models::IngressGatewayTrafficRouteRuleDetails#destinations #destinations} proprety
    ...
    def path_type=(path_type)
      raise "Invalid value for 'path_type': this must be one of the values in PATH_TYPE_ENUM." if path_type && !PATH_TYPE_ENUM.include?(path_type)
    ...
    def hash
      [type, ingress_gateway_host, destinations, path, path_type, is_grpc, is_host_rewrite_enabled, is_path_rewrite_enabled, request_timeout_in_ms].hash
    end
