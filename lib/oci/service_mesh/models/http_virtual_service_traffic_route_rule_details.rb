...
require 'date'
require_relative 'virtual_service_traffic_route_rule_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Rule for routing incoming Virtual Service traffic with HTTP protocol
  class ServiceMesh::Models::HttpVirtualServiceTrafficRouteRuleDetails < ServiceMesh::Models::VirtualServiceTrafficRouteRuleDetails
    PATH_TYPE_ENUM = [
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualDeploymentTrafficRuleTargetDetails>] :destinations The value to assign to the {OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRuleDetails#destinations #destinations} proprety
