...
module OCI
  ...
  class ServiceMesh::Models::CreateVirtualServiceRouteTableDetails
    ...
    # @return [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRuleDetails>]
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualServiceTrafficRouteRuleDetails>] :route_rules The value to assign to the {#route_rules} property
