...
module OCI
  ...
  class ServiceMesh::Models::VirtualDeploymentListener
    ...
    # @return [Integer]
    attr_accessor :idle_timeout_in_ms
    ...
    # @option attributes [Integer] :idle_timeout_in_ms The value to assign to the {#idle_timeout_in_ms} property
    def initialize(attributes = {})
      ...
      self.idle_timeout_in_ms = attributes[:'idleTimeoutInMs'] if attributes[:'idleTimeoutInMs']
      ...
      self.idle_timeout_in_ms = attributes[:'idle_timeout_in_ms'] if attributes[:'idle_timeout_in_ms']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        idle_timeout_in_ms == other.idle_timeout_in_ms
    end
    ...
    def hash
      [protocol, port, request_timeout_in_ms, idle_timeout_in_ms].hash
    end
