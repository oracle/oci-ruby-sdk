...
module OCI
  ...
  class ServiceMesh::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::ServiceMesh::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
