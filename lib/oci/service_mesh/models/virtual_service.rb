...
module OCI
  ...
  class ServiceMesh::Models::VirtualService
    ...
    # @return [OCI::ServiceMesh::Models::MutualTransportLayerSecurity]
    attr_accessor :mtls
    ...
    # @option attributes [OCI::ServiceMesh::Models::MutualTransportLayerSecurity] :mtls The value to assign to the {#mtls} property
    ...
    def hash
      [id, compartment_id, mesh_id, name, description, default_routing_policy, hosts, mtls, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
