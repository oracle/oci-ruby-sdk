...
module OCI
  ...
  class ServiceMesh::Models::VirtualServiceRouteTableSummary
    ...
    def hash
      [id, virtual_service_id, name, description, compartment_id, priority, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
