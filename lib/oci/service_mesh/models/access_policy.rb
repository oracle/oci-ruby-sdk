...
module OCI
  ...
  class ServiceMesh::Models::AccessPolicy
    ...
    # @return [Array<OCI::ServiceMesh::Models::AccessPolicyRule>]
    attr_accessor :rules
    ...
    def self.swagger_types
      {
        ...
        'rules': :'Array<OCI::ServiceMesh::Models::AccessPolicyRule>',
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::AccessPolicyRule>] :rules The value to assign to the {#rules} property
    ...
    def hash
      [id, name, description, mesh_id, compartment_id, rules, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
