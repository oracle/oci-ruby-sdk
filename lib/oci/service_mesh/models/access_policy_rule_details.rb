...
module OCI
  # Access policy rule.
  class ServiceMesh::Models::AccessPolicyRuleDetails
    ACTION_ENUM = [
    ...
    # @return [OCI::ServiceMesh::Models::AccessPolicyTargetDetails]
    ...
    # @option attributes [OCI::ServiceMesh::Models::AccessPolicyTargetDetails] :source The value to assign to the {#source} property
    # @option attributes [OCI::ServiceMesh::Models::AccessPolicyTargetDetails] :destination The value to assign to the {#destination} property
