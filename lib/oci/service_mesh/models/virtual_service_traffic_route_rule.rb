...
module OCI
  ...
  class ServiceMesh::Models::VirtualServiceTrafficRouteRule
    TYPE_ENUM = [
    ...
    # @return [Array<OCI::ServiceMesh::Models::VirtualDeploymentTrafficRuleTarget>]
    ...
    # @option attributes [Array<OCI::ServiceMesh::Models::VirtualDeploymentTrafficRuleTarget>] :destinations The value to assign to the {#destinations} property
