...
module OCI
  # Access policy rule.
  class ServiceMesh::Models::AccessPolicyRule
    ACTION_ENUM = [
    ...
    # @return [OCI::ServiceMesh::Models::AccessPolicyTarget]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'action': :'String',
        'source': :'OCI::ServiceMesh::Models::AccessPolicyTarget',
        'destination': :'OCI::ServiceMesh::Models::AccessPolicyTarget'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ServiceMesh::Models::AccessPolicyTarget] :source The value to assign to the {#source} property
    # @option attributes [OCI::ServiceMesh::Models::AccessPolicyTarget] :destination The value to assign to the {#destination} property
    ...
    def hash
      [action, source, destination].hash
    end
