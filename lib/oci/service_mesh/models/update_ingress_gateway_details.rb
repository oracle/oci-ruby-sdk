...
module OCI
  ...
  class ServiceMesh::Models::UpdateIngressGatewayDetails
    ...
    # @return [OCI::ServiceMesh::Models::IngressGatewayMutualTransportLayerSecurityDetails]
    attr_accessor :mtls
    ...
    # @option attributes [OCI::ServiceMesh::Models::IngressGatewayMutualTransportLayerSecurityDetails] :mtls The value to assign to the {#mtls} property
