...
module OCI
  ...
  class ServiceMesh::Models::VirtualDeploymentTrafficRuleTarget < ServiceMesh::Models::TrafficRuleTarget
    # **[Required]** The OCID of the virtual deployment where the request will be routed.
    # @return [String]
    attr_accessor :virtual_deployment_id
    ...
    # @option attributes [String] :virtual_deployment_id The value to assign to the {#virtual_deployment_id} property
