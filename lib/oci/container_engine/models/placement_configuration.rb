...
module OCI
  ...
  class ContainerEngine::Models::PlacementConfiguration
    ...
    # @option attributes [Array<String>] :fault_domain The value to assign to the {#fault_domain} property
    ...
    def hash
      [availability_domain, fault_domain, subnet_id].hash
    end
