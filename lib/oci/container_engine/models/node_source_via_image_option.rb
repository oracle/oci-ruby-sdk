...
require 'date'
require_relative 'node_source_option'
...
module OCI
  ...
  #
  class ContainerEngine::Models::NodeSourceViaImageOption < ContainerEngine::Models::NodeSourceOption
    ...
    # @option attributes [String] :source_name The value to assign to the {OCI::ContainerEngine::Models::NodeSourceOption#source_name #source_name} proprety
    ...
    def hash
      [source_type, source_name, image_id].hash
    end
