...
module OCI
  ...
  class ContainerEngine::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
      ...
      ACTION_TYPE_CANCELED_CREATE = 'CANCELED_CREATE'.freeze,
      ACTION_TYPE_CANCELED_UPDATE = 'CANCELED_UPDATE'.freeze,
      ACTION_TYPE_CANCELED_DELETE = 'CANCELED_DELETE'.freeze,
