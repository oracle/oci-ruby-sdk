...
module OCI
  ...
  class ContainerEngine::Models::PreemptionAction
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ContainerEngine::Models::TerminatePreemptionAction' if type == 'TERMINATE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ContainerEngine::Models::PreemptionAction'
    end
