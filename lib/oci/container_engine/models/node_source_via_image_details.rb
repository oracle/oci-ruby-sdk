...
require 'date'
require_relative 'node_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details of the image running on the node.
  class ContainerEngine::Models::NodeSourceViaImageDetails < ContainerEngine::Models::NodeSourceDetails
    ...
    def hash
      [source_type, image_id, boot_volume_size_in_gbs].hash
    end
