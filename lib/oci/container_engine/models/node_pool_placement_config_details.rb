...
module OCI
  ...
  class ContainerEngine::Models::NodePoolPlacementConfigDetails
    ...
    # @return [OCI::ContainerEngine::Models::PreemptibleNodeConfigDetails]
    attr_accessor :preemptible_node_config
    ...
    # @option attributes [OCI::ContainerEngine::Models::PreemptibleNodeConfigDetails] :preemptible_node_config The value to assign to the {#preemptible_node_config} property
