...
module OCI
  ...
  class ContainerEngine::Models::UpdateVirtualNodePoolDetails
    ...
    def hash
      [display_name, initial_virtual_node_labels, taints, size, placement_configurations, nsg_ids, pod_configuration, freeform_tags, defined_tags, virtual_node_tags].hash
    end
