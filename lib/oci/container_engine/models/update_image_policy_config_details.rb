...
module OCI
  ...
  class ContainerEngine::Models::UpdateImagePolicyConfigDetails
    ...
    # @return [Array<OCI::ContainerEngine::Models::KeyDetails>]
    ...
    # @option attributes [Array<OCI::ContainerEngine::Models::KeyDetails>] :key_details The value to assign to the {#key_details} property
