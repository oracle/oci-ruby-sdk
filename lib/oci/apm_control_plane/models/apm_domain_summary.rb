...
module OCI
  ...
  class ApmControlPlane::Models::ApmDomainSummary
    ...
    def hash
      [id, display_name, description, compartment_id, lifecycle_state, is_free_tier, time_created, time_updated, freeform_tags, defined_tags].hash
    end
