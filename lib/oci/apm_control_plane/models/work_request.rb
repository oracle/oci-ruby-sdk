...
module OCI
  ...
  class ApmControlPlane::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_UPDATE_APM_DOMAIN = 'UPDATE_APM_DOMAIN'.freeze,
      OPERATION_TYPE_DELETE_APM_DOMAIN = 'DELETE_APM_DOMAIN'.freeze,
      OPERATION_TYPE_GENERATE_DATA_KEYS = 'GENERATE_DATA_KEYS'.freeze,
      OPERATION_TYPE_REMOVE_DATA_KEYS = 'REMOVE_DATA_KEYS'.freeze,
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::ApmControlPlane::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::ApmControlPlane::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
