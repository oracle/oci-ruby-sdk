...
module OCI
  ...
  class VbsInst::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_VBS_INSTANCE = 'CREATE_VBS_INSTANCE'.freeze,
      OPERATION_TYPE_UPDATE_VBS_INSTANCE = 'UPDATE_VBS_INSTANCE'.freeze,
      OPERATION_TYPE_DELETE_VBS_INSTANCE = 'DELETE_VBS_INSTANCE'.freeze,
      OPERATION_TYPE_MOVE_VBS_INSTANCE = 'MOVE_VBS_INSTANCE'.freeze,
    ...
    # @return [Array<OCI::VbsInst::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::VbsInst::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::VbsInst::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
