...
module OCI
  ...
  #
  class LoadBalancer::Models::CreateRoutingPolicyDetails
    CONDITION_LANGUAGE_VERSION_ENUM = [
      CONDITION_LANGUAGE_VERSION_V1 = 'V1'.freeze
    ].freeze

    # **[Required]** The name for this list of routing rules. It must be unique and it cannot be changed. Avoid entering
