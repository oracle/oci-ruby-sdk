...
module OCI
  ...
  class LoadBalancer::Models::UpdatePathRouteSetDetails # rubocop:disable Metrics/LineLength
    ...
    def initialize(attributes = {})
      ...
      self.path_routes = attributes[:'pathRoutes'] if attributes[:'pathRoutes']

      raise 'You cannot provide both :pathRoutes and :path_routes' if attributes.key?(:'pathRoutes') && attributes.key?(:'path_routes')

      self.path_routes = attributes[:'path_routes'] if attributes[:'path_routes']
    end
