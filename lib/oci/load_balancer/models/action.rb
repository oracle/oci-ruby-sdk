...
module OCI
  ...
  class LoadBalancer::Models::Action
    NAME_ENUM = [
      NAME_FORWARD_TO_BACKENDSET = 'FORWARD_TO_BACKENDSET'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::LoadBalancer::Models::ForwardToBackendSet' if type == 'FORWARD_TO_BACKENDSET'
