...
module OCI
  ...
  #
  class LoadBalancer::Models::AddHttpRequestHeaderRule < LoadBalancer::Models::Rule # rubocop:disable Metrics/LineLength
    ...
    def initialize(attributes = {})
      ...
      attributes['action'] = 'ADD_HTTP_REQUEST_HEADER'
