...
module OCI
  ...
  class LoadBalancer::Models::CreateBackendSetDetails
    ...
    #
    # @return [Integer]
    attr_accessor :backend_max_connections
    ...
    # @option attributes [Integer] :backend_max_connections The value to assign to the {#backend_max_connections} property
    ...
    def hash
      [name, policy, backends, backend_max_connections, health_checker, ssl_configuration, session_persistence_configuration, lb_cookie_session_persistence_configuration].hash
    end
