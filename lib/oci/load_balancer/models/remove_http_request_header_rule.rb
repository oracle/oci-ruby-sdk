...
module OCI
  ...
  #
  class LoadBalancer::Models::RemoveHttpRequestHeaderRule < LoadBalancer::Models::Rule # rubocop:disable Metrics/LineLength
    ...
    def initialize(attributes = {})
      ...
      attributes['action'] = 'REMOVE_HTTP_REQUEST_HEADER'
