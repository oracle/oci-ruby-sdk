...
module OCI
  ...
  #
  class LoadBalancer::Models::RoutingRule
    ...
    #
    # @return [Array<OCI::LoadBalancer::Models::Action>]
    ...
    # @option attributes [Array<OCI::LoadBalancer::Models::Action>] :actions The value to assign to the {#actions} property
