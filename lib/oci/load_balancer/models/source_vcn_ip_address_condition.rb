...
module OCI
  ...
  #
  class LoadBalancer::Models::SourceVcnIpAddressCondition < LoadBalancer::Models::RuleCondition
    # **[Required]** An IPv4 address range that the original client IP address (in the context of the specified VCN) of an
    ...
    def initialize(attributes = {})
      ...
      attributes['attributeName'] = 'SOURCE_VCN_IP_ADDRESS'
