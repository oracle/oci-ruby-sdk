...
module OCI
  ...
  #
  class LoadBalancer::Models::PathMatchCondition < LoadBalancer::Models::RuleCondition
    OPERATOR_ENUM = [
    ...
    # **[Required]** A string that specifies how to compare the PathMatchCondition object's `attributeValue` string to the
    # incoming URI.
    #
