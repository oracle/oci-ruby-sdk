...
module OCI
  ...
  #
  class LoadBalancer::Models::ExtendHttpRequestHeaderValueRule < LoadBalancer::Models::Rule # rubocop:disable Metrics/LineLength
    ...
    def initialize(attributes = {})
      ...
      attributes['action'] = 'EXTEND_HTTP_REQUEST_HEADER_VALUE'
