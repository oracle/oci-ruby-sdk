...
module OCI
  ...
  # *  You can specify this rule only with the {#rule_condition rule_condition}
  #    type `PATH`.
  ...
  #   original path.
  #
  class LoadBalancer::Models::RedirectRule < LoadBalancer::Models::Rule
    ...
    # @option attributes [OCI::LoadBalancer::Models::RedirectUri] :redirect_uri The value to assign to the {#redirect_uri} property
