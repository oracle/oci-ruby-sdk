...
module OCI
  ...
  #
  class LoadBalancer::Models::RoutingPolicy
    CONDITION_LANGUAGE_VERSION_ENUM = [
      CONDITION_LANGUAGE_VERSION_V1 = 'V1'.freeze,
      CONDITION_LANGUAGE_VERSION_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_reader :condition_language_version

    # **[Required]** The ordered list of routing rules.
    # @return [Array<OCI::LoadBalancer::Models::RoutingRule>]
    attr_accessor :rules
    ...
    # @option attributes [String] :condition_language_version The value to assign to the {#condition_language_version} property
    # @option attributes [Array<OCI::LoadBalancer::Models::RoutingRule>] :rules The value to assign to the {#rules} property
    ...
    # @param [Object] condition_language_version Object to be assigned
    def condition_language_version=(condition_language_version)
      # rubocop:disable Style/ConditionalAssignment
      if condition_language_version && !CONDITION_LANGUAGE_VERSION_ENUM.include?(condition_language_version)
        OCI.logger.debug("Unknown value for 'condition_language_version' [" + condition_language_version + "]. Mapping to 'CONDITION_LANGUAGE_VERSION_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @condition_language_version = CONDITION_LANGUAGE_VERSION_UNKNOWN_ENUM_VALUE
      else
