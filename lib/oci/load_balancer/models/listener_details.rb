...
module OCI
  ...
  class LoadBalancer::Models::ListenerDetails
    ...
    def hash
      [default_backend_set_name, port, protocol, hostname_names, path_route_set_name, ssl_configuration, connection_configuration, routing_policy_name, rule_set_names].hash
    end
