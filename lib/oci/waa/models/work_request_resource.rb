...
module OCI
  ...
  class Waa::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** The way in which this resource is affected by the work tracked in the WorkRequest.
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource the WorkRequest affects.
    # @return [String]
