...
module OCI
  ...
  class Waa::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_WAA_POLICY = 'CREATE_WAA_POLICY'.freeze,
      OPERATION_TYPE_UPDATE_WAA_POLICY = 'UPDATE_WAA_POLICY'.freeze,
      OPERATION_TYPE_DELETE_WAA_POLICY = 'DELETE_WAA_POLICY'.freeze,
      OPERATION_TYPE_MOVE_WAA_POLICY = 'MOVE_WAA_POLICY'.freeze,
      OPERATION_TYPE_CREATE_WEB_APP_ACCELERATION = 'CREATE_WEB_APP_ACCELERATION'.freeze,
      OPERATION_TYPE_UPDATE_WEB_APP_ACCELERATION = 'UPDATE_WEB_APP_ACCELERATION'.freeze,
      OPERATION_TYPE_DELETE_WEB_APP_ACCELERATION = 'DELETE_WEB_APP_ACCELERATION'.freeze,
      OPERATION_TYPE_MOVE_WEB_APP_ACCELERATION = 'MOVE_WEB_APP_ACCELERATION'.freeze,
      OPERATION_TYPE_PURGE_WEB_APP_ACCELERATION_CACHE = 'PURGE_WEB_APP_ACCELERATION_CACHE'.freeze,
    ...
    # @return [Array<OCI::Waa::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Waa::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Waa::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
