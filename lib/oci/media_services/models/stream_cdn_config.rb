...
module OCI
  ...
  class MediaServices::Models::StreamCdnConfig
    ...
    def hash
      [id, display_name, compartment_id, distribution_channel_id, is_enabled, config, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags, system_tags].hash
    end
