...
module OCI
  ...
  class MediaServices::Models::StreamCdnConfig
    ...
    # @return [OCI::MediaServices::Models::StreamCdnConfigSection]
    ...
    def self.swagger_types
      {
        ...
        'is_enabled': :'BOOLEAN',
        'config': :'OCI::MediaServices::Models::StreamCdnConfigSection',
    ...
    # @option attributes [OCI::MediaServices::Models::StreamCdnConfigSection] :config The value to assign to the {#config} property
    ...
    def hash
      [id, display_name, compartment_id, distribution_channel_id, is_enabled, config, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags, system_tags, locks].hash
    end
