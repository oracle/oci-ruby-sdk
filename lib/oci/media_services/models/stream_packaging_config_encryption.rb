...
module OCI
  ...
  class MediaServices::Models::StreamPackagingConfigEncryption
    ALGORITHM_ENUM = [
      ALGORITHM_NONE = 'NONE'.freeze,
      ALGORITHM_AES128 = 'AES128'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'algorithm'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::MediaServices::Models::StreamPackagingConfigEncryptionAes128' if type == 'AES128'
      return 'OCI::MediaServices::Models::StreamPackagingConfigEncryptionNone' if type == 'NONE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::MediaServices::Models::StreamPackagingConfigEncryption'
    end
