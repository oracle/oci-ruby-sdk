...
require 'date'
require_relative 'ingest_stream_distribution_channel_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Asset Metadata entry information.
  class MediaServices::Models::AssetMetadataEntryDetails < MediaServices::Models::IngestStreamDistributionChannelDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['ingestPayloadType'] = 'ASSET_METADATA_MEDIA_ASSET'
    ...
    def hash
      [ingest_payload_type, media_asset_id, compartment_id].hash
    end
