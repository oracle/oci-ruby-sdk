...
module OCI
  ...
  class MediaServices::Models::MediaWorkflowConfiguration
    ...
    # **[Required]** Reuseable parameter values encoded as a JSON; the top and second level JSON elements are
    ...
    def hash
      [id, display_name, compartment_id, parameters, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags, system_tags, locks].hash
    end
