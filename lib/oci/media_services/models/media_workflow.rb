...
module OCI
  ...
  class MediaServices::Models::MediaWorkflow
    ...
    # **[Required]** The processing to be done in this workflow. Each key of the MediaWorkflowTasks in this array is unique
    ...
    #
    # @return [Array<OCI::MediaServices::Models::MediaWorkflowTask>]
    attr_accessor :tasks
    ...
    # @option attributes [Array<OCI::MediaServices::Models::MediaWorkflowTask>] :tasks The value to assign to the {#tasks} property
    ...
    def hash
      [id, display_name, compartment_id, tasks, media_workflow_configuration_ids, parameters, time_created, time_updated, lifecycle_state, lifecyle_details, version, locks, freeform_tags, defined_tags, system_tags].hash
    end
