...
module OCI
  ...
  class MediaServices::Models::MediaWorkflow
    ...
    def hash
      [id, display_name, compartment_id, tasks, media_workflow_configuration_ids, parameters, time_created, time_updated, lifecycle_state, lifecyle_details, version, freeform_tags, defined_tags, system_tags].hash
    end
