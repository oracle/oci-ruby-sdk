...
module OCI
  ...
  class MediaServices::Models::StreamDistributionChannelSummary
    ...
    def hash
      [id, display_name, compartment_id, domain_name, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags, locks].hash
    end
