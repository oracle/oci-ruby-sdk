...
require 'date'
require_relative 'stream_packaging_config_encryption'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # AES128 encryption type (enabled by default).
  class MediaServices::Models::StreamPackagingConfigEncryptionAes128 < MediaServices::Models::StreamPackagingConfigEncryption
