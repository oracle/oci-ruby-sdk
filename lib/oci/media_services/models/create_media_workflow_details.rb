...
module OCI
  ...
  class MediaServices::Models::CreateMediaWorkflowDetails
    ...
    def hash
      [display_name, compartment_id, tasks, media_workflow_configuration_ids, parameters, freeform_tags, defined_tags, locks].hash
    end
