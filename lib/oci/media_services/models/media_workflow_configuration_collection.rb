...
module OCI
  ...
  class MediaServices::Models::MediaWorkflowConfigurationCollection
    # **[Required]** List of the mediaWorkflowConfigurationSummary objects.
    # @return [Array<OCI::MediaServices::Models::MediaWorkflowConfigurationSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::MediaServices::Models::MediaWorkflowConfigurationSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::MediaServices::Models::MediaWorkflowConfigurationSummary>] :items The value to assign to the {#items} property
