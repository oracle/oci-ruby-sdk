...
module OCI
  ...
  class MediaServices::Models::StreamPackagingConfigSummary
    ...
    def hash
      [id, compartment_id, distribution_channel_id, display_name, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags, locks].hash
    end
