...
module OCI
  ...
  class MediaServices::Models::UpdateMediaAssetDetails
    TYPE_ENUM = [
    ...
    def hash
      [display_name, type, parent_media_asset_id, master_media_asset_id, metadata, media_asset_tags, freeform_tags, defined_tags].hash
    end
