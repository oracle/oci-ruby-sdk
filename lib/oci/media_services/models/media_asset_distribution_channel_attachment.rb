...
module OCI
  ...
  class MediaServices::Models::MediaAssetDistributionChannelAttachment
    ...
    def hash
      [distribution_channel_id, display_name, version, lifecycle_state, metadata_ref, media_workflow_job_id, locks].hash
    end
