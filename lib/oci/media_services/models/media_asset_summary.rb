...
module OCI
  ...
  class MediaServices::Models::MediaAssetSummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, lifecycle_state, type, time_updated, master_media_asset_id, parent_media_asset_id, freeform_tags, defined_tags, system_tags].hash
    end
