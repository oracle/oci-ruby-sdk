...
module OCI
  ...
  class MediaServices::Models::StreamCdnConfigSummary
    ...
    def hash
      [id, display_name, compartment_id, distribution_channel_id, is_enabled, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, locks].hash
    end
