...
module OCI
  ...
  class MediaServices::Models::MediaWorkflowConfigurationSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, locks].hash
    end
