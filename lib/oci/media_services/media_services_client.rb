...
module OCI
  ...
  class MediaServices::MediaServicesClient
    ...
    # @param [String] media_workflow_job_id Unique MediaWorkflowJob identifier.
    # @param [Integer] key Identifier of the MediaWorkflowJobFact within a MediaWorkflowJob.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::MediaServices::Models::MediaWorkflowJobFact MediaWorkflowJobFact}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mediaservices/get_media_workflow_job_fact.rb.html) to see an example of how to use get_media_workflow_job_fact API.
    def get_media_workflow_job_fact(media_workflow_job_id, key, opts = {})
      logger.debug 'Calling operation MediaServicesClient#get_media_workflow_job_fact.' if logger

      raise "Missing the required parameter 'media_workflow_job_id' when calling get_media_workflow_job_fact." if media_workflow_job_id.nil?
      raise "Missing the required parameter 'key' when calling get_media_workflow_job_fact." if key.nil?
      raise "Parameter value for 'media_workflow_job_id' must not be blank" if OCI::Internal::Util.blank_string?(media_workflow_job_id)
      raise "Parameter value for 'key' must not be blank" if OCI::Internal::Util.blank_string?(key)

      path = '/mediaWorkflowJobs/{mediaWorkflowJobId}/facts/{key}'.sub('{mediaWorkflowJobId}', media_workflow_job_id.to_s).sub('{key}', key.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'MediaServicesClient#get_media_workflow_job_fact') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::MediaServices::Models::MediaWorkflowJobFact'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :key Filter by MediaWorkflowJob ID and MediaWorkflowJobFact key.
    #    (default to 0)
    # @option opts [String] :type Types of details to include.
    #   Allowed values are: runnableJob, taskDeclaration, workflow, configuration, parameterResolutionEvent
    # @option opts [String] :sort_by Types of details to include. (default to key)
    # @option opts [String] :sort_order The sort order to use, either 'ASC' or 'DESC'.
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the
    #   `opc-next-page` header field of a previous response.
    #    (default to )
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::MediaServices::Models::MediaWorkflowJobFactCollection MediaWorkflowJobFactCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/mediaservices/list_media_workflow_job_facts.rb.html) to see an example of how to use list_media_workflow_job_facts API.
    def list_media_workflow_job_facts(media_workflow_job_id, opts = {})
      logger.debug 'Calling operation MediaServicesClient#list_media_workflow_job_facts.' if logger

      raise "Missing the required parameter 'media_workflow_job_id' when calling list_media_workflow_job_facts." if media_workflow_job_id.nil?

      if opts[:type] && !%w[runnableJob taskDeclaration workflow configuration parameterResolutionEvent].include?(opts[:type])
        raise 'Invalid value for "type", must be one of runnableJob, taskDeclaration, workflow, configuration, parameterResolutionEvent.'
      end

      if opts[:sort_by] && !OCI::MediaServices::Models::MEDIA_WORKFLOW_JOB_FACT_SORT_BY_ENUM.include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of the values in OCI::MediaServices::Models::MEDIA_WORKFLOW_JOB_FACT_SORT_BY_ENUM.'
      end
      ...
      path = '/mediaWorkflowJobs/{mediaWorkflowJobId}/facts'.sub('{mediaWorkflowJobId}', media_workflow_job_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'MediaServicesClient#list_media_workflow_job_facts') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::MediaServices::Models::MediaWorkflowJobFactCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
