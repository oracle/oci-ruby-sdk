...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::VmClusterTargetSummary < FleetSoftwareUpdate::Models::TargetDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['entityType'] = 'VMCLUSTER'
    ...
    def hash
      [entity_type, id, compartment_id, infrastructure_id].hash
    end
