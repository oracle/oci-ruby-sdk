...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreateFsuCycleDetails
    TYPE_ENUM = [
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::CreateBatchingStrategyDetails]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::CreatePatchFsuCycle' if type == 'PATCH'
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::CreateBatchingStrategyDetails] :batching_strategy The value to assign to the {#batching_strategy} property
    # @option attributes [OCI::FleetSoftwareUpdate::Models::CreateScheduleDetails] :stage_action_schedule The value to assign to the {#stage_action_schedule} property
    # @option attributes [OCI::FleetSoftwareUpdate::Models::CreateScheduleDetails] :apply_action_schedule The value to assign to the {#apply_action_schedule} property
    ...
    def hash
      [display_name, compartment_id, type, fsu_collection_id, goal_version_details, batching_strategy, stage_action_schedule, apply_action_schedule, freeform_tags, defined_tags].hash
    end
