...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuCollection
    TYPE_ENUM = [
      TYPE_DB = 'DB'.freeze,
      TYPE_GI = 'GI'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GiCollection' if type == 'GI'
      return 'OCI::FleetSoftwareUpdate::Models::DbCollection' if type == 'DB'
