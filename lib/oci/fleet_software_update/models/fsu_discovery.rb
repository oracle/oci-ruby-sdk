...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::FsuDiscovery
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::DiscoveryDetails]
    attr_accessor :details

    # **[Required]** The date and time the Exadata Fleet Update Discovery was created, as described in
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::FleetSoftwareUpdate::Models::DiscoveryDetails',
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::DiscoveryDetails] :details The value to assign to the {#details} property
    ...
    def hash
      [id, display_name, compartment_id, details, time_created, time_updated, time_finished, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
