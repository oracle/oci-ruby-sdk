...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::ImageIdFsuTargetDetails < FleetSoftwareUpdate::Models::FsuGoalVersionDetails
    ...
    def hash
      [type, home_policy, new_home_prefix, software_image_id].hash
    end
