...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::DiscoveryDetailsSummary
    TYPE_ENUM = [
      TYPE_DB = 'DB'.freeze,
      TYPE_GI = 'GI'.freeze,
    ...
    # @option attributes [String] :criteria The value to assign to the {#criteria} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] criteria Object to be assigned
    def criteria=(criteria)
      # rubocop:disable Style/ConditionalAssignment
      if criteria && !CRITERIA_ENUM.include?(criteria)
        OCI.logger.debug("Unknown value for 'criteria' [" + criteria + "]. Mapping to 'CRITERIA_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @criteria = CRITERIA_UNKNOWN_ENUM_VALUE
      else
        @criteria = criteria
      end
      # rubocop:enable Style/ConditionalAssignment
