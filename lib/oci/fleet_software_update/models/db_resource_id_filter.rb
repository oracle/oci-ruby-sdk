...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::DbResourceIdFilter < FleetSoftwareUpdate::Models::DbFleetDiscoveryFilter
    ENTITY_TYPE_ENUM = [
      ENTITY_TYPE_DATABASESOFTWAREIMAGE = 'DATABASESOFTWAREIMAGE'.freeze,
      ENTITY_TYPE_DBHOME = 'DBHOME'.freeze,
