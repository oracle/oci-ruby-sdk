...
require 'date'
require_relative 'create_schedule_details'
...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::CreateStartTimeScheduleDetails < FleetSoftwareUpdate::Models::CreateScheduleDetails
    # **[Required]** The date and time the Exadata Fleet Update Action is expected to start.
    # [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
    #
    # @return [DateTime]
    attr_accessor :time_to_start
    ...
    # @option attributes [DateTime] :time_to_start The value to assign to the {#time_to_start} property
