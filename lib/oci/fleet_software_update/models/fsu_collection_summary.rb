...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuCollectionSummary
    TYPE_ENUM = [
      TYPE_DB = 'DB'.freeze,
      TYPE_GI = 'GI'.freeze,
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::ActiveCycleDetails]
    attr_accessor :active_fsu_cycle
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GiFsuCollectionSummary' if type == 'GI'
      return 'OCI::FleetSoftwareUpdate::Models::DbFsuCollectionSummary' if type == 'DB'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::FsuCollectionSummary'
    end
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::ActiveCycleDetails] :active_fsu_cycle The value to assign to the {#active_fsu_cycle} property
    ...
    def initialize(attributes = {})
      ...
      self.active_fsu_cycle = attributes[:'activeFsuCycle'] if attributes[:'activeFsuCycle']

      raise 'You cannot provide both :activeFsuCycle and :active_fsu_cycle' if attributes.key?(:'activeFsuCycle') && attributes.key?(:'active_fsu_cycle')

      self.active_fsu_cycle = attributes[:'active_fsu_cycle'] if attributes[:'active_fsu_cycle']
    ...
    def hash
      [id, display_name, type, service_type, compartment_id, active_fsu_cycle, target_count, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
