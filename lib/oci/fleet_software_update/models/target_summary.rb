...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::TargetSummary
    STATUS_ENUM = [
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::TargetDetails]
    ...
    #
    # @return [String]
    attr_accessor :executing_fsu_job_id

    # Active Exadata Fleet Update Cycle OCID. Null if no Cycle is active that has this target as member.
    #
    # @return [String]
    attr_accessor :active_fsu_cycle_id

    # @return [OCI::FleetSoftwareUpdate::Models::TargetProgressSummary]
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::TargetDetails] :target The value to assign to the {#target} property
    # @option attributes [String] :current_version The value to assign to the {#current_version} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [String] :executing_fsu_job_id The value to assign to the {#executing_fsu_job_id} property
    # @option attributes [String] :active_fsu_cycle_id The value to assign to the {#active_fsu_cycle_id} property
    # @option attributes [OCI::FleetSoftwareUpdate::Models::TargetProgressSummary] :progress The value to assign to the {#progress} property
