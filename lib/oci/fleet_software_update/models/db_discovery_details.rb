...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::DbDiscoveryDetails < FleetSoftwareUpdate::Models::DiscoveryDetails
    ...
    # **[Required]** Database Major Version of targets to be included in the Exadata Fleet Update Discovery results.
    ...
    def self.swagger_types
      {
        ...
        'criteria': :'OCI::FleetSoftwareUpdate::Models::DbFleetDiscoveryDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :service_type The value to assign to the {OCI::FleetSoftwareUpdate::Models::DiscoveryDetails#service_type #service_type} proprety
    # @option attributes [String] :source_major_version The value to assign to the {#source_major_version} property
    # @option attributes [OCI::FleetSoftwareUpdate::Models::DbFleetDiscoveryDetails] :criteria The value to assign to the {#criteria} property
    ...
    def hash
      [type, service_type, source_major_version, criteria].hash
    end
