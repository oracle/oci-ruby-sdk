...
module OCI
  ...
  class FleetSoftwareUpdate::Models::UpdateFsuCycleDetails
    TYPE_ENUM = [
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::UpdateBatchingStrategyDetails]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::UpdatePatchFsuCycle' if type == 'PATCH'
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::UpdateBatchingStrategyDetails] :batching_strategy The value to assign to the {#batching_strategy} property
    ...
    def hash
      [display_name, type, goal_version_details, batching_strategy, freeform_tags, defined_tags].hash
    end
