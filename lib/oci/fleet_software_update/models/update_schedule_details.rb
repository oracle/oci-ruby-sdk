...
module OCI
  ...
  class FleetSoftwareUpdate::Models::UpdateScheduleDetails
    TYPE_ENUM = [
      TYPE_START_TIME = 'START_TIME'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::NoneScheduleDetails' if type == 'NONE'
      return 'OCI::FleetSoftwareUpdate::Models::UpdateStartTimeScheduleDetails' if type == 'START_TIME'
