...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    #
    # @return [Array<OCI::FleetSoftwareUpdate::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::FleetSoftwareUpdate::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::FleetSoftwareUpdate::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
