...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuJob
    TYPE_ENUM = [
    ...
    # @return [OCI::FleetSoftwareUpdate::Models::JobProgressDetails]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::ApplyFsuJob' if type == 'APPLY'
      return 'OCI::FleetSoftwareUpdate::Models::StageFsuJob' if type == 'STAGE'
      return 'OCI::FleetSoftwareUpdate::Models::PrecheckFsuJob' if type == 'PRECHECK'
      return 'OCI::FleetSoftwareUpdate::Models::RollbackFsuJob' if type == 'ROLLBACK_AND_REMOVE_TARGET'
      return 'OCI::FleetSoftwareUpdate::Models::CleanupFsuJob' if type == 'CLEANUP'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetSoftwareUpdate::Models::FsuJob'
    end
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::JobProgressDetails] :progress The value to assign to the {#progress} property
