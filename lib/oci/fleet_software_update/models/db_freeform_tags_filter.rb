...
require 'date'
require 'logger'
require_relative 'db_fleet_discovery_filter'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Freeform tags to include in the discovery.
  #
  class FleetSoftwareUpdate::Models::DbFreeformTagsFilter < FleetSoftwareUpdate::Models::DbFleetDiscoveryFilter
    OPERATOR_ENUM = [
    ...
    #
    # @return [Array<OCI::FleetSoftwareUpdate::Models::FreeformTagFilterEntry>]
    attr_accessor :tags
    ...
    def self.swagger_types
      {
        ...
        'type': :'String',
        'mode': :'String',
        'tags': :'Array<OCI::FleetSoftwareUpdate::Models::FreeformTagFilterEntry>',
        'operator': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :mode The value to assign to the {OCI::FleetSoftwareUpdate::Models::DbFleetDiscoveryFilter#mode #mode} proprety
    # @option attributes [Array<OCI::FleetSoftwareUpdate::Models::FreeformTagFilterEntry>] :tags The value to assign to the {#tags} property
    # @option attributes [String] :operator The value to assign to the {#operator} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'FREEFORM_TAG'
