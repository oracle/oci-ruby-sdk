...
module OCI
  ...
  class FleetSoftwareUpdate::Models::DiscoveryDetails
    TYPE_ENUM = [
      TYPE_DB = 'DB'.freeze,
      TYPE_GI = 'GI'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::GiDiscoveryDetails' if type == 'GI'
      return 'OCI::FleetSoftwareUpdate::Models::DbDiscoveryDetails' if type == 'DB'
