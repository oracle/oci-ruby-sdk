...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreateFsuCollectionDetails
    TYPE_ENUM = [
      TYPE_DB = 'DB'.freeze,
      TYPE_GI = 'GI'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::CreateDbFsuCollectionDetails' if type == 'DB'
      return 'OCI::FleetSoftwareUpdate::Models::CreateGiFsuCollectionDetails' if type == 'GI'
    ...
    def hash
      [display_name, type, service_type, compartment_id, freeform_tags, defined_tags].hash
    end
