...
require 'date'
require_relative 'update_schedule_details'
...
module OCI
  ...
  #
  class FleetSoftwareUpdate::Models::UpdateStartTimeScheduleDetails < FleetSoftwareUpdate::Models::UpdateScheduleDetails
