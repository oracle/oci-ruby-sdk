...
module OCI
  ...
  class FleetSoftwareUpdate::Models::UpdateFsuActionDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::UpdateStageActionDetails' if type == 'STAGE'
      return 'OCI::FleetSoftwareUpdate::Models::UpdateApplyActionDetails' if type == 'APPLY'
      return 'OCI::FleetSoftwareUpdate::Models::UpdateRollbackActionDetails' if type == 'ROLLBACK_AND_REMOVE_TARGET'
      return 'OCI::FleetSoftwareUpdate::Models::UpdatePrecheckActionDetails' if type == 'PRECHECK'
      return 'OCI::FleetSoftwareUpdate::Models::UpdateCleanupActionDetails' if type == 'CLEANUP'
    ...
    def hash
      [type, display_name, freeform_tags, defined_tags].hash
    end
