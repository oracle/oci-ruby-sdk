...
module OCI
  ...
  class ApplicationMigration::Models::CreateSourceDetails
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'description': :'String',
        'source_details': :'OCI::ApplicationMigration::Models::SourceDetails',
        'authorization_details': :'OCI::ApplicationMigration::Models::AuthorizationDetails',
    ...
    # @option attributes [OCI::ApplicationMigration::Models::SourceDetails] :source_details The value to assign to the {#source_details} property
    # @option attributes [OCI::ApplicationMigration::Models::AuthorizationDetails] :authorization_details The value to assign to the {#authorization_details} property
    ...
    def hash
      [compartment_id, display_name, description, source_details, authorization_details, freeform_tags, defined_tags].hash
    end
