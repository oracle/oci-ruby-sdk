...
module OCI
  ...
  class ApplicationMigration::Models::ImportSourceDetails < ApplicationMigration::Models::SourceDetails
    # This attribute is required.
    # @return [OCI::ApplicationMigration::Models::ImportManifest]
    ...
    # @option attributes [OCI::ApplicationMigration::Models::ImportManifest] :manifest The value to assign to the {#manifest} property
