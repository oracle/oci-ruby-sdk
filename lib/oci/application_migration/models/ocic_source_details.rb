...
module OCI
  ...
  #
  class ApplicationMigration::Models::OcicSourceDetails < ApplicationMigration::Models::SourceDetails
    ...
    # **[Required]** If you are using an Oracle Cloud Infrastructure - Classic account with Identity Cloud Service (IDCS), enter the service instance ID.
    ...
    # @option attributes [String] :compute_account The value to assign to the {#compute_account} property
    def initialize(attributes = {})
      ...
      self.compute_account = attributes[:'computeAccount'] if attributes[:'computeAccount']
      ...
      self.compute_account = attributes[:'compute_account'] if attributes[:'compute_account']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        type == other.type &&
        region == other.region &&
        compute_account == other.compute_account
    end
    ...
    def hash
      [type, region, compute_account].hash
    end
