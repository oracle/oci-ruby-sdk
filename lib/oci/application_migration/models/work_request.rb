...
module OCI
  ...
  class ApplicationMigration::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::ApplicationMigration::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::ApplicationMigration::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::ApplicationMigration::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
