...
module OCI
  ...
  #
  class ApplicationMigration::Models::SourceSummary
    TYPE_ENUM = [
    ...
    def hash
      [id, type, compartment_id, display_name, description, time_created, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
