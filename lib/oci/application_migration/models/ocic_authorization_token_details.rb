...
module OCI
  ...
  #
  class ApplicationMigration::Models::OcicAuthorizationTokenDetails < ApplicationMigration::Models::AuthorizationDetails
    # **[Required]** AuthClient app url resource that the accesstoken is for.
    # @return [String]
    attr_accessor :client_app_url
    ...
    # @option attributes [String] :client_app_url The value to assign to the {#client_app_url} property
