...
module OCI
  ...
  class DataConnectivity::Models::TypeSystem
    ...
    attr_accessor :type_mapping_to

    # The type system to map from.
    # @return [Hash<String, String>]
    attr_accessor :type_mapping_from
    ...
    # An array of types.
    # @return [Array<OCI::DataConnectivity::Models::DataType>]
    attr_accessor :types
    ...
    def self.swagger_types
      {
        ...
        'type_mapping_to': :'Hash<String, String>',
        'type_mapping_from': :'Hash<String, String>',
        'object_status': :'Integer',
        'identifier': :'String',
        'types': :'Array<OCI::DataConnectivity::Models::DataType>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, String>] :type_mapping_to The value to assign to the {#type_mapping_to} property
    # @option attributes [Hash<String, String>] :type_mapping_from The value to assign to the {#type_mapping_from} property
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::DataType>] :types The value to assign to the {#types} property
    def initialize(attributes = {})
      ...
      self.type_mapping_to = attributes[:'typeMappingTo'] if attributes[:'typeMappingTo']

      raise 'You cannot provide both :typeMappingTo and :type_mapping_to' if attributes.key?(:'typeMappingTo') && attributes.key?(:'type_mapping_to')

      self.type_mapping_to = attributes[:'type_mapping_to'] if attributes[:'type_mapping_to']

      self.type_mapping_from = attributes[:'typeMappingFrom'] if attributes[:'typeMappingFrom']

      raise 'You cannot provide both :typeMappingFrom and :type_mapping_from' if attributes.key?(:'typeMappingFrom') && attributes.key?(:'type_mapping_from')

      self.type_mapping_from = attributes[:'type_mapping_from'] if attributes[:'type_mapping_from']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        type_mapping_to == other.type_mapping_to &&
        type_mapping_from == other.type_mapping_from &&
    ...
    def hash
      [key, model_type, model_version, parent_ref, name, description, object_version, type_mapping_to, type_mapping_from, object_status, identifier, types].hash
    end
