...
module OCI
  ...
  class DataConnectivity::Models::DataEntityFromTableEntityDetails < DataConnectivity::Models::DataEntityDetails
    ENTITY_TYPE_ENUM = [
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, external_key, shape, shape_id, entity_type, other_type_label, unique_keys, foreign_keys, resource_name, object_status, identifier].hash
    end
