...
require 'date'
require 'logger'
require_relative 'create_connectivity_validation_details'
...
module OCI
  ...
  class DataConnectivity::Models::Target < DataConnectivity::Models::CreateConnectivityValidationDetails
    DATA_PROPERTY_ENUM = [
    ...
    # @return [OCI::DataConnectivity::Models::SchemaDriftConfig]
    attr_accessor :schema_drift_config

    # @return [OCI::DataConnectivity::Models::Shape]
    attr_accessor :fixed_data_shape

    # @return [OCI::DataConnectivity::Models::WriteOperationConfig]
    ...
    def self.swagger_types
      {
        ...
        'input_ports': :'Array<OCI::DataConnectivity::Models::InputPort>',
        'output_ports': :'Array<OCI::DataConnectivity::Models::OutputPort>',
        'object_status': :'Integer',
        'identifier': :'String',
        'parameters': :'Array<OCI::DataConnectivity::Models::Parameter>',
        'op_config_values': :'OCI::DataConnectivity::Models::ConfigValues',
        'entity': :'OCI::DataConnectivity::Models::DataEntity',
        'is_read_access': :'BOOLEAN',
        'is_copy_fields': :'BOOLEAN',
        'is_predefined_shape': :'BOOLEAN',
        'data_property': :'String',
        'schema_drift_config': :'OCI::DataConnectivity::Models::SchemaDriftConfig',
        'fixed_data_shape': :'OCI::DataConnectivity::Models::Shape',
        'write_operation_config': :'OCI::DataConnectivity::Models::WriteOperationConfig'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :key The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#key #key} proprety
    # @option attributes [String] :model_version The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#model_version #model_version} proprety
    # @option attributes [OCI::DataConnectivity::Models::ParentReference] :parent_ref The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#parent_ref #parent_ref} proprety
    # @option attributes [String] :name The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#name #name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#description #description} proprety
    # @option attributes [Integer] :object_version The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#object_version #object_version} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::InputPort>] :input_ports The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#input_ports #input_ports} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::OutputPort>] :output_ports The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#output_ports #output_ports} proprety
    # @option attributes [Integer] :object_status The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#object_status #object_status} proprety
    # @option attributes [String] :identifier The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#identifier #identifier} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::Parameter>] :parameters The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#parameters #parameters} proprety
    # @option attributes [OCI::DataConnectivity::Models::ConfigValues] :op_config_values The value to assign to the {OCI::DataConnectivity::Models::CreateConnectivityValidationDetails#op_config_values #op_config_values} proprety
    # @option attributes [OCI::DataConnectivity::Models::DataEntity] :entity The value to assign to the {#entity} property
    ...
    # @option attributes [OCI::DataConnectivity::Models::SchemaDriftConfig] :schema_drift_config The value to assign to the {#schema_drift_config} property
    # @option attributes [OCI::DataConnectivity::Models::Shape] :fixed_data_shape The value to assign to the {#fixed_data_shape} property
    # @option attributes [OCI::DataConnectivity::Models::WriteOperationConfig] :write_operation_config The value to assign to the {#write_operation_config} property
