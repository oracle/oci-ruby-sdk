...
module OCI
  ...
  class DataConnectivity::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE = 'CREATE'.freeze,
      OPERATION_TYPE_UPDATE = 'UPDATE'.freeze,
      OPERATION_TYPE_DELETE = 'DELETE'.freeze,
      OPERATION_TYPE_MOVE = 'MOVE'.freeze,
    ...
    # @return [Array<OCI::DataConnectivity::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DataConnectivity::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
