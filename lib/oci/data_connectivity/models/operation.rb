...
module OCI
  ...
  class DataConnectivity::Models::Operation
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::OperationFromProcedure' if type == 'PROCEDURE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::Operation'
    end
