...
module OCI
  ...
  class DataConnectivity::Models::ConnectionValidationSummary
    # @return [OCI::DataConnectivity::Models::Message]
    ...
    # @return [OCI::DataConnectivity::Models::CreateConnectionDetails]
    attr_accessor :connection

    # @return [OCI::DataConnectivity::Models::CreateDataAssetDetails]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'validation_message': :'OCI::DataConnectivity::Models::Message',
        'key': :'String',
        'model_type': :'String',
        ...
        'connection': :'OCI::DataConnectivity::Models::CreateConnectionDetails',
        'data_asset': :'OCI::DataConnectivity::Models::CreateDataAssetDetails',
        'identifier': :'String',
    ...
    # @option attributes [OCI::DataConnectivity::Models::Message] :validation_message The value to assign to the {#validation_message} property
    ...
    # @option attributes [OCI::DataConnectivity::Models::CreateConnectionDetails] :connection The value to assign to the {#connection} property
    # @option attributes [OCI::DataConnectivity::Models::CreateDataAssetDetails] :data_asset The value to assign to the {#data_asset} property
    ...
    def hash
      [validation_message, key, model_type, model_version, parent_ref, name, description, object_version, object_status, registry_metadata, connection, data_asset, identifier, metadata].hash
    end
