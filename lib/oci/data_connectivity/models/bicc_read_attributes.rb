...
module OCI
  ...
  class DataConnectivity::Models::BiccReadAttributes < DataConnectivity::Models::AbstractReadAttribute
    ...
    # @return [OCI::DataConnectivity::Models::ExternalStorage]
    ...
    def self.swagger_types
      {
        ...
        'external_storage': :'OCI::DataConnectivity::Models::ExternalStorage',
    ...
    # @option attributes [OCI::DataConnectivity::Models::ExternalStorage] :external_storage The value to assign to the {#external_storage} property
