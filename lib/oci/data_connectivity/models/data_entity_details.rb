...
module OCI
  ...
  class DataConnectivity::Models::DataEntityDetails
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::DataEntityFromFileEntityDetails' if type == 'FILE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromViewEntityDetails' if type == 'VIEW_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromSqlEntityDetails' if type == 'SQL_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromDataStoreEntityDetails' if type == 'DATA_STORE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromTableEntityDetails' if type == 'TABLE_ENTITY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::DataEntityDetails'
    end
