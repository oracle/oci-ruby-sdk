...
require 'date'
require_relative 'dp_endpoint_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The endpoint details for a private endpoint.
  class DataConnectivity::Models::DpEndpointFromPrivateDetails < DataConnectivity::Models::DpEndpointDetails
    STATE_ENUM = [
    ...
    # @option attributes [String] :key The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#key #key} proprety
    # @option attributes [String] :model_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#model_version #model_version} proprety
    # @option attributes [OCI::DataConnectivity::Models::ParentReference] :parent_ref The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#parent_ref #parent_ref} proprety
    # @option attributes [String] :name The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#name #name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#description #description} proprety
    # @option attributes [Integer] :object_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#object_version #object_version} proprety
    # @option attributes [Integer] :object_status The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#object_status #object_status} proprety
    # @option attributes [String] :identifier The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#identifier #identifier} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::DataAsset>] :data_assets The value to assign to the {OCI::DataConnectivity::Models::DpEndpointDetails#data_assets #data_assets} proprety
