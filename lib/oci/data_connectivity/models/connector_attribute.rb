...
module OCI
  ...
  class DataConnectivity::Models::ConnectorAttribute
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_EXTERNAL_STORAGE = 'EXTERNAL_STORAGE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::ExternalStorage' if type == 'EXTERNAL_STORAGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::ConnectorAttribute'
    end
