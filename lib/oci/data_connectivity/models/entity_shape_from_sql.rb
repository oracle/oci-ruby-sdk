...
require 'date'
require 'logger'
require_relative 'entity_shape'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The SQL entity details.
  class DataConnectivity::Models::EntityShapeFromSQL < DataConnectivity::Models::EntityShape
    ENTITY_TYPE_ENUM = [
    ...
    # @option attributes [OCI::DataConnectivity::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataConnectivity::Models::EntityShape#metadata #metadata} proprety
    ...
    def hash
      [model_type, metadata, key, model_version, parent_ref, name, description, object_version, external_key, shape, shape_id, entity_type, other_type_label, unique_keys, foreign_keys, resource_name, data_format, object_status, identifier, sql_query].hash
    end
