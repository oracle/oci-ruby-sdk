...
module OCI
  ...
  class DataConnectivity::Models::AbstractDataOperationConfig
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_READ_OPERATION_CONFIG = 'READ_OPERATION_CONFIG'.freeze,
      MODEL_TYPE_WRITE_OPERATION_CONFIG = 'WRITE_OPERATION_CONFIG'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::WriteOperationConfig' if type == 'WRITE_OPERATION_CONFIG'
      return 'OCI::DataConnectivity::Models::ReadOperationConfig' if type == 'READ_OPERATION_CONFIG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::AbstractDataOperationConfig'
    end
