...
module OCI
  ...
  class DataConnectivity::Models::WriteOperationConfig < DataConnectivity::Models::AbstractDataOperationConfig
    WRITE_MODE_ENUM = [
      ...
      WRITE_MODE_CREATE = 'CREATE'.freeze,
    ...
    # @return [OCI::DataConnectivity::Models::AbstractWriteAttribute]
    ...
    # @return [OCI::DataConnectivity::Models::UniqueKey]
    ...
    def self.swagger_types
      {
        ...
        'write_attribute': :'OCI::DataConnectivity::Models::AbstractWriteAttribute',
        'write_mode': :'String',
        'merge_key': :'OCI::DataConnectivity::Models::UniqueKey',
    ...
    # @option attributes [OCI::DataConnectivity::Models::AbstractWriteAttribute] :write_attribute The value to assign to the {#write_attribute} property
    # @option attributes [String] :write_mode The value to assign to the {#write_mode} property
    # @option attributes [OCI::DataConnectivity::Models::UniqueKey] :merge_key The value to assign to the {#merge_key} property
    # @option attributes [Integer] :object_status The value to assign to the {#object_status} property
    # @option attributes [Integer] :reject_limit The value to assign to the {#reject_limit} property
    def initialize(attributes = {})
      ...
      self.reject_limit = attributes[:'rejectLimit'] if attributes[:'rejectLimit']

      raise 'You cannot provide both :rejectLimit and :reject_limit' if attributes.key?(:'rejectLimit') && attributes.key?(:'reject_limit')

      self.reject_limit = attributes[:'reject_limit'] if attributes[:'reject_limit']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        reject_limit == other.reject_limit
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, operations, data_format, partition_config, write_attribute, write_mode, merge_key, object_status, reject_limit].hash
    end
