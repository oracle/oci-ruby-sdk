...
module OCI
  ...
  class DataConnectivity::Models::PartitionConfig
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_KEYRANGEPARTITIONCONFIG = 'KEYRANGEPARTITIONCONFIG'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::KeyRangePartitionConfig' if type == 'KEYRANGEPARTITIONCONFIG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::PartitionConfig'
    end
