...
module OCI
  ...
  class DataConnectivity::Models::DataEntitySummaryFromSql < DataConnectivity::Models::DataEntitySummary
    ENTITY_TYPE_ENUM = [
    ...
    # @option attributes [OCI::DataConnectivity::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataConnectivity::Models::DataEntitySummary#metadata #metadata} proprety
