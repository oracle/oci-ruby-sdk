...
module OCI
  ...
  class DataConnectivity::Models::DataEntityFromSql < DataConnectivity::Models::DataEntity
    ENTITY_TYPE_ENUM = [
    ...
    # @option attributes [OCI::DataConnectivity::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataConnectivity::Models::DataEntity#metadata #metadata} proprety
