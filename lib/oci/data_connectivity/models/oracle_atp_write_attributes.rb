...
module OCI
  ...
  class DataConnectivity::Models::OracleAtpWriteAttributes < DataConnectivity::Models::AbstractWriteAttribute
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'model_type': :'String',
        'bucket_schema': :'OCI::DataConnectivity::Models::Schema',
    ...
    # @option attributes [OCI::DataConnectivity::Models::Schema] :bucket_schema The value to assign to the {#bucket_schema} property
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'ORACLE_ATP_WRITE_ATTRIBUTE'
