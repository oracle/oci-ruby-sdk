...
module OCI
  ...
  class DataConnectivity::Models::UpdateFolderDetails
    # **[Required]** The type of the folder.
    # @return [String]
    attr_accessor :model_type

    # **[Required]** Generated key that can be used in API calls to identify folder. On scenarios where reference to the folder is needed, a value can be passed in create.
    # @return [String]
    attr_accessor :key
