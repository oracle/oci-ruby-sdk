...
module OCI
  ...
  class DataConnectivity::Models::InputPort < DataConnectivity::Models::TypedObject
    PORT_TYPE_ENUM = [
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'port_type': :'String',
        'fields': :'Array<OCI::DataConnectivity::Models::TypedObject>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::TypedObject>] :fields The value to assign to the {#fields} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'INPUT_PORT'
