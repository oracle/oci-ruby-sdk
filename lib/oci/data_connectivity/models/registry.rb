...
module OCI
  ...
  class DataConnectivity::Models::Registry
    ...
    def hash
      [freeform_tags, defined_tags, description, display_name, updated_by, compartment_id, time_created, time_updated, lifecycle_state, state_message, id].hash
    end
