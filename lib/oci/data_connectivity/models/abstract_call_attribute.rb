...
module OCI
  ...
  class DataConnectivity::Models::AbstractCallAttribute
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_BIPCALLATTRIBUTE = 'BIPCALLATTRIBUTE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::BipCallAttribute' if type == 'BIPCALLATTRIBUTE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::AbstractCallAttribute'
    end
