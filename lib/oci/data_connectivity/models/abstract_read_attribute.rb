...
module OCI
  ...
  class DataConnectivity::Models::AbstractReadAttribute
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::OracleReadAttributes' if type == 'ORACLE_READ_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::BiccReadAttributes' if type == 'BICC_READ_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::OracleReadAttribute' if type == 'ORACLEREADATTRIBUTE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::AbstractReadAttribute'
    end
