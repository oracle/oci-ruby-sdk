...
module OCI
  ...
  class DataConnectivity::Models::EndpointSummary
    ...
    # **[Required]** Data Connectivity Management Endpoint display name, Endpoints can be renamed
    # @return [String]
    ...
    def hash
      [id, description, display_name, compartment_id, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, state_message].hash
    end
