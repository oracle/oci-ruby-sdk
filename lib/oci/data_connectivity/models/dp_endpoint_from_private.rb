...
require 'date'
require 'logger'
require_relative 'dp_endpoint'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The endpoint details for a private endpoint.
  class DataConnectivity::Models::DpEndpointFromPrivate < DataConnectivity::Models::DpEndpoint
    STATE_ENUM = [
    ...
    # @option attributes [String] :key The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#key #key} proprety
    # @option attributes [String] :model_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#model_version #model_version} proprety
    # @option attributes [OCI::DataConnectivity::Models::ParentReference] :parent_ref The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#parent_ref #parent_ref} proprety
    # @option attributes [String] :name The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#name #name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#description #description} proprety
    # @option attributes [Integer] :object_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#object_version #object_version} proprety
    # @option attributes [Integer] :object_status The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#object_status #object_status} proprety
    # @option attributes [String] :identifier The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#identifier #identifier} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::DataAsset>] :data_assets The value to assign to the {OCI::DataConnectivity::Models::DpEndpoint#data_assets #data_assets} proprety
