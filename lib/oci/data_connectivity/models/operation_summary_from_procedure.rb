...
require 'date'
require_relative 'operation_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The operation object.
  class DataConnectivity::Models::OperationSummaryFromProcedure < DataConnectivity::Models::OperationSummary
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [OCI::DataConnectivity::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataConnectivity::Models::OperationSummary#metadata #metadata} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'PROCEDURE'
    ...
    def hash
      [model_type, metadata, key, model_version, parent_ref, name, object_version, external_key, resource_name, object_status].hash
    end
