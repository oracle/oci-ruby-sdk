...
module OCI
  ...
  class DataConnectivity::Models::PushDownOperation
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_FILTER = 'FILTER'.freeze,
      MODEL_TYPE_JOIN = 'JOIN'.freeze,
      MODEL_TYPE_SELECT = 'SELECT'.freeze,
      MODEL_TYPE_SORT = 'SORT'.freeze,
      MODEL_TYPE_QUERY = 'QUERY'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::Query' if type == 'QUERY'
      return 'OCI::DataConnectivity::Models::Select' if type == 'SELECT'
      return 'OCI::DataConnectivity::Models::Join' if type == 'JOIN'
      return 'OCI::DataConnectivity::Models::Sort' if type == 'SORT'
      return 'OCI::DataConnectivity::Models::FilterPush' if type == 'FILTER'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::PushDownOperation'
    end
