...
module OCI
  ...
  class DataConnectivity::Models::UpdateDpEndpointDetails
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_PRIVATE_END_POINT = 'PRIVATE_END_POINT'.freeze,
      MODEL_TYPE_PUBLIC_END_POINT = 'PUBLIC_END_POINT'.freeze
    ].freeze
    ...
    # **[Required]** Generated key that can be used in API calls to identify endpoint. On scenarios where reference to the endpoint is needed, a value can be passed in create.
    # @return [String]
    attr_accessor :key
    ...
    # @return [Array<OCI::DataConnectivity::Models::DataAsset>]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::UpdateDpEndpointFromPublic' if type == 'PUBLIC_END_POINT'
      return 'OCI::DataConnectivity::Models::UpdateDpEndpointFromPrivate' if type == 'PRIVATE_END_POINT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::UpdateDpEndpointDetails'
    end
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::DataAsset>] :data_assets The value to assign to the {#data_assets} property
    def initialize(attributes = {})
      ...
      self.data_assets = attributes[:'dataAssets'] if attributes[:'dataAssets']

      raise 'You cannot provide both :dataAssets and :data_assets' if attributes.key?(:'dataAssets') && attributes.key?(:'data_assets')

      self.data_assets = attributes[:'data_assets'] if attributes[:'data_assets']
    end
