...
module OCI
  ...
  class DataConnectivity::Models::UpdateDataAssetDetails
    ...
    # **[Required]** All the properties for the data asset in a key-value map format.
    # @return [Hash<String, Object>]
    attr_accessor :properties

    # **[Required]** Specific DataAsset Type
    # @return [String]
    attr_accessor :type
    ...
    def hash
      [model_version, model_type, name, description, object_status, object_version, identifier, external_key, asset_properties, properties, type, native_type_system, registry_metadata, metadata, default_connection, end_points].hash
    end
