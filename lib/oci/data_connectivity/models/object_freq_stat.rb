...
module OCI
  ...
  class DataConnectivity::Models::ObjectFreqStat
    ...
    # @option attributes [Integer] :freq The value to assign to the {#freq} property
    # @option attributes [Float] :freq_percentage The value to assign to the {#freq_percentage} property
    def initialize(attributes = {})
      ...
      self.freq = attributes[:'freq'] if attributes[:'freq']

      self.freq_percentage = attributes[:'freqPercentage'] if attributes[:'freqPercentage']

      raise 'You cannot provide both :freqPercentage and :freq_percentage' if attributes.key?(:'freqPercentage') && attributes.key?(:'freq_percentage')

      self.freq_percentage = attributes[:'freq_percentage'] if attributes[:'freq_percentage']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        freq == other.freq &&
        freq_percentage == other.freq_percentage
    end
    ...
    def hash
      [value, confidence, freq, freq_percentage].hash
    end
