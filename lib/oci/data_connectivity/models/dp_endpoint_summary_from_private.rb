...
require 'date'
require_relative 'dp_endpoint_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The endpoint summary details for a private endpoint.
  class DataConnectivity::Models::DpEndpointSummaryFromPrivate < DataConnectivity::Models::DpEndpointSummary
    STATE_ENUM = [
    ...
    # @option attributes [String] :key The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#key #key} proprety
    # @option attributes [String] :model_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#model_version #model_version} proprety
    # @option attributes [OCI::DataConnectivity::Models::ParentReference] :parent_ref The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#parent_ref #parent_ref} proprety
    # @option attributes [String] :name The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#name #name} proprety
    # @option attributes [String] :description The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#description #description} proprety
    # @option attributes [Integer] :object_version The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#object_version #object_version} proprety
    # @option attributes [Integer] :object_status The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#object_status #object_status} proprety
    # @option attributes [String] :identifier The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#identifier #identifier} proprety
    # @option attributes [Array<OCI::DataConnectivity::Models::DataAsset>] :data_assets The value to assign to the {OCI::DataConnectivity::Models::DpEndpointSummary#data_assets #data_assets} proprety
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, data_assets, dcms_endpoint_id, pe_id, compartment_id, dns_proxy_ip, private_endpoint_ip, dns_zones, state].hash
    end
