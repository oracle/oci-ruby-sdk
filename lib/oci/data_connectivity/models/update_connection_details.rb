...
module OCI
  ...
  class DataConnectivity::Models::UpdateConnectionDetails
    ...
    def hash
      [model_version, model_type, name, description, object_version, object_status, identifier, primary_schema, connection_properties, properties, type, is_default, metadata, registry_metadata].hash
    end
