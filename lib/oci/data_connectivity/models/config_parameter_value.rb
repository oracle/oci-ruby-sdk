...
module OCI
  ...
  class DataConnectivity::Models::ConfigParameterValue
    ...
    def initialize(attributes = {})
      ...
      self.string_value = attributes[:'stringValue'] if attributes[:'stringValue']

      raise 'You cannot provide both :stringValue and :string_value' if attributes.key?(:'stringValue') && attributes.key?(:'string_value')

      self.string_value = attributes[:'string_value'] if attributes[:'string_value']

      self.int_value = attributes[:'intValue'] if attributes[:'intValue']
      ...
      raise 'You cannot provide both :refValue and :ref_value' if attributes.key?(:'refValue') && attributes.key?(:'ref_value')

      self.ref_value = attributes[:'ref_value'] if attributes[:'ref_value']
