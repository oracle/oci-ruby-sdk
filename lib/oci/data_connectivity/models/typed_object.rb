...
module OCI
  ...
  class DataConnectivity::Models::TypedObject
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_SHAPE = 'SHAPE'.freeze,
      MODEL_TYPE_SHAPE_FIELD = 'SHAPE_FIELD'.freeze,
      MODEL_TYPE_NATIVE_SHAPE_FIELD = 'NATIVE_SHAPE_FIELD'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::OutputPort' if type == 'OUTPUT_PORT'
      return 'OCI::DataConnectivity::Models::Shape' if type == 'SHAPE'
      return 'OCI::DataConnectivity::Models::ShapeField' if type == 'SHAPE_FIELD'
      return 'OCI::DataConnectivity::Models::InputPort' if type == 'INPUT_PORT'
      return 'OCI::DataConnectivity::Models::Parameter' if type == 'PARAMETER'
      return 'OCI::DataConnectivity::Models::NativeShapeField' if type == 'NATIVE_SHAPE_FIELD'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::TypedObject'
    end
