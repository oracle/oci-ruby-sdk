...
module OCI
  ...
  class DataConnectivity::Models::DpEndpointSummary
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::DpEndpointSummaryFromPublic' if type == 'PUBLIC_END_POINT'
      return 'OCI::DataConnectivity::Models::DpEndpointSummaryFromPrivate' if type == 'PRIVATE_END_POINT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::DpEndpointSummary'
    end
