...
module OCI
  ...
  class DataConnectivity::Models::DataEntity
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::DataEntityFromTable' if type == 'TABLE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromDataStore' if type == 'DATA_STORE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromView' if type == 'VIEW_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromSql' if type == 'SQL_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntityFromFile' if type == 'FILE_ENTITY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::DataEntity'
    end
