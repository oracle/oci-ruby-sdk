...
module OCI
  ...
  class DataConnectivity::Models::BaseType
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::ConfiguredType' if type == 'CONFIGURED_TYPE'
      return 'OCI::DataConnectivity::Models::DerivedType' if type == 'DERIVED_TYPE'
      return 'OCI::DataConnectivity::Models::DataType' if type == 'DATA_TYPE'
      return 'OCI::DataConnectivity::Models::StructuredType' if type == 'STRUCTURED_TYPE'
      return 'OCI::DataConnectivity::Models::CompositeType' if type == 'COMPOSITE_TYPE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::BaseType'
    end
