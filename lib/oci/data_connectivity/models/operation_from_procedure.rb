...
module OCI
  ...
  class DataConnectivity::Models::OperationFromProcedure < DataConnectivity::Models::Operation
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [OCI::DataConnectivity::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataConnectivity::Models::Operation#metadata #metadata} proprety
    ...
    def hash
      [model_type, metadata, key, model_version, parent_ref, shape, name, object_version, external_key, resource_name, object_status].hash
    end
