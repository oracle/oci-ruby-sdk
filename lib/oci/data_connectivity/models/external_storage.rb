...
require 'date'
require 'logger'
require_relative 'connector_attribute'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # BICC Connector Attribute.Object Storage as External storage where the BICC extracted files are written
  class DataConnectivity::Models::ExternalStorage < DataConnectivity::Models::ConnectorAttribute
    ...
    # @option attributes [String] :storage_id The value to assign to the {#storage_id} property
    # @option attributes [String] :storage_name The value to assign to the {#storage_name} property
