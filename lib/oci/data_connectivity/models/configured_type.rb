...
module OCI
  ...
  class DataConnectivity::Models::ConfiguredType < DataConnectivity::Models::BaseType
    # @return [OCI::DataConnectivity::Models::BaseType]
    attr_accessor :wrapped_type

    # @return [OCI::DataConnectivity::Models::ConfigValues]
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'wrapped_type': :'OCI::DataConnectivity::Models::BaseType',
    ...
    # @option attributes [OCI::DataConnectivity::Models::BaseType] :wrapped_type The value to assign to the {#wrapped_type} property
    # @option attributes [OCI::DataConnectivity::Models::ConfigValues] :config_values The value to assign to the {#config_values} property
