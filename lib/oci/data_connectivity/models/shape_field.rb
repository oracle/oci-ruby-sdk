...
module OCI
  ...
  class DataConnectivity::Models::ShapeField < DataConnectivity::Models::TypedObject
    # The type reference.
    # @return [Object]
    attr_accessor :type
    ...
    # @return [OCI::DataConnectivity::Models::NativeShapeField]
    attr_accessor :native_shape_field
    ...
    def self.swagger_types
      {
        ...
        'type': :'Object',
        'labels': :'Array<String>',
        'native_shape_field': :'OCI::DataConnectivity::Models::NativeShapeField'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataConnectivity::Models::NativeShapeField] :native_shape_field The value to assign to the {#native_shape_field} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'SHAPE_FIELD'
      ...
      self.native_shape_field = attributes[:'nativeShapeField'] if attributes[:'nativeShapeField']

      raise 'You cannot provide both :nativeShapeField and :native_shape_field' if attributes.key?(:'nativeShapeField') && attributes.key?(:'native_shape_field')

      self.native_shape_field = attributes[:'native_shape_field'] if attributes[:'native_shape_field']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        type == other.type &&
        labels == other.labels &&
        native_shape_field == other.native_shape_field
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, type, labels, native_shape_field].hash
    end
