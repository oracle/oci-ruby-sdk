...
module OCI
  ...
  class DataConnectivity::Models::CreateEndpointDetails
    ...
    def hash
      [vcn_id, subnet_id, dns_zones, freeform_tags, defined_tags, description, display_name, compartment_id, endpoint_size, nsg_ids].hash
    end
