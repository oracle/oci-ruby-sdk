...
module OCI
  ...
  class DataConnectivity::Models::EntityShape
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::EntityShapeFromDataStore' if type == 'DATA_STORE_ENTITY'
      return 'OCI::DataConnectivity::Models::EntityShapeFromTable' if type == 'TABLE_ENTITY'
      return 'OCI::DataConnectivity::Models::EntityShapeFromSQL' if type == 'SQL_ENTITY'
      return 'OCI::DataConnectivity::Models::EntityShapeFromView' if type == 'VIEW_ENTITY'
      return 'OCI::DataConnectivity::Models::EntityShapeFromFile' if type == 'FILE_ENTITY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::EntityShape'
    end
