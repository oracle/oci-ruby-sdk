...
module OCI
  # The shape object.
  class DataConnectivity::Models::Shape < DataConnectivity::Models::TypedObject
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'description': :'String',
        'type': :'OCI::DataConnectivity::Models::BaseType'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataConnectivity::Models::BaseType] :type The value to assign to the {#type} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'SHAPE'
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, type].hash
    end
