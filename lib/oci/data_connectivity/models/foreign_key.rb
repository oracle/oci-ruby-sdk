...
module OCI
  ...
  class DataConnectivity::Models::ForeignKey < DataConnectivity::Models::Key
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @return [Array<OCI::DataConnectivity::Models::KeyAttribute>]
    ...
    attr_accessor :reference_unique_key
    ...
    def self.swagger_types
      {
        ...
        'update_rule': :'Integer',
        'delete_rule': :'Integer',
        'reference_unique_key': :'OCI::DataConnectivity::Models::UniqueKey',
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::KeyAttribute>] :attribute_refs The value to assign to the {#attribute_refs} property
    # @option attributes [Integer] :update_rule The value to assign to the {#update_rule} property
    # @option attributes [Integer] :delete_rule The value to assign to the {#delete_rule} property
    # @option attributes [OCI::DataConnectivity::Models::UniqueKey] :reference_unique_key The value to assign to the {#reference_unique_key} property
