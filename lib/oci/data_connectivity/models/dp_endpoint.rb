...
module OCI
  ...
  class DataConnectivity::Models::DpEndpoint
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::DpEndpointFromPrivate' if type == 'PRIVATE_END_POINT'
      return 'OCI::DataConnectivity::Models::DpEndpointFromPublic' if type == 'PUBLIC_END_POINT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::DpEndpoint'
    end
