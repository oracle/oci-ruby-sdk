...
module OCI
  ...
  class DataConnectivity::Models::CreateDpEndpointDetails
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::CreateDpEndpointFromPublic' if type == 'PUBLIC_END_POINT'
      return 'OCI::DataConnectivity::Models::CreateDpEndpointFromPrivate' if type == 'PRIVATE_END_POINT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::CreateDpEndpointDetails'
    end
