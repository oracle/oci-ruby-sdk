...
module OCI
  ...
  class DataConnectivity::Models::ObjectMetadata
    ...
    # @return [OCI::DataConnectivity::Models::AggregatorSummary]
    ...
    def self.swagger_types
      {
        ...
        'aggregator': :'OCI::DataConnectivity::Models::AggregatorSummary',
    ...
    # @option attributes [OCI::DataConnectivity::Models::AggregatorSummary] :aggregator The value to assign to the {#aggregator} property
