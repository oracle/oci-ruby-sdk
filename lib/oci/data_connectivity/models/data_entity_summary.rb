...
module OCI
  ...
  class DataConnectivity::Models::DataEntitySummary
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::DataEntitySummaryFromFile' if type == 'FILE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntitySummaryFromTable' if type == 'TABLE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntitySummaryFromDataStore' if type == 'DATA_STORE_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntitySummaryFromSql' if type == 'SQL_ENTITY'
      return 'OCI::DataConnectivity::Models::DataEntitySummaryFromView' if type == 'VIEW_ENTITY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::DataEntitySummary'
    end
