...
module OCI
  ...
  class DataConnectivity::Models::Outlier
    ...
    # @option attributes [String] :low_count The value to assign to the {#low_count} property
    # @option attributes [String] :high_count The value to assign to the {#high_count} property
