...
module OCI
  ...
  class DataConnectivity::Models::ConfigDefinition
    ...
    # @return [Hash<String, OCI::DataConnectivity::Models::ConfigParameterDefinition>]
    ...
    def self.swagger_types
      {
        ...
        'config_parameter_definitions': :'Hash<String, OCI::DataConnectivity::Models::ConfigParameterDefinition>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::DataConnectivity::Models::ConfigParameterDefinition>] :config_parameter_definitions The value to assign to the {#config_parameter_definitions} property
