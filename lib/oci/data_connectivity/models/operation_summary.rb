...
module OCI
  ...
  class DataConnectivity::Models::OperationSummary
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_PROCEDURE = 'PROCEDURE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::OperationSummaryFromProcedure' if type == 'PROCEDURE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::OperationSummary'
    end
