...
module OCI
  ...
  class DataConnectivity::Models::TypeLibrary
    ...
    # types
    # @return [Hash<String, OCI::DataConnectivity::Models::DerivedType>]
    attr_accessor :types
    ...
    def self.swagger_types
      {
        ...
        'types': :'Hash<String, OCI::DataConnectivity::Models::DerivedType>',
    ...
    # @option attributes [Hash<String, OCI::DataConnectivity::Models::DerivedType>] :types The value to assign to the {#types} property
    ...
    def hash
      [key, model_type, model_version, parent_ref, name, description, object_version, types, object_status, identifier].hash
    end
