...
module OCI
  ...
  class DataConnectivity::Models::CreateConnectivityValidationDetails
    MODEL_TYPE_ENUM = [
    ...
    # @return [Array<OCI::DataConnectivity::Models::InputPort>]
    attr_accessor :input_ports

    # An array of output ports.
    # @return [Array<OCI::DataConnectivity::Models::OutputPort>]
    ...
    # @return [Array<OCI::DataConnectivity::Models::Parameter>]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::Target' if type == 'TARGET_OPERATOR'
      return 'OCI::DataConnectivity::Models::Source' if type == 'SOURCE_OPERATOR'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::CreateConnectivityValidationDetails'
    end
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::InputPort>] :input_ports The value to assign to the {#input_ports} property
    # @option attributes [Array<OCI::DataConnectivity::Models::OutputPort>] :output_ports The value to assign to the {#output_ports} property
    ...
    # @option attributes [Array<OCI::DataConnectivity::Models::Parameter>] :parameters The value to assign to the {#parameters} property
    # @option attributes [OCI::DataConnectivity::Models::ConfigValues] :op_config_values The value to assign to the {#op_config_values} property
