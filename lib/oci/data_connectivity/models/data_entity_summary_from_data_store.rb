...
module OCI
  ...
  class DataConnectivity::Models::DataEntitySummaryFromDataStore < DataConnectivity::Models::DataEntitySummary
    ENTITY_TYPE_ENUM = [
    ...
    def hash
      [model_type, metadata, key, model_version, parent_ref, name, description, object_version, external_key, shape, shape_id, entity_type, other_type_label, unique_keys, foreign_keys, resource_name, object_status, identifier, filters, is_effective_date_disabled, is_flex_data_store, is_silent_error, supports_incremental].hash
    end
