...
module OCI
  ...
  class DataConnectivity::Models::AbstractWriteAttribute
    MODEL_TYPE_ENUM = [
      ...
      MODEL_TYPE_HDFS_WRITE_ATTRIBUTE = 'HDFS_WRITE_ATTRIBUTE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataConnectivity::Models::OracleAtpWriteAttributes' if type == 'ORACLE_ATP_WRITE_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::HdfsWriteAttributes' if type == 'HDFS_WRITE_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::OracleWriteAttributes' if type == 'ORACLE_WRITE_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::OracleAdwcWriteAttributes' if type == 'ORACLE_ADWC_WRITE_ATTRIBUTE'
      return 'OCI::DataConnectivity::Models::ObjectStorageWriteAttributes' if type == 'OBJECT_STORAGE_WRITE_ATTRIBUTE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataConnectivity::Models::AbstractWriteAttribute'
    end
