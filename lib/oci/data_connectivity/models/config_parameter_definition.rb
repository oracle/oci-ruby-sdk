...
module OCI
  ...
  class DataConnectivity::Models::ConfigParameterDefinition
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'parameter_type': :'OCI::DataConnectivity::Models::BaseType',
    ...
    # @option attributes [OCI::DataConnectivity::Models::BaseType] :parameter_type The value to assign to the {#parameter_type} property
