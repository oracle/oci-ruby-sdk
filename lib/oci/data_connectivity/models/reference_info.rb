...
module OCI
  ...
  class DataConnectivity::Models::ReferenceInfo
    ...
    # **[Required]** unique id of dcms artifact that is getting registered.
    # @return [String]
    attr_accessor :dcms_artifact_id

    # **[Required]** unique id of service which is referencing data asset.
    # @return [String]
