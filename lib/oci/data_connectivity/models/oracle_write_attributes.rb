...
module OCI
  ...
  class DataConnectivity::Models::OracleWriteAttributes < DataConnectivity::Models::AbstractWriteAttribute
    ...
    # @option attributes [Integer] :batch_size The value to assign to the {#batch_size} property
    # @option attributes [BOOLEAN] :is_truncate The value to assign to the {#is_truncate} property
