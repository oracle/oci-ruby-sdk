...
module OCI
  ...
  class DataConnectivity::NetworkValidationClient
    ...
    # Creates a new NetworkValidationClient.
    # Notes:
    ...
    def initialize(config: nil, region: nil, endpoint: nil, signer: nil, proxy_settings: nil, retry_config: nil)
      ...
      logger.info "NetworkValidationClient endpoint set to '#{@endpoint}'." if logger
    end
    ...
    def region=(new_region)
      ...
      logger.info "NetworkValidationClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @param [String] endpoint_key The endpoint key.
    ...
    # @return [Response] A Response object with data of type {OCI::DataConnectivity::Models::NetworkConnectivityStatusCollection NetworkConnectivityStatusCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dataconnectivity/get_network_connectivity_status_collection.rb.html) to see an example of how to use get_network_connectivity_status_collection API.
    def get_network_connectivity_status_collection(registry_id, endpoint_key, opts = {})
      logger.debug 'Calling operation NetworkValidationClient#get_network_connectivity_status_collection.' if logger

      raise "Missing the required parameter 'registry_id' when calling get_network_connectivity_status_collection." if registry_id.nil?
      raise "Missing the required parameter 'endpoint_key' when calling get_network_connectivity_status_collection." if endpoint_key.nil?
      ...
      raise "Parameter value for 'endpoint_key' must not be blank" if OCI::Internal::Util.blank_string?(endpoint_key)

      path = '/registries/{registryId}/endpoints/{endpointKey}/networkConnectivityStatusCollection'.sub('{registryId}', registry_id.to_s).sub('{endpointKey}', endpoint_key.to_s)
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NetworkValidationClient#get_network_connectivity_status_collection') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          body: post_body,
          return_type: 'OCI::DataConnectivity::Models::NetworkConnectivityStatusCollection'
        )
      end
