...
module OCI
  ...
  class Bds::Models::AddAutoScalePolicyDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Bds::Models::AddMetricBasedHorizontalScalingPolicyDetails' if type == 'METRIC_BASED_HORIZONTAL_SCALING_POLICY'
      return 'OCI::Bds::Models::AddScheduleBasedVerticalScalingPolicyDetails' if type == 'SCHEDULE_BASED_VERTICAL_SCALING_POLICY'
      return 'OCI::Bds::Models::AddScheduleBasedHorizontalScalingPolicyDetails' if type == 'SCHEDULE_BASED_HORIZONTAL_SCALING_POLICY'
      return 'OCI::Bds::Models::AddMetricBasedVerticalScalingPolicyDetails' if type == 'METRIC_BASED_VERTICAL_SCALING_POLICY'
