...
module OCI
  ...
  class Bds::Models::ChangeShapeDetails
    # **[Required]** Base-64 encoded password for Cloudera Manager admin user
    # @return [String]
    attr_accessor :cluster_admin_password

    # **[Required]** Inidividial worker nodes groups details
    # @return [OCI::Bds::Models::ChangeShapeNodes]
    attr_accessor :nodes
    ...
    def self.swagger_types
      {
        ...
        'nodes': :'OCI::Bds::Models::ChangeShapeNodes'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Bds::Models::ChangeShapeNodes] :nodes The value to assign to the {#nodes} property
    ...
    def hash
      [cluster_admin_password, nodes].hash
    end
