...
module OCI
  ...
  class Bds::Models::UpdateAutoScalePolicyDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Bds::Models::UpdateScheduleBasedHorizontalScalingPolicyDetails' if type == 'SCHEDULE_BASED_HORIZONTAL_SCALING_POLICY'
      return 'OCI::Bds::Models::UpdateMetricBasedVerticalScalingPolicyDetails' if type == 'METRIC_BASED_VERTICAL_SCALING_POLICY'
      return 'OCI::Bds::Models::UpdateMetricBasedHorizontalScalingPolicyDetails' if type == 'METRIC_BASED_HORIZONTAL_SCALING_POLICY'
      return 'OCI::Bds::Models::UpdateScheduleBasedVerticalScalingPolicyDetails' if type == 'SCHEDULE_BASED_VERTICAL_SCALING_POLICY'
