...
module OCI
  ...
  #
  class Bds::Models::ScheduleBasedHorizontalScalingPolicyDetails < Bds::Models::AutoScalePolicyDetails
    # The time zone of the execution schedule, in IANA time zone database name format
    # @return [String]
    attr_accessor :timezone

    # @return [Array<OCI::Bds::Models::HorizontalScalingScheduleDetails>]
    ...
    # @option attributes [Array<OCI::Bds::Models::HorizontalScalingScheduleDetails>] :schedule_details The value to assign to the {#schedule_details} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['policyType'] = 'SCHEDULE_BASED_HORIZONTAL_SCALING_POLICY'
