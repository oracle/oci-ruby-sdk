...
module OCI
  ...
  class Bds::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_UPDATE_BDS = 'UPDATE_BDS'.freeze,
      OPERATION_TYPE_DELETE_BDS = 'DELETE_BDS'.freeze,
      OPERATION_TYPE_ADD_BLOCK_STORAGE = 'ADD_BLOCK_STORAGE'.freeze,
      OPERATION_TYPE_ADD_WORKER_NODES = 'ADD_WORKER_NODES'.freeze,
      OPERATION_TYPE_ADD_CLOUD_SQL = 'ADD_CLOUD_SQL'.freeze,
      OPERATION_TYPE_REMOVE_CLOUD_SQL = 'REMOVE_CLOUD_SQL'.freeze,
      OPERATION_TYPE_CHANGE_COMPARTMENT_FOR_BDS = 'CHANGE_COMPARTMENT_FOR_BDS'.freeze,
      OPERATION_TYPE_CHANGE_SHAPE = 'CHANGE_SHAPE'.freeze,
      OPERATION_TYPE_UPDATE_INFRA = 'UPDATE_INFRA'.freeze,
      OPERATION_TYPE_RESTART_NODE = 'RESTART_NODE'.freeze,
      OPERATION_TYPE_REMOVE_NODE = 'REMOVE_NODE'.freeze,
      OPERATION_TYPE_CREATE_AUTOSCALE_CONFIG = 'CREATE_AUTOSCALE_CONFIG'.freeze,
      OPERATION_TYPE_UPDATE_AUTOSCALE_CONFIG = 'UPDATE_AUTOSCALE_CONFIG'.freeze,
      OPERATION_TYPE_DELETE_AUTOSCALE_CONFIG = 'DELETE_AUTOSCALE_CONFIG'.freeze,
      ...
      OPERATION_TYPE_PATCH_BDS = 'PATCH_BDS'.freeze,
      OPERATION_TYPE_PATCH_ODH = 'PATCH_ODH'.freeze,
    ...
    # @option attributes [Array<OCI::Bds::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [id, compartment_id, operation_type, status, resources, percent_complete, time_accepted, time_started, time_finished].hash
    end
