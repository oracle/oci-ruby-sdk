...
module OCI
  ...
  class Bds::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_ADD_MASTER_NODES = 'ADD_MASTER_NODES'.freeze,
      OPERATION_TYPE_ADD_UTILITY_NODES = 'ADD_UTILITY_NODES'.freeze,
      ...
      OPERATION_TYPE_PATCH_OS = 'PATCH_OS'.freeze,
      OPERATION_TYPE_STOP_BDS = 'STOP_BDS'.freeze,
      OPERATION_TYPE_START_BDS = 'START_BDS'.freeze,
      OPERATION_TYPE_ADD_KAFKA = 'ADD_KAFKA'.freeze,
      OPERATION_TYPE_REMOVE_KAFKA = 'REMOVE_KAFKA'.freeze,
      OPERATION_TYPE_EXECUTE_BOOTSTRAP_SCRIPT = 'EXECUTE_BOOTSTRAP_SCRIPT'.freeze,
      OPERATION_TYPE_ODH_SERVICE_CERTIFICATE_UPDATE = 'ODH_SERVICE_CERTIFICATE_UPDATE'.freeze,
