...
module OCI
  ...
  class Bds::Models::MetricBasedHorizontalScaleInConfig
    ...
    # @option attributes [Integer] :min_node_count The value to assign to the {#min_node_count} property
    # @option attributes [Integer] :step_size The value to assign to the {#step_size} property
    def initialize(attributes = {})
      ...
      self.min_node_count = attributes[:'minNodeCount'] if attributes[:'minNodeCount']

      raise 'You cannot provide both :minNodeCount and :min_node_count' if attributes.key?(:'minNodeCount') && attributes.key?(:'min_node_count')

      self.min_node_count = attributes[:'min_node_count'] if attributes[:'min_node_count']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        metric == other.metric &&
        min_node_count == other.min_node_count &&
    ...
    def hash
      [metric, min_node_count, step_size].hash
    end
