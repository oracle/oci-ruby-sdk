...
module OCI
  ...
  class Bds::Models::HostSpecificCertificateDetails
    CERTIFICATE_TYPE_ENUM = [
      CERTIFICATE_TYPE_CUSTOM_SIGNED = 'CUSTOM_SIGNED'.freeze,
      CERTIFICATE_TYPE_SELF_SIGNED = 'SELF_SIGNED'.freeze,
    ...
    # @option attributes [DateTime] :time_expiry The value to assign to the {#time_expiry} property
    ...
    def hash
      [host_name, certificate_type, time_expiry].hash
    end
