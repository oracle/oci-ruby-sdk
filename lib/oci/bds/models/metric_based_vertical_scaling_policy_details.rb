...
module OCI
  ...
  #
  class Bds::Models::MetricBasedVerticalScalingPolicyDetails < Bds::Models::AutoScalePolicyDetails
    # @return [OCI::Bds::Models::MetricBasedVerticalScaleUpConfig]
    attr_accessor :scale_up_config

    # @return [OCI::Bds::Models::MetricBasedVerticalScaleDownConfig]
    attr_accessor :scale_down_config
    ...
    # @option attributes [OCI::Bds::Models::MetricBasedVerticalScaleUpConfig] :scale_up_config The value to assign to the {#scale_up_config} property
    # @option attributes [OCI::Bds::Models::MetricBasedVerticalScaleDownConfig] :scale_down_config The value to assign to the {#scale_down_config} property
    ...
    def hash
      [policy_type, trigger_type, action_type, scale_up_config, scale_down_config].hash
    end
