...
module OCI
  ...
  class Bds::Models::RemoveNodeDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_force_remove_enabled
    ...
    # @option attributes [BOOLEAN] :is_force_remove_enabled The value to assign to the {#is_force_remove_enabled} property
