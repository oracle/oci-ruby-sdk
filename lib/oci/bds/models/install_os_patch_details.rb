...
module OCI
  ...
  class Bds::Models::InstallOsPatchDetails
    ...
    # @return [OCI::Bds::Models::PatchingConfigs]
    attr_accessor :patching_configs
    ...
    def self.swagger_types
      {
        ...
        'patching_configs': :'OCI::Bds::Models::PatchingConfigs'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Bds::Models::PatchingConfigs] :patching_configs The value to assign to the {#patching_configs} property
    def initialize(attributes = {})
      ...
      self.patching_configs = attributes[:'patchingConfigs'] if attributes[:'patchingConfigs']

      raise 'You cannot provide both :patchingConfigs and :patching_configs' if attributes.key?(:'patchingConfigs') && attributes.key?(:'patching_configs')

      self.patching_configs = attributes[:'patching_configs'] if attributes[:'patching_configs']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        patching_configs == other.patching_configs
    end
    ...
    def hash
      [os_patch_version, cluster_admin_password, patching_configs].hash
    end
