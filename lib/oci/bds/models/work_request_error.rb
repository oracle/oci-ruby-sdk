...
module OCI
  ...
  class Bds::Models::WorkRequestError
    # **[Required]** A machine-usable code for the error that occurred. Error codes are listed on (https://docs.oracle.com/en-us/iaas/Content/API/References/apierrors.htm).
    #
    # @return [String]
    attr_accessor :code
    ...
    # **[Required]** The time the error occurred, shown as an RFC 3339 formatted datetime string.
    # @return [DateTime]
