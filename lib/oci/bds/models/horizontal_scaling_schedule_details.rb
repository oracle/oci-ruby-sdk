...
module OCI
  ...
  class Bds::Models::HorizontalScalingScheduleDetails
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'scheduleType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Bds::Models::DayBasedHorizontalScalingScheduleDetails' if type == 'DAY_BASED'
