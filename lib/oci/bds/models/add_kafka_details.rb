...
module OCI
  ...
  class Bds::Models::AddKafkaDetails
    ...
    # @return [Integer]
    attr_accessor :number_of_kafka_nodes
    ...
    # @option attributes [Integer] :number_of_kafka_nodes The value to assign to the {#number_of_kafka_nodes} property
    ...
    def initialize(attributes = {})
      ...
      self.number_of_kafka_nodes = attributes[:'numberOfKafkaNodes'] if attributes[:'numberOfKafkaNodes']

      raise 'You cannot provide both :numberOfKafkaNodes and :number_of_kafka_nodes' if attributes.key?(:'numberOfKafkaNodes') && attributes.key?(:'number_of_kafka_nodes')

      self.number_of_kafka_nodes = attributes[:'number_of_kafka_nodes'] if attributes[:'number_of_kafka_nodes']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        shape == other.shape &&
        number_of_kafka_nodes == other.number_of_kafka_nodes &&
    ...
    def hash
      [shape, number_of_kafka_nodes, shape_config, block_volume_size_in_gbs, cluster_admin_password].hash
    end
