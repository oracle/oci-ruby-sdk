...
module OCI
  ...
  class Bds::Models::AddUtilityNodesDetails
    ...
    # @return [Integer]
    attr_accessor :number_of_utility_nodes
    ...
    def self.swagger_types
      {
        ...
        'number_of_utility_nodes': :'Integer',
        'shape': :'String',
    ...
    # @option attributes [Integer] :number_of_utility_nodes The value to assign to the {#number_of_utility_nodes} property
    ...
    def initialize(attributes = {})
      ...
      self.number_of_utility_nodes = attributes[:'numberOfUtilityNodes'] if attributes[:'numberOfUtilityNodes']

      raise 'You cannot provide both :numberOfUtilityNodes and :number_of_utility_nodes' if attributes.key?(:'numberOfUtilityNodes') && attributes.key?(:'number_of_utility_nodes')

      self.number_of_utility_nodes = attributes[:'number_of_utility_nodes'] if attributes[:'number_of_utility_nodes']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        number_of_utility_nodes == other.number_of_utility_nodes &&
        shape == other.shape &&
    ...
    def hash
      [cluster_admin_password, number_of_utility_nodes, shape, block_volume_size_in_gbs, shape_config].hash
    end
