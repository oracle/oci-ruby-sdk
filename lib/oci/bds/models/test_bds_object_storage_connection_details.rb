...
module OCI
  ...
  class Bds::Models::TestBdsObjectStorageConnectionDetails
    ...
    # @return [String]
    attr_accessor :object_storage_uri
    ...
    # @option attributes [String] :object_storage_uri The value to assign to the {#object_storage_uri} property
    ...
    def initialize(attributes = {})
      ...
      self.object_storage_uri = attributes[:'objectStorageUri'] if attributes[:'objectStorageUri']

      raise 'You cannot provide both :objectStorageUri and :object_storage_uri' if attributes.key?(:'objectStorageUri') && attributes.key?(:'object_storage_uri')

      self.object_storage_uri = attributes[:'object_storage_uri'] if attributes[:'object_storage_uri']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        object_storage_uri == other.object_storage_uri &&
    ...
    def hash
      [object_storage_uri, passphrase, object_storage_region].hash
    end
