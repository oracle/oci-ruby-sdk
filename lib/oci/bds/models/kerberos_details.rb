...
module OCI
  ...
  class Bds::Models::KerberosDetails
    ...
    # @option attributes [String] :keytab_file The value to assign to the {#keytab_file} property
    def initialize(attributes = {})
      ...
      self.keytab_file = attributes[:'keytabFile'] if attributes[:'keytabFile']

      raise 'You cannot provide both :keytabFile and :keytab_file' if attributes.key?(:'keytabFile') && attributes.key?(:'keytab_file')

      self.keytab_file = attributes[:'keytab_file'] if attributes[:'keytab_file']
    end
    ...
    def hash
      [principal_name, keytab_file].hash
    end
