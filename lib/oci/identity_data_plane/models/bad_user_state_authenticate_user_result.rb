...
module OCI
  ...
  class IdentityDataPlane::Models::BadUserStateAuthenticateUserResult
    USER_STATE_ENUM = [
    ...
    # @return [String]
    attr_accessor :resolved_tenant_id

    # **[Required]** The resolved user id.
    # @return [String]
    attr_accessor :resolved_user_id
    ...
    # @option attributes [String] :resolved_tenant_id The value to assign to the {#resolved_tenant_id} property
    # @option attributes [String] :resolved_user_id The value to assign to the {#resolved_user_id} property
    # @option attributes [String] :user_state The value to assign to the {#user_state} property
    ...
    # @param [Object] user_state Object to be assigned
    def user_state=(user_state)
      raise "Invalid value for 'user_state': this must be one of the values in USER_STATE_ENUM." if user_state && !USER_STATE_ENUM.include?(user_state)
