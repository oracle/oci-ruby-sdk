...
module OCI
  ...
  class IdentityDataPlane::Models::GenerateUserSecurityTokenDetails
    ...
    #
    # @return [Integer]
    attr_accessor :session_expiration_in_minutes
    ...
    # @option attributes [Integer] :session_expiration_in_minutes The value to assign to the {#session_expiration_in_minutes} property
    def initialize(attributes = {})
      ...
      self.session_expiration_in_minutes = attributes[:'sessionExpirationInMinutes'] if attributes[:'sessionExpirationInMinutes']

      raise 'You cannot provide both :sessionExpirationInMinutes and :session_expiration_in_minutes' if attributes.key?(:'sessionExpirationInMinutes') && attributes.key?(:'session_expiration_in_minutes')

      self.session_expiration_in_minutes = attributes[:'session_expiration_in_minutes'] if attributes[:'session_expiration_in_minutes']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        session_expiration_in_minutes == other.session_expiration_in_minutes
    end
    ...
    def hash
      [public_key, session_expiration_in_minutes].hash
    end
