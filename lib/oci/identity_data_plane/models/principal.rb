...
module OCI
  # Principal model.
  class IdentityDataPlane::Models::Principal
    ...
    # @return [Array<OCI::IdentityDataPlane::Models::Claim>]
    ...
    def self.swagger_types
      {
        ...
        'subject_id': :'String',
        'tenant_id': :'String',
        'claims': :'Array<OCI::IdentityDataPlane::Models::Claim>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::IdentityDataPlane::Models::Claim>] :claims The value to assign to the {#claims} property
    def initialize(attributes = {})
      ...
      self.subject_id = attributes[:'subjectId'] if attributes[:'subjectId']

      raise 'You cannot provide both :subjectId and :subject_id' if attributes.key?(:'subjectId') && attributes.key?(:'subject_id')
      ...
      self.claims = attributes[:'claims'] if attributes[:'claims']
    end
    ...
    def hash
      [subject_id, tenant_id, claims].hash
    end
