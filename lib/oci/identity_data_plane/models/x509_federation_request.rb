...
module OCI
  ...
  class IdentityDataPlane::Models::X509FederationRequest
    # **[Required]** The x509 certificate of the service instance, issued by his CA.
    # @return [String]
    attr_accessor :certificate

    # **[Required]** A temporary public key, owned by the service. The service also owns the corresponding private key. This public
    ...
    # @option attributes [Array<String>] :intermediate_certificates The value to assign to the {#intermediate_certificates} property
    ...
    def hash
      [certificate, public_key, intermediate_certificates].hash
    end
