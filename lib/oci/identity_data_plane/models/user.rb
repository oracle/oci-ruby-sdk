...
module OCI
  # User model.
  class IdentityDataPlane::Models::User
    ...
    # @option attributes [BOOLEAN] :is_otp The value to assign to the {#is_otp} property
    # @option attributes [BOOLEAN] :is_mfa_activated The value to assign to the {#is_mfa_activated} property
    # @option attributes [BOOLEAN] :is_mfa_verified The value to assign to the {#is_mfa_verified} property
