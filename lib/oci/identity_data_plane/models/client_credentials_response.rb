...
module OCI
  ...
  class IdentityDataPlane::Models::ClientCredentialsResponse
    ...
    # @option attributes [String] :expires_in The value to assign to the {#expires_in} property
    def initialize(attributes = {})
      ...
      self.expires_in = attributes[:'expires_in'] if attributes[:'expires_in']
    end
