...
module OCI
  ...
  #
  class IdentityDataPlane::Models::AuthenticationPolicy
    # Password policy.
    # @return [OCI::IdentityDataPlane::Models::PasswordPolicy]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'password_policy': :'OCI::IdentityDataPlane::Models::PasswordPolicy',
    ...
    # @option attributes [OCI::IdentityDataPlane::Models::PasswordPolicy] :password_policy The value to assign to the {#password_policy} property
