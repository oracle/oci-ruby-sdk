...
module OCI
  ...
  class IdentityDataPlane::Models::IdentityProvider
    PROTOCOL_ENUM = [
    ...
    # @return [Array<String>]
    attr_accessor :authn_context_class_refs
    ...
    # @option attributes [String] :redirect_uri The value to assign to the {#redirect_uri} property
    # @option attributes [String] :signing_certificate The value to assign to the {#signing_certificate} property
    # @option attributes [String] :protocol The value to assign to the {#protocol} property
    # @option attributes [String] :service_provider_entity_id The value to assign to the {#service_provider_entity_id} property
    # @option attributes [BOOLEAN] :force_authentication The value to assign to the {#force_authentication} property
    # @option attributes [Array<String>] :authn_context_class_refs The value to assign to the {#authn_context_class_refs} property
