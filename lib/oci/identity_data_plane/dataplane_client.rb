...
module OCI
  ...
  class IdentityDataPlane::DataplaneClient
    ...
    def region=(new_region)
      ...
      @endpoint = OCI::Regions.get_service_endpoint_for_template(@region, 'https://auth.{region}.{secondLevelDomain}') + '/v1'
      logger.info "DataplaneClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    #
    # @param [OCI::IdentityDataPlane::Models::GenerateScopedAccessTokenDetails] generate_scoped_access_token_details Scoped Access token request
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @return [Response] A Response object with data of type {OCI::IdentityDataPlane::Models::SecurityToken SecurityToken}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/identitydataplane/generate_scoped_access_token.rb.html) to see an example of how to use generate_scoped_access_token API.
