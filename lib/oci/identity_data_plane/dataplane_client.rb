...
module OCI
  ...
  class IdentityDataPlane::DataplaneClient
    ...
    #
    # @param [OCI::IdentityDataPlane::Models::GenerateUserSecurityTokenDetails] generate_user_security_token_details The key-value pair object storing the token exchange request parameters required to obtain a UPST for self.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type {OCI::IdentityDataPlane::Models::SecurityToken SecurityToken}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/identitydataplane/generate_user_security_token.rb.html) to see an example of how to use generate_user_security_token API.
