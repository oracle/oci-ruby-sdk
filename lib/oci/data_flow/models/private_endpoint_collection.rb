...
module OCI
  ...
  class DataFlow::Models::PrivateEndpointCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DataFlow::Models::PrivateEndpointSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataFlow::Models::PrivateEndpointSummary>] :items The value to assign to the {#items} property
