...
module OCI
  ...
  class DataFlow::Models::Pool
    ...
    # @return [OCI::DataFlow::Models::PoolMetrics]
    attr_accessor :pool_metrics

    # **[Required]** List of PoolConfig items.
    #
    # @return [Array<OCI::DataFlow::Models::PoolConfig>]
    attr_accessor :configurations

    # A list of schedules for pool to auto start and stop.
    #
    # @return [Array<OCI::DataFlow::Models::PoolSchedule>]
    ...
    def self.swagger_types
      {
        ...
        'pool_metrics': :'OCI::DataFlow::Models::PoolMetrics',
    ...
    # @option attributes [OCI::DataFlow::Models::PoolMetrics] :pool_metrics The value to assign to the {#pool_metrics} property
    # @option attributes [Array<OCI::DataFlow::Models::PoolConfig>] :configurations The value to assign to the {#configurations} property
    # @option attributes [Array<OCI::DataFlow::Models::PoolSchedule>] :schedules The value to assign to the {#schedules} property
    ...
    def initialize(attributes = {})
      ...
      self.pool_metrics = attributes[:'poolMetrics'] if attributes[:'poolMetrics']

      raise 'You cannot provide both :poolMetrics and :pool_metrics' if attributes.key?(:'poolMetrics') && attributes.key?(:'pool_metrics')

      self.pool_metrics = attributes[:'pool_metrics'] if attributes[:'pool_metrics']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        pool_metrics == other.pool_metrics &&
    ...
    def hash
      [compartment_id, defined_tags, description, display_name, freeform_tags, id, lifecycle_details, lifecycle_state, owner_principal_id, owner_user_name, pool_metrics, configurations, schedules, idle_timeout_in_minutes, time_created, time_updated].hash
    end
