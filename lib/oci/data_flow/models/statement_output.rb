...
module OCI
  ...
  #
  class DataFlow::Models::StatementOutput
    STATUS_ENUM = [
      STATUS_OK = 'OK'.freeze,
    ...
    # @return [OCI::DataFlow::Models::StatementOutputData]
    attr_accessor :data
    ...
    # @option attributes [OCI::DataFlow::Models::StatementOutputData] :data The value to assign to the {#data} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [String] :error_name The value to assign to the {#error_name} property
    # @option attributes [String] :error_value The value to assign to the {#error_value} property
    # @option attributes [Array<String>] :traceback The value to assign to the {#traceback} property
