...
module OCI
  ...
  class DataFlow::Models::SqlEndpointVcnConfig < DataFlow::Models::SqlEndpointNetworkConfiguration
    ...
    def hash
      [network_type, vcn_id, subnet_id, host_name_prefix, nsg_ids, private_endpoint_ip].hash
    end
