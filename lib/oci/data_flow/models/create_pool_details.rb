...
module OCI
  ...
  #
  class DataFlow::Models::CreatePoolDetails
    ...
    def hash
      [compartment_id, display_name, description, configurations, schedules, idle_timeout_in_minutes, freeform_tags, defined_tags].hash
    end
