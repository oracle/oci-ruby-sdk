...
module OCI
  ...
  class DataFlow::Models::ApplicationSummary
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, id, language, lifecycle_state, owner_principal_id, owner_user_name, pool_id, spark_version, time_created, time_updated, type].hash
    end
