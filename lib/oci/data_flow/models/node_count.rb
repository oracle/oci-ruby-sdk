...
module OCI
  ...
  #
  class DataFlow::Models::NodeCount
    # The compute shape of the nodes that the count is for.
    #
    # @return [String]
    attr_accessor :logical_shape
    ...
    # @option attributes [String] :logical_shape The value to assign to the {#logical_shape} property
    ...
    def initialize(attributes = {})
      ...
      self.logical_shape = attributes[:'logicalShape'] if attributes[:'logicalShape']

      raise 'You cannot provide both :logicalShape and :logical_shape' if attributes.key?(:'logicalShape') && attributes.key?(:'logical_shape')

      self.logical_shape = attributes[:'logical_shape'] if attributes[:'logical_shape']
