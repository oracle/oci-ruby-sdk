...
module OCI
  ...
  #
  class DataFlow::Models::PoolCollection
    # **[Required]** A list of pools.
    #
    # @return [Array<OCI::DataFlow::Models::PoolSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DataFlow::Models::PoolSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataFlow::Models::PoolSummary>] :items The value to assign to the {#items} property
