...
module OCI
  ...
  class DataFlow::Models::SqlEndpointCollection
    # **[Required]** The collection of SqlEndpointSummary objects.
    # @return [Array<OCI::DataFlow::Models::SqlEndpointSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DataFlow::Models::SqlEndpointSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataFlow::Models::SqlEndpointSummary>] :items The value to assign to the {#items} property
