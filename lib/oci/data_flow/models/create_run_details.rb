...
module OCI
  ...
  class DataFlow::Models::CreateRunDetails
    ...
    def hash
      [application_log_config, application_id, archive_uri, arguments, compartment_id, configuration, defined_tags, display_name, driver_shape, driver_shape_config, execute, executor_shape, executor_shape_config, freeform_tags, logs_bucket_uri, metastore_id, num_executors, parameters, pool_id, spark_version, type, warehouse_bucket_uri, max_duration_in_minutes, idle_timeout_in_minutes].hash
    end
