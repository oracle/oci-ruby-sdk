...
module OCI
  ...
  #
  class DataFlow::Models::WorkRequest
    OPERATION_ENUM = [
      OPERATION_CREATE_PRIVATE_ENDPOINT = 'CREATE_PRIVATE_ENDPOINT'.freeze,
      OPERATION_UPDATE_PRIVATE_ENDPOINT = 'UPDATE_PRIVATE_ENDPOINT'.freeze,
      OPERATION_DELETE_PRIVATE_ENDPOINT = 'DELETE_PRIVATE_ENDPOINT'.freeze,
      OPERATION_MOVE_PRIVATE_ENDPOINT = 'MOVE_PRIVATE_ENDPOINT'.freeze,
    ...
    #
    # @return [Array<OCI::DataFlow::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DataFlow::Models::WorkRequestResource>',
        'status': :'String',
    ...
    # @option attributes [Array<OCI::DataFlow::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [compartment_id, id, operation, percent_complete, resources, status, time_accepted, time_started, time_finished].hash
    end
