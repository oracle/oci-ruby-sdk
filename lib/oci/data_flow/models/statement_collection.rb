...
module OCI
  ...
  #
  class DataFlow::Models::StatementCollection
    # **[Required]** A list of statements for a Session Run.
    #
    # @return [Array<OCI::DataFlow::Models::StatementSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DataFlow::Models::StatementSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataFlow::Models::StatementSummary>] :items The value to assign to the {#items} property
