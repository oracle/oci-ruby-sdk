...
module OCI
  ...
  class DataFlow::Models::SqlEndpointNetworkConfiguration
    NETWORK_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'networkType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::DataFlow::Models::SqlEndpointVcnConfig' if type == 'VCN'
      return 'OCI::DataFlow::Models::SqlEndpointSecureAccessConfig' if type == 'SECURE_ACCESS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataFlow::Models::SqlEndpointNetworkConfiguration'
    end
    ...
    def initialize(attributes = {})
      ...
      self.network_type = "SECURE_ACCESS" if network_type.nil? && !attributes.key?(:'networkType') # rubocop:disable Style/StringLiterals
      ...
      self.network_type = "SECURE_ACCESS" if network_type.nil? && !attributes.key?(:'networkType') && !attributes.key?(:'network_type') # rubocop:disable Style/StringLiterals
    end
