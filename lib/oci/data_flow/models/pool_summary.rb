...
module OCI
  ...
  #
  class DataFlow::Models::PoolSummary
    ...
    # **[Required]** The username of the user who created the resource.  If the username of the owner does not exist,
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, id, lifecycle_state, owner_principal_id, owner_user_name, time_created, time_updated].hash
    end
