...
module OCI
  ...
  #
  class DataFlow::Models::PoolConfig
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'shape': :'String',
        'shape_config': :'OCI::DataFlow::Models::ShapeConfig',
        'min': :'Integer',
        'max': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [OCI::DataFlow::Models::ShapeConfig] :shape_config The value to assign to the {#shape_config} property
    ...
    def hash
      [shape, shape_config, min, max].hash
    end
