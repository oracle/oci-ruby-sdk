...
module OCI
  ...
  class DataFlow::Models::SqlEndpoint
    ...
    # @option attributes [String] :banner_message The value to assign to the {#banner_message} property
