...
module OCI
  # A statement object.
  #
  class DataFlow::Models::Statement
    LIFECYCLE_STATE_ENUM = [
      LIFECYCLE_STATE_ACCEPTED = 'ACCEPTED'.freeze,
      LIFECYCLE_STATE_CANCELLING = 'CANCELLING'.freeze,
    ...
    # **[Required]** The statement code to execute.
    ...
    # @return [OCI::DataFlow::Models::StatementOutput]
    ...
    def self.swagger_types
      {
        ...
        'output': :'OCI::DataFlow::Models::StatementOutput',
        'progress': :'Float',
        'run_id': :'String',
    ...
    # @option attributes [OCI::DataFlow::Models::StatementOutput] :output The value to assign to the {#output} property
    # @option attributes [Float] :progress The value to assign to the {#progress} property
    ...
    def hash
      [id, code, lifecycle_state, output, progress, run_id, time_created, time_completed].hash
    end
