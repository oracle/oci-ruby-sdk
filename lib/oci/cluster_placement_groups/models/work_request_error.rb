...
module OCI
  ...
  class ClusterPlacementGroups::Models::WorkRequestError
    ...
    # **[Required]** The time the error occured, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    # @return [DateTime]
