...
module OCI
  ...
  class ClusterPlacementGroups::Models::WorkRequestLogEntry
    # **[Required]** Human-readable log message.
    # @return [String]
    attr_accessor :message

    # **[Required]** The time the log message was written, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    # @return [DateTime]
