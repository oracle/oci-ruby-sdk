...
require 'date'
require_relative 'create_private_application_package'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # An object for creating a private application stack package.
  class ServiceCatalog::Models::CreatePrivateApplicationStackPackage < ServiceCatalog::Models::CreatePrivateApplicationPackage
    ...
    # @option attributes [String] :version The value to assign to the {OCI::ServiceCatalog::Models::CreatePrivateApplicationPackage#version #version} proprety
    ...
    def hash
      [package_type, version, zip_file_base64_encoded].hash
    end
