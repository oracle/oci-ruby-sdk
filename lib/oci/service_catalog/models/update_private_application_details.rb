...
module OCI
  ...
  class ServiceCatalog::Models::UpdatePrivateApplicationDetails
    ...
    def hash
      [display_name, short_description, long_description, logo_file_base64_encoded, defined_tags, freeform_tags].hash
    end
