...
module OCI
  ...
  class ServiceCatalog::Models::ServiceCatalog
    ...
    # **[Required]** The date and time the service catalog was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_state, time_created, time_updated, defined_tags, freeform_tags].hash
    end
