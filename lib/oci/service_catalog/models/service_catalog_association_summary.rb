...
module OCI
  ...
  class ServiceCatalog::Models::ServiceCatalogAssociationSummary
    ...
    # @return [String]
    attr_accessor :service_catalog_id
    ...
    # @option attributes [String] :service_catalog_id The value to assign to the {#service_catalog_id} property
    ...
    def initialize(attributes = {})
      ...
      self.service_catalog_id = attributes[:'serviceCatalogId'] if attributes[:'serviceCatalogId']

      raise 'You cannot provide both :serviceCatalogId and :service_catalog_id' if attributes.key?(:'serviceCatalogId') && attributes.key?(:'service_catalog_id')

      self.service_catalog_id = attributes[:'service_catalog_id'] if attributes[:'service_catalog_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        id == other.id &&
        service_catalog_id == other.service_catalog_id &&
    ...
    def hash
      [id, service_catalog_id, entity_id, entity_type, time_created].hash
    end
