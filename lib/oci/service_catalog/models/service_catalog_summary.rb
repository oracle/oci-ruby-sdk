...
module OCI
  ...
  class ServiceCatalog::Models::ServiceCatalogSummary
    ...
    # **[Required]** The date and time this service catalog was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    ...
    def hash
      [id, lifecycle_state, compartment_id, display_name, time_created].hash
    end
