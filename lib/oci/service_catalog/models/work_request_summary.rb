...
module OCI
  ...
  class ServiceCatalog::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::ServiceCatalog::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::ServiceCatalog::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::ServiceCatalog::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
