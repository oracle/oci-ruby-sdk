...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::UserExtRiskScores
    RISK_LEVEL_ENUM = [
    ...
    # @option attributes [Integer] :score The value to assign to the {#score} property
    # @option attributes [String] :risk_level The value to assign to the {#risk_level} property
    # @option attributes [String] :last_update_timestamp The value to assign to the {#last_update_timestamp} property
