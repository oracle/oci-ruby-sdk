...
module OCI
  # The user's API key.
  class IdentityDomains::Models::ApiKey
    ...
    # @return [OCI::IdentityDomains::Models::ApiKeyUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'fingerprint': :'String',
        'key': :'String',
        'user': :'OCI::IdentityDomains::Models::ApiKeyUser',
    ...
    # @option attributes [OCI::IdentityDomains::Models::ApiKeyUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, description, fingerprint, key, user, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
