...
module OCI
  ...
  class IdentityDomains::Models::CloudGates
    ...
    # @return [Array<OCI::IdentityDomains::Models::CloudGate>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::CloudGate>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGate>] :resources The value to assign to the {#resources} property
