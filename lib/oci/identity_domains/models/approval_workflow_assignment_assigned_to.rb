...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::ApprovalWorkflowAssignmentAssignedTo
    TYPE_ENUM = [
      TYPE_GROUP = 'Group'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Identifier of the resource for which Approval Workflow is assigned
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    # **[Required]** Type of the resource (stripe and non-stripe) for which Approval Workflow is assigned
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    def hash
      [value, ocid, type, display, description].hash
    end
