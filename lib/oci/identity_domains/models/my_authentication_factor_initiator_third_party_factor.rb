...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::MyAuthenticationFactorInitiatorThirdPartyFactor
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :third_party_factor_type
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :third_party_factor_id
    ...
    # @option attributes [String] :third_party_factor_type The value to assign to the {#third_party_factor_type} property
    # @option attributes [String] :third_party_factor_id The value to assign to the {#third_party_factor_id} property
    def initialize(attributes = {})
      ...
      self.third_party_factor_id = attributes[:'thirdPartyFactorId'] if attributes[:'thirdPartyFactorId']

      raise 'You cannot provide both :thirdPartyFactorId and :third_party_factor_id' if attributes.key?(:'thirdPartyFactorId') && attributes.key?(:'third_party_factor_id')

      self.third_party_factor_id = attributes[:'third_party_factor_id'] if attributes[:'third_party_factor_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        third_party_factor_id == other.third_party_factor_id
    end
    ...
    def hash
      [third_party_vendor_name, third_party_factor_type, third_party_factor_id].hash
    end
