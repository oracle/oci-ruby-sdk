...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::AppObjectClasses
    TYPE_ENUM = [
      TYPE_ACCOUNT_OBJECT_CLASS = 'AccountObjectClass'.freeze,
      TYPE_MANAGED_OBJECT_CLASS = 'ManagedObjectClass'.freeze,
    ...
    #  - uniqueness: none
    # @return [BOOLEAN]
    attr_accessor :is_account_object_class
    ...
    # @option attributes [BOOLEAN] :is_account_object_class The value to assign to the {#is_account_object_class} property
    ...
    def initialize(attributes = {})
      ...
      self.is_account_object_class = attributes[:'isAccountObjectClass'] unless attributes[:'isAccountObjectClass'].nil?

      raise 'You cannot provide both :isAccountObjectClass and :is_account_object_class' if attributes.key?(:'isAccountObjectClass') && attributes.key?(:'is_account_object_class')

      self.is_account_object_class = attributes[:'is_account_object_class'] unless attributes[:'is_account_object_class'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_account_object_class == other.is_account_object_class &&
        type == other.type
    end
    ...
    def hash
      [value, ref, display, resource_type, is_account_object_class, type].hash
    end
