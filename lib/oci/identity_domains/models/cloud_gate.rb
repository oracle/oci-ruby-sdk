...
module OCI
  ...
  class IdentityDomains::Models::CloudGate
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::CloudGateExtUpstreamServerGroups>]
    attr_accessor :upstream_server_groups
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::CloudGateExtUpstreamServers>]
    attr_accessor :upstream_servers

    # @return [OCI::IdentityDomains::Models::CloudGateOauthClient]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::CloudGateExtServers>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::CloudGateExtMappings>]
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateExtUpstreamServerGroups>] :upstream_server_groups The value to assign to the {#upstream_server_groups} property
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateExtUpstreamServers>] :upstream_servers The value to assign to the {#upstream_servers} property
    # @option attributes [OCI::IdentityDomains::Models::CloudGateOauthClient] :oauth_client The value to assign to the {#oauth_client} property
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateExtServers>] :servers The value to assign to the {#servers} property
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateExtMappings>] :mappings The value to assign to the {#mappings} property
