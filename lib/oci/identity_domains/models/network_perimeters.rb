...
module OCI
  ...
  class IdentityDomains::Models::NetworkPerimeters
    ...
    # @return [Array<OCI::IdentityDomains::Models::NetworkPerimeter>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::NetworkPerimeter>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::NetworkPerimeter>] :resources The value to assign to the {#resources} property
