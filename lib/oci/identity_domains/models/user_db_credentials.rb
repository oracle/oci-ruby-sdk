...
module OCI
  ...
  class IdentityDomains::Models::UserDbCredentials
    ...
    # @return [Array<OCI::IdentityDomains::Models::UserDbCredential>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::UserDbCredential>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::UserDbCredential>] :resources The value to assign to the {#resources} property
