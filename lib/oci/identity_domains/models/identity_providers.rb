...
module OCI
  ...
  class IdentityDomains::Models::IdentityProviders
    ...
    # @return [Array<OCI::IdentityDomains::Models::IdentityProvider>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::IdentityProvider>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProvider>] :resources The value to assign to the {#resources} property
