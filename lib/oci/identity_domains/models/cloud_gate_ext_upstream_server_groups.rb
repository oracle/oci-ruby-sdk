...
module OCI
  ...
  class IdentityDomains::Models::CloudGateExtUpstreamServerGroups
    # **[Required]** Name for the Upstream Block
    #
    # **Added In:** 20.1.3
    #
    # **SCIM++ Properties:**
    ...
    # **[Required]** Display name of upstream
    #
    # **Added In:** 20.1.3
    #
    # **SCIM++ Properties:**
    ...
    def hash
      [value, ref, nginx_settings, ssl, display_name].hash
    end
