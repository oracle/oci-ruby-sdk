...
module OCI
  ...
  class IdentityDomains::Models::MyGroups
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyGroup>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyGroup>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyGroup>] :resources The value to assign to the {#resources} property
