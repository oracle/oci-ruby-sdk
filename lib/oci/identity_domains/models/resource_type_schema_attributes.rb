...
module OCI
  ...
  class IdentityDomains::Models::ResourceTypeSchemaAttributes
    ...
    # @return [Array<OCI::IdentityDomains::Models::ResourceTypeSchemaAttribute>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::ResourceTypeSchemaAttribute>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::ResourceTypeSchemaAttribute>] :resources The value to assign to the {#resources} property
