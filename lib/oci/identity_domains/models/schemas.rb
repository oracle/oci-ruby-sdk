...
module OCI
  ...
  class IdentityDomains::Models::Schemas
    ...
    # @return [Array<OCI::IdentityDomains::Models::Schema>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Schema>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Schema>] :resources The value to assign to the {#resources} property
