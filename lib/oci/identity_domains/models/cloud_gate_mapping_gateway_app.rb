...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::CloudGateMappingGatewayApp
    # **[Required]** The name (Client ID) of the gateway application protected by this Cloud Gate.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    ...
    # **[Required]** The id of the gateway application protected by this Cloud Gate.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
