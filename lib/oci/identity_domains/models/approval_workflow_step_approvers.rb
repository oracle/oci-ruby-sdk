...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflowStepApprovers
    # **[Required]** The unique identifier of the approver.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    # **[Required]** The type of the approver.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    def hash
      [value, ocid, type, display, ref].hash
    end
