...
module OCI
  ...
  class IdentityDomains::Models::CloudGateMappings
    ...
    # @return [Array<OCI::IdentityDomains::Models::CloudGateMapping>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::CloudGateMapping>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateMapping>] :resources The value to assign to the {#resources} property
