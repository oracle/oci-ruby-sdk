...
module OCI
  ...
  class IdentityDomains::Models::KmsiSettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::KmsiSetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::KmsiSetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::KmsiSetting>] :resources The value to assign to the {#resources} property
