...
module OCI
  ...
  #  - returned: request
  #  - type: complex
  class IdentityDomains::Models::GroupExtDomainLevelSchemaNames
    # **[Required]** DBCS Domain Name
    #
    # **Added In:** 18.2.4
    #
    # **SCIM++ Properties:**
    ...
    # **[Required]** The DBCS schema-name granted to this group in the DB domain that 'domainName' specifies.
    #
    # **Added In:** 18.2.4
    #
    # **SCIM++ Properties:**
