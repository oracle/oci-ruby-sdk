...
module OCI
  ...
  class IdentityDomains::Models::MyAuthenticationFactorsRemover
    ...
    TYPE_ENUM = [
      TYPE_KMSI = 'KMSI'.freeze,
      TYPE_MFA = 'MFA'.freeze,
      TYPE_ACCOUNTRECOVERY = 'ACCOUNTRECOVERY'.freeze,
      TYPE_ALL = 'ALL'.freeze,
    ...
    # @return [OCI::IdentityDomains::Models::MyAuthenticationFactorsRemoverUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'tenancy_ocid': :'String',
        'user': :'OCI::IdentityDomains::Models::MyAuthenticationFactorsRemoverUser',
        'type': :'String',
        'token': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [OCI::IdentityDomains::Models::MyAuthenticationFactorsRemoverUser] :user The value to assign to the {#user} property
