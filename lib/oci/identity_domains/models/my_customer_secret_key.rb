...
module OCI
  ...
  class IdentityDomains::Models::MyCustomerSecretKey
    ...
    # @return [OCI::IdentityDomains::Models::MyCustomerSecretKeyUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'expires_on': :'String',
        'access_key': :'String',
        'user': :'OCI::IdentityDomains::Models::MyCustomerSecretKeyUser'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::MyCustomerSecretKeyUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, display_name, description, status, expires_on, access_key, user].hash
    end
