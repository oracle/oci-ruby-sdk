...
module OCI
  ...
  class IdentityDomains::Models::MyCompletedApprovals
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyCompletedApproval>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyCompletedApproval>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyCompletedApproval>] :resources The value to assign to the {#resources} property
