...
module OCI
  ...
  class IdentityDomains::Models::Users
    ...
    # @return [Array<OCI::IdentityDomains::Models::User>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::User>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::User>] :resources The value to assign to the {#resources} property
