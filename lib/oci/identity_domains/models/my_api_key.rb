...
module OCI
  # The user's API key.
  class IdentityDomains::Models::MyApiKey
    ...
    # @return [OCI::IdentityDomains::Models::MyApiKeyUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'fingerprint': :'String',
        'key': :'String',
        'user': :'OCI::IdentityDomains::Models::MyApiKeyUser'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::MyApiKeyUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, description, fingerprint, key, user].hash
    end
