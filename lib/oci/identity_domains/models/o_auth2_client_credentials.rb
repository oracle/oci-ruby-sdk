...
module OCI
  ...
  class IdentityDomains::Models::OAuth2ClientCredentials
    ...
    # @return [Array<OCI::IdentityDomains::Models::OAuth2ClientCredential>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::OAuth2ClientCredential>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::OAuth2ClientCredential>] :resources The value to assign to the {#resources} property
