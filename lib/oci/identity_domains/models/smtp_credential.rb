...
module OCI
  ...
  class IdentityDomains::Models::SmtpCredential
    ...
    # @return [OCI::IdentityDomains::Models::SmtpCredentialUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'expires_on': :'String',
        'user_name': :'String',
        'user': :'OCI::IdentityDomains::Models::SmtpCredentialUser',
    ...
    # @option attributes [OCI::IdentityDomains::Models::SmtpCredentialUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, description, status, expires_on, user_name, user, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
