...
module OCI
  ...
  class IdentityDomains::Models::MyRequests
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyRequest>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyRequest>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyRequest>] :resources The value to assign to the {#resources} property
