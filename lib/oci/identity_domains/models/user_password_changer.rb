...
module OCI
  ...
  class IdentityDomains::Models::UserPasswordChanger
    ...
    # **[Required]** The password attribute. The maximum length for the password is set in the password policy.
    #
    # **SCIM++ Properties:**
    #  - type: string
    #  - multiValued: false
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, password, bypass_notification, notification_email_template_id, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
