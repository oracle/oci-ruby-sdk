...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::UserExtApplicableAuthenticationTargetApp
    # App identifier
    #
    # **Added In:** 18.1.6
    #
    ...
    #  - uniqueness: none
    # @return [Integer]
    attr_accessor :target_request_timeout
    ...
    # @option attributes [Integer] :target_request_timeout The value to assign to the {#target_request_timeout} property
