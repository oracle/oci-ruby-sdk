...
module OCI
  ...
  class IdentityDomains::Models::Groups
    ...
    # @return [Array<OCI::IdentityDomains::Models::Group>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Group>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Group>] :resources The value to assign to the {#resources} property
