...
module OCI
  ...
  class IdentityDomains::Models::AccountMgmtInfos
    ...
    # @return [Array<OCI::IdentityDomains::Models::AccountMgmtInfo>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::AccountMgmtInfo>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::AccountMgmtInfo>] :resources The value to assign to the {#resources} property
