...
module OCI
  ...
  class IdentityDomains::Models::OAuth2ClientCredential
    ...
    #  - required: true
    #  - returned: default
    # @return [Array<OCI::IdentityDomains::Models::OAuth2ClientCredentialScopes>]
    attr_accessor :scopes

    # @return [OCI::IdentityDomains::Models::OAuth2ClientCredentialUser]
    attr_accessor :user
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::OAuth2ClientCredentialScopes>] :scopes The value to assign to the {#scopes} property
    # @option attributes [OCI::IdentityDomains::Models::OAuth2ClientCredentialUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, name, description, status, expires_on, is_reset_secret, scopes, user, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
