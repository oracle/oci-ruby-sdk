...
module OCI
  ...
  class IdentityDomains::Models::Policy
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::PolicyRules>]
    attr_accessor :rules

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::PolicyPolicyType]
    ...
    def self.swagger_types
      {
        ...
        'rules': :'Array<OCI::IdentityDomains::Models::PolicyRules>',
        'policy_type': :'OCI::IdentityDomains::Models::PolicyPolicyType'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :policy_groovy The value to assign to the {#policy_groovy} property
    # @option attributes [Array<OCI::IdentityDomains::Models::PolicyRules>] :rules The value to assign to the {#rules} property
    # @option attributes [OCI::IdentityDomains::Models::PolicyPolicyType] :policy_type The value to assign to the {#policy_type} property
    def initialize(attributes = {})
      ...
      self.policy_groovy = attributes[:'policyGroovy'] if attributes[:'policyGroovy']

      raise 'You cannot provide both :policyGroovy and :policy_groovy' if attributes.key?(:'policyGroovy') && attributes.key?(:'policy_groovy')

      self.policy_groovy = attributes[:'policy_groovy'] if attributes[:'policy_groovy']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        active == other.active &&
        policy_groovy == other.policy_groovy &&
        rules == other.rules &&
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, name, description, active, policy_groovy, rules, policy_type].hash
    end
