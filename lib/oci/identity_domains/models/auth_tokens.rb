...
module OCI
  ...
  class IdentityDomains::Models::AuthTokens
    ...
    # @return [Array<OCI::IdentityDomains::Models::AuthToken>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::AuthToken>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::AuthToken>] :resources The value to assign to the {#resources} property
