...
module OCI
  ...
  class IdentityDomains::Models::AppProtectableSecondaryAudiences
    # **[Required]** The value of an secondary audience--additional URI to be added automatically to any OAuth token that allows access to this App.
    #
    # **Added In:** 18.2.2
    #
    # **SCIM++ Properties:**
