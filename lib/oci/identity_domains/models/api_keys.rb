...
module OCI
  ...
  class IdentityDomains::Models::ApiKeys
    ...
    # @return [Array<OCI::IdentityDomains::Models::ApiKey>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::ApiKey>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::ApiKey>] :resources The value to assign to the {#resources} property
