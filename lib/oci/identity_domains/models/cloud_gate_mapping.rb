...
module OCI
  ...
  class IdentityDomains::Models::CloudGateMapping
    ...
    # @return [OCI::IdentityDomains::Models::CloudGateMappingUpstreamServerGroup]
    attr_accessor :upstream_server_group

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::CloudGateMappingServer]
    attr_accessor :server

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::CloudGateMappingGatewayApp]
    attr_accessor :gateway_app

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::CloudGateMappingCloudGate]
    ...
    # @option attributes [OCI::IdentityDomains::Models::CloudGateMappingUpstreamServerGroup] :upstream_server_group The value to assign to the {#upstream_server_group} property
    # @option attributes [OCI::IdentityDomains::Models::CloudGateMappingServer] :server The value to assign to the {#server} property
    # @option attributes [OCI::IdentityDomains::Models::CloudGateMappingGatewayApp] :gateway_app The value to assign to the {#gateway_app} property
    # @option attributes [OCI::IdentityDomains::Models::CloudGateMappingCloudGate] :cloud_gate The value to assign to the {#cloud_gate} property
    def initialize(attributes = {})
      ...
      self.upstream_server_group = attributes[:'upstreamServerGroup'] if attributes[:'upstreamServerGroup']

      raise 'You cannot provide both :upstreamServerGroup and :upstream_server_group' if attributes.key?(:'upstreamServerGroup') && attributes.key?(:'upstream_server_group')

      self.upstream_server_group = attributes[:'upstream_server_group'] if attributes[:'upstream_server_group']

      self.server = attributes[:'server'] if attributes[:'server']

      self.gateway_app = attributes[:'gatewayApp'] if attributes[:'gatewayApp']

      raise 'You cannot provide both :gatewayApp and :gateway_app' if attributes.key?(:'gatewayApp') && attributes.key?(:'gateway_app')

      self.gateway_app = attributes[:'gateway_app'] if attributes[:'gateway_app']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        upstream_server_group == other.upstream_server_group &&
        server == other.server &&
        gateway_app == other.gateway_app &&
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, is_opc_service, description, resource_prefix, proxy_pass, nginx_settings, policy_name, upstream_server_group, server, gateway_app, cloud_gate].hash
    end
