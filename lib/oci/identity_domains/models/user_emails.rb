...
module OCI
  ...
  class IdentityDomains::Models::UserEmails
    TYPE_ENUM = [
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :pending_verification_data
    ...
    # @option attributes [BOOLEAN] :primary The value to assign to the {#primary} property
    # @option attributes [BOOLEAN] :secondary The value to assign to the {#secondary} property
    # @option attributes [BOOLEAN] :verified The value to assign to the {#verified} property
    # @option attributes [String] :pending_verification_data The value to assign to the {#pending_verification_data} property
