...
module OCI
  ...
  class IdentityDomains::Models::Apps
    ...
    # @return [Array<OCI::IdentityDomains::Models::App>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::App>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::App>] :resources The value to assign to the {#resources} property
