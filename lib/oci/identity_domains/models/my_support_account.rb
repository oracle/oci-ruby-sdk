...
module OCI
  ...
  class IdentityDomains::Models::MySupportAccount
    ...
    # **[Required]** User Support Account Token
    #
    # **Added In:** 2102181953
    #
    # **SCIM++ Properties:**
    ...
    # @return [OCI::IdentityDomains::Models::MySupportAccountUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'provider': :'String',
        'user_id': :'String',
        'user': :'OCI::IdentityDomains::Models::MySupportAccountUser'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::MySupportAccountUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, token, provider, user_id, user].hash
    end
