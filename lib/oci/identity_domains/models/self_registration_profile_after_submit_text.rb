...
module OCI
  ...
  class IdentityDomains::Models::SelfRegistrationProfileAfterSubmitText
    ...
    # **[Required]** Localized value of after submit text in corresponding locale
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - idcsSearchable: true
    ...
    # @option attributes [BOOLEAN] :default The value to assign to the {#default} property
    def initialize(attributes = {})
      ...
      self.default = attributes[:'default'] unless attributes[:'default'].nil?
    end
