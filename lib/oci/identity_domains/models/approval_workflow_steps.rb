...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflowSteps
    ...
    # @return [Array<OCI::IdentityDomains::Models::ApprovalWorkflowStep>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::ApprovalWorkflowStep>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::ApprovalWorkflowStep>] :resources The value to assign to the {#resources} property
