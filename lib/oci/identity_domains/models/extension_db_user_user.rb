...
module OCI
  # DB User extension
  class IdentityDomains::Models::ExtensionDbUserUser
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::UserExtPasswordVerifiers>]
    attr_accessor :password_verifiers
    ...
    # @option attributes [BOOLEAN] :is_db_user The value to assign to the {#is_db_user} property
    # @option attributes [Array<OCI::IdentityDomains::Models::UserExtPasswordVerifiers>] :password_verifiers The value to assign to the {#password_verifiers} property
    ...
    # @option attributes [Array<String>] :db_global_roles The value to assign to the {#db_global_roles} property
