...
module OCI
  ...
  class IdentityDomains::Models::BrandingSettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::BrandingSetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::BrandingSetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::BrandingSetting>] :resources The value to assign to the {#resources} property
