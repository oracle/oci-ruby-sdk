...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflowAssignment
    ...
    ASSIGNMENT_TYPE_ENUM = [
      ASSIGNMENT_TYPE_MEMBERSHIP = 'MEMBERSHIP'.freeze,
      ASSIGNMENT_TYPE_ACTIVATION = 'ACTIVATION'.freeze,
      ASSIGNMENT_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** Type of approval workflow assignment to the resource. Resources like Group have only one workflow associated (default assignment type is membership), but resources like TemporalBusinessRole can have atleast 2 AWs attached, one for membership to TPR, another for activation of that TPR membership
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    # @return [OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentApprovalWorkflow]
    attr_accessor :approval_workflow

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentAssignedTo]
    ...
    def self.swagger_types
      {
        ...
        'approval_workflow': :'OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentApprovalWorkflow',
        'assigned_to': :'OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentAssignedTo'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :assignment_type The value to assign to the {#assignment_type} property
    # @option attributes [OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentApprovalWorkflow] :approval_workflow The value to assign to the {#approval_workflow} property
    # @option attributes [OCI::IdentityDomains::Models::ApprovalWorkflowAssignmentAssignedTo] :assigned_to The value to assign to the {#assigned_to} property
    def initialize(attributes = {})
      ...
      self.assignment_type = attributes[:'assignmentType'] if attributes[:'assignmentType']

      raise 'You cannot provide both :assignmentType and :assignment_type' if attributes.key?(:'assignmentType') && attributes.key?(:'assignment_type')

      self.assignment_type = attributes[:'assignment_type'] if attributes[:'assignment_type']

      self.approval_workflow = attributes[:'approvalWorkflow'] if attributes[:'approvalWorkflow']

      raise 'You cannot provide both :approvalWorkflow and :approval_workflow' if attributes.key?(:'approvalWorkflow') && attributes.key?(:'approval_workflow')

      self.approval_workflow = attributes[:'approval_workflow'] if attributes[:'approval_workflow']

      self.assigned_to = attributes[:'assignedTo'] if attributes[:'assignedTo']

      raise 'You cannot provide both :assignedTo and :assigned_to' if attributes.key?(:'assignedTo') && attributes.key?(:'assigned_to')

      self.assigned_to = attributes[:'assigned_to'] if attributes[:'assigned_to']
    end
    ...
    def assignment_type=(assignment_type)
      # rubocop:disable Style/ConditionalAssignment
      if assignment_type && !ASSIGNMENT_TYPE_ENUM.include?(assignment_type)
        OCI.logger.debug("Unknown value for 'assignment_type' [" + assignment_type + "]. Mapping to 'ASSIGNMENT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @assignment_type = ASSIGNMENT_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        assignment_type == other.assignment_type &&
        approval_workflow == other.approval_workflow &&
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, assignment_type, approval_workflow, assigned_to].hash
    end
