...
module OCI
  ...
  class IdentityDomains::Models::Rules
    ...
    # @return [Array<OCI::IdentityDomains::Models::Rule>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Rule>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Rule>] :resources The value to assign to the {#resources} property
