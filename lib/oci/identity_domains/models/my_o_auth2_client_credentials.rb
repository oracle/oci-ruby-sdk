...
module OCI
  ...
  class IdentityDomains::Models::MyOAuth2ClientCredentials
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyOAuth2ClientCredential>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyOAuth2ClientCredential>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyOAuth2ClientCredential>] :resources The value to assign to the {#resources} property
