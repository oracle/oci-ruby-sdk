...
module OCI
  ...
  class IdentityDomains::Models::SchemaResolveValueUsingResourceType
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :value_to_be_resolved
    ...
    # @option attributes [String] :value_to_be_resolved The value to assign to the {#value_to_be_resolved} property
    # @option attributes [String] :resolve_by The value to assign to the {#resolve_by} property
