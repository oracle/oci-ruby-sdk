...
module OCI
  ...
  class IdentityDomains::Models::PasswordPolicyConfiguredPasswordPolicyRules
    # **[Required]** The specific password policy rule
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - multiValued: false
    ...
    # **[Required]** User-friendly text that describes a specific password policy rule
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - multiValued: false
