...
module OCI
  ...
  class IdentityDomains::Models::MyApp
    ...
    # @return [OCI::IdentityDomains::Models::MyAppApp]
    attr_accessor :app

    # @return [OCI::IdentityDomains::Models::MyAppOwner]
    attr_accessor :owner
    ...
    # @return [OCI::IdentityDomains::Models::MyAppUserWalletArtifact]
    ...
    # @option attributes [OCI::IdentityDomains::Models::MyAppApp] :app The value to assign to the {#app} property
    # @option attributes [OCI::IdentityDomains::Models::MyAppOwner] :owner The value to assign to the {#owner} property
    ...
    # @option attributes [String] :launch_url The value to assign to the {#launch_url} property
    # @option attributes [OCI::IdentityDomains::Models::MyAppUserWalletArtifact] :user_wallet_artifact The value to assign to the {#user_wallet_artifact} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, uid, name, app, owner, active, account_type, is_account, favorite, last_accessed, launch_url, user_wallet_artifact].hash
    end
