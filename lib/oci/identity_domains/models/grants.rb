...
module OCI
  ...
  class IdentityDomains::Models::Grants
    ...
    # @return [Array<OCI::IdentityDomains::Models::Grant>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Grant>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Grant>] :resources The value to assign to the {#resources} property
