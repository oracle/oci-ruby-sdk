...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::UserExtLocked
    ...
    # @option attributes [Integer] :reason The value to assign to the {#reason} property
    # @option attributes [BOOLEAN] :on The value to assign to the {#on} property
    # @option attributes [String] :lock_date The value to assign to the {#lock_date} property
    ...
    def initialize(attributes = {})
      ...
      self.on = attributes[:'on'] unless attributes[:'on'].nil?

      self.lock_date = attributes[:'lockDate'] if attributes[:'lockDate']

      raise 'You cannot provide both :lockDate and :lock_date' if attributes.key?(:'lockDate') && attributes.key?(:'lock_date')

      self.lock_date = attributes[:'lock_date'] if attributes[:'lock_date']
    ...
    def hash
      [reason, on, lock_date, expired].hash
    end
