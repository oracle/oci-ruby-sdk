...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::NotificationSettingsFromEmailAddress
    VALIDATION_STATUS_ENUM = [
      VALIDATION_STATUS_VERIFIED = 'VERIFIED'.freeze,
      VALIDATION_STATUS_PENDING = 'PENDING'.freeze,
      VALIDATION_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    VALIDATE_ENUM = [
      VALIDATE_EMAIL = 'email'.freeze,
      VALIDATE_DOMAIN = 'domain'.freeze,
      VALIDATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :validate The value to assign to the {#validate} property
    ...
    def initialize(attributes = {})
      ...
      self.validate = attributes[:'validate'] if attributes[:'validate']
    ...
    def validate=(validate)
      # rubocop:disable Style/ConditionalAssignment
      if validate && !VALIDATE_ENUM.include?(validate)
        OCI.logger.debug("Unknown value for 'validate' [" + validate + "]. Mapping to 'VALIDATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @validate = VALIDATE_UNKNOWN_ENUM_VALUE
      else
        @validate = validate
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    def hash
      [value, validation_status, validate, display_name].hash
    end
