...
module OCI
  ...
  class IdentityDomains::Models::MyPendingApprovals
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyPendingApproval>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyPendingApproval>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyPendingApproval>] :resources The value to assign to the {#resources} property
