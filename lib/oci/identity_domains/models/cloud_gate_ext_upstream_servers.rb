...
module OCI
  ...
  class IdentityDomains::Models::CloudGateExtUpstreamServers
    # **[Required]** ID of the upstream server
    #
    # **Added In:** 20.1.3
    #
    # **SCIM++ Properties:**
    ...
    def hash
      [value, ref, host_name, port, nginx_settings, group_id, display_name].hash
    end
