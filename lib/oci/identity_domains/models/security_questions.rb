...
module OCI
  ...
  class IdentityDomains::Models::SecurityQuestions
    ...
    # @return [Array<OCI::IdentityDomains::Models::SecurityQuestion>]
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::SecurityQuestion>] :resources The value to assign to the {#resources} property
