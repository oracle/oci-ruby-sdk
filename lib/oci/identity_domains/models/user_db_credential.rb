...
module OCI
  ...
  class IdentityDomains::Models::UserDbCredential
    ...
    # **[Required]** The user's database password.
    #
    # **SCIM++ Properties:**
    #  - type: string
    #  - mutability: immutable
    ...
    #  - required: false
    # @return [String]
    attr_accessor :mixed_db_password
    ...
    # @return [OCI::IdentityDomains::Models::UserDbCredentialsUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'status': :'String',
        'expires_on': :'String',
        'user': :'OCI::IdentityDomains::Models::UserDbCredentialsUser',
    ...
    # @option attributes [String] :db_password The value to assign to the {#db_password} property
    # @option attributes [String] :description The value to assign to the {#description} property
    # @option attributes [String] :mixed_db_password The value to assign to the {#mixed_db_password} property
    # @option attributes [String] :salt The value to assign to the {#salt} property
    # @option attributes [String] :mixed_salt The value to assign to the {#mixed_salt} property
    # @option attributes [String] :last_set_date The value to assign to the {#last_set_date} property
    ...
    # @option attributes [OCI::IdentityDomains::Models::UserDbCredentialsUser] :user The value to assign to the {#user} property
    ...
    def initialize(attributes = {})
      ...
      self.db_password = attributes[:'dbPassword'] if attributes[:'dbPassword']

      raise 'You cannot provide both :dbPassword and :db_password' if attributes.key?(:'dbPassword') && attributes.key?(:'db_password')

      self.db_password = attributes[:'db_password'] if attributes[:'db_password']

      self.description = attributes[:'description'] if attributes[:'description']

      self.mixed_db_password = attributes[:'mixedDbPassword'] if attributes[:'mixedDbPassword']

      raise 'You cannot provide both :mixedDbPassword and :mixed_db_password' if attributes.key?(:'mixedDbPassword') && attributes.key?(:'mixed_db_password')

      self.mixed_db_password = attributes[:'mixed_db_password'] if attributes[:'mixed_db_password']

      self.salt = attributes[:'salt'] if attributes[:'salt']

      self.mixed_salt = attributes[:'mixedSalt'] if attributes[:'mixedSalt']

      raise 'You cannot provide both :mixedSalt and :mixed_salt' if attributes.key?(:'mixedSalt') && attributes.key?(:'mixed_salt')

      self.mixed_salt = attributes[:'mixed_salt'] if attributes[:'mixed_salt']

      self.last_set_date = attributes[:'lastSetDate'] if attributes[:'lastSetDate']

      raise 'You cannot provide both :lastSetDate and :last_set_date' if attributes.key?(:'lastSetDate') && attributes.key?(:'last_set_date')

      self.last_set_date = attributes[:'last_set_date'] if attributes[:'last_set_date']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        mixed_db_password == other.mixed_db_password &&
        salt == other.salt &&
        mixed_salt == other.mixed_salt &&
        last_set_date == other.last_set_date &&
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, name, db_password, description, mixed_db_password, salt, mixed_salt, last_set_date, expired, status, expires_on, user, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
