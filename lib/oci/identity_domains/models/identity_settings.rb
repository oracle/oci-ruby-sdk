...
module OCI
  ...
  class IdentityDomains::Models::IdentitySettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::IdentitySetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::IdentitySetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentitySetting>] :resources The value to assign to the {#resources} property
