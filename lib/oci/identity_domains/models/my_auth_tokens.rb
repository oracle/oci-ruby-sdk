...
module OCI
  ...
  class IdentityDomains::Models::MyAuthTokens
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyAuthToken>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyAuthToken>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyAuthToken>] :resources The value to assign to the {#resources} property
