...
module OCI
  ...
  class IdentityDomains::Models::MyTrustedUserAgents
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyTrustedUserAgent>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyTrustedUserAgent>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyTrustedUserAgent>] :resources The value to assign to the {#resources} property
