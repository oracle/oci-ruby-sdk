...
module OCI
  ...
  class IdentityDomains::Models::MySmtpCredentials
    ...
    # @return [Array<OCI::IdentityDomains::Models::MySmtpCredential>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MySmtpCredential>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MySmtpCredential>] :resources The value to assign to the {#resources} property
