...
module OCI
  ...
  class IdentityDomains::Models::DynamicResourceGroups
    ...
    # @return [Array<OCI::IdentityDomains::Models::DynamicResourceGroup>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::DynamicResourceGroup>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::DynamicResourceGroup>] :resources The value to assign to the {#resources} property
