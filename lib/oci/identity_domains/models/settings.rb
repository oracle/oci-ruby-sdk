...
module OCI
  ...
  class IdentityDomains::Models::Settings
    ...
    # @return [Array<OCI::IdentityDomains::Models::Setting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Setting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Setting>] :resources The value to assign to the {#resources} property
