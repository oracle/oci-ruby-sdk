...
module OCI
  ...
  class IdentityDomains::Models::SmtpCredentials
    ...
    # @return [Array<OCI::IdentityDomains::Models::SmtpCredential>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::SmtpCredential>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::SmtpCredential>] :resources The value to assign to the {#resources} property
