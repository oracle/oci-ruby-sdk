...
module OCI
  ...
  class IdentityDomains::Models::MyDevices
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyDevice>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyDevice>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyDevice>] :resources The value to assign to the {#resources} property
