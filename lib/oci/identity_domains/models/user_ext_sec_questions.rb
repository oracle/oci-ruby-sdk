...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::UserExtSecQuestions
    ...
    # @option attributes [String] :answer The value to assign to the {#answer} property
    ...
    def initialize(attributes = {})
      ...
      self.answer = attributes[:'answer'] if attributes[:'answer']
    ...
    def hash
      [value, ref, answer, hint_text].hash
    end
