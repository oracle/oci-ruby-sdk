...
module OCI
  ...
  class IdentityDomains::Models::IdentityPropagationTrustImpersonationServiceUsers
    # **[Required]** The ID of the Service User.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    # **[Required]** The rule expression to be used for matching the inbound token for impersonation.
    #
    # **SCIM++ Properties:**
    #  - idcsSearchable: false
    #  - multiValued: false
    ...
    # @option attributes [String] :rule The value to assign to the {#rule} property
