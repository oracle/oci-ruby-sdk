...
module OCI
  ...
  class IdentityDomains::Models::AppExtensionDbcsApp
    ...
    # @return [OCI::IdentityDomains::Models::AppDomainApp]
    attr_accessor :domain_app
    ...
    # @option attributes [OCI::IdentityDomains::Models::AppDomainApp] :domain_app The value to assign to the {#domain_app} property
