...
module OCI
  ...
  class IdentityDomains::Models::AppRoles
    ...
    # @return [Array<OCI::IdentityDomains::Models::AppRole>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::AppRole>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::AppRole>] :resources The value to assign to the {#resources} property
