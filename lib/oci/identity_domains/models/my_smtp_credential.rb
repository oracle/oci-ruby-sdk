...
module OCI
  ...
  class IdentityDomains::Models::MySmtpCredential
    ...
    # @return [OCI::IdentityDomains::Models::MySmtpCredentialUser]
    attr_accessor :user
    ...
    def self.swagger_types
      {
        ...
        'expires_on': :'String',
        'user_name': :'String',
        'user': :'OCI::IdentityDomains::Models::MySmtpCredentialUser'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::MySmtpCredentialUser] :user The value to assign to the {#user} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, description, status, expires_on, user_name, user].hash
    end
