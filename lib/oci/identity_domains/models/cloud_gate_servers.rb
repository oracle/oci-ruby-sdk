...
module OCI
  ...
  class IdentityDomains::Models::CloudGateServers
    ...
    # @return [Array<OCI::IdentityDomains::Models::CloudGateServer>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::CloudGateServer>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::CloudGateServer>] :resources The value to assign to the {#resources} property
