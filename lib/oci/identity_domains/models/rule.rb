...
module OCI
  ...
  class IdentityDomains::Models::Rule
    ...
    # @return [OCI::IdentityDomains::Models::RuleConditionGroup]
    attr_accessor :condition_group

    # This attribute is required.
    # @return [OCI::IdentityDomains::Models::RulePolicyType]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::RuleReturn>]
    ...
    # @option attributes [BOOLEAN] :locked The value to assign to the {#locked} property
    # @option attributes [String] :rule_groovy The value to assign to the {#rule_groovy} property
    # @option attributes [String] :condition The value to assign to the {#condition} property
    # @option attributes [OCI::IdentityDomains::Models::RuleConditionGroup] :condition_group The value to assign to the {#condition_group} property
    # @option attributes [OCI::IdentityDomains::Models::RulePolicyType] :policy_type The value to assign to the {#policy_type} property
    # @option attributes [Array<OCI::IdentityDomains::Models::RuleReturn>] :_return The value to assign to the {#_return} property
    def initialize(attributes = {})
      ...
      self.locked = attributes[:'locked'] unless attributes[:'locked'].nil?

      self.rule_groovy = attributes[:'ruleGroovy'] if attributes[:'ruleGroovy']

      raise 'You cannot provide both :ruleGroovy and :rule_groovy' if attributes.key?(:'ruleGroovy') && attributes.key?(:'rule_groovy')

      self.rule_groovy = attributes[:'rule_groovy'] if attributes[:'rule_groovy']

      self.condition = attributes[:'condition'] if attributes[:'condition']

      self.condition_group = attributes[:'conditionGroup'] if attributes[:'conditionGroup']

      raise 'You cannot provide both :conditionGroup and :condition_group' if attributes.key?(:'conditionGroup') && attributes.key?(:'condition_group')

      self.condition_group = attributes[:'condition_group'] if attributes[:'condition_group']
      ...
      self._return = attributes[:'return'] if attributes[:'return']

      raise 'You cannot provide both :return and :_return' if attributes.key?(:'return') && attributes.key?(:'_return')

      self._return = attributes[:'_return'] if attributes[:'_return']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        active == other.active &&
        locked == other.locked &&
        rule_groovy == other.rule_groovy &&
        condition == other.condition &&
        condition_group == other.condition_group &&
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, name, description, active, locked, rule_groovy, condition, condition_group, policy_type, _return].hash
    end
