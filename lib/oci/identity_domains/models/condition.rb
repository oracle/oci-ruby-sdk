...
module OCI
  ...
  class IdentityDomains::Models::Condition
    ...
    # **[Required]** AttributeName - RHS of condition
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: false
    ...
    # **[Required]** attributeValue - RHS of condition
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: false
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :evaluate_condition_if
    ...
    # @option attributes [String] :evaluate_condition_if The value to assign to the {#evaluate_condition_if} property
    def initialize(attributes = {})
      ...
      self.evaluate_condition_if = attributes[:'evaluateConditionIf'] if attributes[:'evaluateConditionIf']

      raise 'You cannot provide both :evaluateConditionIf and :evaluate_condition_if' if attributes.key?(:'evaluateConditionIf') && attributes.key?(:'evaluate_condition_if')

      self.evaluate_condition_if = attributes[:'evaluate_condition_if'] if attributes[:'evaluate_condition_if']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        evaluate_condition_if == other.evaluate_condition_if
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, name, description, attribute_name, operator, attribute_value, evaluate_condition_if].hash
    end
