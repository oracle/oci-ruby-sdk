...
module OCI
  ...
  class IdentityDomains::Models::MePasswordChanger
    ...
    # **[Required]** The old password attribute.
    #
    # **SCIM++ Properties:**
    #  - type: string
    #  - multiValued: false
    ...
    # @option attributes [String] :old_password The value to assign to the {#old_password} property
    def initialize(attributes = {})
      ...
      self.old_password = attributes[:'oldPassword'] if attributes[:'oldPassword']

      raise 'You cannot provide both :oldPassword and :old_password' if attributes.key?(:'oldPassword') && attributes.key?(:'old_password')

      self.old_password = attributes[:'old_password'] if attributes[:'old_password']
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, password, old_password].hash
    end
