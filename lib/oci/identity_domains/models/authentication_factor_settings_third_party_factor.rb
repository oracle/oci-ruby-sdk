...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::AuthenticationFactorSettingsThirdPartyFactor
    ...
    # @option attributes [BOOLEAN] :duo_security The value to assign to the {#duo_security} property
