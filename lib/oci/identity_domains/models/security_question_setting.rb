...
module OCI
  ...
  class IdentityDomains::Models::SecurityQuestionSetting
    ...
    # **[Required]** Indicates the number of security questions a user must setup
    #
    # **SCIM++ Properties:**
    #  - type: integer
    #  - multiValued: false
    ...
    #  - idcsMaxValue: 5
    # @return [Integer]
    attr_accessor :num_questions_to_setup

    # **[Required]** Indicates the minimum length of answer for security questions
    #
    # **SCIM++ Properties:**
    #  - type: integer
    #  - multiValued: false
    ...
    #  - idcsMaxValue: 8
    # @return [Integer]
    attr_accessor :min_answer_length

    # **[Required]** Indicates the maximum length of following fields Security Questions, Answer and Hint
    #
    # **SCIM++ Properties:**
    #  - type: integer
    #  - multiValued: false
    ...
    #  - idcsMaxValue: 100
    # @return [Integer]
    attr_accessor :max_field_length

    # **[Required]** Indicates the number of security questions that a user must answer
    #
    # **SCIM++ Properties:**
    #  - type: integer
    #  - multiValued: false
    ...
    #  - idcsMaxValue: 5
    # @return [Integer]
    attr_accessor :num_questions_to_ans
    ...
    def self.swagger_types
      {
        ...
        'tenancy_ocid': :'String',
        'external_id': :'String',
        'num_questions_to_setup': :'Integer',
        'min_answer_length': :'Integer',
        'max_field_length': :'Integer',
        'num_questions_to_ans': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :num_questions_to_setup The value to assign to the {#num_questions_to_setup} property
    # @option attributes [Integer] :min_answer_length The value to assign to the {#min_answer_length} property
    # @option attributes [Integer] :max_field_length The value to assign to the {#max_field_length} property
    # @option attributes [Integer] :num_questions_to_ans The value to assign to the {#num_questions_to_ans} property
    def initialize(attributes = {})
      ...
      self.num_questions_to_setup = attributes[:'numQuestionsToSetup'] if attributes[:'numQuestionsToSetup']

      raise 'You cannot provide both :numQuestionsToSetup and :num_questions_to_setup' if attributes.key?(:'numQuestionsToSetup') && attributes.key?(:'num_questions_to_setup')

      self.num_questions_to_setup = attributes[:'num_questions_to_setup'] if attributes[:'num_questions_to_setup']

      self.min_answer_length = attributes[:'minAnswerLength'] if attributes[:'minAnswerLength']

      raise 'You cannot provide both :minAnswerLength and :min_answer_length' if attributes.key?(:'minAnswerLength') && attributes.key?(:'min_answer_length')

      self.min_answer_length = attributes[:'min_answer_length'] if attributes[:'min_answer_length']

      self.max_field_length = attributes[:'maxFieldLength'] if attributes[:'maxFieldLength']

      raise 'You cannot provide both :maxFieldLength and :max_field_length' if attributes.key?(:'maxFieldLength') && attributes.key?(:'max_field_length')

      self.max_field_length = attributes[:'max_field_length'] if attributes[:'max_field_length']

      self.num_questions_to_ans = attributes[:'numQuestionsToAns'] if attributes[:'numQuestionsToAns']

      raise 'You cannot provide both :numQuestionsToAns and :num_questions_to_ans' if attributes.key?(:'numQuestionsToAns') && attributes.key?(:'num_questions_to_ans')

      self.num_questions_to_ans = attributes[:'num_questions_to_ans'] if attributes[:'num_questions_to_ans']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        num_questions_to_setup == other.num_questions_to_setup &&
        min_answer_length == other.min_answer_length &&
        max_field_length == other.max_field_length &&
        num_questions_to_ans == other.num_questions_to_ans
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, num_questions_to_setup, min_answer_length, max_field_length, num_questions_to_ans].hash
    end
