...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::UserExtSyncedFromApp
    TYPE_ENUM = [
      TYPE_IDENTITY_SOURCE = 'IdentitySource'.freeze,
      TYPE_APP = 'App'.freeze,
      TYPE_IDENTITY_PROVIDER = 'IdentityProvider'.freeze,
