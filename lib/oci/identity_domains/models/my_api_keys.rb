...
module OCI
  ...
  class IdentityDomains::Models::MyApiKeys
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyApiKey>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyApiKey>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyApiKey>] :resources The value to assign to the {#resources} property
