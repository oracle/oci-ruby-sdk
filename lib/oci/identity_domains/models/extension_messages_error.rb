...
module OCI
  ...
  class IdentityDomains::Models::ExtensionMessagesError
    ...
    # @option attributes [Object] :additional_data The value to assign to the {#additional_data} property
    ...
    def hash
      [message_id, additional_data].hash
    end
