...
module OCI
  ...
  class IdentityDomains::Models::Policies
    ...
    # @return [Array<OCI::IdentityDomains::Models::Policy>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::Policy>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Policy>] :resources The value to assign to the {#resources} property
