...
module OCI
  ...
  class IdentityDomains::Models::PatchOp
    ...
    # @return [Array<OCI::IdentityDomains::Models::Operations>]
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::Operations>] :operations The value to assign to the {#operations} property
