...
module OCI
  ...
  class IdentityDomains::Models::MyDeviceAuthenticationFactors
    TYPE_ENUM = [
      TYPE_EMAIL = 'EMAIL'.freeze,
      TYPE_SMS = 'SMS'.freeze,
      TYPE_TOTP = 'TOTP'.freeze,
      TYPE_PUSH = 'PUSH'.freeze,
      TYPE_OFFLINETOTP = 'OFFLINETOTP'.freeze,
      TYPE_VOICE = 'VOICE'.freeze,
      TYPE_PHONE_CALL = 'PHONE_CALL'.freeze,
      TYPE_THIRDPARTY = 'THIRDPARTY'.freeze,
      TYPE_FIDO_AUTHENTICATOR = 'FIDO_AUTHENTICATOR'.freeze,
      TYPE_YUBICO_OTP = 'YUBICO_OTP'.freeze,
    ...
    # **[Required]** Authentication Factor Type
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
