...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflow
    ...
    # **[Required]** Name of the ApprovalWorkflow.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    #  - idcsSearchable: true
    ...
    # @return [OCI::IdentityDomains::Models::ApprovalWorkflowMaxDuration]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::ApprovalWorkflowApprovalWorkflowSteps>]
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'description': :'String',
        'max_duration': :'OCI::IdentityDomains::Models::ApprovalWorkflowMaxDuration',
        'approval_workflow_steps': :'Array<OCI::IdentityDomains::Models::ApprovalWorkflowApprovalWorkflowSteps>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::ApprovalWorkflowMaxDuration] :max_duration The value to assign to the {#max_duration} property
    # @option attributes [Array<OCI::IdentityDomains::Models::ApprovalWorkflowApprovalWorkflowSteps>] :approval_workflow_steps The value to assign to the {#approval_workflow_steps} property
    def initialize(attributes = {})
      ...
      self.max_duration = attributes[:'maxDuration'] if attributes[:'maxDuration']

      raise 'You cannot provide both :maxDuration and :max_duration' if attributes.key?(:'maxDuration') && attributes.key?(:'max_duration')

      self.max_duration = attributes[:'max_duration'] if attributes[:'max_duration']

      self.approval_workflow_steps = attributes[:'approvalWorkflowSteps'] if attributes[:'approvalWorkflowSteps']

      raise 'You cannot provide both :approvalWorkflowSteps and :approval_workflow_steps' if attributes.key?(:'approvalWorkflowSteps') && attributes.key?(:'approval_workflow_steps')

      self.approval_workflow_steps = attributes[:'approval_workflow_steps'] if attributes[:'approval_workflow_steps']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        approval_workflow_steps == other.approval_workflow_steps
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, name, description, max_duration, approval_workflow_steps].hash
    end
