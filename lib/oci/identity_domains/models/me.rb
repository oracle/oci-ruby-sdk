...
module OCI
  # User Account
  class IdentityDomains::Models::Me
    ...
    # @return [OCI::IdentityDomains::Models::MeName]
    attr_accessor :name
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeEmails>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MePhoneNumbers>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeIms>]
    attr_accessor :ims
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MePhotos>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeGroups>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeEntitlements>]
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeRoles>]
    attr_accessor :roles
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::MeX509Certificates>]
    ...
    # @return [OCI::IdentityDomains::Models::ExtensionMeUser]
    attr_accessor :urn_ietf_params_scim_schemas_oracle_idcs_extension_me_user
    ...
    # @option attributes [OCI::IdentityDomains::Models::MeName] :name The value to assign to the {#name} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeEmails>] :emails The value to assign to the {#emails} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MePhoneNumbers>] :phone_numbers The value to assign to the {#phone_numbers} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeIms>] :ims The value to assign to the {#ims} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MePhotos>] :photos The value to assign to the {#photos} property
    # @option attributes [Array<OCI::IdentityDomains::Models::Addresses>] :addresses The value to assign to the {#addresses} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeGroups>] :groups The value to assign to the {#groups} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeEntitlements>] :entitlements The value to assign to the {#entitlements} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeRoles>] :roles The value to assign to the {#roles} property
    # @option attributes [Array<OCI::IdentityDomains::Models::MeX509Certificates>] :x509_certificates The value to assign to the {#x509_certificates} property
    ...
    # @option attributes [OCI::IdentityDomains::Models::ExtensionMeUser] :urn_ietf_params_scim_schemas_oracle_idcs_extension_me_user The value to assign to the {#urn_ietf_params_scim_schemas_oracle_idcs_extension_me_user} property
