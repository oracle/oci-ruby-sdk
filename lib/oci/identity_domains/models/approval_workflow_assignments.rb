...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflowAssignments
    ...
    # @return [Array<OCI::IdentityDomains::Models::ApprovalWorkflowAssignment>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::ApprovalWorkflowAssignment>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::ApprovalWorkflowAssignment>] :resources The value to assign to the {#resources} property
