...
module OCI
  ...
  class IdentityDomains::Models::MySupportAccounts
    ...
    # @return [Array<OCI::IdentityDomains::Models::MySupportAccount>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MySupportAccount>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MySupportAccount>] :resources The value to assign to the {#resources} property
