...
module OCI
  ...
  class IdentityDomains::Models::KmsiSetting
    ...
    #  - uniqueness: none
    # @return [Integer]
    attr_accessor :token_validity_in_days
    ...
    #  - uniqueness: none
    # @return [Integer]
    attr_accessor :last_used_validity_in_days
    ...
    #  - uniqueness: none
    # @return [Integer]
    attr_accessor :max_allowed_sessions
    ...
    #  - uniqueness: none
    # @return [BOOLEAN]
    attr_accessor :kmsi_feature_enabled
    ...
    #  - uniqueness: none
    # @return [BOOLEAN]
    attr_accessor :kmsi_prompt_enabled
    ...
    #  - uniqueness: none
    # @return [BOOLEAN]
    attr_accessor :tou_prompt_disabled
    ...
    def self.swagger_types
      {
        ...
        'tenancy_ocid': :'String',
        'external_id': :'String',
        'token_validity_in_days': :'Integer',
        'last_used_validity_in_days': :'Integer',
        'max_allowed_sessions': :'Integer',
        'kmsi_feature_enabled': :'BOOLEAN',
        'kmsi_prompt_enabled': :'BOOLEAN',
        'tou_prompt_disabled': :'BOOLEAN',
    ...
    # @option attributes [Integer] :token_validity_in_days The value to assign to the {#token_validity_in_days} property
    # @option attributes [Integer] :last_used_validity_in_days The value to assign to the {#last_used_validity_in_days} property
    # @option attributes [Integer] :max_allowed_sessions The value to assign to the {#max_allowed_sessions} property
    # @option attributes [BOOLEAN] :kmsi_feature_enabled The value to assign to the {#kmsi_feature_enabled} property
    # @option attributes [BOOLEAN] :kmsi_prompt_enabled The value to assign to the {#kmsi_prompt_enabled} property
    # @option attributes [BOOLEAN] :tou_prompt_disabled The value to assign to the {#tou_prompt_disabled} property
    # @option attributes [String] :last_enabled_on The value to assign to the {#last_enabled_on} property
    def initialize(attributes = {})
      ...
      self.token_validity_in_days = attributes[:'tokenValidityInDays'] if attributes[:'tokenValidityInDays']

      raise 'You cannot provide both :tokenValidityInDays and :token_validity_in_days' if attributes.key?(:'tokenValidityInDays') && attributes.key?(:'token_validity_in_days')

      self.token_validity_in_days = attributes[:'token_validity_in_days'] if attributes[:'token_validity_in_days']

      self.last_used_validity_in_days = attributes[:'lastUsedValidityInDays'] if attributes[:'lastUsedValidityInDays']

      raise 'You cannot provide both :lastUsedValidityInDays and :last_used_validity_in_days' if attributes.key?(:'lastUsedValidityInDays') && attributes.key?(:'last_used_validity_in_days')

      self.last_used_validity_in_days = attributes[:'last_used_validity_in_days'] if attributes[:'last_used_validity_in_days']

      self.max_allowed_sessions = attributes[:'maxAllowedSessions'] if attributes[:'maxAllowedSessions']

      raise 'You cannot provide both :maxAllowedSessions and :max_allowed_sessions' if attributes.key?(:'maxAllowedSessions') && attributes.key?(:'max_allowed_sessions')

      self.max_allowed_sessions = attributes[:'max_allowed_sessions'] if attributes[:'max_allowed_sessions']

      self.kmsi_feature_enabled = attributes[:'kmsiFeatureEnabled'] unless attributes[:'kmsiFeatureEnabled'].nil?

      raise 'You cannot provide both :kmsiFeatureEnabled and :kmsi_feature_enabled' if attributes.key?(:'kmsiFeatureEnabled') && attributes.key?(:'kmsi_feature_enabled')

      self.kmsi_feature_enabled = attributes[:'kmsi_feature_enabled'] unless attributes[:'kmsi_feature_enabled'].nil?

      self.kmsi_prompt_enabled = attributes[:'kmsiPromptEnabled'] unless attributes[:'kmsiPromptEnabled'].nil?

      raise 'You cannot provide both :kmsiPromptEnabled and :kmsi_prompt_enabled' if attributes.key?(:'kmsiPromptEnabled') && attributes.key?(:'kmsi_prompt_enabled')

      self.kmsi_prompt_enabled = attributes[:'kmsi_prompt_enabled'] unless attributes[:'kmsi_prompt_enabled'].nil?

      self.tou_prompt_disabled = attributes[:'touPromptDisabled'] unless attributes[:'touPromptDisabled'].nil?

      raise 'You cannot provide both :touPromptDisabled and :tou_prompt_disabled' if attributes.key?(:'touPromptDisabled') && attributes.key?(:'tou_prompt_disabled')

      self.tou_prompt_disabled = attributes[:'tou_prompt_disabled'] unless attributes[:'tou_prompt_disabled'].nil?

      self.last_enabled_on = attributes[:'lastEnabledOn'] if attributes[:'lastEnabledOn']

      raise 'You cannot provide both :lastEnabledOn and :last_enabled_on' if attributes.key?(:'lastEnabledOn') && attributes.key?(:'last_enabled_on')

      self.last_enabled_on = attributes[:'last_enabled_on'] if attributes[:'last_enabled_on']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        token_validity_in_days == other.token_validity_in_days &&
        last_used_validity_in_days == other.last_used_validity_in_days &&
        max_allowed_sessions == other.max_allowed_sessions &&
        kmsi_feature_enabled == other.kmsi_feature_enabled &&
        kmsi_prompt_enabled == other.kmsi_prompt_enabled &&
        tou_prompt_disabled == other.tou_prompt_disabled &&
        last_enabled_on == other.last_enabled_on
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, token_validity_in_days, last_used_validity_in_days, max_allowed_sessions, kmsi_feature_enabled, kmsi_prompt_enabled, tou_prompt_disabled, last_enabled_on].hash
    end
