...
module OCI
  ...
  #  - type: complex
  #
  class IdentityDomains::Models::UserExtIdcsAppRolesLimitedToGroups
    # **[Required]** The id of the Oracle Identity Cloud Service AppRole grant limited to one or more Groups.
    #
    # **Added In:** 19.2.1
    #
    # **SCIM++ Properties:**
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :idcs_app_role_id

    # **[Required]** The id of a Group the AppRole Grant is limited to
    #
    # **Added In:** 19.2.1
    #
    # **SCIM++ Properties:**
    ...
    # @option attributes [String] :idcs_app_role_id The value to assign to the {#idcs_app_role_id} property
    ...
    def initialize(attributes = {})
      ...
      self.idcs_app_role_id = attributes[:'idcsAppRoleId'] if attributes[:'idcsAppRoleId']

      raise 'You cannot provide both :idcsAppRoleId and :idcs_app_role_id' if attributes.key?(:'idcsAppRoleId') && attributes.key?(:'idcs_app_role_id')

      self.idcs_app_role_id = attributes[:'idcs_app_role_id'] if attributes[:'idcs_app_role_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        idcs_app_role_id == other.idcs_app_role_id &&
        value == other.value &&
        ref == other.ref &&
    ...
    def hash
      [idcs_app_role_id, value, ref, display, ocid].hash
    end
