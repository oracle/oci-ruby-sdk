...
module OCI
  ...
  #  - returned: default
  #  - type: complex
  class IdentityDomains::Models::GrantGrantor
    TYPE_ENUM = [
      TYPE_USER = 'User'.freeze,
      TYPE_APP = 'App'.freeze,
      TYPE_GROUP = 'Group'.freeze,
      TYPE_APP_ENTITLEMENT_COLLECTION = 'AppEntitlementCollection'.freeze,
      TYPE_DYNAMIC_RESOURCE_GROUP = 'DynamicResourceGroup'.freeze,
    ...
    # **[Required]** Resource type of the grantor. Allowed values are User and App.
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
