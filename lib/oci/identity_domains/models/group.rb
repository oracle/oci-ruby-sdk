...
module OCI
  # The Group resource.
  class IdentityDomains::Models::Group
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::GroupMembers>]
    ...
    # @return [OCI::IdentityDomains::Models::ExtensionPosixGroup]
    attr_accessor :urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group
    ...
    # @return [OCI::IdentityDomains::Models::ExtensionDbcsGroup]
    attr_accessor :urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group

    # @return [OCI::IdentityDomains::Models::ExtensionDynamicGroup]
    attr_accessor :urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group
    ...
    def self.swagger_types
      {
        ...
        'members': :'Array<OCI::IdentityDomains::Models::GroupMembers>',
        'urn_ietf_params_scim_schemas_oracle_idcs_extension_group_group': :'OCI::IdentityDomains::Models::ExtensionGroupGroup',
        'urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group': :'OCI::IdentityDomains::Models::ExtensionPosixGroup',
        ...
        'urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group': :'OCI::IdentityDomains::Models::ExtensionDbcsGroup',
        'urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group': :'OCI::IdentityDomains::Models::ExtensionDynamicGroup',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::GroupMembers>] :members The value to assign to the {#members} property
    ...
    # @option attributes [OCI::IdentityDomains::Models::ExtensionPosixGroup] :urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group The value to assign to the {#urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group} property
    ...
    # @option attributes [OCI::IdentityDomains::Models::ExtensionDbcsGroup] :urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group The value to assign to the {#urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group} property
    # @option attributes [OCI::IdentityDomains::Models::ExtensionDynamicGroup] :urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group The value to assign to the {#urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group} property
    ...
    def initialize(attributes = {})
      ...
      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group = attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:posix:Group'] if attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:posix:Group']

      raise 'You cannot provide both :urn:ietf:params:scim:schemas:oracle:idcs:extension:posix:Group and :urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group' if attributes.key?(:'urn:ietf:params:scim:schemas:oracle:idcs:extension:posix:Group') && attributes.key?(:'urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group')

      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group = attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group'] if attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group']
      ...
      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group = attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group'] if attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group']

      raise 'You cannot provide both :urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group and :urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group' if attributes.key?(:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group') && attributes.key?(:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group')

      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group = attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group'] if attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group']

      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group = attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group'] if attributes[:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group']

      raise 'You cannot provide both :urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group and :urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group' if attributes.key?(:'urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group') && attributes.key?(:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group')

      self.urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group = attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group'] if attributes[:'urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group == other.urn_ietf_params_scim_schemas_oracle_idcs_extension_posix_group &&
        ...
        urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group == other.urn_ietf_params_scim_schemas_oracle_idcs_extension_dbcs_group &&
        urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group == other.urn_ietf_params_scim_schemas_oracle_idcs_extension_dynamic_group &&
