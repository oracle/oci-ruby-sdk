...
module OCI
  ...
  #  - type: complex
  #  - uniqueness: none
  class IdentityDomains::Models::AppUserAssertionAttributes
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :user_store_attribute_name
    ...
    # @option attributes [String] :user_store_attribute_name The value to assign to the {#user_store_attribute_name} property
