...
module OCI
  ...
  class IdentityDomains::Models::NetworkPerimeter
    ...
    # **[Required]** NetworkPerimeter name
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - idcsSearchable: true
    ...
    # **[Required]** IPAddresses or Ranges assigned to the NetworkPerimeter
    #
    # **SCIM++ Properties:**
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::NetworkPerimeterIpAddresses>]
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'description': :'String',
        'ip_addresses': :'Array<OCI::IdentityDomains::Models::NetworkPerimeterIpAddresses>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::NetworkPerimeterIpAddresses>] :ip_addresses The value to assign to the {#ip_addresses} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, name, description, ip_addresses].hash
    end
