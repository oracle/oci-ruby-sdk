...
module OCI
  ...
  class IdentityDomains::Models::UserPhotos
    TYPE_ENUM = [
      TYPE_PHOTO = 'photo'.freeze,
      TYPE_THUMBNAIL = 'thumbnail'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** URL of a photo for the User
    #
    # **SCIM++ Properties:**
    ...
    # **[Required]** A label indicating the attribute's function; e.g., 'photo' or 'thumbnail'.
    #
    # **SCIM++ Properties:**
    #  - idcsSearchable: false
    #  - multiValued: false
    ...
    def hash
      [value, display, type, primary].hash
    end
