...
module OCI
  # Security Question
  class IdentityDomains::Models::SecurityQuestion
    ...
    # **[Required]** This indicates if the question is selected by the Security Admin and is available for the end user.
    #
    # **SCIM++ Properties:**
    #  - idcsSearchable: true
    #  - multiValued: false
    ...
    # **[Required]** This indicates if the question is a Custom Question added by the Security Admin.
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - idcsSearchable: true
    ...
    # **[Required]** Locale values for the Question
    #
    # **SCIM++ Properties:**
    #  - caseExact: false
    #  - idcsSearchable: true
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::SecurityQuestionQuestionText>]
    ...
    def self.swagger_types
      {
        ...
        'active': :'BOOLEAN',
        'type': :'String',
        'question_text': :'Array<OCI::IdentityDomains::Models::SecurityQuestionQuestionText>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::SecurityQuestionQuestionText>] :question_text The value to assign to the {#question_text} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, active, type, question_text].hash
    end
