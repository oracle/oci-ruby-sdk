...
module OCI
  ...
  class IdentityDomains::Models::NotificationSettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::NotificationSetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::NotificationSetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::NotificationSetting>] :resources The value to assign to the {#resources} property
