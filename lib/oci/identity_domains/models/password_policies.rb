...
module OCI
  ...
  class IdentityDomains::Models::PasswordPolicies
    ...
    # @return [Array<OCI::IdentityDomains::Models::PasswordPolicy>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::PasswordPolicy>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::PasswordPolicy>] :resources The value to assign to the {#resources} property
