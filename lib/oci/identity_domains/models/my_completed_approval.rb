...
module OCI
  ...
  class IdentityDomains::Models::MyCompletedApproval
    ...
    #  - uniqueness: none
    # @return [String]
    attr_accessor :request_created_time
    ...
    # @option attributes [String] :request_ocid The value to assign to the {#request_ocid} property
    ...
    # @option attributes [String] :request_details The value to assign to the {#request_details} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [String] :response_time The value to assign to the {#response_time} property
    # @option attributes [String] :justification The value to assign to the {#justification} property
    # @option attributes [String] :request_created_time The value to assign to the {#request_created_time} property
    def initialize(attributes = {})
      ...
      self.request_ocid = attributes[:'requestOcid'] if attributes[:'requestOcid']

      raise 'You cannot provide both :requestOcid and :request_ocid' if attributes.key?(:'requestOcid') && attributes.key?(:'request_ocid')

      self.request_ocid = attributes[:'request_ocid'] if attributes[:'request_ocid']
      ...
      self.request_details = attributes[:'requestDetails'] if attributes[:'requestDetails']

      raise 'You cannot provide both :requestDetails and :request_details' if attributes.key?(:'requestDetails') && attributes.key?(:'request_details')

      self.request_details = attributes[:'request_details'] if attributes[:'request_details']
      ...
      self.request_created_time = attributes[:'requestCreatedTime'] if attributes[:'requestCreatedTime']

      raise 'You cannot provide both :requestCreatedTime and :request_created_time' if attributes.key?(:'requestCreatedTime') && attributes.key?(:'request_created_time')

      self.request_created_time = attributes[:'request_created_time'] if attributes[:'request_created_time']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        request_ocid == other.request_ocid &&
        resource_display_name == other.resource_display_name &&
        resource_type == other.resource_type &&
        expires == other.expires &&
        request_details == other.request_details &&
        status == other.status &&
        response_time == other.response_time &&
        justification == other.justification &&
        request_created_time == other.request_created_time
    end
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, request_id, request_ocid, resource_display_name, resource_type, expires, request_details, status, response_time, justification, request_created_time].hash
    end
