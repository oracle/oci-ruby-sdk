...
module OCI
  ...
  class IdentityDomains::Models::AuthenticationFactorSettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::AuthenticationFactorSetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::AuthenticationFactorSetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::AuthenticationFactorSetting>] :resources The value to assign to the {#resources} property
