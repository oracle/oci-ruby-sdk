...
module OCI
  ...
  class IdentityDomains::Models::MyRequestableGroups
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyRequestableGroup>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyRequestableGroup>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyRequestableGroup>] :resources The value to assign to the {#resources} property
