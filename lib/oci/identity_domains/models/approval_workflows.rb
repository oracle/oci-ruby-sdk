...
module OCI
  ...
  class IdentityDomains::Models::ApprovalWorkflows
    ...
    # @return [Array<OCI::IdentityDomains::Models::ApprovalWorkflow>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::ApprovalWorkflow>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::ApprovalWorkflow>] :resources The value to assign to the {#resources} property
