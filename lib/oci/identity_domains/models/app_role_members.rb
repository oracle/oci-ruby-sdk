...
module OCI
  ...
  class IdentityDomains::Models::AppRoleMembers
    TYPE_ENUM = [
    ...
    # **[Required]** ID of the member of this AppRole
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
    ...
    # **[Required]** Indicates the type of Resource--for example, User, Group or DynamicResourceGroup
    #
    # **SCIM++ Properties:**
    #  - caseExact: true
