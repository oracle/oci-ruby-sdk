...
module OCI
  ...
  class IdentityDomains::Models::MyCustomerSecretKeys
    ...
    # @return [Array<OCI::IdentityDomains::Models::MyCustomerSecretKey>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::MyCustomerSecretKey>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::MyCustomerSecretKey>] :resources The value to assign to the {#resources} property
