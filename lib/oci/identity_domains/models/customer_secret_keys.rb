...
module OCI
  ...
  class IdentityDomains::Models::CustomerSecretKeys
    ...
    # @return [Array<OCI::IdentityDomains::Models::CustomerSecretKey>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::CustomerSecretKey>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::CustomerSecretKey>] :resources The value to assign to the {#resources} property
