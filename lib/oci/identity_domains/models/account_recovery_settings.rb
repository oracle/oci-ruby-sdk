...
module OCI
  ...
  class IdentityDomains::Models::AccountRecoverySettings
    ...
    # @return [Array<OCI::IdentityDomains::Models::AccountRecoverySetting>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::AccountRecoverySetting>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::AccountRecoverySetting>] :resources The value to assign to the {#resources} property
