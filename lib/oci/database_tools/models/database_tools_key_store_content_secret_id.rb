...
require 'date'
require_relative 'database_tools_key_store_content'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The key store content.
  class DatabaseTools::Models::DatabaseToolsKeyStoreContentSecretId < DatabaseTools::Models::DatabaseToolsKeyStoreContent
