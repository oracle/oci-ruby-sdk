...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionPostgresqlSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    # @return [OCI::DatabaseTools::Models::DatabaseToolsRelatedResourcePostgresql]
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresqlSummary>]
    ...
    # @option attributes [OCI::DatabaseTools::Models::DatabaseToolsRelatedResourcePostgresql] :related_resource The value to assign to the {#related_resource} property
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresqlSummary>] :key_stores The value to assign to the {#key_stores} property
