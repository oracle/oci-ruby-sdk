...
require 'date'
require_relative 'database_tools_key_store_password_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The key store password.
  class DatabaseTools::Models::DatabaseToolsKeyStorePasswordSecretIdSummary < DatabaseTools::Models::DatabaseToolsKeyStorePasswordSummary
