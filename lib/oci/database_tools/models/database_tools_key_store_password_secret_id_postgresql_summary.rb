...
require 'date'
require_relative 'database_tools_key_store_password_postgresql_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The key store password.
  class DatabaseTools::Models::DatabaseToolsKeyStorePasswordSecretIdPostgresqlSummary < DatabaseTools::Models::DatabaseToolsKeyStorePasswordPostgresqlSummary
