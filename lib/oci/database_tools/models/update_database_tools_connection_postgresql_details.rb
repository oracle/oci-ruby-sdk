...
module OCI
  ...
  class DatabaseTools::Models::UpdateDatabaseToolsConnectionPostgresqlDetails < DatabaseTools::Models::UpdateDatabaseToolsConnectionDetails
    # @return [OCI::DatabaseTools::Models::UpdateDatabaseToolsRelatedResourcePostgresqlDetails]
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresqlDetails>]
    ...
    # @option attributes [OCI::DatabaseTools::Models::UpdateDatabaseToolsRelatedResourcePostgresqlDetails] :related_resource The value to assign to the {#related_resource} property
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresqlDetails>] :key_stores The value to assign to the {#key_stores} property
