...
module OCI
  ...
  class DatabaseTools::Models::UpdateDatabaseToolsConnectionGenericJdbcDetails < DatabaseTools::Models::UpdateDatabaseToolsConnectionDetails
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreGenericJdbcDetails>]
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreGenericJdbcDetails>] :key_stores The value to assign to the {#key_stores} property
    ...
    def hash
      [display_name, defined_tags, freeform_tags, type, url, user_name, user_password, advanced_properties, key_stores].hash
    end
