...
require 'date'
require_relative 'database_tools_connection_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # DatabaseToolsConnectionSummary of an Oracle Database.
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    def self.swagger_types
      {
        ...
        'type': :'String',
        'related_resource': :'OCI::DatabaseTools::Models::DatabaseToolsRelatedResource',
        'connection_string': :'String',
        'user_name': :'String',
        'user_password': :'OCI::DatabaseTools::Models::DatabaseToolsUserPasswordSummary',
        'advanced_properties': :'Hash<String, String>',
        'key_stores': :'Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreSummary>',
    ...
    # @option attributes [String] :id The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#id #id} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#display_name #display_name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#compartment_id #compartment_id} proprety
    # @option attributes [String] :lifecycle_state The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#lifecycle_state #lifecycle_state} proprety
    # @option attributes [String] :lifecycle_details The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#lifecycle_details #lifecycle_details} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#time_updated #time_updated} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#defined_tags #defined_tags} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#system_tags #system_tags} proprety
    # @option attributes [OCI::DatabaseTools::Models::DatabaseToolsRelatedResource] :related_resource The value to assign to the {#related_resource} property
    ...
    # @option attributes [OCI::DatabaseTools::Models::DatabaseToolsUserPasswordSummary] :user_password The value to assign to the {#user_password} property
    # @option attributes [Hash<String, String>] :advanced_properties The value to assign to the {#advanced_properties} property
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreSummary>] :key_stores The value to assign to the {#key_stores} property
