...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    # @return [OCI::DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientSummary]
    ...
    def self.swagger_types
      {
        ...
        'proxy_client': :'OCI::DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientSummary'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::ResourceLock>] :locks The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#locks #locks} proprety
    # @option attributes [String] :runtime_support The value to assign to the {OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary#runtime_support #runtime_support} proprety
    ...
    # @option attributes [OCI::DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientSummary] :proxy_client The value to assign to the {#proxy_client} property
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, defined_tags, freeform_tags, system_tags, locks, type, runtime_support, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id, proxy_client].hash
    end
