...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsKeyStorePasswordMySqlDetails
    VALUE_TYPE_ENUM = [
      VALUE_TYPE_SECRETID = 'SECRETID'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsKeyStorePasswordSecretIdMySqlDetails' if type == 'SECRETID'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::DatabaseToolsKeyStorePasswordMySqlDetails'
    end
