...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsConnectionGenericJdbcDetails < DatabaseTools::Models::CreateDatabaseToolsConnectionDetails
    ...
    def hash
      [display_name, compartment_id, defined_tags, freeform_tags, locks, type, runtime_support, url, user_name, user_password, advanced_properties, key_stores].hash
    end
