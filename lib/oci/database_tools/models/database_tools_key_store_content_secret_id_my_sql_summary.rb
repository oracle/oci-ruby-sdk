...
require 'date'
require_relative 'database_tools_key_store_content_my_sql_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The key store content.
  class DatabaseTools::Models::DatabaseToolsKeyStoreContentSecretIdMySqlSummary < DatabaseTools::Models::DatabaseToolsKeyStoreContentMySqlSummary
