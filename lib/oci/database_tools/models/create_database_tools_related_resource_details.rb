...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsRelatedResourceDetails
    ENTITY_TYPE_ENUM = [
      ENTITY_TYPE_AUTONOMOUSDATABASE = 'AUTONOMOUSDATABASE'.freeze,
      ENTITY_TYPE_DATABASE = 'DATABASE'.freeze,
      ENTITY_TYPE_PLUGGABLEDATABASE = 'PLUGGABLEDATABASE'.freeze
    ].freeze
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the related resource.
    # @return [String]
