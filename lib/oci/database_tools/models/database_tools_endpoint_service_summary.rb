...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsEndpointServiceSummary
    ...
    def hash
      [id, display_name, name, compartment_id, defined_tags, freeform_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, description].hash
    end
