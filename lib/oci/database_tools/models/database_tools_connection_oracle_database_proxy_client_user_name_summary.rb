...
require 'date'
require_relative 'database_tools_connection_oracle_database_proxy_client_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Proxy client information for user name based proxy authentication.
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientUserNameSummary < DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientSummary
    ...
    def initialize(attributes = {})
      ...
      attributes['proxyAuthenticationType'] = 'USER_NAME'
    ...
    def hash
      [proxy_authentication_type, user_name, user_password, roles].hash
    end
