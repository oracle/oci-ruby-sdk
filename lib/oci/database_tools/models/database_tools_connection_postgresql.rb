...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionPostgresql < DatabaseTools::Models::DatabaseToolsConnection
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresql>]
    ...
    def self.swagger_types
      {
        ...
        'key_stores': :'Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresql>',
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStorePostgresql>] :key_stores The value to assign to the {#key_stores} property
