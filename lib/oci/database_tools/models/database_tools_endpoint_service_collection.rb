...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsEndpointServiceCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseTools::Models::DatabaseToolsEndpointServiceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsEndpointServiceSummary>] :items The value to assign to the {#items} property
