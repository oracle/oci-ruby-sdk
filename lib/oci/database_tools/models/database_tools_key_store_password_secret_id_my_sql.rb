...
require 'date'
require_relative 'database_tools_key_store_password_my_sql'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The key store password.
  class DatabaseTools::Models::DatabaseToolsKeyStorePasswordSecretIdMySql < DatabaseTools::Models::DatabaseToolsKeyStorePasswordMySql
