...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsConnectionPostgresqlSummary' if type == 'POSTGRESQL'
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsConnectionGenericJdbcSummary' if type == 'GENERIC_JDBC'
