...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsConnectionSummary>] :items The value to assign to the {#items} property
