...
module OCI
  ...
  class DatabaseTools::Models::UpdateDatabaseToolsConnectionOracleDatabaseDetails < DatabaseTools::Models::UpdateDatabaseToolsConnectionDetails
    ...
    def self.swagger_types
      {
        ...
        'type': :'String',
        'related_resource': :'OCI::DatabaseTools::Models::UpdateDatabaseToolsRelatedResourceDetails',
    ...
    # @option attributes [OCI::DatabaseTools::Models::UpdateDatabaseToolsRelatedResourceDetails] :related_resource The value to assign to the {#related_resource} property
