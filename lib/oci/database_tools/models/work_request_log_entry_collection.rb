...
module OCI
  ...
  class DatabaseTools::Models::WorkRequestLogEntryCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseTools::Models::WorkRequestLogEntry>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::WorkRequestLogEntry>] :items The value to assign to the {#items} property
