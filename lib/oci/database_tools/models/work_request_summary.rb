...
module OCI
  ...
  class DatabaseTools::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::DatabaseTools::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DatabaseTools::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
