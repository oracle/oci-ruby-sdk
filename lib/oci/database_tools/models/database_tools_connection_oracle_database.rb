...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabase < DatabaseTools::Models::DatabaseToolsConnection
    ...
    def self.swagger_types
      {
        ...
        'key_stores': :'Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStore>',
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStore>] :key_stores The value to assign to the {#key_stores} property
