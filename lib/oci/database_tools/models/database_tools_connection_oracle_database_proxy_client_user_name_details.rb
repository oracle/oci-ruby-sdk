...
require 'date'
require_relative 'database_tools_connection_oracle_database_proxy_client_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Proxy client information for user name based proxy authentication.
  class DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientUserNameDetails < DatabaseTools::Models::DatabaseToolsConnectionOracleDatabaseProxyClientDetails
