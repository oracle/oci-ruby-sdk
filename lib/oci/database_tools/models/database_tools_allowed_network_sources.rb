...
module OCI
  ...
  #
  class DatabaseTools::Models::DatabaseToolsAllowedNetworkSources
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsVirtualSource>]
    ...
    def self.swagger_types
      {
        ...
        'virtual_source_list': :'Array<OCI::DatabaseTools::Models::DatabaseToolsVirtualSource>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsVirtualSource>] :virtual_source_list The value to assign to the {#virtual_source_list} property
    ...
    def hash
      [public_source_list, virtual_source_list].hash
    end
