...
module OCI
  ...
  class DatabaseTools::Models::WorkRequestErrorCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DatabaseTools::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::WorkRequestError>] :items The value to assign to the {#items} property
