...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionGenericJdbc < DatabaseTools::Models::DatabaseToolsConnection
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreGenericJdbc>]
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreGenericJdbc>] :key_stores The value to assign to the {#key_stores} property
