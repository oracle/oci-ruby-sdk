...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsKeyStorePasswordMySqlSummary
    VALUE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsKeyStorePasswordSecretIdMySqlSummary' if type == 'SECRETID'
