...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsConnectionMySqlSummary < DatabaseTools::Models::DatabaseToolsConnectionSummary
    ...
    #
    # @return [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreMySqlSummary>]
    ...
    def self.swagger_types
      {
        ...
        'key_stores': :'Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreMySqlSummary>',
    ...
    # @option attributes [Array<OCI::DatabaseTools::Models::DatabaseToolsKeyStoreMySqlSummary>] :key_stores The value to assign to the {#key_stores} property
