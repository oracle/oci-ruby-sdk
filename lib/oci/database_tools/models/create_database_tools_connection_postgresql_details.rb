...
module OCI
  ...
  class DatabaseTools::Models::CreateDatabaseToolsConnectionPostgresqlDetails < DatabaseTools::Models::CreateDatabaseToolsConnectionDetails
    # @return [OCI::DatabaseTools::Models::CreateDatabaseToolsRelatedResourcePostgresqlDetails]
    ...
    def self.swagger_types
      {
        ...
        'related_resource': :'OCI::DatabaseTools::Models::CreateDatabaseToolsRelatedResourcePostgresqlDetails',
    ...
    # @option attributes [OCI::DatabaseTools::Models::CreateDatabaseToolsRelatedResourcePostgresqlDetails] :related_resource The value to assign to the {#related_resource} property
    ...
    def hash
      [display_name, compartment_id, defined_tags, freeform_tags, locks, type, runtime_support, related_resource, connection_string, user_name, user_password, advanced_properties, key_stores, private_endpoint_id].hash
    end
