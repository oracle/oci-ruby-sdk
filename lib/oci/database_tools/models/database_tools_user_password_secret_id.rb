...
require 'date'
require_relative 'database_tools_user_password'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The user password.
  class DatabaseTools::Models::DatabaseToolsUserPasswordSecretId < DatabaseTools::Models::DatabaseToolsUserPassword
