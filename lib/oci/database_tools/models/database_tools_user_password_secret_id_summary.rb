...
require 'date'
require_relative 'database_tools_user_password_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The user password.
  class DatabaseTools::Models::DatabaseToolsUserPasswordSecretIdSummary < DatabaseTools::Models::DatabaseToolsUserPasswordSummary
