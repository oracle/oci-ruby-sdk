...
module OCI
  ...
  class DatabaseTools::Models::DatabaseToolsKeyStoreContentPostgresqlDetails
    VALUE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseTools::Models::DatabaseToolsKeyStoreContentSecretIdPostgresqlDetails' if type == 'SECRETID'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseTools::Models::DatabaseToolsKeyStoreContentPostgresqlDetails'
    end
