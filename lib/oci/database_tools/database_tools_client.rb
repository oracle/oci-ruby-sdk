...
module OCI
  ...
  class DatabaseTools::DatabaseToolsClient
    ...
    # @option opts [Array<String>] :runtime_support A filter to return only resources with one of the specified runtimeSupport values.
    #   Allowed values are: SUPPORTED, UNSUPPORTED
    # @option opts [String] :related_resource_identifier A filter to return only resources associated to the related resource identifier OCID passed in the query string.
