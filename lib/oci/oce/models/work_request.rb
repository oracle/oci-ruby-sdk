...
module OCI
  ...
  class Oce::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_OCE_INSTANCE = 'CREATE_OCE_INSTANCE'.freeze,
      OPERATION_TYPE_UPDATE_OCE_INSTANCE = 'UPDATE_OCE_INSTANCE'.freeze,
      OPERATION_TYPE_DELETE_OCE_INSTANCE = 'DELETE_OCE_INSTANCE'.freeze,
    ...
    # @return [Array<OCI::Oce::Models::WorkRequestResource>]
    attr_accessor :resources

    # @return [OCI::Oce::Models::WorkflowMonitor]
    attr_accessor :workflow_monitor
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Oce::Models::WorkRequestResource>',
        'workflow_monitor': :'OCI::Oce::Models::WorkflowMonitor',
    ...
    # @option attributes [Array<OCI::Oce::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    # @option attributes [OCI::Oce::Models::WorkflowMonitor] :workflow_monitor The value to assign to the {#workflow_monitor} property
    ...
    def initialize(attributes = {})
      ...
      self.workflow_monitor = attributes[:'workflowMonitor'] if attributes[:'workflowMonitor']

      raise 'You cannot provide both :workflowMonitor and :workflow_monitor' if attributes.key?(:'workflowMonitor') && attributes.key?(:'workflow_monitor')

      self.workflow_monitor = attributes[:'workflow_monitor'] if attributes[:'workflow_monitor']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        workflow_monitor == other.workflow_monitor &&
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, workflow_monitor, percent_complete, time_accepted, time_started, time_finished].hash
    end
