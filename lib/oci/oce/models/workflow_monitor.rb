...
module OCI
  ...
  class Oce::Models::WorkflowMonitor
    ...
    # @return [Array<OCI::Oce::Models::WorkflowStep>]
    ...
    def self.swagger_types
      {
        ...
        'workflow_steps': :'Array<OCI::Oce::Models::WorkflowStep>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Oce::Models::WorkflowStep>] :workflow_steps The value to assign to the {#workflow_steps} property
    def initialize(attributes = {})
      ...
      self.workflow_steps = attributes[:'workflowSteps'] if attributes[:'workflowSteps']

      raise 'You cannot provide both :workflowSteps and :workflow_steps' if attributes.key?(:'workflowSteps') && attributes.key?(:'workflow_steps')

      self.workflow_steps = attributes[:'workflow_steps'] if attributes[:'workflow_steps']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        workflow_steps == other.workflow_steps
    end
    ...
    def hash
      [workflow_name, resource_name, workflow_steps].hash
    end
