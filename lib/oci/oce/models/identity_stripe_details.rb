...
module OCI
  ...
  class Oce::Models::IdentityStripeDetails
    ...
    # **[Required]** Value of the Identity Cloud Service tenancy.
    ...
    # @option attributes [String] :tenancy The value to assign to the {#tenancy} property
    def initialize(attributes = {})
      ...
      self.tenancy = attributes[:'tenancy'] if attributes[:'tenancy']
    end
