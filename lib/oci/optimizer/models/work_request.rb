...
module OCI
  ...
  class Optimizer::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_BULK_APPLY_RECOMMENDATIONS = 'BULK_APPLY_RECOMMENDATIONS'.freeze,
    ...
    # @return [Array<OCI::Optimizer::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Optimizer::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Optimizer::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
