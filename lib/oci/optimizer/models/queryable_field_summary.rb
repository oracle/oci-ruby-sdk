...
module OCI
  ...
  class Optimizer::Models::QueryableFieldSummary
    ...
    #
    # @return [Array<OCI::Optimizer::Models::QueryableFieldSummary>]
    ...
    # @option attributes [Array<OCI::Optimizer::Models::QueryableFieldSummary>] :object_properties The value to assign to the {#object_properties} property
    ...
    def hash
      [field_type, field_name, object_properties].hash
    end
