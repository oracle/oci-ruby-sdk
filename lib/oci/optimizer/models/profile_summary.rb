...
module OCI
  ...
  class Optimizer::Models::ProfileSummary
    ...
    def hash
      [id, compartment_id, name, description, aggregation_interval_in_days, defined_tags, freeform_tags, system_tags, lifecycle_state, levels_configuration, target_compartments, target_tags, time_created, time_updated].hash
    end
