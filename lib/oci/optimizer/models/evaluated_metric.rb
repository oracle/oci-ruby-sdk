...
module OCI
  ...
  class Optimizer::Models::EvaluatedMetric
    ...
    # @option attributes [String] :statistic The value to assign to the {#statistic} property
    # @option attributes [Float] :threshold The value to assign to the {#threshold} property
    # @option attributes [Float] :target The value to assign to the {#target} property
