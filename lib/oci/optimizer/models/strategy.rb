...
module OCI
  ...
  #
  class Optimizer::Models::Strategy
    ...
    # @return [Array<OCI::Optimizer::Models::StrategyParameter>]
    attr_accessor :parameters_definition
    ...
    # @option attributes [Array<OCI::Optimizer::Models::StrategyParameter>] :parameters_definition The value to assign to the {#parameters_definition} property
    def initialize(attributes = {})
      ...
      self.parameters_definition = attributes[:'parametersDefinition'] if attributes[:'parametersDefinition']

      raise 'You cannot provide both :parametersDefinition and :parameters_definition' if attributes.key?(:'parametersDefinition') && attributes.key?(:'parameters_definition')

      self.parameters_definition = attributes[:'parameters_definition'] if attributes[:'parameters_definition']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        parameters_definition == other.parameters_definition
    end
    ...
    def hash
      [strategy_name, is_default, parameters_definition].hash
    end
