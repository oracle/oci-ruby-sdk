...
module OCI
  ...
  class Optimizer::Models::CategorySummary
    ...
    def hash
      [id, compartment_id, compartment_name, name, description, recommendation_counts, resource_counts, lifecycle_state, estimated_cost_saving, time_created, time_updated, extended_metadata].hash
    end
