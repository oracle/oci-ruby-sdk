...
module OCI
  ...
  class Optimizer::Models::CreateProfileDetails
    ...
    def hash
      [compartment_id, name, description, aggregation_interval_in_days, defined_tags, freeform_tags, system_tags, levels_configuration, target_compartments, target_tags].hash
    end
