...
module OCI
  ...
  class Optimizer::OptimizerClient
    ...
    #   When using this parameter, please make sure to set the compartmentId with the parent tenancy ID.
    #    (default to false)
    # @option opts [BOOLEAN] :include_resource_metadata Supplement additional resource information in extended metadata response. (default to false)
    ...
    def filter_resource_actions(compartment_id, compartment_id_in_subtree, query_details, opts = {})
      ...
      query_params[:includeResourceMetadata] = opts[:include_resource_metadata] if !opts[:include_resource_metadata].nil?
