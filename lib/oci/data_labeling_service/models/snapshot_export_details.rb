...
module OCI
  ...
  class DataLabelingService::Models::SnapshotExportDetails
    EXPORT_TYPE_ENUM = [
    ...
    # @option attributes [String] :export_type The value to assign to the {#export_type} property
    ...
    def export_type=(export_type)
      raise "Invalid value for 'export_type': this must be one of the values in EXPORT_TYPE_ENUM." if export_type && !EXPORT_TYPE_ENUM.include?(export_type)
