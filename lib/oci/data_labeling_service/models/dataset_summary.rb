...
module OCI
  ...
  class DataLabelingService::Models::DatasetSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, annotation_format, dataset_format_details, freeform_tags, defined_tags, system_tags].hash
    end
