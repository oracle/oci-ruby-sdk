...
module OCI
  ...
  class DataLabelingService::Models::ImportPreAnnotatedDataDetails
    ...
    def initialize(attributes = {})
      ...
      self.import_format = attributes[:'importFormat'] if attributes[:'importFormat']

      raise 'You cannot provide both :importFormat and :import_format' if attributes.key?(:'importFormat') && attributes.key?(:'import_format')

      self.import_format = attributes[:'import_format'] if attributes[:'import_format']

      self.import_metadata_path = attributes[:'importMetadataPath'] if attributes[:'importMetadataPath']

      raise 'You cannot provide both :importMetadataPath and :import_metadata_path' if attributes.key?(:'importMetadataPath') && attributes.key?(:'import_metadata_path')

      self.import_metadata_path = attributes[:'import_metadata_path'] if attributes[:'import_metadata_path']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        import_format == other.import_format &&
        import_metadata_path == other.import_metadata_path
    end
    ...
    def hash
      [import_format, import_metadata_path].hash
    end
