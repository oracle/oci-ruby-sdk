...
module OCI
  ...
  class DataLabelingService::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::DataLabelingService::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DataLabelingService::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DataLabelingService::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
