...
require 'date'
require_relative 'snapshot_export_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Specifies where to output the export in Object Storage.
  class DataLabelingService::Models::ObjectStorageSnapshotExportDetails < DataLabelingService::Models::SnapshotExportDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['exportType'] = 'OBJECT_STORAGE'
    ...
    def hash
      [export_type, namespace, bucket, prefix].hash
    end
