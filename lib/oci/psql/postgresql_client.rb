...
module OCI
  ...
  class Psql::PostgresqlClient
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [Array<String>] :excluded_fields A filter to exclude database configuration when this query parameter is set to OverrideDbConfig.
    ...
    # @param [String] default_configuration_id A unique identifier for the configuration.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    # @option opts [DateTime] :time_started The start date for getting backups. An [RFC 3339](https://tools.ietf.org/rfc/rfc3339) formatted datetime string.
    # @option opts [DateTime] :time_ended The end date for getting backups. An [RFC 3339](https://tools.ietf.org/rfc/rfc3339) formatted datetime string.
    # @option opts [String] :lifecycle_state A filter to return only resources if their `lifecycleState` matches the given `lifecycleState`.
    # @option opts [String] :display_name A filter to return only resources that match the entire display name given.
    # @option opts [String] :backup_id A unique identifier for the backup.
    # @option opts [String] :id A unique identifier for the database system.
    ...
    # @option opts [String] :lifecycle_state A filter to return only resources if their `lifecycleState` matches the given `lifecycleState`.
    # @option opts [String] :display_name A filter to return only resources that match the entire display name given.
    # @option opts [String] :db_version Verison of the PostgreSQL database, such as 14.9.
    # @option opts [String] :shape The name of the shape for the configuration.
    #   Example: `VM.Standard.E4.Flex`
    #
    # @option opts [String] :configuration_id A unique identifier for the configuration.
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @option opts [String] :sort_order The sort order to use, either 'ASC' or 'DESC'.
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending.
    ...
    # @option opts [String] :status A filter to return only resources if their `lifecycleState` matches the given OperationStatus.
