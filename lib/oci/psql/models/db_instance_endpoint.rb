...
module OCI
  ...
  class Psql::Models::DbInstanceEndpoint
    ...
    def self.swagger_types
      {
        ...
        'endpoint': :'OCI::Psql::Models::Endpoint'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Psql::Models::Endpoint] :endpoint The value to assign to the {#endpoint} property
