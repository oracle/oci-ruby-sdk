...
module OCI
  ...
  class Psql::Models::ConfigurationSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the configuration. Immutable on creation.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The date and time the configuration was created, expressed in
