...
module OCI
  ...
  class Psql::Models::ConfigurationSummary
    # **[Required]** Unique identifier that is immutable on creation
    # @return [String]
    attr_accessor :id

    # **[Required]** Configuration identifier name
    # @return [String]
    ...
    # **[Required]** The time the the Configuration was created. An RFC3339 formatted datetime string
    # @return [DateTime]
    ...
    def hash
      [id, display_name, compartment_id, time_created, lifecycle_state, lifecycle_details, shape, db_version, instance_ocpu_count, instance_memory_size_in_gbs, freeform_tags, defined_tags, system_tags].hash
    end
