...
module OCI
  ...
  class Psql::Models::CreateConfigurationDetails
    # **[Required]** configuration display name
    # @return [String]
    ...
    # **[Required]** Compute Shape Name like VM.Standard3.Flex.
    # @return [String]
    attr_accessor :shape

    # **[Required]** Version of the Postgresql DB
    # @return [String]
    attr_accessor :db_version

    # **[Required]** CPU cpuCoreCount. Min value is 1. Max value depends on the shape.
    #
    # @return [Integer]
    attr_accessor :instance_ocpu_count

    # **[Required]** Memory Size in GB with 1GB increment. Min value matches the cpuCoreCount. Max value depends on the shape.
    #
    # @return [Integer]
    attr_accessor :instance_memory_size_in_gbs

    # This attribute is required.
    # @return [OCI::Psql::Models::DbConfigurationOverrideCollection]
    attr_accessor :db_configuration_overrides
    ...
    # @option attributes [OCI::Psql::Models::DbConfigurationOverrideCollection] :db_configuration_overrides The value to assign to the {#db_configuration_overrides} property
    ...
    def initialize(attributes = {})
      ...
      self.db_configuration_overrides = attributes[:'dbConfigurationOverrides'] if attributes[:'dbConfigurationOverrides']

      raise 'You cannot provide both :dbConfigurationOverrides and :db_configuration_overrides' if attributes.key?(:'dbConfigurationOverrides') && attributes.key?(:'db_configuration_overrides')

      self.db_configuration_overrides = attributes[:'db_configuration_overrides'] if attributes[:'db_configuration_overrides']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        db_configuration_overrides == other.db_configuration_overrides &&
    ...
    def hash
      [display_name, compartment_id, description, shape, db_version, instance_ocpu_count, instance_memory_size_in_gbs, db_configuration_overrides, freeform_tags, defined_tags, system_tags].hash
    end
