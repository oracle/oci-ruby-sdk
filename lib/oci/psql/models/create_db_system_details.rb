...
module OCI
  ...
  class Psql::Models::CreateDbSystemDetails
    # **[Required]** DbSystem display name
    # @return [String]
    ...
    # **[Required]** Version of DbSystem software.
    # @return [String]
    ...
    # **[Required]** Shape of DbInstance. This name should match from with one of the available shapes from /shapes API.
    # @return [String]
    attr_accessor :shape
    ...
    #
    # @return [Array<OCI::Psql::Models::CreateDbInstanceDetails>]
    attr_accessor :instances_details

    # @return [OCI::Psql::Models::Credentials]
    ...
    # @return [OCI::Psql::Models::ManagementPolicyDetails]
    ...
    def self.swagger_types
      {
        ...
        'instances_details': :'Array<OCI::Psql::Models::CreateDbInstanceDetails>',
    ...
    # @option attributes [Array<OCI::Psql::Models::CreateDbInstanceDetails>] :instances_details The value to assign to the {#instances_details} property
    # @option attributes [OCI::Psql::Models::Credentials] :credentials The value to assign to the {#credentials} property
    # @option attributes [OCI::Psql::Models::NetworkDetails] :network_details The value to assign to the {#network_details} property
    # @option attributes [OCI::Psql::Models::ManagementPolicyDetails] :management_policy The value to assign to the {#management_policy} property
    ...
    def initialize(attributes = {})
      ...
      self.instances_details = attributes[:'instancesDetails'] if attributes[:'instancesDetails']

      raise 'You cannot provide both :instancesDetails and :instances_details' if attributes.key?(:'instancesDetails') && attributes.key?(:'instances_details')

      self.instances_details = attributes[:'instances_details'] if attributes[:'instances_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        instances_details == other.instances_details &&
    ...
    def hash
      [display_name, description, compartment_id, system_type, db_version, config_id, storage_details, shape, instance_ocpu_count, instance_memory_size_in_gbs, instance_count, instances_details, credentials, network_details, management_policy, source, freeform_tags, defined_tags].hash
    end
