...
module OCI
  ...
  class Psql::Models::DbSystemSummary
    ...
    # **[Required]** The time the the DbSystem was created. An RFC3339 formatted datetime string
    # @return [DateTime]
    ...
    # **[Required]** The current state of the DbSystem.
    # @return [String]
    ...
    # **[Required]** Count of DbInstances in the DbSystem.
    # @return [Integer]
    ...
    # **[Required]** The total number of OCPUs available to each DbInstance.
    # @return [Integer]
    attr_accessor :instance_ocpu_count

    # **[Required]** The total amount of memory available to each DbInstance, in gigabytes.
    # @return [Integer]
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, system_type, instance_count, shape, instance_ocpu_count, instance_memory_size_in_gbs, db_version, config_id, freeform_tags, defined_tags, system_tags].hash
    end
