...
module OCI
  ...
  class Psql::Models::BackupSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, source_type, backup_size, db_system_id, retention_period, freeform_tags, defined_tags, system_tags].hash
    end
