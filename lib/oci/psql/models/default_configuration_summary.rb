...
module OCI
  ...
  class Psql::Models::DefaultConfigurationSummary
    ...
    def hash
      [id, display_name, time_created, lifecycle_state, lifecycle_details, shape, db_version, instance_ocpu_count, instance_memory_size_in_gbs].hash
    end
