...
module OCI
  ...
  class Psql::Models::Configuration
    ...
    # **[Required]** Config compartment identifier
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The time Configuration was created. An RFC3339 formatted datetime string
    # @return [DateTime]
    ...
    # @return [OCI::Psql::Models::ConfigurationDetails]
    ...
    def self.swagger_types
      {
        ...
        'db_version': :'String',
        'configuration_details': :'OCI::Psql::Models::ConfigurationDetails',
    ...
    # @option attributes [OCI::Psql::Models::ConfigurationDetails] :configuration_details The value to assign to the {#configuration_details} property
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, lifecycle_state, lifecycle_details, shape, instance_ocpu_count, instance_memory_size_in_gbs, db_version, configuration_details, freeform_tags, defined_tags, system_tags].hash
    end
