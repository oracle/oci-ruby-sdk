...
module OCI
  ...
  class Psql::Models::WorkRequestError
    # **[Required]** A machine-usable [code](https://docs.cloud.oracle.com/Content/API/References/apierrors.htm) for the error that occured.
    # @return [String]
    attr_accessor :code
