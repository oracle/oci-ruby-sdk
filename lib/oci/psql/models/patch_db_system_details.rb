...
module OCI
  ...
  #
  class Psql::Models::PatchDbSystemDetails
    # List of patch instructions.
    # @return [Array<OCI::Psql::Models::PatchInstruction>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Psql::Models::PatchInstruction>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Psql::Models::PatchInstruction>] :items The value to assign to the {#items} property
