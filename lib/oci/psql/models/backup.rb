...
module OCI
  ...
  class Psql::Models::Backup
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the backup.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment that contains the backup.
    # @return [String]
    ...
    # **[Required]** The date and time the backup was created, expressed in
    ...
    # @return [OCI::Psql::Models::DbSystemDetails]
    attr_accessor :db_system_details
    ...
    # @return [String]
    attr_accessor :last_completed_request_token
    ...
    # @option attributes [Integer] :retention_period The value to assign to the {#retention_period} property
    # @option attributes [Integer] :backup_size The value to assign to the {#backup_size} property
    # @option attributes [String] :db_system_id The value to assign to the {#db_system_id} property
    # @option attributes [OCI::Psql::Models::DbSystemDetails] :db_system_details The value to assign to the {#db_system_details} property
    # @option attributes [String] :last_accepted_request_token The value to assign to the {#last_accepted_request_token} property
    # @option attributes [String] :last_completed_request_token The value to assign to the {#last_completed_request_token} property
    ...
    def initialize(attributes = {})
      ...
      self.db_system_details = attributes[:'dbSystemDetails'] if attributes[:'dbSystemDetails']

      raise 'You cannot provide both :dbSystemDetails and :db_system_details' if attributes.key?(:'dbSystemDetails') && attributes.key?(:'db_system_details')

      self.db_system_details = attributes[:'db_system_details'] if attributes[:'db_system_details']
      ...
      self.last_completed_request_token = attributes[:'lastCompletedRequestToken'] if attributes[:'lastCompletedRequestToken']

      raise 'You cannot provide both :lastCompletedRequestToken and :last_completed_request_token' if attributes.key?(:'lastCompletedRequestToken') && attributes.key?(:'last_completed_request_token')

      self.last_completed_request_token = attributes[:'last_completed_request_token'] if attributes[:'last_completed_request_token']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        db_system_details == other.db_system_details &&
        last_accepted_request_token == other.last_accepted_request_token &&
        last_completed_request_token == other.last_completed_request_token &&
    ...
    def hash
      [id, display_name, description, compartment_id, source_type, time_created, time_updated, lifecycle_state, lifecycle_details, retention_period, backup_size, db_system_id, db_system_details, last_accepted_request_token, last_completed_request_token, freeform_tags, defined_tags, system_tags].hash
    end
