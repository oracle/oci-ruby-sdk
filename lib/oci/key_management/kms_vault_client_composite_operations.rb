...
module OCI
  ...
  class KeyManagement::KmsVaultClientCompositeOperations
    ...
    # Calls {OCI::KeyManagement::KmsVaultClient#backup_vault} and then waits for the {OCI::KeyManagement::Models::Vault} acted upon
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::KeyManagement::KmsVaultClient#backup_vault}
    ...
    def backup_vault_and_wait_for_state(vault_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.backup_vault(vault_id, base_operation_opts)
