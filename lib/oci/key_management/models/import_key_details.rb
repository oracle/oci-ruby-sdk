...
module OCI
  ...
  class KeyManagement::Models::ImportKeyDetails
    ...
    # @return [OCI::KeyManagement::Models::AutoKeyRotationDetails]
    attr_accessor :auto_key_rotation_details
    ...
    # @option attributes [OCI::KeyManagement::Models::AutoKeyRotationDetails] :auto_key_rotation_details The value to assign to the {#auto_key_rotation_details} property
    ...
    def hash
      [is_auto_rotation_enabled, auto_key_rotation_details, compartment_id, defined_tags, display_name, freeform_tags, key_shape, wrapped_import_key, protection_mode].hash
    end
