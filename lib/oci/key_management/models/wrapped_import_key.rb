...
module OCI
  ...
  class KeyManagement::Models::WrappedImportKey
    ...
    # @option attributes [String] :key_material The value to assign to the {#key_material} property
    # @option attributes [String] :wrapping_algorithm The value to assign to the {#wrapping_algorithm} property
    ...
    # @param [Object] wrapping_algorithm Object to be assigned
    def wrapping_algorithm=(wrapping_algorithm)
      raise "Invalid value for 'wrapping_algorithm': this must be one of the values in WRAPPING_ALGORITHM_ENUM." if wrapping_algorithm && !WRAPPING_ALGORITHM_ENUM.include?(wrapping_algorithm)
