...
module OCI
  ...
  class KeyManagement::Models::CreateKeyDetails
    ...
    # @return [OCI::KeyManagement::Models::ExternalKeyReference]
    attr_accessor :external_key_reference
    ...
    # @option attributes [OCI::KeyManagement::Models::ExternalKeyReference] :external_key_reference The value to assign to the {#external_key_reference} property
    def initialize(attributes = {})
      ...
      self.external_key_reference = attributes[:'externalKeyReference'] if attributes[:'externalKeyReference']

      raise 'You cannot provide both :externalKeyReference and :external_key_reference' if attributes.key?(:'externalKeyReference') && attributes.key?(:'external_key_reference')

      self.external_key_reference = attributes[:'external_key_reference'] if attributes[:'external_key_reference']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        external_key_reference == other.external_key_reference
    end
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, key_shape, is_auto_rotation_enabled, auto_key_rotation_details, protection_mode, external_key_reference].hash
    end
