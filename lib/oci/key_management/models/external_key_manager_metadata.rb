...
module OCI
  ...
  class KeyManagement::Models::ExternalKeyManagerMetadata
    # This attribute is required.
    # @return [OCI::KeyManagement::Models::OauthMetadata]
    attr_accessor :oauth_metadata

    # **[Required]** URI of the vault on external key manager.
    # @return [String]
    attr_accessor :external_vault_endpoint_url
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'oauth_metadata': :'OCI::KeyManagement::Models::OauthMetadata',
    ...
    # @option attributes [OCI::KeyManagement::Models::OauthMetadata] :oauth_metadata The value to assign to the {#oauth_metadata} property
    # @option attributes [String] :external_vault_endpoint_url The value to assign to the {#external_vault_endpoint_url} property
    ...
    def initialize(attributes = {})
      ...
      self.oauth_metadata = attributes[:'oauthMetadata'] if attributes[:'oauthMetadata']

      raise 'You cannot provide both :oauthMetadata and :oauth_metadata' if attributes.key?(:'oauthMetadata') && attributes.key?(:'oauth_metadata')

      self.oauth_metadata = attributes[:'oauth_metadata'] if attributes[:'oauth_metadata']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        oauth_metadata == other.oauth_metadata &&
    ...
    def hash
      [oauth_metadata, external_vault_endpoint_url, private_endpoint_id].hash
    end
