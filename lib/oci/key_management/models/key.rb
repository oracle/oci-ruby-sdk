...
module OCI
  ...
  class KeyManagement::Models::Key
    ...
    def hash
      [compartment_id, current_key_version, defined_tags, display_name, freeform_tags, id, key_shape, protection_mode, lifecycle_state, time_created, time_of_deletion, vault_id, restored_from_key_id, replica_details, is_primary, is_auto_rotation_enabled, auto_key_rotation_details, external_key_reference_details].hash
    end
