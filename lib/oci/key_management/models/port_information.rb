...
module OCI
  ...
  class KeyManagement::Models::PortInformation
    PORT_TYPE_ENUM = [
      PORT_TYPE_CLIENTUTILITY = 'CLIENTUTILITY'.freeze,
      PORT_TYPE_MANAGEMENTUTILITY = 'MANAGEMENTUTILITY'.freeze,
      PORT_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The port number of the cavium server.
    # @return [Integer]
    ...
    # @option attributes [Integer] :port_number The value to assign to the {#port_number} property
