...
module OCI
  ...
  class KeyManagement::Models::BackupLocation
    DESTINATION_ENUM = [
      DESTINATION_BUCKET = 'BUCKET'.freeze,
      DESTINATION_PRE_AUTHENTICATED_REQUEST_URI = 'PRE_AUTHENTICATED_REQUEST_URI'.freeze
    ].freeze

    # **[Required]** 'Backup location destination:
