...
module OCI
  ...
  class KeyManagement::Models::KeySummary
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, id, lifecycle_state, time_created, vault_id, protection_mode, algorithm, external_key_reference_details].hash
    end
