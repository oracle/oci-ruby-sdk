...
module OCI
  ...
  class KeyManagement::Models::HsmCluster
    LIFECYCLE_STATE_ENUM = [
      LIFECYCLE_STATE_CREATING = 'CREATING'.freeze,
      LIFECYCLE_STATE_INITIALIZATION_REQUIRED = 'INITIALIZATION_REQUIRED'.freeze,
      LIFECYCLE_STATE_INITIALIZING = 'INITIALIZING'.freeze,
    ...
    # **[Required]** The OCID of the HSMCluster resource.
    # @return [String]
    attr_accessor :id

    # **[Required]** The OCID of the compartment that contains this HSMCluster resource.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** A user-friendly name for the HSMCluster resource. It does not have to be unique, and it is changeable.
    # Avoid entering confidential information.
    #
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The date and time this HSM resource was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    #
    ...
    # **[Required]** The date and time this HSM resource was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    #
    # Example: `2023-04-03T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # **[Required]** The HSMCluster's current state.
    #
    # Example: `ACTIVE`
    #
    # @return [String]
    ...
    # **[Required]** DNS name for the Hsm Cluster.
    # @return [String]
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, dns_name, time_of_deletion, defined_tags, freeform_tags].hash
    end
