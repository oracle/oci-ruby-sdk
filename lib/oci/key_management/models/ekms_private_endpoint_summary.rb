...
module OCI
  ...
  class KeyManagement::Models::EkmsPrivateEndpointSummary
    ...
    def hash
      [id, subnet_id, compartment_id, time_created, time_updated, display_name, freeform_tags, defined_tags, lifecycle_state].hash
    end
