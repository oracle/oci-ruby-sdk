...
module OCI
  ...
  class KeyManagement::Models::ReplicationStatusDetails
    # @return [Array<OCI::KeyManagement::Models::ReplicaDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'replica_details': :'Array<OCI::KeyManagement::Models::ReplicaDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::KeyManagement::Models::ReplicaDetails>] :replica_details The value to assign to the {#replica_details} property
