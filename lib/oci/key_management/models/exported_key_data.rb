...
module OCI
  ...
  class KeyManagement::Models::ExportedKeyData
    ALGORITHM_ENUM = [
    ...
    # @option attributes [String] :encrypted_key The value to assign to the {#encrypted_key} property
    ...
    def initialize(attributes = {})
      ...
      self.encrypted_key = attributes[:'encryptedKey'] if attributes[:'encryptedKey']

      raise 'You cannot provide both :encryptedKey and :encrypted_key' if attributes.key?(:'encryptedKey') && attributes.key?(:'encrypted_key')

      self.encrypted_key = attributes[:'encrypted_key'] if attributes[:'encrypted_key']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        encrypted_key == other.encrypted_key &&
    ...
    def hash
      [key_version_id, key_id, time_created, vault_id, encrypted_key, algorithm].hash
    end
