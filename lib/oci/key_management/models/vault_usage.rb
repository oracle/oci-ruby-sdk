...
module OCI
  ...
  class KeyManagement::Models::VaultUsage
    # **[Required]** The number of keys in this vault, across all compartments, excluding keys in a `DELETED` state.
    # @return [Integer]
    attr_accessor :key_count

    # **[Required]** The number of key versions in this vault, across all compartments, excluding key versions in a `DELETED` state.
    # @return [Integer]
