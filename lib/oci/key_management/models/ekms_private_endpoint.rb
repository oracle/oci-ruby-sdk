...
module OCI
  ...
  class KeyManagement::Models::EkmsPrivateEndpoint
    ...
    def hash
      [id, compartment_id, subnet_id, display_name, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, lifecycle_details, external_key_manager_ip, port, ca_bundle, private_endpoint_ip].hash
    end
