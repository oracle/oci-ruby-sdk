...
module OCI
  ...
  class KeyManagement::Models::BackupLocationURI < KeyManagement::Models::BackupLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['destination'] = 'PRE_AUTHENTICATED_REQUEST_URI'
