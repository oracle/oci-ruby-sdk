...
module OCI
  ...
  class ThreatIntelligence::Models::GeodataDetails
    # Encompassing assigned prefix for the IP
    # @return [String]
    attr_accessor :routed_prefix
    ...
    # @option attributes [String] :routed_prefix The value to assign to the {#routed_prefix} property
    # @option attributes [String] :origin The value to assign to the {#origin} property
    # @option attributes [String] :geo_id The value to assign to the {#geo_id} property
    # @option attributes [String] :country_code The value to assign to the {#country_code} property
    # @option attributes [String] :admin_div The value to assign to the {#admin_div} property
    # @option attributes [String] :city The value to assign to the {#city} property
    # @option attributes [String] :latitude The value to assign to the {#latitude} property
    # @option attributes [String] :longitude The value to assign to the {#longitude} property
