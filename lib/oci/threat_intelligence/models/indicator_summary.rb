...
module OCI
  ...
  class ThreatIntelligence::Models::IndicatorSummary
    ...
    #
    # @return [Array<OCI::ThreatIntelligence::Models::IndicatorAttributeSummary>]
    ...
    # @option attributes [Array<OCI::ThreatIntelligence::Models::IndicatorAttributeSummary>] :attributes The value to assign to the {#attributes} property
    ...
    def hash
      [id, type, value, confidence, compartment_id, threat_types, attributes, lifecycle_state, time_created, time_updated, time_last_seen, geodata].hash
    end
