...
module OCI
  ...
  #
  class DataCatalog::Models::TypeCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of types.
    # @return [Array<OCI::DataCatalog::Models::TypeSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::TypeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::TypeSummary>] :items The value to assign to the {#items} property
