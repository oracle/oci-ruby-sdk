...
module OCI
  ...
  class DataCatalog::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_CATALOG = 'CREATE_CATALOG'.freeze,
      OPERATION_TYPE_UPDATE_CATALOG = 'UPDATE_CATALOG'.freeze,
      OPERATION_TYPE_DELETE_CATALOG = 'DELETE_CATALOG'.freeze,
      OPERATION_TYPE_MOVE_CATALOG = 'MOVE_CATALOG'.freeze,
      OPERATION_TYPE_CREATE_CATALOG_PRIVATE_ENDPOINT = 'CREATE_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_DELETE_CATALOG_PRIVATE_ENDPOINT = 'DELETE_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_UPDATE_CATALOG_PRIVATE_ENDPOINT = 'UPDATE_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_MOVE_CATALOG_PRIVATE_ENDPOINT = 'MOVE_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_ATTACH_CATALOG_PRIVATE_ENDPOINT = 'ATTACH_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_DETACH_CATALOG_PRIVATE_ENDPOINT = 'DETACH_CATALOG_PRIVATE_ENDPOINT'.freeze,
      OPERATION_TYPE_CREATE_METASTORE = 'CREATE_METASTORE'.freeze,
      OPERATION_TYPE_UPDATE_METASTORE = 'UPDATE_METASTORE'.freeze,
      OPERATION_TYPE_DELETE_METASTORE = 'DELETE_METASTORE'.freeze,
      OPERATION_TYPE_MOVE_METASTORE = 'MOVE_METASTORE'.freeze,
    ...
    # @return [Array<OCI::DataCatalog::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DataCatalog::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
