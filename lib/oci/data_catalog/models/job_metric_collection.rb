...
module OCI
  ...
  #
  class DataCatalog::Models::JobMetricCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of job metrics.
    # @return [Array<OCI::DataCatalog::Models::JobMetricSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::JobMetricSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::JobMetricSummary>] :items The value to assign to the {#items} property
