...
module OCI
  ...
  class DataCatalog::Models::ConnectionAliasSummary
    ...
    # @option attributes [String] :alias_details The value to assign to the {#alias_details} property
    def initialize(attributes = {})
      ...
      self.alias_details = attributes[:'aliasDetails'] if attributes[:'aliasDetails']

      raise 'You cannot provide both :aliasDetails and :alias_details' if attributes.key?(:'aliasDetails') && attributes.key?(:'alias_details')

      self.alias_details = attributes[:'alias_details'] if attributes[:'alias_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        alias_details == other.alias_details
    end
