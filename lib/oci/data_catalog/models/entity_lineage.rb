...
module OCI
  ...
  class DataCatalog::Models::EntityLineage
    DIRECTION_ENUM = [
    ...
    # @return [Array<OCI::DataCatalog::Models::LineageObject>]
    attr_accessor :objects

    # Set of relationships between the objects in the 'objects' set.
    # @return [Array<OCI::DataCatalog::Models::LineageRelationship>]
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::LineageObject>] :objects The value to assign to the {#objects} property
    # @option attributes [Array<OCI::DataCatalog::Models::LineageRelationship>] :relationships The value to assign to the {#relationships} property
    # @option attributes [Hash<String, Hash<String, String>>] :annotations The value to assign to the {#annotations} property
