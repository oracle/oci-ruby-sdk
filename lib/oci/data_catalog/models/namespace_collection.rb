...
module OCI
  ...
  #
  class DataCatalog::Models::NamespaceCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of namespace summaries
    # @return [Array<OCI::DataCatalog::Models::NamespaceSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::NamespaceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::NamespaceSummary>] :items The value to assign to the {#items} property
