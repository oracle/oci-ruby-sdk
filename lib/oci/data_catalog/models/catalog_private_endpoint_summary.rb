...
module OCI
  ...
  class DataCatalog::Models::CatalogPrivateEndpointSummary
    ...
    def hash
      [id, subnet_id, dns_zones, compartment_id, time_created, time_updated, display_name, lifecycle_details, freeform_tags, system_tags, defined_tags, lifecycle_state, attached_catalogs, locks].hash
    end
