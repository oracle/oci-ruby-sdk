...
module OCI
  ...
  class DataCatalog::Models::CatalogPrivateEndpointSummary
    ...
    # **[Required]** List of DNS zones to be used by the data assets to be harvested.
    ...
    # @return [Array<String>]
    attr_accessor :attached_catalogs
    ...
    # @option attributes [Array<String>] :attached_catalogs The value to assign to the {#attached_catalogs} property
    ...
    def hash
      [id, subnet_id, dns_zones, compartment_id, time_created, time_updated, display_name, lifecycle_details, freeform_tags, defined_tags, lifecycle_state, attached_catalogs].hash
    end
