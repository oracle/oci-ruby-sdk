...
module OCI
  ...
  class DataCatalog::Models::CatalogSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, number_of_objects, lifecycle_state, lifecycle_details, freeform_tags, system_tags, defined_tags, attached_catalog_private_endpoints, locks].hash
    end
