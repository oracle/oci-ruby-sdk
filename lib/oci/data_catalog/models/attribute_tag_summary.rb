...
module OCI
  ...
  class DataCatalog::Models::AttributeTagSummary
    ...
    # @option attributes [String] :attribute_key The value to assign to the {#attribute_key} property
    ...
    def hash
      [attribute_key, key, time_created, name, uri, term_key, term_path, term_description, glossary_key, lifecycle_state].hash
    end
