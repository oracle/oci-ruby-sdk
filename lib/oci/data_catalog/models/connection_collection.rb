...
module OCI
  ...
  #
  class DataCatalog::Models::ConnectionCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of connection summaries.
    # @return [Array<OCI::DataCatalog::Models::ConnectionSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::ConnectionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::ConnectionSummary>] :items The value to assign to the {#items} property
