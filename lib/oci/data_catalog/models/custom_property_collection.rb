...
module OCI
  ...
  #
  class DataCatalog::Models::CustomPropertyCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::CustomPropertySummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::CustomPropertySummary>] :items The value to assign to the {#items} property
