...
module OCI
  ...
  class DataCatalog::Models::DerivedLogicalEntities
    ...
    # @return [Array<String>]
    attr_accessor :files_in_logical_grouping
    ...
    # @option attributes [Array<String>] :files_in_logical_grouping The value to assign to the {#files_in_logical_grouping} property
