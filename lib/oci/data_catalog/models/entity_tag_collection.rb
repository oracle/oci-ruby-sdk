...
module OCI
  ...
  #
  class DataCatalog::Models::EntityTagCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of entity tags.
    # @return [Array<OCI::DataCatalog::Models::EntityTagSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::EntityTagSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::EntityTagSummary>] :items The value to assign to the {#items} property
