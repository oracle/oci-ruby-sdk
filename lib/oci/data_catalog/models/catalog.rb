...
module OCI
  ...
  class DataCatalog::Models::Catalog
    ...
    # @option attributes [String] :service_api_url The value to assign to the {#service_api_url} property
    # @option attributes [String] :service_console_url The value to assign to the {#service_console_url} property
    # @option attributes [Integer] :number_of_objects The value to assign to the {#number_of_objects} property
    ...
    def initialize(attributes = {})
      ...
      self.service_api_url = attributes[:'serviceApiUrl'] if attributes[:'serviceApiUrl']

      raise 'You cannot provide both :serviceApiUrl and :service_api_url' if attributes.key?(:'serviceApiUrl') && attributes.key?(:'service_api_url')

      self.service_api_url = attributes[:'service_api_url'] if attributes[:'service_api_url']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        service_api_url == other.service_api_url &&
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, service_api_url, service_console_url, number_of_objects, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, attached_catalog_private_endpoints].hash
    end
