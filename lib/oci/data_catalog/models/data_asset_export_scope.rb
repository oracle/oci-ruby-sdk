...
module OCI
  ...
  #
  class DataCatalog::Models::DataAssetExportScope
    ...
    # @option attributes [Array<String>] :export_type_ids The value to assign to the {#export_type_ids} property
