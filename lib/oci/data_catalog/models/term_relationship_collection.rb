...
module OCI
  ...
  #
  class DataCatalog::Models::TermRelationshipCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of term relationships.
    # @return [Array<OCI::DataCatalog::Models::TermRelationshipSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::TermRelationshipSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::TermRelationshipSummary>] :items The value to assign to the {#items} property
