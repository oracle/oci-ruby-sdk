...
module OCI
  ...
  class DataCatalog::Models::DataAssetTagSummary
    ...
    def hash
      [data_asset_key, key, time_created, name, uri, term_key, term_path, term_description, glossary_key, lifecycle_state].hash
    end
