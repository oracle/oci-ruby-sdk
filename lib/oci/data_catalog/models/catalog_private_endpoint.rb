...
module OCI
  ...
  class DataCatalog::Models::CatalogPrivateEndpoint
    ...
    def hash
      [id, compartment_id, subnet_id, display_name, dns_zones, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, lifecycle_details, attached_catalogs].hash
    end
