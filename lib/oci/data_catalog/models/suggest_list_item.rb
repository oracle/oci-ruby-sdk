...
module OCI
  ...
  #
  class DataCatalog::Models::SuggestListItem
    ...
    # @option attributes [String] :suggestion The value to assign to the {#suggestion} property
    ...
    def initialize(attributes = {})
      ...
      self.suggestion = attributes[:'suggestion'] if attributes[:'suggestion']
