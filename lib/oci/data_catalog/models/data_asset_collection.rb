...
module OCI
  ...
  #
  class DataCatalog::Models::DataAssetCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of data asset summaries.
    # @return [Array<OCI::DataCatalog::Models::DataAssetSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::DataAssetSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::DataAssetSummary>] :items The value to assign to the {#items} property
