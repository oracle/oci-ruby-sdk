...
module OCI
  ...
  class DataCatalog::Models::ValidateConnectionDetails
    # @return [OCI::DataCatalog::Models::CreateConnectionDetails]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'connection_detail': :'OCI::DataCatalog::Models::CreateConnectionDetails',
    ...
    # @option attributes [OCI::DataCatalog::Models::CreateConnectionDetails] :connection_detail The value to assign to the {#connection_detail} property
    ...
    def hash
      [connection_detail, connection_payload].hash
    end
