...
module OCI
  ...
  #
  class DataCatalog::Models::GlossaryCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of glossaries.
    # @return [Array<OCI::DataCatalog::Models::GlossarySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'count': :'Integer',
        'items': :'Array<OCI::DataCatalog::Models::GlossarySummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::GlossarySummary>] :items The value to assign to the {#items} property
