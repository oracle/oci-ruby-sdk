...
module OCI
  ...
  #
  class DataCatalog::Models::FolderCollection
    # Total number of items returned.
    # @return [Integer]
    attr_accessor :count

    # **[Required]** Collection of folders.
    # @return [Array<OCI::DataCatalog::Models::FolderSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::DataCatalog::Models::FolderSummary>] :items The value to assign to the {#items} property
