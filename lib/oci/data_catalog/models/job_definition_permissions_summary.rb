...
module OCI
  ...
  class DataCatalog::Models::JobDefinitionPermissionsSummary
    ...
    # @option attributes [Array<String>] :user_permissions The value to assign to the {#user_permissions} property
    def initialize(attributes = {})
      ...
      self.user_permissions = attributes[:'userPermissions'] if attributes[:'userPermissions']

      raise 'You cannot provide both :userPermissions and :user_permissions' if attributes.key?(:'userPermissions') && attributes.key?(:'user_permissions')

      self.user_permissions = attributes[:'user_permissions'] if attributes[:'user_permissions']
    end
    ...
    def hash
      [job_definition_key, user_permissions].hash
    end
