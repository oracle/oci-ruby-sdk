...
module OCI
  ...
  class DataCatalog::Models::LineageRelationship
    # Object key of source lineage element.
    # @return [String]
    attr_accessor :from_object_key

    # Object key of target lineage element.
    # @return [String]
    attr_accessor :to_object_key
    ...
    # @option attributes [String] :from_object_key The value to assign to the {#from_object_key} property
    # @option attributes [String] :to_object_key The value to assign to the {#to_object_key} property
    ...
    def initialize(attributes = {})
      ...
      self.from_object_key = attributes[:'fromObjectKey'] if attributes[:'fromObjectKey']
      ...
      self.from_object_key = attributes[:'from_object_key'] if attributes[:'from_object_key']

      self.to_object_key = attributes[:'toObjectKey'] if attributes[:'toObjectKey']

      raise 'You cannot provide both :toObjectKey and :to_object_key' if attributes.key?(:'toObjectKey') && attributes.key?(:'to_object_key')

      self.to_object_key = attributes[:'to_object_key'] if attributes[:'to_object_key']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        from_object_key == other.from_object_key &&
        to_object_key == other.to_object_key &&
    ...
    def hash
      [from_object_key, to_object_key, relationship_type].hash
    end
