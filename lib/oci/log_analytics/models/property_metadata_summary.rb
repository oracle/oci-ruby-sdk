...
module OCI
  ...
  class LogAnalytics::Models::PropertyMetadataSummary
    # The property name.
    # @return [String]
    attr_accessor :name
    ...
    # @return [Array<OCI::LogAnalytics::Models::Level>]
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::Level>] :levels The value to assign to the {#levels} property
    def initialize(attributes = {})
      ...
      self.levels = attributes[:'levels'] if attributes[:'levels']
    end
    ...
    def hash
      [name, display_name, description, default_value, levels].hash
    end
