...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeClusterColumn < LogAnalytics::Models::AbstractColumn
    ...
    #
    # @return [Hash<String, OCI::LogAnalytics::Models::TimeStatsCluster>]
    attr_accessor :clusters

    # List of series data sets for each statistical function specified in the command.
    #
    # @return [Array<OCI::LogAnalytics::Models::TimeClusterDataColumn>]
    ...
    def self.swagger_types
      {
        ...
        'group_by_columns': :'Array<OCI::LogAnalytics::Models::AbstractColumn>',
        'clusters': :'Hash<String, OCI::LogAnalytics::Models::TimeStatsCluster>',
        'series': :'Array<OCI::LogAnalytics::Models::TimeClusterDataColumn>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::AbstractColumn>] :group_by_columns The value to assign to the {#group_by_columns} property
    # @option attributes [Hash<String, OCI::LogAnalytics::Models::TimeStatsCluster>] :clusters The value to assign to the {#clusters} property
    # @option attributes [Array<OCI::LogAnalytics::Models::TimeClusterDataColumn>] :series The value to assign to the {#series} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'TIME_CLUSTER_COLUMN'
      ...
      self.clusters = attributes[:'clusters'] if attributes[:'clusters']
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, is_hidden, value_type, original_display_name, internal_name, interval_gap, intervals, group_by_columns, clusters, series].hash
    end
