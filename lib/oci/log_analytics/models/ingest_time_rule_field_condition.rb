...
require 'date'
require 'logger'
require_relative 'ingest_time_rule_condition'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The field condition(s) to evaluate for an ingest time rule.
  class LogAnalytics::Models::IngestTimeRuleFieldCondition < LogAnalytics::Models::IngestTimeRuleCondition
    FIELD_OPERATOR_ENUM = [
    ...
    # @return [Array<OCI::LogAnalytics::Models::IngestTimeRuleAdditionalFieldCondition>]
    attr_accessor :additional_conditions
    ...
    # @option attributes [String] :field_operator The value to assign to the {#field_operator} property
    # @option attributes [String] :field_value The value to assign to the {#field_value} property
    # @option attributes [Array<OCI::LogAnalytics::Models::IngestTimeRuleAdditionalFieldCondition>] :additional_conditions The value to assign to the {#additional_conditions} property
    ...
    # @param [Object] field_operator Object to be assigned
    def field_operator=(field_operator)
      # rubocop:disable Style/ConditionalAssignment
      if field_operator && !FIELD_OPERATOR_ENUM.include?(field_operator)
        OCI.logger.debug("Unknown value for 'field_operator' [" + field_operator + "]. Mapping to 'FIELD_OPERATOR_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @field_operator = FIELD_OPERATOR_UNKNOWN_ENUM_VALUE
      else
