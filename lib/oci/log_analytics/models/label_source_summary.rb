...
module OCI
  ...
  class LogAnalytics::Models::LabelSourceSummary
    ...
    def hash
      [source_display_name, source_name, source_id, label_operator_name, label_condition, condition_string, condition_block, label_field_displayname, label_field_name].hash
    end
