...
module OCI
  # FieldSummaryReport
  class LogAnalytics::Models::FieldSummaryReport
    ...
    # @return [Array<OCI::LogAnalytics::Models::UsageStatusItem>]
    ...
    def self.swagger_types
      {
        ...
        'oob_count': :'Integer',
        'usage_details': :'Array<OCI::LogAnalytics::Models::UsageStatusItem>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::UsageStatusItem>] :usage_details The value to assign to the {#usage_details} property
    def initialize(attributes = {})
      ...
      self.usage_details = attributes[:'usageDetails'] if attributes[:'usageDetails']

      raise 'You cannot provide both :usageDetails and :usage_details' if attributes.key?(:'usageDetails') && attributes.key?(:'usage_details')

      self.usage_details = attributes[:'usage_details'] if attributes[:'usage_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        usage_details == other.usage_details
    end
    ...
    def hash
      [non_oob_count, oob_count, usage_details].hash
    end
