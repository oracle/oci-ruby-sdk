...
module OCI
  ...
  class LogAnalytics::Models::CreateLogAnalyticsEmBridgeDetails
    ...
    def hash
      [display_name, description, compartment_id, em_entities_compartment_id, bucket_name, freeform_tags, defined_tags].hash
    end
