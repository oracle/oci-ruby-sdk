...
require 'date'
require_relative 'ingest_time_rule_action'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details of metric to post to OCI Monitoring if ingest time rule condition(s) are satisfied.
  #
  class LogAnalytics::Models::IngestTimeRuleMetricExtractionAction < LogAnalytics::Models::IngestTimeRuleAction
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'METRIC_EXTRACTION'
    ...
    def hash
      [type, compartment_id, namespace, metric_name, resource_group, dimensions].hash
    end
