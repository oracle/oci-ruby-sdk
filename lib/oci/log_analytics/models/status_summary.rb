...
module OCI
  # StatusSummary
  class LogAnalytics::Models::StatusSummary
    # chunks processed
    # @return [Integer]
    ...
    # @option attributes [Integer] :chunks_processed The value to assign to the {#chunks_processed} property
    # @option attributes [String] :failure_details The value to assign to the {#failure_details} property
    # @option attributes [String] :filename The value to assign to the {#filename} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [Integer] :total_chunks The value to assign to the {#total_chunks} property
