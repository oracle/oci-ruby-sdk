...
module OCI
  ...
  class LogAnalytics::Models::CreateScheduledTaskDetails
    KIND_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::LogAnalytics::Models::CreateStandardTaskDetails' if type == 'STANDARD'
      return 'OCI::LogAnalytics::Models::CreateAccelerationTaskDetails' if type == 'ACCELERATION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::LogAnalytics::Models::CreateScheduledTaskDetails'
    end
    ...
    def hash
      [kind, compartment_id, display_name, freeform_tags, defined_tags].hash
    end
