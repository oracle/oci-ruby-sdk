...
module OCI
  ...
  class LogAnalytics::Models::UpsertLogAnalyticsLabelDetails
    PRIORITY_ENUM = [
    ...
    def priority=(priority)
      raise "Invalid value for 'priority': this must be one of the values in PRIORITY_ENUM." if priority && !PRIORITY_ENUM.include?(priority)
    ...
    def hash
      [aliases, suggest_type, description, display_name, edit_version, impact, is_system, name, priority, recommendation, type].hash
    end
