...
module OCI
  ...
  class LogAnalytics::Models::LogAnalytics
    ...
    # **[Required]** Type of the LogAnalytics.
    # @return [String]
    attr_accessor :log_analytics_type
    ...
    # @option attributes [String] :log_analytics_type The value to assign to the {#log_analytics_type} property
    ...
    def initialize(attributes = {})
      ...
      self.log_analytics_type = attributes[:'logAnalyticsType'] if attributes[:'logAnalyticsType']

      raise 'You cannot provide both :logAnalyticsType and :log_analytics_type' if attributes.key?(:'logAnalyticsType') && attributes.key?(:'log_analytics_type')

      self.log_analytics_type = attributes[:'log_analytics_type'] if attributes[:'log_analytics_type']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        log_analytics_type == other.log_analytics_type &&
    ...
    def hash
      [id, display_name, compartment_id, log_analytics_type, time_created, time_updated, lifecycle_state, lifecyle_details, freeform_tags, defined_tags].hash
    end
