...
module OCI
  ...
  #
  class LogAnalytics::Models::DeltaCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    # @option attributes [Integer] :step The value to assign to the {#step} property
    def initialize(attributes = {})
      ...
      self.step = attributes[:'step'] if attributes[:'step']
    end
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, step].hash
    end
