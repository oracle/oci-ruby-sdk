...
module OCI
  ...
  #
  class LogAnalytics::Models::DeleteCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, is_dry_run].hash
    end
