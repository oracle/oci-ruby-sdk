...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsAssociation
    ...
    def hash
      [failure_message, agent_id, time_last_attempted, retry_count, source_name, source_display_name, source_type_name, life_cycle_state, entity_id, entity_name, entity_type_name, host, agent_entity_name, entity_type_display_name, log_group_id, log_group_name, log_group_compartment, association_properties].hash
    end
