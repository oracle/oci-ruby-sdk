...
module OCI
  ...
  class LogAnalytics::Models::UploadWarningSummary
    # **[Required]** Unique internal identifier to refer to upload warning
    # @return [String]
    ...
    def hash
      [reference, status, time_started, error_message].hash
    end
