...
module OCI
  ...
  #
  class LogAnalytics::Models::FieldSummaryCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    # @option attributes [Integer] :max_values The value to assign to the {#max_values} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['name'] = 'FIELD_SUMMARY'
      ...
      self.max_values = attributes[:'maxValues'] if attributes[:'maxValues']
      self.max_values = 10 if max_values.nil? && !attributes.key?(:'maxValues') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :maxValues and :max_values' if attributes.key?(:'maxValues') && attributes.key?(:'max_values')

      self.max_values = attributes[:'max_values'] if attributes[:'max_values']
      self.max_values = 10 if max_values.nil? && !attributes.key?(:'maxValues') && !attributes.key?(:'max_values') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, max_values].hash
    end
