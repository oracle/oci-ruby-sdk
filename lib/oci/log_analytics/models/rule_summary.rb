...
module OCI
  ...
  class LogAnalytics::Models::RuleSummary
    ...
    def hash
      [id, description, compartment_id, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, kind, display_name, is_enabled, last_execution_status, time_last_executed].hash
    end
