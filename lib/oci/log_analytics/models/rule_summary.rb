...
module OCI
  ...
  #
  class LogAnalytics::Models::RuleSummary
    ...
    KIND_ENUM = [
      KIND_INGEST_TIME = 'INGEST_TIME'.freeze,
      KIND_SAVED_SEARCH = 'SAVED_SEARCH'.freeze,
    ...
    # @option attributes [String] :target_service The value to assign to the {#target_service} property
    ...
    def hash
      [id, description, compartment_id, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, kind, target_service, display_name, is_enabled, last_execution_status, time_last_executed].hash
    end
