...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsLabelView
    PRIORITY_ENUM = [
    ...
    # @option attributes [Integer] :count_usage_in_alert_rule The value to assign to the {#count_usage_in_alert_rule} property
