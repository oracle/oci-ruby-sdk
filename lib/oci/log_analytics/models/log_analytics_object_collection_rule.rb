...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsObjectCollectionRule
    ...
    LOG_SET_KEY_ENUM = [
      ...
      LOG_SET_KEY_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def log_set_key=(log_set_key)
      # rubocop:disable Style/ConditionalAssignment
      if log_set_key && !LOG_SET_KEY_ENUM.include?(log_set_key)
        OCI.logger.debug("Unknown value for 'log_set_key' [" + log_set_key + "]. Mapping to 'LOG_SET_KEY_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @log_set_key = LOG_SET_KEY_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, name, description, compartment_id, os_namespace, os_bucket_name, collection_type, poll_since, poll_till, log_group_id, log_source_name, entity_id, char_encoding, timezone, log_set, log_set_key, log_set_ext_regex, overrides, lifecycle_state, lifecycle_details, time_created, time_updated, is_enabled, object_name_filters, log_type, is_force_historic_collection, defined_tags, freeform_tags].hash
    end
