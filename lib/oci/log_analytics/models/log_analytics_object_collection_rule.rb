...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsObjectCollectionRule
    ...
    def hash
      [id, name, description, compartment_id, os_namespace, os_bucket_name, collection_type, poll_since, poll_till, log_group_id, log_source_name, entity_id, char_encoding, timezone, log_set, log_set_key, log_set_ext_regex, overrides, lifecycle_state, lifecycle_details, time_created, time_updated, is_enabled, object_name_filters, defined_tags, freeform_tags].hash
    end
