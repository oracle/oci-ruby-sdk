...
module OCI
  ...
  #
  class LogAnalytics::Models::BottomCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, limit].hash
    end
