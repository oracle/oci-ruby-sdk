...
module OCI
  ...
  class LogAnalytics::Models::EndpointRequest
    METHOD_ENUM = [
    ...
    # @return [Array<OCI::LogAnalytics::Models::NameValuePair>]
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::NameValuePair>] :headers The value to assign to the {#headers} property
    # @option attributes [Array<OCI::LogAnalytics::Models::NameValuePair>] :form_parameters The value to assign to the {#form_parameters} property
