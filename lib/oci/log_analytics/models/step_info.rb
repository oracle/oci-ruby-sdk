...
module OCI
  ...
  class LogAnalytics::Models::StepInfo
    ...
    # @option attributes [String] :input_sequence_current_match The value to assign to the {#input_sequence_current_match} property
    # @option attributes [String] :regex_engine_class_name The value to assign to the {#regex_engine_class_name} property
