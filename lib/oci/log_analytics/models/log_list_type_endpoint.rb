...
require 'date'
require_relative 'log_analytics_endpoint'
...
module OCI
  ...
  #
  class LogAnalytics::Models::LogListTypeEndpoint < LogAnalytics::Models::LogAnalyticsEndpoint
    # This attribute is required.
    # @return [OCI::LogAnalytics::Models::LogListEndpoint]
    attr_accessor :list_endpoint

    # **[Required]** Log endpoints, which reference the listEndpoint response, to fetch log data.
    #
    # @return [Array<OCI::LogAnalytics::Models::LogEndpoint>]
    attr_accessor :log_endpoints
    ...
    # @option attributes [OCI::LogAnalytics::Models::LogListEndpoint] :list_endpoint The value to assign to the {#list_endpoint} property
    # @option attributes [Array<OCI::LogAnalytics::Models::LogEndpoint>] :log_endpoints The value to assign to the {#log_endpoints} property
