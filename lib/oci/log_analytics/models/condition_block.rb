...
module OCI
  ...
  #
  class LogAnalytics::Models::ConditionBlock
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::ConditionBlock>]
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::ConditionBlock>] :condition_blocks The value to assign to the {#condition_blocks} property
