...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsParserSummary
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_position_aware
    ...
    # @option attributes [BOOLEAN] :is_position_aware The value to assign to the {#is_position_aware} property
    def initialize(attributes = {})
      ...
      self.is_position_aware = attributes[:'isPositionAware'] unless attributes[:'isPositionAware'].nil?
      self.is_position_aware = false if is_position_aware.nil? && !attributes.key?(:'isPositionAware') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isPositionAware and :is_position_aware' if attributes.key?(:'isPositionAware') && attributes.key?(:'is_position_aware')

      self.is_position_aware = attributes[:'is_position_aware'] unless attributes[:'is_position_aware'].nil?
      self.is_position_aware = false if is_position_aware.nil? && !attributes.key?(:'isPositionAware') && !attributes.key?(:'is_position_aware') # rubocop:disable Style/StringLiterals
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_position_aware == other.is_position_aware
    end
