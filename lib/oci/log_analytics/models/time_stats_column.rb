...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeStatsColumn < LogAnalytics::Models::AbstractColumn
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::TimeStatsDataColumn>]
    ...
    def self.swagger_types
      {
        ...
        'series': :'Array<OCI::LogAnalytics::Models::TimeStatsDataColumn>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::TimeStatsDataColumn>] :series The value to assign to the {#series} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'TIME_STATS_COLUMN'
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, is_hidden, value_type, original_display_name, internal_name, interval_gap, intervals, series].hash
    end
