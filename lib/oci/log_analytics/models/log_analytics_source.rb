...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSource
    ...
    # @return [Array<OCI::LogAnalytics::Models::LogAnalyticsEndpoint>]
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsEndpoint>] :endpoints The value to assign to the {#endpoints} property
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsProperty>] :source_properties The value to assign to the {#source_properties} property
