...
module OCI
  ...
  class LogAnalytics::Models::ClassifyColumn < LogAnalytics::Models::AbstractColumn
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_groupable, is_evaluable, value_type, original_display_name, internal_name, classify_field_names, classify_field_null_count, classify_anomaly_interval_counts, classify_columns, classify_result, classify_correlate_columns, classify_correlate_result].hash
    end
