...
module OCI
  ...
  #
  class LogAnalytics::Models::ChartDataColumn < LogAnalytics::Models::AbstractColumn
    ...
    #
    # @return [Array<Object>]
    attr_accessor :filtered_data_items
    ...
    # @option attributes [Array<Object>] :data_items The value to assign to the {#data_items} property
    # @option attributes [Array<Object>] :filtered_data_items The value to assign to the {#filtered_data_items} property
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_groupable, is_evaluable, value_type, original_display_name, internal_name, data_items, filtered_data_items].hash
    end
