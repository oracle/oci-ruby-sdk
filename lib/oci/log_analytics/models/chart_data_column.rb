...
module OCI
  ...
  class LogAnalytics::Models::ChartDataColumn < LogAnalytics::Models::AbstractColumn
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, is_hidden, value_type, original_display_name, internal_name, data_items, filtered_data_items].hash
    end
