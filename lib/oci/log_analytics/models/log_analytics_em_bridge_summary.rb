...
module OCI
  ...
  #
  class LogAnalytics::Models::LogAnalyticsEmBridgeSummary
    ...
    LAST_IMPORT_PROCESSING_STATUS_ENUM = [
      LAST_IMPORT_PROCESSING_STATUS_NOT_STARTED = 'NOT_STARTED'.freeze,
      LAST_IMPORT_PROCESSING_STATUS_SUCCESS = 'SUCCESS'.freeze,
      LAST_IMPORT_PROCESSING_STATUS_IN_PROGRESS = 'IN_PROGRESS'.freeze,
      LAST_IMPORT_PROCESSING_STATUS_FAILED = 'FAILED'.freeze,
      LAST_IMPORT_PROCESSING_STATUS_PARTIAL_SUCCESS = 'PARTIAL_SUCCESS'.freeze,
      LAST_IMPORT_PROCESSING_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_accessor :em_entities_compartment_id
    ...
    # @option attributes [String] :em_entities_compartment_id The value to assign to the {#em_entities_compartment_id} property
    ...
    # @option attributes [String] :last_import_processing_status The value to assign to the {#last_import_processing_status} property
    # @option attributes [String] :last_import_processing_details The value to assign to the {#last_import_processing_details} property
    # @option attributes [DateTime] :time_import_last_processed The value to assign to the {#time_import_last_processed} property
    # @option attributes [DateTime] :time_em_data_last_extracted The value to assign to the {#time_em_data_last_extracted} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] last_import_processing_status Object to be assigned
