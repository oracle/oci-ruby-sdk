...
module OCI
  ...
  class LogAnalytics::Models::StorageWorkRequestCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LogAnalytics::Models::StorageWorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::StorageWorkRequestSummary>] :items The value to assign to the {#items} property
