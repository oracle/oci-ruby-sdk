...
module OCI
  ...
  #
  class LogAnalytics::Models::EstimateReleaseDataSizeDetails
    # **[Required]** This is the start of the time range for the data to be released
    # @return [DateTime]
    attr_accessor :time_data_started

    # **[Required]** This is the end of the time range for the data to be released
    # @return [DateTime]
