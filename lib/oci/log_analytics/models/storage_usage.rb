...
module OCI
  ...
  class LogAnalytics::Models::StorageUsage
    ...
    # @option attributes [Integer] :active_data_size_in_bytes The value to assign to the {#active_data_size_in_bytes} property
    # @option attributes [Integer] :archived_data_size_in_bytes The value to assign to the {#archived_data_size_in_bytes} property
    # @option attributes [Integer] :recalled_archived_data_size_in_bytes The value to assign to the {#recalled_archived_data_size_in_bytes} property
