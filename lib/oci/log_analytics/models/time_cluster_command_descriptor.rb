...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeClusterCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, is_hidden, time, span, group_by_fields, functions].hash
    end
