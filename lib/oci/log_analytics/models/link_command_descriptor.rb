...
module OCI
  ...
  class LogAnalytics::Models::LinkCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, is_hidden, should_include_nulls, should_include_trends, span].hash
    end
