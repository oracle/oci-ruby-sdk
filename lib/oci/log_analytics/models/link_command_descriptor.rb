...
module OCI
  ...
  #
  class LogAnalytics::Models::LinkCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    # Option to return groups with a null value if specified.
    #
    # @return [BOOLEAN]
    attr_accessor :should_include_nulls
    ...
    # @option attributes [BOOLEAN] :should_include_nulls The value to assign to the {#should_include_nulls} property
    ...
    def initialize(attributes = {})
      ...
      self.should_include_nulls = attributes[:'shouldIncludeNulls'] unless attributes[:'shouldIncludeNulls'].nil?
      self.should_include_nulls = false if should_include_nulls.nil? && !attributes.key?(:'shouldIncludeNulls') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :shouldIncludeNulls and :should_include_nulls' if attributes.key?(:'shouldIncludeNulls') && attributes.key?(:'should_include_nulls')

      self.should_include_nulls = attributes[:'should_include_nulls'] unless attributes[:'should_include_nulls'].nil?
      self.should_include_nulls = false if should_include_nulls.nil? && !attributes.key?(:'shouldIncludeNulls') && !attributes.key?(:'should_include_nulls') # rubocop:disable Style/StringLiterals
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        should_include_nulls == other.should_include_nulls &&
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, should_include_nulls, should_include_trends, span].hash
    end
