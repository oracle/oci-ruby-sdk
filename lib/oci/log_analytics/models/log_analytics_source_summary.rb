...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSourceSummary
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsAssociation>] :association_entity The value to assign to the {#association_entity} property
    ...
    # @option attributes [Integer] :pattern_count The value to assign to the {#pattern_count} property
    ...
    # @option attributes [BOOLEAN] :is_auto_association_override The value to assign to the {#is_auto_association_override} property
