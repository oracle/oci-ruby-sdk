...
module OCI
  ...
  class LogAnalytics::Models::OverlappingRecallSummary
    STATUS_ENUM = [
    ...
    # @option attributes [Integer] :recall_id The value to assign to the {#recall_id} property
