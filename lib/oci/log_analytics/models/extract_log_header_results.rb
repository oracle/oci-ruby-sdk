...
module OCI
  ...
  class LogAnalytics::Models::ExtractLogHeaderResults
    ...
    def initialize(attributes = {})
      ...
      self.json_paths = attributes[:'jsonPaths'] if attributes[:'jsonPaths']

      raise 'You cannot provide both :jsonPaths and :json_paths' if attributes.key?(:'jsonPaths') && attributes.key?(:'json_paths')

      self.json_paths = attributes[:'json_paths'] if attributes[:'json_paths']

      self.xml_paths = attributes[:'xmlPaths'] if attributes[:'xmlPaths']
