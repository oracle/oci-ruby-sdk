...
module OCI
  ...
  class LogAnalytics::Models::EventTypeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LogAnalytics::Models::EventType>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::EventType>] :items The value to assign to the {#items} property
