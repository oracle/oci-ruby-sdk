...
module OCI
  ...
  class LogAnalytics::Models::IngestTimeRuleCondition
    KIND_ENUM = [
      KIND_FIELD = 'FIELD'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::LogAnalytics::Models::IngestTimeRuleFieldCondition' if type == 'FIELD'

      # TODO: Log a warning when the subtype is not found.
      'OCI::LogAnalytics::Models::IngestTimeRuleCondition'
    end
