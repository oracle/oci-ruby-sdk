...
module OCI
  ...
  class LogAnalytics::Models::TimeStatsDataColumn < LogAnalytics::Models::AbstractColumn
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, value_type, original_display_name, internal_name, columns, result, result_count, total_count, partial_results].hash
    end
