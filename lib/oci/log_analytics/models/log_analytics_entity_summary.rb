...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsEntitySummary
    ...
    # @return [OCI::LogAnalytics::Models::LogAnalyticsMetadataCollection]
    ...
    def self.swagger_types
      {
        ...
        'metadata': :'OCI::LogAnalytics::Models::LogAnalyticsMetadataCollection',
    ...
    # @option attributes [OCI::LogAnalytics::Models::LogAnalyticsMetadataCollection] :metadata The value to assign to the {#metadata} property
    ...
    def hash
      [id, name, compartment_id, entity_type_name, entity_type_internal_name, lifecycle_state, lifecycle_details, management_agent_id, cloud_resource_id, timezone_region, time_created, time_updated, time_last_discovered, metadata, are_logs_collected, source_id, creation_source, freeform_tags, defined_tags].hash
    end
