...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeStatsCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    # Optional timestamp datatype field if specified. Default field is time.
    #
    # @return [OCI::LogAnalytics::Models::AbstractField]
    attr_accessor :time
    ...
    def self.swagger_types
      {
        ...
        'time': :'OCI::LogAnalytics::Models::AbstractField',
        'span': :'String',
    ...
    # @option attributes [OCI::LogAnalytics::Models::AbstractField] :time The value to assign to the {#time} property
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, time, span, group_by_fields, functions].hash
    end
