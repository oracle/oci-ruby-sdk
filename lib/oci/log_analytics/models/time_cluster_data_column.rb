...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeClusterDataColumn < LogAnalytics::Models::AbstractColumn
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'TIME_CLUSTER_DATA_COLUMN'
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, is_hidden, value_type, original_display_name, internal_name, columns, result].hash
    end
