...
module OCI
  ...
  class LogAnalytics::Models::EstimateReleaseDataSizeResult
    # **[Required]** This is the end of the time range of data to be released.  timeDataStarted and timeDataEnded delineate
    ...
    def hash
      [time_data_ended, time_data_started, size_in_bytes].hash
    end
