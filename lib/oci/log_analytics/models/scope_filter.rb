...
module OCI
  ...
  class LogAnalytics::Models::ScopeFilter
    ...
    # **[Required]** Field values that will be used to filter the query scope. Please note all values should reflect the fields data type otherwise the query is subject to fail.
    #
    # @return [Array<Object>]
    ...
    # @option attributes [Array<Object>] :values The value to assign to the {#values} property
