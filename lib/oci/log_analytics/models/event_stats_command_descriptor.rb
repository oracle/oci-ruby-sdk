...
module OCI
  ...
  #
  class LogAnalytics::Models::EventStatsCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, group_by_fields, functions].hash
    end
