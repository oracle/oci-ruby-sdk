...
module OCI
  ...
  #
  class LogAnalytics::Models::ChartColumn < LogAnalytics::Models::AbstractColumn
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::ChartDataColumn>]
    ...
    def self.swagger_types
      {
        ...
        'series': :'Array<OCI::LogAnalytics::Models::ChartDataColumn>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::ChartDataColumn>] :series The value to assign to the {#series} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'CHART_COLUMN'
      ...
      self.series = attributes[:'series'] if attributes[:'series']
    end
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, value_type, original_display_name, internal_name, interval_gap, intervals, total_interval_counts, series].hash
    end
