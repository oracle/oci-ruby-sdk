...
module OCI
  ...
  #
  class LogAnalytics::Models::TimeColumn < LogAnalytics::Models::AbstractColumn
    ...
    # @option attributes [Array<Integer>] :times The value to assign to the {#times} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'TIME_COLUMN'
      ...
      self.times = attributes[:'times'] if attributes[:'times']
    end
    ...
    def hash
      [type, display_name, sub_system, values, is_list_of_values, is_multi_valued, is_case_sensitive, is_groupable, is_evaluable, value_type, original_display_name, internal_name, span, times].hash
    end
