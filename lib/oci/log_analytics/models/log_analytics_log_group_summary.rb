...
module OCI
  ...
  #
  class LogAnalytics::Models::LogAnalyticsLogGroupSummary
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, freeform_tags, defined_tags].hash
    end
