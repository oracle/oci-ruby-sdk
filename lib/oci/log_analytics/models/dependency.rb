...
module OCI
  ...
  #
  class LogAnalytics::Models::Dependency
    # The dependency type.
    # @return [String]
    attr_accessor :type
    ...
    # @option attributes [Integer] :reference_id The value to assign to the {#reference_id} property
    def initialize(attributes = {})
      ...
      self.reference_id = attributes[:'referenceId'] if attributes[:'referenceId']

      raise 'You cannot provide both :referenceId and :reference_id' if attributes.key?(:'referenceId') && attributes.key?(:'reference_id')

      self.reference_id = attributes[:'reference_id'] if attributes[:'reference_id']
    end
    ...
    def hash
      [type, reference_type, reference_id].hash
    end
