...
module OCI
  ...
  #
  class LogAnalytics::Models::LogTypeEndpoint < LogAnalytics::Models::LogAnalyticsEndpoint
    # This attribute is required.
    # @return [OCI::LogAnalytics::Models::LogEndpoint]
    attr_accessor :log_endpoint
    ...
    # @option attributes [OCI::LogAnalytics::Models::LogEndpoint] :log_endpoint The value to assign to the {#log_endpoint} property
