...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSourcePattern
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsProperty>] :pattern_properties The value to assign to the {#pattern_properties} property
    def initialize(attributes = {})
      ...
      self.pattern_properties = attributes[:'patternProperties'] if attributes[:'patternProperties']

      raise 'You cannot provide both :patternProperties and :pattern_properties' if attributes.key?(:'patternProperties') && attributes.key?(:'pattern_properties')

      self.pattern_properties = attributes[:'pattern_properties'] if attributes[:'pattern_properties']
    end
