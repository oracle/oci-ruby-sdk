...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSourcePattern
    ...
    # @option attributes [String] :converted_text The value to assign to the {#converted_text} property
    # @option attributes [Integer] :db_parser_id The value to assign to the {#db_parser_id} property
    # @option attributes [String] :db_pattern_date_time_columns The value to assign to the {#db_pattern_date_time_columns} property
    # @option attributes [String] :db_pattern_date_time_field The value to assign to the {#db_pattern_date_time_field} property
    # @option attributes [String] :db_pattern_sequence_column The value to assign to the {#db_pattern_sequence_column} property
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsParserField>] :fields The value to assign to the {#fields} property
    # @option attributes [BOOLEAN] :is_include The value to assign to the {#is_include} property
    # @option attributes [BOOLEAN] :is_default The value to assign to the {#is_default} property
    # @option attributes [OCI::LogAnalytics::Models::LogAnalyticsPatternFilter] :pattern_filter The value to assign to the {#pattern_filter} property
    ...
    # @option attributes [BOOLEAN] :is_agent_warning_suppressed The value to assign to the {#is_agent_warning_suppressed} property
    # @option attributes [String] :pattern_text The value to assign to the {#pattern_text} property
    # @option attributes [Integer] :pattern_type The value to assign to the {#pattern_type} property
    # @option attributes [Array<String>] :entity_type The value to assign to the {#entity_type} property
