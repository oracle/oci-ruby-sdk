...
module OCI
  ...
  class LogAnalytics::Models::NamespaceCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LogAnalytics::Models::NamespaceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::NamespaceSummary>] :items The value to assign to the {#items} property
