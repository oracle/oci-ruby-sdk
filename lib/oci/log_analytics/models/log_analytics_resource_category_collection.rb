...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsResourceCategoryCollection
    ...
    # @return [Array<OCI::LogAnalytics::Models::LogAnalyticsResourceCategory>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::LogAnalytics::Models::LogAnalyticsResourceCategory>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsResourceCategory>] :items The value to assign to the {#items} property
