...
module OCI
  ...
  class LogAnalytics::Models::EndpointResult
    # The endpoint name.
    # @return [String]
    ...
    # @option attributes [Array<String>] :log_endpoints The value to assign to the {#log_endpoints} property
    ...
    def hash
      [endpoint_name, url, status, violations, log_endpoints].hash
    end
