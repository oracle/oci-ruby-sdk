...
module OCI
  ...
  #
  class LogAnalytics::Models::WorkRequestSummary
    STATUS_ENUM = [
    ...
    # **[Required]** Unique OCID identifier to reference this query job work Request.
    #
    # @return [String]
    attr_accessor :id
    ...
    def hash
      [id, compartment_id, time_started, time_accepted, time_finished, percent_complete, status].hash
    end
