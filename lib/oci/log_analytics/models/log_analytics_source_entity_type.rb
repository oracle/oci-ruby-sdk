...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSourceEntityType
    ...
    # The type category.
    # @return [String]
    attr_accessor :entity_type_category
    ...
    # @option attributes [String] :entity_type_category The value to assign to the {#entity_type_category} property
    ...
    def initialize(attributes = {})
      ...
      self.entity_type_category = attributes[:'entityTypeCategory'] if attributes[:'entityTypeCategory']

      raise 'You cannot provide both :entityTypeCategory and :entity_type_category' if attributes.key?(:'entityTypeCategory') && attributes.key?(:'entity_type_category')

      self.entity_type_category = attributes[:'entity_type_category'] if attributes[:'entity_type_category']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        entity_type_category == other.entity_type_category &&
    ...
    def hash
      [source_id, entity_type, entity_type_category, entity_type_display_name].hash
    end
