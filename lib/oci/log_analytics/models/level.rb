...
module OCI
  ...
  class LogAnalytics::Models::Level
    # **[Required]** The level name.
    # @return [String]
    attr_accessor :name
    ...
    # @option attributes [String] :constraints The value to assign to the {#constraints} property
    def initialize(attributes = {})
      ...
      self.constraints = attributes[:'constraints'] if attributes[:'constraints']
    end
