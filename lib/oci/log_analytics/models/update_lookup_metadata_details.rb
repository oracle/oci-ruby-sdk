...
module OCI
  ...
  class LogAnalytics::Models::UpdateLookupMetadataDetails
    ...
    # The lookup fields.
    # @return [Array<OCI::LogAnalytics::Models::LogAnalyticsLookupFields>]
    ...
    def initialize(attributes = {})
      ...
      self.max_matches = attributes[:'maxMatches'] if attributes[:'maxMatches']
