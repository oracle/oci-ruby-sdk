...
module OCI
  ...
  #
  class LogAnalytics::Models::CreateTableCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    # **[Required]** Name of the table being created.
    #
    # @return [String]
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, is_hidden, table_name].hash
    end
