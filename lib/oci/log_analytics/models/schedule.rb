...
module OCI
  ...
  class LogAnalytics::Models::Schedule
    TYPE_ENUM = [
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] misfire_policy Object to be assigned
    def misfire_policy=(misfire_policy)
      # rubocop:disable Style/ConditionalAssignment
      if misfire_policy && !MISFIRE_POLICY_ENUM.include?(misfire_policy)
        OCI.logger.debug("Unknown value for 'misfire_policy' [" + misfire_policy + "]. Mapping to 'MISFIRE_POLICY_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @misfire_policy = MISFIRE_POLICY_UNKNOWN_ENUM_VALUE
      else
