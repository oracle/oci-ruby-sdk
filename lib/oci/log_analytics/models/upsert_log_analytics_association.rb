...
module OCI
  ...
  class LogAnalytics::Models::UpsertLogAnalyticsAssociation
    ...
    def hash
      [agent_id, source_name, source_type_name, entity_id, entity_name, entity_type_name, host, log_group_id].hash
    end
