...
module OCI
  ...
  class LogAnalytics::Models::UploadCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LogAnalytics::Models::UploadSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::UploadSummary>] :items The value to assign to the {#items} property
