...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsConfigWorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    def self.swagger_types
      {
        ...
        'payload': :'Array<OCI::LogAnalytics::Models::LogAnalyticsConfigWorkRequestPayload>',
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsConfigWorkRequestPayload>] :payload The value to assign to the {#payload} property
    ...
    def hash
      [id, compartment_id, operation_type, payload, percent_complete, time_started, time_accepted, time_finished, lifecycle_state].hash
    end
