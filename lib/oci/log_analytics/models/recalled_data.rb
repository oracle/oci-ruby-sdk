...
module OCI
  ...
  class LogAnalytics::Models::RecalledData
    ...
    def hash
      [time_data_ended, time_data_started, time_started, status, recall_count, storage_usage_in_bytes, not_recalled_data_in_bytes, purpose, query_string, log_sets, created_by].hash
    end
