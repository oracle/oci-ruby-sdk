...
module OCI
  ...
  class LogAnalytics::Models::WorkRequestErrorCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::LogAnalytics::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::WorkRequestError>] :items The value to assign to the {#items} property
