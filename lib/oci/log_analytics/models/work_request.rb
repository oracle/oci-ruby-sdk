...
module OCI
  ...
  class LogAnalytics::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_LOG_ANALYTICS = 'CREATE_LOG_ANALYTICS'.freeze,
      OPERATION_TYPE_DELETE_LOG_ANALYTICS = 'DELETE_LOG_ANALYTICS'.freeze,
    ...
    # @return [Array<OCI::LogAnalytics::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::LogAnalytics::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
