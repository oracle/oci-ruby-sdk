...
module OCI
  ...
  #
  class LogAnalytics::Models::FilterDetails
    SUB_SYSTEM_ENUM = [
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::Filter>]
    ...
    def self.swagger_types
      {
        ...
        'query_string': :'String',
        'sub_system': :'String',
        'filters': :'Array<OCI::LogAnalytics::Models::Filter>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::Filter>] :filters The value to assign to the {#filters} property
    ...
    def hash
      [query_string, sub_system, filters].hash
    end
