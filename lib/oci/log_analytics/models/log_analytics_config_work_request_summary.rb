...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsConfigWorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    def hash
      [id, compartment_id, operation_type, percent_complete, time_finished, time_accepted, lifecycle_state].hash
    end
