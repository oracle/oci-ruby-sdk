...
module OCI
  ...
  class LogAnalytics::Models::FileValidationResponse
    ...
    # @option attributes [String] :input_file The value to assign to the {#input_file} property
    # @option attributes [String] :object_location The value to assign to the {#object_location} property
    # @option attributes [Array<OCI::LogAnalytics::Models::UploadFileStatus>] :files The value to assign to the {#files} property
