...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsLabelAlias
    PRIORITY_ENUM = [
    ...
    # alias display name
    # @return [String]
    attr_accessor :alias_display_name
    ...
    # @option attributes [String] :alias_display_name The value to assign to the {#alias_display_name} property
