...
module OCI
  ...
  class LogAnalytics::Models::EstimateRecallDataSizeResult
    # **[Required]** This is the end of the time range of data to be recalled.  timeDataStarted and timeDataEnded delineate
    ...
    # @return [BOOLEAN]
    attr_accessor :is_overlapping_with_existing_recalls
    ...
    # @option attributes [BOOLEAN] :is_overlapping_with_existing_recalls The value to assign to the {#is_overlapping_with_existing_recalls} property
