...
module OCI
  ...
  class LogAnalytics::Models::EstimateRecallDataSizeResult
    ...
    # @option attributes [Integer] :core_group_count The value to assign to the {#core_group_count} property
    # @option attributes [Integer] :core_group_count_limit The value to assign to the {#core_group_count_limit} property
    # @option attributes [Integer] :size_limit_in_bytes The value to assign to the {#size_limit_in_bytes} property
    ...
    def hash
      [time_data_ended, time_data_started, size_in_bytes, is_overlapping_with_existing_recalls, core_group_count, core_group_count_limit, size_limit_in_bytes].hash
    end
