...
module OCI
  # LogAnalytics label
  class LogAnalytics::Models::LogAnalyticsLabelSummary
    PRIORITY_ENUM = [
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::LogAnalyticsLabelAlias>] :aliases The value to assign to the {#aliases} property
    # @option attributes [Integer] :count_usage_in_source The value to assign to the {#count_usage_in_source} property
    # @option attributes [Integer] :suggest_type The value to assign to the {#suggest_type} property
    ...
    def initialize(attributes = {})
      ...
      self.type = "INFO" if type.nil? && !attributes.key?(:'type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [aliases, count_usage_in_source, suggest_type, description, display_name, edit_version, impact, is_system, name, priority, recommendation, type, is_user_deleted].hash
    end
