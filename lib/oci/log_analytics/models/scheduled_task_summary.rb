...
module OCI
  ...
  class LogAnalytics::Models::ScheduledTaskSummary
    ...
    def hash
      [id, task_type, target_service, compartment_id, time_created, time_updated, lifecycle_state, task_status, pause_reason, work_request_id, display_name, freeform_tags, defined_tags, last_execution_status, time_last_executed].hash
    end
