...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsEndpoint
    ENDPOINT_TYPE_ENUM = [
      ENDPOINT_TYPE_LOG_LIST = 'LOG_LIST'.freeze,
      ENDPOINT_TYPE_LOG = 'LOG'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::LogAnalytics::Models::LogListTypeEndpoint' if type == 'LOG_LIST'
      return 'OCI::LogAnalytics::Models::LogTypeEndpoint' if type == 'LOG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::LogAnalytics::Models::LogAnalyticsEndpoint'
    end
