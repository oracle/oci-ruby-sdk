...
module OCI
  ...
  class ApmTraces::Models::QueryResultMetadataSummary
    ...
    #
    # @return [Array<OCI::ApmTraces::Models::QueryResultsGroupedBySummary>]
    attr_accessor :query_results_grouped_by
    ...
    #
    # @return [Array<OCI::ApmTraces::Models::QueryResultsOrderedBySummary>]
    attr_accessor :query_results_ordered_by

    # Interval for the time series function in minutes.
    #
    # @return [Integer]
    attr_accessor :time_series_interval_in_mins
    ...
    # @option attributes [Array<OCI::ApmTraces::Models::QueryResultsGroupedBySummary>] :query_results_grouped_by The value to assign to the {#query_results_grouped_by} property
    # @option attributes [Array<OCI::ApmTraces::Models::QueryResultsOrderedBySummary>] :query_results_ordered_by The value to assign to the {#query_results_ordered_by} property
    # @option attributes [Integer] :time_series_interval_in_mins The value to assign to the {#time_series_interval_in_mins} property
    def initialize(attributes = {})
      ...
      self.query_results_grouped_by = attributes[:'queryResultsGroupedBy'] if attributes[:'queryResultsGroupedBy']

      raise 'You cannot provide both :queryResultsGroupedBy and :query_results_grouped_by' if attributes.key?(:'queryResultsGroupedBy') && attributes.key?(:'query_results_grouped_by')

      self.query_results_grouped_by = attributes[:'query_results_grouped_by'] if attributes[:'query_results_grouped_by']

      self.query_results_ordered_by = attributes[:'queryResultsOrderedBy'] if attributes[:'queryResultsOrderedBy']

      raise 'You cannot provide both :queryResultsOrderedBy and :query_results_ordered_by' if attributes.key?(:'queryResultsOrderedBy') && attributes.key?(:'query_results_ordered_by')

      self.query_results_ordered_by = attributes[:'query_results_ordered_by'] if attributes[:'query_results_ordered_by']

      self.time_series_interval_in_mins = attributes[:'timeSeriesIntervalInMins'] if attributes[:'timeSeriesIntervalInMins']

      raise 'You cannot provide both :timeSeriesIntervalInMins and :time_series_interval_in_mins' if attributes.key?(:'timeSeriesIntervalInMins') && attributes.key?(:'time_series_interval_in_mins')

      self.time_series_interval_in_mins = attributes[:'time_series_interval_in_mins'] if attributes[:'time_series_interval_in_mins']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        query_results_grouped_by == other.query_results_grouped_by &&
        query_results_ordered_by == other.query_results_ordered_by &&
        time_series_interval_in_mins == other.time_series_interval_in_mins
    end
    ...
    def hash
      [query_result_row_type_summaries, source_name, query_results_grouped_by, query_results_ordered_by, time_series_interval_in_mins].hash
    end
