...
module OCI
  ...
  #
  class ApmTraces::Models::BulkUnpinMetadata
    ...
    # **[Required]** Operation status of the bulk unpin operation.
    ...
    # **[Required]** Total number attributes (both string and numeric) in TRACES namespace that were unpinned.
    #
    # @return [Integer]
    attr_accessor :attributes_unpinned

    # Total number attributes (both string and numeric) in SYNTHETIC namespace that were unpinned.
    #
    # @return [Integer]
    attr_accessor :synthetic_attributes_unpinned
    ...
    def self.swagger_types
      {
        ...
        'attributes_unpinned': :'Integer',
        'synthetic_attributes_unpinned': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :attributes_unpinned The value to assign to the {#attributes_unpinned} property
    # @option attributes [Integer] :synthetic_attributes_unpinned The value to assign to the {#synthetic_attributes_unpinned} property
    def initialize(attributes = {})
      ...
      self.attributes_unpinned = attributes[:'attributesUnpinned'] if attributes[:'attributesUnpinned']

      raise 'You cannot provide both :attributesUnpinned and :attributes_unpinned' if attributes.key?(:'attributesUnpinned') && attributes.key?(:'attributes_unpinned')

      self.attributes_unpinned = attributes[:'attributes_unpinned'] if attributes[:'attributes_unpinned']

      self.synthetic_attributes_unpinned = attributes[:'syntheticAttributesUnpinned'] if attributes[:'syntheticAttributesUnpinned']

      raise 'You cannot provide both :syntheticAttributesUnpinned and :synthetic_attributes_unpinned' if attributes.key?(:'syntheticAttributesUnpinned') && attributes.key?(:'synthetic_attributes_unpinned')

      self.synthetic_attributes_unpinned = attributes[:'synthetic_attributes_unpinned'] if attributes[:'synthetic_attributes_unpinned']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        attributes_unpinned == other.attributes_unpinned &&
        synthetic_attributes_unpinned == other.synthetic_attributes_unpinned
    end
    ...
    def hash
      [operation_status, operation_type, attributes_unpinned, synthetic_attributes_unpinned].hash
    end
