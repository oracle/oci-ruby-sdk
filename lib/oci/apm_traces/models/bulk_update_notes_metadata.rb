...
module OCI
  ...
  #
  class ApmTraces::Models::BulkUpdateNotesMetadata
    ...
    # **[Required]** Operation status of the bulk update notes operation.
    ...
    # **[Required]** Total number attributes (both string and numeric) in TRACES namespace for which notes were updated.
    #
    # @return [Integer]
    attr_accessor :attributes_notes_updated

    # Total number attributes (both string and numeric) in SYNTHETIC namespace that were pinned.
    #
    # @return [Integer]
    attr_accessor :synthetic_attributes_pinned
    ...
    def self.swagger_types
      {
        ...
        'attributes_notes_updated': :'Integer',
    ...
    # @option attributes [Integer] :attributes_notes_updated The value to assign to the {#attributes_notes_updated} property
    # @option attributes [Integer] :synthetic_attributes_pinned The value to assign to the {#synthetic_attributes_pinned} property
    def initialize(attributes = {})
      ...
      self.attributes_notes_updated = attributes[:'attributesNotesUpdated'] if attributes[:'attributesNotesUpdated']

      raise 'You cannot provide both :attributesNotesUpdated and :attributes_notes_updated' if attributes.key?(:'attributesNotesUpdated') && attributes.key?(:'attributes_notes_updated')

      self.attributes_notes_updated = attributes[:'attributes_notes_updated'] if attributes[:'attributes_notes_updated']

      self.synthetic_attributes_pinned = attributes[:'syntheticAttributesPinned'] if attributes[:'syntheticAttributesPinned']

      raise 'You cannot provide both :syntheticAttributesPinned and :synthetic_attributes_pinned' if attributes.key?(:'syntheticAttributesPinned') && attributes.key?(:'synthetic_attributes_pinned')

      self.synthetic_attributes_pinned = attributes[:'synthetic_attributes_pinned'] if attributes[:'synthetic_attributes_pinned']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        attributes_notes_updated == other.attributes_notes_updated &&
        synthetic_attributes_pinned == other.synthetic_attributes_pinned
    end
    ...
    def hash
      [operation_status, operation_type, attributes_notes_updated, synthetic_attributes_pinned].hash
    end
