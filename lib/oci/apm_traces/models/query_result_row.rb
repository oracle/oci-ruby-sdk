...
module OCI
  ...
  #
  class ApmTraces::Models::QueryResultRow
    ...
    attr_accessor :query_result_row_data

    # **[Required]** A map containing metadata or add-on data for the data presented in the queryResultRowData map.  Data required to present drill down
    # information from the queryResultRowData is presented as key-value pairs.
    #
    # @return [Hash<String, Object>]
    attr_accessor :query_result_row_metadata
    ...
    # @option attributes [Hash<String, Object>] :query_result_row_data The value to assign to the {#query_result_row_data} property
    # @option attributes [Hash<String, Object>] :query_result_row_metadata The value to assign to the {#query_result_row_metadata} property
    def initialize(attributes = {})
      ...
      self.query_result_row_data = attributes[:'queryResultRowData'] if attributes[:'queryResultRowData']

      raise 'You cannot provide both :queryResultRowData and :query_result_row_data' if attributes.key?(:'queryResultRowData') && attributes.key?(:'query_result_row_data')

      self.query_result_row_data = attributes[:'query_result_row_data'] if attributes[:'query_result_row_data']

      self.query_result_row_metadata = attributes[:'queryResultRowMetadata'] if attributes[:'queryResultRowMetadata']

      raise 'You cannot provide both :queryResultRowMetadata and :query_result_row_metadata' if attributes.key?(:'queryResultRowMetadata') && attributes.key?(:'query_result_row_metadata')

      self.query_result_row_metadata = attributes[:'query_result_row_metadata'] if attributes[:'query_result_row_metadata']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        query_result_row_data == other.query_result_row_data &&
        query_result_row_metadata == other.query_result_row_metadata
    end
    ...
    def hash
      [query_result_row_data, query_result_row_metadata].hash
    end
