...
module OCI
  ...
  #
  class ApmTraces::Models::AttributeUpdateNotesResponse
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** Namespace of the attribute whose notes were updated.  The attributeNameSpace will default to TRACES if it is
    # not passed in.
    #
    # @return [String]
    attr_reader :attribute_name_space

    # **[Required]** Status of the attribute after this operation.  The attribute can have one of the following statuses after the update notes operation.  The attribute
