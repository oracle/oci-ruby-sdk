...
module OCI
  # Stack trace element.
  #
  class ApmTraces::Models::StackTraceElement
    ...
    # @option attributes [String] :method_name The value to assign to the {#method_name} property
    ...
    # @option attributes [Float] :weightage The value to assign to the {#weightage} property
