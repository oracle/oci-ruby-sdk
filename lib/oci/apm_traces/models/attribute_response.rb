...
module OCI
  ...
  #
  class ApmTraces::Models::AttributeResponse
    ATTRIBUTE_TYPE_ENUM = [
    ...
    ATTRIBUTE_STATUS_ENUM = [
      ATTRIBUTE_STATUS_ATTRIBUTE_ALREADY_ACTIVE = 'ATTRIBUTE_ALREADY_ACTIVE'.freeze,
      ATTRIBUTE_STATUS_ATTRIBUTE_ACTIVATED = 'ATTRIBUTE_ACTIVATED'.freeze,
      ATTRIBUTE_STATUS_ATTRIBUTE_DEACTIVATED = 'ATTRIBUTE_DEACTIVATED'.freeze,
      ATTRIBUTE_STATUS_DEACTIVATION_NOT_ALLOWED = 'DEACTIVATION_NOT_ALLOWED'.freeze,
      ATTRIBUTE_STATUS_ATTRIBUTE_DOES_NOT_EXIST = 'ATTRIBUTE_DOES_NOT_EXIST'.freeze,
      ATTRIBUTE_STATUS_ATTRIBUTE_ALREADY_DEACTIVATED = 'ATTRIBUTE_ALREADY_DEACTIVATED'.freeze,
      ...
      ATTRIBUTE_STATUS_INVALID_ATTRIBUTE_TYPE_CONFLICT = 'INVALID_ATTRIBUTE_TYPE_CONFLICT'.freeze,
    ...
    # **[Required]** Status of the attribute after this operation.  The attribute can have one of the following statuses after the activate or deactivate operation.  The attribute
    ...
    def hash
      [attribute_name, attribute_type, unit, notes, operation_type, attribute_name_space, attribute_status, time_updated].hash
    end
