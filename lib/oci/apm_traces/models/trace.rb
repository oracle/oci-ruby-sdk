...
module OCI
  ...
  class ApmTraces::Models::Trace
    ...
    # @return [OCI::ApmTraces::Models::TraceSpanSummary]
    attr_accessor :span_summary

    # **[Required]** An array of spans in the trace.
    #
    # @return [Array<OCI::ApmTraces::Models::Span>]
    attr_accessor :spans
    ...
    # @option attributes [OCI::ApmTraces::Models::TraceSpanSummary] :span_summary The value to assign to the {#span_summary} property
    # @option attributes [Array<OCI::ApmTraces::Models::Span>] :spans The value to assign to the {#spans} property
