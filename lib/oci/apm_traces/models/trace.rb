...
module OCI
  ...
  class ApmTraces::Models::Trace
    SOURCE_NAME_ENUM = [
      SOURCE_NAME_TRACES = 'TRACES'.freeze,
      SOURCE_NAME_SYN_TRACES = 'SYN_TRACES'.freeze,
