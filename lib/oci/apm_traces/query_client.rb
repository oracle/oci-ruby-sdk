...
module OCI
  ...
  class ApmTraces::QueryClient
    ...
    #    (default to 1)
    # @return [Response] A Response object with data of type Array<{OCI::ApmTraces::Models::QuickPickSummary QuickPickSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apmtraces/list_quick_picks.rb.html) to see an example of how to use list_quick_picks API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/apmtraces/query.rb.html) to see an example of how to use query API.
