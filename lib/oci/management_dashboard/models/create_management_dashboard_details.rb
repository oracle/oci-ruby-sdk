...
module OCI
  ...
  class ManagementDashboard::Models::CreateManagementDashboardDetails
    ...
    # **[Required]** String boolean (\"true\" or \"false\").  Whether to show the dashboard description.
    # @return [BOOLEAN]
    ...
    # **[Required]** NORMAL means single dashboard, or SET means dashboard set.
    # @return [String]
    attr_accessor :type
    ...
    def hash
      [dashboard_id, provider_id, provider_name, provider_version, tiles, display_name, description, compartment_id, is_oob_dashboard, is_show_in_home, metadata_version, is_show_description, screen_image, nls, ui_config, data_config, type, is_favorite, freeform_tags, defined_tags].hash
    end
