...
module OCI
  ...
  class ManagementDashboard::Models::ManagementSavedSearchForImportDetails
    TYPE_ENUM = [
    ...
    def hash
      [id, display_name, provider_id, provider_version, provider_name, compartment_id, is_oob_saved_search, description, nls, type, ui_config, data_config, screen_image, metadata_version, widget_template, widget_vm, freeform_tags, defined_tags, parameters_config, drilldown_config].hash
    end
