...
module OCI
  ...
  class ManagementDashboard::Models::UpdateManagementSavedSearchDetails
    ...
    def hash
      [display_name, provider_id, provider_version, provider_name, compartment_id, is_oob_saved_search, description, nls, type, ui_config, data_config, screen_image, metadata_version, widget_template, widget_vm, parameters_config, freeform_tags, defined_tags].hash
    end
