...
module OCI
  ...
  class ManagementDashboard::Models::UpdateManagementDashboardDetails
    ...
    def hash
      [provider_id, provider_name, provider_version, tiles, display_name, description, compartment_id, is_oob_dashboard, is_show_in_home, metadata_version, is_show_description, screen_image, nls, ui_config, data_config, type, is_favorite, parameters_config, drilldown_config, freeform_tags, defined_tags].hash
    end
