...
module OCI
  ...
  class ManagementDashboard::Models::ManagementDashboardSummary
    ...
    def hash
      [dashboard_id, id, display_name, description, compartment_id, provider_id, provider_name, provider_version, is_oob_dashboard, created_by, time_created, updated_by, time_updated, metadata_version, screen_image, nls, type, features_config, lifecycle_state, freeform_tags, defined_tags].hash
    end
