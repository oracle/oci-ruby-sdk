...
module OCI
  ...
  class Marketplace::Models::Screenshot
    ...
    # @option attributes [String] :file_extension The value to assign to the {#file_extension} property
    ...
    def hash
      [name, description, content_url, mime_type, file_extension].hash
    end
