...
module OCI
  ...
  class Marketplace::Models::SearchListingsDetails
    TYPE_ENUM = [
      TYPE_FREE_TEXT = 'FreeText'.freeze,
      TYPE_STRUCTURED = 'Structured'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Marketplace::Models::StructuredSearchDetails' if type == 'Structured'
      return 'OCI::Marketplace::Models::FreeTextSearchDetails' if type == 'FreeText'
