...
module OCI
  ...
  class Marketplace::Models::ImageListingPackage < Marketplace::Models::ListingPackage
    ...
    def hash
      [description, listing_id, version, package_type, pricing, resource_id, time_created, operating_system, regions, app_catalog_listing_id, app_catalog_listing_resource_version, image_id].hash
    end
