...
module OCI
  ...
  class Marketplace::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Marketplace::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Marketplace::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Marketplace::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, percent_complete, time_accepted, time_started, time_finished, listing_id, package_version].hash
    end
