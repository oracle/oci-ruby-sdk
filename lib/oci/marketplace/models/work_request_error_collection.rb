...
module OCI
  ...
  #
  class Marketplace::Models::WorkRequestErrorCollection
    # **[Required]** A collection of work request errors.
    # @return [Array<OCI::Marketplace::Models::WorkRequestError>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Marketplace::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Marketplace::Models::WorkRequestError>] :items The value to assign to the {#items} property
