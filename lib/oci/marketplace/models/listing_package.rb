...
module OCI
  ...
  class Marketplace::Models::ListingPackage
    PACKAGE_TYPE_ENUM = [
    ...
    # **[Required]** The version of this package.
    # @return [String]
    ...
    def hash
      [description, listing_id, version, package_type, pricing, resource_id, time_created].hash
    end
