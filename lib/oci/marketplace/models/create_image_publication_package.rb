...
require 'date'
require_relative 'create_publication_package'
...
module OCI
  ...
  class Marketplace::Models::CreateImagePublicationPackage < Marketplace::Models::CreatePublicationPackage
    ...
    # @option attributes [String] :package_version The value to assign to the {OCI::Marketplace::Models::CreatePublicationPackage#package_version #package_version} proprety
    # @option attributes [OCI::Marketplace::Models::OperatingSystem] :operating_system The value to assign to the {OCI::Marketplace::Models::CreatePublicationPackage#operating_system #operating_system} proprety
    # @option attributes [Array<OCI::Marketplace::Models::Eula>] :eula The value to assign to the {OCI::Marketplace::Models::CreatePublicationPackage#eula #eula} proprety
    ...
    def hash
      [package_version, package_type, operating_system, eula, image_id].hash
    end
