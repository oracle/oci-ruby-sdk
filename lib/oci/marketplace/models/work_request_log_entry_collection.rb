...
module OCI
  ...
  #
  class Marketplace::Models::WorkRequestLogEntryCollection
    # **[Required]** A collection of work request log entries.
    # @return [Array<OCI::Marketplace::Models::WorkRequestLogEntry>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Marketplace::Models::WorkRequestLogEntry>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Marketplace::Models::WorkRequestLogEntry>] :items The value to assign to the {#items} property
