...
require 'date'
require_relative 'search_listings_details'
...
module OCI
  ...
  class Marketplace::Models::FreeTextSearchDetails < Marketplace::Models::SearchListingsDetails
    ...
    # @option attributes [String] :matching_context_type The value to assign to the {OCI::Marketplace::Models::SearchListingsDetails#matching_context_type #matching_context_type} proprety
