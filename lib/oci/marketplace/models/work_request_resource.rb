...
module OCI
  ...
  class Marketplace::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_ACCEPTED = 'ACCEPTED'.freeze,
      ACTION_TYPE_IN_PROGRESS = 'IN_PROGRESS'.freeze,
      ACTION_TYPE_WAITING = 'WAITING'.freeze,
      ACTION_TYPE_NEEDS_ATTENTION = 'NEEDS_ATTENTION'.freeze,
      ACTION_TYPE_FAILED = 'FAILED'.freeze,
      ACTION_TYPE_SUCCEEDED = 'SUCCEEDED'.freeze,
      ACTION_TYPE_CANCELED = 'CANCELED'.freeze,
