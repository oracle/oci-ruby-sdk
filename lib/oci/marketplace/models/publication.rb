...
module OCI
  ...
  class Marketplace::Models::Publication
    ...
    def hash
      [lifecycle_state, compartment_id, id, name, short_description, long_description, support_contacts, icon, package_type, listing_type, supported_operating_systems, time_created, defined_tags, freeform_tags, system_tags].hash
    end
