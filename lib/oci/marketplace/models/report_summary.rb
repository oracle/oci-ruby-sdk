...
module OCI
  ...
  class Marketplace::Models::ReportSummary
    ...
    # @option attributes [String] :report_type The value to assign to the {#report_type} property
    # @option attributes [DateTime] :date The value to assign to the {#date} property
    # @option attributes [Array<String>] :columns The value to assign to the {#columns} property
