...
module OCI
  ...
  class Marketplace::Models::Agreement
    AUTHOR_ENUM = [
    ...
    # **[Required]** A time-based signature that can be used to accept an agreement or remove a
    ...
    # @option attributes [String] :author The value to assign to the {#author} property
    ...
    def author=(author)
      ...
      if author && !AUTHOR_ENUM.include?(author)
        OCI.logger.debug("Unknown value for 'author' [" + author + "]. Mapping to 'AUTHOR_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @author = AUTHOR_UNKNOWN_ENUM_VALUE
      else
        @author = author
      end
