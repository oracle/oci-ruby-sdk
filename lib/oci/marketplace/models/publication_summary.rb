...
module OCI
  ...
  class Marketplace::Models::PublicationSummary
    ...
    def hash
      [lifecycle_state, compartment_id, id, name, short_description, icon, package_type, supported_operating_systems, listing_type, time_created, defined_tags, freeform_tags, system_tags].hash
    end
