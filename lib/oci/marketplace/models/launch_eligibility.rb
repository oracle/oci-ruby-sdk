...
module OCI
  ...
  class Marketplace::Models::LaunchEligibility
    INELIGIBILITY_REASON_ENUM = [
      ...
      INELIGIBILITY_REASON_INELIGIBLE_ACCOUNT_NOT_AVAILABLE = 'INELIGIBLE_ACCOUNT_NOT_AVAILABLE'.freeze,
      INELIGIBILITY_REASON_INELIGIBLE_ACCOUNT_NOT_MONTHLY_INCLUSIVE = 'INELIGIBLE_ACCOUNT_NOT_MONTHLY_INCLUSIVE'.freeze,
      INELIGIBILITY_REASON_IMAGE_META_DATA_SO = 'IMAGE_META_DATA_SO'.freeze,
      INELIGIBILITY_REASON_INELIGIBLE_ACCOUNT_TENANCY_NOT_ALLOWED_ACCESS_IMAGE = 'INELIGIBLE_ACCOUNT_TENANCY_NOT_ALLOWED_ACCESS_IMAGE'.freeze,
      INELIGIBILITY_REASON_INELIGIBLE_ACCOUNT_GOV_LAUNCH_NON_GOV_LISTING = 'INELIGIBLE_ACCOUNT_GOV_LAUNCH_NON_GOV_LISTING'.freeze,
      INELIGIBILITY_REASON_AGREEMENT_NOT_ACCEPTED = 'AGREEMENT_NOT_ACCEPTED'.freeze,
      INELIGIBILITY_REASON_NOT_AUTHORIZED = 'NOT_AUTHORIZED'.freeze,
      INELIGIBILITY_REASON_ELIGIBLE = 'ELIGIBLE'.freeze,
