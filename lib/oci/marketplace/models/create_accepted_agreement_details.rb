...
module OCI
  ...
  class Marketplace::Models::CreateAcceptedAgreementDetails
    ...
    # **[Required]** A signature generated for the listing package agreements that you can retrieve
    ...
    def hash
      [display_name, compartment_id, listing_id, package_version, agreement_id, signature, defined_tags, freeform_tags].hash
    end
