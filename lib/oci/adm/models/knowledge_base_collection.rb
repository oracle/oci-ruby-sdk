...
module OCI
  ...
  class Adm::Models::KnowledgeBaseCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Adm::Models::KnowledgeBaseSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Adm::Models::KnowledgeBaseSummary>] :items The value to assign to the {#items} property
