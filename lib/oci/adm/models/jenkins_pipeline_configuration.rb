...
module OCI
  ...
  class Adm::Models::JenkinsPipelineConfiguration < Adm::Models::VerifyConfiguration
    ...
    # @option attributes [String] :jenkins_url The value to assign to the {#jenkins_url} property
    ...
    def initialize(attributes = {})
      ...
      attributes['buildServiceType'] = 'JENKINS_PIPELINE'
      ...
      self.jenkins_url = attributes[:'jenkinsUrl'] if attributes[:'jenkinsUrl']

      raise 'You cannot provide both :jenkinsUrl and :jenkins_url' if attributes.key?(:'jenkinsUrl') && attributes.key?(:'jenkins_url')

      self.jenkins_url = attributes[:'jenkins_url'] if attributes[:'jenkins_url']
    ...
    def hash
      [build_service_type, username, pat_secret_id, jenkins_url, job_name, additional_parameters].hash
    end
