...
module OCI
  ...
  class Adm::Models::RemediationRecipeSummary
    ...
    def hash
      [id, display_name, time_created, time_updated, compartment_id, lifecycle_state, knowledge_base_id, is_run_triggered_on_kb_change, freeform_tags, defined_tags, system_tags].hash
    end
