...
module OCI
  ...
  class Adm::Models::WorkRequestSummary
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, percent_complete, time_accepted, time_started, time_finished, freeform_tags, defined_tags, system_tags].hash
    end
