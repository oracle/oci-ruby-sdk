...
module OCI
  ...
  class Adm::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Adm::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Adm::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Adm::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [operation_type, status, id, compartment_id, resources, percent_complete, time_accepted, time_started, time_finished, freeform_tags, defined_tags].hash
    end
