...
module OCI
  ...
  class Adm::Models::ApplicationDependency
    # **[Required]** Unique Group Artifact Version (GAV) identifier (Group:Artifact:Version), e.g. org.graalvm.nativeimage:svm:21.1.0.
    # @return [String]
    attr_accessor :gav

    # **[Required]** Unique identifier of an Application Dependency node, e.g. nodeId1.
    # @return [String]
    attr_accessor :node_id

    # **[Required]** List of (Application Dependencies) node identifiers on which this node depends.
    # @return [Array<String>]
    attr_accessor :application_dependency_node_ids
    ...
    # @option attributes [String] :gav The value to assign to the {#gav} property
    # @option attributes [String] :node_id The value to assign to the {#node_id} property
    # @option attributes [Array<String>] :application_dependency_node_ids The value to assign to the {#application_dependency_node_ids} property
    ...
    def hash
      [gav, node_id, application_dependency_node_ids].hash
    end
