...
module OCI
  ...
  class Adm::Models::GitLabPipelineConfiguration < Adm::Models::VerifyConfiguration
    ...
    # **[Required]** The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the trigger Secret.
    # The Secret provides access to the trigger for a GitLab pipeline.
    #
    # @return [String]
    attr_accessor :trigger_secret_id
    ...
    # @option attributes [String] :trigger_secret_id The value to assign to the {#trigger_secret_id} property
    ...
    def initialize(attributes = {})
      ...
      attributes['buildServiceType'] = 'GITLAB_PIPELINE'
      ...
      self.trigger_secret_id = attributes[:'triggerSecretId'] if attributes[:'triggerSecretId']

      raise 'You cannot provide both :triggerSecretId and :trigger_secret_id' if attributes.key?(:'triggerSecretId') && attributes.key?(:'trigger_secret_id')

      self.trigger_secret_id = attributes[:'trigger_secret_id'] if attributes[:'trigger_secret_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        trigger_secret_id == other.trigger_secret_id &&
    ...
    def hash
      [build_service_type, repository_url, username, pat_secret_id, trigger_secret_id, additional_parameters].hash
    end
