...
module OCI
  ...
  class Adm::Models::OciCodeRepositoryConfiguration < Adm::Models::ScmConfiguration
    # **[Required]** The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the OCI DevOps repository.
    # @return [String]
    attr_accessor :oci_code_repository_id
    ...
    # @option attributes [String] :oci_code_repository_id The value to assign to the {#oci_code_repository_id} property
