...
module OCI
  ...
  #
  class Adm::Models::NetworkConfiguration
    # **[Required]** The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the subnet.
    # @return [String]
