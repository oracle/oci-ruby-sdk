...
module OCI
  ...
  # and use {#usage_data_via_object_storage_tuple_details usage_data_via_object_storage_tuple_details}
  # when specifying the namespace, bucket name, and object name.
  #
  # This class has direct subclasses. If you are using this class as input to a service operations then you should favor using a subclass over the base class
  class Adm::Models::UsageDataDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Adm::Models::UsageDataViaObjectStorageTupleDetails' if type == 'objectStorageTuple'
