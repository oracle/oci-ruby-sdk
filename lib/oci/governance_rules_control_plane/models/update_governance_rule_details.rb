...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::UpdateGovernanceRuleDetails
    ...
    def hash
      [display_name, description, template, related_resource_id, freeform_tags, defined_tags].hash
    end
