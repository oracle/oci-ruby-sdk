...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::QuotaTemplate < GovernanceRulesControlPlane::Models::Template
    ...
    def hash
      [type, display_name, description, statements].hash
    end
