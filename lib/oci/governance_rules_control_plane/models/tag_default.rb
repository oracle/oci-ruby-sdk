...
module OCI
  ...
  #
  class GovernanceRulesControlPlane::Models::TagDefault
    ...
    # **[Required]** If you specify that a value is required, a value is set during resource creation (either by
    ...
    def hash
      [tag_name, value, is_required].hash
    end
