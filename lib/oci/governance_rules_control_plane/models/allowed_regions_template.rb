...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::AllowedRegionsTemplate < GovernanceRulesControlPlane::Models::Template
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'ALLOWED_REGIONS'
    ...
    def hash
      [type, display_name, description, regions].hash
    end
