...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::EnforcedGovernanceRuleSummary
    TYPE_ENUM = [
    ...
    def hash
      [id, compartment_id, governance_rule_display_name, type, lifecycle_state, time_created, time_updated].hash
    end
