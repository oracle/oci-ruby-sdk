...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::BaseTagDefinitionValidator
    VALIDATOR_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GovernanceRulesControlPlane::Models::DefaultTagDefinitionValidator' if type == 'DEFAULT'
      return 'OCI::GovernanceRulesControlPlane::Models::EnumTagDefinitionValidator' if type == 'ENUM'
