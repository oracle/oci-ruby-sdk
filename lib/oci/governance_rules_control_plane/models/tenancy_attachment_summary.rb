...
module OCI
  ...
  class GovernanceRulesControlPlane::Models::TenancyAttachmentSummary
    # **[Required]** The Oracle ID ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the tenancy attachment.
    # @return [String]
    attr_accessor :id

    # **[Required]** The Oracle ID ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the root compartment containing the tenancy attachment.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The Oracle ID ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the governance rule. Every tenancy attachment is associated with a governance rule.
    # @return [String]
    attr_accessor :governance_rule_id

    # **[Required]** The Oracle ID ([OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)) of the tenancy to which the governance rule is attached.
    # @return [String]
