...
module OCI
  ...
  #
  class GovernanceRulesControlPlane::Models::EnumTagDefinitionValidator < GovernanceRulesControlPlane::Models::BaseTagDefinitionValidator
