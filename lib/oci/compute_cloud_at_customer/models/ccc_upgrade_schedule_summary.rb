...
module OCI
  ...
  #
  class ComputeCloudAtCustomer::Models::CccUpgradeScheduleSummary
    # **[Required]** The upgrade schedule [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    # **[Required]** The current state of the Compute Cloud@Customer
    # upgrade schedule.
    #
    # @return [String]
    ...
    def hash
      [id, display_name, compartment_id, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
