...
module OCI
  ...
  class ComputeCloudAtCustomer::Models::CccInfrastructureSummary
    # **[Required]** The Compute Cloud@Customer infrastructure
    ...
    # **[Required]** The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with
    # the infrastructure.
    #
    # @return [String]
    ...
    # **[Required]** Compute Cloud@Customer infrastructure creation date and time. An RFC3339 formatted
    # datetime string.
    #
    # @return [DateTime]
    ...
    def hash
      [id, short_name, display_name, compartment_id, subnet_id, time_created, connection_state, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
