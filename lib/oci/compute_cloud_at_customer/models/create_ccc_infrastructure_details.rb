...
module OCI
  ...
  class ComputeCloudAtCustomer::Models::CreateCccInfrastructureDetails
    ...
    def hash
      [display_name, description, compartment_id, subnet_id, connection_state, connection_details, ccc_upgrade_schedule_id, freeform_tags, defined_tags].hash
    end
