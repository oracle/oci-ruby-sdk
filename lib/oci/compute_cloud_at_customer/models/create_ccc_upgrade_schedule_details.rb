...
module OCI
  ...
  #
  class ComputeCloudAtCustomer::Models::CreateCccUpgradeScheduleDetails
    ...
    #
    # @return [Array<OCI::ComputeCloudAtCustomer::Models::CreateCccScheduleEvent>]
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'events': :'Array<OCI::ComputeCloudAtCustomer::Models::CreateCccScheduleEvent>',
    ...
    # @option attributes [Array<OCI::ComputeCloudAtCustomer::Models::CreateCccScheduleEvent>] :events The value to assign to the {#events} property
    ...
    def hash
      [display_name, compartment_id, description, events, freeform_tags, defined_tags].hash
    end
