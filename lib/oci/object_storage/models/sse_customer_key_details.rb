...
module OCI
  ...
  #
  class ObjectStorage::Models::SSECustomerKeyDetails
    ALGORITHM_ENUM = [
    ...
    # **[Required]** Specifies the base64-encoded SHA256 hash of the encryption key. This value is used to check the integrity
    ...
    # @option attributes [String] :key_sha256 The value to assign to the {#key_sha256} property
