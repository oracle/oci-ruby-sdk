...
module OCI
  ...
  #
  class ObjectStorage::Models::ObjectVersionCollection
    # **[Required]** An array of object version summaries.
    #
    # @return [Array<OCI::ObjectStorage::Models::ObjectVersionSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::ObjectStorage::Models::ObjectVersionSummary>] :items The value to assign to the {#items} property
