...
module OCI
  ...
  class ManagementAgent::ManagementAgentClient
    ...
    # @option opts [String] :type The OperationType of the workRequest
    ...
    def list_work_requests(compartment_id, opts = {})
      ...
      if opts[:type] && !OCI::ManagementAgent::Models::OPERATION_TYPES_ENUM.include?(opts[:type])
        raise 'Invalid value for "type", must be one of the values in OCI::ManagementAgent::Models::OPERATION_TYPES_ENUM.'
      end
