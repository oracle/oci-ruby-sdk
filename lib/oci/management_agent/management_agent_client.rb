...
module OCI
  ...
  class ManagementAgent::ManagementAgentClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/create_data_source.rb.html) to see an example of how to use create_data_source API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/delete_data_source.rb.html) to see an example of how to use delete_data_source API.
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::ManagementAgent::Models::DataSource DataSource}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/get_data_source.rb.html) to see an example of how to use get_data_source API.
    ...
    # @option opts [String] :sort_order The sort order to use, either 'asc' or 'desc'.
    #   Allowed values are: ASC, DESC
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. If no value is specified dataSourceName is default.
    #    (default to dataSourceName)
    #   Allowed values are: dataSourceName, dataSourceType
    # @option opts [Array<String>] :name Unique name of the dataSource.
    # @return [Response] A Response object with data of type Array<{OCI::ManagementAgent::Models::DataSourceSummary DataSourceSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/list_data_sources.rb.html) to see an example of how to use list_data_sources API.
    ...
    # @option opts [String] :install_type A filter to return either agents or gateway types depending upon install type selected by user. By default both install type will be returned.
    # @option opts [Array<String>] :gateway_id Filter to return only results having the particular gatewayId.
    # @option opts [Integer] :limit The maximum number of items to return.
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order to use, either 'asc' or 'desc'.
    #   Allowed values are: ASC, DESC
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [BOOLEAN] :compartment_id_in_subtree if set to true then it fetches resources for all compartments where user has access to else only on the compartment specified. (default to false)
    # @option opts [String] :access_level When the value is \"ACCESSIBLE\", insufficient permissions for a compartment will filter out resources in that compartment without rejecting the request.
    #
    # @option opts [String] :data_source_type The type of the dataSource.
    # @option opts [Array<String>] :data_source_name Unique name of the dataSource.
    ...
    # @option opts [Array<String>] :type The OperationType of the workRequest
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementagent/update_data_source.rb.html) to see an example of how to use update_data_source API.
