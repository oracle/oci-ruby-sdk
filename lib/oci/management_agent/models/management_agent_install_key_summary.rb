...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgentInstallKeySummary
    ...
    def hash
      [id, display_name, created_by_principal_id, allowed_key_install_count, current_key_install_count, lifecycle_state, lifecycle_details, time_created, time_expires, compartment_id].hash
    end
