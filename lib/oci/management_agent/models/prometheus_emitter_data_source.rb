...
module OCI
  ...
  #
  class ManagementAgent::Models::PrometheusEmitterDataSource < ManagementAgent::Models::DataSource
    ...
    # @option attributes [Integer] :read_data_limit The value to assign to the {#read_data_limit} property
