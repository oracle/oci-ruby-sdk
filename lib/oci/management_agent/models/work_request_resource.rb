...
module OCI
  ...
  class ManagementAgent::Models::WorkRequestResource
    ...
    # @option attributes [String] :source_version The value to assign to the {#source_version} property
    ...
    def hash
      [entity_type, action_type, identifier, source_id, source_name, source_version, entity_uri, time_accepted, time_started, time_finished, metadata].hash
    end
