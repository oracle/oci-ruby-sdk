...
module OCI
  ...
  class ManagementAgent::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_UPGRADE_PLUGIN = 'UPGRADE_PLUGIN'.freeze,
      OPERATION_TYPE_CREATE_UPGRADE_PLUGINS = 'CREATE_UPGRADE_PLUGINS'.freeze,
      OPERATION_TYPE_AGENTIMAGE_UPGRADE = 'AGENTIMAGE_UPGRADE'.freeze,
    ...
    # @return [Array<OCI::ManagementAgent::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::ManagementAgent::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::ManagementAgent::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
