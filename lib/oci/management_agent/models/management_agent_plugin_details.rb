...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgentPluginDetails
    ...
    # Plugin Status
    # @return [String]
    attr_reader :plugin_status

    # Status message of the Plugin
    # @return [String]
    attr_accessor :plugin_status_message
    ...
    # @option attributes [String] :plugin_status The value to assign to the {#plugin_status} property
    # @option attributes [String] :plugin_status_message The value to assign to the {#plugin_status_message} property
    ...
    # @param [Object] plugin_status Object to be assigned
    def plugin_status=(plugin_status)
      # rubocop:disable Style/ConditionalAssignment
      if plugin_status && !PLUGIN_STATUS_ENUM.include?(plugin_status)
        OCI.logger.debug("Unknown value for 'plugin_status' [" + plugin_status + "]. Mapping to 'PLUGIN_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @plugin_status = PLUGIN_STATUS_UNKNOWN_ENUM_VALUE
      else
