...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgent
    ...
    def hash
      [id, install_key_id, display_name, platform_type, platform_name, platform_version, version, host, install_path, plugin_list, compartment_id, is_agent_auto_upgradable, time_created, time_updated, time_last_heartbeat, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
