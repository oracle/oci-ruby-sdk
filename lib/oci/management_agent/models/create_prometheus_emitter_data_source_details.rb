...
require 'date'
require_relative 'create_data_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A Prometheus emitter data source.
  #
  class ManagementAgent::Models::CreatePrometheusEmitterDataSourceDetails < ManagementAgent::Models::CreateDataSourceDetails
    ...
    # @option attributes [String] :name The value to assign to the {OCI::ManagementAgent::Models::CreateDataSourceDetails#name #name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::ManagementAgent::Models::CreateDataSourceDetails#compartment_id #compartment_id} proprety
