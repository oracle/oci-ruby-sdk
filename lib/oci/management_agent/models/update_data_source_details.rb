...
module OCI
  ...
  class ManagementAgent::Models::UpdateDataSourceDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ManagementAgent::Models::UpdatePrometheusEmitterDataSourceDetails' if type == 'PROMETHEUS_EMITTER'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ManagementAgent::Models::UpdateDataSourceDetails'
    end
