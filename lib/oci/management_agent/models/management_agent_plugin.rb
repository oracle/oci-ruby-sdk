...
module OCI
  ...
  class ManagementAgent::Models::ManagementAgentPlugin
    ...
    def supported_platform_types=(supported_platform_types)
      ...
      if supported_platform_types.nil?
        ...
        supported_platform_types.each do |item|
          raise "Invalid value for 'supported_platform_types': this must be one of the values in SUPPORTED_PLATFORM_TYPES_ENUM." unless SUPPORTED_PLATFORM_TYPES_ENUM.include?(item)
        end
