...
module OCI
  ...
  class ManagementAgent::Models::CreateDataSourceDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ManagementAgent::Models::CreatePrometheusEmitterDataSourceDetails' if type == 'PROMETHEUS_EMITTER'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ManagementAgent::Models::CreateDataSourceDetails'
    end
