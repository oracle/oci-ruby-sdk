...
module OCI
  ...
  class DataScience::Models::UpdatePipelineDetails
    ...
    # @return [Array<OCI::DataScience::Models::PipelineStepUpdateDetails>]
    ...
    # @option attributes [Array<OCI::DataScience::Models::PipelineStepUpdateDetails>] :step_details The value to assign to the {#step_details} property
    ...
    def hash
      [display_name, description, configuration_details, log_configuration_details, step_details, freeform_tags, defined_tags].hash
    end
