...
module OCI
  ...
  class DataScience::Models::StorageMountConfigurationDetails
    STORAGE_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :destination_directory_name
    ...
    # @option attributes [String] :storage_type The value to assign to the {#storage_type} property
    # @option attributes [String] :destination_directory_name The value to assign to the {#destination_directory_name} property
    # @option attributes [String] :destination_path The value to assign to the {#destination_path} property
    ...
    def storage_type=(storage_type)
      ...
      if storage_type && !STORAGE_TYPE_ENUM.include?(storage_type)
        OCI.logger.debug("Unknown value for 'storage_type' [" + storage_type + "]. Mapping to 'STORAGE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @storage_type = STORAGE_TYPE_UNKNOWN_ENUM_VALUE
      else
