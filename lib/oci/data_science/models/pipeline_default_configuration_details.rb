...
require 'date'
require_relative 'pipeline_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The default pipeline configuration.
  class DataScience::Models::PipelineDefaultConfigurationDetails < DataScience::Models::PipelineConfigurationDetails
    ...
    def initialize(attributes = {})
      ...
      self.maximum_runtime_in_minutes = 1440 if maximum_runtime_in_minutes.nil? && !attributes.key?(:'maximumRuntimeInMinutes') # rubocop:disable Style/StringLiterals
      ...
      self.maximum_runtime_in_minutes = 1440 if maximum_runtime_in_minutes.nil? && !attributes.key?(:'maximumRuntimeInMinutes') && !attributes.key?(:'maximum_runtime_in_minutes') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [type, maximum_runtime_in_minutes, environment_variables, command_line_arguments].hash
    end
