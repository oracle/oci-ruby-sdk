...
module OCI
  ...
  class DataScience::Models::PipelineStepUpdateDetails
    STEP_TYPE_ENUM = [
    ...
    # @return [OCI::DataScience::Models::PipelineStepConfigurationDetails]
    attr_accessor :step_configuration_details
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::PipelineMLJobStepUpdateDetails' if type == 'ML_JOB'
      return 'OCI::DataScience::Models::PipelineCustomScriptStepUpdateDetails' if type == 'CUSTOM_SCRIPT'
    ...
    # @option attributes [OCI::DataScience::Models::PipelineStepConfigurationDetails] :step_configuration_details The value to assign to the {#step_configuration_details} property
