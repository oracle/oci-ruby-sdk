...
require 'date'
require_relative 'job_infrastructure_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The standalone job infrastructure configuration with network egress settings preconfigured.
  class DataScience::Models::ManagedEgressStandaloneJobInfrastructureConfigurationDetails < DataScience::Models::JobInfrastructureConfigurationDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['jobInfrastructureType'] = 'ME_STANDALONE'
    ...
    def hash
      [job_infrastructure_type, shape_name, block_storage_size_in_gbs].hash
    end
