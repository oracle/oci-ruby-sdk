...
module OCI
  ...
  class DataScience::Models::StandaloneJobInfrastructureConfigurationDetails < DataScience::Models::JobInfrastructureConfigurationDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['jobInfrastructureType'] = 'STANDALONE'
    ...
    def hash
      [job_infrastructure_type, shape_name, subnet_id, block_storage_size_in_gbs].hash
    end
