...
module OCI
  ...
  class DataScience::Models::ModelSummary
    ...
    def hash
      [compartment_id, project_id, id, display_name, created_by, time_created, lifecycle_state, model_version_set_id, model_version_set_name, version_id, version_label, freeform_tags, defined_tags].hash
    end
