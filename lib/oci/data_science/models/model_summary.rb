...
module OCI
  ...
  class DataScience::Models::ModelSummary
    ...
    def hash
      [compartment_id, project_id, id, display_name, created_by, time_created, lifecycle_state, freeform_tags, defined_tags].hash
    end
