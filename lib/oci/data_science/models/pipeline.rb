...
module OCI
  ...
  class DataScience::Models::Pipeline
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user who created the pipeline.
    # @return [String]
    attr_accessor :created_by

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate the pipeline with.
    # @return [String]
    attr_accessor :project_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the pipeline.
    # @return [String]
    ...
    attr_accessor :log_configuration_details

    # @return [OCI::DataScience::Models::PipelineInfrastructureConfigurationDetails]
    attr_accessor :infrastructure_configuration_details

    # **[Required]** Array of step details for each step.
    # @return [Array<OCI::DataScience::Models::PipelineStepDetails>]
    ...
    # @option attributes [OCI::DataScience::Models::PipelineLogConfigurationDetails] :log_configuration_details The value to assign to the {#log_configuration_details} property
    # @option attributes [OCI::DataScience::Models::PipelineInfrastructureConfigurationDetails] :infrastructure_configuration_details The value to assign to the {#infrastructure_configuration_details} property
    # @option attributes [Array<OCI::DataScience::Models::PipelineStepDetails>] :step_details The value to assign to the {#step_details} property
    ...
    def hash
      [id, time_created, time_updated, created_by, project_id, compartment_id, display_name, description, configuration_details, log_configuration_details, infrastructure_configuration_details, step_details, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
