...
require 'date'
require 'logger'
require_relative 'scaling_configuration'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The scaling configuration for the predefined metric expression rule.
  #
  class DataScience::Models::PredefinedExpressionThresholdScalingConfiguration < DataScience::Models::ScalingConfiguration
    ...
    # @option attributes [String] :pending_duration The value to assign to the {OCI::DataScience::Models::ScalingConfiguration#pending_duration #pending_duration} proprety
    # @option attributes [Integer] :instance_count_adjustment The value to assign to the {OCI::DataScience::Models::ScalingConfiguration#instance_count_adjustment #instance_count_adjustment} proprety
    # @option attributes [Integer] :threshold The value to assign to the {#threshold} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['scalingConfigurationType'] = 'THRESHOLD'
    ...
    def hash
      [scaling_configuration_type, pending_duration, instance_count_adjustment, threshold].hash
    end
