...
module OCI
  ...
  class DataScience::Models::PipelineSummary
    ...
    def hash
      [id, time_created, time_updated, created_by, project_id, compartment_id, display_name, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
