...
module OCI
  ...
  class DataScience::Models::ScalingPolicy
    POLICY_TYPE_ENUM = [
      POLICY_TYPE_FIXED_SIZE = 'FIXED_SIZE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::FixedSizeScalingPolicy' if type == 'FIXED_SIZE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ScalingPolicy'
    end
