...
module OCI
  ...
  class DataScience::Models::ModelVersionSet
    ...
    def hash
      [id, compartment_id, project_id, name, description, lifecycle_state, time_created, time_updated, created_by, freeform_tags, defined_tags, system_tags].hash
    end
