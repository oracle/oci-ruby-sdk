...
module OCI
  ...
  class DataScience::Models::PipelineRunSummary
    ...
    def hash
      [id, time_accepted, time_started, time_finished, time_updated, created_by, project_id, compartment_id, pipeline_id, display_name, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
