...
module OCI
  ...
  class DataScience::Models::NotebookSessionShapeConfigDetails
    ...
    def initialize(attributes = {})
      ...
      self.ocpus = 1.0 if ocpus.nil? && !attributes.key?(:'ocpus') # rubocop:disable Style/StringLiterals

      self.memory_in_gbs = attributes[:'memoryInGBs'] if attributes[:'memoryInGBs']
      self.memory_in_gbs = 15.0 if memory_in_gbs.nil? && !attributes.key?(:'memoryInGBs') # rubocop:disable Style/StringLiterals
      ...
      self.memory_in_gbs = 15.0 if memory_in_gbs.nil? && !attributes.key?(:'memoryInGBs') && !attributes.key?(:'memory_in_gbs') # rubocop:disable Style/StringLiterals
    end
