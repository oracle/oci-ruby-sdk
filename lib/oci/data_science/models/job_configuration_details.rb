...
module OCI
  ...
  class DataScience::Models::JobConfigurationDetails
    JOB_TYPE_ENUM = [
      JOB_TYPE_DEFAULT = 'DEFAULT'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::DefaultJobConfigurationDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::JobConfigurationDetails'
    end
