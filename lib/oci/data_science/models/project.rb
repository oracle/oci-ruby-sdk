...
module OCI
  ...
  #
  class DataScience::Models::Project
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user who created this project.
    # @return [String]
