...
require 'date'
require_relative 'scaling_policy'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The fixed size scaling policy.
  class DataScience::Models::FixedSizeScalingPolicy < DataScience::Models::ScalingPolicy
    ...
    def initialize(attributes = {})
      ...
      attributes['policyType'] = 'FIXED_SIZE'
    ...
    def hash
      [policy_type, instance_count].hash
    end
