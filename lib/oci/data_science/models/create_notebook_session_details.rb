...
module OCI
  ...
  class DataScience::Models::CreateNotebookSessionDetails
    ...
    def initialize(attributes = {})
      ...
      self.notebook_session_runtime_config_details = attributes[:'notebookSessionRuntimeConfigDetails'] if attributes[:'notebookSessionRuntimeConfigDetails']
    ...
    def hash
      [display_name, project_id, compartment_id, notebook_session_configuration_details, notebook_session_config_details, freeform_tags, defined_tags, notebook_session_runtime_config_details, notebook_session_storage_mount_configuration_details_list].hash
    end
