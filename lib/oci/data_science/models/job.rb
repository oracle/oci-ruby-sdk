...
module OCI
  ...
  class DataScience::Models::Job
    ...
    def hash
      [id, time_created, created_by, project_id, compartment_id, display_name, description, job_configuration_details, job_infrastructure_configuration_details, job_environment_configuration_details, job_log_configuration_details, job_storage_mount_configuration_details_list, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
