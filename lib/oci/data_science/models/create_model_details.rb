...
module OCI
  ...
  class DataScience::Models::CreateModelDetails
    ...
    def hash
      [compartment_id, project_id, display_name, description, freeform_tags, defined_tags, custom_metadata_list, defined_metadata_list, input_schema, output_schema].hash
    end
