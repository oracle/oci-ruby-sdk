...
module OCI
  ...
  class DataScience::Models::CreatePipelineDetails
    ...
    def hash
      [project_id, compartment_id, display_name, description, configuration_details, log_configuration_details, infrastructure_configuration_details, step_details, freeform_tags, defined_tags].hash
    end
