...
module OCI
  ...
  #
  class DataScience::Models::UpdateModelDeploymentDetails
    ...
    # @option attributes [OCI::DataScience::Models::UpdateModelDeploymentConfigurationDetails] :model_deployment_configuration_details The value to assign to the {#model_deployment_configuration_details} property
    # @option attributes [OCI::DataScience::Models::UpdateCategoryLogDetails] :category_log_details The value to assign to the {#category_log_details} property
    ...
    def hash
      [display_name, description, model_deployment_configuration_details, category_log_details, freeform_tags, defined_tags].hash
    end
