...
module OCI
  ...
  #
  class DataScience::Models::CreateJobRunDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the job to create a run for.
    # @return [String]
    attr_accessor :job_id

    # @return [OCI::DataScience::Models::JobConfigurationDetails]
    attr_accessor :job_configuration_override_details
    ...
    def initialize(attributes = {})
      ...
      self.job_configuration_override_details = attributes[:'jobConfigurationOverrideDetails'] if attributes[:'jobConfigurationOverrideDetails']

      raise 'You cannot provide both :jobConfigurationOverrideDetails and :job_configuration_override_details' if attributes.key?(:'jobConfigurationOverrideDetails') && attributes.key?(:'job_configuration_override_details')

      self.job_configuration_override_details = attributes[:'job_configuration_override_details'] if attributes[:'job_configuration_override_details']

      self.job_log_configuration_override_details = attributes[:'jobLogConfigurationOverrideDetails'] if attributes[:'jobLogConfigurationOverrideDetails']

      raise 'You cannot provide both :jobLogConfigurationOverrideDetails and :job_log_configuration_override_details' if attributes.key?(:'jobLogConfigurationOverrideDetails') && attributes.key?(:'job_log_configuration_override_details')
    ...
    def hash
      [project_id, compartment_id, display_name, job_id, job_configuration_override_details, job_log_configuration_override_details, freeform_tags, defined_tags].hash
    end
