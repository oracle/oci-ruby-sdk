...
module OCI
  ...
  class DataScience::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_MODELVERSIONSET_DELETE = 'MODELVERSIONSET_DELETE'.freeze,
      OPERATION_TYPE_EXPORT_MODEL_ARTIFACT = 'EXPORT_MODEL_ARTIFACT'.freeze,
      OPERATION_TYPE_IMPORT_MODEL_ARTIFACT = 'IMPORT_MODEL_ARTIFACT'.freeze,
      ...
      OPERATION_TYPE_PIPELINE_CREATE = 'PIPELINE_CREATE'.freeze,
      OPERATION_TYPE_PIPELINE_DELETE = 'PIPELINE_DELETE'.freeze,
      OPERATION_TYPE_PIPELINE_RUN_CREATE = 'PIPELINE_RUN_CREATE'.freeze,
      OPERATION_TYPE_PIPELINE_RUN_CANCEL = 'PIPELINE_RUN_CANCEL'.freeze,
      OPERATION_TYPE_PIPELINE_RUN_DELETE = 'PIPELINE_RUN_DELETE'.freeze,
      OPERATION_TYPE_PRIVATE_ENDPOINT_CREATE = 'PRIVATE_ENDPOINT_CREATE'.freeze,
      OPERATION_TYPE_PRIVATE_ENDPOINT_DELETE = 'PRIVATE_ENDPOINT_DELETE'.freeze,
      OPERATION_TYPE_PRIVATE_ENDPOINT_MOVE = 'PRIVATE_ENDPOINT_MOVE'.freeze,
      OPERATION_TYPE_PRIVATE_ENDPOINT_UPDATE = 'PRIVATE_ENDPOINT_UPDATE'.freeze,
