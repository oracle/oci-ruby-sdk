...
module OCI
  ...
  class DataScience::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_NOTEBOOK_SESSION_CREATE = 'NOTEBOOK_SESSION_CREATE'.freeze,
      ...
      OPERATION_TYPE_JOB_DELETE = 'JOB_DELETE'.freeze,
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DataScience::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DataScience::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [id, operation_type, status, compartment_id, percent_complete, resources, time_accepted, time_started, time_finished].hash
    end
