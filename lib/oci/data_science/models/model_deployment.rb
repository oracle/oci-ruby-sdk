...
module OCI
  ...
  class DataScience::Models::ModelDeployment
    ...
    def hash
      [id, time_created, display_name, description, project_id, created_by, compartment_id, model_deployment_configuration_details, category_log_details, model_deployment_url, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
