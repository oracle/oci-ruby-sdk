...
require 'date'
require_relative 'update_model_deployment_environment_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The update environment configuration details object for OCI Registry
  class DataScience::Models::UpdateOcirModelDeploymentEnvironmentConfigurationDetails < DataScience::Models::UpdateModelDeploymentEnvironmentConfigurationDetails
    ...
    # @option attributes [Integer] :server_port The value to assign to the {#server_port} property
    # @option attributes [Integer] :health_check_port The value to assign to the {#health_check_port} property
