...
module OCI
  ...
  class DataScience::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource the work request affects.
    # @return [String]
