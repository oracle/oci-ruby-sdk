...
module OCI
  ...
  class DataScience::Models::Model
    ...
    # @return [String]
    attr_accessor :model_version_set_name
    ...
    # @option attributes [String] :model_version_set_name The value to assign to the {#model_version_set_name} property
    # @option attributes [Integer] :version_id The value to assign to the {#version_id} property
    ...
    def hash
      [id, compartment_id, project_id, display_name, description, lifecycle_state, time_created, created_by, freeform_tags, defined_tags, custom_metadata_list, defined_metadata_list, input_schema, output_schema, model_version_set_id, model_version_set_name, version_id, version_label].hash
    end
