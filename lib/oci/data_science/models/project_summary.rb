...
module OCI
  ...
  class DataScience::Models::ProjectSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project's compartment.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user who created the project.
    # @return [String]
    ...
    def hash
      [id, time_created, display_name, description, compartment_id, created_by, lifecycle_state, freeform_tags, defined_tags].hash
    end
