...
module OCI
  ...
  #
  class DataScience::Models::CustomExpressionQueryScalingConfiguration < DataScience::Models::ScalingConfiguration
    ...
    def initialize(attributes = {})
      ...
      attributes['scalingConfigurationType'] = 'QUERY'
    ...
    def hash
      [scaling_configuration_type, pending_duration, instance_count_adjustment, query].hash
    end
