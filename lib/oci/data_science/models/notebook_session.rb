...
module OCI
  ...
  class DataScience::Models::NotebookSession
    ...
    def hash
      [id, time_created, display_name, project_id, created_by, compartment_id, notebook_session_configuration_details, notebook_session_url, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
