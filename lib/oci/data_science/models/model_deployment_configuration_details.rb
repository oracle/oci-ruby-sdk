...
module OCI
  ...
  class DataScience::Models::ModelDeploymentConfigurationDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::SingleModelDeploymentConfigurationDetails' if type == 'SINGLE_MODEL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ModelDeploymentConfigurationDetails'
    end
