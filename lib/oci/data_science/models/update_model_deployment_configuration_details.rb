...
module OCI
  ...
  class DataScience::Models::UpdateModelDeploymentConfigurationDetails
    DEPLOYMENT_TYPE_ENUM = [
      DEPLOYMENT_TYPE_SINGLE_MODEL = 'SINGLE_MODEL'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::UpdateSingleModelDeploymentConfigurationDetails' if type == 'SINGLE_MODEL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::UpdateModelDeploymentConfigurationDetails'
    end
