...
require 'date'
require_relative 'build_runner_shape_config'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Specifies the custom build runner shape config.
  class Devops::Models::CustomBuildRunnerShapeConfig < Devops::Models::BuildRunnerShapeConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['buildRunnerType'] = 'CUSTOM'
    ...
    def hash
      [build_runner_type, ocpus, memory_in_gbs].hash
    end
