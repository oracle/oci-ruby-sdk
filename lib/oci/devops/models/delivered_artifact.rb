...
module OCI
  ...
  class Devops::Models::DeliveredArtifact
    ARTIFACT_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :output_artifact_name
    ...
    # @option attributes [String] :output_artifact_name The value to assign to the {#output_artifact_name} property
