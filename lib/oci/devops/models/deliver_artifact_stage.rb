...
module OCI
  ...
  class Devops::Models::DeliverArtifactStage < Devops::Models::BuildPipelineStage
    ...
    def hash
      [id, display_name, description, project_id, build_pipeline_id, compartment_id, build_pipeline_stage_type, time_created, time_updated, lifecycle_state, lifecycle_details, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, system_tags, deliver_artifact_collection].hash
    end
