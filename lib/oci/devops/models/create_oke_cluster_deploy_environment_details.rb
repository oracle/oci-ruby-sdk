...
module OCI
  ...
  class Devops::Models::CreateOkeClusterDeployEnvironmentDetails < Devops::Models::CreateDeployEnvironmentDetails
    ...
    def hash
      [description, display_name, deploy_environment_type, project_id, freeform_tags, defined_tags, cluster_id, network_channel].hash
    end
