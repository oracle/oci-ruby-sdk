...
module OCI
  ...
  class Devops::Models::OkeCanaryApprovalDeployStageSummary < Devops::Models::DeployStageSummary
    # **[Required]** The OCID of an upstream OKE canary deployment traffic shift stage in this pipeline.
    # @return [String]
    attr_accessor :oke_canary_traffic_shift_deploy_stage_id
    ...
    # @option attributes [String] :oke_canary_traffic_shift_deploy_stage_id The value to assign to the {#oke_canary_traffic_shift_deploy_stage_id} property
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'OKE_CANARY_APPROVAL'
      ...
      self.oke_canary_traffic_shift_deploy_stage_id = attributes[:'okeCanaryTrafficShiftDeployStageId'] if attributes[:'okeCanaryTrafficShiftDeployStageId']

      raise 'You cannot provide both :okeCanaryTrafficShiftDeployStageId and :oke_canary_traffic_shift_deploy_stage_id' if attributes.key?(:'okeCanaryTrafficShiftDeployStageId') && attributes.key?(:'oke_canary_traffic_shift_deploy_stage_id')

      self.oke_canary_traffic_shift_deploy_stage_id = attributes[:'oke_canary_traffic_shift_deploy_stage_id'] if attributes[:'oke_canary_traffic_shift_deploy_stage_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        oke_canary_traffic_shift_deploy_stage_id == other.oke_canary_traffic_shift_deploy_stage_id &&
    ...
    def hash
      [id, description, display_name, project_id, deploy_pipeline_id, compartment_id, deploy_stage_type, time_created, time_updated, lifecycle_state, lifecycle_details, deploy_stage_predecessor_collection, freeform_tags, defined_tags, system_tags, oke_canary_traffic_shift_deploy_stage_id, approval_policy].hash
    end
