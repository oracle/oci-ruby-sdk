...
module OCI
  ...
  class Devops::Models::RepositoryRef
    REF_TYPE_ENUM = [
      REF_TYPE_BRANCH = 'BRANCH'.freeze,
      REF_TYPE_TAG = 'TAG'.freeze,
      REF_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::RepositoryBranch' if type == 'BRANCH'
      return 'OCI::Devops::Models::RepositoryTag' if type == 'TAG'
    ...
    # @option attributes [String] :ref_name The value to assign to the {#ref_name} property
    # @option attributes [String] :ref_type The value to assign to the {#ref_type} property
    # @option attributes [String] :full_ref_name The value to assign to the {#full_ref_name} property
    ...
    def ref_type=(ref_type)
      ...
      if ref_type && !REF_TYPE_ENUM.include?(ref_type)
        OCI.logger.debug("Unknown value for 'ref_type' [" + ref_type + "]. Mapping to 'REF_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @ref_type = REF_TYPE_UNKNOWN_ENUM_VALUE
      else
        @ref_type = ref_type
      end
    ...
    def hash
      [ref_name, ref_type, full_ref_name, repository_id, freeform_tags, defined_tags].hash
    end
