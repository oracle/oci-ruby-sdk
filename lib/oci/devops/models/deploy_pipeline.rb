...
module OCI
  ...
  class Devops::Models::DeployPipeline
    ...
    # @return [OCI::Devops::Models::DeployPipelineParameterCollection]
    attr_accessor :deploy_pipeline_parameters
    ...
    # @option attributes [OCI::Devops::Models::DeployPipelineParameterCollection] :deploy_pipeline_parameters The value to assign to the {#deploy_pipeline_parameters} property
    ...
    def initialize(attributes = {})
      ...
      self.deploy_pipeline_parameters = attributes[:'deployPipelineParameters'] if attributes[:'deployPipelineParameters']

      raise 'You cannot provide both :deployPipelineParameters and :deploy_pipeline_parameters' if attributes.key?(:'deployPipelineParameters') && attributes.key?(:'deploy_pipeline_parameters')

      self.deploy_pipeline_parameters = attributes[:'deploy_pipeline_parameters'] if attributes[:'deploy_pipeline_parameters']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        deploy_pipeline_parameters == other.deploy_pipeline_parameters &&
    ...
    def hash
      [id, description, display_name, project_id, compartment_id, deploy_pipeline_artifacts, deploy_pipeline_environments, time_created, time_updated, lifecycle_state, lifecycle_details, deploy_pipeline_parameters, freeform_tags, defined_tags, system_tags].hash
    end
