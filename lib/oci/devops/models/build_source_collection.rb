...
module OCI
  ...
  class Devops::Models::BuildSourceCollection
    ...
    # @return [Array<OCI::Devops::Models::BuildSource>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Devops::Models::BuildSource>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Devops::Models::BuildSource>] :items The value to assign to the {#items} property
