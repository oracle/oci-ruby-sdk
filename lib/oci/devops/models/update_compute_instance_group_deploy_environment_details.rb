...
module OCI
  ...
  class Devops::Models::UpdateComputeInstanceGroupDeployEnvironmentDetails < Devops::Models::UpdateDeployEnvironmentDetails
    ...
    def hash
      [description, display_name, deploy_environment_type, freeform_tags, defined_tags, compute_instance_group_selectors].hash
    end
