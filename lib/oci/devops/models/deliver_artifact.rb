...
module OCI
  ...
  class Devops::Models::DeliverArtifact
    ...
    # @option attributes [String] :artifact_name The value to assign to the {#artifact_name} property
    # @option attributes [String] :artifact_id The value to assign to the {#artifact_id} property
    def initialize(attributes = {})
      ...
      self.artifact_name = attributes[:'artifactName'] if attributes[:'artifactName']

      raise 'You cannot provide both :artifactName and :artifact_name' if attributes.key?(:'artifactName') && attributes.key?(:'artifact_name')

      self.artifact_name = attributes[:'artifact_name'] if attributes[:'artifact_name']
    ...
    def hash
      [artifact_name, artifact_id].hash
    end
