...
module OCI
  ...
  class Devops::Models::WaitDeployStageSummary < Devops::Models::DeployStageSummary
    # This attribute is required.
    # @return [OCI::Devops::Models::WaitCriteriaSummary]
    ...
    def self.swagger_types
      {
        ...
        'wait_criteria': :'OCI::Devops::Models::WaitCriteriaSummary'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Devops::Models::WaitCriteriaSummary] :wait_criteria The value to assign to the {#wait_criteria} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['deployStageType'] = 'WAIT'
    ...
    def hash
      [id, description, display_name, project_id, deploy_pipeline_id, compartment_id, deploy_stage_type, time_created, time_updated, lifecycle_state, lifecycle_details, deploy_stage_predecessor_collection, freeform_tags, defined_tags, system_tags, wait_criteria].hash
    end
