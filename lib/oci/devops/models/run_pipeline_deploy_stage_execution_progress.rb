...
module OCI
  ...
  class Devops::Models::RunPipelineDeployStageExecutionProgress < Devops::Models::DeployStageExecutionProgress
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'RUN_DEPLOYMENT_PIPELINE'
