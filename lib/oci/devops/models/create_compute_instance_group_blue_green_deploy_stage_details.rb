...
module OCI
  ...
  class Devops::Models::CreateComputeInstanceGroupBlueGreenDeployStageDetails < Devops::Models::CreateDeployStageDetails
    # **[Required]** First compute instance group environment OCID for deployment.
    # @return [String]
    attr_accessor :deploy_environment_id_a

    # **[Required]** Second compute instance group environment OCID for deployment.
    # @return [String]
    attr_accessor :deploy_environment_id_b
    ...
    # This attribute is required.
    # @return [OCI::Devops::Models::LoadBalancerConfig]
    attr_accessor :production_load_balancer_config
    ...
    def self.swagger_types
      {
        ...
        'production_load_balancer_config': :'OCI::Devops::Models::LoadBalancerConfig'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :deploy_environment_id_a The value to assign to the {#deploy_environment_id_a} property
    # @option attributes [String] :deploy_environment_id_b The value to assign to the {#deploy_environment_id_b} property
    ...
    # @option attributes [OCI::Devops::Models::LoadBalancerConfig] :production_load_balancer_config The value to assign to the {#production_load_balancer_config} property
    def initialize(attributes = {})
      ...
      self.deploy_environment_id_a = attributes[:'deployEnvironmentIdA'] if attributes[:'deployEnvironmentIdA']

      raise 'You cannot provide both :deployEnvironmentIdA and :deploy_environment_id_a' if attributes.key?(:'deployEnvironmentIdA') && attributes.key?(:'deploy_environment_id_a')

      self.deploy_environment_id_a = attributes[:'deploy_environment_id_a'] if attributes[:'deploy_environment_id_a']

      self.deploy_environment_id_b = attributes[:'deployEnvironmentIdB'] if attributes[:'deployEnvironmentIdB']

      raise 'You cannot provide both :deployEnvironmentIdB and :deploy_environment_id_b' if attributes.key?(:'deployEnvironmentIdB') && attributes.key?(:'deploy_environment_id_b')

      self.deploy_environment_id_b = attributes[:'deploy_environment_id_b'] if attributes[:'deploy_environment_id_b']
      ...
      self.production_load_balancer_config = attributes[:'productionLoadBalancerConfig'] if attributes[:'productionLoadBalancerConfig']

      raise 'You cannot provide both :productionLoadBalancerConfig and :production_load_balancer_config' if attributes.key?(:'productionLoadBalancerConfig') && attributes.key?(:'production_load_balancer_config')

      self.production_load_balancer_config = attributes[:'production_load_balancer_config'] if attributes[:'production_load_balancer_config']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        deploy_environment_id_a == other.deploy_environment_id_a &&
        deploy_environment_id_b == other.deploy_environment_id_b &&
        ...
        production_load_balancer_config == other.production_load_balancer_config
    end
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, deploy_environment_id_a, deploy_environment_id_b, deployment_spec_deploy_artifact_id, deploy_artifact_ids, rollout_policy, failure_policy, test_load_balancer_config, production_load_balancer_config].hash
    end
