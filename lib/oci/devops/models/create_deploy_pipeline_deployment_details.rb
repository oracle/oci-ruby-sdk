...
module OCI
  ...
  class Devops::Models::CreateDeployPipelineDeploymentDetails < Devops::Models::CreateDeploymentDetails
    ...
    def hash
      [deploy_pipeline_id, deployment_type, display_name, freeform_tags, defined_tags, deployment_arguments, deploy_stage_override_arguments, deploy_artifact_override_arguments].hash
    end
