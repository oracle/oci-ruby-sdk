...
require 'date'
require_relative 'trigger_action'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The action to trigger a build pipeline.
  class Devops::Models::TriggerBuildPipelineAction < Devops::Models::TriggerAction
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'type': :'String',
        'filter': :'OCI::Devops::Models::Filter',
    ...
    # @option attributes [OCI::Devops::Models::Filter] :filter The value to assign to the {OCI::Devops::Models::TriggerAction#filter #filter} proprety
    # @option attributes [String] :build_pipeline_id The value to assign to the {#build_pipeline_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'TRIGGER_BUILD_PIPELINE'
    ...
    def hash
      [type, filter, build_pipeline_id].hash
    end
