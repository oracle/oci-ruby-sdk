...
module OCI
  ...
  class Devops::Models::DeliverArtifactCollection
    ...
    # @return [Array<OCI::Devops::Models::DeliverArtifact>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Devops::Models::DeliverArtifact>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Devops::Models::DeliverArtifact>] :items The value to assign to the {#items} property
