...
module OCI
  ...
  class Devops::Models::ComputeInstanceGroupFailurePolicy
    POLICY_TYPE_ENUM = [
      POLICY_TYPE_COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_COUNT = 'COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_COUNT'.freeze,
      POLICY_TYPE_COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_PERCENTAGE = 'COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_PERCENTAGE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::ComputeInstanceGroupFailurePolicyByPercentage' if type == 'COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_PERCENTAGE'
      return 'OCI::Devops::Models::ComputeInstanceGroupFailurePolicyByCount' if type == 'COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_COUNT'
