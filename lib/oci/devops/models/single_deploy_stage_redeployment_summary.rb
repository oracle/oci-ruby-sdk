...
module OCI
  ...
  class Devops::Models::SingleDeployStageRedeploymentSummary < Devops::Models::DeploymentSummary
    ...
    def hash
      [deployment_type, id, display_name, project_id, deploy_pipeline_id, compartment_id, time_created, time_updated, lifecycle_state, deployment_arguments, deploy_artifact_override_arguments, lifecycle_details, freeform_tags, defined_tags, system_tags, previous_deployment_id, deploy_stage_id].hash
    end
