...
module OCI
  ...
  class Devops::Models::CreateWaitDeployStageDetails < Devops::Models::CreateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, wait_criteria].hash
    end
