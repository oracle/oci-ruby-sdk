...
module OCI
  ...
  class Devops::Models::CreateWaitStageDetails < Devops::Models::CreateBuildPipelineStageDetails
    # This attribute is required.
    # @return [OCI::Devops::Models::CreateWaitCriteriaDetails]
    ...
    def self.swagger_types
      {
        ...
        'wait_criteria': :'OCI::Devops::Models::CreateWaitCriteriaDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Devops::Models::CreateWaitCriteriaDetails] :wait_criteria The value to assign to the {#wait_criteria} property
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_id, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, wait_criteria].hash
    end
