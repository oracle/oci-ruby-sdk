...
module OCI
  ...
  class Devops::Models::ComputeInstanceGroupSelectorCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Devops::Models::ComputeInstanceGroupSelector>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Devops::Models::ComputeInstanceGroupSelector>] :items The value to assign to the {#items} property
