...
module OCI
  ...
  class Devops::Models::MirrorRepositoryConfig
    ...
    # @return [OCI::Devops::Models::TriggerSchedule]
    ...
    def self.swagger_types
      {
        ...
        'trigger_schedule': :'OCI::Devops::Models::TriggerSchedule'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Devops::Models::TriggerSchedule] :trigger_schedule The value to assign to the {#trigger_schedule} property
    def initialize(attributes = {})
      ...
      self.trigger_schedule = attributes[:'triggerSchedule'] if attributes[:'triggerSchedule']

      raise 'You cannot provide both :triggerSchedule and :trigger_schedule' if attributes.key?(:'triggerSchedule') && attributes.key?(:'trigger_schedule')

      self.trigger_schedule = attributes[:'trigger_schedule'] if attributes[:'trigger_schedule']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        trigger_schedule == other.trigger_schedule
    end
    ...
    def hash
      [connector_id, repository_url, trigger_schedule].hash
    end
