...
module OCI
  ...
  #
  class Devops::Models::CreateVbsAccessTokenConnectionDetails < Devops::Models::CreateConnectionDetails
    ...
    def hash
      [description, display_name, project_id, connection_type, freeform_tags, defined_tags, access_token, base_url].hash
    end
