...
module OCI
  ...
  class Devops::Models::DeployStage
    ...
    # @param [Object] deploy_stage_type Object to be assigned
    def deploy_stage_type=(deploy_stage_type)
      # rubocop:disable Style/ConditionalAssignment
      if deploy_stage_type && !DEPLOY_STAGE_TYPE_ENUM.include?(deploy_stage_type)
        OCI.logger.debug("Unknown value for 'deploy_stage_type' [" + deploy_stage_type + "]. Mapping to 'DEPLOY_STAGE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @deploy_stage_type = DEPLOY_STAGE_TYPE_UNKNOWN_ENUM_VALUE
      else
