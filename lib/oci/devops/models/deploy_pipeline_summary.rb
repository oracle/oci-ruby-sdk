...
module OCI
  ...
  class Devops::Models::DeployPipelineSummary
    ...
    def hash
      [id, description, display_name, project_id, compartment_id, time_created, time_updated, lifecycle_details, lifecycle_state, deploy_pipeline_parameters, freeform_tags, defined_tags, system_tags].hash
    end
