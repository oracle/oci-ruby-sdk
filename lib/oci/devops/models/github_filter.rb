...
module OCI
  ...
  class Devops::Models::GithubFilter < Devops::Models::Filter
    ...
    # @return [OCI::Devops::Models::GithubFilterExclusionAttributes]
    ...
    # @option attributes [OCI::Devops::Models::GithubFilterExclusionAttributes] :exclude The value to assign to the {#exclude} property
