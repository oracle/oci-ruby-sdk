...
module OCI
  ...
  class Devops::Models::GithubFilter < Devops::Models::Filter
    EVENTS_ENUM = [
    ...
    # @return [OCI::Devops::Models::GithubFilterAttributes]
    ...
    # @option attributes [OCI::Devops::Models::GithubFilterAttributes] :include The value to assign to the {#include} property
