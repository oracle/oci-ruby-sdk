...
module OCI
  ...
  class Devops::Models::RunValidationTestOnComputeInstanceDeployStageExecutionProgress < Devops::Models::DeployStageExecutionProgress
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'RUN_VALIDATION_TEST_ON_COMPUTE_INSTANCE'
