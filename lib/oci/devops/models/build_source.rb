...
module OCI
  ...
  class Devops::Models::BuildSource
    CONNECTION_TYPE_ENUM = [
      ...
      CONNECTION_TYPE_GITLAB_SERVER = 'GITLAB_SERVER'.freeze,
      CONNECTION_TYPE_BITBUCKET_CLOUD = 'BITBUCKET_CLOUD'.freeze,
      CONNECTION_TYPE_BITBUCKET_SERVER = 'BITBUCKET_SERVER'.freeze,
      CONNECTION_TYPE_DEVOPS_CODE_REPOSITORY = 'DEVOPS_CODE_REPOSITORY'.freeze,
      CONNECTION_TYPE_VBS = 'VBS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::VbsBuildSource' if type == 'VBS'
      return 'OCI::Devops::Models::BitbucketServerBuildSource' if type == 'BITBUCKET_SERVER'
      ...
      return 'OCI::Devops::Models::GitlabServerBuildSource' if type == 'GITLAB_SERVER'
