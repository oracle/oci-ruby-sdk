...
module OCI
  ...
  class Devops::Models::UpdateDeliverArtifactStageDetails < Devops::Models::UpdateBuildPipelineStageDetails
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, deliver_artifact_collection].hash
    end
