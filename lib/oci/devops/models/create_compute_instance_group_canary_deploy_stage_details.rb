...
module OCI
  ...
  class Devops::Models::CreateComputeInstanceGroupCanaryDeployStageDetails < Devops::Models::CreateDeployStageDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'COMPUTE_INSTANCE_GROUP_CANARY_DEPLOYMENT'
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, compute_instance_group_deploy_environment_id, deployment_spec_deploy_artifact_id, deploy_artifact_ids, rollout_policy, test_load_balancer_config, production_load_balancer_config].hash
    end
