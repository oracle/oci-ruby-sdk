...
module OCI
  ...
  class Devops::Models::PutRepositoryRefDetails
    REF_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::PutRepositoryTagDetails' if type == 'TAG'
      return 'OCI::Devops::Models::PutRepositoryBranchDetails' if type == 'BRANCH'
    ...
    def ref_type=(ref_type)
      raise "Invalid value for 'ref_type': this must be one of the values in REF_TYPE_ENUM." if ref_type && !REF_TYPE_ENUM.include?(ref_type)
