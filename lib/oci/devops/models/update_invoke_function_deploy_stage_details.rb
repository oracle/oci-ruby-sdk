...
module OCI
  ...
  class Devops::Models::UpdateInvokeFunctionDeployStageDetails < Devops::Models::UpdateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_stage_predecessor_collection, freeform_tags, defined_tags, function_deploy_environment_id, deploy_artifact_id, is_async, is_validation_enabled].hash
    end
