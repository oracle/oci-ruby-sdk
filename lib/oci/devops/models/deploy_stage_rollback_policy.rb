...
module OCI
  ...
  class Devops::Models::DeployStageRollbackPolicy
    POLICY_TYPE_ENUM = [
      POLICY_TYPE_AUTOMATED_STAGE_ROLLBACK_POLICY = 'AUTOMATED_STAGE_ROLLBACK_POLICY'.freeze,
      POLICY_TYPE_NO_STAGE_ROLLBACK_POLICY = 'NO_STAGE_ROLLBACK_POLICY'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::NoDeployStageRollbackPolicy' if type == 'NO_STAGE_ROLLBACK_POLICY'
      return 'OCI::Devops::Models::AutomatedDeployStageRollbackPolicy' if type == 'AUTOMATED_STAGE_ROLLBACK_POLICY'
