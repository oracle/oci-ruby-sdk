...
module OCI
  ...
  class Devops::Models::UpdateBuildPipelineStageDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::UpdateWaitStageDetails' if type == 'WAIT'
      return 'OCI::Devops::Models::UpdateBuildStageDetails' if type == 'BUILD'
      return 'OCI::Devops::Models::UpdateTriggerDeploymentStageDetails' if type == 'TRIGGER_DEPLOYMENT_PIPELINE'
      return 'OCI::Devops::Models::UpdateDeliverArtifactStageDetails' if type == 'DELIVER_ARTIFACT'
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags].hash
    end
