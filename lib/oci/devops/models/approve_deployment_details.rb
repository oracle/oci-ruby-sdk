...
module OCI
  ...
  class Devops::Models::ApproveDeploymentDetails
    ACTION_ENUM = [
      ACTION_APPROVE = 'APPROVE'.freeze,
      ACTION_REJECT = 'REJECT'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the stage which is marked for approval.
    # @return [String]
    ...
    def hash
      [deploy_stage_id, reason, action].hash
    end
