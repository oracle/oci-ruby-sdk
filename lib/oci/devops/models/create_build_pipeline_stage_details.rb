...
module OCI
  ...
  class Devops::Models::CreateBuildPipelineStageDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::CreateDeliverArtifactStageDetails' if type == 'DELIVER_ARTIFACT'
      return 'OCI::Devops::Models::CreateTriggerDeploymentStageDetails' if type == 'TRIGGER_DEPLOYMENT_PIPELINE'
      return 'OCI::Devops::Models::CreateWaitStageDetails' if type == 'WAIT'
      return 'OCI::Devops::Models::CreateBuildStageDetails' if type == 'BUILD'
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_id, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags].hash
    end
