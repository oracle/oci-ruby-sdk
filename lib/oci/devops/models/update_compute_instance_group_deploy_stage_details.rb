...
module OCI
  ...
  class Devops::Models::UpdateComputeInstanceGroupDeployStageDetails < Devops::Models::UpdateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_stage_predecessor_collection, freeform_tags, defined_tags, compute_instance_group_deploy_environment_id, deployment_spec_deploy_artifact_id, deploy_artifact_ids, rollout_policy, rollback_policy, failure_policy, load_balancer_config].hash
    end
