...
module OCI
  ...
  class Devops::Models::ComputeInstanceGroupBlueGreenTrafficShiftDeployStageExecutionProgress < Devops::Models::DeployStageExecutionProgress
    ...
    def hash
      [deploy_stage_display_name, deploy_stage_type, deploy_stage_id, time_started, time_finished, status, deploy_stage_predecessors, deploy_stage_execution_progress_details, environment_id].hash
    end
