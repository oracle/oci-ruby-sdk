...
module OCI
  ...
  class Devops::Models::UpdateWaitDeployStageDetails < Devops::Models::UpdateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_stage_predecessor_collection, freeform_tags, defined_tags, wait_criteria].hash
    end
