...
module OCI
  ...
  class Devops::Models::CreateTriggerDeploymentStageDetails < Devops::Models::CreateBuildPipelineStageDetails
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_id, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, deploy_pipeline_id, is_pass_all_parameters_enabled].hash
    end
