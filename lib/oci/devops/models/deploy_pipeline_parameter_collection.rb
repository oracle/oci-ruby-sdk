...
module OCI
  ...
  class Devops::Models::DeployPipelineParameterCollection
    # **[Required]** List of parameters defined for a deployment pipeline.
    # @return [Array<OCI::Devops::Models::DeployPipelineParameter>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Devops::Models::DeployPipelineParameter>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Devops::Models::DeployPipelineParameter>] :items The value to assign to the {#items} property
