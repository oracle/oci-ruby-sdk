...
module OCI
  ...
  class Devops::Models::CreateOkeBlueGreenDeployStageDetails < Devops::Models::CreateDeployStageDetails
    ...
    # @return [OCI::Devops::Models::OkeBlueGreenStrategy]
    attr_accessor :blue_green_strategy
    ...
    def self.swagger_types
      {
        ...
        'blue_green_strategy': :'OCI::Devops::Models::OkeBlueGreenStrategy'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Devops::Models::OkeBlueGreenStrategy] :blue_green_strategy The value to assign to the {#blue_green_strategy} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['deployStageType'] = 'OKE_BLUE_GREEN_DEPLOYMENT'
      ...
      self.blue_green_strategy = attributes[:'blueGreenStrategy'] if attributes[:'blueGreenStrategy']

      raise 'You cannot provide both :blueGreenStrategy and :blue_green_strategy' if attributes.key?(:'blueGreenStrategy') && attributes.key?(:'blue_green_strategy')

      self.blue_green_strategy = attributes[:'blue_green_strategy'] if attributes[:'blue_green_strategy']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        blue_green_strategy == other.blue_green_strategy
    end
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, oke_cluster_deploy_environment_id, kubernetes_manifest_deploy_artifact_ids, blue_green_strategy].hash
    end
