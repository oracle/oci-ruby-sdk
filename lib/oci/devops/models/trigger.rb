...
module OCI
  ...
  class Devops::Models::Trigger
    TRIGGER_SOURCE_ENUM = [
      ...
      TRIGGER_SOURCE_GITLAB_SERVER = 'GITLAB_SERVER'.freeze,
      TRIGGER_SOURCE_BITBUCKET_CLOUD = 'BITBUCKET_CLOUD'.freeze,
      TRIGGER_SOURCE_BITBUCKET_SERVER = 'BITBUCKET_SERVER'.freeze,
      TRIGGER_SOURCE_VBS = 'VBS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::VbsTrigger' if type == 'VBS'
      return 'OCI::Devops::Models::BitbucketServerTrigger' if type == 'BITBUCKET_SERVER'
      return 'OCI::Devops::Models::GitlabServerTrigger' if type == 'GITLAB_SERVER'
