...
module OCI
  ...
  class Devops::Models::DiffSection
    # Type of change.
    # @return [String]
    attr_accessor :type
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'type': :'String',
        'lines': :'Array<OCI::Devops::Models::DiffLineDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Devops::Models::DiffLineDetails>] :lines The value to assign to the {#lines} property
