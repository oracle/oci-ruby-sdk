...
module OCI
  ...
  class Devops::Models::CreateBuildStageDetails < Devops::Models::CreateBuildPipelineStageDetails
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_id, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, image, build_spec_file, stage_execution_timeout_in_seconds, build_source_collection, primary_build_source, build_runner_shape_config, private_access_config].hash
    end
