...
module OCI
  ...
  class Devops::Models::ConnectionSummary
    ...
    def hash
      [id, display_name, description, compartment_id, project_id, connection_type, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
