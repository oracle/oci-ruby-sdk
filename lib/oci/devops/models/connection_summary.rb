...
module OCI
  ...
  class Devops::Models::ConnectionSummary
    ...
    # @return [OCI::Devops::Models::ConnectionValidationResult]
    attr_accessor :last_connection_validation_result
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::VbsAccessTokenConnectionSummary' if type == 'VBS_ACCESS_TOKEN'
      ...
      return 'OCI::Devops::Models::BitbucketServerTokenConnectionSummary' if type == 'BITBUCKET_SERVER_ACCESS_TOKEN'
      return 'OCI::Devops::Models::GitlabServerAccessTokenConnectionSummary' if type == 'GITLAB_SERVER_ACCESS_TOKEN'
    ...
    # @option attributes [OCI::Devops::Models::ConnectionValidationResult] :last_connection_validation_result The value to assign to the {#last_connection_validation_result} property
    ...
    def hash
      [id, display_name, description, compartment_id, project_id, connection_type, time_created, time_updated, last_connection_validation_result, lifecycle_details, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
