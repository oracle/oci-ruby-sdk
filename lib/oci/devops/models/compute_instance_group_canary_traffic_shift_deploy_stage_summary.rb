...
module OCI
  ...
  class Devops::Models::ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary < Devops::Models::DeployStageSummary
    # **[Required]** A compute instance group canary stage OCID for load balancer.
    # @return [String]
    attr_accessor :compute_instance_group_canary_deploy_stage_id
    ...
    # @option attributes [String] :compute_instance_group_canary_deploy_stage_id The value to assign to the {#compute_instance_group_canary_deploy_stage_id} property
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'COMPUTE_INSTANCE_GROUP_CANARY_TRAFFIC_SHIFT'
      ...
      self.compute_instance_group_canary_deploy_stage_id = attributes[:'computeInstanceGroupCanaryDeployStageId'] if attributes[:'computeInstanceGroupCanaryDeployStageId']

      raise 'You cannot provide both :computeInstanceGroupCanaryDeployStageId and :compute_instance_group_canary_deploy_stage_id' if attributes.key?(:'computeInstanceGroupCanaryDeployStageId') && attributes.key?(:'compute_instance_group_canary_deploy_stage_id')

      self.compute_instance_group_canary_deploy_stage_id = attributes[:'compute_instance_group_canary_deploy_stage_id'] if attributes[:'compute_instance_group_canary_deploy_stage_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        compute_instance_group_canary_deploy_stage_id == other.compute_instance_group_canary_deploy_stage_id &&
    ...
    def hash
      [id, description, display_name, project_id, deploy_pipeline_id, compartment_id, deploy_stage_type, time_created, time_updated, lifecycle_state, lifecycle_details, deploy_stage_predecessor_collection, freeform_tags, defined_tags, system_tags, compute_instance_group_canary_deploy_stage_id, rollout_policy].hash
    end
