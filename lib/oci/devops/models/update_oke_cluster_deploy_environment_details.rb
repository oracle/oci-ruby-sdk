...
require 'date'
require_relative 'update_deploy_environment_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Specifies the Kubernetes cluster environment.
  class Devops::Models::UpdateOkeClusterDeployEnvironmentDetails < Devops::Models::UpdateDeployEnvironmentDetails
    ...
    # @option attributes [String] :description The value to assign to the {OCI::Devops::Models::UpdateDeployEnvironmentDetails#description #description} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::Devops::Models::UpdateDeployEnvironmentDetails#display_name #display_name} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Devops::Models::UpdateDeployEnvironmentDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Devops::Models::UpdateDeployEnvironmentDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [description, display_name, deploy_environment_type, freeform_tags, defined_tags, cluster_id, network_channel].hash
    end
