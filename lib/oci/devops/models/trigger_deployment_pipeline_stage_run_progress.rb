...
module OCI
  ...
  class Devops::Models::TriggerDeploymentPipelineStageRunProgress < Devops::Models::BuildPipelineStageRunProgress
    ...
    def initialize(attributes = {})
      ...
      self.artifact_override_parameters = attributes[:'artifactOverrideParameters'] if attributes[:'artifactOverrideParameters']
    ...
    def hash
      [stage_display_name, build_pipeline_stage_type, build_pipeline_stage_id, time_started, time_finished, status, build_pipeline_stage_predecessors, exported_variables, artifact_override_parameters, deployment_id].hash
    end
