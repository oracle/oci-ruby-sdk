...
module OCI
  ...
  #
  class Devops::Models::UpdateBitbucketServerAccessTokenConnectionDetails < Devops::Models::UpdateConnectionDetails
    ...
    def hash
      [description, display_name, connection_type, freeform_tags, defined_tags, access_token, base_url, tls_verify_config].hash
    end
