...
module OCI
  ...
  #
  class Devops::Models::CreateBitbucketServerAccessTokenConnectionDetails < Devops::Models::CreateConnectionDetails
    ...
    def hash
      [description, display_name, project_id, connection_type, freeform_tags, defined_tags, access_token, base_url, tls_verify_config].hash
    end
