...
module OCI
  ...
  class Devops::Models::CreateComputeInstanceGroupCanaryApprovalDeployStageDetails < Devops::Models::CreateDeployStageDetails
    # **[Required]** A compute instance group canary traffic shift stage OCID for load balancer.
    # @return [String]
    attr_accessor :compute_instance_group_canary_traffic_shift_deploy_stage_id
    ...
    # @option attributes [String] :compute_instance_group_canary_traffic_shift_deploy_stage_id The value to assign to the {#compute_instance_group_canary_traffic_shift_deploy_stage_id} property
    ...
    def initialize(attributes = {})
      ...
      attributes['deployStageType'] = 'COMPUTE_INSTANCE_GROUP_CANARY_APPROVAL'
      ...
      self.compute_instance_group_canary_traffic_shift_deploy_stage_id = attributes[:'computeInstanceGroupCanaryTrafficShiftDeployStageId'] if attributes[:'computeInstanceGroupCanaryTrafficShiftDeployStageId']

      raise 'You cannot provide both :computeInstanceGroupCanaryTrafficShiftDeployStageId and :compute_instance_group_canary_traffic_shift_deploy_stage_id' if attributes.key?(:'computeInstanceGroupCanaryTrafficShiftDeployStageId') && attributes.key?(:'compute_instance_group_canary_traffic_shift_deploy_stage_id')

      self.compute_instance_group_canary_traffic_shift_deploy_stage_id = attributes[:'compute_instance_group_canary_traffic_shift_deploy_stage_id'] if attributes[:'compute_instance_group_canary_traffic_shift_deploy_stage_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        compute_instance_group_canary_traffic_shift_deploy_stage_id == other.compute_instance_group_canary_traffic_shift_deploy_stage_id &&
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, compute_instance_group_canary_traffic_shift_deploy_stage_id, approval_policy].hash
    end
