...
module OCI
  ...
  class Devops::Models::CreateSingleDeployStageDeploymentDetails < Devops::Models::CreateDeploymentDetails
    ...
    def hash
      [deploy_pipeline_id, deployment_type, display_name, freeform_tags, defined_tags, deploy_stage_id, deployment_arguments, deploy_stage_override_arguments, deploy_artifact_override_arguments].hash
    end
