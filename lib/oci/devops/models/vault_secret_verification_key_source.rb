...
module OCI
  ...
  class Devops::Models::VaultSecretVerificationKeySource < Devops::Models::VerificationKeySource
    ...
    def initialize(attributes = {})
      ...
      attributes['verificationKeySourceType'] = 'VAULT_SECRET'
    ...
    def hash
      [verification_key_source_type, vault_secret_id].hash
    end
