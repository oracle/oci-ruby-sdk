...
module OCI
  ...
  class Devops::Models::UpdateBuildStageDetails < Devops::Models::UpdateBuildPipelineStageDetails
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, image, build_spec_file, stage_execution_timeout_in_seconds, build_source_collection, primary_build_source].hash
    end
