...
module OCI
  ...
  class Devops::Models::OkeBlueGreenTrafficShiftDeployStageSummary < Devops::Models::DeployStageSummary
    # **[Required]** The OCID of the upstream OKE blue-green deployment stage in this pipeline.
    # @return [String]
    attr_accessor :oke_blue_green_deploy_stage_id
    ...
    # @option attributes [String] :oke_blue_green_deploy_stage_id The value to assign to the {#oke_blue_green_deploy_stage_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['deployStageType'] = 'OKE_BLUE_GREEN_TRAFFIC_SHIFT'
      ...
      self.oke_blue_green_deploy_stage_id = attributes[:'okeBlueGreenDeployStageId'] if attributes[:'okeBlueGreenDeployStageId']

      raise 'You cannot provide both :okeBlueGreenDeployStageId and :oke_blue_green_deploy_stage_id' if attributes.key?(:'okeBlueGreenDeployStageId') && attributes.key?(:'oke_blue_green_deploy_stage_id')

      self.oke_blue_green_deploy_stage_id = attributes[:'oke_blue_green_deploy_stage_id'] if attributes[:'oke_blue_green_deploy_stage_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        oke_blue_green_deploy_stage_id == other.oke_blue_green_deploy_stage_id
    end
    ...
    def hash
      [id, description, display_name, project_id, deploy_pipeline_id, compartment_id, deploy_stage_type, time_created, time_updated, lifecycle_state, lifecycle_details, deploy_stage_predecessor_collection, freeform_tags, defined_tags, system_tags, oke_blue_green_deploy_stage_id].hash
    end
