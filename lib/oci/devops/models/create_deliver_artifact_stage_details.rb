...
module OCI
  ...
  class Devops::Models::CreateDeliverArtifactStageDetails < Devops::Models::CreateBuildPipelineStageDetails
    ...
    def hash
      [display_name, description, build_pipeline_stage_type, build_pipeline_id, build_pipeline_stage_predecessor_collection, freeform_tags, defined_tags, deliver_artifact_collection].hash
    end
