...
module OCI
  ...
  class Devops::Models::BuildRunSource
    SOURCE_TYPE_ENUM = [
      ...
      SOURCE_TYPE_GITLAB_SERVER = 'GITLAB_SERVER'.freeze,
      SOURCE_TYPE_BITBUCKET_CLOUD = 'BITBUCKET_CLOUD'.freeze,
      SOURCE_TYPE_BITBUCKET_SERVER = 'BITBUCKET_SERVER'.freeze,
      SOURCE_TYPE_DEVOPS_CODE_REPOSITORY = 'DEVOPS_CODE_REPOSITORY'.freeze,
      SOURCE_TYPE_VBS = 'VBS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::GitlabServerBuildRunSource' if type == 'GITLAB_SERVER'
      return 'OCI::Devops::Models::BitbucketServerBuildRunSource' if type == 'BITBUCKET_SERVER'
      ...
      return 'OCI::Devops::Models::VbsBuildRunSource' if type == 'VBS'
