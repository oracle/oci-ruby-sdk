...
module OCI
  ...
  class Devops::Models::UpdateOkeHelmChartDeployStageDetails < Devops::Models::UpdateDeployStageDetails
    ...
    def purpose=(purpose)
      raise "Invalid value for 'purpose': this must be one of the values in PURPOSE_ENUM." if purpose && !PURPOSE_ENUM.include?(purpose)
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_stage_predecessor_collection, freeform_tags, defined_tags, oke_cluster_deploy_environment_id, helm_chart_deploy_artifact_id, values_artifact_ids, release_name, is_uninstall_on_stage_delete, helm_command_artifact_ids, purpose, namespace, timeout_in_seconds, rollback_policy, set_values, set_string, are_hooks_enabled, should_reuse_values, should_reset_values, is_force_enabled, should_cleanup_on_fail, max_history, should_skip_crds, should_skip_render_subchart_notes, should_not_wait, is_debug_enabled].hash
    end
