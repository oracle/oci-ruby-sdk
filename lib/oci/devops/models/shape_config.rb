...
module OCI
  ...
  class Devops::Models::ShapeConfig
    ...
    def initialize(attributes = {})
      ...
      self.memory_in_gbs = 1.0 if memory_in_gbs.nil? && !attributes.key?(:'memoryInGBs') # rubocop:disable Style/StringLiterals
      ...
      self.memory_in_gbs = 1.0 if memory_in_gbs.nil? && !attributes.key?(:'memoryInGBs') && !attributes.key?(:'memory_in_gbs') # rubocop:disable Style/StringLiterals
    end
