...
module OCI
  ...
  class Devops::Models::BuildPipelineStageRunProgress
    STATUS_ENUM = [
    ...
    # @return [String]
    attr_accessor :stage_display_name
    ...
    # The stage OCID.
    # @return [String]
    attr_accessor :build_pipeline_stage_id
    ...
    attr_accessor :build_pipeline_stage_predecessors
    ...
    # @option attributes [String] :stage_display_name The value to assign to the {#stage_display_name} property
    # @option attributes [String] :build_pipeline_stage_type The value to assign to the {#build_pipeline_stage_type} property
    # @option attributes [String] :build_pipeline_stage_id The value to assign to the {#build_pipeline_stage_id} property
    ...
    # @option attributes [OCI::Devops::Models::BuildPipelineStagePredecessorCollection] :build_pipeline_stage_predecessors The value to assign to the {#build_pipeline_stage_predecessors} property
