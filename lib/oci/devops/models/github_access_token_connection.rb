...
module OCI
  ...
  class Devops::Models::GithubAccessTokenConnection < Devops::Models::Connection
    ...
    def hash
      [id, description, display_name, compartment_id, project_id, connection_type, time_created, time_updated, last_connection_validation_result, lifecycle_details, lifecycle_state, freeform_tags, defined_tags, system_tags, access_token].hash
    end
