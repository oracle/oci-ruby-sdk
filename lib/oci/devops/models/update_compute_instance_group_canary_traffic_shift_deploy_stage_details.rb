...
module OCI
  ...
  class Devops::Models::UpdateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails < Devops::Models::UpdateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_stage_predecessor_collection, freeform_tags, defined_tags, rollout_policy].hash
    end
