...
module OCI
  ...
  class Devops::Models::CreateOkeBlueGreenTrafficShiftDeployStageDetails < Devops::Models::CreateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, oke_blue_green_deploy_stage_id].hash
    end
