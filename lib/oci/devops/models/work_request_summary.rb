...
module OCI
  ...
  class Devops::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Devops::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Devops::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Devops::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
