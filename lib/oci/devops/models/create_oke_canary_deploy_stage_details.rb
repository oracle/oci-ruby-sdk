...
module OCI
  ...
  class Devops::Models::CreateOkeCanaryDeployStageDetails < Devops::Models::CreateDeployStageDetails
    ...
    def hash
      [description, display_name, deploy_stage_type, deploy_pipeline_id, deploy_stage_predecessor_collection, freeform_tags, defined_tags, oke_cluster_deploy_environment_id, kubernetes_manifest_deploy_artifact_ids, canary_strategy].hash
    end
