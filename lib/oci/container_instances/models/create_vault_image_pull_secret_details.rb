...
module OCI
  ...
  # ```
  #
  class ContainerInstances::Models::CreateVaultImagePullSecretDetails < ContainerInstances::Models::CreateImagePullSecretDetails
    ...
    def hash
      [secret_type, registry_endpoint, secret_id].hash
    end
