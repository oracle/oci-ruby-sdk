...
require 'date'
require_relative 'image_pull_secret'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A VaultImagePullSecret is a ImagePullSecret which accepts secretId as credentials information.
  #
  class ContainerInstances::Models::VaultImagePullSecret < ContainerInstances::Models::ImagePullSecret
    ...
    # @option attributes [String] :registry_endpoint The value to assign to the {OCI::ContainerInstances::Models::ImagePullSecret#registry_endpoint #registry_endpoint} proprety
