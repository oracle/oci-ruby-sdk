...
module OCI
  ...
  class ContainerInstances::Models::WorkRequestError
    # **[Required]** A machine-usable code for the error that occured. See [API Errors](https://docs.cloud.oracle.com/Content/API/References/apierrors.htm) for a list of error codes.
    #
    # @return [String]
    attr_accessor :code
