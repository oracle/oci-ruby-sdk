...
module OCI
  ...
  #
  class ContainerInstances::Models::ContainerInstanceShapeSummary
    ...
    # @return [OCI::ContainerInstances::Models::ShapeOcpuOptions]
    attr_accessor :ocpu_options

    # @return [OCI::ContainerInstances::Models::ShapeMemoryOptions]
    attr_accessor :memory_options

    # @return [OCI::ContainerInstances::Models::ShapeNetworkingBandwidthOptions]
    ...
    def self.swagger_types
      {
        ...
        'ocpu_options': :'OCI::ContainerInstances::Models::ShapeOcpuOptions',
        'memory_options': :'OCI::ContainerInstances::Models::ShapeMemoryOptions',
        'networking_bandwidth_options': :'OCI::ContainerInstances::Models::ShapeNetworkingBandwidthOptions'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ContainerInstances::Models::ShapeOcpuOptions] :ocpu_options The value to assign to the {#ocpu_options} property
    # @option attributes [OCI::ContainerInstances::Models::ShapeMemoryOptions] :memory_options The value to assign to the {#memory_options} property
    # @option attributes [OCI::ContainerInstances::Models::ShapeNetworkingBandwidthOptions] :networking_bandwidth_options The value to assign to the {#networking_bandwidth_options} property
    ...
    def hash
      [name, processor_description, ocpu_options, memory_options, networking_bandwidth_options].hash
    end
