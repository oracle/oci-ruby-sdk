...
module OCI
  ...
  class ContainerInstances::Models::CreateContainerHealthCheckDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ContainerInstances::Models::CreateContainerCommandHealthCheckDetails' if type == 'COMMAND'
    ...
    def health_check_type=(health_check_type)
      raise "Invalid value for 'health_check_type': this must be one of the values in HEALTH_CHECK_TYPE_ENUM." if health_check_type && !HEALTH_CHECK_TYPE_ENUM.include?(health_check_type)
    ...
    def failure_action=(failure_action)
      raise "Invalid value for 'failure_action': this must be one of the values in FAILURE_ACTION_ENUM." if failure_action && !FAILURE_ACTION_ENUM.include?(failure_action)
