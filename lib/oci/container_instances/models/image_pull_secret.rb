...
module OCI
  ...
  class ContainerInstances::Models::ImagePullSecret
    SECRET_TYPE_ENUM = [
    ...
    def secret_type=(secret_type)
      ...
      if secret_type && !SECRET_TYPE_ENUM.include?(secret_type)
        OCI.logger.debug("Unknown value for 'secret_type' [" + secret_type + "]. Mapping to 'SECRET_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @secret_type = SECRET_TYPE_UNKNOWN_ENUM_VALUE
      else
