...
module OCI
  ...
  #
  class ContainerInstances::Models::ShapeMemoryOptions
    ...
    #
    # @return [Float]
    attr_accessor :default_per_ocpu_in_gbs
    ...
    # @option attributes [Float] :min_in_gbs The value to assign to the {#min_in_gbs} property
    # @option attributes [Float] :max_in_gbs The value to assign to the {#max_in_gbs} property
    # @option attributes [Float] :default_per_ocpu_in_gbs The value to assign to the {#default_per_ocpu_in_gbs} property
    ...
    def initialize(attributes = {})
      ...
      self.default_per_ocpu_in_gbs = attributes[:'defaultPerOcpuInGBs'] if attributes[:'defaultPerOcpuInGBs']

      raise 'You cannot provide both :defaultPerOcpuInGBs and :default_per_ocpu_in_gbs' if attributes.key?(:'defaultPerOcpuInGBs') && attributes.key?(:'default_per_ocpu_in_gbs')

      self.default_per_ocpu_in_gbs = attributes[:'default_per_ocpu_in_gbs'] if attributes[:'default_per_ocpu_in_gbs']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        default_per_ocpu_in_gbs == other.default_per_ocpu_in_gbs &&
    ...
    def hash
      [min_in_gbs, max_in_gbs, default_per_ocpu_in_gbs, min_per_ocpu_in_gbs, max_per_ocpu_in_gbs].hash
    end
