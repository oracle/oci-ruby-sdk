...
require 'date'
require_relative 'create_image_pull_secret_details'
...
module OCI
  ...
  #
  class ContainerInstances::Models::CreateBasicImagePullSecretDetails < ContainerInstances::Models::CreateImagePullSecretDetails
    ...
    # @option attributes [String] :registry_endpoint The value to assign to the {OCI::ContainerInstances::Models::CreateImagePullSecretDetails#registry_endpoint #registry_endpoint} proprety
    ...
    def hash
      [secret_type, registry_endpoint, username, password].hash
    end
