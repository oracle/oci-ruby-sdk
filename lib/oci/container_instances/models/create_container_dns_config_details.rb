...
module OCI
  ...
  #
  class ContainerInstances::Models::CreateContainerDnsConfigDetails
    ...
    # @option attributes [Array<String>] :nameservers The value to assign to the {#nameservers} property
    # @option attributes [Array<String>] :searches The value to assign to the {#searches} property
