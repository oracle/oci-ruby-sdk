...
module OCI
  ...
  #
  class ContainerInstances::Models::CreateContainerResourceConfigDetails
    ...
    #
    # @return [Float]
    attr_accessor :memory_limit_in_gbs
    ...
    # @option attributes [Float] :vcpus_limit The value to assign to the {#vcpus_limit} property
    # @option attributes [Float] :memory_limit_in_gbs The value to assign to the {#memory_limit_in_gbs} property
