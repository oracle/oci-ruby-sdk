...
module OCI
  ...
  class ContainerInstances::Models::CreateContainerVolumeDetails
    VOLUME_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ContainerInstances::Models::CreateContainerConfigFileVolumeDetails' if type == 'CONFIGFILE'
      return 'OCI::ContainerInstances::Models::CreateContainerEmptyDirVolumeDetails' if type == 'EMPTYDIR'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ContainerInstances::Models::CreateContainerVolumeDetails'
    end
    ...
    def initialize(attributes = {})
      ...
      self.volume_type = "null" if volume_type.nil? && !attributes.key?(:'volumeType') # rubocop:disable Style/StringLiterals
      ...
      self.volume_type = "null" if volume_type.nil? && !attributes.key?(:'volumeType') && !attributes.key?(:'volume_type') # rubocop:disable Style/StringLiterals
    end
    ...
    def volume_type=(volume_type)
      raise "Invalid value for 'volume_type': this must be one of the values in VOLUME_TYPE_ENUM." if volume_type && !VOLUME_TYPE_ENUM.include?(volume_type)
