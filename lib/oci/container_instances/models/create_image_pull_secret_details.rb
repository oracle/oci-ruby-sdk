...
module OCI
  ...
  class ContainerInstances::Models::CreateImagePullSecretDetails
    SECRET_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :registry_endpoint
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ContainerInstances::Models::CreateVaultImagePullSecretDetails' if type == 'VAULT'
      return 'OCI::ContainerInstances::Models::CreateBasicImagePullSecretDetails' if type == 'BASIC'

      # TODO: Log a warning when the subtype is not found.
      'OCI::ContainerInstances::Models::CreateImagePullSecretDetails'
    end
    ...
    # @option attributes [String] :secret_type The value to assign to the {#secret_type} property
    # @option attributes [String] :registry_endpoint The value to assign to the {#registry_endpoint} property
    ...
    # @param [Object] secret_type Object to be assigned
    def secret_type=(secret_type)
      raise "Invalid value for 'secret_type': this must be one of the values in SECRET_TYPE_ENUM." if secret_type && !SECRET_TYPE_ENUM.include?(secret_type)
