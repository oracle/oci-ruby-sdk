...
require 'date'
require_relative 'create_security_context_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Security context for Linux container.
  class ContainerInstances::Models::CreateLinuxSecurityContextDetails < ContainerInstances::Models::CreateSecurityContextDetails
    ...
    def initialize(attributes = {})
      ...
      self.is_non_root_user_check_enabled = false if is_non_root_user_check_enabled.nil? && !attributes.key?(:'isNonRootUserCheckEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_non_root_user_check_enabled = false if is_non_root_user_check_enabled.nil? && !attributes.key?(:'isNonRootUserCheckEnabled') && !attributes.key?(:'is_non_root_user_check_enabled') # rubocop:disable Style/StringLiterals

      self.is_root_file_system_readonly = attributes[:'isRootFileSystemReadonly'] unless attributes[:'isRootFileSystemReadonly'].nil?
      self.is_root_file_system_readonly = false if is_root_file_system_readonly.nil? && !attributes.key?(:'isRootFileSystemReadonly') # rubocop:disable Style/StringLiterals
      ...
      self.is_root_file_system_readonly = false if is_root_file_system_readonly.nil? && !attributes.key?(:'isRootFileSystemReadonly') && !attributes.key?(:'is_root_file_system_readonly') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [security_context_type, run_as_user, run_as_group, is_non_root_user_check_enabled, is_root_file_system_readonly].hash
    end
