...
module OCI
  ...
  #
  class DatabaseMigration::Models::DbLinkDataTransferMediumDetails < DatabaseMigration::Models::DataTransferMediumDetailsV2
    ...
    def hash
      [type, object_storage_bucket, name].hash
    end
