...
module OCI
  ...
  #
  class DatabaseMigration::Models::MigrationJobProgressResource
    CURRENT_STATUS_ENUM = [
    ...
    #
    # @return [Array<OCI::DatabaseMigration::Models::PhaseStatus>]
    ...
    # @option attributes [Array<OCI::DatabaseMigration::Models::PhaseStatus>] :phases The value to assign to the {#phases} property
