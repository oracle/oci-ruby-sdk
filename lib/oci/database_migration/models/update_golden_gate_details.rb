...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateGoldenGateDetails
    # @return [OCI::DatabaseMigration::Models::UpdateGoldenGateHub]
    attr_accessor :hub
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'hub': :'OCI::DatabaseMigration::Models::UpdateGoldenGateHub',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::UpdateGoldenGateHub] :hub The value to assign to the {#hub} property
