...
module OCI
  ...
  #
  class DatabaseMigration::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CLONE_MIGRATION = 'CLONE_MIGRATION'.freeze,
      OPERATION_TYPE_DELETE_MIGRATION = 'DELETE_MIGRATION'.freeze,
      OPERATION_TYPE_UPDATE_MIGRATION = 'UPDATE_MIGRATION'.freeze,
      OPERATION_TYPE_START_MIGRATION = 'START_MIGRATION'.freeze,
      OPERATION_TYPE_VALIDATE_MIGRATION = 'VALIDATE_MIGRATION'.freeze,
    ...
    #
    # @return [Array<OCI::DatabaseMigration::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::DatabaseMigration::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::DatabaseMigration::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
