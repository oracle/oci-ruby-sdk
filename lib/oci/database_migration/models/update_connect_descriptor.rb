...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateConnectDescriptor
    ...
    # @option attributes [String] :database_service_name The value to assign to the {#database_service_name} property
    # @option attributes [String] :connect_string The value to assign to the {#connect_string} property
