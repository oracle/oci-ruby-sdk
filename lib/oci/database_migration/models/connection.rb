...
module OCI
  ...
  class DatabaseMigration::Models::Connection
    ...
    # @option attributes [OCI::DatabaseMigration::Models::AdminCredentials] :replication_credentials The value to assign to the {#replication_credentials} property
    ...
    def hash
      [id, compartment_id, database_type, manual_database_sub_type, is_dedicated, display_name, database_id, connect_descriptor, credentials_secret_id, certificate_tdn, ssh_details, admin_credentials, replication_credentials, private_endpoint, vault_details, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags, nsg_ids].hash
    end
