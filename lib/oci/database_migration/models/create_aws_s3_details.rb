...
module OCI
  ...
  #
  class DatabaseMigration::Models::CreateAwsS3Details
    # **[Required]** S3 bucket name.
    #
    # @return [String]
    attr_accessor :name

    # **[Required]** AWS region code where the S3 bucket is located.
