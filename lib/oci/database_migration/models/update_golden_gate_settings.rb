...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateGoldenGateSettings
    # @return [OCI::DatabaseMigration::Models::UpdateExtract]
    attr_accessor :extract

    # @return [OCI::DatabaseMigration::Models::UpdateReplicat]
    ...
    # @option attributes [OCI::DatabaseMigration::Models::UpdateExtract] :extract The value to assign to the {#extract} property
    # @option attributes [OCI::DatabaseMigration::Models::UpdateReplicat] :replicat The value to assign to the {#replicat} property
