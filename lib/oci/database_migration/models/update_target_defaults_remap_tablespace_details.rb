...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateTargetDefaultsRemapTablespaceDetails < DatabaseMigration::Models::UpdateTargetTypeTablespaceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['targetType'] = 'TARGET_DEFAULTS_REMAP'
