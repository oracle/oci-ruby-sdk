...
module OCI
  ...
  class DatabaseMigration::Models::HostDumpTransferDetails
    KIND_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::OciCliDumpTransferDetails' if type == 'OCI_CLI'
      return 'OCI::DatabaseMigration::Models::CurlTransferDetails' if type == 'CURL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseMigration::Models::HostDumpTransferDetails'
    end
