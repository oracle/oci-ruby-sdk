...
module OCI
  ...
  #
  class DatabaseMigration::Models::CreateGoldenGateHub
    ...
    # **[Required]** Name of GoldenGate Microservices deployment to operate on source database
    #
    # @return [String]
    attr_accessor :source_microservices_deployment_name

    # **[Required]** Name of GoldenGate Microservices deployment to operate on target database
    #
    # @return [String]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'rest_admin_credentials': :'OCI::DatabaseMigration::Models::CreateAdminCredentials',
        'source_db_admin_credentials': :'OCI::DatabaseMigration::Models::CreateAdminCredentials',
        'source_container_db_admin_credentials': :'OCI::DatabaseMigration::Models::CreateAdminCredentials',
        'target_db_admin_credentials': :'OCI::DatabaseMigration::Models::CreateAdminCredentials',
        'url': :'String',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateAdminCredentials] :rest_admin_credentials The value to assign to the {#rest_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateAdminCredentials] :source_db_admin_credentials The value to assign to the {#source_db_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateAdminCredentials] :source_container_db_admin_credentials The value to assign to the {#source_container_db_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateAdminCredentials] :target_db_admin_credentials The value to assign to the {#target_db_admin_credentials} property
