...
module OCI
  ...
  #
  class DatabaseMigration::Models::WorkRequestSummary
    STATUS_ENUM = [
    ...
    def hash
      [operation_type, status, id, compartment_id, percent_complete, time_accepted, time_started, time_finished].hash
    end
