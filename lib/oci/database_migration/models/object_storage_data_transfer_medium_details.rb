...
module OCI
  ...
  #
  class DatabaseMigration::Models::ObjectStorageDataTransferMediumDetails < DatabaseMigration::Models::DataTransferMediumDetailsV2
    ...
    def hash
      [type, object_storage_bucket].hash
    end
