...
module OCI
  ...
  class DatabaseMigration::Models::UpdateADBDedicatedAutoCreateTablespaceDetails < DatabaseMigration::Models::UpdateTargetTypeTablespaceDetails
    ...
    def block_size_in_kbs=(block_size_in_kbs)
      raise "Invalid value for 'block_size_in_kbs': this must be one of the values in BLOCK_SIZE_IN_KBS_ENUM." if block_size_in_kbs && !BLOCK_SIZE_IN_KBS_ENUM.include?(block_size_in_kbs)
