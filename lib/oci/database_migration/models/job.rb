...
module OCI
  ...
  #
  class DatabaseMigration::Models::Job
    TYPE_ENUM = [
      TYPE_EVALUATION = 'EVALUATION'.freeze,
      TYPE_MIGRATION = 'MIGRATION'.freeze,
    ...
    # @return [OCI::DatabaseMigration::Models::MigrationJobProgressResource]
    attr_accessor :progress

    # Database objects not supported.
    #
    # @return [Array<OCI::DatabaseMigration::Models::UnsupportedDatabaseObject>]
    attr_accessor :unsupported_objects
    ...
    def self.swagger_types
      {
        ...
        'progress': :'OCI::DatabaseMigration::Models::MigrationJobProgressResource',
        'unsupported_objects': :'Array<OCI::DatabaseMigration::Models::UnsupportedDatabaseObject>',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::MigrationJobProgressResource] :progress The value to assign to the {#progress} property
    # @option attributes [Array<OCI::DatabaseMigration::Models::UnsupportedDatabaseObject>] :unsupported_objects The value to assign to the {#unsupported_objects} property
    ...
    def initialize(attributes = {})
      ...
      self.unsupported_objects = attributes[:'unsupportedObjects'] if attributes[:'unsupportedObjects']

      raise 'You cannot provide both :unsupportedObjects and :unsupported_objects' if attributes.key?(:'unsupportedObjects') && attributes.key?(:'unsupported_objects')

      self.unsupported_objects = attributes[:'unsupported_objects'] if attributes[:'unsupported_objects']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        unsupported_objects == other.unsupported_objects &&
    ...
    def hash
      [id, display_name, migration_id, type, time_created, time_updated, progress, unsupported_objects, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
