...
module OCI
  # Job description
  #
  class DatabaseMigration::Models::JobSummary
    TYPE_ENUM = [
    ...
    # @return [OCI::DatabaseMigration::Models::MigrationJobProgressSummary]
    ...
    def self.swagger_types
      {
        ...
        'migration_id': :'String',
        'type': :'String',
        'progress': :'OCI::DatabaseMigration::Models::MigrationJobProgressSummary',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::MigrationJobProgressSummary] :progress The value to assign to the {#progress} property
    ...
    def hash
      [id, display_name, migration_id, type, progress, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
