...
module OCI
  ...
  class DatabaseMigration::Models::ADBDedicatedAutoCreateTablespaceDetails < DatabaseMigration::Models::TargetTypeTablespaceDetails
    BLOCK_SIZE_IN_KBS_ENUM = [
      BLOCK_SIZE_IN_KBS_SIZE_8_K = 'SIZE_8K'.freeze,
      BLOCK_SIZE_IN_KBS_SIZE_16_K = 'SIZE_16K'.freeze,
      BLOCK_SIZE_IN_KBS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :block_size_in_kbs The value to assign to the {#block_size_in_kbs} property
    def initialize(attributes = {})
      ...
      self.block_size_in_kbs = attributes[:'blockSizeInKBs'] if attributes[:'blockSizeInKBs']
      self.block_size_in_kbs = "SIZE_8K" if block_size_in_kbs.nil? && !attributes.key?(:'blockSizeInKBs') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :blockSizeInKBs and :block_size_in_kbs' if attributes.key?(:'blockSizeInKBs') && attributes.key?(:'block_size_in_kbs')

      self.block_size_in_kbs = attributes[:'block_size_in_kbs'] if attributes[:'block_size_in_kbs']
      self.block_size_in_kbs = "SIZE_8K" if block_size_in_kbs.nil? && !attributes.key?(:'blockSizeInKBs') && !attributes.key?(:'block_size_in_kbs') # rubocop:disable Style/StringLiterals
    end
    # rubocop:enable Metrics/CyclomaticComplexity, Metrics/AbcSize, Metrics/PerceivedComplexity
    # rubocop:enable Metrics/MethodLength, Layout/EmptyLines, Style/SymbolLiteral

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] block_size_in_kbs Object to be assigned
    def block_size_in_kbs=(block_size_in_kbs)
      # rubocop:disable Style/ConditionalAssignment
      if block_size_in_kbs && !BLOCK_SIZE_IN_KBS_ENUM.include?(block_size_in_kbs)
        OCI.logger.debug("Unknown value for 'block_size_in_kbs' [" + block_size_in_kbs + "]. Mapping to 'BLOCK_SIZE_IN_KBS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @block_size_in_kbs = BLOCK_SIZE_IN_KBS_UNKNOWN_ENUM_VALUE
      else
        @block_size_in_kbs = block_size_in_kbs
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        block_size_in_kbs == other.block_size_in_kbs
    end
    ...
    def hash
      [target_type, is_auto_create, is_big_file, extend_size_in_mbs, block_size_in_kbs].hash
    end
