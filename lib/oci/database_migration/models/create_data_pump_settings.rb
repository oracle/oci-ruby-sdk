...
module OCI
  ...
  #
  class DatabaseMigration::Models::CreateDataPumpSettings
    JOB_MODE_ENUM = [
    ...
    # @return [OCI::DatabaseMigration::Models::CreateDataPumpParameters]
    ...
    # @return [OCI::DatabaseMigration::Models::CreateTargetTypeTablespaceDetails]
    attr_accessor :tablespace_details

    # @return [OCI::DatabaseMigration::Models::CreateDirectoryObject]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'job_mode': :'String',
        'data_pump_parameters': :'OCI::DatabaseMigration::Models::CreateDataPumpParameters',
        'metadata_remaps': :'Array<OCI::DatabaseMigration::Models::MetadataRemap>',
        'tablespace_details': :'OCI::DatabaseMigration::Models::CreateTargetTypeTablespaceDetails',
        'export_directory_object': :'OCI::DatabaseMigration::Models::CreateDirectoryObject',
        'import_directory_object': :'OCI::DatabaseMigration::Models::CreateDirectoryObject'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateDataPumpParameters] :data_pump_parameters The value to assign to the {#data_pump_parameters} property
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateTargetTypeTablespaceDetails] :tablespace_details The value to assign to the {#tablespace_details} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateDirectoryObject] :export_directory_object The value to assign to the {#export_directory_object} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateDirectoryObject] :import_directory_object The value to assign to the {#import_directory_object} property
