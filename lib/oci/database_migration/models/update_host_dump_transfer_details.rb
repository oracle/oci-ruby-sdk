...
module OCI
  ...
  class DatabaseMigration::Models::UpdateHostDumpTransferDetails
    KIND_ENUM = [
      KIND_CURL = 'CURL'.freeze,
      KIND_OCI_CLI = 'OCI_CLI'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::UpdateCurlTransferDetails' if type == 'CURL'
      return 'OCI::DatabaseMigration::Models::UpdateOciCliDumpTransferDetails' if type == 'OCI_CLI'
    ...
    def initialize(attributes = {})
      ...
      self.kind = "CURL" if kind.nil? && !attributes.key?(:'kind') # rubocop:disable Style/StringLiterals
    end
