...
module OCI
  # ODMS Agent Details
  #
  class DatabaseMigration::Models::AgentSummary
    ...
    def hash
      [id, display_name, compartment_id, stream_id, version, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
