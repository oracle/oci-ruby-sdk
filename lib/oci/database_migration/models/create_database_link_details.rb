...
module OCI
  ...
  #
  class DatabaseMigration::Models::CreateDatabaseLinkDetails
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'wallet_bucket': :'OCI::DatabaseMigration::Models::CreateObjectStoreBucket'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateObjectStoreBucket] :wallet_bucket The value to assign to the {#wallet_bucket} property
