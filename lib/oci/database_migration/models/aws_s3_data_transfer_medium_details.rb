...
require 'date'
require_relative 'data_transfer_medium_details_v2'
...
module OCI
  ...
  #
  class DatabaseMigration::Models::AwsS3DataTransferMediumDetails < DatabaseMigration::Models::DataTransferMediumDetailsV2
    # S3 bucket name.
    #
    # @return [String]
    attr_accessor :name
    ...
    # @option attributes [OCI::DatabaseMigration::Models::ObjectStoreBucket] :object_storage_bucket The value to assign to the {#object_storage_bucket} property
    ...
    def hash
      [type, name, region, access_key_id, secret_access_key, object_storage_bucket].hash
    end
