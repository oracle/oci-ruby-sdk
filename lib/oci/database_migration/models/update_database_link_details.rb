...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateDatabaseLinkDetails
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'wallet_bucket': :'OCI::DatabaseMigration::Models::UpdateObjectStoreBucket'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseMigration::Models::UpdateObjectStoreBucket] :wallet_bucket The value to assign to the {#wallet_bucket} property
