...
module OCI
  # ODMS Agent Details
  #
  class DatabaseMigration::Models::Agent
    ...
    def hash
      [id, display_name, compartment_id, stream_id, public_key, version, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
