...
module OCI
  ...
  #
  class DatabaseMigration::Models::MigrationObjectSummary
    OBJECT_STATUS_ENUM = [
      OBJECT_STATUS_EXCLUDE = 'EXCLUDE'.freeze,
      OBJECT_STATUS_INCLUDE = 'INCLUDE'.freeze,
      OBJECT_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :object_status The value to assign to the {#object_status} property
    ...
    # @param [Object] object_status Object to be assigned
    def object_status=(object_status)
      # rubocop:disable Style/ConditionalAssignment
      if object_status && !OBJECT_STATUS_ENUM.include?(object_status)
        OCI.logger.debug("Unknown value for 'object_status' [" + object_status + "]. Mapping to 'OBJECT_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @object_status = OBJECT_STATUS_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [owner, object_name, type, object_status].hash
    end
