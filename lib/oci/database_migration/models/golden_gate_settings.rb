...
module OCI
  ...
  #
  class DatabaseMigration::Models::GoldenGateSettings
    # @return [OCI::DatabaseMigration::Models::Extract]
    attr_accessor :extract

    # @return [OCI::DatabaseMigration::Models::Replicat]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'extract': :'OCI::DatabaseMigration::Models::Extract',
        'replicat': :'OCI::DatabaseMigration::Models::Replicat',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::Extract] :extract The value to assign to the {#extract} property
    # @option attributes [OCI::DatabaseMigration::Models::Replicat] :replicat The value to assign to the {#replicat} property
