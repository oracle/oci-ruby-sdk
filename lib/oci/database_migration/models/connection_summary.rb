...
module OCI
  ...
  #
  class DatabaseMigration::Models::ConnectionSummary
    DATABASE_TYPE_ENUM = [
    ...
    def hash
      [id, compartment_id, database_type, manual_database_sub_type, is_dedicated, display_name, database_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
