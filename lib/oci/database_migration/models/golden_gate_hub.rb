...
module OCI
  ...
  #
  class DatabaseMigration::Models::GoldenGateHub
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'rest_admin_credentials': :'OCI::DatabaseMigration::Models::AdminCredentials',
        'source_db_admin_credentials': :'OCI::DatabaseMigration::Models::AdminCredentials',
        'source_container_db_admin_credentials': :'OCI::DatabaseMigration::Models::AdminCredentials',
        'target_db_admin_credentials': :'OCI::DatabaseMigration::Models::AdminCredentials',
        'url': :'String',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::AdminCredentials] :rest_admin_credentials The value to assign to the {#rest_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::AdminCredentials] :source_db_admin_credentials The value to assign to the {#source_db_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::AdminCredentials] :source_container_db_admin_credentials The value to assign to the {#source_container_db_admin_credentials} property
    # @option attributes [OCI::DatabaseMigration::Models::AdminCredentials] :target_db_admin_credentials The value to assign to the {#target_db_admin_credentials} property
