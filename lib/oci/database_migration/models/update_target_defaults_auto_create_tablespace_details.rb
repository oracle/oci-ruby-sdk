...
module OCI
  ...
  #
  class DatabaseMigration::Models::UpdateTargetDefaultsAutoCreateTablespaceDetails < DatabaseMigration::Models::UpdateTargetTypeTablespaceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['targetType'] = 'TARGET_DEFAULTS_AUTOCREATE'
