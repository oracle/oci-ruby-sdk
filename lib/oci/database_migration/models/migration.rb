...
module OCI
  ...
  class DatabaseMigration::Models::Migration
    ...
    # @return [OCI::DatabaseMigration::Models::GoldenGateServiceDetails]
    ...
    def self.swagger_types
      {
        ...
        'golden_gate_service_details': :'OCI::DatabaseMigration::Models::GoldenGateServiceDetails',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::GoldenGateServiceDetails] :golden_gate_service_details The value to assign to the {#golden_gate_service_details} property
    ...
    def hash
      [id, display_name, compartment_id, type, wait_after, agent_id, credentials_secret_id, source_database_connection_id, source_container_database_connection_id, target_database_connection_id, executing_job_id, data_transfer_medium_details_v2, data_transfer_medium_details, dump_transfer_details, datapump_settings, advisor_settings, exclude_objects, include_objects, golden_gate_service_details, golden_gate_details, vault_details, time_created, time_updated, time_last_migration, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
