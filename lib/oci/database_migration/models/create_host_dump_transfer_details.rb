...
module OCI
  ...
  class DatabaseMigration::Models::CreateHostDumpTransferDetails
    KIND_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::CreateOciCliDumpTransferDetails' if type == 'OCI_CLI'
      return 'OCI::DatabaseMigration::Models::CreateCurlTransferDetails' if type == 'CURL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseMigration::Models::CreateHostDumpTransferDetails'
    end
