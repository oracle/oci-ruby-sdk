...
module OCI
  ...
  #
  class DatabaseMigration::Models::StartMigrationDetails
    WAIT_AFTER_ENUM = [
    ...
    def wait_after=(wait_after)
      raise "Invalid value for 'wait_after': this must be one of the values in WAIT_AFTER_ENUM." if wait_after && !WAIT_AFTER_ENUM.include?(wait_after)
