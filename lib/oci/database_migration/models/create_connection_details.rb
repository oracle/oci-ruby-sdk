...
module OCI
  ...
  class DatabaseMigration::Models::CreateConnectionDetails
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateAdminCredentials] :replication_credentials The value to assign to the {#replication_credentials} property
