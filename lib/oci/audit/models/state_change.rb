...
module OCI
  ...
  class Audit::Models::StateChange
    ...
    # @option attributes [Hash<String, Object>] :previous The value to assign to the {#previous} property
    # @option attributes [Hash<String, Object>] :current The value to assign to the {#current} property
    def initialize(attributes = {})
      ...
      self.previous = attributes[:'previous'] if attributes[:'previous']
