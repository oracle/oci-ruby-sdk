...
module OCI
  ...
  class Dts::Models::NewTransferDevice
    ...
    # @return [String]
    attr_accessor :encryption_passphrase
    ...
    # @option attributes [String] :encryption_passphrase The value to assign to the {#encryption_passphrase} property
    ...
    def initialize(attributes = {})
      ...
      self.encryption_passphrase = attributes[:'encryptionPassphrase'] if attributes[:'encryptionPassphrase']

      raise 'You cannot provide both :encryptionPassphrase and :encryption_passphrase' if attributes.key?(:'encryptionPassphrase') && attributes.key?(:'encryption_passphrase')

      self.encryption_passphrase = attributes[:'encryption_passphrase'] if attributes[:'encryption_passphrase']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        encryption_passphrase == other.encryption_passphrase &&
    ...
    def hash
      [label, serial_number, iscsi_iqn, lifecycle_state, encryption_passphrase, transfer_job_id, creation_time].hash
    end
