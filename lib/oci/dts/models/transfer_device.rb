...
module OCI
  ...
  class Dts::Models::TransferDevice
    ...
    def hash
      [serial_number, iscsi_iqn, label, lifecycle_state, transfer_job_id, attached_transfer_package_label, creation_time, upload_status_log_uri].hash
    end
