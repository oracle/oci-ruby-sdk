...
module OCI
  ...
  class Dts::Models::CreateTransferPackageDetails
    # @return [String]
    ...
    def hash
      [original_package_delivery_tracking_number, return_package_delivery_tracking_number, package_delivery_vendor].hash
    end
