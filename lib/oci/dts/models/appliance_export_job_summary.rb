...
module OCI
  ...
  class Dts::Models::ApplianceExportJobSummary
    ...
    def hash
      [id, bucket_name, display_name, creation_time, lifecycle_state, lifecycle_state_details, freeform_tags, defined_tags].hash
    end
