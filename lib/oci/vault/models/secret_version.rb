...
module OCI
  ...
  class Vault::Models::SecretVersion
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_content_auto_generated
    ...
    # @option attributes [BOOLEAN] :is_content_auto_generated The value to assign to the {#is_content_auto_generated} property
    def initialize(attributes = {})
      ...
      self.is_content_auto_generated = attributes[:'isContentAutoGenerated'] unless attributes[:'isContentAutoGenerated'].nil?

      raise 'You cannot provide both :isContentAutoGenerated and :is_content_auto_generated' if attributes.key?(:'isContentAutoGenerated') && attributes.key?(:'is_content_auto_generated')

      self.is_content_auto_generated = attributes[:'is_content_auto_generated'] unless attributes[:'is_content_auto_generated'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_content_auto_generated == other.is_content_auto_generated
    end
    ...
    def hash
      [content_type, name, secret_id, stages, time_created, time_of_deletion, time_of_current_version_expiry, version_number, is_content_auto_generated].hash
    end
