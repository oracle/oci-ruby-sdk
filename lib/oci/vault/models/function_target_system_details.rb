...
module OCI
  ...
  #
  class Vault::Models::FunctionTargetSystemDetails < Vault::Models::TargetSystemDetails
    # **[Required]** The unique identifier (OCID) of the OCI Functions that vault secret connects to.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['targetSystemType'] = 'FUNCTION'
    ...
    def hash
      [target_system_type, function_id].hash
    end
