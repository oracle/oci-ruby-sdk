...
module OCI
  ...
  class Vault::Models::SecretSummary
    ...
    def hash
      [compartment_id, defined_tags, description, freeform_tags, system_tags, key_id, id, lifecycle_details, lifecycle_state, rotation_config, rotation_status, last_rotation_time, next_rotation_time, secret_name, time_created, time_of_current_version_expiry, time_of_deletion, vault_id, secret_generation_context, is_auto_generation_enabled].hash
    end
