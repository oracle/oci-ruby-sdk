...
module OCI
  ...
  class Vault::Models::SecretRule
    RULE_TYPE_ENUM = [
      RULE_TYPE_SECRET_EXPIRY_RULE = 'SECRET_EXPIRY_RULE'.freeze,
      RULE_TYPE_SECRET_REUSE_RULE = 'SECRET_REUSE_RULE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Vault::Models::SecretExpiryRule' if type == 'SECRET_EXPIRY_RULE'
      return 'OCI::Vault::Models::SecretReuseRule' if type == 'SECRET_REUSE_RULE'
