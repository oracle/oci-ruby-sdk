...
module OCI
  ...
  #
  class Vault::Models::PassphraseGenerationContext < Vault::Models::SecretGenerationContext
    ...
    # @return [Integer]
    attr_accessor :passphrase_length
    ...
    # @option attributes [Integer] :passphrase_length The value to assign to the {#passphrase_length} property
