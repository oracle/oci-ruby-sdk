...
module OCI
  ...
  class Vault::Models::CreateSecretDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :enable_auto_generation
    ...
    # @option attributes [BOOLEAN] :enable_auto_generation The value to assign to the {#enable_auto_generation} property
    ...
    def hash
      [compartment_id, defined_tags, description, freeform_tags, key_id, metadata, secret_content, rotation_config, secret_name, secret_rules, vault_id, secret_generation_context, enable_auto_generation].hash
    end
