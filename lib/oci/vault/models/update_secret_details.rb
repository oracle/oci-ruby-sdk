...
module OCI
  ...
  class Vault::Models::UpdateSecretDetails
    ...
    def hash
      [current_version_number, defined_tags, description, freeform_tags, metadata, secret_content, rotation_config, secret_rules, secret_generation_context, enable_auto_generation].hash
    end
