...
module OCI
  ...
  class Vault::VaultsClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/vault/cancel_secret_rotation.rb.html) to see an example of how to use cancel_secret_rotation API.
    def cancel_secret_rotation(secret_id, opts = {})
      logger.debug 'Calling operation VaultsClient#cancel_secret_rotation.' if logger

      raise "Missing the required parameter 'secret_id' when calling cancel_secret_rotation." if secret_id.nil?
      raise "Parameter value for 'secret_id' must not be blank" if OCI::Internal::Util.blank_string?(secret_id)

      path = '/secrets/{secretId}/actions/cancelRotation'.sub('{secretId}', secret_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'VaultsClient#cancel_secret_rotation') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/vault/rotate_secret.rb.html) to see an example of how to use rotate_secret API.
    def rotate_secret(secret_id, opts = {})
      logger.debug 'Calling operation VaultsClient#rotate_secret.' if logger

      raise "Missing the required parameter 'secret_id' when calling rotate_secret." if secret_id.nil?
      raise "Parameter value for 'secret_id' must not be blank" if OCI::Internal::Util.blank_string?(secret_id)

      path = '/secrets/{secretId}/actions/rotate'.sub('{secretId}', secret_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'VaultsClient#rotate_secret') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
