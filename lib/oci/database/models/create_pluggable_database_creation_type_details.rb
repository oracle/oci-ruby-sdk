...
module OCI
  ...
  class Database::Models::CreatePluggableDatabaseCreationTypeDetails
    CREATION_TYPE_ENUM = [
      CREATION_TYPE_LOCAL_CLONE_PDB = 'LOCAL_CLONE_PDB'.freeze,
      CREATION_TYPE_REMOTE_CLONE_PDB = 'REMOTE_CLONE_PDB'.freeze,
      CREATION_TYPE_RELOCATE_PDB = 'RELOCATE_PDB'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::CreatePluggableDatabaseFromRelocateDetails' if type == 'RELOCATE_PDB'
      return 'OCI::Database::Models::CreatePluggableDatabaseFromRemoteCloneDetails' if type == 'REMOTE_CLONE_PDB'
      return 'OCI::Database::Models::CreatePluggableDatabaseFromLocalCloneDetails' if type == 'LOCAL_CLONE_PDB'
