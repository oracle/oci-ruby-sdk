...
module OCI
  ...
  #
  class Database::Models::CreateExternalPluggableDatabaseDetails
    ...
    def hash
      [source_id, external_container_database_id, compartment_id, display_name, freeform_tags, defined_tags].hash
    end
