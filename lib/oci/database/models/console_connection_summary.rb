...
module OCI
  ...
  class Database::Models::ConsoleConnectionSummary
    ...
    def hash
      [id, compartment_id, db_node_id, connection_string, fingerprint, service_host_key_fingerprint, freeform_tags, defined_tags, lifecycle_details, lifecycle_state].hash
    end
