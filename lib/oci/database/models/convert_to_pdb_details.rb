...
module OCI
  ...
  #
  class Database::Models::ConvertToPdbDetails
    ACTION_ENUM = [
    ...
    # @return [OCI::Database::Models::ConvertToPdbTargetBase]
    attr_accessor :convert_to_pdb_target_details
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'action': :'String',
        'convert_to_pdb_target_details': :'OCI::Database::Models::ConvertToPdbTargetBase'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Database::Models::ConvertToPdbTargetBase] :convert_to_pdb_target_details The value to assign to the {#convert_to_pdb_target_details} property
    def initialize(attributes = {})
      ...
      self.convert_to_pdb_target_details = attributes[:'convertToPdbTargetDetails'] if attributes[:'convertToPdbTargetDetails']

      raise 'You cannot provide both :convertToPdbTargetDetails and :convert_to_pdb_target_details' if attributes.key?(:'convertToPdbTargetDetails') && attributes.key?(:'convert_to_pdb_target_details')

      self.convert_to_pdb_target_details = attributes[:'convert_to_pdb_target_details'] if attributes[:'convert_to_pdb_target_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        action == other.action &&
        convert_to_pdb_target_details == other.convert_to_pdb_target_details
    end
    ...
    def hash
      [action, convert_to_pdb_target_details].hash
    end
