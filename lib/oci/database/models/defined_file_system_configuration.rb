...
module OCI
  ...
  class Database::Models::DefinedFileSystemConfiguration
    ...
    # @option attributes [Integer] :min_size_gb The value to assign to the {#min_size_gb} property
    # @option attributes [BOOLEAN] :is_resizable The value to assign to the {#is_resizable} property
    # @option attributes [BOOLEAN] :is_backup_partition The value to assign to the {#is_backup_partition} property
