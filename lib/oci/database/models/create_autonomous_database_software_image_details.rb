...
module OCI
  ...
  #
  class Database::Models::CreateAutonomousDatabaseSoftwareImageDetails
    ...
    # **[Required]** The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) from which to create Autonomous Database Software Image.
    # @return [String]
    attr_accessor :source_cdb_id
    ...
    # @option attributes [String] :source_cdb_id The value to assign to the {#source_cdb_id} property
    ...
    def initialize(attributes = {})
      ...
      self.source_cdb_id = attributes[:'sourceCdbId'] if attributes[:'sourceCdbId']

      raise 'You cannot provide both :sourceCdbId and :source_cdb_id' if attributes.key?(:'sourceCdbId') && attributes.key?(:'source_cdb_id')

      self.source_cdb_id = attributes[:'source_cdb_id'] if attributes[:'source_cdb_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_cdb_id == other.source_cdb_id &&
    ...
    def hash
      [compartment_id, display_name, source_cdb_id, image_shape_family, freeform_tags, defined_tags].hash
    end
