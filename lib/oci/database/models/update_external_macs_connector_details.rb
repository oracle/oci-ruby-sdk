...
require 'date'
require_relative 'update_external_database_connector_details'
...
module OCI
  ...
  class Database::Models::UpdateExternalMacsConnectorDetails < Database::Models::UpdateExternalDatabaseConnectorDetails
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Database::Models::UpdateExternalDatabaseConnectorDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Database::Models::UpdateExternalDatabaseConnectorDetails#defined_tags #defined_tags} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::Database::Models::UpdateExternalDatabaseConnectorDetails#display_name #display_name} proprety
    ...
    def hash
      [freeform_tags, defined_tags, display_name, connector_type, connection_string, connection_credentials].hash
    end
