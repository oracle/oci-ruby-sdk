...
module OCI
  ...
  class Database::Models::DatabaseConnectionCredentials
    ...
    def initialize(attributes = {})
      ...
      self.credential_type = "DETAILS" if credential_type.nil? && !attributes.key?(:'credentialType') # rubocop:disable Style/StringLiterals
      ...
      self.credential_type = "DETAILS" if credential_type.nil? && !attributes.key?(:'credentialType') && !attributes.key?(:'credential_type') # rubocop:disable Style/StringLiterals
    end
