...
module OCI
  ...
  #
  class Database::Models::RemoveVirtualMachineFromVmClusterDetails
    # **[Required]** The list of Exacc DB servers for the cluster to be removed.
    # @return [Array<OCI::Database::Models::DbServerDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'db_servers': :'Array<OCI::Database::Models::DbServerDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Database::Models::DbServerDetails>] :db_servers The value to assign to the {#db_servers} property
