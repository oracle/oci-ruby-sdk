...
module OCI
  ...
  #
  class Database::Models::EnablePluggableDatabaseManagementDetails
    PROTOCOL_ENUM = [
    ...
    def hash
      [credential_details, private_end_point_id, service_name, protocol, port, ssl_secret_id, role].hash
    end
