...
require 'date'
require_relative 'mount_type_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Used for creating NFS Auto Mount backup destinations for autonomous on ExaCC.
  class Database::Models::AutomatedMountDetails < Database::Models::MountTypeDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['mountType'] = 'AUTOMATED_MOUNT'
    ...
    def hash
      [mount_type, nfs_server, nfs_server_export].hash
    end
