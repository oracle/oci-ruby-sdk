...
module OCI
  ...
  class Database::Models::ExternalDatabaseConnectorSummary
    CONNECTOR_TYPE_ENUM = [
    ...
    # **[Required]** The user-friendly name for the
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external database resource.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::ExternalMacsConnectorSummary' if type == 'MACS'
    ...
    def hash
      [compartment_id, freeform_tags, defined_tags, display_name, id, lifecycle_state, lifecycle_details, time_created, connector_type, external_database_id, connection_status, time_connection_status_last_updated].hash
    end
