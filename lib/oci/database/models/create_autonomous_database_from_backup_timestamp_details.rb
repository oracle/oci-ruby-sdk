...
module OCI
  ...
  class Database::Models::CreateAutonomousDatabaseFromBackupTimestampDetails < Database::Models::CreateAutonomousDatabaseBase
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :use_latest_available_backup_time_stamp
    ...
    # @option attributes [BOOLEAN] :use_latest_available_backup_time_stamp The value to assign to the {#use_latest_available_backup_time_stamp} property
