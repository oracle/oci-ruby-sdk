...
module OCI
  ...
  class Database::Models::OperationsInsightsConfig
    ...
    #
    # @return [String]
    attr_accessor :operations_insights_connector_id
    ...
    # @option attributes [String] :operations_insights_connector_id The value to assign to the {#operations_insights_connector_id} property
    def initialize(attributes = {})
      ...
      self.operations_insights_connector_id = attributes[:'operationsInsightsConnectorId'] if attributes[:'operationsInsightsConnectorId']

      raise 'You cannot provide both :operationsInsightsConnectorId and :operations_insights_connector_id' if attributes.key?(:'operationsInsightsConnectorId') && attributes.key?(:'operations_insights_connector_id')

      self.operations_insights_connector_id = attributes[:'operations_insights_connector_id'] if attributes[:'operations_insights_connector_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        operations_insights_connector_id == other.operations_insights_connector_id
    end
    ...
    def hash
      [operations_insights_status, operations_insights_connector_id].hash
    end
