...
module OCI
  ...
  #     }`
  #
  class Database::Models::CreateCrossRegionDisasterRecoveryDetails < Database::Models::CreateAutonomousDatabaseBase
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous Database that will be used to create a new standby database for the DR association.
    # @return [String]
    ...
    #
    # @return [String]
    attr_accessor :remote_disaster_recovery_type
    ...
    # @option attributes [String] :remote_disaster_recovery_type The value to assign to the {#remote_disaster_recovery_type} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['source'] = 'CROSS_REGION_DISASTER_RECOVERY'
      ...
      self.remote_disaster_recovery_type = attributes[:'remoteDisasterRecoveryType'] if attributes[:'remoteDisasterRecoveryType']

      raise 'You cannot provide both :remoteDisasterRecoveryType and :remote_disaster_recovery_type' if attributes.key?(:'remoteDisasterRecoveryType') && attributes.key?(:'remote_disaster_recovery_type')

      self.remote_disaster_recovery_type = attributes[:'remote_disaster_recovery_type'] if attributes[:'remote_disaster_recovery_type']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        remote_disaster_recovery_type == other.remote_disaster_recovery_type
    end
