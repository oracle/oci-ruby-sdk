...
module OCI
  ...
  class Database::Models::CreateCrossRegionDisasterRecoveryDetails < Database::Models::CreateAutonomousDatabaseBase
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous Database that will be used to create a new peer database for the DR association.
    # @return [String]
