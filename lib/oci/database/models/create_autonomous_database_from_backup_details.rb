...
module OCI
  ...
  #
  class Database::Models::CreateAutonomousDatabaseFromBackupDetails < Database::Models::CreateAutonomousDatabaseBase
    CLONE_TYPE_ENUM = [
      CLONE_TYPE_FULL = 'FULL'.freeze,
      CLONE_TYPE_METADATA = 'METADATA'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source Autonomous Database Backup that you will clone to create a new Autonomous Database.
    # @return [String]
    attr_accessor :autonomous_database_backup_id
    ...
    def initialize(attributes = {})
      ...
      self.autonomous_database_backup_id = attributes[:'autonomousDatabaseBackupId'] if attributes[:'autonomousDatabaseBackupId']

      raise 'You cannot provide both :autonomousDatabaseBackupId and :autonomous_database_backup_id' if attributes.key?(:'autonomousDatabaseBackupId') && attributes.key?(:'autonomous_database_backup_id')

      self.autonomous_database_backup_id = attributes[:'autonomous_database_backup_id'] if attributes[:'autonomous_database_backup_id']
