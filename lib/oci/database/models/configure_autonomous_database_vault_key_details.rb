...
module OCI
  ...
  class Database::Models::ConfigureAutonomousDatabaseVaultKeyDetails
    ...
    # @return [BOOLEAN]
    attr_accessor :is_using_oracle_managed_keys
    ...
    # @option attributes [BOOLEAN] :is_using_oracle_managed_keys The value to assign to the {#is_using_oracle_managed_keys} property
    ...
    def hash
      [kms_key_id, vault_id, is_using_oracle_managed_keys].hash
    end
