...
module OCI
  ...
  #
  class Database::Models::ExadataInfrastructureUnAllocatedResources
    ...
    # @return [Array<OCI::Database::Models::AutonomousVmClusterResourceDetails>]
    attr_accessor :autonomous_vm_clusters
    ...
    # @option attributes [Array<OCI::Database::Models::AutonomousVmClusterResourceDetails>] :autonomous_vm_clusters The value to assign to the {#autonomous_vm_clusters} property
