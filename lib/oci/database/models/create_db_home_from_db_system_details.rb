...
module OCI
  ...
  #
  class Database::Models::CreateDbHomeFromDbSystemDetails
    # The user-provided name of the Database Home.
    # @return [String]
    attr_accessor :display_name

    # This attribute is required.
    # @return [OCI::Database::Models::CreateDatabaseFromDbSystemDetails]
    ...
    # @option attributes [OCI::Database::Models::CreateDatabaseFromDbSystemDetails] :database The value to assign to the {#database} property
