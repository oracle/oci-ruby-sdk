...
require 'date'
require_relative 'external_database_connector_summary'
...
module OCI
  ...
  #
  class Database::Models::ExternalMacsConnectorSummary < Database::Models::ExternalDatabaseConnectorSummary
    ...
    # @option attributes [String] :compartment_id The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#compartment_id #compartment_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#defined_tags #defined_tags} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#display_name #display_name} proprety
    # @option attributes [String] :id The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#id #id} proprety
    # @option attributes [String] :lifecycle_state The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#lifecycle_state #lifecycle_state} proprety
    # @option attributes [String] :lifecycle_details The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#lifecycle_details #lifecycle_details} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#time_created #time_created} proprety
    # @option attributes [String] :external_database_id The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#external_database_id #external_database_id} proprety
    # @option attributes [String] :connection_status The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#connection_status #connection_status} proprety
    # @option attributes [DateTime] :time_connection_status_last_updated The value to assign to the {OCI::Database::Models::ExternalDatabaseConnectorSummary#time_connection_status_last_updated #time_connection_status_last_updated} proprety
