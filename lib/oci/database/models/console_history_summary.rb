...
module OCI
  ...
  #
  class Database::Models::ConsoleHistorySummary
    LIFECYCLE_STATE_ENUM = [
      LIFECYCLE_STATE_REQUESTED = 'REQUESTED'.freeze,
      LIFECYCLE_STATE_GETTING_HISTORY = 'GETTING_HISTORY'.freeze,
    ...
    def hash
      [id, compartment_id, db_node_id, display_name, freeform_tags, defined_tags, lifecycle_state, lifecycle_details, time_created].hash
    end
