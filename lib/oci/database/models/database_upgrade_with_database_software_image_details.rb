...
module OCI
  ...
  #
  class Database::Models::DatabaseUpgradeWithDatabaseSoftwareImageDetails < Database::Models::DatabaseUpgradeSourceBase
    # **[Required]** The database software image [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the image to be used to upgrade a database.
    # @return [String]
    ...
    def hash
      [source, options, database_software_image_id].hash
    end
