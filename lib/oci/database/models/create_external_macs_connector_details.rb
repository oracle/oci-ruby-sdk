...
require 'date'
require_relative 'create_external_database_connector_details'
...
module OCI
  ...
  #
  class Database::Models::CreateExternalMacsConnectorDetails < Database::Models::CreateExternalDatabaseConnectorDetails
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Database::Models::CreateExternalDatabaseConnectorDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Database::Models::CreateExternalDatabaseConnectorDetails#defined_tags #defined_tags} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::Database::Models::CreateExternalDatabaseConnectorDetails#display_name #display_name} proprety
    # @option attributes [String] :external_database_id The value to assign to the {OCI::Database::Models::CreateExternalDatabaseConnectorDetails#external_database_id #external_database_id} proprety
