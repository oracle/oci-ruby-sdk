...
module OCI
  ...
  class Database::Models::SystemVersionSummary
    ...
    # @option attributes [Array<String>] :system_versions The value to assign to the {#system_versions} property
    def initialize(attributes = {})
      ...
      self.system_versions = attributes[:'systemVersions'] if attributes[:'systemVersions']

      raise 'You cannot provide both :systemVersions and :system_versions' if attributes.key?(:'systemVersions') && attributes.key?(:'system_versions')

      self.system_versions = attributes[:'system_versions'] if attributes[:'system_versions']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        system_versions == other.system_versions
    end
    ...
    def hash
      [shape, gi_version, system_versions].hash
    end
