...
module OCI
  ...
  #
  class Database::Models::RemoveVirtualMachineFromCloudVmClusterDetails
    # **[Required]** The list of ExaDB-D DB server for the cluster to be removed.
    # @return [Array<OCI::Database::Models::CloudDbServerDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'db_servers': :'Array<OCI::Database::Models::CloudDbServerDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Database::Models::CloudDbServerDetails>] :db_servers The value to assign to the {#db_servers} property
