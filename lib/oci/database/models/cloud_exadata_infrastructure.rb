...
module OCI
  ...
  class Database::Models::CloudExadataInfrastructure
    ...
    def hash
      [id, compartment_id, lifecycle_state, display_name, shape, availability_domain, compute_count, storage_count, total_storage_size_in_gbs, available_storage_size_in_gbs, cpu_count, max_cpu_count, memory_size_in_gbs, max_memory_in_gbs, db_node_storage_size_in_gbs, max_db_node_storage_in_gbs, data_storage_size_in_tbs, max_data_storage_in_tbs, additional_storage_count, activated_storage_count, time_created, lifecycle_details, maintenance_window, last_maintenance_run_id, next_maintenance_run_id, freeform_tags, defined_tags, customer_contacts, storage_server_version, db_server_version, monthly_storage_server_version, monthly_db_server_version].hash
    end
