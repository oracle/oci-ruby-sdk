...
module OCI
  ...
  class Database::Models::CreateDbHomeWithVmClusterIdFromBackupDetails < Database::Models::CreateDbHomeBase
    ...
    def hash
      [display_name, kms_key_id, kms_key_version_id, database_software_image_id, freeform_tags, defined_tags, source, is_desupported_version, is_unified_auditing_enabled, vm_cluster_id, database].hash
    end
