...
module OCI
  ...
  #
  class Database::Models::CreateDbHomeWithVmClusterIdFromBackupDetails < Database::Models::CreateDbHomeBase
    ...
    def initialize(attributes = {})
      ...
      attributes['source'] = 'VM_CLUSTER_BACKUP'
    ...
    def hash
      [display_name, kms_key_id, kms_key_version_id, database_software_image_id, freeform_tags, defined_tags, source, is_desupported_version, vm_cluster_id, database].hash
    end
