...
module OCI
  ...
  #
  class Database::Models::EnableDatabaseManagementDetails
    ...
    # @return [OCI::Database::Models::DatabaseCredentialDetails]
    attr_accessor :credential_details

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the private endpoint.
    #
    # @return [String]
    attr_accessor :private_end_point_id
    ...
    # @option attributes [OCI::Database::Models::DatabaseCredentialDetails] :credential_details The value to assign to the {#credential_details} property
    # @option attributes [String] :private_end_point_id The value to assign to the {#private_end_point_id} property
