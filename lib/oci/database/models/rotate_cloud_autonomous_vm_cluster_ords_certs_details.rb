...
module OCI
  ...
  #
  class Database::Models::RotateCloudAutonomousVmClusterOrdsCertsDetails
    ...
    def certificate_generation_type=(certificate_generation_type)
      raise "Invalid value for 'certificate_generation_type': this must be one of the values in CERTIFICATE_GENERATION_TYPE_ENUM." if certificate_generation_type && !CERTIFICATE_GENERATION_TYPE_ENUM.include?(certificate_generation_type)
