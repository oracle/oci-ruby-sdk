...
module OCI
  ...
  #
  class Database::Models::CreateAutonomousContainerDatabaseDataguardAssociationDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the peer cloud Autonomous Exadata VM Cluster.
    # @return [String]
    ...
    # **[Required]** The protection mode of this Autonomous Data Guard association. For more information, see
