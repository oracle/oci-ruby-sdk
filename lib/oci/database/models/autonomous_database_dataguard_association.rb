...
module OCI
  ...
  class Database::Models::AutonomousDatabaseDataguardAssociation
    ...
    PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_ENUM = [
      ...
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_STOPPING = 'STOPPING'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_STOPPED = 'STOPPED'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_STARTING = 'STARTING'.freeze,
      ...
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_RESTORE_IN_PROGRESS = 'RESTORE_IN_PROGRESS'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_RESTORE_FAILED = 'RESTORE_FAILED'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_BACKUP_IN_PROGRESS = 'BACKUP_IN_PROGRESS'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_SCALE_IN_PROGRESS = 'SCALE_IN_PROGRESS'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_AVAILABLE_NEEDS_ATTENTION = 'AVAILABLE_NEEDS_ATTENTION'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_UPDATING = 'UPDATING'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_MAINTENANCE_IN_PROGRESS = 'MAINTENANCE_IN_PROGRESS'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_RESTARTING = 'RESTARTING'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_RECREATING = 'RECREATING'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_ROLE_CHANGE_IN_PROGRESS = 'ROLE_CHANGE_IN_PROGRESS'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_UPGRADING = 'UPGRADING'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_INACCESSIBLE = 'INACCESSIBLE'.freeze,
      PEER_AUTONOMOUS_DATABASE_LIFE_CYCLE_STATE_STANDBY = 'STANDBY'.freeze,
