...
module OCI
  ...
  #
  class Database::Models::CreatePluggableDatabaseFromRemoteCloneDetails < Database::Models::CreatePluggableDatabaseCreationTypeDetails
    ...
    # @return [OCI::Database::Models::CreatePluggableDatabaseRefreshableCloneDetails]
    attr_accessor :refreshable_clone_details
    ...
    # @option attributes [OCI::Database::Models::CreatePluggableDatabaseRefreshableCloneDetails] :refreshable_clone_details The value to assign to the {#refreshable_clone_details} property
