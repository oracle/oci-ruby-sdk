...
module OCI
  ...
  #
  class Database::Models::AutonomousContainerDatabaseDataguardAssociation
    ROLE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous Container Database that has a relationship with the peer Autonomous Container Database.
    #
    # @return [String]
    ...
    # @return [String]
    attr_accessor :peer_autonomous_container_database_dataguard_association_id
    ...
    # @option attributes [String] :peer_autonomous_container_database_dataguard_association_id The value to assign to the {#peer_autonomous_container_database_dataguard_association_id} property
    # @option attributes [String] :peer_autonomous_container_database_id The value to assign to the {#peer_autonomous_container_database_id} property
    # @option attributes [String] :peer_role The value to assign to the {#peer_role} property
    # @option attributes [String] :peer_lifecycle_state The value to assign to the {#peer_lifecycle_state} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] peer_lifecycle_state Object to be assigned
    def peer_lifecycle_state=(peer_lifecycle_state)
      # rubocop:disable Style/ConditionalAssignment
      if peer_lifecycle_state && !PEER_LIFECYCLE_STATE_ENUM.include?(peer_lifecycle_state)
        OCI.logger.debug("Unknown value for 'peer_lifecycle_state' [" + peer_lifecycle_state + "]. Mapping to 'PEER_LIFECYCLE_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @peer_lifecycle_state = PEER_LIFECYCLE_STATE_UNKNOWN_ENUM_VALUE
      else
