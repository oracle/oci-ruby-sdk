...
module OCI
  ...
  class Database::Models::ChangeDisasterRecoveryConfigurationDetails
    ...
    def disaster_recovery_type=(disaster_recovery_type)
      raise "Invalid value for 'disaster_recovery_type': this must be one of the values in DISASTER_RECOVERY_TYPE_ENUM." if disaster_recovery_type && !DISASTER_RECOVERY_TYPE_ENUM.include?(disaster_recovery_type)
