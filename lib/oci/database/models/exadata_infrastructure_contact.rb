...
module OCI
  ...
  class Database::Models::ExadataInfrastructureContact
    ...
    # @return [BOOLEAN]
    attr_accessor :is_contact_mos_validated
    ...
    # @option attributes [BOOLEAN] :is_contact_mos_validated The value to assign to the {#is_contact_mos_validated} property
