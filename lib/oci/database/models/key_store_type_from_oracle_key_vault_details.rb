...
require 'date'
require_relative 'key_store_type_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details for Oracle Key Vault
  class Database::Models::KeyStoreTypeFromOracleKeyVaultDetails < Database::Models::KeyStoreTypeDetails
    # **[Required]** The list of Oracle Key Vault connection IP addresses.
    # @return [Array<String>]
    attr_accessor :connection_ips

    # **[Required]** The administrator username to connect to Oracle Key Vault
    # @return [String]
    attr_accessor :admin_username

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle Cloud Infrastructure [vault](https://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm#concepts).
    # @return [String]
    ...
    # @option attributes [Array<String>] :connection_ips The value to assign to the {#connection_ips} property
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'ORACLE_KEY_VAULT'
      ...
      self.connection_ips = attributes[:'connectionIps'] if attributes[:'connectionIps']

      raise 'You cannot provide both :connectionIps and :connection_ips' if attributes.key?(:'connectionIps') && attributes.key?(:'connection_ips')

      self.connection_ips = attributes[:'connection_ips'] if attributes[:'connection_ips']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        type == other.type &&
        connection_ips == other.connection_ips &&
    ...
    def hash
      [type, connection_ips, admin_username, vault_id, secret_id].hash
    end
