...
module OCI
  ...
  #
  class Database::Models::ExternalPluggableDatabaseSummary
    ...
    def hash
      [source_id, external_container_database_id, compartment_id, freeform_tags, defined_tags, display_name, id, lifecycle_details, lifecycle_state, time_created, db_unique_name, db_id, database_version, database_edition, time_zone, character_set, ncharacter_set, db_packs, database_management_config].hash
    end
