...
module OCI
  ...
  class Database::Models::CreatePluggableDatabaseFromLocalCloneDetails < Database::Models::CreatePluggableDatabaseCreationTypeDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['creationType'] = 'LOCAL_CLONE_PDB'
    ...
    def hash
      [creation_type, source_pluggable_database_id].hash
    end
