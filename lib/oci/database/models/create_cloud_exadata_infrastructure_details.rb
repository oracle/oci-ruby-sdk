...
module OCI
  ...
  class Database::Models::CreateCloudExadataInfrastructureDetails
    ...
    def hash
      [availability_domain, compartment_id, display_name, shape, compute_count, storage_count, maintenance_window, freeform_tags, defined_tags, customer_contacts].hash
    end
