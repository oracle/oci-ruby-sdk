...
module OCI
  ...
  #
  class Database::Models::UpgradeDbSystemDetails
    ACTION_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      raise 'You cannot provide both :isSnapshotRetentionDaysForceUpdated and :is_snapshot_retention_days_force_updated' if attributes.key?(:'isSnapshotRetentionDaysForceUpdated') && attributes.key?(:'is_snapshot_retention_days_force_updated')

      self.is_snapshot_retention_days_force_updated = attributes[:'is_snapshot_retention_days_force_updated'] unless attributes[:'is_snapshot_retention_days_force_updated'].nil?
    end
