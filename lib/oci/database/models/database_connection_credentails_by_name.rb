...
module OCI
  ...
  #
  class Database::Models::DatabaseConnectionCredentailsByName < Database::Models::DatabaseConnectionCredentials
    # **[Required]** The name of the credential information that used to connect to the database. The name should be in \"x.y\" format, where
