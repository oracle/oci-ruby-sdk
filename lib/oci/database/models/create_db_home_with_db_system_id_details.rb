...
module OCI
  ...
  class Database::Models::CreateDbHomeWithDbSystemIdDetails < Database::Models::CreateDbHomeBase
    ...
    def hash
      [display_name, kms_key_id, kms_key_version_id, database_software_image_id, freeform_tags, defined_tags, source, is_desupported_version, db_system_id, db_version, database].hash
    end
