...
module OCI
  ...
  #
  class Database::Models::ApplicationVipSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the application virtual IP (VIP) address.
    # @return [String]
    attr_accessor :id
    ...
    # @option attributes [DateTime] :time_assigned The value to assign to the {#time_assigned} property
    ...
    def hash
      [id, cloud_vm_cluster_id, compartment_id, subnet_id, ip_address, hostname_label, lifecycle_state, lifecycle_details, time_assigned, freeform_tags, defined_tags].hash
    end
