...
module OCI
  ...
  class Database::Models::CreateExternalDatabaseConnectorDetails
    CONNECTOR_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Database::Models::CreateExternalMacsConnectorDetails' if type == 'MACS'
    ...
    def connector_type=(connector_type)
      raise "Invalid value for 'connector_type': this must be one of the values in CONNECTOR_TYPE_ENUM." if connector_type && !CONNECTOR_TYPE_ENUM.include?(connector_type)
    ...
    def hash
      [freeform_tags, defined_tags, display_name, connector_type, external_database_id].hash
    end
