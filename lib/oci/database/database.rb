...
require 'oci/database/models/autonomous_database_software_image'
require 'oci/database/models/autonomous_database_software_image_collection'
require 'oci/database/models/autonomous_database_software_image_summary'
...
require 'oci/database/models/autonomous_vm_cluster_resource_usage'
...
require 'oci/database/models/change_autonomous_database_software_image_compartment_details'
...
require 'oci/database/models/configure_saas_admin_user_details'
require 'oci/database/models/console_connection'
require 'oci/database/models/console_connection_summary'
require 'oci/database/models/console_history'
require 'oci/database/models/console_history_collection'
require 'oci/database/models/console_history_summary'
require 'oci/database/models/convert_to_pdb_details'
require 'oci/database/models/convert_to_pdb_target_base'
require 'oci/database/models/convert_to_regular_pluggable_database_details'
require 'oci/database/models/create_application_vip_details'
require 'oci/database/models/create_autonomous_container_database_dataguard_association_details'
...
require 'oci/database/models/create_autonomous_database_software_image_details'
...
require 'oci/database/models/create_console_history_details'
...
require 'oci/database/models/create_maintenance_run_details'
...
require 'oci/database/models/create_pluggable_database_creation_type_details'
require 'oci/database/models/create_pluggable_database_details'
require 'oci/database/models/create_pluggable_database_from_local_clone_details'
require 'oci/database/models/create_pluggable_database_from_relocate_details'
require 'oci/database/models/create_pluggable_database_from_remote_clone_details'
require 'oci/database/models/create_pluggable_database_refreshable_clone_details'
...
require 'oci/database/models/database_connection_credentials_by_name'
...
require 'oci/database/models/defined_file_system_configuration'
...
require 'oci/database/models/file_system_configuration_detail'
...
require 'oci/database/models/pluggable_database_node_level_details'
require 'oci/database/models/pluggable_database_refreshable_clone_config'
...
require 'oci/database/models/saas_admin_user_configuration'
require 'oci/database/models/saas_admin_user_status'
...
require 'oci/database/models/system_version_collection'
require 'oci/database/models/system_version_summary'
...
require 'oci/database/models/update_autonomous_database_software_image_details'
...
require 'oci/database/models/update_console_history_details'
