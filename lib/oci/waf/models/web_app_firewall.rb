...
module OCI
  ...
  class Waf::Models::WebAppFirewall
    BACKEND_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the WebAppFirewall.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of WebAppFirewallPolicy, which is attached to the resource.
    # @return [String]
    attr_accessor :web_app_firewall_policy_id
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Waf::Models::WebAppFirewallLoadBalancer' if type == 'LOAD_BALANCER'
    ...
    # @option attributes [String] :web_app_firewall_policy_id The value to assign to the {#web_app_firewall_policy_id} property
