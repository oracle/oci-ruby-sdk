...
module OCI
  ...
  class Waf::Models::CreateWebAppFirewallDetails
    BACKEND_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Waf::Models::CreateWebAppFirewallLoadBalancerDetails' if type == 'LOAD_BALANCER'
    ...
    def hash
      [display_name, backend_type, compartment_id, web_app_firewall_policy_id, freeform_tags, defined_tags, system_tags].hash
    end
