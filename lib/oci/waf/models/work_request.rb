...
module OCI
  ...
  class Waf::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_WAF_POLICY = 'CREATE_WAF_POLICY'.freeze,
      OPERATION_TYPE_UPDATE_WAF_POLICY = 'UPDATE_WAF_POLICY'.freeze,
      OPERATION_TYPE_DELETE_WAF_POLICY = 'DELETE_WAF_POLICY'.freeze,
      OPERATION_TYPE_MOVE_WAF_POLICY = 'MOVE_WAF_POLICY'.freeze,
      OPERATION_TYPE_CREATE_NETWORK_ADDRESS_LIST = 'CREATE_NETWORK_ADDRESS_LIST'.freeze,
      OPERATION_TYPE_UPDATE_NETWORK_ADDRESS_LIST = 'UPDATE_NETWORK_ADDRESS_LIST'.freeze,
      OPERATION_TYPE_DELETE_NETWORK_ADDRESS_LIST = 'DELETE_NETWORK_ADDRESS_LIST'.freeze,
      OPERATION_TYPE_MOVE_NETWORK_ADDRESS_LIST = 'MOVE_NETWORK_ADDRESS_LIST'.freeze,
      OPERATION_TYPE_CREATE_WEB_APP_FIREWALL = 'CREATE_WEB_APP_FIREWALL'.freeze,
      OPERATION_TYPE_UPDATE_WEB_APP_FIREWALL = 'UPDATE_WEB_APP_FIREWALL'.freeze,
      OPERATION_TYPE_DELETE_WEB_APP_FIREWALL = 'DELETE_WEB_APP_FIREWALL'.freeze,
      OPERATION_TYPE_MOVE_WEB_APP_FIREWALL = 'MOVE_WEB_APP_FIREWALL'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the WorkRequest.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment that contains the WorkRequest.
    ...
    # @return [Array<OCI::Waf::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Waf::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Waf::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
