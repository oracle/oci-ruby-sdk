...
module OCI
  ...
  class Waf::Models::RequestRateLimiting
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'rules': :'Array<OCI::Waf::Models::RequestRateLimitingRule>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Waf::Models::RequestRateLimitingRule>] :rules The value to assign to the {#rules} property
