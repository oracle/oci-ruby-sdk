...
module OCI
  ...
  #
  class Waf::Models::ProtectionCapabilityExclusions
    ...
    # @option attributes [Array<String>] :request_cookies The value to assign to the {#request_cookies} property
    # @option attributes [Array<String>] :args The value to assign to the {#args} property
