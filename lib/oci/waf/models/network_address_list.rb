...
module OCI
  ...
  class Waf::Models::NetworkAddressList
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Waf::Models::NetworkAddressListAddresses' if type == 'ADDRESSES'
      return 'OCI::Waf::Models::NetworkAddressListVcnAddresses' if type == 'VCN_ADDRESSES'
