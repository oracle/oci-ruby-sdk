...
module OCI
  ...
  #
  class Waf::Models::RequestRateLimitingRule < Waf::Models::WebAppFirewallPolicyRule
    # **[Required]** Rate Limiting Configurations.
    # Each configuration counts requests towards its own `requestsLimit`.
    #
    # @return [Array<OCI::Waf::Models::RequestRateLimitingConfiguration>]
    ...
    # @option attributes [Array<OCI::Waf::Models::RequestRateLimitingConfiguration>] :configurations The value to assign to the {#configurations} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'REQUEST_RATE_LIMITING'
    ...
    def hash
      [type, name, condition_language, condition, action_name, configurations].hash
    end
