...
module OCI
  ...
  #
  class CapacityManagement::Models::OccCustomerGroupSummary
    ...
    # **[Required]** The status (enabled/disabled) of the customer group.
    # @return [String]
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, time_updated, status, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
