...
module OCI
  ...
  #
  class CapacityManagement::Models::OccCapacityRequest
    NAMESPACE_ENUM = [
    ...
    REQUEST_STATE_ENUM = [
      ...
      REQUEST_STATE_REJECTED = 'REJECTED'.freeze,
      REQUEST_STATE_IN_PROGRESS = 'IN_PROGRESS'.freeze,
      REQUEST_STATE_COMPLETED = 'COMPLETED'.freeze,
      REQUEST_STATE_PARTIALLY_COMPLETED = 'PARTIALLY_COMPLETED'.freeze,
      REQUEST_STATE_CANCELLED = 'CANCELLED'.freeze,
      REQUEST_STATE_DELETED = 'DELETED'.freeze,
      REQUEST_STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def request_state=(request_state)
      # rubocop:disable Style/ConditionalAssignment
      if request_state && !REQUEST_STATE_ENUM.include?(request_state)
        OCI.logger.debug("Unknown value for 'request_state' [" + request_state + "]. Mapping to 'REQUEST_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @request_state = REQUEST_STATE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, compartment_id, occ_availability_catalog_id, display_name, description, namespace, occ_customer_group_id, region, availability_domain, date_expected_capacity_handover, request_state, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, details].hash
    end
