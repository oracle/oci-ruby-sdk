...
module OCI
  ...
  class ApmConfig::Models::ConfigCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::ApmConfig::Models::ConfigSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ApmConfig::Models::ConfigSummary>] :items The value to assign to the {#items} property
