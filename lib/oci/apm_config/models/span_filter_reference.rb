...
module OCI
  ...
  class ApmConfig::Models::SpanFilterReference
    CONFIG_TYPE_ENUM = [
    ...
    # @option attributes [String] :options_group The value to assign to the {#options_group} property
    ...
    def initialize(attributes = {})
      ...
      self.options_group = attributes[:'optionsGroup'] if attributes[:'optionsGroup']

      raise 'You cannot provide both :optionsGroup and :options_group' if attributes.key?(:'optionsGroup') && attributes.key?(:'options_group')

      self.options_group = attributes[:'options_group'] if attributes[:'options_group']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        options_group == other.options_group &&
    ...
    def hash
      [id, config_type, options_group, display_name].hash
    end
