...
module OCI
  ...
  class ApmConfig::Models::UpdateSpanFilterDetails < ApmConfig::Models::UpdateConfigDetails
    ...
    def hash
      [config_type, freeform_tags, defined_tags, display_name, filter_text, description].hash
    end
