...
require 'date'
require_relative 'create_config_details'
...
module OCI
  ...
  class ApmConfig::Models::CreateMetricGroupDetails < ApmConfig::Models::CreateConfigDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of a Span Filter. The filterId is mandatory for the creation
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::ApmConfig::Models::CreateConfigDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::ApmConfig::Models::CreateConfigDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [config_type, freeform_tags, defined_tags, display_name, filter_id, namespace, dimensions, metrics].hash
    end
