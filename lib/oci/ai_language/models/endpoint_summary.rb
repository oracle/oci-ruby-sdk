...
module OCI
  ...
  class AiLanguage::Models::EndpointSummary
    ...
    def hash
      [id, display_name, compartment_id, project_id, description, time_created, lifecycle_state, lifecycle_details, inference_units, model_id, freeform_tags, defined_tags, system_tags].hash
    end
