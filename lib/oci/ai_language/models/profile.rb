...
module OCI
  # Documents profile
  class AiLanguage::Models::Profile
    ...
    # @option attributes [String] :speciality The value to assign to the {#speciality} property
    def initialize(attributes = {})
      ...
      self.speciality = attributes[:'speciality'] if attributes[:'speciality']
    end
    ...
    def hash
      [domain, document_type, speciality].hash
    end
