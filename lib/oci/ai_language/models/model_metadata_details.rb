...
module OCI
  ...
  #
  class AiLanguage::Models::ModelMetadataDetails
    ...
    #
    # @return [Hash<String, OCI::AiLanguage::Models::ConfigurationDetails>]
    ...
    def self.swagger_types
      {
        ...
        'configuration': :'Hash<String, OCI::AiLanguage::Models::ConfigurationDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::AiLanguage::Models::ConfigurationDetails>] :configuration The value to assign to the {#configuration} property
    ...
    def hash
      [model_type, model_id, endpoint_id, language_code, configuration].hash
    end
