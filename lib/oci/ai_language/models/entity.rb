...
module OCI
  # entity object
  class AiLanguage::Models::Entity
    ...
    # @option attributes [BOOLEAN] :is_pii The value to assign to the {#is_pii} property
    ...
    def initialize(attributes = {})
      ...
      self.is_pii = attributes[:'isPii'] unless attributes[:'isPii'].nil?

      raise 'You cannot provide both :isPii and :is_pii' if attributes.key?(:'isPii') && attributes.key?(:'is_pii')

      self.is_pii = attributes[:'is_pii'] unless attributes[:'is_pii'].nil?
    ...
    def hash
      [offset, length, text, type, is_pii, score].hash
    end
