...
module OCI
  ...
  class AiLanguage::Models::Project
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)  for the project's compartment.
    # @return [String]
    ...
    def hash
      [id, display_name, compartment_id, description, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
