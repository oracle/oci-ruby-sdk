...
require 'date'
require_relative 'test_strategy'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # This information will be used capture training, testing and validation dataset.
  class AiLanguage::Models::TestAndValidationDatasetStrategy < AiLanguage::Models::TestStrategy
    ...
    def self.swagger_types
      {
        ...
        'testing_dataset': :'OCI::AiLanguage::Models::DatasetDetails',
        'validation_dataset': :'OCI::AiLanguage::Models::DatasetDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::AiLanguage::Models::DatasetDetails] :testing_dataset The value to assign to the {#testing_dataset} property
    # @option attributes [OCI::AiLanguage::Models::DatasetDetails] :validation_dataset The value to assign to the {#validation_dataset} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['strategyType'] = 'TEST_AND_VALIDATION_DATASET'
    ...
    def hash
      [strategy_type, testing_dataset, validation_dataset].hash
    end
