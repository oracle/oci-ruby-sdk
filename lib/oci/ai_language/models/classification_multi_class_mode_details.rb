...
module OCI
  ...
  class AiLanguage::Models::ClassificationMultiClassModeDetails < AiLanguage::Models::ClassificationType
    ...
    def initialize(attributes = {})
      ...
      attributes['classificationMode'] = 'MULTI_CLASS'
    ...
    def hash
      [classification_mode, version].hash
    end
