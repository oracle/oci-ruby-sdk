...
module OCI
  ...
  class AiLanguage::Models::TranslationDocumentResult
    ...
    # @option attributes [String] :translated_text The value to assign to the {#translated_text} property
    # @option attributes [String] :source_language_code The value to assign to the {#source_language_code} property
