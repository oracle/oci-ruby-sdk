...
module OCI
  ...
  class AiLanguage::Models::BatchDetectLanguagePiiEntitiesDetails
    ...
    # @return [Hash<String, OCI::AiLanguage::Models::PiiEntityMasking>]
    attr_accessor :masking
    ...
    # @option attributes [Hash<String, OCI::AiLanguage::Models::PiiEntityMasking>] :masking The value to assign to the {#masking} property
    ...
    def initialize(attributes = {})
      ...
      self.masking = attributes[:'masking'] if attributes[:'masking']
    ...
    def hash
      [endpoint_id, compartment_id, documents, masking, profile].hash
    end
