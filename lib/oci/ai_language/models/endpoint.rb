...
module OCI
  ...
  class AiLanguage::Models::Endpoint
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) for the endpoint compartment.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the Endpoint.
    # @return [String]
    ...
    # @return [Integer]
    attr_accessor :inference_units

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model to associate with the endpoint.
    # @return [String]
    ...
    # @option attributes [Integer] :inference_units The value to assign to the {#inference_units} property
    ...
    def hash
      [id, display_name, compartment_id, project_id, description, time_created, time_updated, lifecycle_state, lifecycle_details, inference_units, model_id, freeform_tags, defined_tags, system_tags].hash
    end
