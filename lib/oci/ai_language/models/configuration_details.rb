...
module OCI
  ...
  #
  class AiLanguage::Models::ConfigurationDetails
    ...
    attr_accessor :configuration_map
    ...
    # @option attributes [Hash<String, String>] :configuration_map The value to assign to the {#configuration_map} property
