...
module OCI
  # Resolved entity.
  class AiLanguage::Models::ResolvedEntity
    # **[Required]** id of the resolved entity in input
    # @return [String]
    attr_accessor :id

    # **[Required]** offset of resolved entity in input
    # @return [Integer]
    attr_accessor :offset

    # **[Required]** length of resolved entity in input
    # @return [Integer]
    ...
    # **[Required]** key and value pair for resolved entities. keys can be specific for each type of resolved entity. Values can be instances of resolvedEntity, arrays of resolvedEntities, primitives, or custom JSON.
    ...
    # @option attributes [Hash<String, String>] :value The value to assign to the {#value} property
    ...
    def hash
      [id, offset, length, text, type, value].hash
    end
