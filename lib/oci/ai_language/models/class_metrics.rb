...
module OCI
  ...
  class AiLanguage::Models::ClassMetrics
    ...
    # @option attributes [Float] :f1 The value to assign to the {#f1} property
    ...
    # @option attributes [Float] :support The value to assign to the {#support} property
    def initialize(attributes = {})
      ...
      self.support = attributes[:'support'] if attributes[:'support']
    end
    ...
    def hash
      [label, f1, precision, recall, support].hash
    end
