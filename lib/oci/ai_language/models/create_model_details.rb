...
module OCI
  ...
  class AiLanguage::Models::CreateModelDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)  for the models compartment.
    # @return [String]
    ...
    def hash
      [display_name, description, compartment_id, project_id, model_details, training_dataset, test_strategy, freeform_tags, defined_tags].hash
    end
