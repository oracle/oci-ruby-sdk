...
module OCI
  ...
  class AiLanguage::Models::DominantLanguageDocumentResult
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'key': :'String',
        'languages': :'Array<OCI::AiLanguage::Models::DetectedLanguage>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::AiLanguage::Models::DetectedLanguage>] :languages The value to assign to the {#languages} property
