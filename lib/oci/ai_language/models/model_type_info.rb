...
module OCI
  ...
  class AiLanguage::Models::ModelTypeInfo
    ...
    def self.swagger_types
      {
        ...
        'capabilities': :'Hash<String, OCI::AiLanguage::Models::Capabilities>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::AiLanguage::Models::Capabilities>] :capabilities The value to assign to the {#capabilities} property
