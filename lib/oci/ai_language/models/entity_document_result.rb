...
module OCI
  ...
  class AiLanguage::Models::EntityDocumentResult
    # **[Required]** Document unique identifier defined by the user.
    # @return [String]
    attr_accessor :key

    # **[Required]** List of detected entities.
    # @return [Array<OCI::AiLanguage::Models::HierarchicalEntity>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'key': :'String',
        'entities': :'Array<OCI::AiLanguage::Models::HierarchicalEntity>',
    ...
    # @option attributes [Array<OCI::AiLanguage::Models::HierarchicalEntity>] :entities The value to assign to the {#entities} property
    ...
    def hash
      [key, entities, language_code].hash
    end
