...
module OCI
  ...
  class AiLanguage::Models::CreateJobDetails
    ...
    def hash
      [display_name, description, compartment_id, input_location, input_configuration, model_metadata_details, output_location].hash
    end
