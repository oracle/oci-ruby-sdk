...
module OCI
  ...
  class AiLanguage::Models::ObjectStorageFileNameLocation < AiLanguage::Models::InputLocation
    ...
    # **[Required]** List of objects to be processed
    # @return [Array<String>]
    ...
    def initialize(attributes = {})
      ...
      attributes['locationType'] = 'OBJECT_STORAGE_FILE_LIST'
    ...
    def hash
      [location_type, namespace_name, bucket_name, object_names].hash
    end
