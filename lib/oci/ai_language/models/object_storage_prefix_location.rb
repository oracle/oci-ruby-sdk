...
module OCI
  ...
  class AiLanguage::Models::ObjectStoragePrefixLocation < AiLanguage::Models::InputLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['locationType'] = 'OBJECT_STORAGE_PREFIX'
    ...
    def hash
      [location_type, namespace_name, bucket_name, prefix].hash
    end
