...
module OCI
  ...
  class AiLanguage::Models::MelConceptDetails
    # **[Required]** id of the relation
    # @return [String]
    attr_accessor :id

    # **[Required]** The matched concept name/description on the ontology
    # @return [String]
    attr_accessor :name

    # **[Required]** The relevant score between the concept and the input text
    # @return [Float]
    attr_accessor :score
    ...
    # @option attributes [Hash<String, String>] :attributes The value to assign to the {#attributes} property
