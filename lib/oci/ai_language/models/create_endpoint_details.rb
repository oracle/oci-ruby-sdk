...
module OCI
  ...
  class AiLanguage::Models::CreateEndpointDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) compartment identifier for the endpoint
    # @return [String]
    ...
    def hash
      [display_name, description, compartment_id, model_id, inference_units, freeform_tags, defined_tags].hash
    end
