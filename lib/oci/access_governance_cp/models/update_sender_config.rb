...
module OCI
  ...
  class AccessGovernanceCp::Models::UpdateSenderConfig
    ...
    # @return [BOOLEAN]
    attr_accessor :is_inbox_configured

    # Whether there is a need to resend the verification email.
    # @return [BOOLEAN]
    attr_accessor :is_resend_notification_email
    ...
    def self.swagger_types
      {
        ...
        'is_resend_notification_email': :'BOOLEAN'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :is_inbox_configured The value to assign to the {#is_inbox_configured} property
    # @option attributes [BOOLEAN] :is_resend_notification_email The value to assign to the {#is_resend_notification_email} property
    def initialize(attributes = {})
      ...
      self.is_resend_notification_email = attributes[:'isResendNotificationEmail'] unless attributes[:'isResendNotificationEmail'].nil?

      raise 'You cannot provide both :isResendNotificationEmail and :is_resend_notification_email' if attributes.key?(:'isResendNotificationEmail') && attributes.key?(:'is_resend_notification_email')

      self.is_resend_notification_email = attributes[:'is_resend_notification_email'] unless attributes[:'is_resend_notification_email'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_resend_notification_email == other.is_resend_notification_email
    end
    ...
    def hash
      [display_name, email, is_inbox_configured, is_resend_notification_email].hash
    end
