...
module OCI
  ...
  class AccessGovernanceCp::Models::GovernanceInstanceSummary
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, license_type, instance_url, defined_tags, freeform_tags, system_tags].hash
    end
