...
module OCI
  ...
  class AccessGovernanceCp::Models::SenderConfig
    ...
    # @return [DateTime]
    attr_accessor :time_verify_response_expiry
    ...
    # @option attributes [BOOLEAN] :is_verified The value to assign to the {#is_verified} property
    # @option attributes [DateTime] :time_verify_response_expiry The value to assign to the {#time_verify_response_expiry} property
