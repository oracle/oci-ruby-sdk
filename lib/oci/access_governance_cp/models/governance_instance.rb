...
module OCI
  ...
  class AccessGovernanceCp::Models::GovernanceInstance
    ...
    # @return [String]
    attr_accessor :tenancy_namespace
    ...
    # @option attributes [String] :tenancy_namespace The value to assign to the {#tenancy_namespace} property
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, description, license_type, tenancy_namespace, instance_url, defined_tags, freeform_tags, system_tags].hash
    end
