...
require 'date'
require_relative 'update_item_details'
...
module OCI
  ...
  class Cims::Models::UpdateActivityItemDetails < Cims::Models::UpdateItemDetails
    ...
    def activity_type=(activity_type)
      raise "Invalid value for 'activity_type': this must be one of the values in ACTIVITY_TYPE_ENUM." if activity_type && !ACTIVITY_TYPE_ENUM.include?(activity_type)
