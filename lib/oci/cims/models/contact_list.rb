...
module OCI
  ...
  class Cims::Models::ContactList
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'contact_list': :'Array<OCI::Cims::Models::Contact>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Cims::Models::Contact>] :contact_list The value to assign to the {#contact_list} property
