...
module OCI
  ...
  class Cims::Models::IncidentResourceType
    ...
    # @return [Array<OCI::Cims::Models::ServiceCategories>]
    attr_accessor :service_categories
    ...
    # @option attributes [Hash<String, String>] :service The value to assign to the {#service} property
    # @option attributes [Array<OCI::Cims::Models::ServiceCategories>] :service_categories The value to assign to the {#service_categories} property
    def initialize(attributes = {})
      ...
      self.service_categories = attributes[:'serviceCategories'] if attributes[:'serviceCategories']

      raise 'You cannot provide both :serviceCategories and :service_categories' if attributes.key?(:'serviceCategories') && attributes.key?(:'service_categories')

      self.service_categories = attributes[:'service_categories'] if attributes[:'service_categories']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        service_categories == other.service_categories
    end
    ...
    def hash
      [resource_type_key, name, label, description, service_category_list, service, service_categories].hash
    end
