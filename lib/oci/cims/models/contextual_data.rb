...
module OCI
  ...
  class Cims::Models::ContextualData
    ...
    # **[Required]** The context data payload
    # @return [String]
    ...
    # @option attributes [String] :payload The value to assign to the {#payload} property
    ...
    def hash
      [client_id, schema_name, schema_version, payload].hash
    end
