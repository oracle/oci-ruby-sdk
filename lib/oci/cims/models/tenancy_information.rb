...
module OCI
  ...
  class Cims::Models::TenancyInformation
    ...
    # @option attributes [String] :customer_support_key The value to assign to the {#customer_support_key} property
    ...
    def initialize(attributes = {})
      ...
      self.customer_support_key = attributes[:'customerSupportKey'] if attributes[:'customerSupportKey']

      raise 'You cannot provide both :customerSupportKey and :customer_support_key' if attributes.key?(:'customerSupportKey') && attributes.key?(:'customer_support_key')

      self.customer_support_key = attributes[:'customer_support_key'] if attributes[:'customer_support_key']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        customer_support_key == other.customer_support_key &&
    ...
    def hash
      [customer_support_key, tenancy_id].hash
    end
