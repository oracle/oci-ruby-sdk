...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::AnnotationAnalyticsAggregationCollection
    # **[Required]** The list of annotation entities.
    # @return [Array<OCI::DataLabelingServiceDataplane::Models::AnnotationAnalyticsAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DataLabelingServiceDataplane::Models::AnnotationAnalyticsAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataLabelingServiceDataplane::Models::AnnotationAnalyticsAggregation>] :items The value to assign to the {#items} property
