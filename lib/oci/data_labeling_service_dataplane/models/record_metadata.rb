...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::RecordMetadata
    RECORD_TYPE_ENUM = [
      RECORD_TYPE_IMAGE_METADATA = 'IMAGE_METADATA'.freeze,
      RECORD_TYPE_TEXT_METADATA = 'TEXT_METADATA'.freeze,
      RECORD_TYPE_DOCUMENT_METADATA = 'DOCUMENT_METADATA'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'recordType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::DataLabelingServiceDataplane::Models::DocumentMetadata' if type == 'DOCUMENT_METADATA'
      return 'OCI::DataLabelingServiceDataplane::Models::ImageMetadata' if type == 'IMAGE_METADATA'
      return 'OCI::DataLabelingServiceDataplane::Models::TextMetadata' if type == 'TEXT_METADATA'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataLabelingServiceDataplane::Models::RecordMetadata'
    end
