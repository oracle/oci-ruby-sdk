...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::ImageObjectSelectionEntity < DataLabelingServiceDataplane::Models::Entity
    ...
    def hash
      [entity_type, labels, bounding_polygon, extended_metadata].hash
    end
