...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::SourceDetails
    SOURCE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataLabelingServiceDataplane::Models::ObjectStorageSourceDetails' if type == 'OBJECT_STORAGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataLabelingServiceDataplane::Models::SourceDetails'
    end
