...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::RecordAnalyticsAggregation
    # **[Required]** the count of the matching results
    # @return [Float]
    attr_accessor :count

    # @return [OCI::DataLabelingServiceDataplane::Models::RecordAggregationDimensions]
    ...
    # @option attributes [OCI::DataLabelingServiceDataplane::Models::RecordAggregationDimensions] :dimensions The value to assign to the {#dimensions} property
    ...
    def hash
      [count, dimensions, dataset_id, compartment_id, lifecycle_state].hash
    end
