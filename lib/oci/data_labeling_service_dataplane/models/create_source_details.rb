...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::CreateSourceDetails
    SOURCE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataLabelingServiceDataplane::Models::CreateObjectStorageSourceDetails' if type == 'OBJECT_STORAGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataLabelingServiceDataplane::Models::CreateSourceDetails'
    end
