...
module OCI
  ...
  class DataLabelingServiceDataplane::Models::AnnotationAggregationDimensions
    # @return [OCI::DataLabelingServiceDataplane::Models::Label]
    attr_accessor :label
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'label': :'OCI::DataLabelingServiceDataplane::Models::Label',
        'updated_by': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataLabelingServiceDataplane::Models::Label] :label The value to assign to the {#label} property
