...
module OCI
  ...
  class AiDocument::Models::InputLocation
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_OBJECT_STORAGE_LOCATIONS = 'OBJECT_STORAGE_LOCATIONS'.freeze,
      SOURCE_TYPE_INLINE_DOCUMENT_CONTENT = 'INLINE_DOCUMENT_CONTENT'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiDocument::Models::InlineDocumentContent' if type == 'INLINE_DOCUMENT_CONTENT'
      return 'OCI::AiDocument::Models::ObjectStorageLocations' if type == 'OBJECT_STORAGE_LOCATIONS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiDocument::Models::InputLocation'
    end
