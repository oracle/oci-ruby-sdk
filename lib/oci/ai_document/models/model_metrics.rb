...
module OCI
  ...
  class AiDocument::Models::ModelMetrics
    MODEL_TYPE_ENUM = [
    ...
    # @return [OCI::AiDocument::Models::DatasetSummary]
    attr_accessor :dataset_summary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiDocument::Models::DocumentClassificationModelMetrics' if type == 'DOCUMENT_CLASSIFICATION'
      return 'OCI::AiDocument::Models::KeyValueDetectionModelMetrics' if type == 'KEY_VALUE_EXTRACTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiDocument::Models::ModelMetrics'
    end
    ...
    # @option attributes [OCI::AiDocument::Models::DatasetSummary] :dataset_summary The value to assign to the {#dataset_summary} property
    def initialize(attributes = {})
      ...
      self.dataset_summary = attributes[:'datasetSummary'] if attributes[:'datasetSummary']

      raise 'You cannot provide both :datasetSummary and :dataset_summary' if attributes.key?(:'datasetSummary') && attributes.key?(:'dataset_summary')

      self.dataset_summary = attributes[:'dataset_summary'] if attributes[:'dataset_summary']
    end
    ...
    def hash
      [model_type, dataset_summary].hash
    end
