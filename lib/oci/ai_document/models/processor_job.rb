...
module OCI
  ...
  class AiDocument::Models::ProcessorJob
    ...
    # @return [OCI::AiDocument::Models::ProcessorConfig]
    attr_accessor :processor_config

    # @return [OCI::AiDocument::Models::InputLocation]
    ...
    # @option attributes [OCI::AiDocument::Models::ProcessorConfig] :processor_config The value to assign to the {#processor_config} property
    # @option attributes [OCI::AiDocument::Models::InputLocation] :input_location The value to assign to the {#input_location} property
    ...
    def initialize(attributes = {})
      ...
      self.processor_config = attributes[:'processorConfig'] if attributes[:'processorConfig']

      raise 'You cannot provide both :processorConfig and :processor_config' if attributes.key?(:'processorConfig') && attributes.key?(:'processor_config')

      self.processor_config = attributes[:'processor_config'] if attributes[:'processor_config']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        processor_config == other.processor_config &&
    ...
    def hash
      [id, compartment_id, display_name, processor_config, input_location, time_accepted, time_started, time_finished, percent_complete, output_location, lifecycle_state, lifecycle_details].hash
    end
