...
module OCI
  ...
  class AiDocument::Models::DetectedDocumentType
    ...
    # @option attributes [String] :document_id The value to assign to the {#document_id} property
    ...
    def hash
      [document_type, document_id, confidence].hash
    end
