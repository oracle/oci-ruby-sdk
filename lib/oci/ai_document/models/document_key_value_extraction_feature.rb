...
module OCI
  ...
  class AiDocument::Models::DocumentKeyValueExtractionFeature < AiDocument::Models::DocumentFeature
    # The custom model ID.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['featureType'] = 'KEY_VALUE_EXTRACTION'
    ...
    def hash
      [feature_type, model_id, tenancy_id].hash
    end
