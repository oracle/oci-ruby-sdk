...
module OCI
  ...
  class AiDocument::Models::DocumentDetails
    SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiDocument::Models::ObjectStorageDocumentDetails' if type == 'OBJECT_STORAGE'
      return 'OCI::AiDocument::Models::InlineDocumentDetails' if type == 'INLINE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiDocument::Models::DocumentDetails'
    end
