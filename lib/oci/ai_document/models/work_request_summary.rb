...
module OCI
  ...
  class AiDocument::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::AiDocument::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::AiDocument::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::AiDocument::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
