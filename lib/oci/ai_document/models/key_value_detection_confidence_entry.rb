...
module OCI
  ...
  class AiDocument::Models::KeyValueDetectionConfidenceEntry
    ...
    # @option attributes [Float] :f1_score The value to assign to the {#f1_score} property
    ...
    def initialize(attributes = {})
      ...
      self.f1_score = attributes[:'f1Score'] if attributes[:'f1Score']

      raise 'You cannot provide both :f1Score and :f1_score' if attributes.key?(:'f1Score') && attributes.key?(:'f1_score')

      self.f1_score = attributes[:'f1_score'] if attributes[:'f1_score']
    ...
    def hash
      [threshold, precision, recall, f1_score, accuracy].hash
    end
