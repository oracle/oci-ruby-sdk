...
module OCI
  ...
  class DataIntegration::Models::BipCallAttribute < DataIntegration::Models::AbstractCallAttribute
    ...
    # @option attributes [Integer] :fetch_size The value to assign to the {OCI::DataIntegration::Models::AbstractCallAttribute#fetch_size #fetch_size} proprety
