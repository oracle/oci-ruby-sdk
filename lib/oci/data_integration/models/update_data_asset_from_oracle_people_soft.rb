...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromOraclePeopleSoft < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::UpdateConnectionFromOraclePeopleSoft]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::UpdateConnectionFromOraclePeopleSoft'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionFromOraclePeopleSoft] :default_connection The value to assign to the {#default_connection} property
