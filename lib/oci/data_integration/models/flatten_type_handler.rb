...
module OCI
  ...
  class DataIntegration::Models::FlattenTypeHandler < DataIntegration::Models::DynamicTypeHandler
    ...
    # @option attributes [String] :flatten_details The value to assign to the {#flatten_details} property
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'FLATTEN_TYPE_HANDLER'
    ...
    def hash
      [model_type, key, model_version, parent_ref, scope, flatten_details, config_values, object_status].hash
    end
