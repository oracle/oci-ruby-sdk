...
module OCI
  ...
  class DataIntegration::Models::MacroField < DataIntegration::Models::TypedObject
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'MACRO_FIELD'
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, expr, type, is_use_source_type, use_type, labels].hash
    end
