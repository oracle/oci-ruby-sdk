...
module OCI
  ...
  class DataIntegration::Models::UpdateProjectDetails
    ...
    def hash
      [key, model_type, model_version, name, description, object_status, identifier, object_version, parent_ref, registry_metadata].hash
    end
