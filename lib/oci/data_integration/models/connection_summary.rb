...
module OCI
  ...
  class DataIntegration::Models::ConnectionSummary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromRestNoAuth' if type == 'REST_NO_AUTH_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromOracleSiebel' if type == 'ORACLE_SIEBEL_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromOracle' if type == 'ORACLEDB_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromMySqlHeatWave' if type == 'MYSQL_HEATWAVE_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromAmazonS3' if type == 'AMAZON_S3_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromOAuth2' if type == 'OAUTH2_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromOraclePeopleSoft' if type == 'ORACLE_PEOPLESOFT_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromOracleEbs' if type == 'ORACLE_EBS_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromLake' if type == 'LAKE_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromBIP' if type == 'BIP_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromHdfs' if type == 'HDFS_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionSummaryFromRestBasicAuth' if type == 'REST_BASIC_AUTH_CONNECTION'
