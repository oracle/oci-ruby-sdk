...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromObjectStorage < DataIntegration::Models::DataAssetSummary
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromObjectStorage] :default_connection The value to assign to the {#default_connection} property
