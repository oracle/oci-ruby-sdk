...
module OCI
  ...
  class DataIntegration::Models::ConfigurationDetails
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'data_asset': :'OCI::DataIntegration::Models::DataAsset',
        'connection': :'OCI::DataIntegration::Models::Connection',
        'compartment_id': :'String',
        'schema': :'OCI::DataIntegration::Models::Schema'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::DataAsset] :data_asset The value to assign to the {#data_asset} property
    # @option attributes [OCI::DataIntegration::Models::Connection] :connection The value to assign to the {#connection} property
    # @option attributes [String] :compartment_id The value to assign to the {#compartment_id} property
    # @option attributes [OCI::DataIntegration::Models::Schema] :schema The value to assign to the {#schema} property
    ...
    def hash
      [data_asset, connection, compartment_id, schema].hash
    end
