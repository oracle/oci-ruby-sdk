...
module OCI
  ...
  class DataIntegration::Models::ParquetFormatAttribute < DataIntegration::Models::AbstractFormatAttribute
    ...
    # @option attributes [String] :compression The value to assign to the {#compression} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'PARQUET_FORMAT'
      ...
      self.compression = attributes[:'compression'] if attributes[:'compression']
    end
    ...
    def hash
      [model_type, is_file_pattern, compression].hash
    end
