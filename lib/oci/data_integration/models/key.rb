...
module OCI
  ...
  class DataIntegration::Models::Key
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_FOREIGN_KEY = 'FOREIGN_KEY'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::UniqueKey' if type == 'UNIQUE_KEY'
      return 'OCI::DataIntegration::Models::ForeignKey' if type == 'FOREIGN_KEY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::Key'
    end
