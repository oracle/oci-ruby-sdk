...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromJdbc < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromJdbcDetails]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromJdbcDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromJdbcDetails] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, host, port, data_asset_type, default_connection].hash
    end
