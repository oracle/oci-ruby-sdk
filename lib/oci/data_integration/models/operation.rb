...
module OCI
  ...
  class DataIntegration::Models::Operation
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::OperationFromProcedure' if type == 'PROCEDURE'
      return 'OCI::DataIntegration::Models::OperationFromApi' if type == 'API'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::Operation'
    end
