...
module OCI
  ...
  class DataIntegration::Models::Function < DataIntegration::Models::Operator
    # @return [OCI::DataIntegration::Models::OciFunction]
    attr_accessor :oci_function
    ...
    def self.swagger_types
      {
        ...
        'oci_function': :'OCI::DataIntegration::Models::OciFunction'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::OciFunction] :oci_function The value to assign to the {#oci_function} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'FUNCTION_OPERATOR'
      ...
      self.oci_function = attributes[:'ociFunction'] if attributes[:'ociFunction']

      raise 'You cannot provide both :ociFunction and :oci_function' if attributes.key?(:'ociFunction') && attributes.key?(:'oci_function')

      self.oci_function = attributes[:'oci_function'] if attributes[:'oci_function']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        oci_function == other.oci_function
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, input_ports, output_ports, object_status, identifier, parameters, op_config_values, oci_function].hash
    end
