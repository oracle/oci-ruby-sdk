...
module OCI
  ...
  class DataIntegration::Models::CreateUserDefinedFunctionDetails
    ...
    def hash
      [key, model_version, parent_ref, name, identifier, signatures, expr, description, object_status, registry_metadata].hash
    end
