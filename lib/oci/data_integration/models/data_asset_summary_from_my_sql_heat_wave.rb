...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromMySqlHeatWave < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromMySqlHeatWave]
    ...
    def self.swagger_types
      {
        ...
        'port': :'String',
        'service_name': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromMySqlHeatWave'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromMySqlHeatWave] :default_connection The value to assign to the {#default_connection} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'MYSQL_HEATWAVE_DATA_ASSET'
