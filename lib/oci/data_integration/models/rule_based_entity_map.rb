...
module OCI
  ...
  class DataIntegration::Models::RuleBasedEntityMap < DataIntegration::Models::FieldMap
    MAP_TYPE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'RULE_BASED_ENTITY_MAP'
    ...
    def hash
      [model_type, description, key, model_version, parent_ref, config_values, map_type, from_pattern, to_pattern, is_java_regex_syntax, object_status].hash
    end
