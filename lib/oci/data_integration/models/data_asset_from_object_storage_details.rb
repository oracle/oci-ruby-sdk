...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromObjectStorageDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromObjectStorageDetails]
    ...
    def self.swagger_types
      {
        ...
        'tenancy_id': :'String',
        'namespace': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromObjectStorageDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromObjectStorageDetails] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, oci_region, url, tenancy_id, namespace, default_connection].hash
    end
