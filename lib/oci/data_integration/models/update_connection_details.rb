...
module OCI
  ...
  class DataIntegration::Models::UpdateConnectionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::UpdateConnectionFromLake' if type == 'LAKE_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromOracleEbs' if type == 'ORACLE_EBS_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::UpdateConnectionFromRestNoAuth' if type == 'REST_NO_AUTH_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromHdfs' if type == 'HDFS_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromOAuth2' if type == 'OAUTH2_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromRestBasicAuth' if type == 'REST_BASIC_AUTH_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromOracleSiebel' if type == 'ORACLE_SIEBEL_CONNECTION'
      return 'OCI::DataIntegration::Models::UpdateConnectionFromMySqlHeatWave' if type == 'MYSQL_HEATWAVE_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::UpdateConnectionFromOraclePeopleSoft' if type == 'ORACLE_PEOPLESOFT_CONNECTION'
