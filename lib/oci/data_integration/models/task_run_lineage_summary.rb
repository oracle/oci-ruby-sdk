...
module OCI
  ...
  class DataIntegration::Models::TaskRunLineageSummary
    ...
    # @return [BOOLEAN]
    attr_accessor :is_lineage_gen_completed

    # The status of the task run.
    # @return [String]
    attr_reader :task_execution_status
    ...
    # @option attributes [BOOLEAN] :is_lineage_gen_completed The value to assign to the {#is_lineage_gen_completed} property
    # @option attributes [String] :task_execution_status The value to assign to the {#task_execution_status} property
    # @option attributes [OCI::DataIntegration::Models::DataFlow] :flow The value to assign to the {#flow} property
    ...
    # @param [Object] task_execution_status Object to be assigned
    def task_execution_status=(task_execution_status)
      # rubocop:disable Style/ConditionalAssignment
      if task_execution_status && !TASK_EXECUTION_STATUS_ENUM.include?(task_execution_status)
        OCI.logger.debug("Unknown value for 'task_execution_status' [" + task_execution_status + "]. Mapping to 'TASK_EXECUTION_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @task_execution_status = TASK_EXECUTION_STATUS_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [key, model_type, model_version, parent_ref, name, description, object_version, task_name, task_type, task_key, is_lineage_gen_completed, task_execution_status, flow, metadata].hash
    end
