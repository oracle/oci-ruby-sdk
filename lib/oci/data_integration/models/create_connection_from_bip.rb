...
module OCI
  ...
  class DataIntegration::Models::CreateConnectionFromBIP < DataIntegration::Models::CreateConnectionDetails
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_status, identifier, connection_properties, registry_metadata, username, password_secret].hash
    end
