...
module OCI
  ...
  class DataIntegration::Models::ReadOperationConfig < DataIntegration::Models::AbstractDataOperationConfig
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [OCI::DataIntegration::Models::AbstractReadAttribute] :read_attribute The value to assign to the {#read_attribute} property
    ...
    def hash
      [model_type, metadata_config_properties, derived_attributes, call_attribute, key, model_version, parent_ref, operations, data_format, partition_config, read_attribute, object_status].hash
    end
