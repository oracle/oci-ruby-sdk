...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromAtpDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromAtpDetails]
    ...
    def self.swagger_types
      {
        ...
        'driver_class': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromAtpDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromAtpDetails] :default_connection The value to assign to the {#default_connection} property
