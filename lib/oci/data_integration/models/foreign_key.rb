...
module OCI
  ...
  class DataIntegration::Models::ForeignKey < DataIntegration::Models::Key
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [OCI::DataIntegration::Models::UniqueKey] :reference_unique_key The value to assign to the {#reference_unique_key} property
