...
module OCI
  ...
  class DataIntegration::Models::FunctionLibraryDetails
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_FUNCTION_LIBRARY = 'FUNCTION_LIBRARY'.freeze
    ].freeze
    ...
    def hash
      [key, model_type, model_version, name, description, category_name, object_status, identifier, parent_ref, object_version, registry_metadata].hash
    end
