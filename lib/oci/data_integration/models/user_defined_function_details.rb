...
module OCI
  ...
  class DataIntegration::Models::UserDefinedFunctionDetails
    MODEL_TYPE_ENUM = [
    ...
    def hash
      [key, model_type, model_version, parent_ref, name, identifier, object_version, signatures, expr, description, object_status, registry_metadata].hash
    end
