...
module OCI
  ...
  class DataIntegration::Models::ConnectionFromRestBasicAuthDetails < DataIntegration::Models::ConnectionDetails
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, primary_schema, connection_properties, is_default, metadata, username, password_secret, auth_header].hash
    end
