...
module OCI
  ...
  class DataIntegration::Models::TypeSystem
    ...
    # An array of types.
    # @return [Array<OCI::DataIntegration::Models::DataType>]
    attr_accessor :types
    ...
    def self.swagger_types
      {
        ...
        'identifier': :'String',
        'types': :'Array<OCI::DataIntegration::Models::DataType>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DataIntegration::Models::DataType>] :types The value to assign to the {#types} property
