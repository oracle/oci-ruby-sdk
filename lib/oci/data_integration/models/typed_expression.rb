...
module OCI
  ...
  class DataIntegration::Models::TypedExpression < DataIntegration::Models::TypedObject
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, expression].hash
    end
