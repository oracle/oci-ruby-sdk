...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromOracleSiebel < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromOracleSiebel]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromOracleSiebel'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromOracleSiebel] :default_connection The value to assign to the {#default_connection} property
