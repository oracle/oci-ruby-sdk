...
module OCI
  ...
  class DataIntegration::Models::BaseType
    MODEL_TYPE_ENUM = [
      ...
      MODEL_TYPE_ARRAY_TYPE = 'ARRAY_TYPE'.freeze,
      MODEL_TYPE_MAP_TYPE = 'MAP_TYPE'.freeze,
      MODEL_TYPE_MATERIALIZED_COMPOSITE_TYPE = 'MATERIALIZED_COMPOSITE_TYPE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ArrayType' if type == 'ARRAY_TYPE'
      ...
      return 'OCI::DataIntegration::Models::MaterializedCompositeType' if type == 'MATERIALIZED_COMPOSITE_TYPE'
      return 'OCI::DataIntegration::Models::MapType' if type == 'MAP_TYPE'
