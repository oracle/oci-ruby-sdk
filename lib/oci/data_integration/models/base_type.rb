...
module OCI
  ...
  class DataIntegration::Models::BaseType
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_DYNAMIC_TYPE = 'DYNAMIC_TYPE'.freeze,
      MODEL_TYPE_STRUCTURED_TYPE = 'STRUCTURED_TYPE'.freeze,
      MODEL_TYPE_DATA_TYPE = 'DATA_TYPE'.freeze,
      MODEL_TYPE_JAVA_TYPE = 'JAVA_TYPE'.freeze,
      MODEL_TYPE_CONFIGURED_TYPE = 'CONFIGURED_TYPE'.freeze,
      MODEL_TYPE_COMPOSITE_TYPE = 'COMPOSITE_TYPE'.freeze,
      MODEL_TYPE_DERIVED_TYPE = 'DERIVED_TYPE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ConfiguredType' if type == 'CONFIGURED_TYPE'
      return 'OCI::DataIntegration::Models::JavaType' if type == 'JAVA_TYPE'
      return 'OCI::DataIntegration::Models::DynamicType' if type == 'DYNAMIC_TYPE'
      return 'OCI::DataIntegration::Models::DerivedType' if type == 'DERIVED_TYPE'
      return 'OCI::DataIntegration::Models::DataType' if type == 'DATA_TYPE'
      return 'OCI::DataIntegration::Models::CompositeType' if type == 'COMPOSITE_TYPE'
