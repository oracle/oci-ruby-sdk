...
module OCI
  ...
  class DataIntegration::Models::UpdateDataFlowDetails
    ...
    def hash
      [key, model_type, model_version, parent_ref, name, identifier, object_version, nodes, parameters, description, flow_config_values, object_status, registry_metadata].hash
    end
