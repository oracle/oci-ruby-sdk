...
module OCI
  ...
  class DataIntegration::Models::TypeLibrary
    ...
    # types
    # @return [Hash<String, OCI::DataIntegration::Models::DerivedType>]
    attr_accessor :types
    ...
    def self.swagger_types
      {
        ...
        'types': :'Hash<String, OCI::DataIntegration::Models::DerivedType>',
    ...
    # @option attributes [Hash<String, OCI::DataIntegration::Models::DerivedType>] :types The value to assign to the {#types} property
