...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromMySQL < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::UpdateConnectionFromMySQL]
    ...
    def self.swagger_types
      {
        ...
        'port': :'String',
        'service_name': :'String',
        'default_connection': :'OCI::DataIntegration::Models::UpdateConnectionFromMySQL'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionFromMySQL] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, host, port, service_name, default_connection].hash
    end
