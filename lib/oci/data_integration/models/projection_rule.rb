...
module OCI
  ...
  class DataIntegration::Models::ProjectionRule
    MODEL_TYPE_ENUM = [
      ...
      MODEL_TYPE_GROUPED_NAME_PATTERN_RULE = 'GROUPED_NAME_PATTERN_RULE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::GroupedNamePatternRule' if type == 'GROUPED_NAME_PATTERN_RULE'
