...
module OCI
  ...
  class DataIntegration::Models::ProjectionRule
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_NAME_PATTERN_RULE = 'NAME_PATTERN_RULE'.freeze,
      MODEL_TYPE_TYPE_LIST_RULE = 'TYPE_LIST_RULE'.freeze,
      MODEL_TYPE_NAME_LIST_RULE = 'NAME_LIST_RULE'.freeze,
      MODEL_TYPE_TYPED_NAME_PATTERN_RULE = 'TYPED_NAME_PATTERN_RULE'.freeze,
      MODEL_TYPE_RENAME_RULE = 'RENAME_RULE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::RenameRule' if type == 'RENAME_RULE'
      return 'OCI::DataIntegration::Models::TypeListRule' if type == 'TYPE_LIST_RULE'
      return 'OCI::DataIntegration::Models::TypedNamePatternRule' if type == 'TYPED_NAME_PATTERN_RULE'
      return 'OCI::DataIntegration::Models::NamePatternRule' if type == 'NAME_PATTERN_RULE'
      return 'OCI::DataIntegration::Models::NameListRule' if type == 'NAME_LIST_RULE'
    ...
    def hash
      [model_type, key, model_version, parent_ref, is_java_regex_syntax, config_values, object_status, description].hash
    end
