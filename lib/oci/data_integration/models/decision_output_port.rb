...
module OCI
  ...
  class DataIntegration::Models::DecisionOutputPort < DataIntegration::Models::TypedObject
    PORT_TYPE_ENUM = [
    ...
    # @return [String]
    attr_reader :decision_output_port_type
    ...
    # @option attributes [String] :decision_output_port_type The value to assign to the {#decision_output_port_type} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] decision_output_port_type Object to be assigned
    def decision_output_port_type=(decision_output_port_type)
      # rubocop:disable Style/ConditionalAssignment
      if decision_output_port_type && !DECISION_OUTPUT_PORT_TYPE_ENUM.include?(decision_output_port_type)
        OCI.logger.debug("Unknown value for 'decision_output_port_type' [" + decision_output_port_type + "]. Mapping to 'DECISION_OUTPUT_PORT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @decision_output_port_type = DECISION_OUTPUT_PORT_TYPE_UNKNOWN_ENUM_VALUE
      else
        @decision_output_port_type = decision_output_port_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end
