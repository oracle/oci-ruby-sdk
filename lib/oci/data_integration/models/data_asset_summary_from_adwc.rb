...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromAdwc < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromAdwc]
    ...
    def self.swagger_types
      {
        ...
        'driver_class': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromAdwc'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromAdwc] :default_connection The value to assign to the {#default_connection} property
