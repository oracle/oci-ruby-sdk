...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromOracle < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromOracle]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromOracle'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromOracle] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, host, port, service_name, driver_class, sid, credential_file_content, wallet_secret, wallet_password_secret, default_connection].hash
    end
