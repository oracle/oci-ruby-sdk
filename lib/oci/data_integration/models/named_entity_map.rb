...
module OCI
  # A named field map.
  class DataIntegration::Models::NamedEntityMap < DataIntegration::Models::FieldMap
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [String] :source_entity The value to assign to the {#source_entity} property
    # @option attributes [String] :target_entity The value to assign to the {#target_entity} property
    # @option attributes [Integer] :object_status The value to assign to the {#object_status} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'NAMED_ENTITY_MAP'
      ...
      self.source_entity = attributes[:'sourceEntity'] if attributes[:'sourceEntity']

      raise 'You cannot provide both :sourceEntity and :source_entity' if attributes.key?(:'sourceEntity') && attributes.key?(:'source_entity')

      self.source_entity = attributes[:'source_entity'] if attributes[:'source_entity']

      self.target_entity = attributes[:'targetEntity'] if attributes[:'targetEntity']

      raise 'You cannot provide both :targetEntity and :target_entity' if attributes.key?(:'targetEntity') && attributes.key?(:'target_entity')

      self.target_entity = attributes[:'target_entity'] if attributes[:'target_entity']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_entity == other.source_entity &&
        target_entity == other.target_entity &&
    ...
    def hash
      [model_type, description, key, model_version, parent_ref, config_values, source_entity, target_entity, object_status].hash
    end
