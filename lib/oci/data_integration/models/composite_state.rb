...
module OCI
  ...
  class DataIntegration::Models::CompositeState
    COMPOSITE_STATE_AGGREGATOR_ENUM = [
      COMPOSITE_STATE_AGGREGATOR_TASK_SCHEDULE = 'TASK_SCHEDULE'.freeze,
      COMPOSITE_STATE_AGGREGATOR_TASK = 'TASK'.freeze,
      COMPOSITE_STATE_AGGREGATOR_TASK_OPERATOR = 'TASK_OPERATOR'.freeze,
      COMPOSITE_STATE_AGGREGATOR_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # The type of the Composite State Aggregator.
    # @return [String]
    attr_reader :composite_state_aggregator
    ...
    # @return [Hash<String, OCI::DataIntegration::Models::State>]
    attr_accessor :all_states_map
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'composite_state_aggregator': :'String',
        'key': :'String',
        'model_type': :'String',
        ...
        'all_states_map': :'Hash<String, OCI::DataIntegration::Models::State>',
    ...
    # @option attributes [String] :composite_state_aggregator The value to assign to the {#composite_state_aggregator} property
    ...
    # @option attributes [Hash<String, OCI::DataIntegration::Models::State>] :all_states_map The value to assign to the {#all_states_map} property
    ...
    def initialize(attributes = {})
      ...
      self.composite_state_aggregator = attributes[:'compositeStateAggregator'] if attributes[:'compositeStateAggregator']

      raise 'You cannot provide both :compositeStateAggregator and :composite_state_aggregator' if attributes.key?(:'compositeStateAggregator') && attributes.key?(:'composite_state_aggregator')

      self.composite_state_aggregator = attributes[:'composite_state_aggregator'] if attributes[:'composite_state_aggregator']
      ...
      self.all_states_map = attributes[:'allStatesMap'] if attributes[:'allStatesMap']

      raise 'You cannot provide both :allStatesMap and :all_states_map' if attributes.key?(:'allStatesMap') && attributes.key?(:'all_states_map')

      self.all_states_map = attributes[:'all_states_map'] if attributes[:'all_states_map']
    ...
    # @param [Object] composite_state_aggregator Object to be assigned
    def composite_state_aggregator=(composite_state_aggregator)
      # rubocop:disable Style/ConditionalAssignment
      if composite_state_aggregator && !COMPOSITE_STATE_AGGREGATOR_ENUM.include?(composite_state_aggregator)
        OCI.logger.debug("Unknown value for 'composite_state_aggregator' [" + composite_state_aggregator + "]. Mapping to 'COMPOSITE_STATE_AGGREGATOR_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @composite_state_aggregator = COMPOSITE_STATE_AGGREGATOR_UNKNOWN_ENUM_VALUE
      else
        @composite_state_aggregator = composite_state_aggregator
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        composite_state_aggregator == other.composite_state_aggregator &&
        key == other.key &&
        ...
        all_states_map == other.all_states_map &&
    ...
    def hash
      [composite_state_aggregator, key, model_type, model_version, parent_ref, name, identifier, description, object_version, object_status, all_states_map, registry_metadata, metadata].hash
    end
