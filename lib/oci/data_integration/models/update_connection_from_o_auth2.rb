...
module OCI
  ...
  class DataIntegration::Models::UpdateConnectionFromOAuth2 < DataIntegration::Models::UpdateConnectionDetails
    GRANT_TYPE_ENUM = [
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_status, object_version, identifier, connection_properties, registry_metadata, access_token_url, client_id, client_secret, scope, grant_type].hash
    end
