...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromRest < DataIntegration::Models::CreateDataAssetDetails
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, base_url, manifest_file_content, default_connection].hash
    end
