...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromAtp < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::UpdateConnectionFromAtp]
    ...
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionFromAtp] :default_connection The value to assign to the {#default_connection} property
