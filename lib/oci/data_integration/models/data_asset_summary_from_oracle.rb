...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromOracle < DataIntegration::Models::DataAssetSummary
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, host, port, service_name, driver_class, sid, credential_file_content, default_connection].hash
    end
