...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromOracle < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromOracle]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromOracle'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromOracle] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, host, port, service_name, driver_class, sid, credential_file_content, wallet_secret, wallet_password_secret, default_connection].hash
    end
