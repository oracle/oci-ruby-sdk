...
module OCI
  ...
  class DataIntegration::Models::UpdateConnectionFromBICC < DataIntegration::Models::UpdateConnectionDetails
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_status, object_version, identifier, connection_properties, registry_metadata, username, password_secret, default_external_storage].hash
    end
