...
module OCI
  ...
  class DataIntegration::Models::CreatePipelineValidationDetails
    ...
    def hash
      [key, model_version, parent_ref, name, description, model_type, object_version, object_status, identifier, nodes, parameters, flow_config_values, variables, metadata].hash
    end
