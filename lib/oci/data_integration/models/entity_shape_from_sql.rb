...
module OCI
  ...
  class DataIntegration::Models::EntityShapeFromSQL < DataIntegration::Models::EntityShape
    ENTITY_TYPE_ENUM = [
    ...
    # @option attributes [OCI::DataIntegration::Models::ObjectMetadata] :metadata The value to assign to the {OCI::DataIntegration::Models::EntityShape#metadata #metadata} proprety
