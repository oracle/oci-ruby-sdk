...
module OCI
  ...
  class DataIntegration::Models::PartitionConfig
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::KeyRangePartitionConfig' if type == 'KEYRANGEPARTITIONCONFIG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::PartitionConfig'
    end
