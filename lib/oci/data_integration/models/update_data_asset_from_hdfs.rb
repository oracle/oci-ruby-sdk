...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromHdfs < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::UpdateConnectionFromHdfs]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::UpdateConnectionFromHdfs'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionFromHdfs] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, host, port, protocol, validate_certificate, default_connection].hash
    end
