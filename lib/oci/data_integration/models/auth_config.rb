...
module OCI
  ...
  class DataIntegration::Models::AuthConfig
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_OCI_RESOURCE_AUTH_CONFIG = 'OCI_RESOURCE_AUTH_CONFIG'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ResourcePrincipalAuthConfig' if type == 'OCI_RESOURCE_AUTH_CONFIG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::AuthConfig'
    end
