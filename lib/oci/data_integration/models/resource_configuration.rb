...
module OCI
  ...
  class DataIntegration::Models::ResourceConfiguration
    ...
    # @option attributes [Integer] :total_executors The value to assign to the {#total_executors} property
    def initialize(attributes = {})
      ...
      self.total_executors = attributes[:'totalExecutors'] if attributes[:'totalExecutors']

      raise 'You cannot provide both :totalExecutors and :total_executors' if attributes.key?(:'totalExecutors') && attributes.key?(:'total_executors')

      self.total_executors = attributes[:'total_executors'] if attributes[:'total_executors']
    end
    ...
    def hash
      [spark_version, driver_shape, executor_shape, total_executors].hash
    end
