...
module OCI
  ...
  class DataIntegration::Models::WorkspaceSummary
    ...
    def hash
      [id, description, display_name, compartment_id, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, state_message, endpoint_name, endpoint_id, registry_id].hash
    end
