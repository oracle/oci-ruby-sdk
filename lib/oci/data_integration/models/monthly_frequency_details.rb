...
module OCI
  ...
  class DataIntegration::Models::MonthlyFrequencyDetails < DataIntegration::Models::AbstractFrequencyDetails
    ...
    # @option attributes [Array<Integer>] :days The value to assign to the {#days} property
