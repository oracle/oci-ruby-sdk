...
module OCI
  ...
  class DataIntegration::Models::LastRunDetails
    ...
    # @return [Integer]
    attr_accessor :last_run_time_millis
    ...
    # @option attributes [Integer] :last_run_time_millis The value to assign to the {#last_run_time_millis} property
    def initialize(attributes = {})
      ...
      self.last_run_time_millis = attributes[:'lastRunTimeMillis'] if attributes[:'lastRunTimeMillis']

      raise 'You cannot provide both :lastRunTimeMillis and :last_run_time_millis' if attributes.key?(:'lastRunTimeMillis') && attributes.key?(:'last_run_time_millis')

      self.last_run_time_millis = attributes[:'last_run_time_millis'] if attributes[:'last_run_time_millis']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        last_run_time_millis == other.last_run_time_millis
    end
    ...
    def hash
      [key, model_version, model_type, parent_ref, name, description, object_version, object_status, identifier, last_run_time_millis].hash
    end
