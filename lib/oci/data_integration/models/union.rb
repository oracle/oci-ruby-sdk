...
module OCI
  ...
  class DataIntegration::Models::Union < DataIntegration::Models::Operator
    UNION_TYPE_ENUM = [
      UNION_TYPE_NAME = 'NAME'.freeze,
      UNION_TYPE_POSITION = 'POSITION'.freeze,
      UNION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :union_type The value to assign to the {#union_type} property
    ...
    # @param [Object] union_type Object to be assigned
