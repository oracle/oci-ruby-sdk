...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromOracleDetails < DataIntegration::Models::DataAsset
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, host, port, service_name, driver_class, sid, credential_file_content, wallet_secret, wallet_password_secret, default_connection].hash
    end
