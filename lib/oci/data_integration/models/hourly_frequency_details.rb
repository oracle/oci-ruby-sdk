...
module OCI
  ...
  class DataIntegration::Models::HourlyFrequencyDetails < DataIntegration::Models::AbstractFrequencyDetails
    ...
    def hash
      [model_type, frequency, interval, time].hash
    end
