...
module OCI
  ...
  class DataIntegration::Models::UpdateScheduleDetails
    ...
    # @return [OCI::DataIntegration::Models::AbstractFrequencyDetails]
    attr_accessor :frequency_details
    ...
    # @return [BOOLEAN]
    attr_accessor :is_daylight_adjustment_enabled
    ...
    # @option attributes [OCI::DataIntegration::Models::AbstractFrequencyDetails] :frequency_details The value to assign to the {#frequency_details} property
    # @option attributes [String] :timezone The value to assign to the {#timezone} property
    # @option attributes [BOOLEAN] :is_daylight_adjustment_enabled The value to assign to the {#is_daylight_adjustment_enabled} property
    ...
    def initialize(attributes = {})
      ...
      self.frequency_details = attributes[:'frequencyDetails'] if attributes[:'frequencyDetails']

      raise 'You cannot provide both :frequencyDetails and :frequency_details' if attributes.key?(:'frequencyDetails') && attributes.key?(:'frequency_details')

      self.frequency_details = attributes[:'frequency_details'] if attributes[:'frequency_details']

      self.timezone = attributes[:'timezone'] if attributes[:'timezone']

      self.is_daylight_adjustment_enabled = attributes[:'isDaylightAdjustmentEnabled'] unless attributes[:'isDaylightAdjustmentEnabled'].nil?

      raise 'You cannot provide both :isDaylightAdjustmentEnabled and :is_daylight_adjustment_enabled' if attributes.key?(:'isDaylightAdjustmentEnabled') && attributes.key?(:'is_daylight_adjustment_enabled')

      self.is_daylight_adjustment_enabled = attributes[:'is_daylight_adjustment_enabled'] unless attributes[:'is_daylight_adjustment_enabled'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        frequency_details == other.frequency_details &&
        timezone == other.timezone &&
        is_daylight_adjustment_enabled == other.is_daylight_adjustment_enabled &&
    ...
    def hash
      [key, model_version, model_type, parent_ref, name, description, object_version, object_status, identifier, frequency_details, timezone, is_daylight_adjustment_enabled, registry_metadata].hash
    end
