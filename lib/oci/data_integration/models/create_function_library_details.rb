...
module OCI
  ...
  class DataIntegration::Models::CreateFunctionLibraryDetails
    ...
    def hash
      [key, model_version, name, description, category_name, object_status, identifier, registry_metadata].hash
    end
