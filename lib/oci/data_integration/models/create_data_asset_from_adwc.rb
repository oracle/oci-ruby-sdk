...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromAdwc < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromAdwc]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromAdwc'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromAdwc] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, service_name, driver_class, credential_file_content, wallet_secret, wallet_password_secret, region_id, tenancy_id, compartment_id, autonomous_db_id, default_connection].hash
    end
