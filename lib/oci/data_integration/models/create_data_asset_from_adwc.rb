...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromAdwc < DataIntegration::Models::CreateDataAssetDetails
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, service_name, driver_class, credential_file_content, wallet_secret, wallet_password_secret, region_id, tenancy_id, compartment_id, autonomous_db_id, default_connection, staging_data_asset, staging_connection, bucket_schema].hash
    end
