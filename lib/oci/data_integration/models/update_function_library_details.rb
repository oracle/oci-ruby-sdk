...
module OCI
  ...
  class DataIntegration::Models::UpdateFunctionLibraryDetails
    ...
    def hash
      [name, description, category_name, object_status, identifier, model_version, object_version, registry_metadata].hash
    end
