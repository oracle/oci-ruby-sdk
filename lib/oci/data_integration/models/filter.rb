...
module OCI
  ...
  class DataIntegration::Models::Filter < DataIntegration::Models::Operator
    ...
    def self.swagger_types
      {
        ...
        'filter_condition': :'OCI::DataIntegration::Models::Expression'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::Expression] :filter_condition The value to assign to the {#filter_condition} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'FILTER_OPERATOR'
      ...
      self.filter_condition = attributes[:'filterCondition'] if attributes[:'filterCondition']

      raise 'You cannot provide both :filterCondition and :filter_condition' if attributes.key?(:'filterCondition') && attributes.key?(:'filter_condition')

      self.filter_condition = attributes[:'filter_condition'] if attributes[:'filter_condition']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        filter_condition == other.filter_condition
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, input_ports, output_ports, object_status, identifier, parameters, op_config_values, filter_condition].hash
    end
