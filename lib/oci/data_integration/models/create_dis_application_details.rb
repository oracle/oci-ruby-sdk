...
module OCI
  ...
  class DataIntegration::Models::CreateDisApplicationDetails
    ...
    def hash
      [compartment_id, key, model_version, model_type, name, description, object_status, identifier, display_name, freeform_tags, defined_tags, lifecycle_state, source_application_info, registry_metadata].hash
    end
