...
module OCI
  ...
  class DataIntegration::Models::IncrementalFieldClause
    ...
    # @return [String]
    attr_accessor :incremental_field_name

    # **[Required]** Value of incremental field filter.
    # @return [Hash<String, String>]
    attr_accessor :incremental_field_value
    ...
    # @option attributes [String] :incremental_field_name The value to assign to the {#incremental_field_name} property
    # @option attributes [Hash<String, String>] :incremental_field_value The value to assign to the {#incremental_field_value} property
