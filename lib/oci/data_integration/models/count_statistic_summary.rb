...
module OCI
  ...
  class DataIntegration::Models::CountStatisticSummary
    OBJECT_TYPE_ENUM = [
      OBJECT_TYPE_PROJECT = 'PROJECT'.freeze,
      OBJECT_TYPE_FOLDER = 'FOLDER'.freeze,
      OBJECT_TYPE_DATA_FLOW = 'DATA_FLOW'.freeze,
      OBJECT_TYPE_DATA_ASSET = 'DATA_ASSET'.freeze,
      OBJECT_TYPE_CONNECTION = 'CONNECTION'.freeze,
      OBJECT_TYPE_TASK = 'TASK'.freeze,
      OBJECT_TYPE_APPLICATION = 'APPLICATION'.freeze,
      OBJECT_TYPE_FUNCTION_LIBRARY = 'FUNCTION_LIBRARY'.freeze,
      OBJECT_TYPE_USER_DEFINED_FUNCTION = 'USER_DEFINED_FUNCTION'.freeze,
