...
module OCI
  ...
  class DataIntegration::Models::DetailedDescription
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_DETAILED_DESCRIPTION = 'DETAILED_DESCRIPTION'.freeze,
    ...
    # @option attributes [String] :logo The value to assign to the {#logo} property
    # @option attributes [String] :detailed_description The value to assign to the {#detailed_description} property
    def initialize(attributes = {})
      ...
      self.detailed_description = attributes[:'detailedDescription'] if attributes[:'detailedDescription']

      raise 'You cannot provide both :detailedDescription and :detailed_description' if attributes.key?(:'detailedDescription') && attributes.key?(:'detailed_description')

      self.detailed_description = attributes[:'detailed_description'] if attributes[:'detailed_description']
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, object_version, object_status, identifier, metadata, logo, detailed_description].hash
    end
