...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromOracle < DataIntegration::Models::UpdateDataAssetDetails
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, host, port, service_name, driver_class, sid, credential_file_content, default_connection].hash
    end
