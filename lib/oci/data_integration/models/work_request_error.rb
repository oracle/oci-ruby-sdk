...
module OCI
  ...
  class DataIntegration::Models::WorkRequestError
    # **[Required]** A machine-usable code for the error that occured, as listed in [API Errors](https://docs.cloud.oracle.com/Content/API/References/apierrors.htm).
    #
    # @return [String]
    attr_accessor :code
