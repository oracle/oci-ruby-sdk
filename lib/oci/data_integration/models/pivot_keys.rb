...
module OCI
  ...
  class DataIntegration::Models::PivotKeys
    ...
    # @return [Array<String>]
    attr_accessor :pivot_axis

    # Map of alias to pivot key values.
    # @return [Hash<String, Array<String>>]
    attr_accessor :pivot_key_value_map
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'pivot_axis': :'Array<String>',
        'pivot_key_value_map': :'Hash<String, Array<String>>',
        'key': :'String',
        'model_type': :'String',
    ...
    # @option attributes [Array<String>] :pivot_axis The value to assign to the {#pivot_axis} property
    # @option attributes [Hash<String, Array<String>>] :pivot_key_value_map The value to assign to the {#pivot_key_value_map} property
    ...
    def initialize(attributes = {})
      ...
      self.pivot_axis = attributes[:'pivotAxis'] if attributes[:'pivotAxis']

      raise 'You cannot provide both :pivotAxis and :pivot_axis' if attributes.key?(:'pivotAxis') && attributes.key?(:'pivot_axis')

      self.pivot_axis = attributes[:'pivot_axis'] if attributes[:'pivot_axis']

      self.pivot_key_value_map = attributes[:'pivotKeyValueMap'] if attributes[:'pivotKeyValueMap']

      raise 'You cannot provide both :pivotKeyValueMap and :pivot_key_value_map' if attributes.key?(:'pivotKeyValueMap') && attributes.key?(:'pivot_key_value_map')

      self.pivot_key_value_map = attributes[:'pivot_key_value_map'] if attributes[:'pivot_key_value_map']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        pivot_axis == other.pivot_axis &&
        pivot_key_value_map == other.pivot_key_value_map &&
        key == other.key &&
    ...
    def hash
      [pivot_axis, pivot_key_value_map, key, model_type, model_version, parent_ref, object_status].hash
    end
