...
module OCI
  ...
  class DataIntegration::Models::EntityShape
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::EntityShapeFromSQL' if type == 'SQL_ENTITY'
      return 'OCI::DataIntegration::Models::EntityShapeFromFile' if type == 'FILE_ENTITY'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::EntityShape'
    end
