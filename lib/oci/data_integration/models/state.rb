...
module OCI
  ...
  class DataIntegration::Models::State
    # A simple name for the State.
    # @return [String]
    attr_accessor :name

    # @return [OCI::DataIntegration::Models::ParameterValue]
    ...
    # @option attributes [OCI::DataIntegration::Models::ParameterValue] :parameter_value The value to assign to the {#parameter_value} property
    # @option attributes [DateTime] :time_value The value to assign to the {#time_value} property
    def initialize(attributes = {})
      ...
      self.time_value = attributes[:'timeValue'] if attributes[:'timeValue']

      raise 'You cannot provide both :timeValue and :time_value' if attributes.key?(:'timeValue') && attributes.key?(:'time_value')

      self.time_value = attributes[:'time_value'] if attributes[:'time_value']
    end
    ...
    def hash
      [name, parameter_value, time_value].hash
    end
