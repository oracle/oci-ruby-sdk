...
module OCI
  ...
  class DataIntegration::Models::Pivot < DataIntegration::Models::Operator
    ...
    attr_accessor :materialized_group_by_columns
    ...
    # @option attributes [OCI::DataIntegration::Models::MaterializedDynamicField] :materialized_group_by_columns The value to assign to the {#materialized_group_by_columns} property
    ...
    def initialize(attributes = {})
      ...
      self.materialized_group_by_columns = attributes[:'materializedGroupByColumns'] if attributes[:'materializedGroupByColumns']

      raise 'You cannot provide both :materializedGroupByColumns and :materialized_group_by_columns' if attributes.key?(:'materializedGroupByColumns') && attributes.key?(:'materialized_group_by_columns')

      self.materialized_group_by_columns = attributes[:'materialized_group_by_columns'] if attributes[:'materialized_group_by_columns']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        materialized_group_by_columns == other.materialized_group_by_columns &&
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, input_ports, output_ports, object_status, identifier, parameters, op_config_values, group_by_columns, materialized_group_by_columns, pivot_keys].hash
    end
