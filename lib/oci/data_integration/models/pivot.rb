...
module OCI
  ...
  class DataIntegration::Models::Pivot < DataIntegration::Models::Operator
    # @return [OCI::DataIntegration::Models::DynamicProxyField]
    attr_accessor :group_by_columns

    # @return [OCI::DataIntegration::Models::PivotKeys]
    attr_accessor :pivot_keys
    ...
    def self.swagger_types
      {
        ...
        'pivot_keys': :'OCI::DataIntegration::Models::PivotKeys'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::DynamicProxyField] :group_by_columns The value to assign to the {#group_by_columns} property
    # @option attributes [OCI::DataIntegration::Models::PivotKeys] :pivot_keys The value to assign to the {#pivot_keys} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'PIVOT_OPERATOR'
      ...
      self.group_by_columns = attributes[:'groupByColumns'] if attributes[:'groupByColumns']

      raise 'You cannot provide both :groupByColumns and :group_by_columns' if attributes.key?(:'groupByColumns') && attributes.key?(:'group_by_columns')

      self.group_by_columns = attributes[:'group_by_columns'] if attributes[:'group_by_columns']

      self.pivot_keys = attributes[:'pivotKeys'] if attributes[:'pivotKeys']

      raise 'You cannot provide both :pivotKeys and :pivot_keys' if attributes.key?(:'pivotKeys') && attributes.key?(:'pivot_keys')

      self.pivot_keys = attributes[:'pivot_keys'] if attributes[:'pivot_keys']
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, input_ports, output_ports, object_status, identifier, parameters, op_config_values, group_by_columns, pivot_keys].hash
    end
