...
module OCI
  ...
  class DataIntegration::Models::ConnectionSummaryFromOAuth2 < DataIntegration::Models::ConnectionSummary
    GRANT_TYPE_ENUM = [
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, primary_schema, connection_properties, is_default, metadata, key_map, access_token_url, client_id, client_secret, scope, grant_type].hash
    end
