...
module OCI
  ...
  class DataIntegration::Models::CreateConnectionValidationDetails
    # @return [OCI::DataIntegration::Models::CreateDataAssetDetails]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'data_asset': :'OCI::DataIntegration::Models::CreateDataAssetDetails',
        'connection': :'OCI::DataIntegration::Models::CreateConnectionDetails',
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateDataAssetDetails] :data_asset The value to assign to the {#data_asset} property
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionDetails] :connection The value to assign to the {#connection} property
