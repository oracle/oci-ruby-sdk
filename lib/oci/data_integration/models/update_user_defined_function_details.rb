...
module OCI
  ...
  class DataIntegration::Models::UpdateUserDefinedFunctionDetails
    ...
    def hash
      [parent_ref, name, identifier, model_version, object_version, signatures, expr, description, object_status, registry_metadata].hash
    end
