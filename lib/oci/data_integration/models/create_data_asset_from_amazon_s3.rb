...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromAmazonS3 < DataIntegration::Models::CreateDataAssetDetails
    # The region for Amazon s3
    # @return [String]
    attr_accessor :region

    # @return [OCI::DataIntegration::Models::CreateConnectionFromAmazonS3]
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromAmazonS3] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, region, default_connection].hash
    end
