...
module OCI
  ...
  class DataIntegration::Models::CreateScheduleDetails
    ...
    def hash
      [key, model_version, name, description, object_version, object_status, identifier, frequency_details, timezone, is_daylight_adjustment_enabled, registry_metadata].hash
    end
