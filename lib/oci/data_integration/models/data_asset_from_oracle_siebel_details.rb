...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromOracleSiebelDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromOracleSiebelDetails]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromOracleSiebelDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromOracleSiebelDetails] :default_connection The value to assign to the {#default_connection} property
