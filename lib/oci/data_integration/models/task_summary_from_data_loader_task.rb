...
module OCI
  ...
  class DataIntegration::Models::TaskSummaryFromDataLoaderTask < DataIntegration::Models::TaskSummary
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, input_ports, output_ports, parameters, op_config_values, config_provider_delegate, metadata, key_map, data_flow, conditional_composite_field_map, is_single_load, parallel_load_limit].hash
    end
