...
module OCI
  ...
  class DataIntegration::Models::ParameterValue
    ...
    # @option attributes [Object] :simple_value The value to assign to the {#simple_value} property
    ...
    def initialize(attributes = {})
      ...
      self.simple_value = attributes[:'simpleValue'] if attributes[:'simpleValue']

      raise 'You cannot provide both :simpleValue and :simple_value' if attributes.key?(:'simpleValue') && attributes.key?(:'simple_value')

      self.simple_value = attributes[:'simple_value'] if attributes[:'simple_value']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        simple_value == other.simple_value &&
    ...
    def hash
      [simple_value, root_object_value].hash
    end
