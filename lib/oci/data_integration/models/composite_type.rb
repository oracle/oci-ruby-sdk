...
module OCI
  ...
  class DataIntegration::Models::CompositeType < DataIntegration::Models::BaseType
    # @return [OCI::DataIntegration::Models::CompositeType]
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'parent_type': :'OCI::DataIntegration::Models::CompositeType',
        'elements': :'Array<OCI::DataIntegration::Models::TypedObject>',
    ...
    # @option attributes [OCI::DataIntegration::Models::CompositeType] :parent_type The value to assign to the {#parent_type} property
    # @option attributes [Array<OCI::DataIntegration::Models::TypedObject>] :elements The value to assign to the {#elements} property
