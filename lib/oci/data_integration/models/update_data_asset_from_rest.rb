...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromRest < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [String]
    attr_accessor :manifest_file_content

    # This attribute is required.
    # @return [OCI::DataIntegration::Models::UpdateConnectionDetails]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::UpdateConnectionDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :manifest_file_content The value to assign to the {#manifest_file_content} property
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionDetails] :default_connection The value to assign to the {#default_connection} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'REST_DATA_ASSET'
      ...
      self.manifest_file_content = attributes[:'manifestFileContent'] if attributes[:'manifestFileContent']

      raise 'You cannot provide both :manifestFileContent and :manifest_file_content' if attributes.key?(:'manifestFileContent') && attributes.key?(:'manifest_file_content')

      self.manifest_file_content = attributes[:'manifest_file_content'] if attributes[:'manifest_file_content']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        manifest_file_content == other.manifest_file_content &&
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, base_url, manifest_file_content, default_connection].hash
    end
