...
module OCI
  ...
  class DataIntegration::Models::FunctionConfigurationDefinition
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_CONFIG_DEFINITION = 'CONFIG_DEFINITION'.freeze,
    ...
    attr_accessor :config_param_defs
    ...
    def self.swagger_types
      {
        ...
        'config_param_defs': :'Hash<String, OCI::DataIntegration::Models::ConfigParameterDefinition>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, OCI::DataIntegration::Models::ConfigParameterDefinition>] :config_param_defs The value to assign to the {#config_param_defs} property
    def initialize(attributes = {})
      ...
      self.model_type = "CONFIG_DEFINITION" if model_type.nil? && !attributes.key?(:'modelType') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :modelType and :model_type' if attributes.key?(:'modelType') && attributes.key?(:'model_type')

      self.model_type = attributes[:'model_type'] if attributes[:'model_type']
      self.model_type = "CONFIG_DEFINITION" if model_type.nil? && !attributes.key?(:'modelType') && !attributes.key?(:'model_type') # rubocop:disable Style/StringLiterals
      ...
      self.config_param_defs = attributes[:'configParamDefs'] if attributes[:'configParamDefs']

      raise 'You cannot provide both :configParamDefs and :config_param_defs' if attributes.key?(:'configParamDefs') && attributes.key?(:'config_param_defs')

      self.config_param_defs = attributes[:'config_param_defs'] if attributes[:'config_param_defs']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        config_param_defs == other.config_param_defs
    end
    ...
    def hash
      [key, model_type, model_version, parent_ref, is_contained, config_param_defs].hash
    end
