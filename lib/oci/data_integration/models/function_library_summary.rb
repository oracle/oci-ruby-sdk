...
module OCI
  ...
  class DataIntegration::Models::FunctionLibrarySummary
    MODEL_TYPE_ENUM = [
    ...
    def hash
      [key, model_type, model_version, name, description, category_name, object_status, identifier, parent_ref, object_version, metadata, key_map].hash
    end
