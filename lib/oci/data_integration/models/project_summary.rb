...
module OCI
  ...
  class DataIntegration::Models::ProjectSummary
    ...
    def hash
      [key, model_type, model_version, name, description, object_status, identifier, object_version, parent_ref, metadata, key_map].hash
    end
