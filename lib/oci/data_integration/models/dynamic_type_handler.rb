...
module OCI
  ...
  class DataIntegration::Models::DynamicTypeHandler
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_RULE_TYPE_CONFIGS = 'RULE_TYPE_CONFIGS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::RuleTypeConfig' if type == 'RULE_TYPE_CONFIGS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::DynamicTypeHandler'
    end
