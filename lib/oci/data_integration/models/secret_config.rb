...
module OCI
  ...
  class DataIntegration::Models::SecretConfig
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_OCI_VAULT_SECRET_CONFIG = 'OCI_VAULT_SECRET_CONFIG'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::OciVaultSecretConfig' if type == 'OCI_VAULT_SECRET_CONFIG'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::SecretConfig'
    end
