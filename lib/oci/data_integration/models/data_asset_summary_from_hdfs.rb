...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromHdfs < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromHdfs]
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromHdfs] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, host, port, protocol, validate_certificate, default_connection].hash
    end
