...
module OCI
  # An expression node.
  class DataIntegration::Models::Expression
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    # @option attributes [String] :expr_string The value to assign to the {#expr_string} property
    ...
    def initialize(attributes = {})
      ...
      self.expr_string = attributes[:'exprString'] if attributes[:'exprString']

      raise 'You cannot provide both :exprString and :expr_string' if attributes.key?(:'exprString') && attributes.key?(:'expr_string')

      self.expr_string = attributes[:'expr_string'] if attributes[:'expr_string']
    ...
    def hash
      [key, model_type, model_version, parent_ref, expr_string, config_values, object_status].hash
    end
