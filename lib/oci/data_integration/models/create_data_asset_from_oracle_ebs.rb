...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromOracleEbs < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromOracleEbs]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromOracleEbs'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromOracleEbs] :default_connection The value to assign to the {#default_connection} property
