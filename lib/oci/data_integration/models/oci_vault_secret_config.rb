...
module OCI
  ...
  class DataIntegration::Models::OciVaultSecretConfig < DataIntegration::Models::SecretConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'OCI_VAULT_SECRET_CONFIG'
