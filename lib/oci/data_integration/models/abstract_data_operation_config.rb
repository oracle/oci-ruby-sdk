...
module OCI
  ...
  class DataIntegration::Models::AbstractDataOperationConfig
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::WriteOperationConfig' if type == 'WRITE_OPERATION_CONFIG'
      return 'OCI::DataIntegration::Models::ReadOperationConfig' if type == 'READ_OPERATION_CONFIG'
