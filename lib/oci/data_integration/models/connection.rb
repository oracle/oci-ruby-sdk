...
module OCI
  ...
  class DataIntegration::Models::Connection
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromOAuth2' if type == 'OAUTH2_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromMySqlHeatWave' if type == 'MYSQL_HEATWAVE_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromRestBasicAuth' if type == 'REST_BASIC_AUTH_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromOraclePeopleSoft' if type == 'ORACLE_PEOPLESOFT_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromHdfs' if type == 'HDFS_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromOracleEbs' if type == 'ORACLE_EBS_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromOracleSiebel' if type == 'ORACLE_SIEBEL_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromRestNoAuth' if type == 'REST_NO_AUTH_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromLake' if type == 'LAKE_CONNECTION'
