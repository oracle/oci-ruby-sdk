...
module OCI
  ...
  class DataIntegration::Models::Connection
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromObjectStorage' if type == 'ORACLE_OBJECT_STORAGE_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromAdwc' if type == 'ORACLE_ADWC_CONNECTION'
      ...
      'OCI::DataIntegration::Models::Connection'
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, primary_schema, connection_properties, is_default, metadata, key_map].hash
    end
