...
module OCI
  ...
  class DataIntegration::Models::ChildReference
    TYPE_ENUM = [
      TYPE_ORACLEDB_CONNECTION = 'ORACLEDB_CONNECTION'.freeze,
      TYPE_ORACLE_OBJECT_STORAGE_CONNECTION = 'ORACLE_OBJECT_STORAGE_CONNECTION'.freeze,
      TYPE_ORACLE_ATP_CONNECTION = 'ORACLE_ATP_CONNECTION'.freeze,
      TYPE_ORACLE_ADWC_CONNECTION = 'ORACLE_ADWC_CONNECTION'.freeze,
      TYPE_MYSQL_CONNECTION = 'MYSQL_CONNECTION'.freeze,
      TYPE_GENERIC_JDBC_CONNECTION = 'GENERIC_JDBC_CONNECTION'.freeze,
      TYPE_BIP_CONNECTION = 'BIP_CONNECTION'.freeze,
      TYPE_BICC_CONNECTION = 'BICC_CONNECTION'.freeze,
      TYPE_AMAZON_S3_CONNECTION = 'AMAZON_S3_CONNECTION'.freeze,
    ...
    def hash
      [key, name, identifier, identifier_path, description, type, target_object, aggregator_key, used_by].hash
    end
