...
module OCI
  ...
  class DataIntegration::Models::FlowPortLink
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_CONDITIONAL_INPUT_LINK = 'CONDITIONAL_INPUT_LINK'.freeze,
      MODEL_TYPE_OUTPUT_LINK = 'OUTPUT_LINK'.freeze,
      MODEL_TYPE_INPUT_LINK = 'INPUT_LINK'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::InputLink' if type == 'INPUT_LINK'
      return 'OCI::DataIntegration::Models::OutputLink' if type == 'OUTPUT_LINK'
      return 'OCI::DataIntegration::Models::ConditionalInputLink' if type == 'CONDITIONAL_INPUT_LINK'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::FlowPortLink'
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, object_status, description, port].hash
    end
