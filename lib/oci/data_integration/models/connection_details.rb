...
module OCI
  ...
  class DataIntegration::Models::ConnectionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromRestNoAuthDetails' if type == 'REST_NO_AUTH_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromOracleSiebelDetails' if type == 'ORACLE_SIEBEL_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromHdfsDetails' if type == 'HDFS_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromMySQLDetails' if type == 'MYSQL_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromMySqlHeatWaveDetails' if type == 'MYSQL_HEATWAVE_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromAtpDetails' if type == 'ORACLE_ATP_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromOraclePeopleSoftDetails' if type == 'ORACLE_PEOPLESOFT_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromRestBasicAuthDetails' if type == 'REST_BASIC_AUTH_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromOAuth2Details' if type == 'OAUTH2_CONNECTION'
      ...
      return 'OCI::DataIntegration::Models::ConnectionFromOracleEbsDetails' if type == 'ORACLE_EBS_CONNECTION'
      return 'OCI::DataIntegration::Models::ConnectionFromLakeDetails' if type == 'LAKE_CONNECTION'
