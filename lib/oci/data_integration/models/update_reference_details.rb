...
module OCI
  ...
  class DataIntegration::Models::UpdateReferenceDetails
    ...
    # @return [Array<OCI::DataIntegration::Models::ChildReferenceDetail>]
    ...
    # @option attributes [Array<OCI::DataIntegration::Models::ChildReferenceDetail>] :child_references The value to assign to the {#child_references} property
    ...
    def hash
      [options, target_object, child_references].hash
    end
