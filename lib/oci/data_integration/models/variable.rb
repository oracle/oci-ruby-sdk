...
module OCI
  ...
  class DataIntegration::Models::Variable
    ...
    # @return [OCI::DataIntegration::Models::RootObject]
    ...
    def self.swagger_types
      {
        ...
        'root_object_default_value': :'OCI::DataIntegration::Models::RootObject'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::RootObject] :root_object_default_value The value to assign to the {#root_object_default_value} property
    ...
    def hash
      [key, model_version, model_type, parent_ref, name, description, object_version, object_status, identifier, type, config_values, default_value, root_object_default_value].hash
    end
