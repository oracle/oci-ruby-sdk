...
module OCI
  ...
  class DataIntegration::Models::TaskRunLineageDetails
    ...
    def task_execution_status=(task_execution_status)
      raise "Invalid value for 'task_execution_status': this must be one of the values in TASK_EXECUTION_STATUS_ENUM." if task_execution_status && !TASK_EXECUTION_STATUS_ENUM.include?(task_execution_status)
