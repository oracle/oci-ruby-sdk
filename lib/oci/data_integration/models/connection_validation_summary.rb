...
module OCI
  ...
  class DataIntegration::Models::ConnectionValidationSummary
    # @return [OCI::DataIntegration::Models::Message]
    ...
    # @option attributes [OCI::DataIntegration::Models::Message] :validation_message The value to assign to the {#validation_message} property
    ...
    def hash
      [validation_message, key, model_type, model_version, parent_ref, name, description, object_version, object_status, identifier, metadata].hash
    end
