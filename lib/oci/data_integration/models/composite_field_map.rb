...
module OCI
  ...
  class DataIntegration::Models::CompositeFieldMap < DataIntegration::Models::FieldMap
    # The object key.
    # @return [String]
    attr_accessor :key
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'COMPOSITE_FIELD_MAP'
    ...
    def hash
      [model_type, description, key, model_version, parent_ref, config_values, object_status, field_maps].hash
    end
