...
module OCI
  ...
  class DataIntegration::Models::PublishedObjectSummary
    MODEL_TYPE_ENUM = [
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, metadata].hash
    end
