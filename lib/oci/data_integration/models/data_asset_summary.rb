...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummary
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromMySQL' if type == 'MYSQL_DATA_ASSET'
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata].hash
    end
