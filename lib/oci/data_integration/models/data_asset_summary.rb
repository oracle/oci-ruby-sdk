...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromOracleSiebel' if type == 'ORACLE_SIEBEL_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromMySqlHeatWave' if type == 'MYSQL_HEATWAVE_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromMySQL' if type == 'MYSQL_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromHdfs' if type == 'HDFS_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromAmazonS3' if type == 'AMAZON_S3_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromOraclePeopleSoft' if type == 'ORACLE_PEOPLESOFT_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromObjectStorage' if type == 'ORACLE_OBJECT_STORAGE_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromLake' if type == 'LAKE_DATA_ASSET'
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromRest' if type == 'REST_DATA_ASSET'
      ...
      return 'OCI::DataIntegration::Models::DataAssetSummaryFromOracleEbs' if type == 'ORACLE_EBS_DATA_ASSET'
