...
module OCI
  ...
  class DataIntegration::Models::AbstractCallAttribute
    MODEL_TYPE_ENUM = [
      MODEL_TYPE_BIP_CALL_ATTRIBUTE = 'BIP_CALL_ATTRIBUTE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::BipCallAttribute' if type == 'BIP_CALL_ATTRIBUTE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::AbstractCallAttribute'
    end
