...
module OCI
  ...
  class DataIntegration::Models::AbstractCallAttribute
    MODEL_TYPE_ENUM = [
      ...
      MODEL_TYPE_GENERIC_REST_CALL_ATTRIBUTE = 'GENERIC_REST_CALL_ATTRIBUTE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::GenericRestCallAttribute' if type == 'GENERIC_REST_CALL_ATTRIBUTE'
