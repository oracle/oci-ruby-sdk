...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::CreateDataAssetFromHdfs' if type == 'HDFS_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromLake' if type == 'LAKE_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromMySqlHeatWave' if type == 'MYSQL_HEATWAVE_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromAmazonS3' if type == 'AMAZON_S3_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromRest' if type == 'REST_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromOracleSiebel' if type == 'ORACLE_SIEBEL_DATA_ASSET'
      ...
      return 'OCI::DataIntegration::Models::CreateDataAssetFromOracleEbs' if type == 'ORACLE_EBS_DATA_ASSET'
      return 'OCI::DataIntegration::Models::CreateDataAssetFromOraclePeopleSoft' if type == 'ORACLE_PEOPLESOFT_DATA_ASSET'
