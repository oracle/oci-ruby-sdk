...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetDetails
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::CreateDataAssetFromJdbc' if type == 'GENERIC_JDBC_DATA_ASSET'
      ...
      'OCI::DataIntegration::Models::CreateDataAssetDetails'
    end
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata].hash
    end
