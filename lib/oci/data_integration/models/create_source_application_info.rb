...
module OCI
  ...
  class DataIntegration::Models::CreateSourceApplicationInfo
    ...
    # @option attributes [String] :copy_type The value to assign to the {#copy_type} property
    ...
    # @param [Object] copy_type Object to be assigned
    def copy_type=(copy_type)
      raise "Invalid value for 'copy_type': this must be one of the values in COPY_TYPE_ENUM." if copy_type && !COPY_TYPE_ENUM.include?(copy_type)
