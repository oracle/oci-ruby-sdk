...
module OCI
  ...
  class DataIntegration::Models::MaterializedDynamicField < DataIntegration::Models::TypedObject
    # Reference key value to an object within the document.
    # @return [String]
    attr_accessor :scope

    # @return [OCI::DataIntegration::Models::MaterializedCompositeType]
    attr_accessor :type
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'scope': :'String',
        'type': :'OCI::DataIntegration::Models::MaterializedCompositeType'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::MaterializedCompositeType] :type The value to assign to the {#type} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'MATERIALIZED_DYNAMIC_FIELD'
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, scope, type].hash
    end
