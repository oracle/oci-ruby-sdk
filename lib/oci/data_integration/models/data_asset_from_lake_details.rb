...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromLakeDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromLakeDetails]
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromLakeDetails] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, lake_id, metastore_id, lake_proxy_endpoint, default_connection].hash
    end
