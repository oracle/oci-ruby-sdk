...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromLake < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromLake]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromLake'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromLake] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, registry_metadata, lake_id, metastore_id, lake_proxy_endpoint, default_connection].hash
    end
