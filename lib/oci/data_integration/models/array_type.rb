...
module OCI
  # Array type object.
  class DataIntegration::Models::ArrayType < DataIntegration::Models::BaseType
    # Seeded type
    # @return [String]
    ...
    # @option attributes [String] :element_type The value to assign to the {#element_type} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'ARRAY_TYPE'
      ...
      self.element_type = attributes[:'elementType'] if attributes[:'elementType']

      raise 'You cannot provide both :elementType and :element_type' if attributes.key?(:'elementType') && attributes.key?(:'element_type')

      self.element_type = attributes[:'element_type'] if attributes[:'element_type']
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, object_status, description, element_type].hash
    end
