...
module OCI
  ...
  class DataIntegration::Models::CreateEntityShapeFromObject < DataIntegration::Models::CreateEntityShapeDetails
    ENTITY_TYPE_ENUM = [
      ENTITY_TYPE_TABLE = 'TABLE'.freeze,
      ENTITY_TYPE_VIEW = 'VIEW'.freeze,
      ENTITY_TYPE_FILE = 'FILE'.freeze,
      ENTITY_TYPE_SQL = 'SQL'.freeze,
      ENTITY_TYPE_OBJECT = 'OBJECT'.freeze
    ].freeze
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'OBJECT_ENTITY'
      ...
      self.entity_type = "OBJECT" if entity_type.nil? && !attributes.key?(:'entityType') # rubocop:disable Style/StringLiterals
      ...
      self.entity_type = "OBJECT" if entity_type.nil? && !attributes.key?(:'entityType') && !attributes.key?(:'entity_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [model_type, key, parent_ref, name, description, external_key, shape, shape_id, entity_type, other_type_label, unique_keys, foreign_keys, resource_name, data_format, identifier].hash
    end
