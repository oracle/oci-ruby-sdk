...
module OCI
  ...
  class DataIntegration::Models::ConnectorAttribute
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::ExternalStorage' if type == 'EXTERNAL_STORAGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::ConnectorAttribute'
    end
