...
module OCI
  ...
  class DataIntegration::Models::PublishedObject
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::PublishedObjectFromDataLoaderTask' if type == 'DATA_LOADER_TASK'
      return 'OCI::DataIntegration::Models::PublishedObjectFromPipelineTask' if type == 'PIPELINE_TASK'
      return 'OCI::DataIntegration::Models::PublishedObjectFromIntegrationTask' if type == 'INTEGRATION_TASK'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::PublishedObject'
    end
