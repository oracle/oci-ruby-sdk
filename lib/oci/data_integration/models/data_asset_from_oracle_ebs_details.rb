...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromOracleEbsDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromOracleEbsDetails]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromOracleEbsDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromOracleEbsDetails] :default_connection The value to assign to the {#default_connection} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'ORACLE_EBS_DATA_ASSET'
