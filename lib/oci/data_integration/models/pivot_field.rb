...
module OCI
  ...
  class DataIntegration::Models::PivotField < DataIntegration::Models::TypedObject
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'PIVOT_FIELD'
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, expr, use_type, type, column_name_pattern].hash
    end
