...
module OCI
  ...
  class DataIntegration::Models::ConditionalOutputPort < DataIntegration::Models::TypedObject
    PORT_TYPE_ENUM = [
    ...
    def self.swagger_types
      {
        ...
        'split_condition': :'OCI::DataIntegration::Models::Expression'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::Expression] :split_condition The value to assign to the {#split_condition} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'CONDITIONAL_OUTPUT_PORT'
      ...
      self.split_condition = attributes[:'splitCondition'] if attributes[:'splitCondition']

      raise 'You cannot provide both :splitCondition and :split_condition' if attributes.key?(:'splitCondition') && attributes.key?(:'split_condition')

      self.split_condition = attributes[:'split_condition'] if attributes[:'split_condition']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        fields == other.fields &&
        split_condition == other.split_condition
    end
    ...
    def hash
      [model_type, key, model_version, parent_ref, config_values, object_status, name, description, port_type, fields, split_condition].hash
    end
