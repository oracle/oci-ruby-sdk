...
module OCI
  ...
  class DataIntegration::Models::CreateWorkspaceDetails
    ...
    # @return [String]
    attr_accessor :registry_compartment_id
    ...
    # @return [String]
    attr_accessor :endpoint_compartment_id
    ...
    # @option attributes [String] :registry_name The value to assign to the {#registry_name} property
    # @option attributes [String] :registry_compartment_id The value to assign to the {#registry_compartment_id} property
    # @option attributes [String] :endpoint_name The value to assign to the {#endpoint_name} property
    # @option attributes [String] :endpoint_compartment_id The value to assign to the {#endpoint_compartment_id} property
    ...
    def initialize(attributes = {})
      ...
      self.registry_name = attributes[:'registryName'] if attributes[:'registryName']

      raise 'You cannot provide both :registryName and :registry_name' if attributes.key?(:'registryName') && attributes.key?(:'registry_name')

      self.registry_name = attributes[:'registry_name'] if attributes[:'registry_name']

      self.registry_compartment_id = attributes[:'registryCompartmentId'] if attributes[:'registryCompartmentId']

      raise 'You cannot provide both :registryCompartmentId and :registry_compartment_id' if attributes.key?(:'registryCompartmentId') && attributes.key?(:'registry_compartment_id')

      self.registry_compartment_id = attributes[:'registry_compartment_id'] if attributes[:'registry_compartment_id']
      ...
      self.endpoint_compartment_id = attributes[:'endpointCompartmentId'] if attributes[:'endpointCompartmentId']

      raise 'You cannot provide both :endpointCompartmentId and :endpoint_compartment_id' if attributes.key?(:'endpointCompartmentId') && attributes.key?(:'endpoint_compartment_id')

      self.endpoint_compartment_id = attributes[:'endpoint_compartment_id'] if attributes[:'endpoint_compartment_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        registry_name == other.registry_name &&
        registry_compartment_id == other.registry_compartment_id &&
        endpoint_name == other.endpoint_name &&
        endpoint_compartment_id == other.endpoint_compartment_id &&
    ...
    def hash
      [vcn_id, subnet_id, dns_server_ip, dns_server_zone, freeform_tags, defined_tags, description, display_name, compartment_id, is_private_network_enabled, registry_id, endpoint_id, registry_name, registry_compartment_id, endpoint_name, endpoint_compartment_id, workspace_properties].hash
    end
