...
module OCI
  ...
  class DataIntegration::Models::CreateWorkspaceDetails
    ...
    def hash
      [vcn_id, subnet_id, dns_server_ip, dns_server_zone, freeform_tags, defined_tags, description, display_name, compartment_id, is_private_network_enabled, registry_id, endpoint_id, registry_name, registry_compartment_id, endpoint_name, endpoint_compartment_id].hash
    end
