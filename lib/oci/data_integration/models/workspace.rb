...
module OCI
  ...
  class DataIntegration::Models::Workspace
    ...
    def hash
      [vcn_id, subnet_id, dns_server_ip, dns_server_zone, is_private_network_enabled, freeform_tags, defined_tags, description, display_name, compartment_id, time_created, time_updated, lifecycle_state, state_message, id].hash
    end
