...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromObjectStorage < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromObjectStorage]
    ...
    def self.swagger_types
      {
        ...
        'tenancy_id': :'String',
        'namespace': :'String',
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromObjectStorage'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromObjectStorage] :default_connection The value to assign to the {#default_connection} property
