...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromHdfsDetails < DataIntegration::Models::DataAsset
    ...
    # @return [OCI::DataIntegration::Models::ConnectionFromHdfsDetails]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionFromHdfsDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :validate_certificate The value to assign to the {#validate_certificate} property
    # @option attributes [OCI::DataIntegration::Models::ConnectionFromHdfsDetails] :default_connection The value to assign to the {#default_connection} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'HDFS_DATA_ASSET'
      ...
      self.validate_certificate = attributes[:'validateCertificate'] unless attributes[:'validateCertificate'].nil?
      self.validate_certificate = true if validate_certificate.nil? && !attributes.key?(:'validateCertificate') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :validateCertificate and :validate_certificate' if attributes.key?(:'validateCertificate') && attributes.key?(:'validate_certificate')

      self.validate_certificate = attributes[:'validate_certificate'] unless attributes[:'validate_certificate'].nil?
      self.validate_certificate = true if validate_certificate.nil? && !attributes.key?(:'validateCertificate') && !attributes.key?(:'validate_certificate') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, host, port, protocol, validate_certificate, default_connection].hash
    end
