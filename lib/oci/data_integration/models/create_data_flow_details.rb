...
module OCI
  ...
  class DataIntegration::Models::CreateDataFlowDetails
    ...
    def hash
      [key, model_version, parent_ref, name, identifier, nodes, parameters, description, flow_config_values, object_status, registry_metadata].hash
    end
