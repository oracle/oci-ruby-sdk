...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromAdwcDetails < DataIntegration::Models::DataAsset
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, service_name, service_names, driver_class, default_connection].hash
    end
