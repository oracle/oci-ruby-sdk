...
module OCI
  ...
  class DataIntegration::Models::Aggregator < DataIntegration::Models::Operator
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'AGGREGATOR_OPERATOR'
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, input_ports, output_ports, object_status, identifier, parameters, op_config_values, group_by_columns].hash
    end
