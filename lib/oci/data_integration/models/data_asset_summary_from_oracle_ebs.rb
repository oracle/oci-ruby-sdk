...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromOracleEbs < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromOracleEbs]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromOracleEbs'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromOracleEbs] :default_connection The value to assign to the {#default_connection} property
