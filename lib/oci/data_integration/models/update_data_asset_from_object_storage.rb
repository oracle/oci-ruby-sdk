...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromObjectStorage < DataIntegration::Models::UpdateDataAssetDetails
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, url, tenancy_id, namespace, default_connection].hash
    end
