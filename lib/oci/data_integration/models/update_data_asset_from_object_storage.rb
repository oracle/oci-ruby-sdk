...
module OCI
  ...
  class DataIntegration::Models::UpdateDataAssetFromObjectStorage < DataIntegration::Models::UpdateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::UpdateConnectionFromObjectStorage]
    ...
    # @option attributes [OCI::DataIntegration::Models::UpdateConnectionFromObjectStorage] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, object_version, identifier, external_key, asset_properties, registry_metadata, oci_region, url, tenancy_id, namespace, default_connection].hash
    end
