...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromMySQL < DataIntegration::Models::DataAssetSummary
    ...
    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromMySQL]
    ...
    def self.swagger_types
      {
        ...
        'port': :'String',
        'service_name': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromMySQL'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromMySQL] :default_connection The value to assign to the {#default_connection} property
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, host, port, service_name, default_connection].hash
    end
