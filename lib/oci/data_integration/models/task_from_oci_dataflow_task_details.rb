...
module OCI
  ...
  class DataIntegration::Models::TaskFromOCIDataflowTaskDetails < DataIntegration::Models::Task
    ...
    # @option attributes [BOOLEAN] :is_concurrent_allowed The value to assign to the {OCI::DataIntegration::Models::Task#is_concurrent_allowed #is_concurrent_allowed} proprety
