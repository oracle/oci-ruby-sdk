...
module OCI
  ...
  class DataIntegration::Models::CreateConnectionFromOAuth2 < DataIntegration::Models::CreateConnectionDetails
    GRANT_TYPE_ENUM = [
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_status, identifier, connection_properties, registry_metadata, access_token_url, client_id, client_secret, scope, grant_type].hash
    end
