...
module OCI
  ...
  class DataIntegration::Models::ConnectionFromObjectStorageDetails < DataIntegration::Models::ConnectionDetails
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, description, object_version, object_status, identifier, primary_schema, connection_properties, is_default, metadata, credential_file_content, user_id, finger_print, pass_phrase].hash
    end
