...
module OCI
  ...
  class DataIntegration::Models::DataAssetSummaryFromAmazonS3 < DataIntegration::Models::DataAssetSummary
    # The region for Amazon s3
    # @return [String]
    attr_accessor :region

    # @return [OCI::DataIntegration::Models::ConnectionSummaryFromAmazonS3]
    ...
    def self.swagger_types
      {
        ...
        'region': :'String',
        'default_connection': :'OCI::DataIntegration::Models::ConnectionSummaryFromAmazonS3'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::ConnectionSummaryFromAmazonS3] :default_connection The value to assign to the {#default_connection} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'AMAZON_S3_DATA_ASSET'
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, region, default_connection].hash
    end
