...
module OCI
  ...
  class DataIntegration::Models::CreateDataAssetFromOracleSiebel < DataIntegration::Models::CreateDataAssetDetails
    ...
    # @return [OCI::DataIntegration::Models::CreateConnectionFromOracleSiebel]
    ...
    def self.swagger_types
      {
        ...
        'default_connection': :'OCI::DataIntegration::Models::CreateConnectionFromOracleSiebel'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DataIntegration::Models::CreateConnectionFromOracleSiebel] :default_connection The value to assign to the {#default_connection} property
