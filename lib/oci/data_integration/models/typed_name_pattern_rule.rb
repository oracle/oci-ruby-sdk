...
module OCI
  ...
  class DataIntegration::Models::TypedNamePatternRule < DataIntegration::Models::ProjectionRule
    ...
    # @option attributes [Array<String>] :names The value to assign to the {#names} property
