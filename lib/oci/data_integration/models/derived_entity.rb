...
module OCI
  ...
  class DataIntegration::Models::DerivedEntity < DataIntegration::Models::DataEntity
    MODE_ENUM = [
      MODE_IN = 'IN'.freeze,
      MODE_OUT = 'OUT'.freeze,
    ...
    # @return [OCI::DataIntegration::Models::ReferencedDataObject]
    attr_accessor :ref_data_object
    ...
    attr_accessor :derived_properties
    ...
    # @option attributes [OCI::DataIntegration::Models::ReferencedDataObject] :ref_data_object The value to assign to the {#ref_data_object} property
    # @option attributes [String] :mode The value to assign to the {#mode} property
    # @option attributes [Hash<String, Object>] :derived_properties The value to assign to the {#derived_properties} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['modelType'] = 'DERIVED_ENTITY'
      ...
      self.ref_data_object = attributes[:'refDataObject'] if attributes[:'refDataObject']

      raise 'You cannot provide both :refDataObject and :ref_data_object' if attributes.key?(:'refDataObject') && attributes.key?(:'ref_data_object')

      self.ref_data_object = attributes[:'ref_data_object'] if attributes[:'ref_data_object']

      self.mode = attributes[:'mode'] if attributes[:'mode']

      self.derived_properties = attributes[:'derivedProperties'] if attributes[:'derivedProperties']

      raise 'You cannot provide both :derivedProperties and :derived_properties' if attributes.key?(:'derivedProperties') && attributes.key?(:'derived_properties')

      self.derived_properties = attributes[:'derived_properties'] if attributes[:'derived_properties']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ref_data_object == other.ref_data_object &&
        mode == other.mode &&
        derived_properties == other.derived_properties
    end
    ...
    def hash
      [model_type, metadata, key, model_version, parent_ref, name, object_version, shape, shape_id, resource_name, object_status, identifier, ref_data_object, mode, derived_properties].hash
    end
