...
module OCI
  ...
  class DataIntegration::Models::ImportConflictResolution
    IMPORT_CONFLICT_RESOLUTION_TYPE_ENUM = [
      IMPORT_CONFLICT_RESOLUTION_TYPE_DUPLICATE = 'DUPLICATE'.freeze,
      IMPORT_CONFLICT_RESOLUTION_TYPE_REPLACE = 'REPLACE'.freeze,
      IMPORT_CONFLICT_RESOLUTION_TYPE_RETAIN = 'RETAIN'.freeze,
      IMPORT_CONFLICT_RESOLUTION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [String]
    attr_reader :import_conflict_resolution_type
    ...
    # @option attributes [String] :import_conflict_resolution_type The value to assign to the {#import_conflict_resolution_type} property
    def initialize(attributes = {})
      ...
      self.import_conflict_resolution_type = attributes[:'importConflictResolutionType'] if attributes[:'importConflictResolutionType']
      self.import_conflict_resolution_type = "RETAIN" if import_conflict_resolution_type.nil? && !attributes.key?(:'importConflictResolutionType') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :importConflictResolutionType and :import_conflict_resolution_type' if attributes.key?(:'importConflictResolutionType') && attributes.key?(:'import_conflict_resolution_type')

      self.import_conflict_resolution_type = attributes[:'import_conflict_resolution_type'] if attributes[:'import_conflict_resolution_type']
      self.import_conflict_resolution_type = "RETAIN" if import_conflict_resolution_type.nil? && !attributes.key?(:'importConflictResolutionType') && !attributes.key?(:'import_conflict_resolution_type') # rubocop:disable Style/StringLiterals
    end
    # rubocop:enable Metrics/CyclomaticComplexity, Metrics/AbcSize, Metrics/PerceivedComplexity
    # rubocop:enable Metrics/MethodLength, Layout/EmptyLines, Style/SymbolLiteral

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] import_conflict_resolution_type Object to be assigned
    def import_conflict_resolution_type=(import_conflict_resolution_type)
      # rubocop:disable Style/ConditionalAssignment
      if import_conflict_resolution_type && !IMPORT_CONFLICT_RESOLUTION_TYPE_ENUM.include?(import_conflict_resolution_type)
        OCI.logger.debug("Unknown value for 'import_conflict_resolution_type' [" + import_conflict_resolution_type + "]. Mapping to 'IMPORT_CONFLICT_RESOLUTION_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @import_conflict_resolution_type = IMPORT_CONFLICT_RESOLUTION_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        import_conflict_resolution_type == other.import_conflict_resolution_type
    end
    ...
    def hash
      [duplicate_prefix, duplicate_suffix, import_conflict_resolution_type].hash
    end
