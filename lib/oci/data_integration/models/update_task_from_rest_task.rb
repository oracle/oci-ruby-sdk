...
module OCI
  ...
  class DataIntegration::Models::UpdateTaskFromRestTask < DataIntegration::Models::UpdateTaskDetails
    METHOD_TYPE_ENUM = [
    ...
    # @option attributes [String] :additional_properties The value to assign to the {#additional_properties} property
