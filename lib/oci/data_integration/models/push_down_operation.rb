...
module OCI
  ...
  class DataIntegration::Models::PushDownOperation
    MODEL_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataIntegration::Models::Query' if type == 'QUERY'
      return 'OCI::DataIntegration::Models::Select' if type == 'SELECT'
      return 'OCI::DataIntegration::Models::Join' if type == 'JOIN'
      return 'OCI::DataIntegration::Models::Sort' if type == 'SORT'
      return 'OCI::DataIntegration::Models::FilterPush' if type == 'FILTER'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataIntegration::Models::PushDownOperation'
    end
