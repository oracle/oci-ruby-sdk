...
module OCI
  ...
  class DataIntegration::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_MOVE_WORKSPACE = 'MOVE_WORKSPACE'.freeze,
    ...
    # **[Required]** The OCID of the compartment that contains this work request. Work requests should be scoped to
    ...
    # @return [Array<OCI::DataIntegration::Models::WorkRequestResource>]
    ...
    # **[Required]** The date and time this work request was accepted, in the timestamp format defined by
    ...
    # @option attributes [Array<OCI::DataIntegration::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
