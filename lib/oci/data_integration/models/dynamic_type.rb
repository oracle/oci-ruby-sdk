...
module OCI
  # The dynamic type.
  class DataIntegration::Models::DynamicType < DataIntegration::Models::BaseType
    # @return [OCI::DataIntegration::Models::DynamicTypeHandler]
    attr_accessor :type_handler
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'type_handler': :'OCI::DataIntegration::Models::DynamicTypeHandler',
    ...
    # @option attributes [OCI::DataIntegration::Models::DynamicTypeHandler] :type_handler The value to assign to the {#type_handler} property
    ...
    def initialize(attributes = {})
      ...
      attributes['modelType'] = 'DYNAMIC_TYPE'
      ...
      self.type_handler = attributes[:'typeHandler'] if attributes[:'typeHandler']

      raise 'You cannot provide both :typeHandler and :type_handler' if attributes.key?(:'typeHandler') && attributes.key?(:'type_handler')

      self.type_handler = attributes[:'type_handler'] if attributes[:'type_handler']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        type_handler == other.type_handler &&
    ...
    def hash
      [model_type, key, model_version, parent_ref, name, object_status, description, type_handler, config_definition].hash
    end
