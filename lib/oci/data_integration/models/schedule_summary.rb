...
module OCI
  ...
  class DataIntegration::Models::ScheduleSummary
    ...
    def hash
      [key, model_version, model_type, parent_ref, name, description, object_version, object_status, identifier, frequency_details, timezone, is_daylight_adjustment_enabled, metadata].hash
    end
