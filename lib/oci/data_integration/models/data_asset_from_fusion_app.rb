...
module OCI
  ...
  class DataIntegration::Models::DataAssetFromFusionApp < DataIntegration::Models::DataAsset
    ...
    def hash
      [model_type, key, model_version, name, description, object_status, identifier, external_key, asset_properties, native_type_system, object_version, parent_ref, metadata, key_map, service_url, default_connection].hash
    end
