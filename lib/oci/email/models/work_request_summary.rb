...
module OCI
  ...
  class Email::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Email::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Email::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Email::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
