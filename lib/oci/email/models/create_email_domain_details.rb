...
module OCI
  ...
  #
  class Email::Models::CreateEmailDomainDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for this email domain.
    #
    # @return [String]
    ...
    def hash
      [name, compartment_id, description, freeform_tags, defined_tags].hash
    end
