...
module OCI
  ...
  #
  class Email::Models::DkimSummary
    ...
    def hash
      [name, id, email_domain_id, compartment_id, lifecycle_state, description, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
