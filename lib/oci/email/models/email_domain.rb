...
module OCI
  ...
  #
  class Email::Models::EmailDomain
    ...
    # **[Required]** The name of the email domain in the Internet Domain Name System (DNS).
    #
    # Example: `example.net`
    #
    # @return [String]
    ...
    # @option attributes [String] :active_dkim_id The value to assign to the {#active_dkim_id} property
    ...
    def initialize(attributes = {})
      ...
      self.active_dkim_id = attributes[:'activeDkimId'] if attributes[:'activeDkimId']

      raise 'You cannot provide both :activeDkimId and :active_dkim_id' if attributes.key?(:'activeDkimId') && attributes.key?(:'active_dkim_id')

      self.active_dkim_id = attributes[:'active_dkim_id'] if attributes[:'active_dkim_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        active_dkim_id == other.active_dkim_id &&
        is_spf == other.is_spf &&
    ...
    def hash
      [name, id, compartment_id, lifecycle_state, active_dkim_id, is_spf, description, time_created, freeform_tags, defined_tags, system_tags].hash
    end
