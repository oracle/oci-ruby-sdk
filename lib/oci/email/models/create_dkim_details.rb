...
module OCI
  ...
  #
  class Email::Models::CreateDkimDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the EmailDomain for this DKIM.
    #
    # @return [String]
