...
module OCI
  ...
  #
  class Email::Models::EmailDomainSummary
    ...
    def hash
      [name, id, compartment_id, lifecycle_state, active_dkim_id, description, time_created, freeform_tags, defined_tags, system_tags].hash
    end
