...
module OCI
  ...
  class UsageApi::Models::CreateCustomTableDetails
    ...
    attr_accessor :saved_custom_table
    ...
    def initialize(attributes = {})
      ...
      raise 'You cannot provide both :savedCustomTable and :saved_custom_table' if attributes.key?(:'savedCustomTable') && attributes.key?(:'saved_custom_table')

      self.saved_custom_table = attributes[:'saved_custom_table'] if attributes[:'saved_custom_table']
    end
