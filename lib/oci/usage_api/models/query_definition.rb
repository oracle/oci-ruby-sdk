...
module OCI
  ...
  class UsageApi::Models::QueryDefinition
    # **[Required]** The query display name. Avoid entering confidential information.
    # @return [String]
    attr_accessor :display_name

    # This attribute is required.
    # @return [OCI::UsageApi::Models::ReportQuery]
    attr_accessor :report_query
    ...
    # @option attributes [OCI::UsageApi::Models::ReportQuery] :report_query The value to assign to the {#report_query} property
    # @option attributes [OCI::UsageApi::Models::CostAnalysisUI] :cost_analysis_ui The value to assign to the {#cost_analysis_ui} property
