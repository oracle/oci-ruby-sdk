...
module OCI
  ...
  class UsageApi::Models::EmailRecipient
    ...
    # **[Required]** the email of the recipient.
    # @return [String]
    attr_accessor :email_id

    # **[Required]** The email recipient lifecycle state.
    # @return [String]
    ...
    def hash
      [first_name, last_name, email_id, lifecycle_state].hash
    end
