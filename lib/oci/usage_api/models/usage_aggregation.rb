...
module OCI
  ...
  class UsageApi::Models::UsageAggregation
    ...
    # @return [Array<OCI::UsageApi::Models::UsageSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::UsageApi::Models::UsageSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::UsageApi::Models::UsageSummary>] :items The value to assign to the {#items} property
