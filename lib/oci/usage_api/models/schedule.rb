...
module OCI
  ...
  class UsageApi::Models::Schedule
    ...
    # **[Required]** The tenancy of the customer
    # @return [String]
    ...
    # **[Required]** In x-obmcs-recurring-time format shown here: https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10
    ...
    # **[Required]** The date and time of when the schedule was created
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The lifecycle state of the schedule
    # @return [String]
    ...
    def hash
      [id, name, compartment_id, result_location, schedule_recurrences, time_scheduled, query_properties, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
