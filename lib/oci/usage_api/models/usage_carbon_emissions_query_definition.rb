...
module OCI
  ...
  class UsageApi::Models::UsageCarbonEmissionsQueryDefinition
    # **[Required]** The query display name. Avoid entering confidential information.
    # @return [String]
    attr_accessor :display_name

    # This attribute is required.
    # @return [OCI::UsageApi::Models::UsageCarbonEmissionsReportQuery]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'display_name': :'String',
        'report_query': :'OCI::UsageApi::Models::UsageCarbonEmissionsReportQuery',
    ...
    # @option attributes [OCI::UsageApi::Models::UsageCarbonEmissionsReportQuery] :report_query The value to assign to the {#report_query} property
