...
module OCI
  # The saved schedule.
  class UsageApi::Models::CreateScheduleDetails
    ...
    def hash
      [name, compartment_id, result_location, schedule_recurrences, time_scheduled, query_properties, freeform_tags, defined_tags].hash
    end
