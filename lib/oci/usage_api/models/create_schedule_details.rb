...
module OCI
  ...
  class UsageApi::Models::CreateScheduleDetails
    ...
    def output_file_format=(output_file_format)
      raise "Invalid value for 'output_file_format': this must be one of the values in OUTPUT_FILE_FORMAT_ENUM." if output_file_format && !OUTPUT_FILE_FORMAT_ENUM.include?(output_file_format)
    ...
    def hash
      [name, compartment_id, description, output_file_format, saved_report_id, result_location, schedule_recurrences, time_scheduled, query_properties, freeform_tags, defined_tags].hash
    end
