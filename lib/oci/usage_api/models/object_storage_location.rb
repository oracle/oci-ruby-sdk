...
module OCI
  ...
  class UsageApi::Models::ObjectStorageLocation < UsageApi::Models::ResultLocation
    # **[Required]** The destination Object Store Region specified by customer
    # @return [String]
    attr_accessor :region

    # **[Required]** The namespace needed to determine object storage bucket.
    # @return [String]
    attr_accessor :namespace

    # **[Required]** The bucket name where usage/cost CSVs will be uploaded
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['locationType'] = 'OBJECT_STORAGE'
    ...
    def hash
      [location_type, region, namespace, bucket_name].hash
    end
