...
module OCI
  ...
  class UsageApi::Models::RequestUsageCarbonEmissionsDetails
    # **[Required]** Tenant ID.
    # @return [String]
    ...
    def hash
      [tenant_id, time_usage_started, time_usage_ended, is_aggregate_by_time, group_by, group_by_tag, compartment_depth, filter].hash
    end
