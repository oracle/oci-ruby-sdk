...
module OCI
  ...
  class UsageApi::Models::Forecast
    FORECAST_TYPE_ENUM = [
    ...
    # @option attributes [String] :forecast_type The value to assign to the {#forecast_type} property
    # @option attributes [DateTime] :time_forecast_started The value to assign to the {#time_forecast_started} property
    # @option attributes [DateTime] :time_forecast_ended The value to assign to the {#time_forecast_ended} property
    ...
    def forecast_type=(forecast_type)
      ...
      if forecast_type && !FORECAST_TYPE_ENUM.include?(forecast_type)
        OCI.logger.debug("Unknown value for 'forecast_type' [" + forecast_type + "]. Mapping to 'FORECAST_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @forecast_type = FORECAST_TYPE_UNKNOWN_ENUM_VALUE
      else
