...
module OCI
  ...
  class UsageApi::Models::UsageCarbonEmissionAggregation
    # Aggregate the result by.
    # @return [Array<String>]
    attr_accessor :group_by

    # **[Required]** A list of usage carbon emission items.
    # @return [Array<OCI::UsageApi::Models::UsageCarbonEmissionSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::UsageApi::Models::UsageCarbonEmissionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::UsageApi::Models::UsageCarbonEmissionSummary>] :items The value to assign to the {#items} property
