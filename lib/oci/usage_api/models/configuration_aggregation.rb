...
module OCI
  ...
  class UsageApi::Models::ConfigurationAggregation
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::UsageApi::Models::Configuration>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::UsageApi::Models::Configuration>] :items The value to assign to the {#items} property
