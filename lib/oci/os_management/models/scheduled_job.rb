...
module OCI
  ...
  class OsManagement::Models::ScheduledJob
    ...
    UPDATE_TYPE_ENUM = [
      ...
      UPDATE_TYPE_KSPLICE = 'KSPLICE'.freeze,
    ...
    def hash
      [id, compartment_id, display_name, description, schedule_type, time_next_execution, time_last_execution, interval_type, interval_value, managed_instances, managed_instance_groups, operation_type, update_type, package_names, work_requests, lifecycle_state, freeform_tags, defined_tags, update_names, os_family, is_restricted].hash
    end
