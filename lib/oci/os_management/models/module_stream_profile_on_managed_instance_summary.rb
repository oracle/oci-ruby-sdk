...
module OCI
  ...
  class OsManagement::Models::ModuleStreamProfileOnManagedInstanceSummary
    STATUS_ENUM = [
      STATUS_INSTALLED = 'INSTALLED'.freeze,
    ...
    # **[Required]** The status of the profile.
    #
    ...
    def hash
      [module_name, stream_name, profile_name, status, time_modified].hash
    end
