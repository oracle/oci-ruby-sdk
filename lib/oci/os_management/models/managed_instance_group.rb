...
module OCI
  ...
  class OsManagement::Models::ManagedInstanceGroup
    ...
    def hash
      [display_name, id, description, compartment_id, managed_instances, lifecycle_state, freeform_tags, defined_tags, os_family].hash
    end
