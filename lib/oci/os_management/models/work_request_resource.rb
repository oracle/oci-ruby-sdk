...
module OCI
  ...
  class OsManagement::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
      ...
      ACTION_TYPE_INSTALLED = 'INSTALLED'.freeze,
      ACTION_TYPE_REMOVED = 'REMOVED'.freeze,
    ...
    def hash
      [entity_type, action_type, identifier, name, entity_uri].hash
    end
