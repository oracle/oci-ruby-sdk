...
module OCI
  ...
  class OsManagement::Models::SoftwarePackage
    ...
    # @return [Array<OCI::OsManagement::Models::SoftwarePackageDependency>]
    attr_accessor :dependencies

    # list of files for the software package
    # @return [Array<OCI::OsManagement::Models::SoftwarePackageFile>]
    attr_accessor :files
    ...
    def self.swagger_types
      {
        ...
        'dependencies': :'Array<OCI::OsManagement::Models::SoftwarePackageDependency>',
        'files': :'Array<OCI::OsManagement::Models::SoftwarePackageFile>',
    ...
    # @option attributes [String] :last_modified_date The value to assign to the {#last_modified_date} property
    ...
    # @option attributes [Array<OCI::OsManagement::Models::SoftwarePackageDependency>] :dependencies The value to assign to the {#dependencies} property
    # @option attributes [Array<OCI::OsManagement::Models::SoftwarePackageFile>] :files The value to assign to the {#files} property
    ...
    def initialize(attributes = {})
      ...
      self.last_modified_date = attributes[:'lastModifiedDate'] if attributes[:'lastModifiedDate']

      raise 'You cannot provide both :lastModifiedDate and :last_modified_date' if attributes.key?(:'lastModifiedDate') && attributes.key?(:'last_modified_date')

      self.last_modified_date = attributes[:'last_modified_date'] if attributes[:'last_modified_date']
    ...
    def hash
      [display_name, name, type, version, architecture, last_modified_date, checksum, checksum_type, description, size_in_bytes, dependencies, files, software_sources].hash
    end
