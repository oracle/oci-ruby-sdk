...
module OCI
  ...
  class OsManagement::Models::WindowsUpdateSummary
    UPDATE_TYPE_ENUM = [
    ...
    INSTALLABLE_ENUM = [
      ...
      INSTALLABLE_UNKNOWN = 'UNKNOWN'.freeze,
    ...
    def hash
      [display_name, name, update_type, installable, is_reboot_required_for_installation].hash
    end
