...
module OCI
  ...
  class OsManagement::Models::SoftwareSourceSummary
    STATUS_ENUM = [
    ...
    def hash
      [id, description, compartment_id, display_name, repo_type, status, packages, lifecycle_state, parent_id, parent_name, freeform_tags, defined_tags].hash
    end
