...
module OCI
  ...
  class OsManagement::Models::ManageModuleStreamsOnManagedInstanceDetails
    ...
    # @return [Array<OCI::OsManagement::Models::ModuleStreamDetails>]
    ...
    # @return [Array<OCI::OsManagement::Models::ModuleStreamProfileDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'is_dry_run': :'BOOLEAN',
        'enable': :'Array<OCI::OsManagement::Models::ModuleStreamDetails>',
        'disable': :'Array<OCI::OsManagement::Models::ModuleStreamDetails>',
        'install': :'Array<OCI::OsManagement::Models::ModuleStreamProfileDetails>',
        'remove': :'Array<OCI::OsManagement::Models::ModuleStreamProfileDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::OsManagement::Models::ModuleStreamDetails>] :enable The value to assign to the {#enable} property
    # @option attributes [Array<OCI::OsManagement::Models::ModuleStreamDetails>] :disable The value to assign to the {#disable} property
    # @option attributes [Array<OCI::OsManagement::Models::ModuleStreamProfileDetails>] :install The value to assign to the {#install} property
    # @option attributes [Array<OCI::OsManagement::Models::ModuleStreamProfileDetails>] :remove The value to assign to the {#remove} property
    ...
    def hash
      [is_dry_run, enable, disable, install, remove].hash
    end
