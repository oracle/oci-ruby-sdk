...
module OCI
  ...
  class OsManagement::Models::Recurrence
    INTERVAL_TYPE_ENUM = [
      INTERVAL_TYPE_MINUTES = 'MINUTES'.freeze,
      INTERVAL_TYPE_HOURS = 'HOURS'.freeze,
      INTERVAL_TYPE_DAYS = 'DAYS'.freeze,
      INTERVAL_TYPE_WEEKS = 'WEEKS'.freeze
    ].freeze
    ...
    def hash
      [interval_type, interval_value].hash
    end
