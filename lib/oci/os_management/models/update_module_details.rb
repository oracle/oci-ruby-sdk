...
module OCI
  ...
  class OsManagement::Models::UpdateModuleDetails
    # **[Required]** The name of a module
    # @return [String]
    attr_accessor :module_name

    # The streams of the module
    # @return [Array<OCI::OsManagement::Models::UpdateModuleStreamDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'module_name': :'String',
        'streams': :'Array<OCI::OsManagement::Models::UpdateModuleStreamDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::OsManagement::Models::UpdateModuleStreamDetails>] :streams The value to assign to the {#streams} property
    def initialize(attributes = {})
      ...
      self.streams = attributes[:'streams'] if attributes[:'streams']
    end
