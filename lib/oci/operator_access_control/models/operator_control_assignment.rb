...
module OCI
  ...
  class OperatorAccessControl::Models::OperatorControlAssignment
    ...
    # @return [BOOLEAN]
    attr_accessor :is_hypervisor_log_forwarded

    # Name of the operator control name associated.
    # @return [String]
    attr_accessor :op_control_name
    ...
    def self.swagger_types
      {
        ...
        'is_hypervisor_log_forwarded': :'BOOLEAN',
    ...
    # @option attributes [BOOLEAN] :is_hypervisor_log_forwarded The value to assign to the {#is_hypervisor_log_forwarded} property
    # @option attributes [String] :op_control_name The value to assign to the {#op_control_name} property
    ...
    def initialize(attributes = {})
      ...
      self.is_hypervisor_log_forwarded = attributes[:'isHypervisorLogForwarded'] unless attributes[:'isHypervisorLogForwarded'].nil?

      raise 'You cannot provide both :isHypervisorLogForwarded and :is_hypervisor_log_forwarded' if attributes.key?(:'isHypervisorLogForwarded') && attributes.key?(:'is_hypervisor_log_forwarded')

      self.is_hypervisor_log_forwarded = attributes[:'is_hypervisor_log_forwarded'] unless attributes[:'is_hypervisor_log_forwarded'].nil?

      self.op_control_name = attributes[:'opControlName'] if attributes[:'opControlName']

      raise 'You cannot provide both :opControlName and :op_control_name' if attributes.key?(:'opControlName') && attributes.key?(:'op_control_name')

      self.op_control_name = attributes[:'op_control_name'] if attributes[:'op_control_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_hypervisor_log_forwarded == other.is_hypervisor_log_forwarded &&
        op_control_name == other.op_control_name &&
