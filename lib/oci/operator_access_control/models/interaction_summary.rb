...
module OCI
  ...
  class OperatorAccessControl::Models::InteractionSummary
    ...
    #
    # @return [DateTime]
    attr_accessor :time_of_conversation
    ...
    # @option attributes [DateTime] :time_of_conversation The value to assign to the {#time_of_conversation} property
    def initialize(attributes = {})
      ...
      self.time_of_conversation = attributes[:'timeOfConversation'] if attributes[:'timeOfConversation']

      raise 'You cannot provide both :timeOfConversation and :time_of_conversation' if attributes.key?(:'timeOfConversation') && attributes.key?(:'time_of_conversation')

      self.time_of_conversation = attributes[:'time_of_conversation'] if attributes[:'time_of_conversation']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        time_of_conversation == other.time_of_conversation
    end
    ...
    def hash
      [id, user_id, user_name, message, user_type, time_of_conversation].hash
    end
