...
module OCI
  ...
  class OperatorAccessControl::Models::OperatorControlSummary
    ...
    def hash
      [id, operator_control_name, compartment_id, is_fully_pre_approved, resource_type, number_of_approvers, time_of_creation, time_of_modification, time_of_deletion, lifecycle_state, freeform_tags, defined_tags].hash
    end
