...
module OCI
  ...
  class OperatorAccessControl::Models::AccessRequest
    ...
    # @return [Integer]
    attr_accessor :number_of_extension_approvers

    # Contains the user ids who have approved the accessRequest for extension.
    # @return [Array<OCI::OperatorAccessControl::Models::ApproverDetail>]
    attr_accessor :approver_details

    # Contains the user ids who have approved the accessRequest for extension.
    # @return [Array<OCI::OperatorAccessControl::Models::ApproverDetail>]
    attr_accessor :extension_approver_details

    # Whether the access request was requested for Validate Assignment.
    # @return [BOOLEAN]
    attr_accessor :is_validate_assignment
    ...
    # @option attributes [Integer] :number_of_extension_approvers The value to assign to the {#number_of_extension_approvers} property
    # @option attributes [Array<OCI::OperatorAccessControl::Models::ApproverDetail>] :approver_details The value to assign to the {#approver_details} property
    # @option attributes [Array<OCI::OperatorAccessControl::Models::ApproverDetail>] :extension_approver_details The value to assign to the {#extension_approver_details} property
    # @option attributes [BOOLEAN] :is_validate_assignment The value to assign to the {#is_validate_assignment} property
