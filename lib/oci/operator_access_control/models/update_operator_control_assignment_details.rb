...
module OCI
  ...
  class OperatorAccessControl::Models::UpdateOperatorControlAssignmentDetails
    ...
    def hash
      [time_assignment_from, time_assignment_to, is_enforced_always, comment, is_log_forwarded, remote_syslog_server_address, remote_syslog_server_port, remote_syslog_server_ca_cert, is_hypervisor_log_forwarded, is_auto_approve_during_maintenance, freeform_tags, defined_tags].hash
    end
