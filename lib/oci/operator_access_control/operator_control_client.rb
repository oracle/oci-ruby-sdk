...
module OCI
  ...
  class OperatorAccessControl::OperatorControlClient
    ...
    def region=(new_region)
      ...
      logger.info "OperatorControlClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @param [OCI::OperatorAccessControl::Models::ChangeOperatorControlCompartmentDetails] change_operator_control_compartment_details Moves the Operator Control resource into a different compartment.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/change_operator_control_compartment.rb.html) to see an example of how to use change_operator_control_compartment API.
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::OperatorAccessControl::Models::OperatorControl OperatorControl}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/create_operator_control.rb.html) to see an example of how to use create_operator_control API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :description reason for deletion of OperatorControl.
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    #   for a resource, set the `if-match` parameter to the value of the
    #   etag from a previous GET or POST response for that resource.
    #   The resource will be updated or deleted only if the etag you
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/delete_operator_control.rb.html) to see an example of how to use delete_operator_control API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::OperatorAccessControl::Models::OperatorControl OperatorControl}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/get_operator_control.rb.html) to see an example of how to use get_operator_control API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :lifecycle_state A filter to return only resources whose lifecycleState matches the given OperatorControl lifecycleState.
    # @option opts [String] :display_name A filter to return OperatorControl that match the entire display name given.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::OperatorAccessControl::Models::OperatorControlCollection OperatorControlCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/list_operator_controls.rb.html) to see an example of how to use list_operator_controls API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::OperatorAccessControl::Models::OperatorControl OperatorControl}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/operatoraccesscontrol/update_operator_control.rb.html) to see an example of how to use update_operator_control API.
