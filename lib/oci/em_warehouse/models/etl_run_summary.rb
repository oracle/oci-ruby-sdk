...
module OCI
  ...
  class EmWarehouse::Models::EtlRunSummary
    ...
    # @option attributes [Integer] :data_written The value to assign to the {#data_written} property
    ...
    def initialize(attributes = {})
      ...
      self.data_written = attributes[:'dataWritten'] if attributes[:'dataWritten']

      raise 'You cannot provide both :dataWritten and :data_written' if attributes.key?(:'dataWritten') && attributes.key?(:'data_written')

      self.data_written = attributes[:'data_written'] if attributes[:'data_written']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_written == other.data_written &&
    ...
    def hash
      [compartment_id, data_read_in_bytes, data_written, lifecycle_state, display_name, lifecycle_details, run_duration_in_milliseconds, time_created, time_updated, freeform_tags, defined_tags].hash
    end
