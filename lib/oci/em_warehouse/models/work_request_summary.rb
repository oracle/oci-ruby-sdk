...
module OCI
  ...
  class EmWarehouse::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::EmWarehouse::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::EmWarehouse::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::EmWarehouse::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
