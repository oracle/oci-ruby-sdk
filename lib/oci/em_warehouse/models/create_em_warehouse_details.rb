...
module OCI
  ...
  class EmWarehouse::Models::CreateEmWarehouseDetails
    ...
    def hash
      [display_name, em_bridge_id, compartment_id, operations_insights_warehouse_id, freeform_tags, defined_tags].hash
    end
