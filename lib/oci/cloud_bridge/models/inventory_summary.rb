...
module OCI
  ...
  class CloudBridge::Models::InventorySummary
    ...
    def hash
      [id, display_name, lifecycle_state, lifecycle_details, compartment_id, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
