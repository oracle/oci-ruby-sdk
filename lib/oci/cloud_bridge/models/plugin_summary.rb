...
module OCI
  ...
  class CloudBridge::Models::PluginSummary
    ...
    def hash
      [name, agent_id, plugin_version, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
