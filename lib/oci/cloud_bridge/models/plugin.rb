...
module OCI
  ...
  class CloudBridge::Models::Plugin
    DESIRED_STATE_ENUM = [
    ...
    def hash
      [name, agent_id, plugin_version, desired_state, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
