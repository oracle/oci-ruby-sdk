...
module OCI
  # Metric details.
  class CloudBridge::Models::HistoricalMetricSummary
    ...
    # @option attributes [String] :aggregation The value to assign to the {#aggregation} property
    ...
    def hash
      [name, aggregation, value, time_created, time_updated].hash
    end
