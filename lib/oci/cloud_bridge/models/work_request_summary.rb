...
module OCI
  ...
  class CloudBridge::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::CloudBridge::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::CloudBridge::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::CloudBridge::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
