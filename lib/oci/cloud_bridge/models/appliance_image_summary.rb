...
module OCI
  ...
  class CloudBridge::Models::ApplianceImageSummary
    ...
    # @option attributes [String] :size_in_mbs The value to assign to the {#size_in_mbs} property
    ...
    def hash
      [id, file_name, display_name, version, size_in_mbs, checksum, platform, format, time_created, time_updated, lifecycle_state, download_url, freeform_tags, defined_tags].hash
    end
