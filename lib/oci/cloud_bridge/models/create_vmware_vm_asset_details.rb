...
require 'date'
require_relative 'create_asset_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Create VMware VM type of asset.
  class CloudBridge::Models::CreateVmwareVmAssetDetails < CloudBridge::Models::CreateAssetDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#display_name #display_name} proprety
    # @option attributes [String] :inventory_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#inventory_id #inventory_id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#compartment_id #compartment_id} proprety
    # @option attributes [String] :source_key The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#source_key #source_key} proprety
    # @option attributes [String] :external_asset_key The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#external_asset_key #external_asset_key} proprety
    # @option attributes [Array<String>] :asset_source_ids The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#asset_source_ids #asset_source_ids} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::CloudBridge::Models::CreateAssetDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [display_name, inventory_id, compartment_id, source_key, external_asset_key, asset_type, asset_source_ids, freeform_tags, defined_tags, compute, vm, vmware_vm, vmware_v_center].hash
    end
