...
module OCI
  # VM type of asset.
  class CloudBridge::Models::VmAsset < CloudBridge::Models::Asset
    ...
    def hash
      [display_name, inventory_id, id, compartment_id, source_key, external_asset_key, asset_type, time_created, time_updated, asset_source_ids, lifecycle_state, freeform_tags, defined_tags, system_tags, compute, vm].hash
    end
