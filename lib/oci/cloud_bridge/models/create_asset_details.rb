...
module OCI
  ...
  class CloudBridge::Models::CreateAssetDetails
    ASSET_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudBridge::Models::CreateVmwareVmAssetDetails' if type == 'VMWARE_VM'
    ...
    def hash
      [display_name, inventory_id, compartment_id, source_key, external_asset_key, asset_type, asset_source_ids, freeform_tags, defined_tags].hash
    end
