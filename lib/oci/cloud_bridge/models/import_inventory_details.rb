...
module OCI
  ...
  class CloudBridge::Models::ImportInventoryDetails
    RESOURCE_TYPE_ENUM = [
      RESOURCE_TYPE_ASSET = 'ASSET'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudBridge::Models::ImportInventoryViaAssetsDetails' if type == 'ASSET'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CloudBridge::Models::ImportInventoryDetails'
    end
    ...
    def hash
      [compartment_id, resource_type, freeform_tags, defined_tags].hash
    end
