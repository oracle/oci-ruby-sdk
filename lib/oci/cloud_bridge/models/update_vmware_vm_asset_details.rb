...
module OCI
  ...
  class CloudBridge::Models::UpdateVmwareVmAssetDetails < CloudBridge::Models::UpdateAssetDetails
    ...
    def hash
      [display_name, asset_type, asset_source_ids, freeform_tags, defined_tags, compute, vm, vmware_vm, vmware_v_center].hash
    end
