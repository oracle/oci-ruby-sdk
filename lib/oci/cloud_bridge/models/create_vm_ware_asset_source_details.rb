...
module OCI
  ...
  class CloudBridge::Models::CreateVmWareAssetSourceDetails < CloudBridge::Models::CreateAssetSourceDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#display_name #display_name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#compartment_id #compartment_id} proprety
    # @option attributes [String] :environment_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#environment_id #environment_id} proprety
    # @option attributes [String] :inventory_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#inventory_id #inventory_id} proprety
    # @option attributes [String] :assets_compartment_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#assets_compartment_id #assets_compartment_id} proprety
    # @option attributes [String] :discovery_schedule_id The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#discovery_schedule_id #discovery_schedule_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#defined_tags #defined_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::CloudBridge::Models::CreateAssetSourceDetails#system_tags #system_tags} proprety
