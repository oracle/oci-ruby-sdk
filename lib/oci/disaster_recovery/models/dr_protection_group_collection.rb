...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DisasterRecovery::Models::DrProtectionGroupSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::DrProtectionGroupSummary>] :items The value to assign to the {#items} property
