...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanExecutionControlDetails
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_CANCEL = 'CANCEL'.freeze,
      ACTION_TYPE_PAUSE = 'PAUSE'.freeze,
      ACTION_TYPE_RESUME = 'RESUME'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::PauseDrPlanExecutionDetails' if type == 'PAUSE'
      return 'OCI::DisasterRecovery::Models::CancelDrPlanExecutionDetails' if type == 'CANCEL'
      return 'OCI::DisasterRecovery::Models::ResumeDrPlanExecutionDetails' if type == 'RESUME'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DisasterRecovery::Models::DrPlanExecutionControlDetails'
    end
