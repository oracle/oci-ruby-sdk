...
module OCI
  ...
  class DisasterRecovery::Models::DisassociateDrProtectionGroupDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::DisassociateDrProtectionGroupDefaultDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DisasterRecovery::Models::DisassociateDrProtectionGroupDetails'
    end
