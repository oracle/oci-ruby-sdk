...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanExecutionOptionDetails
    ...
    def plan_execution_type=(plan_execution_type)
      raise "Invalid value for 'plan_execution_type': this must be one of the values in PLAN_EXECUTION_TYPE_ENUM." if plan_execution_type && !PLAN_EXECUTION_TYPE_ENUM.include?(plan_execution_type)
