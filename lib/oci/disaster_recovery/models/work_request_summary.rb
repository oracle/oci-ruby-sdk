...
module OCI
  ...
  class DisasterRecovery::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
