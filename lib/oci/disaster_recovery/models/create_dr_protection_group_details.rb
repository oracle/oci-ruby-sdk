...
module OCI
  ...
  class DisasterRecovery::Models::CreateDrProtectionGroupDetails
    ...
    # @return [OCI::DisasterRecovery::Models::CreateObjectStorageLogLocationDetails]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'log_location': :'OCI::DisasterRecovery::Models::CreateObjectStorageLogLocationDetails',
        'association': :'OCI::DisasterRecovery::Models::AssociateDrProtectionGroupDetails',
        'members': :'Array<OCI::DisasterRecovery::Models::CreateDrProtectionGroupMemberDetails>',
    ...
    # @option attributes [OCI::DisasterRecovery::Models::CreateObjectStorageLogLocationDetails] :log_location The value to assign to the {#log_location} property
    # @option attributes [OCI::DisasterRecovery::Models::AssociateDrProtectionGroupDetails] :association The value to assign to the {#association} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::CreateDrProtectionGroupMemberDetails>] :members The value to assign to the {#members} property
    ...
    def hash
      [compartment_id, display_name, log_location, association, members, freeform_tags, defined_tags].hash
    end
