...
module OCI
  ...
  #
  class DisasterRecovery::Models::CreateComputeInstanceMovableFileSystemOperationDetails
    ...
    # @return [OCI::DisasterRecovery::Models::CreateFileSystemMountDetails]
    attr_accessor :mount_details

    # This attribute is required.
    # @return [OCI::DisasterRecovery::Models::CreateFileSystemUnmountDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::CreateFileSystemMountDetails] :mount_details The value to assign to the {#mount_details} property
    # @option attributes [OCI::DisasterRecovery::Models::CreateFileSystemUnmountDetails] :unmount_details The value to assign to the {#unmount_details} property
