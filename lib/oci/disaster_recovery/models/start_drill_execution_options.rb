...
require 'date'
require_relative 'dr_plan_execution_options'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Options for start drill execution.
  class DisasterRecovery::Models::StartDrillExecutionOptions < DisasterRecovery::Models::DrPlanExecutionOptions
    ...
    def initialize(attributes = {})
      ...
      attributes['planExecutionType'] = 'START_DRILL'
