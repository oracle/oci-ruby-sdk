...
module OCI
  ...
  class DisasterRecovery::Models::RunObjectStoreScriptUserDefinedStep < DisasterRecovery::Models::DrPlanUserDefinedStep
    ...
    # @return [OCI::DisasterRecovery::Models::ObjectStorageScriptLocation]
    attr_accessor :object_storage_script_location
    ...
    # @option attributes [OCI::DisasterRecovery::Models::ObjectStorageScriptLocation] :object_storage_script_location The value to assign to the {#object_storage_script_location} property
