...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrPlanStepDetails
    ...
    # @return [OCI::DisasterRecovery::Models::UpdateDrPlanUserDefinedStepDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::UpdateDrPlanUserDefinedStepDetails] :user_defined_step The value to assign to the {#user_defined_step} property
    ...
    def error_mode=(error_mode)
      raise "Invalid value for 'error_mode': this must be one of the values in ERROR_MODE_ENUM." if error_mode && !ERROR_MODE_ENUM.include?(error_mode)
