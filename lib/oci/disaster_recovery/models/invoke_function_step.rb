...
require 'date'
require_relative 'dr_plan_user_defined_step'
...
module OCI
  ...
  class DisasterRecovery::Models::InvokeFunctionStep < DisasterRecovery::Models::DrPlanUserDefinedStep
    ...
    # @option attributes [String] :function_region The value to assign to the {#function_region} property
    # @option attributes [String] :request_body The value to assign to the {#request_body} property
    def initialize(attributes = {})
      ...
      self.function_region = attributes[:'functionRegion'] if attributes[:'functionRegion']

      raise 'You cannot provide both :functionRegion and :function_region' if attributes.key?(:'functionRegion') && attributes.key?(:'function_region')

      self.function_region = attributes[:'function_region'] if attributes[:'function_region']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        function_region == other.function_region &&
    ...
    def hash
      [step_type, function_id, function_region, request_body].hash
    end
