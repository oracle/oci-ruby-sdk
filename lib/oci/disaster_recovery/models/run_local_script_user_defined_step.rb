...
module OCI
  ...
  class DisasterRecovery::Models::RunLocalScriptUserDefinedStep < DisasterRecovery::Models::DrPlanUserDefinedStep
    ...
    # **[Required]** The region in which the instance is present.
    #
    ...
    # @option attributes [String] :run_on_instance_id The value to assign to the {#run_on_instance_id} property
    # @option attributes [String] :run_on_instance_region The value to assign to the {#run_on_instance_region} property
    # @option attributes [String] :script_command The value to assign to the {#script_command} property
    ...
    def hash
      [step_type, run_on_instance_id, run_on_instance_region, script_command, run_as_user].hash
    end
