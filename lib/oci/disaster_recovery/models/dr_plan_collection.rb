...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DisasterRecovery::Models::DrPlanSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::DrPlanSummary>] :items The value to assign to the {#items} property
