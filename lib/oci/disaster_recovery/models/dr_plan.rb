...
module OCI
  ...
  class DisasterRecovery::Models::DrPlan
    ...
    # **[Required]** The OCID of this DR Plan.
    #
    ...
    # **[Required]** The display name of this DR Plan.
    #
    ...
    # **[Required]** The type of this DR Plan.
    #
    # @return [String]
    attr_reader :type
    ...
    # **[Required]** The OCID of the DR Protection Group with which this DR Plan is associated.
    #
    # Example: `ocid1.drplan.oc1.iad.&lt;unique_id&gt;`
    #
    # @return [String]
    ...
    # **[Required]** The OCID of the peer (remote) DR Protection Group associated with this plan's
    # DR Protection Group.
    #
    ...
    # **[Required]** The region of the peer (remote) DR Protection Group associated with this plan's
    # DR Protection Group.
    #
