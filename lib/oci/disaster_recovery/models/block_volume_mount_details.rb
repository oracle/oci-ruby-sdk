...
module OCI
  ...
  #
  class DisasterRecovery::Models::BlockVolumeMountDetails
    # **[Required]** The physical mount point used for mounting and unmounting the file system on a block volume.
    #
