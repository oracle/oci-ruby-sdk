...
module OCI
  ...
  class DisasterRecovery::Models::CreateDrProtectionGroupMemberComputeInstanceDetails < DisasterRecovery::Models::CreateDrProtectionGroupMemberDetails
    ...
    def self.swagger_types
      {
        ...
        'member_type': :'String',
        'is_movable': :'BOOLEAN',
        'vnic_mapping': :'Array<OCI::DisasterRecovery::Models::ComputeInstanceVnicMappingDetails>',
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::ComputeInstanceVnicMappingDetails>] :vnic_mapping The value to assign to the {#vnic_mapping} property
