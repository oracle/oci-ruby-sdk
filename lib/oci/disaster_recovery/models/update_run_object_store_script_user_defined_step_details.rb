...
require 'date'
require_relative 'update_dr_plan_user_defined_step_details'
...
module OCI
  ...
  class DisasterRecovery::Models::UpdateRunObjectStoreScriptUserDefinedStepDetails < DisasterRecovery::Models::UpdateDrPlanUserDefinedStepDetails
    ...
    # @return [OCI::DisasterRecovery::Models::UpdateObjectStorageScriptLocationDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::UpdateObjectStorageScriptLocationDetails] :object_storage_script_location The value to assign to the {#object_storage_script_location} property
    ...
    def hash
      [step_type, run_on_instance_id, object_storage_script_location].hash
    end
