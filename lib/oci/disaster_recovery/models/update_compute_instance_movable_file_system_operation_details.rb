...
module OCI
  ...
  #
  class DisasterRecovery::Models::UpdateComputeInstanceMovableFileSystemOperationDetails
    ...
    # @return [OCI::DisasterRecovery::Models::UpdateFileSystemMountDetails]
    attr_accessor :mount_details

    # This attribute is required.
    # @return [OCI::DisasterRecovery::Models::UpdateFileSystemUnmountDetails]
    attr_accessor :unmount_details
    ...
    def self.swagger_types
      {
        ...
        'export_path': :'String',
        'mount_point': :'String',
        'mount_details': :'OCI::DisasterRecovery::Models::UpdateFileSystemMountDetails',
        'unmount_details': :'OCI::DisasterRecovery::Models::UpdateFileSystemUnmountDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :export_path The value to assign to the {#export_path} property
    # @option attributes [String] :mount_point The value to assign to the {#mount_point} property
    # @option attributes [OCI::DisasterRecovery::Models::UpdateFileSystemMountDetails] :mount_details The value to assign to the {#mount_details} property
    # @option attributes [OCI::DisasterRecovery::Models::UpdateFileSystemUnmountDetails] :unmount_details The value to assign to the {#unmount_details} property
