...
module OCI
  ...
  class DisasterRecovery::Models::SwitchoverExecutionOptionDetails < DisasterRecovery::Models::DrPlanExecutionOptionDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['planExecutionType'] = 'SWITCHOVER'
