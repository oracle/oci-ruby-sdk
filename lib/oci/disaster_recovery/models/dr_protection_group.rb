...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroup
    ROLE_ENUM = [
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::DrProtectionGroupMember>]
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::DrProtectionGroupMember>] :members The value to assign to the {#members} property
    ...
    def hash
      [id, compartment_id, display_name, role, peer_id, peer_region, log_location, members, time_created, time_updated, lifecycle_state, life_cycle_details, freeform_tags, defined_tags, system_tags].hash
    end
