...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupMember
    ...
    def member_type=(member_type)
      ...
      if member_type && !MEMBER_TYPE_ENUM.include?(member_type)
        OCI.logger.debug("Unknown value for 'member_type' [" + member_type + "]. Mapping to 'MEMBER_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @member_type = MEMBER_TYPE_UNKNOWN_ENUM_VALUE
      else
