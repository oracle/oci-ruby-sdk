...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrPlanDetails
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::UpdateDrPlanGroupDetails>]
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::UpdateDrPlanGroupDetails>] :plan_groups The value to assign to the {#plan_groups} property
    ...
    def hash
      [display_name, plan_groups, freeform_tags, defined_tags].hash
    end
