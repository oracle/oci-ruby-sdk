...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupDetails
    ...
    # @option attributes [OCI::DisasterRecovery::Models::UpdateObjectStorageLogLocationDetails] :log_location The value to assign to the {#log_location} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails>] :members The value to assign to the {#members} property
    ...
    def hash
      [display_name, log_location, members, freeform_tags, defined_tags].hash
    end
