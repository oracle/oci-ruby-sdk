...
module OCI
  ...
  class DisasterRecovery::Models::CreateDrProtectionGroupMemberFileSystemDetails < DisasterRecovery::Models::CreateDrProtectionGroupMemberDetails
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::FileSystemExportMappingDetails>]
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::FileSystemExportMappingDetails>] :export_mappings The value to assign to the {#export_mappings} property
    ...
    def hash
      [member_id, member_type, destination_availability_domain, export_mappings].hash
    end
