...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanStep
    TYPE_ENUM = [
    ...
    # **[Required]** The unique id of this step. Must not be modified by the user.
    #
    ...
    # @return [OCI::DisasterRecovery::Models::DrPlanUserDefinedStep]
    attr_accessor :user_defined_step
    ...
    # @option attributes [String] :error_mode The value to assign to the {#error_mode} property
    # @option attributes [Integer] :timeout The value to assign to the {#timeout} property
    # @option attributes [BOOLEAN] :is_enabled The value to assign to the {#is_enabled} property
    # @option attributes [OCI::DisasterRecovery::Models::DrPlanUserDefinedStep] :user_defined_step The value to assign to the {#user_defined_step} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] error_mode Object to be assigned
    def error_mode=(error_mode)
      # rubocop:disable Style/ConditionalAssignment
      if error_mode && !ERROR_MODE_ENUM.include?(error_mode)
        OCI.logger.debug("Unknown value for 'error_mode' [" + error_mode + "]. Mapping to 'ERROR_MODE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @error_mode = ERROR_MODE_UNKNOWN_ENUM_VALUE
      else
