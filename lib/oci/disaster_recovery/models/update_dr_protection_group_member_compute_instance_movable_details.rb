...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberComputeInstanceMovableDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::UpdateComputeInstanceMovableFileSystemOperationDetails>]
    ...
    def self.swagger_types
      {
        ...
        'file_system_operations': :'Array<OCI::DisasterRecovery::Models::UpdateComputeInstanceMovableFileSystemOperationDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::UpdateComputeInstanceMovableFileSystemOperationDetails>] :file_system_operations The value to assign to the {#file_system_operations} property
