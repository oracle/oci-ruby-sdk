...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanExecutionCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DisasterRecovery::Models::DrPlanExecutionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::DrPlanExecutionSummary>] :items The value to assign to the {#items} property
