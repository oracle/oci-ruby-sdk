...
module OCI
  ...
  #
  class DisasterRecovery::Models::BlockVolumeAttachmentDetails
    # **[Required]** The OCID of the reference compute instance from which to obtain the attachment details for the volume.
    # This reference compute instance is from the peer DR protection group.
    #
    # Example: `ocid1.instance.oc1..uniqueID`
    #
    # @return [String]
    attr_accessor :volume_attachment_reference_instance_id
    ...
    # @option attributes [String] :volume_attachment_reference_instance_id The value to assign to the {#volume_attachment_reference_instance_id} property
