...
module OCI
  ...
  class DisasterRecovery::Models::CreateDrPlanExecutionDetails
    ...
    # @return [OCI::DisasterRecovery::Models::DrPlanExecutionOptionDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::DrPlanExecutionOptionDetails] :execution_options The value to assign to the {#execution_options} property
    ...
    def hash
      [display_name, plan_id, execution_options, freeform_tags, defined_tags].hash
    end
