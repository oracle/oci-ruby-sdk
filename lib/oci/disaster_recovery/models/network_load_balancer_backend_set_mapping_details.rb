...
module OCI
  ...
  class DisasterRecovery::Models::NetworkLoadBalancerBackendSetMappingDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_backend_set_for_non_movable
    ...
    #
    # @return [String]
    attr_accessor :source_backend_set_name
    ...
    #
    # @return [String]
    attr_accessor :destination_backend_set_name
    ...
    # @option attributes [BOOLEAN] :is_backend_set_for_non_movable The value to assign to the {#is_backend_set_for_non_movable} property
    # @option attributes [String] :source_backend_set_name The value to assign to the {#source_backend_set_name} property
    # @option attributes [String] :destination_backend_set_name The value to assign to the {#destination_backend_set_name} property
