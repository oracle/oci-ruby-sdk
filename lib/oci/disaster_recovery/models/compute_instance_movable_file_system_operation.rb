...
module OCI
  ...
  #
  class DisasterRecovery::Models::ComputeInstanceMovableFileSystemOperation
    ...
    # @return [OCI::DisasterRecovery::Models::FileSystemMountDetails]
    attr_accessor :mount_details

    # This attribute is required.
    # @return [OCI::DisasterRecovery::Models::FileSystemUnmountDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::FileSystemMountDetails] :mount_details The value to assign to the {#mount_details} property
    # @option attributes [OCI::DisasterRecovery::Models::FileSystemUnmountDetails] :unmount_details The value to assign to the {#unmount_details} property
