...
module OCI
  ...
  #
  class DisasterRecovery::Models::DrProtectionGroupMemberLoadBalancer < DisasterRecovery::Models::DrProtectionGroupMember
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::LoadBalancerBackendSetMapping>]
    ...
    def self.swagger_types
      {
        ...
        'backend_set_mappings': :'Array<OCI::DisasterRecovery::Models::LoadBalancerBackendSetMapping>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DisasterRecovery::Models::LoadBalancerBackendSetMapping>] :backend_set_mappings The value to assign to the {#backend_set_mappings} property
