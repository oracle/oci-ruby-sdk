...
module OCI
  ...
  class ComputeInstanceAgent::Models::InstanceAgentCommandSourceViaObjectStorageTupleDetails < ComputeInstanceAgent::Models::InstanceAgentCommandSourceDetails
    ...
    # **[Required]** The Object Storage name for the command.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceType'] = 'OBJECT_STORAGE_TUPLE'
