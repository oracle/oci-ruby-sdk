...
module OCI
  ...
  class ComputeInstanceAgent::Models::InstanceAgentCommandSourceDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_TEXT = 'TEXT'.freeze,
      SOURCE_TYPE_OBJECT_STORAGE_URI = 'OBJECT_STORAGE_URI'.freeze,
      SOURCE_TYPE_OBJECT_STORAGE_TUPLE = 'OBJECT_STORAGE_TUPLE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ComputeInstanceAgent::Models::InstanceAgentCommandSourceViaObjectStorageTupleDetails' if type == 'OBJECT_STORAGE_TUPLE'
      return 'OCI::ComputeInstanceAgent::Models::InstanceAgentCommandSourceViaObjectStorageUriDetails' if type == 'OBJECT_STORAGE_URI'
      return 'OCI::ComputeInstanceAgent::Models::InstanceAgentCommandSourceViaTextDetails' if type == 'TEXT'
    ...
    def initialize(attributes = {})
      ...
      self.source_type = "TEXT" if source_type.nil? && !attributes.key?(:'sourceType') # rubocop:disable Style/StringLiterals
      ...
      self.source_type = "TEXT" if source_type.nil? && !attributes.key?(:'sourceType') && !attributes.key?(:'source_type') # rubocop:disable Style/StringLiterals
    end
