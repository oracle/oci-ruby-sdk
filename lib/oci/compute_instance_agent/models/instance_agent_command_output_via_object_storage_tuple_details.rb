...
module OCI
  ...
  class ComputeInstanceAgent::Models::InstanceAgentCommandOutputViaObjectStorageTupleDetails < ComputeInstanceAgent::Models::InstanceAgentCommandOutputDetails
    ...
    def hash
      [output_type, bucket_name, namespace_name, object_name].hash
    end
