...
module OCI
  # The command content.
  class ComputeInstanceAgent::Models::InstanceAgentCommandContentInfo
    ...
    def hash
      [instance_agent_command_id, compartment_id, time_created, time_updated, is_canceled, execution_time_out_in_seconds, content].hash
    end
