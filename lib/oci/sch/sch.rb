...
require 'oci/sch/models/logging_analytics_target_details'
require 'oci/sch/models/logging_source_details'
require 'oci/sch/models/monitoring_source'
require 'oci/sch/models/monitoring_source_all_metrics'
require 'oci/sch/models/monitoring_source_details'
require 'oci/sch/models/monitoring_source_metric_details'
require 'oci/sch/models/monitoring_source_namespace_details'
require 'oci/sch/models/monitoring_source_selected_namespace'
require 'oci/sch/models/monitoring_source_selected_namespace_details'
...
require 'oci/sch/models/trim_horizon_streaming_cursor'
