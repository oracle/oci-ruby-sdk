...
module OCI
  ...
  #
  class Sch::Models::ServiceConnector
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the service connector.
    #
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the service connector.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The date and time when the service connector was created.
    ...
    # **[Required]** The date and time when the service connector was updated.
    # Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    # Example: `2020-01-25T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # @return [OCI::Sch::Models::SourceDetails]
    attr_accessor :source

    # The list of tasks.
    #
    # @return [Array<OCI::Sch::Models::TaskDetails>]
    attr_accessor :tasks

    # @return [OCI::Sch::Models::TargetDetails]
    ...
    # @option attributes [OCI::Sch::Models::SourceDetails] :source The value to assign to the {#source} property
    # @option attributes [Array<OCI::Sch::Models::TaskDetails>] :tasks The value to assign to the {#tasks} property
    # @option attributes [OCI::Sch::Models::TargetDetails] :target The value to assign to the {#target} property
