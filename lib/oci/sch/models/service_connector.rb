...
module OCI
  ...
  class Sch::Models::ServiceConnector
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector.
    #
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the connector.
    #
    # @return [String]
