...
module OCI
  ...
  class Sch::Models::StreamingCursorDetails
    KIND_ENUM = [
      KIND_LATEST = 'LATEST'.freeze,
      KIND_TRIM_HORIZON = 'TRIM_HORIZON'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Sch::Models::TrimHorizonStreamingCursor' if type == 'TRIM_HORIZON'
      return 'OCI::Sch::Models::LatestStreamingCursor' if type == 'LATEST'
