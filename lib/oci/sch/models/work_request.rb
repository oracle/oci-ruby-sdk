...
module OCI
  ...
  class Sch::Models::WorkRequest
    ...
    #
    # @return [Array<OCI::Sch::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::Sch::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
