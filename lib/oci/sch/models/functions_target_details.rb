...
module OCI
  ...
  class Sch::Models::FunctionsTargetDetails < Sch::Models::TargetDetails
    ...
    #
    # @return [Integer]
    attr_accessor :batch_size_in_num
    ...
    # @option attributes [Integer] :batch_size_in_num The value to assign to the {#batch_size_in_num} property
    ...
    def initialize(attributes = {})
      ...
      self.batch_size_in_num = attributes[:'batchSizeInNum'] if attributes[:'batchSizeInNum']

      raise 'You cannot provide both :batchSizeInNum and :batch_size_in_num' if attributes.key?(:'batchSizeInNum') && attributes.key?(:'batch_size_in_num')

      self.batch_size_in_num = attributes[:'batch_size_in_num'] if attributes[:'batch_size_in_num']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        batch_size_in_num == other.batch_size_in_num &&
    ...
    def hash
      [kind, function_id, batch_size_in_kbs, batch_size_in_num, batch_time_in_sec].hash
    end
