...
module OCI
  ...
  #
  class Sch::Models::LoggingAnalyticsTargetDetails < Sch::Models::TargetDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Logging Analytics log group.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['kind'] = 'loggingAnalytics'
