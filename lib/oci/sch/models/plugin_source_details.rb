...
module OCI
  ...
  #
  class Sch::Models::PluginSourceDetails < Sch::Models::SourceDetails
    # **[Required]** The name of the connector plugin. This name indicates the service to be called by the connector plugin. For example, `QueueSource` indicates the Queue service.
    ...
    # **[Required]** The configuration map for the connector plugin. This map includes parameters specific to the connector plugin type.
    ...
    # @option attributes [Object] :config_map The value to assign to the {#config_map} property
