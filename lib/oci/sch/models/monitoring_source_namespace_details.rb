...
module OCI
  ...
  class Sch::Models::MonitoringSourceNamespaceDetails
    KIND_ENUM = [
      KIND_SELECTED = 'selected'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Sch::Models::MonitoringSourceSelectedNamespaceDetails' if type == 'selected'
