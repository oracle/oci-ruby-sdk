...
module OCI
  ...
  #
  class Sch::Models::DimensionDetails
    # **[Required]** Dimension key. A valid dimension key includes only printable ASCII, excluding periods (.) and spaces.
    ...
    # For information on valid dimension keys and values, see {#metric_data_details metric_data_details}.
    # Example: `type`
    #
    # @return [String]
    attr_accessor :name
    ...
    # @return [OCI::Sch::Models::DimensionValueDetails]
    ...
    # @option attributes [OCI::Sch::Models::DimensionValueDetails] :dimension_value The value to assign to the {#dimension_value} property
