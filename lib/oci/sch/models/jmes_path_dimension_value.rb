...
require 'date'
require_relative 'dimension_value_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Evaluated type of dimension value.
  #
  class Sch::Models::JmesPathDimensionValue < Sch::Models::DimensionValueDetails
    # **[Required]** The location to use for deriving the dimension value (evaluated).
    # The path must start with `logContent` in an acceptable notation style with supported [JMESPath selectors](https://jmespath.org/specification.html): expression with dot and index operator (`.`, and `{#metric_data_details metric_data_details}.
