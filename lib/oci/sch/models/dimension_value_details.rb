...
module OCI
  ...
  class Sch::Models::DimensionValueDetails
    KIND_ENUM = [
      KIND_JMES_PATH = 'jmesPath'.freeze,
      KIND_STATIC = 'static'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Sch::Models::StaticDimensionValue' if type == 'static'
      return 'OCI::Sch::Models::JmesPathDimensionValue' if type == 'jmesPath'
