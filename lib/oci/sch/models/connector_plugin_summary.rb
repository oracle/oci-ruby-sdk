...
module OCI
  ...
  class Sch::Models::ConnectorPluginSummary
    KIND_ENUM = [
    ...
    #
    # @return [String]
    attr_reader :estimated_throughput
    ...
    # @option attributes [String] :estimated_throughput The value to assign to the {#estimated_throughput} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] estimated_throughput Object to be assigned
    def estimated_throughput=(estimated_throughput)
      # rubocop:disable Style/ConditionalAssignment
      if estimated_throughput && !ESTIMATED_THROUGHPUT_ENUM.include?(estimated_throughput)
        OCI.logger.debug("Unknown value for 'estimated_throughput' [" + estimated_throughput + "]. Mapping to 'ESTIMATED_THROUGHPUT_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @estimated_throughput = ESTIMATED_THROUGHPUT_UNKNOWN_ENUM_VALUE
      else
