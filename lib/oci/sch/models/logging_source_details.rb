...
module OCI
  ...
  class Sch::Models::LoggingSourceDetails < Sch::Models::SourceDetails
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'kind': :'String',
        'log_sources': :'Array<OCI::Sch::Models::LogSource>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Sch::Models::LogSource>] :log_sources The value to assign to the {#log_sources} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['kind'] = 'logging'
