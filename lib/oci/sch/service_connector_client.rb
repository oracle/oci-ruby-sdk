...
module OCI
  ...
  class Sch::ServiceConnectorClient
    ...
    #
    # @param [String] service_connector_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector.
    #
    ...
    # @param [String] service_connector_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector.
    #
    # @param [OCI::Sch::Models::ChangeServiceConnectorCompartmentDetails] change_service_connector_compartment_details The configuration details for moving a connector to a different compartment.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    # [Activating a Connector](https://docs.cloud.oracle.com/iaas/Content/connector-hub/activate-service-connector.htm).
    #
    # @param [OCI::Sch::Models::CreateServiceConnectorDetails] create_service_connector_details Configuration details for the new connector.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
