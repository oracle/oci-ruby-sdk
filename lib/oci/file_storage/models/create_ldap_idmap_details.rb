...
module OCI
  ...
  #
  class FileStorage::Models::CreateLdapIdmapDetails
    SCHEMA_TYPE_ENUM = [
    ...
    def schema_type=(schema_type)
      raise "Invalid value for 'schema_type': this must be one of the values in SCHEMA_TYPE_ENUM." if schema_type && !SCHEMA_TYPE_ENUM.include?(schema_type)
