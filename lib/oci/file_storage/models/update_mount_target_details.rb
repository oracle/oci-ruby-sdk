...
module OCI
  ...
  class FileStorage::Models::UpdateMountTargetDetails
    ...
    # @return [OCI::FileStorage::Models::UpdateLdapIdmapDetails]
    ...
    # @return [OCI::FileStorage::Models::UpdateKerberosDetails]
    ...
    # @option attributes [OCI::FileStorage::Models::UpdateLdapIdmapDetails] :ldap_idmap The value to assign to the {#ldap_idmap} property
    # @option attributes [Array<String>] :nsg_ids The value to assign to the {#nsg_ids} property
    # @option attributes [OCI::FileStorage::Models::UpdateKerberosDetails] :kerberos The value to assign to the {#kerberos} property
    ...
    def hash
      [display_name, idmap_type, ldap_idmap, nsg_ids, kerberos, freeform_tags, defined_tags].hash
    end
