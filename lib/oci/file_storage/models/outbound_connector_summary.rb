...
module OCI
  ...
  class FileStorage::Models::OutboundConnectorSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the outbound connector.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The date and time the outbound connector was created
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FileStorage::Models::LdapBindAccountSummary' if type == 'LDAPBIND'
