...
module OCI
  ...
  class FileStorage::Models::Snapshot
    ...
    def hash
      [file_system_id, id, lifecycle_state, name, time_created, snapshot_type, snapshot_time, provenance_id, is_clone_source, lifecycle_details, freeform_tags, defined_tags, expiration_time, filesystem_snapshot_policy_id].hash
    end
