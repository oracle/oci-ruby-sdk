...
module OCI
  ...
  #
  class FileStorage::Models::ReplicationTargetSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the replication target.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** A user-friendly name. This name is the same as the associated replication name.
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, freeform_tags, defined_tags, lifecycle_details, recovery_point_time].hash
    end
