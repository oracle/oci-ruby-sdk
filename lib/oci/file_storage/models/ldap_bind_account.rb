...
require 'date'
require_relative 'outbound_connector'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Account details for the LDAP bind account used by the outbound connector.
  #
  class FileStorage::Models::LdapBindAccount < FileStorage::Models::OutboundConnector
    ...
    # @option attributes [String] :availability_domain The value to assign to the {OCI::FileStorage::Models::OutboundConnector#availability_domain #availability_domain} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::FileStorage::Models::OutboundConnector#compartment_id #compartment_id} proprety
    # @option attributes [String] :id The value to assign to the {OCI::FileStorage::Models::OutboundConnector#id #id} proprety
    # @option attributes [String] :lifecycle_state The value to assign to the {OCI::FileStorage::Models::OutboundConnector#lifecycle_state #lifecycle_state} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::FileStorage::Models::OutboundConnector#display_name #display_name} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::FileStorage::Models::OutboundConnector#time_created #time_created} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::FileStorage::Models::OutboundConnector#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::FileStorage::Models::OutboundConnector#defined_tags #defined_tags} proprety
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, connector_type, freeform_tags, defined_tags, endpoints, bind_distinguished_name, password_secret_id, password_secret_version].hash
    end
