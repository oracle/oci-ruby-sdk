...
module OCI
  ...
  class FileStorage::Models::SnapshotSummary
    ...
    SNAPSHOT_TYPE_ENUM = [
      SNAPSHOT_TYPE_USER = 'USER'.freeze,
      SNAPSHOT_TYPE_POLICY_BASED = 'POLICY_BASED'.freeze,
      SNAPSHOT_TYPE_REPLICATION = 'REPLICATION'.freeze,
      SNAPSHOT_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :snapshot_type The value to assign to the {#snapshot_type} property
    # @option attributes [DateTime] :snapshot_time The value to assign to the {#snapshot_time} property
    ...
    def initialize(attributes = {})
      ...
      self.snapshot_type = attributes[:'snapshotType'] if attributes[:'snapshotType']

      raise 'You cannot provide both :snapshotType and :snapshot_type' if attributes.key?(:'snapshotType') && attributes.key?(:'snapshot_type')

      self.snapshot_type = attributes[:'snapshot_type'] if attributes[:'snapshot_type']

      self.snapshot_time = attributes[:'snapshotTime'] if attributes[:'snapshotTime']

      raise 'You cannot provide both :snapshotTime and :snapshot_time' if attributes.key?(:'snapshotTime') && attributes.key?(:'snapshot_time')

      self.snapshot_time = attributes[:'snapshot_time'] if attributes[:'snapshot_time']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] snapshot_type Object to be assigned
    def snapshot_type=(snapshot_type)
      # rubocop:disable Style/ConditionalAssignment
      if snapshot_type && !SNAPSHOT_TYPE_ENUM.include?(snapshot_type)
        OCI.logger.debug("Unknown value for 'snapshot_type' [" + snapshot_type + "]. Mapping to 'SNAPSHOT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @snapshot_type = SNAPSHOT_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [file_system_id, id, lifecycle_state, name, time_created, snapshot_type, snapshot_time, expiration_time, provenance_id, is_clone_source, lifecycle_details, freeform_tags, defined_tags].hash
    end
