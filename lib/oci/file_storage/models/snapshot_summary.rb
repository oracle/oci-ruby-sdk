...
module OCI
  ...
  #
  class FileStorage::Models::SnapshotSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system from which the snapshot was created.
    #
    # @return [String]
    ...
    # **[Required]** The date and time the snapshot was created, expressed
