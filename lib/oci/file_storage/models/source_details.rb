...
module OCI
  ...
  #
  class FileStorage::Models::SourceDetails
    ...
    #
    # @return [String]
    attr_accessor :parent_file_system_id
    ...
    # @option attributes [String] :parent_file_system_id The value to assign to the {#parent_file_system_id} property
    # @option attributes [String] :source_snapshot_id The value to assign to the {#source_snapshot_id} property
    def initialize(attributes = {})
      ...
      self.parent_file_system_id = attributes[:'parentFileSystemId'] if attributes[:'parentFileSystemId']

      raise 'You cannot provide both :parentFileSystemId and :parent_file_system_id' if attributes.key?(:'parentFileSystemId') && attributes.key?(:'parent_file_system_id')

      self.parent_file_system_id = attributes[:'parent_file_system_id'] if attributes[:'parent_file_system_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        parent_file_system_id == other.parent_file_system_id &&
    ...
    def hash
      [parent_file_system_id, source_snapshot_id].hash
    end
