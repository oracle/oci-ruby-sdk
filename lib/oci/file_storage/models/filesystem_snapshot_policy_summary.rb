...
module OCI
  ...
  #
  class FileStorage::Models::FilesystemSnapshotPolicySummary
    ...
    # **[Required]** The date and time that the file system snapshot policy was created
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, policy_prefix, freeform_tags, defined_tags].hash
    end
