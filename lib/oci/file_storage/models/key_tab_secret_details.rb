...
module OCI
  ...
  class FileStorage::Models::KeyTabSecretDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the keytab secret in the Vault.
    # @return [String]
    ...
    def hash
      [key_tab_secret_id, current_key_tab_secret_version, backup_key_tab_secret_version].hash
    end
