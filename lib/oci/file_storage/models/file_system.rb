...
module OCI
  ...
  class FileStorage::Models::FileSystem
    ...
    def hash
      [availability_domain, metered_bytes, compartment_id, display_name, id, lifecycle_state, time_created, freeform_tags, defined_tags, kms_key_id, source_details, is_clone_parent, is_hydrated, lifecycle_details, is_targetable, replication_target_id, filesystem_snapshot_policy_id].hash
    end
