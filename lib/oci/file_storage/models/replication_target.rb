...
module OCI
  # Replication targets are associated with a primary resource called a {Replication}
  ...
  #
  class FileStorage::Models::ReplicationTarget
    ...
    # **[Required]** A user-friendly name. This name is same as the replication display name for the associated resource.
    # Example: `My Replication`
    #
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The date and time the replication target was created in target region.
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of source filesystem.
    # @return [String]
    attr_accessor :source_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of target filesystem.
    # @return [String]
    attr_accessor :target_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of replication.
    # @return [String]
