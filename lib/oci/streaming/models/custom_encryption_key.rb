...
module OCI
  ...
  class Streaming::Models::CustomEncryptionKey
    KEY_STATE_ENUM = [
    ...
    # @option attributes [String] :key_state The value to assign to the {#key_state} property
    ...
    # @param [Object] key_state Object to be assigned
    def key_state=(key_state)
      # rubocop:disable Style/ConditionalAssignment
      if key_state && !KEY_STATE_ENUM.include?(key_state)
        OCI.logger.debug("Unknown value for 'key_state' [" + key_state + "]. Mapping to 'KEY_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @key_state = KEY_STATE_UNKNOWN_ENUM_VALUE
      else
        @key_state = key_state
      end
