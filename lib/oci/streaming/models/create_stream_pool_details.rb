...
module OCI
  ...
  class Streaming::Models::CreateStreamPoolDetails
    # **[Required]** The OCID of the compartment that contains the stream.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The name of the stream pool. Avoid entering confidential information.
    #
    ...
    # @return [OCI::Streaming::Models::PrivateEndpointDetails]
    attr_accessor :private_endpoint_details
    ...
    def self.swagger_types
      {
        ...
        'private_endpoint_details': :'OCI::Streaming::Models::PrivateEndpointDetails',
    ...
    # @option attributes [OCI::Streaming::Models::PrivateEndpointDetails] :private_endpoint_details The value to assign to the {#private_endpoint_details} property
    ...
    def initialize(attributes = {})
      ...
      self.private_endpoint_details = attributes[:'privateEndpointDetails'] if attributes[:'privateEndpointDetails']

      raise 'You cannot provide both :privateEndpointDetails and :private_endpoint_details' if attributes.key?(:'privateEndpointDetails') && attributes.key?(:'private_endpoint_details')

      self.private_endpoint_details = attributes[:'private_endpoint_details'] if attributes[:'private_endpoint_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        private_endpoint_details == other.private_endpoint_details &&
    ...
    def hash
      [compartment_id, name, kafka_settings, custom_encryption_key_details, private_endpoint_details, freeform_tags, defined_tags].hash
    end
