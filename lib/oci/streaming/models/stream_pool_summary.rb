...
module OCI
  ...
  class Streaming::Models::StreamPoolSummary
    ...
    # The associated endpoint and subnetId of a private stream pool can be retrieved through the {#get_stream_pool get_stream_pool} API.
    #
    # @return [BOOLEAN]
    ...
    def hash
      [id, compartment_id, name, lifecycle_state, time_created, is_private, freeform_tags, defined_tags].hash
    end
