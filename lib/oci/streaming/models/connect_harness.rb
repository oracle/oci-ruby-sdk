...
module OCI
  ...
  class Streaming::Models::ConnectHarness
    ...
    # **[Required]** The name of the connect harness. Avoid entering confidential information.
    #
    ...
    # **[Required]** The date and time the connect harness was created, expressed in in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.
    #
    ...
    def hash
      [name, id, compartment_id, lifecycle_state, lifecycle_state_details, time_created, freeform_tags, defined_tags].hash
    end
