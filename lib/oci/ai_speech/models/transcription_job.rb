...
module OCI
  ...
  class AiSpeech::Models::TranscriptionJob
    ADDITIONAL_TRANSCRIPTION_FORMATS_ENUM = [
      ADDITIONAL_TRANSCRIPTION_FORMATS_SRT = 'SRT'.freeze,
      ADDITIONAL_TRANSCRIPTION_FORMATS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def additional_transcription_formats=(additional_transcription_formats)
      ...
      if additional_transcription_formats.nil?
        ...
        @additional_transcription_formats =
          additional_transcription_formats.collect do |item|
            if ADDITIONAL_TRANSCRIPTION_FORMATS_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'additional_transcription_formats' [#{item}]. Mapping to 'ADDITIONAL_TRANSCRIPTION_FORMATS_UNKNOWN_ENUM_VALUE'") if OCI.logger
              ADDITIONAL_TRANSCRIPTION_FORMATS_UNKNOWN_ENUM_VALUE
            end
          end
      end
    ...
    def hash
      [id, display_name, compartment_id, description, model_details, normalization, time_accepted, time_started, time_finished, total_tasks, outstanding_tasks, successful_tasks, ttl_in_days, percent_complete, input_location, output_location, created_by, additional_transcription_formats, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
