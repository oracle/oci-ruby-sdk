...
require 'date'
require 'logger'
require_relative 'transcription_filter'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Profanity transcription filter to recognize profane words.
  class AiSpeech::Models::ProfanityTranscriptionFilter < AiSpeech::Models::TranscriptionFilter
    MODE_ENUM = [
      MODE_MASK = 'MASK'.freeze,
      MODE_REMOVE = 'REMOVE'.freeze,
      MODE_TAG = 'TAG'.freeze,
      MODE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** - `MASK`: Will mask detected profanity in transcription.
