...
module OCI
  ...
  class AiSpeech::Models::ObjectListFileInputLocation < AiSpeech::Models::InputLocation
    ...
    # @option attributes [OCI::AiSpeech::Models::ObjectLocation] :object_location The value to assign to the {#object_location} property
