...
module OCI
  ...
  class AiSpeech::Models::ObjectLocation
    ...
    # @option attributes [Array<String>] :object_names The value to assign to the {#object_names} property
    def initialize(attributes = {})
      ...
      self.object_names = attributes[:'objectNames'] if attributes[:'objectNames']

      raise 'You cannot provide both :objectNames and :object_names' if attributes.key?(:'objectNames') && attributes.key?(:'object_names')

      self.object_names = attributes[:'object_names'] if attributes[:'object_names']
    end
    ...
    def hash
      [namespace_name, bucket_name, object_names].hash
    end
