...
module OCI
  ...
  class AiSpeech::Models::TranscriptionTaskSummary
    ...
    def hash
      [id, display_name, percent_complete, file_size_in_bytes, file_duration_in_seconds, processing_duration_in_seconds, time_started, time_finished, lifecycle_state, lifecycle_details].hash
    end
