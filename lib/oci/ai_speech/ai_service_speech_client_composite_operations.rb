...
module OCI
  ...
  class AiSpeech::AIServiceSpeechClientCompositeOperations
    ...
    # Calls {OCI::AiSpeech::AIServiceSpeechClient#delete_transcription_job} and then waits for the {OCI::AiSpeech::Models::TranscriptionJob} acted upon
    # to enter the given state(s).
    #
    # @param [String] transcription_job_id Unique Transcription Job identifier.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::AiSpeech::Models::TranscriptionJob#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::AiSpeech::AIServiceSpeechClient#delete_transcription_job}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_transcription_job_and_wait_for_state(transcription_job_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_transcription_job(transcription_job_id)
      operation_result = @service_client.delete_transcription_job(transcription_job_id, base_operation_opts)
