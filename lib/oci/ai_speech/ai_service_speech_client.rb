...
module OCI
  ...
  class AiSpeech::AIServiceSpeechClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/delete_transcription_job.rb.html) to see an example of how to use delete_transcription_job API.
    def delete_transcription_job(transcription_job_id, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#delete_transcription_job.' if logger

      raise "Missing the required parameter 'transcription_job_id' when calling delete_transcription_job." if transcription_job_id.nil?
      raise "Parameter value for 'transcription_job_id' must not be blank" if OCI::Internal::Util.blank_string?(transcription_job_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#delete_transcription_job') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
