...
module OCI
  ...
  class AppmgmtControl::Models::MonitoredInstanceSummary
    ...
    # @return [String]
    attr_accessor :monitoring_state
    ...
    def hash
      [instance_id, compartment_id, display_name, management_agent_id, lifecycle_state, monitoring_state].hash
    end
