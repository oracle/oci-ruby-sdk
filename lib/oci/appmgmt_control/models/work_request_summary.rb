...
module OCI
  ...
  class AppmgmtControl::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_ACTIVATE_RESOURCE_MONITORING_PLUGIN = 'ACTIVATE_RESOURCE_MONITORING_PLUGIN'.freeze,
      OPERATION_TYPE_PUBLISH_TOP_PROCESSES_METRICS = 'PUBLISH_TOP_PROCESSES_METRICS'.freeze,
    ...
    # @return [Array<OCI::AppmgmtControl::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::AppmgmtControl::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::AppmgmtControl::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
