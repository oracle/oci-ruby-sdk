...
module OCI
  ...
  #
  class NetworkLoadBalancer::Models::BackendHealth
    STATUS_ENUM = [
      STATUS_OK = 'OK'.freeze,
    ...
    # **[Required]** The general health status of the specified backend server.
    #
    ...
    #
    # @return [Array<OCI::NetworkLoadBalancer::Models::HealthCheckResult>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'status': :'String',
        'health_check_results': :'Array<OCI::NetworkLoadBalancer::Models::HealthCheckResult>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::NetworkLoadBalancer::Models::HealthCheckResult>] :health_check_results The value to assign to the {#health_check_results} property
