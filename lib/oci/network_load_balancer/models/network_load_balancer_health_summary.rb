...
module OCI
  ...
  class NetworkLoadBalancer::Models::NetworkLoadBalancerHealthSummary
    STATUS_ENUM = [
      STATUS_OK = 'OK'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the network load balancer with which the health status is associated.
    #
    # @return [String]
    ...
    def hash
      [network_load_balancer_id, status].hash
    end
