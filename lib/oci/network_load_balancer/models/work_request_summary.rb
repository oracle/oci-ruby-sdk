...
module OCI
  ...
  class NetworkLoadBalancer::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** The OCID of the compartment that contains the work request. Work requests are scoped to
    ...
    # @return [Array<OCI::NetworkLoadBalancer::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::NetworkLoadBalancer::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::NetworkLoadBalancer::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
