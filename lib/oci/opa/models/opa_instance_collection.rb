...
module OCI
  ...
  class Opa::Models::OpaInstanceCollection
    # **[Required]** List of opaInstances.
    # @return [Array<OCI::Opa::Models::OpaInstanceSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Opa::Models::OpaInstanceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opa::Models::OpaInstanceSummary>] :items The value to assign to the {#items} property
