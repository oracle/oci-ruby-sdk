...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionPackage
    PACKAGE_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :listing_revision_id
    ...
    # @return [BOOLEAN]
    attr_accessor :are_security_upgrades_provided

    # **[Required]** Identifies that this will be default package for the listing revision.
    # @return [BOOLEAN]
    attr_accessor :is_default

    # **[Required]** The date and time this listing revision package was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    ...
    # **[Required]** The date and time this listing revision package was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::HelmChartPackage' if type == 'HELM_CHART'
      return 'OCI::MarketplacePublisher::Models::ContainerPackage' if type == 'CONTAINER_IMAGE'
    ...
    # @option attributes [String] :listing_revision_id The value to assign to the {#listing_revision_id} property
    # @option attributes [String] :compartment_id The value to assign to the {#compartment_id} property
    # @option attributes [String] :artifact_id The value to assign to the {#artifact_id} property
    # @option attributes [String] :term_id The value to assign to the {#term_id} property
    ...
    # @option attributes [BOOLEAN] :are_security_upgrades_provided The value to assign to the {#are_security_upgrades_provided} property
    ...
    def initialize(attributes = {})
      ...
      self.listing_revision_id = attributes[:'listingRevisionId'] if attributes[:'listingRevisionId']

      raise 'You cannot provide both :listingRevisionId and :listing_revision_id' if attributes.key?(:'listingRevisionId') && attributes.key?(:'listing_revision_id')

      self.listing_revision_id = attributes[:'listing_revision_id'] if attributes[:'listing_revision_id']
      ...
      self.term_id = attributes[:'termId'] if attributes[:'termId']

      raise 'You cannot provide both :termId and :term_id' if attributes.key?(:'termId') && attributes.key?(:'term_id')

      self.term_id = attributes[:'term_id'] if attributes[:'term_id']
      ...
      self.are_security_upgrades_provided = attributes[:'areSecurityUpgradesProvided'] unless attributes[:'areSecurityUpgradesProvided'].nil?

      raise 'You cannot provide both :areSecurityUpgradesProvided and :are_security_upgrades_provided' if attributes.key?(:'areSecurityUpgradesProvided') && attributes.key?(:'are_security_upgrades_provided')

      self.are_security_upgrades_provided = attributes[:'are_security_upgrades_provided'] unless attributes[:'are_security_upgrades_provided'].nil?
