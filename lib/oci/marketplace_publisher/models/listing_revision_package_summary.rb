...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionPackageSummary
    PACKAGE_TYPE_ENUM = [
    ...
    # **[Required]** The date and time the publication package was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    ...
    # **[Required]** The date and time the publication package was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    # Example: `2022-09-24T21:10:29.600Z`
    #
    ...
    def hash
      [id, listing_revision_id, compartment_id, display_name, package_version, package_type, are_security_upgrades_provided, lifecycle_state, status, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
