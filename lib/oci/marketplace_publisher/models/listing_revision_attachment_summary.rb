...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionAttachmentSummary
    ...
    # **[Required]** The date and time the related document was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    ...
    # **[Required]** The date and time the related document was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    # timestamp format.
    #
    # Example: `2022-09-24T21:10:29.600Z`
    #
    ...
    def hash
      [id, listing_revision_id, compartment_id, display_name, attachment_type, content_url, mime_type, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
