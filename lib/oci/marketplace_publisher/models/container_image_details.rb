...
module OCI
  ...
  class MarketplacePublisher::Models::ContainerImageDetails
    ...
    def hash
      [source_registry_id, source_registry_url, validation_status, validation_error, publication_status, publication_error].hash
    end
