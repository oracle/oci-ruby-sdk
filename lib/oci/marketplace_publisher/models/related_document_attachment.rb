...
module OCI
  ...
  class MarketplacePublisher::Models::RelatedDocumentAttachment < MarketplacePublisher::Models::ListingRevisionAttachment
    DOCUMENT_CATEGORY_ENUM = [
      DOCUMENT_CATEGORY_CASE_STUDIES = 'CASE_STUDIES'.freeze,
      DOCUMENT_CATEGORY_CUSTOMIZATION_GUIDES = 'CUSTOMIZATION_GUIDES'.freeze,
      DOCUMENT_CATEGORY_DATA_SHEETS = 'DATA_SHEETS'.freeze,
      DOCUMENT_CATEGORY_PRESS_RELEASE = 'PRESS_RELEASE'.freeze,
      DOCUMENT_CATEGORY_PRODUCT_DOCUMENTATION = 'PRODUCT_DOCUMENTATION'.freeze,
      DOCUMENT_CATEGORY_USER_GUIDES = 'USER_GUIDES'.freeze,
      DOCUMENT_CATEGORY_WEBINAR = 'WEBINAR'.freeze,
      DOCUMENT_CATEGORY_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # Possible lifecycle states.
    # @return [String]
    attr_reader :document_category
    ...
    def document_category=(document_category)
      ...
      if document_category && !DOCUMENT_CATEGORY_ENUM.include?(document_category)
        OCI.logger.debug("Unknown value for 'document_category' [" + document_category + "]. Mapping to 'DOCUMENT_CATEGORY_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @document_category = DOCUMENT_CATEGORY_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, compartment_id, listing_revision_id, display_name, description, attachment_type, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags, document_category, content_url, mime_type].hash
    end
