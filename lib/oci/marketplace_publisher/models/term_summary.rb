...
module OCI
  ...
  class MarketplacePublisher::Models::TermSummary
    ...
    def hash
      [id, compartment_id, name, author, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
