...
module OCI
  ...
  class MarketplacePublisher::Models::UpdateListingRevisionDetails
    ...
    def hash
      [display_name, version_details, headline, tagline, keywords, short_description, usage_information, long_description, system_requirements, categories, markets, content_language, supportedlanguages, support_contacts, support_links, pricing_type, freeform_tags, defined_tags].hash
    end
