...
module OCI
  ...
  class MarketplacePublisher::Models::ScreenShotAttachment < MarketplacePublisher::Models::ListingRevisionAttachment
    ...
    def hash
      [id, compartment_id, listing_revision_id, display_name, description, attachment_type, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags, content_url, mime_type].hash
    end
