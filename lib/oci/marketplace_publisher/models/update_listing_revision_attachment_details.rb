...
module OCI
  ...
  class MarketplacePublisher::Models::UpdateListingRevisionAttachmentDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::UpdateScreenShotAttachmentDetails' if type == 'SCREENSHOT'
      return 'OCI::MarketplacePublisher::Models::UpdateRelatedDocumentAttachmentDetails' if type == 'RELATED_DOCUMENT'
      return 'OCI::MarketplacePublisher::Models::UpdateVideoAttachmentDetails' if type == 'VIDEO'
