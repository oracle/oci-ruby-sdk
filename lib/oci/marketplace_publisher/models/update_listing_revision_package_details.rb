...
module OCI
  ...
  class MarketplacePublisher::Models::UpdateListingRevisionPackageDetails
    ...
    def hash
      [package_version, display_name, description, artifact_id, term_id, is_default, are_security_upgrades_provided, freeform_tags, defined_tags].hash
    end
