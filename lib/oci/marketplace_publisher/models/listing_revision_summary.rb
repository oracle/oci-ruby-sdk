...
module OCI
  ...
  class MarketplacePublisher::Models::ListingRevisionSummary
    PACKAGE_TYPE_ENUM = [
    ...
    # **[Required]** The date and time the listing revision was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The date and time the listing revision was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2022-09-15T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    def hash
      [id, listing_id, compartment_id, display_name, status, lifecycle_state, package_type, pricing_type, short_description, tagline, icon, markets, categories, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
