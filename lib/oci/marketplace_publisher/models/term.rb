...
module OCI
  ...
  class MarketplacePublisher::Models::Term
    AUTHOR_ENUM = [
    ...
    # **[Required]** The date and time the term was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The date and time the term was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2022-09-15T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    def hash
      [id, name, author, compartment_id, publisher_id, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
