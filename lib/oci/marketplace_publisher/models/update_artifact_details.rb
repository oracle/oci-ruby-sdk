...
module OCI
  ...
  class MarketplacePublisher::Models::UpdateArtifactDetails
    ARTIFACT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::UpdateKubernetesImageArtifactDetails' if type == 'HELM_CHART'
      return 'OCI::MarketplacePublisher::Models::UpdateContainerImageArtifactDetails' if type == 'CONTAINER_IMAGE'
