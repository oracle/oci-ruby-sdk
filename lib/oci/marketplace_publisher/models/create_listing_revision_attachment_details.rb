...
module OCI
  ...
  class MarketplacePublisher::Models::CreateListingRevisionAttachmentDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::MarketplacePublisher::Models::CreateScreenShotAttachmentDetails' if type == 'SCREENSHOT'
      return 'OCI::MarketplacePublisher::Models::CreateVideoAttachmentDetails' if type == 'VIDEO'
      return 'OCI::MarketplacePublisher::Models::CreateRelatedDocumentAttachmentDetails' if type == 'RELATED_DOCUMENT'
