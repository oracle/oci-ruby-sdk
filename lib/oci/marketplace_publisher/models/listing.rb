...
module OCI
  ...
  class MarketplacePublisher::Models::Listing
    LISTING_TYPE_ENUM = [
    ...
    def hash
      [id, compartment_id, publisher_id, listing_type, name, package_type, extended_metadata, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
