...
module OCI
  ...
  class Lockbox::LockboxClient
    ...
    #
    # @param [OCI::Lockbox::Models::ExportAccessRequestsDetails] export_access_requests_details Exports the list of access requests for given date range in text format
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Lockbox::Models::AccessRequestExt AccessRequestExt}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/lockbox/get_access_request_internal.rb.html) to see an example of how to use get_access_request_internal API.
    def get_access_request_internal(access_request_id, opts = {})
      logger.debug 'Calling operation LockboxClient#get_access_request_internal.' if logger

      raise "Missing the required parameter 'access_request_id' when calling get_access_request_internal." if access_request_id.nil?
      raise "Parameter value for 'access_request_id' must not be blank" if OCI::Internal::Util.blank_string?(access_request_id)

      path = '/accessRequests/{accessRequestId}/internal'.sub('{accessRequestId}', access_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'LockboxClient#get_access_request_internal') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Lockbox::Models::AccessRequestExt'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
