...
module OCI
  ...
  class Lockbox::Models::AccessRequestCollection
    # **[Required]** List of AccessRequestSummary.
    # @return [Array<OCI::Lockbox::Models::AccessRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Lockbox::Models::AccessRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Lockbox::Models::AccessRequestSummary>] :items The value to assign to the {#items} property
