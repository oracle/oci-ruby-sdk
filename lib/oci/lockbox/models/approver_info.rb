...
module OCI
  ...
  class Lockbox::Models::ApproverInfo
    APPROVER_TYPE_ENUM = [
    ...
    # @option attributes [String] :approver_type The value to assign to the {#approver_type} property
    ...
    # @param [Object] approver_type Object to be assigned
    def approver_type=(approver_type)
      # rubocop:disable Style/ConditionalAssignment
      if approver_type && !APPROVER_TYPE_ENUM.include?(approver_type)
        OCI.logger.debug("Unknown value for 'approver_type' [" + approver_type + "]. Mapping to 'APPROVER_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @approver_type = APPROVER_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [approver_type, approver_id].hash
    end
