...
module OCI
  ...
  class Lockbox::Models::ApprovalTemplateCollection
    # **[Required]** List of ApprovalTemplateSummary.
    # @return [Array<OCI::Lockbox::Models::ApprovalTemplateSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Lockbox::Models::ApprovalTemplateSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Lockbox::Models::ApprovalTemplateSummary>] :items The value to assign to the {#items} property
