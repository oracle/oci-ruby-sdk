...
module OCI
  ...
  class Lockbox::Models::LockboxCollection
    # **[Required]** List of lockboxes.
    # @return [Array<OCI::Lockbox::Models::LockboxSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Lockbox::Models::LockboxSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Lockbox::Models::LockboxSummary>] :items The value to assign to the {#items} property
