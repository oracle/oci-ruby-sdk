...
module OCI
  ...
  class Lockbox::Models::LockboxSummary
    LOCKBOX_PARTNER_ENUM = [
      LOCKBOX_PARTNER_FAAAS = 'FAAAS'.freeze,
      LOCKBOX_PARTNER_CANARY = 'CANARY'.freeze,
      LOCKBOX_PARTNER_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def lockbox_partner=(lockbox_partner)
      ...
      if lockbox_partner && !LOCKBOX_PARTNER_ENUM.include?(lockbox_partner)
        OCI.logger.debug("Unknown value for 'lockbox_partner' [" + lockbox_partner + "]. Mapping to 'LOCKBOX_PARTNER_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @lockbox_partner = LOCKBOX_PARTNER_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, display_name, lockbox_partner, compartment_id, partner_id, partner_compartment_id, resource_id, approval_template_id, max_access_duration, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
