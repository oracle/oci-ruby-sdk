...
module OCI
  ...
  class Lockbox::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Lockbox::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Lockbox::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Lockbox::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
