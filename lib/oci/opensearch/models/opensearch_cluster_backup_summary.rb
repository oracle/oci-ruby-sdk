...
module OCI
  ...
  class Opensearch::Models::OpensearchClusterBackupSummary
    ...
    def hash
      [id, display_name, compartment_id, backup_type, source_cluster_id, time_created, time_updated, lifecycle_state, lifecycle_details, time_expired, backup_size, source_cluster_display_name, freeform_tags, defined_tags, system_tags].hash
    end
