...
module OCI
  ...
  class Opensearch::Models::ResizeOpensearchClusterVerticalDetails
    ...
    def hash
      [master_node_host_ocpu_count, master_node_host_memory_gb, data_node_host_ocpu_count, data_node_host_memory_gb, data_node_storage_gb, opendashboard_node_host_ocpu_count, opendashboard_node_host_memory_gb, freeform_tags, defined_tags].hash
    end
