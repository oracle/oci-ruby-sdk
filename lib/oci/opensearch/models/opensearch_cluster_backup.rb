...
module OCI
  ...
  #
  class Opensearch::Models::OpensearchClusterBackup
    BACKUP_TYPE_ENUM = [
      BACKUP_TYPE_SCHEDULED = 'SCHEDULED'.freeze,
      BACKUP_TYPE_MANUAL = 'MANUAL'.freeze,
    ...
    # @return [String]
    attr_accessor :source_cluster_id
    ...
    # @return [String]
    attr_accessor :source_cluster_display_name
    ...
    def self.swagger_types
      {
        ...
        'backup_size': :'Float',
        'source_cluster_display_name': :'String',
    ...
    # @option attributes [String] :source_cluster_id The value to assign to the {#source_cluster_id} property
    ...
    # @option attributes [String] :source_cluster_display_name The value to assign to the {#source_cluster_display_name} property
    ...
    def initialize(attributes = {})
      ...
      self.source_cluster_id = attributes[:'sourceClusterId'] if attributes[:'sourceClusterId']

      raise 'You cannot provide both :sourceClusterId and :source_cluster_id' if attributes.key?(:'sourceClusterId') && attributes.key?(:'source_cluster_id')

      self.source_cluster_id = attributes[:'source_cluster_id'] if attributes[:'source_cluster_id']
      ...
      self.source_cluster_display_name = attributes[:'sourceClusterDisplayName'] if attributes[:'sourceClusterDisplayName']

      raise 'You cannot provide both :sourceClusterDisplayName and :source_cluster_display_name' if attributes.key?(:'sourceClusterDisplayName') && attributes.key?(:'source_cluster_display_name')

      self.source_cluster_display_name = attributes[:'source_cluster_display_name'] if attributes[:'source_cluster_display_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_cluster_display_name == other.source_cluster_display_name &&
    ...
    def hash
      [id, display_name, compartment_id, backup_type, time_created, time_updated, lifecycle_state, lifecyle_details, source_cluster_id, namespace, bucket_name, prefix, time_expired, backup_size, source_cluster_display_name, freeform_tags, defined_tags, system_tags].hash
    end
