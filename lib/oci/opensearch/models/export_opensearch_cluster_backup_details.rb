...
module OCI
  ...
  class Opensearch::Models::ExportOpensearchClusterBackupDetails
    ...
    def hash
      [compartment_id, object_storage_namespace, object_storage_bucket_name, object_storage_prefix, snapshot_name, repository_name, prefix, freeform_tags, defined_tags].hash
    end
