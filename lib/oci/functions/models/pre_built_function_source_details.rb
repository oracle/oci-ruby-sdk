...
require 'date'
require_relative 'function_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The source of the Function which is based on a Pre-Built Function Listing (PbfListing).
  #
  class Functions::Models::PreBuiltFunctionSourceDetails < Functions::Models::FunctionSourceDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the PbfListing this
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceType'] = 'PRE_BUILT_FUNCTIONS'
    ...
    def hash
      [source_type, pbf_listing_id].hash
    end
