...
module OCI
  ...
  class Functions::Models::Function
    ...
    # @return [OCI::Functions::Models::FunctionSourceDetails]
    ...
    def self.swagger_types
      {
        ...
        'image': :'String',
        'image_digest': :'String',
        'source_details': :'OCI::Functions::Models::FunctionSourceDetails',
        'shape': :'String',
    ...
    # @option attributes [OCI::Functions::Models::FunctionSourceDetails] :source_details The value to assign to the {#source_details} property
    ...
    def hash
      [id, display_name, lifecycle_state, application_id, compartment_id, image, image_digest, source_details, shape, memory_in_m_bs, config, timeout_in_seconds, provisioned_concurrency_config, trace_config, freeform_tags, invoke_endpoint, defined_tags, time_created, time_updated].hash
    end
