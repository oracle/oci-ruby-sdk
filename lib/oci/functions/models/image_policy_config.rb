...
module OCI
  ...
  #
  class Functions::Models::ImagePolicyConfig
    ...
    # @return [Array<OCI::Functions::Models::KeyDetails>]
    ...
    def self.swagger_types
      {
        ...
        'key_details': :'Array<OCI::Functions::Models::KeyDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :is_policy_enabled The value to assign to the {#is_policy_enabled} property
    # @option attributes [Array<OCI::Functions::Models::KeyDetails>] :key_details The value to assign to the {#key_details} property
