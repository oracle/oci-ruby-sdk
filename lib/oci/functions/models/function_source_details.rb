...
module OCI
  ...
  class Functions::Models::FunctionSourceDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_PRE_BUILT_FUNCTIONS = 'PRE_BUILT_FUNCTIONS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Functions::Models::PreBuiltFunctionSourceDetails' if type == 'PRE_BUILT_FUNCTIONS'
