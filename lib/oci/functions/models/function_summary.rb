...
module OCI
  ...
  class Functions::Models::FunctionSummary
    ...
    def hash
      [id, display_name, application_id, compartment_id, lifecycle_state, image, image_digest, source_details, shape, memory_in_m_bs, timeout_in_seconds, provisioned_concurrency_config, trace_config, freeform_tags, invoke_endpoint, defined_tags, time_created, time_updated].hash
    end
