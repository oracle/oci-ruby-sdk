...
module OCI
  ...
  class Functions::FunctionsManagementClient
    ...
    #
    # @param [String] pbf_listing_id unique PbfListing identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The unique Oracle-assigned identifier for the request. If you need to contact Oracle about a
    #   particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::Functions::Models::PbfListing PbfListing}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/functions/get_pbf_listing.rb.html) to see an example of how to use get_pbf_listing API.
    ...
    # @param [String] pbf_listing_version_id unique PbfListingVersion identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The unique Oracle-assigned identifier for the request. If you need to contact Oracle about a
    #   particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::Functions::Models::PbfListingVersion PbfListingVersion}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/functions/get_pbf_listing_version.rb.html) to see an example of how to use get_pbf_listing_version API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :pbf_listing_version_id unique PbfListingVersion identifier
    # @option opts [String] :name Matches a PbfListingVersion based on a provided semantic version name for a PbfListingVersion.
    #   Each PbfListingVersion name is unique with respect to its associated PbfListing.
    #
    # @option opts [BOOLEAN] :is_current_version Matches the current version (the most recently added version with an Active
    ...
    #   particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::Functions::Models::PbfListingVersionsCollection PbfListingVersionsCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/functions/list_pbf_listing_versions.rb.html) to see an example of how to use list_pbf_listing_versions API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :pbf_listing_id unique PbfListing identifier
    # @option opts [String] :name A filter to return only resources that match the entire PBF name given.
    # @option opts [String] :name_contains A filter to return only resources that contain the supplied filter text in the PBF name given.
    # @option opts [String] :name_starts_with A filter to return only resources that start with the supplied filter text in the PBF name given.
    # @option opts [Array<String>] :trigger A filter to return only resources that match the service trigger sources of a PBF.
    # @option opts [String] :lifecycle_state A filter to return only resources their lifecycleState matches the given lifecycleState.
    # @option opts [Integer] :limit The maximum number of items to return. 1 is the minimum, 50 is the maximum.
    #
    #   Default: 10
    ...
    #   particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::Functions::Models::PbfListingsCollection PbfListingsCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/functions/list_pbf_listings.rb.html) to see an example of how to use list_pbf_listings API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :name A filter to return only resources that match the service trigger source of a PBF.
    # @option opts [Integer] :limit The maximum number of items to return. 1 is the minimum, 50 is the maximum.
    #
    #   Default: 10
    #    (default to 5)
    ...
    #   particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type {OCI::Functions::Models::TriggersCollection TriggersCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/functions/list_triggers.rb.html) to see an example of how to use list_triggers API.
