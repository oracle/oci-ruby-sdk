...
module OCI
  ...
  class CertificatesManagement::Models::CertificateVersionSummary
    ...
    # **[Required]** A optional property indicating the time when the certificate version was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
