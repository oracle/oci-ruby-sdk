...
module OCI
  ...
  class CertificatesManagement::Models::CreateRootCaByGeneratingInternallyConfigDetails < CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails
    ...
    def hash
      [config_type, version_name, validity, signing_algorithm, subject].hash
    end
