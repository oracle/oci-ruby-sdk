...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateDetails
    ...
    # @return [OCI::CertificatesManagement::Models::CreateCertificateConfigDetails]
    ...
    # @option attributes [OCI::CertificatesManagement::Models::CreateCertificateConfigDetails] :certificate_config The value to assign to the {#certificate_config} property
    ...
    def hash
      [name, description, compartment_id, certificate_rules, certificate_config, freeform_tags, defined_tags].hash
    end
