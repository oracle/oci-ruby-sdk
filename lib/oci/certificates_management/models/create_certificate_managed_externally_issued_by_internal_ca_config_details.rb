...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateManagedExternallyIssuedByInternalCaConfigDetails < CertificatesManagement::Models::CreateCertificateConfigDetails
