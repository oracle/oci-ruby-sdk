...
module OCI
  ...
  class CertificatesManagement::Models::CertificateAuthoritySummary
    ...
    # @option attributes [OCI::CertificatesManagement::Models::CertificateAuthorityVersionSummary] :current_version_summary The value to assign to the {#current_version_summary} property
