...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateAuthorityDetails
    ...
    # @return [OCI::CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails]
    ...
    # @option attributes [OCI::CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails] :certificate_authority_config The value to assign to the {#certificate_authority_config} property
    ...
    def hash
      [name, description, compartment_id, certificate_authority_rules, certificate_authority_config, certificate_revocation_list_details, kms_key_id, freeform_tags, defined_tags].hash
    end
