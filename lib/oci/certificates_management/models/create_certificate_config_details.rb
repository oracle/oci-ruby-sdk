...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateConfigDetails
    CONFIG_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CertificatesManagement::Models::CreateCertificateManagedExternallyIssuedByInternalCaConfigDetails' if type == 'MANAGED_EXTERNALLY_ISSUED_BY_INTERNAL_CA'
      return 'OCI::CertificatesManagement::Models::CreateCertificateIssuedByInternalCaConfigDetails' if type == 'ISSUED_BY_INTERNAL_CA'
      return 'OCI::CertificatesManagement::Models::CreateCertificateByImportingConfigDetails' if type == 'IMPORTED'
