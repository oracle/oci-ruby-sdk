...
module OCI
  ...
  class CertificatesManagement::Models::CertificateRule
    RULE_TYPE_ENUM = [
      RULE_TYPE_CERTIFICATE_RENEWAL_RULE = 'CERTIFICATE_RENEWAL_RULE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CertificatesManagement::Models::CertificateRenewalRule' if type == 'CERTIFICATE_RENEWAL_RULE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CertificatesManagement::Models::CertificateRule'
    end
