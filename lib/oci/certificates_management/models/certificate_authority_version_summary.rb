...
module OCI
  ...
  class CertificatesManagement::Models::CertificateAuthorityVersionSummary
    ...
    def hash
      [certificate_authority_id, issuer_ca_version_number, serial_number, time_created, version_number, version_name, time_of_deletion, validity, stages, revocation_status].hash
    end
