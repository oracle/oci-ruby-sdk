...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails
    CONFIG_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CertificatesManagement::Models::CreateRootCaByGeneratingInternallyConfigDetails' if type == 'ROOT_CA_GENERATED_INTERNALLY'
      return 'OCI::CertificatesManagement::Models::CreateSubordinateCaIssuedByInternalCaConfigDetails' if type == 'SUBORDINATE_CA_ISSUED_BY_INTERNAL_CA'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CertificatesManagement::Models::CreateCertificateAuthorityConfigDetails'
    end
