...
require 'date'
require_relative 'certificate_rule'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A rule that imposes constraints on certificate renewal.
  class CertificatesManagement::Models::CertificateRenewalRule < CertificatesManagement::Models::CertificateRule
    # **[Required]** A property specifying how often, in days, a certificate should be renewed.
    # Expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format.
    #
    # @return [String]
    attr_accessor :renewal_interval

    # **[Required]** A property specifying the period of time, in days, before the certificate's targeted renewal that the process should occur.
    # Expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format.
    #
    # @return [String]
    attr_accessor :advance_renewal_period
    ...
    # @option attributes [String] :renewal_interval The value to assign to the {#renewal_interval} property
    # @option attributes [String] :advance_renewal_period The value to assign to the {#advance_renewal_period} property
