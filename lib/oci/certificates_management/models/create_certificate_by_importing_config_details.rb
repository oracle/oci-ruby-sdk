...
module OCI
  ...
  class CertificatesManagement::Models::CreateCertificateByImportingConfigDetails < CertificatesManagement::Models::CreateCertificateConfigDetails
    ...
    def hash
      [config_type, version_name, cert_chain_pem, private_key_pem, certificate_pem, private_key_pem_passphrase].hash
    end
