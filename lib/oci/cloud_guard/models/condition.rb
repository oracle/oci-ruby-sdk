...
module OCI
  ...
  class CloudGuard::Models::Condition
    KIND_ENUM = [
      KIND_COMPOSITE = 'COMPOSITE'.freeze,
      KIND_SIMPLE = 'SIMPLE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudGuard::Models::SimpleCondition' if type == 'SIMPLE'
      return 'OCI::CloudGuard::Models::CompositeCondition' if type == 'COMPOSITE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CloudGuard::Models::Condition'
    end
