...
module OCI
  ...
  class CloudGuard::Models::UpdateTargetDetails
    ...
    # @return [Array<OCI::CloudGuard::Models::UpdateTargetDetectorRecipe>]
    attr_accessor :target_detector_recipes

    # The details of target responder recipes to be updated.
    # @return [Array<OCI::CloudGuard::Models::UpdateTargetResponderRecipe>]
    ...
    def self.swagger_types
      {
        ...
        'target_detector_recipes': :'Array<OCI::CloudGuard::Models::UpdateTargetDetectorRecipe>',
        'target_responder_recipes': :'Array<OCI::CloudGuard::Models::UpdateTargetResponderRecipe>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::UpdateTargetDetectorRecipe>] :target_detector_recipes The value to assign to the {#target_detector_recipes} property
    # @option attributes [Array<OCI::CloudGuard::Models::UpdateTargetResponderRecipe>] :target_responder_recipes The value to assign to the {#target_responder_recipes} property
    ...
    def hash
      [display_name, lifecycle_state, target_detector_recipes, target_responder_recipes, freeform_tags, defined_tags].hash
    end
