...
module OCI
  ...
  class CloudGuard::Models::DetectorRule
    ...
    def hash
      [id, display_name, description, recommendation, detector, service_type, resource_type, detector_details, managed_list_types, candidate_responder_rules, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
