...
module OCI
  ...
  class CloudGuard::Models::DataSourceMappingInfo
    # **[Required]** ID of the detector recipe attached to the data source
    # @return [String]
    attr_accessor :detector_recipe_id

    # **[Required]** ID of the detector rule attached to the data source
    # @return [String]
    ...
    def hash
      [detector_recipe_id, detector_rule_id].hash
    end
