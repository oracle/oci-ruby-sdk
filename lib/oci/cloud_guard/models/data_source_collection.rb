...
module OCI
  ...
  class CloudGuard::Models::DataSourceCollection
    # **[Required]** List of data source summaries (DataSourceSummary resources)
    # @return [Array<OCI::CloudGuard::Models::DataSourceSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::DataSourceSummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::DataSourceSummary>] :items The value to assign to the {#items} property
