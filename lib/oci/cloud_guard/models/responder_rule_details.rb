...
module OCI
  ...
  class CloudGuard::Models::ResponderRuleDetails
    MODE_ENUM = [
    ...
    # @return [Array<OCI::CloudGuard::Models::ResponderConfiguration>]
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::ResponderConfiguration>] :configurations The value to assign to the {#configurations} property
    ...
    def hash
      [condition, configurations, is_enabled, mode].hash
    end
