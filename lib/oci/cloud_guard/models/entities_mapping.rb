...
module OCI
  ...
  class CloudGuard::Models::EntitiesMapping
    ENTITY_TYPE_ENUM = [
    ...
    # @option attributes [String] :query_field The value to assign to the {#query_field} property
    ...
    def initialize(attributes = {})
      ...
      self.query_field = attributes[:'queryField'] if attributes[:'queryField']

      raise 'You cannot provide both :queryField and :query_field' if attributes.key?(:'queryField') && attributes.key?(:'query_field')

      self.query_field = attributes[:'query_field'] if attributes[:'query_field']
    ...
    def hash
      [display_name, query_field, entity_type].hash
    end
