...
module OCI
  ...
  class CloudGuard::Models::CreateResponderRecipeDetails
    ...
    # @return [Array<OCI::CloudGuard::Models::UpdateResponderRecipeResponderRule>]
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::UpdateResponderRecipeResponderRule>] :responder_rules The value to assign to the {#responder_rules} property
    ...
    def hash
      [display_name, description, source_responder_recipe_id, compartment_id, responder_rules, freeform_tags, defined_tags].hash
    end
