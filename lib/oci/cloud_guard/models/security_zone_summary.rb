...
module OCI
  ...
  class CloudGuard::Models::SecurityZoneSummary
    ...
    def hash
      [id, display_name, description, compartment_id, security_zone_recipe_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
