...
module OCI
  ...
  class CloudGuard::Models::ResourceSummary
    RISK_LEVEL_ENUM = [
    ...
    def hash
      [id, resource_name, resource_type, compartment_id, target_id, target_name, region, risk_level, problem_count, vulnerability_count, open_ports_count, freeform_tags, defined_tags, system_tags].hash
    end
