...
module OCI
  ...
  class CloudGuard::Models::TargetDetectorRecipeDetectorRule
    ...
    def hash
      [detector_rule_id, display_name, description, recommendation, detector, service_type, resource_type, details, managed_list_types, time_created, time_updated, lifecycle_state, lifecycle_details, data_source_id, entities_mappings].hash
    end
