...
module OCI
  ...
  class CloudGuard::Models::ServiceTypeSummary
    # **[Required]** name of the service type
    # @return [String]
    attr_accessor :name

    # **[Required]** List of Resource
    # @return [Array<OCI::CloudGuard::Models::ResourceTypeSummary>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'resource_types': :'Array<OCI::CloudGuard::Models::ResourceTypeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::ResourceTypeSummary>] :resource_types The value to assign to the {#resource_types} property
