...
module OCI
  ...
  class CloudGuard::Models::CreateTargetDetails
    ...
    # @return [Array<OCI::CloudGuard::Models::CreateTargetDetectorRecipeDetails>]
    attr_accessor :target_detector_recipes

    # List of responder recipes to associate with target
    # @return [Array<OCI::CloudGuard::Models::CreateTargetResponderRecipeDetails>]
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::CreateTargetDetectorRecipeDetails>] :target_detector_recipes The value to assign to the {#target_detector_recipes} property
    # @option attributes [Array<OCI::CloudGuard::Models::CreateTargetResponderRecipeDetails>] :target_responder_recipes The value to assign to the {#target_responder_recipes} property
    ...
    def hash
      [display_name, compartment_id, description, target_resource_type, target_resource_id, target_detector_recipes, target_responder_recipes, lifecycle_state, freeform_tags, defined_tags].hash
    end
