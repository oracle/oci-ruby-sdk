...
module OCI
  ...
  class CloudGuard::Models::DataSourceEventCollection
    # **[Required]** List of events related to a data source
    # @return [Array<OCI::CloudGuard::Models::DataSourceEventSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::DataSourceEventSummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::DataSourceEventSummary>] :items The value to assign to the {#items} property
