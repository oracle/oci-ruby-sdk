...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipeDetectorRule
    ...
    def hash
      [detector_rule_id, display_name, description, recommendation, detector, service_type, resource_type, details, managed_list_types, candidate_responder_rules, time_created, time_updated, lifecycle_state, lifecycle_details, data_source_id, entities_mappings].hash
    end
