...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipeDetectorRule
    DETECTOR_ENUM = [
    ...
    # @option attributes [OCI::CloudGuard::Models::DetectorDetails] :details The value to assign to the {#details} property
    ...
    def hash
      [detector_rule_id, display_name, description, recommendation, detector, service_type, resource_type, details, managed_list_types, candidate_responder_rules, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
