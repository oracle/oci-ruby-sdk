...
module OCI
  ...
  class CloudGuard::Models::DataMaskRule
    ...
    def hash
      [id, display_name, compartment_id, description, iam_group_id, target_selected, data_mask_categories, time_created, time_updated, data_mask_rule_status, lifecycle_state, lifecyle_details, locks, freeform_tags, defined_tags, system_tags].hash
    end
