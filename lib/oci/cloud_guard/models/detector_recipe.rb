...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipe
    OWNER_ENUM = [
    ...
    # @return [String]
    attr_accessor :source_detector_recipe_id
    ...
    # @option attributes [String] :source_detector_recipe_id The value to assign to the {#source_detector_recipe_id} property
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::DetectorRecipeDetectorRule>] :detector_rules The value to assign to the {#detector_rules} property
    # @option attributes [Array<OCI::CloudGuard::Models::DetectorRecipeDetectorRule>] :effective_detector_rules The value to assign to the {#effective_detector_rules} property
    ...
    def initialize(attributes = {})
      ...
      self.source_detector_recipe_id = attributes[:'sourceDetectorRecipeId'] if attributes[:'sourceDetectorRecipeId']

      raise 'You cannot provide both :sourceDetectorRecipeId and :source_detector_recipe_id' if attributes.key?(:'sourceDetectorRecipeId') && attributes.key?(:'source_detector_recipe_id')

      self.source_detector_recipe_id = attributes[:'source_detector_recipe_id'] if attributes[:'source_detector_recipe_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_detector_recipe_id == other.source_detector_recipe_id &&
        owner == other.owner &&
    ...
    def hash
      [id, display_name, description, compartment_id, source_detector_recipe_id, owner, detector, detector_rules, effective_detector_rules, time_created, time_updated, lifecycle_state, source_data_retention, freeform_tags, defined_tags, system_tags].hash
    end
