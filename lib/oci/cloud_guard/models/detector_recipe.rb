...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipe
    ...
    # **[Required]** Compartment OCID of detector recipe
    # @return [String]
    ...
    def hash
      [id, display_name, description, compartment_id, source_detector_recipe_id, detector_recipe_type, owner, detector, detector_rules, effective_detector_rules, time_created, time_updated, lifecycle_state, source_data_retention, freeform_tags, defined_tags, system_tags, target_ids].hash
    end
