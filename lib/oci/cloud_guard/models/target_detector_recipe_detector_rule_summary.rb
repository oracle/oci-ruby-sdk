...
module OCI
  ...
  class CloudGuard::Models::TargetDetectorRecipeDetectorRuleSummary
    ...
    def hash
      [id, display_name, description, recommendation, detector, service_type, resource_type, managed_list_types, detector_details, time_created, time_updated, lifecycle_state, lifecycle_details, data_source_id, entities_mappings, locks].hash
    end
