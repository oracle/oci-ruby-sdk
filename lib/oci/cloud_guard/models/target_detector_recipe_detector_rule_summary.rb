...
module OCI
  ...
  class CloudGuard::Models::TargetDetectorRecipeDetectorRuleSummary
    DETECTOR_ENUM = [
    ...
    def self.swagger_types
      {
        ...
        'detector_details': :'OCI::CloudGuard::Models::TargetDetectorDetails',
    ...
    # @option attributes [OCI::CloudGuard::Models::TargetDetectorDetails] :detector_details The value to assign to the {#detector_details} property
    ...
    def hash
      [id, display_name, description, recommendation, detector, service_type, resource_type, managed_list_types, detector_details, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
