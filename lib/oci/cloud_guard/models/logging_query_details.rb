...
module OCI
  ...
  class CloudGuard::Models::LoggingQueryDetails
    ...
    # **[Required]** Logging query type for data source
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'loggingQueryType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::CloudGuard::Models::InsightTypeLoggingQueryDetails' if type == 'INSIGHT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CloudGuard::Models::LoggingQueryDetails'
    end
