...
module OCI
  ...
  class CloudGuard::Models::SecurityPolicy
    ...
    def hash
      [id, friendly_name, display_name, description, compartment_id, owner, category, services, time_created, time_updated, lifecycle_state, lifecycle_details, locks, freeform_tags, defined_tags, system_tags].hash
    end
