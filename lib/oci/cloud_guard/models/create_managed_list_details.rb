...
module OCI
  # Create ManagedList
  class CloudGuard::Models::CreateManagedListDetails
    LIST_TYPE_ENUM = [
    ...
    def list_type=(list_type)
      raise "Invalid value for 'list_type': this must be one of the values in LIST_TYPE_ENUM." if list_type && !LIST_TYPE_ENUM.include?(list_type)
    ...
    def hash
      [display_name, compartment_id, source_managed_list_id, description, list_type, list_items, freeform_tags, defined_tags].hash
    end
