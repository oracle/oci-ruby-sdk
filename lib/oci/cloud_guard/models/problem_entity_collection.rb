...
module OCI
  ...
  class CloudGuard::Models::ProblemEntityCollection
    # **[Required]** List of entity details related to a data source
    # @return [Array<OCI::CloudGuard::Models::ProblemEntitySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::ProblemEntitySummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::ProblemEntitySummary>] :items The value to assign to the {#items} property
