...
module OCI
  ...
  class CloudGuard::Models::ProblemEntitySummary
    ...
    # @return [Array<OCI::CloudGuard::Models::EntityDetails>]
    ...
    # @option attributes [String] :result_url The value to assign to the {#result_url} property
    # @option attributes [Array<OCI::CloudGuard::Models::EntityDetails>] :entity_details The value to assign to the {#entity_details} property
    def initialize(attributes = {})
      ...
      self.result_url = attributes[:'resultUrl'] if attributes[:'resultUrl']

      raise 'You cannot provide both :resultUrl and :result_url' if attributes.key?(:'resultUrl') && attributes.key?(:'result_url')

      self.result_url = attributes[:'result_url'] if attributes[:'result_url']

      self.entity_details = attributes[:'entityDetails'] if attributes[:'entityDetails']

      raise 'You cannot provide both :entityDetails and :entity_details' if attributes.key?(:'entityDetails') && attributes.key?(:'entity_details')

      self.entity_details = attributes[:'entity_details'] if attributes[:'entity_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        result_url == other.result_url &&
        entity_details == other.entity_details
    end
    ...
    def hash
      [regions, time_first_detected, problem_id, time_last_detected, result_url, entity_details].hash
    end
