...
module OCI
  ...
  class CloudGuard::Models::UpdateDataMaskRuleDetails
    ...
    def hash
      [display_name, compartment_id, iam_group_id, target_selected, data_mask_categories, data_mask_rule_status, freeform_tags, defined_tags].hash
    end
