...
module OCI
  ...
  class CloudGuard::Models::TargetDetails
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'targetResourceType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::CloudGuard::Models::SecurityZoneTargetDetails' if type == 'SECURITY_ZONE'
