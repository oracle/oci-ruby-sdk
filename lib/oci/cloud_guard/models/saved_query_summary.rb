...
module OCI
  ...
  class CloudGuard::Models::SavedQuerySummary
    ...
    def hash
      [id, description, display_name, query, compartment_id, time_created, time_updated, lifecycle_state, locks, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
