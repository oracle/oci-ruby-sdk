...
module OCI
  ...
  #
  class CloudGuard::Models::WlpAgent
    # **[Required]** OCID for WlpAgent
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** Compartment OCID of WlpAgent.
    # @return [String]
    ...
    # **[Required]** The certificate ID returned by OCI certificates service
    # @return [String]
    ...
    def hash
      [id, host_id, tenant_id, compartment_id, agent_version, certificate_id, certificate_signed_request, time_created, time_updated, locks, freeform_tags, defined_tags, system_tags].hash
    end
