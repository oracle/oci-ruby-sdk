...
module OCI
  ...
  class CloudGuard::Models::ResponderRecipeSummary
    OWNER_ENUM = [
    ...
    def hash
      [id, display_name, description, owner, responder_rules, source_responder_recipe_id, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
