...
module OCI
  ...
  #
  class CloudGuard::Models::WlpAgentSummary
    ...
    def hash
      [id, host_id, tenant_id, compartment_id, agent_version, certificate_id, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
