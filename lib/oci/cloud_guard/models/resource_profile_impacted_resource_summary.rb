...
module OCI
  ...
  class CloudGuard::Models::ResourceProfileImpactedResourceSummary
    ...
    def hash
      [id, resource_profile_id, problem_id, compartment_id, resource_id, resource_name, resource_type, sighting_type, sighting_type_display_name, region, time_identified].hash
    end
