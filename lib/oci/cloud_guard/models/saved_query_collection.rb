...
module OCI
  ...
  class CloudGuard::Models::SavedQueryCollection
    # **[Required]** List of SavedQuery resources
    # @return [Array<OCI::CloudGuard::Models::SavedQuerySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::SavedQuerySummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::SavedQuerySummary>] :items The value to assign to the {#items} property
