...
module OCI
  ...
  class CloudGuard::Models::AdhocQueryCollection
    # **[Required]** List of AdhocQuery resources
    # @return [Array<OCI::CloudGuard::Models::AdhocQuerySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::AdhocQuerySummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::AdhocQuerySummary>] :items The value to assign to the {#items} property
