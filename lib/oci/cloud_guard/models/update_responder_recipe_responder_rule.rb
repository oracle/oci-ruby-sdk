...
module OCI
  ...
  class CloudGuard::Models::UpdateResponderRecipeResponderRule
    # **[Required]** ResponderRecipeRule Identifier
    # @return [String]
    attr_accessor :responder_rule_id

    # This attribute is required.
    # @return [OCI::CloudGuard::Models::UpdateResponderRuleDetails]
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::CloudGuard::Models::UpdateResponderRuleDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudGuard::Models::UpdateResponderRuleDetails] :details The value to assign to the {#details} property
    ...
    def hash
      [responder_rule_id, details].hash
    end
