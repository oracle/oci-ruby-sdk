...
module OCI
  ...
  class CloudGuard::Models::WlpAgentCollection
    # **[Required]** List of WLP agents
    # @return [Array<OCI::CloudGuard::Models::WlpAgentSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::WlpAgentSummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::WlpAgentSummary>] :items The value to assign to the {#items} property
