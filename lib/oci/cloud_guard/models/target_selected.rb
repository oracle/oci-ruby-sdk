...
module OCI
  ...
  class CloudGuard::Models::TargetSelected
    KIND_ENUM = [
      KIND_ALL = 'ALL'.freeze,
      KIND_TARGETTYPES = 'TARGETTYPES'.freeze,
      KIND_TARGETIDS = 'TARGETIDS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudGuard::Models::AllTargetsSelected' if type == 'ALL'
      return 'OCI::CloudGuard::Models::TargetResourceTypesSelected' if type == 'TARGETTYPES'
      return 'OCI::CloudGuard::Models::TargetIdsSelected' if type == 'TARGETIDS'
