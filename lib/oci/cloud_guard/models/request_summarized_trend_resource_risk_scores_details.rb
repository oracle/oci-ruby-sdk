...
module OCI
  ...
  class CloudGuard::Models::RequestSummarizedTrendResourceRiskScoresDetails
    FILTER_ENUM = [
    ...
    def filter=(filter)
      raise "Invalid value for 'filter': this must be one of the values in FILTER_ENUM." if filter && !FILTER_ENUM.include?(filter)
