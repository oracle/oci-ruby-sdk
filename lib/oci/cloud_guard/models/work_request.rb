...
module OCI
  ...
  class CloudGuard::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** Unique identifier of the work request
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** List of resources affected by the work request
    # @return [Array<OCI::CloudGuard::Models::WorkRequestResource>]
    attr_accessor :resources

    # **[Required]** Percentage of the work request that's completed
    # @return [Float]
    attr_accessor :percent_complete

    # **[Required]** The date and time the work request was created
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'status': :'String',
        'resources': :'Array<OCI::CloudGuard::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [id, compartment_id, operation_type, status, resources, percent_complete, time_accepted, time_started, time_finished, locks].hash
    end
