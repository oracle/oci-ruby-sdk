...
module OCI
  ...
  class CloudGuard::Models::UpdateConfigurationDetails
    STATUS_ENUM = [
    ...
    # @return [String]
    attr_accessor :reporting_region
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :self_manage_resources
    ...
    # @option attributes [String] :reporting_region The value to assign to the {#reporting_region} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [BOOLEAN] :self_manage_resources The value to assign to the {#self_manage_resources} property
