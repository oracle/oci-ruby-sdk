...
module OCI
  ...
  class CloudGuard::Models::UpdateTargetRecipeResponderRuleDetails
    # **[Required]** Identifier for ResponderRule.
    # @return [String]
    attr_accessor :responder_rule_id

    # This attribute is required.
    # @return [OCI::CloudGuard::Models::UpdateTargetResponderRuleDetails]
    ...
    # @option attributes [OCI::CloudGuard::Models::UpdateTargetResponderRuleDetails] :details The value to assign to the {#details} property
