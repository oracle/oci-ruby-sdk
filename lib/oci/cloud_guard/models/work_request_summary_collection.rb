...
module OCI
  ...
  class CloudGuard::Models::WorkRequestSummaryCollection
    # **[Required]** List of workRequestSummary resources
    # @return [Array<OCI::CloudGuard::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::WorkRequestSummary>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
