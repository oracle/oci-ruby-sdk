...
require 'date'
require_relative 'continuous_query_start_policy'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Start policy that defines the exact start time
  class CloudGuard::Models::AbsoluteTimeStartPolicy < CloudGuard::Models::ContinuousQueryStartPolicy
    ...
    # @option attributes [DateTime] :query_start_time The value to assign to the {#query_start_time} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['startPolicyType'] = 'ABSOLUTE_TIME_START_POLICY'
    ...
    def hash
      [start_policy_type, query_start_time].hash
    end
