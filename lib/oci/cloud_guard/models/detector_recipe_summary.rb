...
module OCI
  ...
  class CloudGuard::Models::DetectorRecipeSummary
    ...
    # **[Required]** Display name for detector recipe
    # @return [String]
    ...
    def hash
      [id, display_name, description, compartment_id, source_detector_recipe_id, owner, detector_recipe_type, detector, detector_rules, time_created, time_updated, lifecycle_state, source_data_retention, freeform_tags, defined_tags, system_tags].hash
    end
