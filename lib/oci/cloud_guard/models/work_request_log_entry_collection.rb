...
module OCI
  ...
  #
  class CloudGuard::Models::WorkRequestLogEntryCollection
    # **[Required]** List of workRequestLogEntry resources
    # @return [Array<OCI::CloudGuard::Models::WorkRequestLogEntry>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudGuard::Models::WorkRequestLogEntry>',
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::WorkRequestLogEntry>] :items The value to assign to the {#items} property
