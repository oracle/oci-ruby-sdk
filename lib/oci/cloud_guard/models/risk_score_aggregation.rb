...
module OCI
  ...
  class CloudGuard::Models::RiskScoreAggregation
    ...
    # @option attributes [Integer] :risk_score The value to assign to the {#risk_score} property
    ...
    def hash
      [dimensions_map, risk_score].hash
    end
