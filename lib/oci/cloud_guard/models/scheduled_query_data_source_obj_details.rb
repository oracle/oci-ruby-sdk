...
module OCI
  ...
  class CloudGuard::Models::ScheduledQueryDataSourceObjDetails < CloudGuard::Models::DataSourceDetails
    ...
    def hash
      [data_source_feed_provider, query, description, interval_in_seconds, scheduled_query_scope_details].hash
    end
