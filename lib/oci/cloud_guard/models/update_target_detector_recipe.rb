...
module OCI
  ...
  class CloudGuard::Models::UpdateTargetDetectorRecipe
    # **[Required]** Identifier for DetectorRecipe.
    # @return [String]
    attr_accessor :target_detector_recipe_id
    ...
    # @option attributes [String] :target_detector_recipe_id The value to assign to the {#target_detector_recipe_id} property
    ...
    def initialize(attributes = {})
      ...
      self.target_detector_recipe_id = attributes[:'targetDetectorRecipeId'] if attributes[:'targetDetectorRecipeId']

      raise 'You cannot provide both :targetDetectorRecipeId and :target_detector_recipe_id' if attributes.key?(:'targetDetectorRecipeId') && attributes.key?(:'target_detector_recipe_id')

      self.target_detector_recipe_id = attributes[:'target_detector_recipe_id'] if attributes[:'target_detector_recipe_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        target_detector_recipe_id == other.target_detector_recipe_id &&
    ...
    def hash
      [target_detector_recipe_id, detector_rules].hash
    end
