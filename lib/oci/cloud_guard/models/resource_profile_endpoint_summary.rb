...
module OCI
  ...
  class CloudGuard::Models::ResourceProfileEndpointSummary
    ...
    def hash
      [id, resource_profile_id, problem_id, sighting_type, sighting_type_display_name, ip_address, ip_address_type, ip_classification_type, country, latitude, longitude, asn_number, regions, services, time_last_detected].hash
    end
