...
module OCI
  ...
  class CloudGuard::Models::ResponderExecution
    ...
    def hash
      [id, responder_rule_id, responder_rule_type, responder_rule_name, problem_id, region, target_id, compartment_id, resource_type, resource_name, time_created, time_completed, responder_execution_status, responder_execution_mode, message, responder_rule_execution_details].hash
    end
