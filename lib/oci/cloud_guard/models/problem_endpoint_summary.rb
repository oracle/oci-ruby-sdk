...
module OCI
  ...
  class CloudGuard::Models::ProblemEndpointSummary
    ...
    # **[Required]** Unique identifier for sighting associated with the endpoint
    # @return [String]
    attr_accessor :sighting_id

    # **[Required]** Unique identifier for problem associated with the endpoint
    # @return [String]
    attr_accessor :problem_id

    # **[Required]** Unique identifier for the sighting type associated with the endpoint
    # @return [String]
    ...
    # **[Required]** Type of IP address for the endpoint
    # @return [String]
