...
module OCI
  ...
  class CloudGuard::Models::UpdateTargetRecipeDetectorRuleDetails
    # **[Required]** Identifier for DetectorRule.
    # @return [String]
    attr_accessor :detector_rule_id

    # This attribute is required.
    # @return [OCI::CloudGuard::Models::UpdateTargetDetectorRuleDetails]
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::CloudGuard::Models::UpdateTargetDetectorRuleDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudGuard::Models::UpdateTargetDetectorRuleDetails] :details The value to assign to the {#details} property
