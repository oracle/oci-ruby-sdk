...
module OCI
  ...
  class CloudGuard::Models::UpdateDetectorRecipeDetectorRule
    # **[Required]** DetectorRecipeRule Identifier
    # @return [String]
    attr_accessor :detector_rule_id

    # This attribute is required.
    # @return [OCI::CloudGuard::Models::UpdateDetectorRuleDetails]
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::CloudGuard::Models::UpdateDetectorRuleDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudGuard::Models::UpdateDetectorRuleDetails] :details The value to assign to the {#details} property
