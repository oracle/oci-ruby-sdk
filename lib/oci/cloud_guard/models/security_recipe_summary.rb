...
module OCI
  ...
  class CloudGuard::Models::SecurityRecipeSummary
    OWNER_ENUM = [
    ...
    # @option attributes [Array<String>] :security_policies The value to assign to the {#security_policies} property
    ...
    def hash
      [id, display_name, description, compartment_id, owner, security_policies, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
