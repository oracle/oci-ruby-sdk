...
module OCI
  ...
  class CloudGuard::Models::DataSource
    ...
    def hash
      [id, display_name, data_source_feed_provider, compartment_id, data_source_details, time_created, time_updated, status, data_source_detector_mapping_info, region_status_detail, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
