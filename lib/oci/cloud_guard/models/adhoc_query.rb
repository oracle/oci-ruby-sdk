...
module OCI
  ...
  class CloudGuard::Models::AdhocQuery
    STATUS_ENUM = [
    ...
    # **[Required]** OCID for the adhoc query
    # @return [String]
    attr_accessor :id
    ...
    # @return [Array<OCI::CloudGuard::Models::AdhocQueryRegionalDetails>]
    attr_accessor :adhoc_query_regional_details

    # This attribute is required.
    # @return [OCI::CloudGuard::Models::AdhocQueryDetails]
    attr_accessor :adhoc_query_details
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::AdhocQueryRegionalDetails>] :adhoc_query_regional_details The value to assign to the {#adhoc_query_regional_details} property
    # @option attributes [OCI::CloudGuard::Models::AdhocQueryDetails] :adhoc_query_details The value to assign to the {#adhoc_query_details} property
    ...
    def hash
      [id, compartment_id, time_created, time_updated, status, adhoc_query_regional_details, adhoc_query_details, error_message, locks, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
