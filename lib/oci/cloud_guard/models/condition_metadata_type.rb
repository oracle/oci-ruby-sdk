...
module OCI
  ...
  class CloudGuard::Models::ConditionMetadataType
    # **[Required]** Name used to identify
    # @return [String]
    attr_accessor :name

    # **[Required]** collection of Service type
    # @return [Array<OCI::CloudGuard::Models::ServiceTypeSummary>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'service_types': :'Array<OCI::CloudGuard::Models::ServiceTypeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudGuard::Models::ServiceTypeSummary>] :service_types The value to assign to the {#service_types} property
