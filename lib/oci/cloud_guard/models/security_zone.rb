...
module OCI
  ...
  class CloudGuard::Models::SecurityZone
    ...
    # @return [String]
    attr_accessor :security_zone_recipe_id

    # The OCID of the target associated with the security zone
    # @return [String]
    attr_accessor :security_zone_target_id
    ...
    # @option attributes [String] :security_zone_recipe_id The value to assign to the {#security_zone_recipe_id} property
    # @option attributes [String] :security_zone_target_id The value to assign to the {#security_zone_target_id} property
    ...
    def initialize(attributes = {})
      ...
      self.security_zone_recipe_id = attributes[:'securityZoneRecipeId'] if attributes[:'securityZoneRecipeId']

      raise 'You cannot provide both :securityZoneRecipeId and :security_zone_recipe_id' if attributes.key?(:'securityZoneRecipeId') && attributes.key?(:'security_zone_recipe_id')

      self.security_zone_recipe_id = attributes[:'security_zone_recipe_id'] if attributes[:'security_zone_recipe_id']

      self.security_zone_target_id = attributes[:'securityZoneTargetId'] if attributes[:'securityZoneTargetId']

      raise 'You cannot provide both :securityZoneTargetId and :security_zone_target_id' if attributes.key?(:'securityZoneTargetId') && attributes.key?(:'security_zone_target_id')

      self.security_zone_target_id = attributes[:'security_zone_target_id'] if attributes[:'security_zone_target_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        security_zone_recipe_id == other.security_zone_recipe_id &&
        security_zone_target_id == other.security_zone_target_id &&
    ...
    def hash
      [id, display_name, description, compartment_id, security_zone_recipe_id, security_zone_target_id, inherited_by_compartments, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
