...
module OCI
  ...
  class Monitoring::Models::AlarmSuppressionTarget
    TARGET_TYPE_ENUM = [
      TARGET_TYPE_ALARM = 'ALARM'.freeze,
      TARGET_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of the alarm suppression target.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Monitoring::Models::AlarmSuppressionAlarmTarget' if type == 'ALARM'
