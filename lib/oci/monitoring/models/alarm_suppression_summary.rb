...
module OCI
  ...
  #
  class Monitoring::Models::AlarmSuppressionSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm suppression.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the alarm suppression.
    # @return [String]
    ...
    # **[Required]** Configured dimension filter for suppressing alarm state entries that include the set of specified dimension key-value pairs.
    #
    ...
    def hash
      [id, compartment_id, alarm_suppression_target, display_name, description, dimensions, time_suppress_from, time_suppress_until, lifecycle_state, time_created, time_updated, freeform_tags, defined_tags].hash
    end
