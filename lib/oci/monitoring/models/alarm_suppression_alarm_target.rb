...
require 'date'
require_relative 'alarm_suppression_target'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The alarm target of the alarm suppression.
  class Monitoring::Models::AlarmSuppressionAlarmTarget < Monitoring::Models::AlarmSuppressionTarget
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm that is the target of the alarm suppression.
    # @return [String]
