...
module OCI
  ...
  #
  class Monitoring::Models::AlarmDimensionStatesCollection
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm to retrieve alarm state entries for.
    #
    # @return [String]
    ...
    #
    # @return [Array<OCI::Monitoring::Models::AlarmDimensionStatesEntry>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Monitoring::Models::AlarmDimensionStatesEntry>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Monitoring::Models::AlarmDimensionStatesEntry>] :items The value to assign to the {#items} property
    ...
    def hash
      [alarm_id, is_enabled, is_notifications_per_metric_dimension_enabled, items].hash
    end
