...
module OCI
  ...
  class Monitoring::MonitoringClient
    ...
    # or transactions, per second (TPS) for a given tenancy.
    #
    # @param [OCI::Monitoring::Models::CreateAlarmSuppressionDetails] create_alarm_suppression_details The details of the alarm suppression to be created
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Monitoring::Models::AlarmSuppression AlarmSuppression}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/create_alarm_suppression.rb.html) to see an example of how to use create_alarm_suppression API.
    ...
    # or transactions, per second (TPS) for a given tenancy.
    #
    # @param [String] alarm_suppression_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm suppression.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Customer part of the request identifier token. If you need to contact Oracle about a particular
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/delete_alarm_suppression.rb.html) to see an example of how to use delete_alarm_suppression API.
    ...
    #   request, please provide the complete request ID.
    #
    # @option opts [String] :alarm_historytype The type of history entries to retrieve.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Monitoring::Models::AlarmSuppression AlarmSuppression}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/get_alarm_suppression.rb.html) to see an example of how to use get_alarm_suppression API.
    ...
    # or transactions, per second (TPS) for a given tenancy.
    #
    # @param [String] alarm_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm that is the target of the alarm suppression.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Customer part of the request identifier token. If you need to contact Oracle about a particular
    ...
    #
    # @option opts [String] :lifecycle_state A filter to return only resources that match the given lifecycle state exactly. When not specified, only resources in the ACTIVE lifecycle state are listed.
    #
    # @option opts [String] :sort_by The field to use when sorting returned alarm suppressions. Only one sorting level is provided.
    #
    #   Example: `timeCreated`
    #
    #   Allowed values are: displayName, timeCreated, timeSuppressFrom
    # @option opts [String] :sort_order The sort order to use when sorting returned alarm suppressions. Ascending (ASC) or descending (DESC).
    #
    #   Example: `ASC`
    #
    ...
    #   Example: 500
    #
    # @return [Response] A Response object with data of type {OCI::Monitoring::Models::AlarmSuppressionCollection AlarmSuppressionCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/list_alarm_suppressions.rb.html) to see an example of how to use list_alarm_suppressions API.
    def list_alarm_suppressions(alarm_id, opts = {})
      logger.debug 'Calling operation MonitoringClient#list_alarm_suppressions.' if logger

      raise "Missing the required parameter 'alarm_id' when calling list_alarm_suppressions." if alarm_id.nil?
    ...
    #
    #   Allowed values are: ASC, DESC
    # @option opts [String] :resource_id A filter to return only the resource with the specified [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    #   The resource must be monitored by the metric that you are searching for.
    #
    #   Example: `ocid1.instance.oc1.phx.exampleuniqueID`
    #
    # @option opts [String] :service_name A filter to return only resources that match the given service name exactly.
    ...
    #
    # @option opts [String] :entity_id A filter to return only resources that match the given entity [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) exactly.
    #   The resource (entity) must be monitored by the metric that you are searching for.
    #
    #   Example: `ocid1.instance.oc1.phx.exampleuniqueID`
    #
    # @option opts [String] :status A filter to return only metric streams that match the specified status.
    ...
    #   request, please provide the complete request ID.
    #
    # @option opts [String] :content_encoding The optional Content-Encoding header that defines the content encodings that were applied to the payload.
    #
    ...
    #   Example: 500
    #
    # @option opts [OCI::Monitoring::Models::RetrieveDimensionStatesDetails] :retrieve_dimension_states_details The configuration details for retrieving the current alarm status of each metric stream.
    #
    # @return [Response] A Response object with data of type {OCI::Monitoring::Models::AlarmDimensionStatesCollection AlarmDimensionStatesCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/retrieve_dimension_states.rb.html) to see an example of how to use retrieve_dimension_states API.
    ...
    #   Example: 500
    #
    # @option opts [OCI::Monitoring::Models::SummarizeAlarmSuppressionHistoryDetails] :summarize_alarm_suppression_history_details summarize history details
    # @return [Response] A Response object with data of type {OCI::Monitoring::Models::AlarmSuppressionHistoryItemCollection AlarmSuppressionHistoryItemCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/monitoring/summarize_alarm_suppression_history.rb.html) to see an example of how to use summarize_alarm_suppression_history API.
