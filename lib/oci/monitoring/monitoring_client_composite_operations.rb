...
module OCI
  ...
  class Monitoring::MonitoringClientCompositeOperations
    ...
    # Calls {OCI::Monitoring::MonitoringClient#create_alarm_suppression} and then waits for the {OCI::Monitoring::Models::AlarmSuppression} acted upon
    # to enter the given state(s).
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Monitoring::Models::AlarmSuppression#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Monitoring::MonitoringClient#create_alarm_suppression}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Monitoring::Models::AlarmSuppression}
    ...
    # Calls {OCI::Monitoring::MonitoringClient#delete_alarm_suppression} and then waits for the {OCI::Monitoring::Models::AlarmSuppression} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Monitoring::Models::AlarmSuppression#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Monitoring::MonitoringClient#delete_alarm_suppression}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
