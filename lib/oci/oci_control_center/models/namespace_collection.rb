...
module OCI
  ...
  #
  class OciControlCenter::Models::NamespaceCollection
    # **[Required]** An array of NamespaceSummary objects.
    #
    # @return [Array<OCI::OciControlCenter::Models::NamespaceSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::OciControlCenter::Models::NamespaceSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::OciControlCenter::Models::NamespaceSummary>] :items The value to assign to the {#items} property
