...
module OCI
  ...
  #
  class OciControlCenter::Models::RequestSummarizedMetricDataDetails
    # **[Required]** The source service or application to use when searching for metric data points to aggregate. For a list of valid namespaces, see {#list_namespaces list_namespaces}.
    #
    # @return [String]
    attr_accessor :namespace_name

    # **[Required]** The name of a metric for retrieving aggregated data. For a list of valid metrics for a given namespace, see {#list_metric_properties list_metric_properties}.
    #
    # @return [String]
    ...
    # Qualifiers to use when searching for metric data. For a list of valid dimensions for a given metric, see {#list_metric_properties list_metric_properties}.
    #
    ...
    def hash
      [namespace_name, metric_name, compartment_id, dimensions, start_time, end_time].hash
    end
