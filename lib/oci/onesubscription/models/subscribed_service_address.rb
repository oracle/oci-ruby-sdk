...
module OCI
  # Address.
  #
  class Onesubscription::Models::SubscribedServiceAddress
    # @return [OCI::Onesubscription::Models::SubscribedServiceLocation]
    ...
    # @option attributes [OCI::Onesubscription::Models::SubscribedServiceLocation] :location The value to assign to the {#location} property
