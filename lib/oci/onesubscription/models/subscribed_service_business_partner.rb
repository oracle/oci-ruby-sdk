...
module OCI
  # Business partner.
  #
  class Onesubscription::Models::SubscribedServiceBusinessPartner
    ...
    #
    # @return [String]
    attr_accessor :name_phonetic

    # TCA customer account number.
    #
    # @return [String]
    attr_accessor :tca_cust_account_number

    # The business partner is part of the public sector or not.
    #
    # @return [BOOLEAN]
    attr_accessor :is_public_sector

    # The business partner is chain customer or not.
    #
    # @return [BOOLEAN]
    attr_accessor :is_chain_customer

    # Customer chain type.
    #
    # @return [String]
    attr_accessor :customer_chain_type

    # TCA party number.
    #
    # @return [String]
    attr_accessor :tca_party_number

    # TCA party ID.
    #
    # @return [Integer]
    attr_accessor :tca_party_id

    # TCA customer account ID.
    #
    # @return [Integer]
    attr_accessor :tca_customer_account_id
    ...
    def self.swagger_types
      {
        ...
        'tca_cust_account_number': :'String',
    ...
    # @option attributes [String] :name_phonetic The value to assign to the {#name_phonetic} property
    # @option attributes [String] :tca_cust_account_number The value to assign to the {#tca_cust_account_number} property
    # @option attributes [BOOLEAN] :is_public_sector The value to assign to the {#is_public_sector} property
    # @option attributes [BOOLEAN] :is_chain_customer The value to assign to the {#is_chain_customer} property
    # @option attributes [String] :customer_chain_type The value to assign to the {#customer_chain_type} property
    # @option attributes [String] :tca_party_number The value to assign to the {#tca_party_number} property
    # @option attributes [Integer] :tca_party_id The value to assign to the {#tca_party_id} property
    # @option attributes [Integer] :tca_customer_account_id The value to assign to the {#tca_customer_account_id} property
    def initialize(attributes = {})
      ...
      self.tca_cust_account_number = attributes[:'tcaCustAccountNumber'] if attributes[:'tcaCustAccountNumber']

      raise 'You cannot provide both :tcaCustAccountNumber and :tca_cust_account_number' if attributes.key?(:'tcaCustAccountNumber') && attributes.key?(:'tca_cust_account_number')

      self.tca_cust_account_number = attributes[:'tca_cust_account_number'] if attributes[:'tca_cust_account_number']
      ...
      self.tca_customer_account_id = attributes[:'tcaCustomerAccountId'] if attributes[:'tcaCustomerAccountId']
      ...
      self.tca_customer_account_id = attributes[:'tca_customer_account_id'] if attributes[:'tca_customer_account_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tca_cust_account_number == other.tca_cust_account_number &&
        ...
        tca_customer_account_id == other.tca_customer_account_id
    end
    ...
    def hash
      [name, name_phonetic, tca_cust_account_number, is_public_sector, is_chain_customer, customer_chain_type, tca_party_number, tca_party_id, tca_customer_account_id].hash
    end
