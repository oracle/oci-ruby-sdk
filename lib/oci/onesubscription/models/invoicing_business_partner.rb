...
module OCI
  # Business partner.
  #
  class Onesubscription::Models::InvoicingBusinessPartner
    ...
    #
    # @return [String]
    attr_accessor :tca_customer_account_number
    ...
    # @option attributes [String] :tca_customer_account_number The value to assign to the {#tca_customer_account_number} property
    ...
    def initialize(attributes = {})
      ...
      self.tca_customer_account_number = attributes[:'tcaCustomerAccountNumber'] if attributes[:'tcaCustomerAccountNumber']
      ...
      self.tca_customer_account_number = attributes[:'tca_customer_account_number'] if attributes[:'tca_customer_account_number']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tca_customer_account_number == other.tca_customer_account_number &&
    ...
    def hash
      [name, name_phonetic, tca_customer_account_number, is_public_sector, is_chain_customer, customer_chain_type, tca_party_number, tca_party_id, tca_customer_account_id].hash
    end
