...
module OCI
  # Rate Card Summary
  #
  class Onesubscription::Models::RateCardSummary
    ...
    #
    # @return [Array<OCI::Onesubscription::Models::RateCardTier>]
    ...
    # @option attributes [Array<OCI::Onesubscription::Models::RateCardTier>] :rate_card_tiers The value to assign to the {#rate_card_tiers} property
