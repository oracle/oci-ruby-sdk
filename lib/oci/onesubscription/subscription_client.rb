...
module OCI
  ...
  class Onesubscription::SubscriptionClient
    ...
    #
    # @return [Response] A Response object with data of type Array<{OCI::Onesubscription::Models::SubscriptionSummary SubscriptionSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/list_subscriptions.rb.html) to see an example of how to use list_subscriptions API.
    def list_subscriptions(compartment_id, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SubscriptionClient#list_subscriptions') do
        @api_client.call_api(
          ...
          body: post_body,
          return_type: 'Array<OCI::Onesubscription::Models::SubscriptionSummary>'
        )
      end
