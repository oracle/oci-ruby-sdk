...
module OCI
  ...
  class Onesubscription::CommitmentClient
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Onesubscription::Models::Commitment Commitment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/get_commitment.rb.html) to see an example of how to use get_commitment API.
    def get_commitment(commitment_id, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'CommitmentClient#get_commitment') do
        @api_client.call_api(
          ...
          body: post_body,
          return_type: 'OCI::Onesubscription::Models::Commitment'
        )
      end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type Array<{OCI::Onesubscription::Models::CommitmentSummary CommitmentSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/list_commitments.rb.html) to see an example of how to use list_commitments API.
    def list_commitments(subscribed_service_id, compartment_id, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'CommitmentClient#list_commitments') do
        @api_client.call_api(
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Onesubscription::Models::CommitmentSummary>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
