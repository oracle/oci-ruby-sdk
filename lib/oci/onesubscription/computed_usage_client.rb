...
module OCI
  ...
  class Onesubscription::ComputedUsageClient
    ...
    #
    # @return [Response] A Response object with data of type {OCI::Onesubscription::Models::ComputedUsage ComputedUsage}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/get_computed_usage.rb.html) to see an example of how to use get_computed_usage API.
    def get_computed_usage(computed_usage_id, compartment_id, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ComputedUsageClient#get_computed_usage') do
        @api_client.call_api(
          ...
          body: post_body,
          return_type: 'OCI::Onesubscription::Models::ComputedUsage'
        )
      end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type Array<{OCI::Onesubscription::Models::AggregatedComputedUsageSummary AggregatedComputedUsageSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/list_aggregated_computed_usages.rb.html) to see an example of how to use list_aggregated_computed_usages API.
    def list_aggregated_computed_usages(compartment_id, subscription_id, time_from, time_to, opts = {})
      logger.debug 'Calling operation ComputedUsageClient#list_aggregated_computed_usages.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_aggregated_computed_usages." if compartment_id.nil?
      raise "Missing the required parameter 'subscription_id' when calling list_aggregated_computed_usages." if subscription_id.nil?
      raise "Missing the required parameter 'time_from' when calling list_aggregated_computed_usages." if time_from.nil?
      raise "Missing the required parameter 'time_to' when calling list_aggregated_computed_usages." if time_to.nil?
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ComputedUsageClient#list_aggregated_computed_usages') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Onesubscription::Models::AggregatedComputedUsageSummary>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type Array<{OCI::Onesubscription::Models::ComputedUsageSummary ComputedUsageSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/onesubscription/list_computed_usages.rb.html) to see an example of how to use list_computed_usages API.
    def list_computed_usages(compartment_id, subscription_id, time_from, time_to, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ComputedUsageClient#list_computed_usages') do
        @api_client.call_api(
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'Array<OCI::Onesubscription::Models::ComputedUsageSummary>'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
