...
require 'date'
require_relative 'ca_bundle'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # CA bundle from Certificates Service that should be used on the gateway for TLS validation
  class Apigateway::Models::CertificatesCaBundle < Apigateway::Models::CaBundle
    # The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource.
    #
    # @return [String]
    attr_accessor :ca_bundle_id
    ...
    # @option attributes [String] :ca_bundle_id The value to assign to the {#ca_bundle_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'CA_BUNDLE'
