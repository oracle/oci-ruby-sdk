...
module OCI
  ...
  class Apigateway::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_GATEWAY = 'CREATE_GATEWAY'.freeze,
      OPERATION_TYPE_UPDATE_GATEWAY = 'UPDATE_GATEWAY'.freeze,
      OPERATION_TYPE_DELETE_GATEWAY = 'DELETE_GATEWAY'.freeze,
      ...
      OPERATION_TYPE_CREATE_SDK = 'CREATE_SDK'.freeze,
      OPERATION_TYPE_DELETE_SDK = 'DELETE_SDK'.freeze,
      OPERATION_TYPE_CREATE_USAGE_PLAN = 'CREATE_USAGE_PLAN'.freeze,
      OPERATION_TYPE_UPDATE_USAGE_PLAN = 'UPDATE_USAGE_PLAN'.freeze,
      OPERATION_TYPE_DELETE_USAGE_PLAN = 'DELETE_USAGE_PLAN'.freeze,
      OPERATION_TYPE_CREATE_SUBSCRIBER = 'CREATE_SUBSCRIBER'.freeze,
      OPERATION_TYPE_UPDATE_SUBSCRIBER = 'UPDATE_SUBSCRIBER'.freeze,
      OPERATION_TYPE_DELETE_SUBSCRIBER = 'DELETE_SUBSCRIBER'.freeze,
    ...
    # @return [Array<OCI::Apigateway::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Apigateway::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
