...
module OCI
  ...
  #
  class Apigateway::Models::Deployment
    ...
    # @option attributes [String] :path_prefix The value to assign to the {#path_prefix} property
    # @option attributes [String] :endpoint The value to assign to the {#endpoint} property
    # @option attributes [OCI::Apigateway::Models::ApiSpecification] :specification The value to assign to the {#specification} property
    ...
    def initialize(attributes = {})
      ...
      self.specification = attributes[:'specification'] if attributes[:'specification']
    ...
    def hash
      [id, gateway_id, display_name, compartment_id, path_prefix, endpoint, specification, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
