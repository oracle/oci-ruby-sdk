...
module OCI
  ...
  class Apigateway::Models::WorkRequestSummary
    ...
    def hash
      [operation_type, status, work_request_id, compartment_id, percent_complete, time_accepted, time_started, time_finished].hash
    end
