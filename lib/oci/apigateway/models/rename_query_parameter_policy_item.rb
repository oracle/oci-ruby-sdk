...
module OCI
  ...
  #
  class Apigateway::Models::RenameQueryParameterPolicyItem
    # **[Required]** The original case-sensitive name of the query parameter.  This name must be unique across transformation
    # policies.
    #
    # @return [String]
    attr_accessor :from
    ...
    # @option attributes [String] :to The value to assign to the {#to} property
