...
module OCI
  ...
  class Apigateway::Models::SdkSummary
    ...
    def hash
      [id, compartment_id, time_created, time_updated, display_name, target_language, lifecycle_state, freeform_tags, defined_tags].hash
    end
