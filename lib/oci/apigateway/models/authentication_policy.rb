...
module OCI
  ...
  class Apigateway::Models::AuthenticationPolicy
    ...
    def initialize(attributes = {})
      ...
      self.is_anonymous_access_allowed = false if is_anonymous_access_allowed.nil? && !attributes.key?(:'isAnonymousAccessAllowed') # rubocop:disable Style/StringLiterals
      ...
      self.is_anonymous_access_allowed = false if is_anonymous_access_allowed.nil? && !attributes.key?(:'isAnonymousAccessAllowed') && !attributes.key?(:'is_anonymous_access_allowed') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [is_anonymous_access_allowed, type].hash
    end
