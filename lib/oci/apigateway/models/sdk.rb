...
module OCI
  ...
  class Apigateway::Models::Sdk
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of API resource
    #
    # @return [String]
    ...
    # @return [DateTime]
    attr_accessor :time_artifact_url_expires_at
    ...
    # @option attributes [String] :api_id The value to assign to the {#api_id} property
    # @option attributes [String] :compartment_id The value to assign to the {#compartment_id} property
    # @option attributes [DateTime] :time_created The value to assign to the {#time_created} property
    # @option attributes [DateTime] :time_updated The value to assign to the {#time_updated} property
    # @option attributes [String] :display_name The value to assign to the {#display_name} property
    # @option attributes [String] :target_language The value to assign to the {#target_language} property
    # @option attributes [String] :artifact_url The value to assign to the {#artifact_url} property
    # @option attributes [DateTime] :time_artifact_url_expires_at The value to assign to the {#time_artifact_url_expires_at} property
