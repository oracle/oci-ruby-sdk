...
module OCI
  ...
  #
  class Apigateway::Models::FilterHeaderPolicy
    TYPE_ENUM = [
    ...
    # **[Required]** BLOCK drops any headers that are in the list of items, so it acts as an exclusion list.  ALLOW
    ...
    #
    # @return [Array<OCI::Apigateway::Models::FilterHeaderPolicyItem>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Apigateway::Models::FilterHeaderPolicyItem>] :items The value to assign to the {#items} property
