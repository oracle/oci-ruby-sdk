...
require 'date'
require_relative 'dynamic_selection_key'
...
module OCI
  ...
  class Apigateway::Models::AnyOfSelectionKey < Apigateway::Models::DynamicSelectionKey
    ...
    # @option attributes [BOOLEAN] :is_default The value to assign to the {OCI::Apigateway::Models::DynamicSelectionKey#is_default #is_default} proprety
    # @option attributes [String] :name The value to assign to the {OCI::Apigateway::Models::DynamicSelectionKey#name #name} proprety
    ...
    def hash
      [type, is_default, name, values].hash
    end
