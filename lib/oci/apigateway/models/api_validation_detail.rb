...
module OCI
  ...
  class Apigateway::Models::ApiValidationDetail
    SEVERITY_ENUM = [
    ...
    # @option attributes [String] :msg The value to assign to the {#msg} property
    # @option attributes [String] :severity The value to assign to the {#severity} property
    # @option attributes [Array<Array<Float>>] :src The value to assign to the {#src} property
