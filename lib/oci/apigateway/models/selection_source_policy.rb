...
module OCI
  ...
  class Apigateway::Models::SelectionSourcePolicy
    TYPE_ENUM = [
      TYPE_SINGLE = 'SINGLE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Apigateway::Models::SingleSelectionSourcePolicy' if type == 'SINGLE'
    ...
    def initialize(attributes = {})
      ...
      self.type = "SINGLE" if type.nil? && !attributes.key?(:'type') # rubocop:disable Style/StringLiterals
    end
