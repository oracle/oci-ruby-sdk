...
module OCI
  ...
  class Apigateway::Models::TokenAuthenticationStaticKeysValidationPolicy < Apigateway::Models::TokenAuthenticationValidationPolicy
    ...
    def hash
      [type, additional_validation_policy, keys].hash
    end
