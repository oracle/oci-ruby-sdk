...
module OCI
  ...
  class Apigateway::Models::BodyValidationRequestPolicy
    ...
    # **[Required]** The content of the request body. The key is a [media type range](https://tools.ietf.org/html/rfc7231#appendix-D)
    ...
    #
    # @return [Hash<String, OCI::Apigateway::Models::ContentValidation>]
    ...
    # @option attributes [Hash<String, OCI::Apigateway::Models::ContentValidation>] :content The value to assign to the {#content} property
    ...
    def initialize(attributes = {})
      ...
      self.required = false if required.nil? && !attributes.key?(:'required') # rubocop:disable Style/StringLiterals
    ...
    def validation_mode=(validation_mode)
      raise "Invalid value for 'validation_mode': this must be one of the values in VALIDATION_MODE_ENUM." if validation_mode && !VALIDATION_MODE_ENUM.include?(validation_mode)
    ...
    def hash
      [required, content, validation_mode].hash
    end
