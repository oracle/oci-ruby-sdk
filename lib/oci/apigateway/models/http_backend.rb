...
require 'date'
require_relative 'api_specification_route_backend'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Send the request to an HTTP backend.
  #
  class Apigateway::Models::HTTPBackend < Apigateway::Models::ApiSpecificationRouteBackend
    ...
    #
    # @return [Float]
    attr_accessor :connect_timeout_in_seconds

    # Defines a timeout for reading a response from the proxied server.
    #
    # @return [Float]
    attr_accessor :read_timeout_in_seconds

    # Defines a timeout for transmitting a request to the proxied server.
    #
    # @return [Float]
    attr_accessor :send_timeout_in_seconds
    ...
    # @option attributes [Float] :connect_timeout_in_seconds The value to assign to the {#connect_timeout_in_seconds} property
    # @option attributes [Float] :read_timeout_in_seconds The value to assign to the {#read_timeout_in_seconds} property
    # @option attributes [Float] :send_timeout_in_seconds The value to assign to the {#send_timeout_in_seconds} property
