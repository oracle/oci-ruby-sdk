...
module OCI
  ...
  class Apigateway::Models::ClientAppDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Apigateway::Models::CustomClientAppDetails' if type == 'CUSTOM'
      return 'OCI::Apigateway::Models::ValidationBlockClientAppDetails' if type == 'VALIDATION_BLOCK'
