...
module OCI
  ...
  class Apigateway::Models::ApiValidationDetails
    RESULT_ENUM = [
    ...
    # @return [Array<OCI::Apigateway::Models::ApiValidationDetail>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'details': :'Array<OCI::Apigateway::Models::ApiValidationDetail>',
        'name': :'String',
        'result': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [Array<OCI::Apigateway::Models::ApiValidationDetail>] :details The value to assign to the {#details} property
