...
module OCI
  ...
  #
  class Apigateway::Models::FilterQueryParameterPolicy
    TYPE_ENUM = [
      TYPE_ALLOW = 'ALLOW'.freeze,
      TYPE_BLOCK = 'BLOCK'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** BLOCK drops any query parameters that are in the list of items, so it acts as an exclusion list.  ALLOW
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'type': :'String',
        'items': :'Array<OCI::Apigateway::Models::FilterQueryParameterPolicyItem>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Apigateway::Models::FilterQueryParameterPolicyItem>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      ...
      self.type = "BLOCK" if type.nil? && !attributes.key?(:'type') # rubocop:disable Style/StringLiterals
