...
module OCI
  ...
  #
  class Apigateway::Models::StockResponseBackend < Apigateway::Models::ApiSpecificationRouteBackend
    ...
    # @return [Array<OCI::Apigateway::Models::HeaderFieldSpecification>]
    ...
    # @option attributes [Integer] :status The value to assign to the {#status} property
    # @option attributes [Array<OCI::Apigateway::Models::HeaderFieldSpecification>] :headers The value to assign to the {#headers} property
