...
module OCI
  ...
  class Apigateway::Models::CertificateSummary
    ...
    def hash
      [id, display_name, compartment_id, subject_names, time_not_valid_after, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
