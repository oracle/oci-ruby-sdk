...
module OCI
  ...
  class Apigateway::Models::CertificatesCertificateAuthority < Apigateway::Models::CaBundle
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'CERTIFICATE_AUTHORITY'
    ...
    def hash
      [type, certificate_authority_id].hash
    end
