...
module OCI
  ...
  class Apigateway::Models::MutualTlsDetails
    ...
    # @option attributes [BOOLEAN] :is_verified_certificate_required The value to assign to the {#is_verified_certificate_required} property
    # @option attributes [Array<String>] :allowed_sans The value to assign to the {#allowed_sans} property
