...
module OCI
  ...
  #
  class Apigateway::Models::Subscriber
    ...
    # @return [Array<OCI::Apigateway::Models::Client>]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'clients': :'Array<OCI::Apigateway::Models::Client>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::Client>] :clients The value to assign to the {#clients} property
