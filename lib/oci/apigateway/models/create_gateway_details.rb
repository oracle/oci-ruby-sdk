...
module OCI
  ...
  class Apigateway::Models::CreateGatewayDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the subnet in which
    ...
    def hash
      [display_name, compartment_id, endpoint_type, subnet_id, network_security_group_ids, certificate_id, response_cache_details, freeform_tags, defined_tags, ca_bundles].hash
    end
