...
module OCI
  ...
  # keys.
  #
  class Apigateway::Models::RemoteJsonWebKeySet < Apigateway::Models::PublicKeySet
    # **[Required]** The uri from which to retrieve the key. It must be accessible
    ...
    def hash
      [type, uri, is_ssl_verify_disabled, max_cache_duration_in_hours].hash
    end
