...
module OCI
  ...
  #
  class Apigateway::Models::OAuth2ResponseValidationFailurePolicy < Apigateway::Models::ValidationFailurePolicy
    RESPONSE_TYPE_ENUM = [
    ...
    # @return [String]
    attr_accessor :fallback_redirect_path
    ...
    # @option attributes [Integer] :max_expiry_duration_in_hours The value to assign to the {#max_expiry_duration_in_hours} property
    # @option attributes [BOOLEAN] :use_cookies_for_session The value to assign to the {#use_cookies_for_session} property
    # @option attributes [BOOLEAN] :use_cookies_for_intermediate_steps The value to assign to the {#use_cookies_for_intermediate_steps} property
    # @option attributes [BOOLEAN] :use_pkce The value to assign to the {#use_pkce} property
    # @option attributes [String] :response_type The value to assign to the {#response_type} property
    # @option attributes [String] :fallback_redirect_path The value to assign to the {#fallback_redirect_path} property
    # @option attributes [String] :logout_path The value to assign to the {#logout_path} property
    ...
    def response_type=(response_type)
      ...
      if response_type && !RESPONSE_TYPE_ENUM.include?(response_type)
        OCI.logger.debug("Unknown value for 'response_type' [" + response_type + "]. Mapping to 'RESPONSE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @response_type = RESPONSE_TYPE_UNKNOWN_ENUM_VALUE
      else
