...
module OCI
  ...
  #
  class Apigateway::Models::UsagePlan
    ...
    #
    # @return [Array<OCI::Apigateway::Models::Entitlement>]
    ...
    def self.swagger_types
      {
        ...
        'id': :'String',
        'display_name': :'String',
        'entitlements': :'Array<OCI::Apigateway::Models::Entitlement>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::Entitlement>] :entitlements The value to assign to the {#entitlements} property
