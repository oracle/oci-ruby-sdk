...
module OCI
  ...
  # keys.
  #
  class Apigateway::Models::TokenAuthenticationRemoteJWKSValidationPolicy < Apigateway::Models::TokenAuthenticationValidationPolicy
    ...
    def hash
      [type, additional_validation_policy, uri, is_ssl_verify_disabled, max_cache_duration_in_hours].hash
    end
