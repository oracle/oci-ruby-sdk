...
module OCI
  ...
  class Apigateway::Models::ResponseCacheLookupPolicy
    TYPE_ENUM = [
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_private_caching_enabled
    ...
    # @option attributes [BOOLEAN] :is_private_caching_enabled The value to assign to the {#is_private_caching_enabled} property
