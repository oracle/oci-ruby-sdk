...
module OCI
  ...
  class Apigateway::Models::CreateCertificateDetails
    ...
    def hash
      [display_name, compartment_id, private_key, certificate, intermediate_certificates, freeform_tags, defined_tags].hash
    end
