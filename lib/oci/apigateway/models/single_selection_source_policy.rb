...
require 'date'
require_relative 'selection_source_policy'
...
module OCI
  ...
  class Apigateway::Models::SingleSelectionSourcePolicy < Apigateway::Models::SelectionSourcePolicy
    ...
    # @option attributes [String] :selector The value to assign to the {#selector} property
    def initialize(attributes = {})
      ...
      self.selector = attributes[:'selector'] if attributes[:'selector']
    end
