...
module OCI
  ...
  class Apigateway::Models::UsagePlanSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of a usage plan
    # resource.
    #
    # @return [String]
    attr_accessor :id
    ...
    #
    # @return [Array<OCI::Apigateway::Models::EntitlementSummary>]
    ...
    def self.swagger_types
      {
        ...
        'id': :'String',
        'display_name': :'String',
        'entitlements': :'Array<OCI::Apigateway::Models::EntitlementSummary>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::EntitlementSummary>] :entitlements The value to assign to the {#entitlements} property
    ...
    def hash
      [id, display_name, entitlements, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
