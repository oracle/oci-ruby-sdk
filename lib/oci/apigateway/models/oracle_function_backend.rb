...
module OCI
  ...
  #
  class Apigateway::Models::OracleFunctionBackend < Apigateway::Models::ApiSpecificationRouteBackend
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'ORACLE_FUNCTIONS_BACKEND'
