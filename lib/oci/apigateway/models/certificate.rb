...
module OCI
  ...
  #
  class Apigateway::Models::Certificate
    ...
    # @option attributes [Array<String>] :subject_names The value to assign to the {#subject_names} property
    ...
    # @option attributes [String] :intermediate_certificates The value to assign to the {#intermediate_certificates} property
    ...
    def initialize(attributes = {})
      ...
      self.subject_names = attributes[:'subjectNames'] if attributes[:'subjectNames']

      raise 'You cannot provide both :subjectNames and :subject_names' if attributes.key?(:'subjectNames') && attributes.key?(:'subject_names')

      self.subject_names = attributes[:'subject_names'] if attributes[:'subject_names']
      ...
      self.intermediate_certificates = attributes[:'intermediateCertificates'] if attributes[:'intermediateCertificates']

      raise 'You cannot provide both :intermediateCertificates and :intermediate_certificates' if attributes.key?(:'intermediateCertificates') && attributes.key?(:'intermediate_certificates')

      self.intermediate_certificates = attributes[:'intermediate_certificates'] if attributes[:'intermediate_certificates']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        subject_names == other.subject_names &&
        time_not_valid_after == other.time_not_valid_after &&
        certificate == other.certificate &&
        intermediate_certificates == other.intermediate_certificates &&
    ...
    def hash
      [id, display_name, compartment_id, subject_names, time_not_valid_after, certificate, intermediate_certificates, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
