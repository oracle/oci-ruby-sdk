...
module OCI
  ...
  class Apigateway::Models::HeaderValidationRequestPolicy
    ...
    # @return [Array<OCI::Apigateway::Models::HeaderValidationItem>]
    ...
    # @option attributes [Array<OCI::Apigateway::Models::HeaderValidationItem>] :headers The value to assign to the {#headers} property
