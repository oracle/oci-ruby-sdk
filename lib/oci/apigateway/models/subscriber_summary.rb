...
module OCI
  ...
  class Apigateway::Models::SubscriberSummary
    ...
    # @return [Array<OCI::Apigateway::Models::ClientSummary>]
    attr_accessor :clients

    # **[Required]** An array of [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm)s of usage
    # plan resources.
    #
    # @return [Array<String>]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'clients': :'Array<OCI::Apigateway::Models::ClientSummary>',
        'usage_plans': :'Array<String>',
    ...
    # @option attributes [Array<OCI::Apigateway::Models::ClientSummary>] :clients The value to assign to the {#clients} property
    # @option attributes [Array<String>] :usage_plans The value to assign to the {#usage_plans} property
    ...
    def initialize(attributes = {})
      ...
      self.clients = attributes[:'clients'] if attributes[:'clients']
    ...
    def hash
      [id, compartment_id, display_name, clients, usage_plans, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
