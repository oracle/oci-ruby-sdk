...
module OCI
  ...
  class Apigateway::Models::ApiSpecification
    # @return [OCI::Apigateway::Models::ApiSpecificationRequestPolicies]
    ...
    # @return [Array<OCI::Apigateway::Models::ApiSpecificationRoute>]
    ...
    # @option attributes [OCI::Apigateway::Models::ApiSpecificationRequestPolicies] :request_policies The value to assign to the {#request_policies} property
    ...
    # @option attributes [Array<OCI::Apigateway::Models::ApiSpecificationRoute>] :routes The value to assign to the {#routes} property
