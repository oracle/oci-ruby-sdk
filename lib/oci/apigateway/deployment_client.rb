...
module OCI
  ...
  class Apigateway::DeploymentClient
    ...
    # Creates a new DeploymentClient.
    # Notes:
    ...
    def initialize(config: nil, region: nil, endpoint: nil, signer: nil, proxy_settings: nil, retry_config: nil)
      ...
      logger.info "DeploymentClient endpoint set to '#{@endpoint}'." if logger
    end
    ...
    def region=(new_region)
      ...
      logger.info "DeploymentClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    def change_deployment_compartment(deployment_id, change_deployment_compartment_details, opts = {})
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#change_deployment_compartment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    def create_deployment(create_deployment_details, opts = {})
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#create_deployment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Apigateway::Models::Deployment'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    def delete_deployment(deployment_id, opts = {})
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#delete_deployment') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    def get_deployment(deployment_id, opts = {})
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#get_deployment') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :gateway_id Filter deployments by the gateway ocid. (default to null)
    ...
    def list_deployments(compartment_id, opts = {})
      ...
      if opts[:lifecycle_state] && !OCI::Apigateway::Models::Deployment::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::Apigateway::Models::Deployment::LIFECYCLE_STATE_ENUM.'
      end
      ...
      query_params[:gatewayId] = opts[:gateway_id] if opts[:gateway_id]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#list_deployments') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Apigateway::Models::DeploymentCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    def update_deployment(deployment_id, update_deployment_details, opts = {})
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DeploymentClient#update_deployment') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
