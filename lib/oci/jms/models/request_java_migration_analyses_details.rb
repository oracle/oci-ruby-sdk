...
module OCI
  ...
  #
  class Jms::Models::RequestJavaMigrationAnalysesDetails
    # **[Required]** An array of migration analysis requests.
    # @return [Array<OCI::Jms::Models::JavaMigrationAnalysisTarget>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'targets': :'Array<OCI::Jms::Models::JavaMigrationAnalysisTarget>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Jms::Models::JavaMigrationAnalysisTarget>] :targets The value to assign to the {#targets} property
