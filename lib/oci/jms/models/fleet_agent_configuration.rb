...
module OCI
  ...
  #
  class Jms::Models::FleetAgentConfiguration
    ...
    def hash
      [jre_scan_frequency_in_minutes, java_usage_tracker_processing_frequency_in_minutes, linux_configuration, windows_configuration, time_last_modified].hash
    end
