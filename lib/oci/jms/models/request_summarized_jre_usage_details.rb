...
module OCI
  ...
  class Jms::Models::RequestSummarizedJreUsageDetails
    SORT_ORDER_ENUM = [
    ...
    SORT_BY_ENUM = [
      SORT_BY_DISTRIBUTION = 'distribution'.freeze,
      SORT_BY_TIME_FIRST_SEEN = 'timeFirstSeen'.freeze,
      SORT_BY_TIME_LAST_SEEN = 'timeLastSeen'.freeze,
      SORT_BY_VENDOR = 'vendor'.freeze,
      SORT_BY_VERSION = 'version'.freeze,
    ...
    # @option attributes [Array<OCI::Jms::Models::SummarizeJreUsageFields>] :fields The value to assign to the {#fields} property
