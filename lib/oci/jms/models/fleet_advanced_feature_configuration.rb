...
module OCI
  ...
  class Jms::Models::FleetAdvancedFeatureConfiguration
    ...
    def hash
      [analytic_namespace, analytic_bucket_name, lcm, crypto_event_analysis, advanced_usage_tracking, jfr_recording, performance_tuning_analysis, java_migration_analysis, time_last_modified].hash
    end
