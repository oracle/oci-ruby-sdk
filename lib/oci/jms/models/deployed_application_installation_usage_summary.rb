...
module OCI
  ...
  #
  class Jms::Models::DeployedApplicationInstallationUsageSummary
    ...
    #
    # @return [String]
    attr_accessor :application_source_path
    ...
    # @option attributes [String] :application_source_path The value to assign to the {#application_source_path} property
    ...
    def initialize(attributes = {})
      ...
      self.application_source_path = attributes[:'applicationSourcePath'] if attributes[:'applicationSourcePath']

      raise 'You cannot provide both :applicationSourcePath and :application_source_path' if attributes.key?(:'applicationSourcePath') && attributes.key?(:'application_source_path')

      self.application_source_path = attributes[:'application_source_path'] if attributes[:'application_source_path']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        application_source_path == other.application_source_path &&
    ...
    def hash
      [application_installation_key, application_key, fleet_id, application_name, application_type, application_source_path, is_clustered, approximate_java_server_instance_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
