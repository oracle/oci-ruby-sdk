...
module OCI
  ...
  class Jms::Models::WorkItemDetails
    KIND_ENUM = [
    ...
    # @option attributes [String] :work_item_type The value to assign to the {#work_item_type} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] work_item_type Object to be assigned
    def work_item_type=(work_item_type)
      # rubocop:disable Style/ConditionalAssignment
      if work_item_type && !WORK_ITEM_TYPE_ENUM.include?(work_item_type)
        OCI.logger.debug("Unknown value for 'work_item_type' [" + work_item_type + "]. Mapping to 'WORK_ITEM_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @work_item_type = WORK_ITEM_TYPE_UNKNOWN_ENUM_VALUE
      else
