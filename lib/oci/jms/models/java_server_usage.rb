...
module OCI
  ...
  #
  class Jms::Models::JavaServerUsage
    ...
    #
    # @return [Integer]
    attr_accessor :server_instance_count
    ...
    # @option attributes [Integer] :server_instance_count The value to assign to the {#server_instance_count} property
    ...
    def initialize(attributes = {})
      ...
      self.server_instance_count = attributes[:'serverInstanceCount'] if attributes[:'serverInstanceCount']

      raise 'You cannot provide both :serverInstanceCount and :server_instance_count' if attributes.key?(:'serverInstanceCount') && attributes.key?(:'server_instance_count')

      self.server_instance_count = attributes[:'server_instance_count'] if attributes[:'server_instance_count']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        server_instance_count == other.server_instance_count &&
    ...
    def hash
      [server_key, fleet_id, server_name, server_version, server_instance_count, approximate_deployed_application_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
