...
module OCI
  ...
  class Jms::Models::LibraryUsage
    ...
    def hash
      [library_key, fleet_id, library_name, library_version, cvss_score, approximate_application_count, approximate_java_server_instance_count, approximate_deployed_application_count, approximate_managed_instance_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
