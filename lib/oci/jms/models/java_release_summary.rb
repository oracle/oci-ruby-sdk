...
module OCI
  ...
  class Jms::Models::JavaReleaseSummary
    ...
    def hash
      [release_version, family_version, parent_release_version, security_status, release_type, license_type, family_details, license_details, release_date, release_notes_url, artifact_content_types].hash
    end
