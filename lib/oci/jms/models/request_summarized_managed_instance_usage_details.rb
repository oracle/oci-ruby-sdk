...
module OCI
  ...
  class Jms::Models::RequestSummarizedManagedInstanceUsageDetails
    ...
    SORT_BY_ENUM = [
      ...
      SORT_BY_APPROXIMATE_JRE_COUNT = 'approximateJreCount'.freeze,
      SORT_BY_APPROXIMATE_INSTALLATION_COUNT = 'approximateInstallationCount'.freeze,
    ...
    # @option attributes [Array<OCI::Jms::Models::SummarizeManagedInstanceUsageFields>] :fields The value to assign to the {#fields} property
    ...
    def managed_instance_type=(managed_instance_type)
      raise "Invalid value for 'managed_instance_type': this must be one of the values in MANAGED_INSTANCE_TYPE_ENUM." if managed_instance_type && !MANAGED_INSTANCE_TYPE_ENUM.include?(managed_instance_type)
    ...
    def hash
      [time_start, time_end, installation_path, jre_vendor, jre_distribution, jre_version, application_id, managed_instance_id, managed_instance_type, sort_order, sort_by, fields].hash
    end
