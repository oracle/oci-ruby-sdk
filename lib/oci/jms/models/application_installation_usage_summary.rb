...
module OCI
  ...
  #
  class Jms::Models::ApplicationInstallationUsageSummary
    ...
    # @option attributes [Array<String>] :full_class_path The value to assign to the {#full_class_path} property
    ...
    def initialize(attributes = {})
      ...
      self.full_class_path = attributes[:'fullClassPath'] if attributes[:'fullClassPath']

      raise 'You cannot provide both :fullClassPath and :full_class_path' if attributes.key?(:'fullClassPath') && attributes.key?(:'full_class_path')

      self.full_class_path = attributes[:'full_class_path'] if attributes[:'full_class_path']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        full_class_path == other.full_class_path &&
    ...
    def hash
      [application_installation_key, application_key, display_name, application_type, installation_path, full_class_path, operating_systems, approximate_installation_count, approximate_jre_count, approximate_managed_instance_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
