...
module OCI
  ...
  class Jms::Models::GenerateAgentDeployScriptDetails
    OS_FAMILY_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the install key for which to generate the script.
    # @return [String]
    ...
    # @return [BOOLEAN]
    attr_accessor :is_user_name_enabled
    ...
    # @option attributes [BOOLEAN] :is_user_name_enabled The value to assign to the {#is_user_name_enabled} property
    def initialize(attributes = {})
      ...
      self.is_user_name_enabled = attributes[:'isUserNameEnabled'] unless attributes[:'isUserNameEnabled'].nil?

      raise 'You cannot provide both :isUserNameEnabled and :is_user_name_enabled' if attributes.key?(:'isUserNameEnabled') && attributes.key?(:'is_user_name_enabled')

      self.is_user_name_enabled = attributes[:'is_user_name_enabled'] unless attributes[:'is_user_name_enabled'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_user_name_enabled == other.is_user_name_enabled
    end
    ...
    def hash
      [install_key_id, os_family, is_user_name_enabled].hash
    end
