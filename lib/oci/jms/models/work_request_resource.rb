...
module OCI
  ...
  class Jms::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** An [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) or other unique identifier of the resource affected by the work request.
    # @return [String]
