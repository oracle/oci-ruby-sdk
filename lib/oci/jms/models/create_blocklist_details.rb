...
module OCI
  ...
  class Jms::Models::CreateBlocklistDetails
    OPERATION_ENUM = [
    ...
    # @return [OCI::Jms::Models::BlocklistTarget]
    ...
    # @option attributes [OCI::Jms::Models::BlocklistTarget] :target The value to assign to the {#target} property
