...
module OCI
  ...
  #
  class Jms::Models::ManageDrsDetails
    # The targets to manage DRS.
    # @return [Array<OCI::Jms::Models::DrsTarget>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'targets': :'Array<OCI::Jms::Models::DrsTarget>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Jms::Models::DrsTarget>] :targets The value to assign to the {#targets} property
