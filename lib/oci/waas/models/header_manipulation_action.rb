...
module OCI
  ...
  class Waas::Models::HeaderManipulationAction
    ACTION_ENUM = [
      ACTION_EXTEND_HTTP_RESPONSE_HEADER = 'EXTEND_HTTP_RESPONSE_HEADER'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Waas::Models::ExtendHttpResponseHeaderAction' if type == 'EXTEND_HTTP_RESPONSE_HEADER'
      return 'OCI::Waas::Models::AddHttpResponseHeaderAction' if type == 'ADD_HTTP_RESPONSE_HEADER'
      return 'OCI::Waas::Models::RemoveHttpResponseHeaderAction' if type == 'REMOVE_HTTP_RESPONSE_HEADER'
