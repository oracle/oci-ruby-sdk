...
module OCI
  ...
  class Waas::Models::CreateCustomProtectionRuleDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment in which to create the Custom Protection rule.
    # @return [String]
    ...
    # **[Required]** The template text of the Custom Protection rule. The syntax is based on ModSecurity Rule Language. Additionaly it needs to include two variables / placeholders which will be replaced during publishing.
    #
    ...
    def hash
      [compartment_id, display_name, description, template, freeform_tags, defined_tags].hash
    end
