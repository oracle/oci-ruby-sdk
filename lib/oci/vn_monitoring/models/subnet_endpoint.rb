...
module OCI
  ...
  #
  class VnMonitoring::Models::SubnetEndpoint < VnMonitoring::Models::Endpoint
    # **[Required]** The IPv4 address of the `Endpoint`.
    # @return [String]
    attr_accessor :address

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the subnet containing the IP address.
