...
module OCI
  ...
  #
  class VnMonitoring::Models::UdpOptions
    # @return [OCI::VnMonitoring::Models::PortRange]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'destination_port_range': :'OCI::VnMonitoring::Models::PortRange',
        'source_port_range': :'OCI::VnMonitoring::Models::PortRange'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::PortRange] :destination_port_range The value to assign to the {#destination_port_range} property
    # @option attributes [OCI::VnMonitoring::Models::PortRange] :source_port_range The value to assign to the {#source_port_range} property
