...
module OCI
  ...
  class VnMonitoring::Models::Topology
    TYPE_ENUM = [
    ...
    # @return [Array<OCI::VnMonitoring::Models::TopologyEntityRelationship>]
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::TopologyEntityRelationship>] :relationships The value to assign to the {#relationships} property
