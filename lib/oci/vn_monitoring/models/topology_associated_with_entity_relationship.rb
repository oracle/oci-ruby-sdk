...
require 'date'
require_relative 'topology_entity_relationship'
...
module OCI
  ...
  # attached to a VCN.
  #
  class VnMonitoring::Models::TopologyAssociatedWithEntityRelationship < VnMonitoring::Models::TopologyEntityRelationship
    # @return [OCI::VnMonitoring::Models::TopologyAssociatedWithRelationshipDetails]
    ...
    def self.swagger_types
      {
        ...
        'id2': :'String',
        'type': :'String',
        'associated_with_details': :'OCI::VnMonitoring::Models::TopologyAssociatedWithRelationshipDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :id1 The value to assign to the {OCI::VnMonitoring::Models::TopologyEntityRelationship#id1 #id1} proprety
    # @option attributes [String] :id2 The value to assign to the {OCI::VnMonitoring::Models::TopologyEntityRelationship#id2 #id2} proprety
    # @option attributes [OCI::VnMonitoring::Models::TopologyAssociatedWithRelationshipDetails] :associated_with_details The value to assign to the {#associated_with_details} property
