...
module OCI
  ...
  class VnMonitoring::Models::UpdateDrgAttachmentDetails
    ...
    # @return [OCI::VnMonitoring::Models::DrgAttachmentNetworkUpdateDetails]
    ...
    # @option attributes [OCI::VnMonitoring::Models::DrgAttachmentNetworkUpdateDetails] :network_details The value to assign to the {#network_details} property
    ...
    def hash
      [display_name, drg_route_table_id, network_details, defined_tags, freeform_tags, export_drg_route_distribution_id].hash
    end
