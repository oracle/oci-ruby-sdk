...
module OCI
  ...
  class VnMonitoring::Models::TopologyAssociatedWithRelationshipDetails
    ...
    # @option attributes [Array<String>] :via The value to assign to the {#via} property
    def initialize(attributes = {})
      ...
      self.via = attributes[:'via'] if attributes[:'via']
    end
