...
module OCI
  ...
  class VnMonitoring::Models::CreateIPSecConnectionDetails
    ...
    # two tunnels).
    #
    # @return [Array<OCI::VnMonitoring::Models::CreateIPSecConnectionTunnelDetails>]
    ...
    def self.swagger_types
      {
        ...
        'tunnel_configuration': :'Array<OCI::VnMonitoring::Models::CreateIPSecConnectionTunnelDetails>',
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::CreateIPSecConnectionTunnelDetails>] :tunnel_configuration The value to assign to the {#tunnel_configuration} property
    # @option attributes [Integer] :tunnel_count The value to assign to the {#tunnel_count} property
    def initialize(attributes = {})
      ...
      self.tunnel_count = attributes[:'tunnelCount'] if attributes[:'tunnelCount']

      raise 'You cannot provide both :tunnelCount and :tunnel_count' if attributes.key?(:'tunnelCount') && attributes.key?(:'tunnel_count')

      self.tunnel_count = attributes[:'tunnel_count'] if attributes[:'tunnel_count']
    end
    ...
    def hash
      [compartment_id, cpe_id, defined_tags, display_name, drg_id, freeform_tags, cpe_local_identifier, cpe_local_identifier_type, static_routes, tunnel_configuration, tunnel_count].hash
    end
