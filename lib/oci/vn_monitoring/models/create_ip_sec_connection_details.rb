...
module OCI
  ...
  class VnMonitoring::Models::CreateIPSecConnectionDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the IPSec connection.
    # @return [String]
