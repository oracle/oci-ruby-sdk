...
module OCI
  ...
  #
  class VnMonitoring::Models::DrgAttachment
    ...
    # @return [OCI::VnMonitoring::Models::DrgAttachmentNetworkDetails]
    ...
    # @option attributes [OCI::VnMonitoring::Models::DrgAttachmentNetworkDetails] :network_details The value to assign to the {#network_details} property
    ...
    def hash
      [compartment_id, display_name, drg_id, id, lifecycle_state, time_created, drg_route_table_id, network_details, defined_tags, freeform_tags, vcn_id, export_drg_route_distribution_id, is_cross_tenancy].hash
    end
