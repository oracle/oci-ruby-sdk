...
module OCI
  ...
  class VnMonitoring::Models::DrgAttachmentNetworkCreateDetails
    TYPE_ENUM = [
      TYPE_VCN = 'VCN'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::VnMonitoring::Models::VcnDrgAttachmentNetworkCreateDetails' if type == 'VCN'

      # TODO: Log a warning when the subtype is not found.
      'OCI::VnMonitoring::Models::DrgAttachmentNetworkCreateDetails'
    end
