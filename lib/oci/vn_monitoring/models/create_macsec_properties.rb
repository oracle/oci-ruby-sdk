...
module OCI
  ...
  class VnMonitoring::Models::CreateMacsecProperties
    STATE_ENUM = [
    ...
    # @return [OCI::VnMonitoring::Models::CreateMacsecKey]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'state': :'String',
        'primary_key': :'OCI::VnMonitoring::Models::CreateMacsecKey',
    ...
    # @option attributes [OCI::VnMonitoring::Models::CreateMacsecKey] :primary_key The value to assign to the {#primary_key} property
