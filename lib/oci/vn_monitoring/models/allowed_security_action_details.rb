...
module OCI
  ...
  #
  class VnMonitoring::Models::AllowedSecurityActionDetails
    # **[Required]** If true, the allowed security configuration details are incomplete.
    # @return [BOOLEAN]
    attr_accessor :is_restricted_or_partial

    # @return [OCI::VnMonitoring::Models::AllowedSecurityConfiguration]
    attr_accessor :allowed_security_configuration
    ...
    def self.swagger_types
      {
        ...
        'allowed_security_configuration': :'OCI::VnMonitoring::Models::AllowedSecurityConfiguration'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::AllowedSecurityConfiguration] :allowed_security_configuration The value to assign to the {#allowed_security_configuration} property
    def initialize(attributes = {})
      ...
      self.allowed_security_configuration = attributes[:'allowedSecurityConfiguration'] if attributes[:'allowedSecurityConfiguration']

      raise 'You cannot provide both :allowedSecurityConfiguration and :allowed_security_configuration' if attributes.key?(:'allowedSecurityConfiguration') && attributes.key?(:'allowed_security_configuration')

      self.allowed_security_configuration = attributes[:'allowed_security_configuration'] if attributes[:'allowed_security_configuration']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        allowed_security_configuration == other.allowed_security_configuration
    end
    ...
    def hash
      [is_restricted_or_partial, allowed_security_configuration].hash
    end
