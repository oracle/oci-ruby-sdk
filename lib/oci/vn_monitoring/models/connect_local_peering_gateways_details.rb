...
module OCI
  ...
  class VnMonitoring::Models::ConnectLocalPeeringGatewaysDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the LPG you want to peer with.
    # @return [String]
