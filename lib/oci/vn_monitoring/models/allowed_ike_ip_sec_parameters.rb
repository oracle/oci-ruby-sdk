...
module OCI
  ...
  class VnMonitoring::Models::AllowedIkeIPSecParameters
    # This attribute is required.
    # @return [OCI::VnMonitoring::Models::AllowedPhaseOneParameters]
    attr_accessor :allowed_phase_one_parameters

    # This attribute is required.
    # @return [OCI::VnMonitoring::Models::AllowedPhaseTwoParameters]
    attr_accessor :allowed_phase_two_parameters

    # This attribute is required.
    # @return [OCI::VnMonitoring::Models::DefaultPhaseOneParameters]
    attr_accessor :default_phase_one_parameters

    # This attribute is required.
    # @return [OCI::VnMonitoring::Models::DefaultPhaseTwoParameters]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'allowed_phase_one_parameters': :'OCI::VnMonitoring::Models::AllowedPhaseOneParameters',
        'allowed_phase_two_parameters': :'OCI::VnMonitoring::Models::AllowedPhaseTwoParameters',
        'default_phase_one_parameters': :'OCI::VnMonitoring::Models::DefaultPhaseOneParameters',
        'default_phase_two_parameters': :'OCI::VnMonitoring::Models::DefaultPhaseTwoParameters'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::AllowedPhaseOneParameters] :allowed_phase_one_parameters The value to assign to the {#allowed_phase_one_parameters} property
    # @option attributes [OCI::VnMonitoring::Models::AllowedPhaseTwoParameters] :allowed_phase_two_parameters The value to assign to the {#allowed_phase_two_parameters} property
    # @option attributes [OCI::VnMonitoring::Models::DefaultPhaseOneParameters] :default_phase_one_parameters The value to assign to the {#default_phase_one_parameters} property
    # @option attributes [OCI::VnMonitoring::Models::DefaultPhaseTwoParameters] :default_phase_two_parameters The value to assign to the {#default_phase_two_parameters} property
