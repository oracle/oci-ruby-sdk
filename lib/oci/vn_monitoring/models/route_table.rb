...
module OCI
  ...
  #
  class VnMonitoring::Models::RouteTable
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the route table.
    # @return [String]
    ...
    # **[Required]** The route table's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
    # @return [String]
    attr_accessor :id
    ...
    #
    # @return [Array<OCI::VnMonitoring::Models::RouteRule>]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the route table list belongs to.
    # @return [String]
    ...
    def self.swagger_types
      {
        ...
        'route_rules': :'Array<OCI::VnMonitoring::Models::RouteRule>',
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::RouteRule>] :route_rules The value to assign to the {#route_rules} property
