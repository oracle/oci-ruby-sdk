...
module OCI
  ...
  class VnMonitoring::Models::IPSecConnectionDeviceStatus
    ...
    # @return [Array<OCI::VnMonitoring::Models::TunnelStatus>]
    ...
    def self.swagger_types
      {
        ...
        'tunnels': :'Array<OCI::VnMonitoring::Models::TunnelStatus>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::TunnelStatus>] :tunnels The value to assign to the {#tunnels} property
    def initialize(attributes = {})
      ...
      self.tunnels = attributes[:'tunnels'] if attributes[:'tunnels']
    end
