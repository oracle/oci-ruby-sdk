...
module OCI
  ...
  #
  class VnMonitoring::Models::IPSecConnectionTunnel
    STATUS_ENUM = [
      STATUS_UP = 'UP'.freeze,
    ...
    # @return [OCI::VnMonitoring::Models::BgpSessionInfo]
    attr_accessor :bgp_session_info

    # @return [OCI::VnMonitoring::Models::EncryptionDomainConfig]
    ...
    # @return [OCI::VnMonitoring::Models::TunnelPhaseOneDetails]
    attr_accessor :phase_one_details

    # @return [OCI::VnMonitoring::Models::TunnelPhaseTwoDetails]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'bgp_session_info': :'OCI::VnMonitoring::Models::BgpSessionInfo',
        'encryption_domain_config': :'OCI::VnMonitoring::Models::EncryptionDomainConfig',
        'routing': :'String',
        ...
        'phase_one_details': :'OCI::VnMonitoring::Models::TunnelPhaseOneDetails',
        'phase_two_details': :'OCI::VnMonitoring::Models::TunnelPhaseTwoDetails',
    ...
    # @option attributes [OCI::VnMonitoring::Models::BgpSessionInfo] :bgp_session_info The value to assign to the {#bgp_session_info} property
    # @option attributes [OCI::VnMonitoring::Models::EncryptionDomainConfig] :encryption_domain_config The value to assign to the {#encryption_domain_config} property
    ...
    # @option attributes [OCI::VnMonitoring::Models::TunnelPhaseOneDetails] :phase_one_details The value to assign to the {#phase_one_details} property
    # @option attributes [OCI::VnMonitoring::Models::TunnelPhaseTwoDetails] :phase_two_details The value to assign to the {#phase_two_details} property
