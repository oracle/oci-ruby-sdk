...
module OCI
  ...
  class VnMonitoring::Models::CreateServiceGatewayDetails
    # **[Required]** The [OCID] (https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment to contain the service gateway.
    #
    # @return [String]
    ...
    # {RouteTable}.
    #
    # @return [Array<OCI::VnMonitoring::Models::ServiceIdRequestDetails>]
    attr_accessor :services

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
    #
    # @return [String]
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::ServiceIdRequestDetails>] :services The value to assign to the {#services} property
