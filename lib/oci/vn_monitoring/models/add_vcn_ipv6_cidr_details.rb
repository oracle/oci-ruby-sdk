...
module OCI
  ...
  class VnMonitoring::Models::AddVcnIpv6CidrDetails
    ...
    # @return [OCI::VnMonitoring::Models::Byoipv6CidrDetails]
    ...
    def self.swagger_types
      {
        ...
        'byoipv6_cidr_detail': :'OCI::VnMonitoring::Models::Byoipv6CidrDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::Byoipv6CidrDetails] :byoipv6_cidr_detail The value to assign to the {#byoipv6_cidr_detail} property
