...
module OCI
  ...
  class VnMonitoring::Models::BulkDeleteVirtualCircuitPublicPrefixesDetails
    # **[Required]** The public IP prefixes (CIDRs) to remove from the public virtual circuit.
    #
    # @return [Array<OCI::VnMonitoring::Models::DeleteVirtualCircuitPublicPrefixDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'public_prefixes': :'Array<OCI::VnMonitoring::Models::DeleteVirtualCircuitPublicPrefixDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::DeleteVirtualCircuitPublicPrefixDetails>] :public_prefixes The value to assign to the {#public_prefixes} property
