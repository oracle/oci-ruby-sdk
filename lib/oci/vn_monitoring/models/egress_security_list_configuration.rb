...
module OCI
  ...
  #
  class VnMonitoring::Models::EgressSecurityListConfiguration < VnMonitoring::Models::AllowedSecurityConfiguration
    ...
    # @return [OCI::VnMonitoring::Models::EgressSecurityRule]
    ...
    # @option attributes [OCI::VnMonitoring::Models::EgressSecurityRule] :security_rule The value to assign to the {#security_rule} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'EGRESS_SECURITY_LIST'
