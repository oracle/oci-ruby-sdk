...
module OCI
  ...
  #
  class VnMonitoring::Models::TopologyRoutesToEntityRelationship < VnMonitoring::Models::TopologyEntityRelationship
    # This attribute is required.
    # @return [OCI::VnMonitoring::Models::TopologyRoutesToRelationshipDetails]
    attr_accessor :route_rule_details
    ...
    # @option attributes [OCI::VnMonitoring::Models::TopologyRoutesToRelationshipDetails] :route_rule_details The value to assign to the {#route_rule_details} property
