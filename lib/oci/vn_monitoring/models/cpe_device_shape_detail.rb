...
module OCI
  ...
  #
  class VnMonitoring::Models::CpeDeviceShapeDetail
    ...
    # @return [OCI::VnMonitoring::Models::CpeDeviceInfo]
    ...
    #
    # @return [Array<OCI::VnMonitoring::Models::CpeDeviceConfigQuestion>]
    ...
    def self.swagger_types
      {
        ...
        'cpe_device_info': :'OCI::VnMonitoring::Models::CpeDeviceInfo',
        'parameters': :'Array<OCI::VnMonitoring::Models::CpeDeviceConfigQuestion>',
        'template': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::CpeDeviceInfo] :cpe_device_info The value to assign to the {#cpe_device_info} property
    # @option attributes [Array<OCI::VnMonitoring::Models::CpeDeviceConfigQuestion>] :parameters The value to assign to the {#parameters} property
