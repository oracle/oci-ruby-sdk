...
module OCI
  ...
  #
  class VnMonitoring::Models::DhcpOptions
    ...
    # @return [Array<OCI::VnMonitoring::Models::DhcpOption>]
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::DhcpOption>] :options The value to assign to the {#options} property
