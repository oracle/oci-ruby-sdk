...
module OCI
  ...
  class VnMonitoring::Models::DhcpOption
    # **[Required]** The specific DHCP option. Either `DomainNameServer`
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::VnMonitoring::Models::DhcpDnsOption' if type == 'DomainNameServer'
      return 'OCI::VnMonitoring::Models::DhcpSearchDomainOption' if type == 'SearchDomain'

      # TODO: Log a warning when the subtype is not found.
      'OCI::VnMonitoring::Models::DhcpOption'
    end
