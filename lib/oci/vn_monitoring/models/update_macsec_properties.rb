...
module OCI
  ...
  class VnMonitoring::Models::UpdateMacsecProperties
    STATE_ENUM = [
    ...
    # @return [OCI::VnMonitoring::Models::UpdateMacsecKey]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'state': :'String',
        'primary_key': :'OCI::VnMonitoring::Models::UpdateMacsecKey',
    ...
    # @option attributes [OCI::VnMonitoring::Models::UpdateMacsecKey] :primary_key The value to assign to the {#primary_key} property
