...
module OCI
  ...
  class VnMonitoring::Models::ByoipRangeSummary
    # A list of `ByoipRangeVcnIpv6AllocationSummary` objects.
    #
    # @return [Array<OCI::VnMonitoring::Models::ByoipRangeVcnIpv6AllocationSummary>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'byoip_range_vcn_ipv6_allocations': :'Array<OCI::VnMonitoring::Models::ByoipRangeVcnIpv6AllocationSummary>',
        'cidr_block': :'String',
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::ByoipRangeVcnIpv6AllocationSummary>] :byoip_range_vcn_ipv6_allocations The value to assign to the {#byoip_range_vcn_ipv6_allocations} property
