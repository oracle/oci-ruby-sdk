...
module OCI
  ...
  class VnMonitoring::Models::CreatePathAnalyzerTestDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the `PathAnalyzerTest` resource's compartment.
    # @return [String]
