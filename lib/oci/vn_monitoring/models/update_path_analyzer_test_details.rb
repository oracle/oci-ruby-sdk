...
module OCI
  ...
  class VnMonitoring::Models::UpdatePathAnalyzerTestDetails
    ...
    def hash
      [display_name, protocol, source_endpoint, destination_endpoint, protocol_parameters, query_options, freeform_tags, defined_tags].hash
    end
