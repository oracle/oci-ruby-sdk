...
module OCI
  ...
  class VnMonitoring::Models::DrgRouteDistributionMatchCriteria
    MATCH_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'matchType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::VnMonitoring::Models::DrgAttachmentIdDrgRouteDistributionMatchCriteria' if type == 'DRG_ATTACHMENT_ID'
      return 'OCI::VnMonitoring::Models::DrgAttachmentTypeDrgRouteDistributionMatchCriteria' if type == 'DRG_ATTACHMENT_TYPE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::VnMonitoring::Models::DrgRouteDistributionMatchCriteria'
    end
    ...
    def match_type=(match_type)
      ...
      if match_type && !MATCH_TYPE_ENUM.include?(match_type)
        OCI.logger.debug("Unknown value for 'match_type' [" + match_type + "]. Mapping to 'MATCH_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
