...
module OCI
  ...
  class VnMonitoring::Models::IPSecConnectionDeviceConfig
    ...
    # @return [Array<OCI::VnMonitoring::Models::TunnelConfig>]
    ...
    def self.swagger_types
      {
        ...
        'tunnels': :'Array<OCI::VnMonitoring::Models::TunnelConfig>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::TunnelConfig>] :tunnels The value to assign to the {#tunnels} property
