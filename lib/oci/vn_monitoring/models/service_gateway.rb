...
module OCI
  ...
  #
  class VnMonitoring::Models::ServiceGateway
    ...
    #
    # @return [Array<OCI::VnMonitoring::Models::ServiceIdResponseDetails>]
    ...
    def self.swagger_types
      {
        ...
        'services': :'Array<OCI::VnMonitoring::Models::ServiceIdResponseDetails>',
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::ServiceIdResponseDetails>] :services The value to assign to the {#services} property
