...
module OCI
  ...
  #
  class VnMonitoring::Models::DeniedSecurityActionDetails
    ...
    #
    # @return [Array<String>]
    attr_accessor :evaluated_security_list_ids
    ...
    #
    # @return [Array<String>]
    attr_accessor :evaluated_nsg_ids
    ...
    def self.swagger_types
      {
        ...
        'evaluated_security_list_ids': :'Array<String>',
        'evaluated_nsg_ids': :'Array<String>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<String>] :evaluated_security_list_ids The value to assign to the {#evaluated_security_list_ids} property
    # @option attributes [Array<String>] :evaluated_nsg_ids The value to assign to the {#evaluated_nsg_ids} property
    def initialize(attributes = {})
      ...
      self.evaluated_security_list_ids = attributes[:'evaluatedSecurityListIds'] if attributes[:'evaluatedSecurityListIds']

      raise 'You cannot provide both :evaluatedSecurityListIds and :evaluated_security_list_ids' if attributes.key?(:'evaluatedSecurityListIds') && attributes.key?(:'evaluated_security_list_ids')

      self.evaluated_security_list_ids = attributes[:'evaluated_security_list_ids'] if attributes[:'evaluated_security_list_ids']

      self.evaluated_nsg_ids = attributes[:'evaluatedNsgIds'] if attributes[:'evaluatedNsgIds']

      raise 'You cannot provide both :evaluatedNsgIds and :evaluated_nsg_ids' if attributes.key?(:'evaluatedNsgIds') && attributes.key?(:'evaluated_nsg_ids')

      self.evaluated_nsg_ids = attributes[:'evaluated_nsg_ids'] if attributes[:'evaluated_nsg_ids']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        evaluated_security_list_ids == other.evaluated_security_list_ids &&
        evaluated_nsg_ids == other.evaluated_nsg_ids
    end
    ...
    def hash
      [is_restricted_or_partial, evaluated_security_list_ids, evaluated_nsg_ids].hash
    end
