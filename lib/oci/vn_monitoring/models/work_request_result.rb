...
module OCI
  ...
  class VnMonitoring::Models::WorkRequestResult
    RESULT_TYPE_ENUM = [
      RESULT_TYPE_PATH_ANALYSIS = 'PATH_ANALYSIS'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'resultType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::VnMonitoring::Models::PathAnalysisWorkRequestResult' if type == 'PATH_ANALYSIS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::VnMonitoring::Models::WorkRequestResult'
    end
