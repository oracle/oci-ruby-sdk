...
module OCI
  ...
  class VnMonitoring::Models::UpdateDrgDetails
    ...
    # @return [OCI::VnMonitoring::Models::DefaultDrgRouteTables]
    ...
    # @option attributes [OCI::VnMonitoring::Models::DefaultDrgRouteTables] :default_drg_route_tables The value to assign to the {#default_drg_route_tables} property
