...
module OCI
  ...
  class VnMonitoring::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_PATH_ANALYSIS_RESULT = 'CREATE_PATH_ANALYSIS_RESULT'.freeze,
    ...
    # @return [Array<OCI::VnMonitoring::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'id': :'String',
        'resources': :'Array<OCI::VnMonitoring::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [operation_type, compartment_id, id, resources, percent_complete, status, time_accepted, time_started, time_finished].hash
    end
