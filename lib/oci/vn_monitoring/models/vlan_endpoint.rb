...
module OCI
  ...
  class VnMonitoring::Models::VlanEndpoint < VnMonitoring::Models::Endpoint
    # **[Required]** The IPv4 address of the `Endpoint`.
    # @return [String]
    attr_accessor :address

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the VLAN containing the IP address.
