...
module OCI
  ...
  #
  class VnMonitoring::Models::SecurityList
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the security list.
    # @return [String]
    ...
    # @return [Array<OCI::VnMonitoring::Models::EgressSecurityRule>]
    ...
    # **[Required]** The security list's Oracle Cloud ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
    # @return [String]
    attr_accessor :id

    # **[Required]** Rules for allowing ingress IP packets.
    # @return [Array<OCI::VnMonitoring::Models::IngressSecurityRule>]
    ...
    # **[Required]** The date and time the security list was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::EgressSecurityRule>] :egress_security_rules The value to assign to the {#egress_security_rules} property
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {#freeform_tags} property
    # @option attributes [String] :id The value to assign to the {#id} property
    # @option attributes [Array<OCI::VnMonitoring::Models::IngressSecurityRule>] :ingress_security_rules The value to assign to the {#ingress_security_rules} property
    ...
    def initialize(attributes = {})
      ...
      self.egress_security_rules = attributes[:'egressSecurityRules'] if attributes[:'egressSecurityRules']
      ...
      self.egress_security_rules = attributes[:'egress_security_rules'] if attributes[:'egress_security_rules']
      ...
      self.ingress_security_rules = attributes[:'ingressSecurityRules'] if attributes[:'ingressSecurityRules']
      ...
      self.ingress_security_rules = attributes[:'ingress_security_rules'] if attributes[:'ingress_security_rules']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        egress_security_rules == other.egress_security_rules &&
        freeform_tags == other.freeform_tags &&
        id == other.id &&
        ingress_security_rules == other.ingress_security_rules &&
