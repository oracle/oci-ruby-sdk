...
module OCI
  ...
  #
  class VnMonitoring::Models::ForwardedRoutingActionDetails
    # **[Required]** If true, the forwarded routing configuration details are incomplete.
    # @return [BOOLEAN]
    attr_accessor :is_restricted_or_partial

    # @return [OCI::VnMonitoring::Models::ForwardedRoutingConfiguration]
    attr_accessor :forwarded_routing_configuration
    ...
    def self.swagger_types
      {
        ...
        'forwarded_routing_configuration': :'OCI::VnMonitoring::Models::ForwardedRoutingConfiguration'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::ForwardedRoutingConfiguration] :forwarded_routing_configuration The value to assign to the {#forwarded_routing_configuration} property
    def initialize(attributes = {})
      ...
      self.forwarded_routing_configuration = attributes[:'forwardedRoutingConfiguration'] if attributes[:'forwardedRoutingConfiguration']

      raise 'You cannot provide both :forwardedRoutingConfiguration and :forwarded_routing_configuration' if attributes.key?(:'forwardedRoutingConfiguration') && attributes.key?(:'forwarded_routing_configuration')

      self.forwarded_routing_configuration = attributes[:'forwarded_routing_configuration'] if attributes[:'forwarded_routing_configuration']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        forwarded_routing_configuration == other.forwarded_routing_configuration
    end
    ...
    def hash
      [is_restricted_or_partial, forwarded_routing_configuration].hash
    end
