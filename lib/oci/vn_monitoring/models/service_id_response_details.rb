...
module OCI
  ...
  class VnMonitoring::Models::ServiceIdResponseDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the service.
    #
    # @return [String]
