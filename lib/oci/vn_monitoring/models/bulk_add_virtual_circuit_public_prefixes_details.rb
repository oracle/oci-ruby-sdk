...
module OCI
  ...
  class VnMonitoring::Models::BulkAddVirtualCircuitPublicPrefixesDetails
    # **[Required]** The public IP prefixes (CIDRs) to add to the public virtual circuit.
    # @return [Array<OCI::VnMonitoring::Models::CreateVirtualCircuitPublicPrefixDetails>]
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::CreateVirtualCircuitPublicPrefixDetails>] :public_prefixes The value to assign to the {#public_prefixes} property
