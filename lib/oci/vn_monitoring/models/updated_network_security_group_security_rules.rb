...
module OCI
  ...
  class VnMonitoring::Models::UpdatedNetworkSecurityGroupSecurityRules
    # The NSG security rules that were updated.
    # @return [Array<OCI::VnMonitoring::Models::SecurityRule>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'security_rules': :'Array<OCI::VnMonitoring::Models::SecurityRule>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::SecurityRule>] :security_rules The value to assign to the {#security_rules} property
