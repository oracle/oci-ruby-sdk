...
module OCI
  ...
  #
  class VnMonitoring::Models::AddDrgRouteRulesDetails
    # The collection of static rules used to insert routes into the DRG route table.
    #
    # @return [Array<OCI::VnMonitoring::Models::AddDrgRouteRuleDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'route_rules': :'Array<OCI::VnMonitoring::Models::AddDrgRouteRuleDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::AddDrgRouteRuleDetails>] :route_rules The value to assign to the {#route_rules} property
