...
module OCI
  ...
  class VnMonitoring::Models::AddNetworkSecurityGroupSecurityRulesDetails
    # The NSG security rules to add.
    # @return [Array<OCI::VnMonitoring::Models::AddSecurityRuleDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'security_rules': :'Array<OCI::VnMonitoring::Models::AddSecurityRuleDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::AddSecurityRuleDetails>] :security_rules The value to assign to the {#security_rules} property
