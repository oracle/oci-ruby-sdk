...
module OCI
  ...
  #
  class VnMonitoring::Models::CreateCaptureFilterDetails
    FILTER_TYPE_ENUM = [
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, filter_type, vtap_capture_filter_rules, flow_log_capture_filter_rules].hash
    end
