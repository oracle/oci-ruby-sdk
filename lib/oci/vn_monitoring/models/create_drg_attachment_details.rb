...
module OCI
  ...
  class VnMonitoring::Models::CreateDrgAttachmentDetails
    ...
    # @return [OCI::VnMonitoring::Models::DrgAttachmentNetworkCreateDetails]
    ...
    # @option attributes [OCI::VnMonitoring::Models::DrgAttachmentNetworkCreateDetails] :network_details The value to assign to the {#network_details} property
    ...
    def hash
      [display_name, drg_id, drg_route_table_id, network_details, defined_tags, freeform_tags, vcn_id].hash
    end
