...
module OCI
  ...
  #
  class VnMonitoring::Models::DrgAttachmentTypeDrgRouteDistributionMatchCriteria < VnMonitoring::Models::DrgRouteDistributionMatchCriteria
    ...
    # **[Required]** The type of the network resource to be included in this match. A match for a network type implies that all
