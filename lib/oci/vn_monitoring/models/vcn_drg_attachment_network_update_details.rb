...
require 'date'
require_relative 'drg_attachment_network_update_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Specifies the update details for the VCN attachment.
  class VnMonitoring::Models::VcnDrgAttachmentNetworkUpdateDetails < VnMonitoring::Models::DrgAttachmentNetworkUpdateDetails
