...
module OCI
  ...
  class VnMonitoring::Models::CreateCrossConnectGroupDetails
    ...
    # @return [OCI::VnMonitoring::Models::CreateMacsecProperties]
    ...
    # @option attributes [OCI::VnMonitoring::Models::CreateMacsecProperties] :macsec_properties The value to assign to the {#macsec_properties} property
