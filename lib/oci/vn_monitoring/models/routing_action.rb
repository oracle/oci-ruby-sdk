...
module OCI
  ...
  class VnMonitoring::Models::RoutingAction
    ACTION_ENUM = [
      ACTION_FORWARDED = 'FORWARDED'.freeze,
      ACTION_NO_ROUTE = 'NO_ROUTE'.freeze,
      ACTION_INDETERMINATE = 'INDETERMINATE'.freeze,
    ...
    ACTION_TYPE_ENUM = [
      ...
      ACTION_TYPE_NOT_SUPPORTED = 'NOT_SUPPORTED'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::VnMonitoring::Models::NoRouteRoutingAction' if type == 'NO_ROUTE'
      return 'OCI::VnMonitoring::Models::IndeterminateRoutingAction' if type == 'INDETERMINATE'
      return 'OCI::VnMonitoring::Models::ForwardedRoutingAction' if type == 'FORWARDED'

      # TODO: Log a warning when the subtype is not found.
      'OCI::VnMonitoring::Models::RoutingAction'
    end
