...
module OCI
  ...
  class VnMonitoring::Models::LoopBackDrgAttachmentNetworkDetails < VnMonitoring::Models::DrgAttachmentNetworkDetails
    ...
    # @option attributes [Array<String>] :ids The value to assign to the {#ids} property
    def initialize(attributes = {})
      ...
      self.ids = attributes[:'ids'] if attributes[:'ids']
    end
