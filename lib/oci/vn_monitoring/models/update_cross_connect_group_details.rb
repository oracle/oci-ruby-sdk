...
module OCI
  ...
  class VnMonitoring::Models::UpdateCrossConnectGroupDetails
    ...
    # @return [OCI::VnMonitoring::Models::UpdateMacsecProperties]
    ...
    def self.swagger_types
      {
        ...
        'macsec_properties': :'OCI::VnMonitoring::Models::UpdateMacsecProperties'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VnMonitoring::Models::UpdateMacsecProperties] :macsec_properties The value to assign to the {#macsec_properties} property
