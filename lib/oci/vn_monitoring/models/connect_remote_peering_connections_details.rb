...
module OCI
  ...
  class VnMonitoring::Models::ConnectRemotePeeringConnectionsDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the RPC you want to peer with.
    # @return [String]
