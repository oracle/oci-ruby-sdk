...
module OCI
  ...
  class VnMonitoring::Models::UpdateNetworkSecurityGroupSecurityRulesDetails
    # The NSG security rules to update.
    # @return [Array<OCI::VnMonitoring::Models::UpdateSecurityRuleDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'security_rules': :'Array<OCI::VnMonitoring::Models::UpdateSecurityRuleDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::UpdateSecurityRuleDetails>] :security_rules The value to assign to the {#security_rules} property
