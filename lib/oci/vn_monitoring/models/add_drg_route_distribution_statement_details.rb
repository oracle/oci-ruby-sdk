...
module OCI
  ...
  #
  class VnMonitoring::Models::AddDrgRouteDistributionStatementDetails
    ACTION_ENUM = [
    ...
    #
    # @return [Array<OCI::VnMonitoring::Models::DrgRouteDistributionMatchCriteria>]
    ...
    # **[Required]** This field is used to specify the priority of each statement in a route distribution.
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'match_criteria': :'Array<OCI::VnMonitoring::Models::DrgRouteDistributionMatchCriteria>',
        'action': :'String',
        'priority': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    ...
    # @option attributes [Array<OCI::VnMonitoring::Models::DrgRouteDistributionMatchCriteria>] :match_criteria The value to assign to the {#match_criteria} property
