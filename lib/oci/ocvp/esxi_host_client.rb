...
module OCI
  ...
  class Ocvp::EsxiHostClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/ocvp/inplace_upgrade.rb.html) to see an example of how to use inplace_upgrade API.
    def inplace_upgrade(esxi_host_id, opts = {})
      logger.debug 'Calling operation EsxiHostClient#inplace_upgrade.' if logger

      raise "Missing the required parameter 'esxi_host_id' when calling inplace_upgrade." if esxi_host_id.nil?
      raise "Parameter value for 'esxi_host_id' must not be blank" if OCI::Internal::Util.blank_string?(esxi_host_id)

      path = '/esxiHosts/{esxiHostId}/actions/inplaceUpgrade'.sub('{esxiHostId}', esxi_host_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EsxiHostClient#inplace_upgrade') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @option opts [String] :cluster_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Cluster.
    #
    ...
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    # @param [OCI::Ocvp::Models::ReplaceHostDetails] replace_host_details The details for replacing ESXi host
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/ocvp/replace_host.rb.html) to see an example of how to use replace_host API.
    def replace_host(esxi_host_id, replace_host_details, opts = {})
      logger.debug 'Calling operation EsxiHostClient#replace_host.' if logger

      raise "Missing the required parameter 'esxi_host_id' when calling replace_host." if esxi_host_id.nil?
      raise "Missing the required parameter 'replace_host_details' when calling replace_host." if replace_host_details.nil?
      raise "Parameter value for 'esxi_host_id' must not be blank" if OCI::Internal::Util.blank_string?(esxi_host_id)

      path = '/esxiHosts/{esxiHostId}/actions/replaceHost'.sub('{esxiHostId}', esxi_host_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(replace_host_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EsxiHostClient#replace_host') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
