...
module OCI
  ...
  class Ocvp::EsxiHostClientCompositeOperations
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#inplace_upgrade} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#inplace_upgrade}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#replace_host} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#replace_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#swap_billing} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#swap_billing}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
