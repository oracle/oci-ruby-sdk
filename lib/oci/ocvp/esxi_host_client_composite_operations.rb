...
module OCI
  # This class provides a wrapper around {OCI::Ocvp::EsxiHostClient} and offers convenience methods
  # for operations that would otherwise need to be chained together. For example, instead of performing an action
  # on a resource (e.g. launching an instance, creating a load balancer) and then using a waiter to wait for the resource
  # to enter a given state, you can call a single method in this class to accomplish the same functionality
  class Ocvp::EsxiHostClientCompositeOperations
    # The {OCI::Ocvp::EsxiHostClient} used to communicate with the service_client
    #
    # @return [OCI::Ocvp::EsxiHostClient]
    attr_reader :service_client

    # Initializes a new EsxiHostClientCompositeOperations
    #
    # @param [OCI::Ocvp::EsxiHostClient] service_client The client used to communicate with the service.
    #   Defaults to a new service client created via {OCI::Ocvp::EsxiHostClient#initialize} with no arguments
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#create_esxi_host} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#create_esxi_host}
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#delete_esxi_host} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#delete_esxi_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Ocvp::EsxiHostClient#update_esxi_host} and then waits for the {OCI::Ocvp::Models::EsxiHost} acted upon
    # to enter the given state(s).
    #
    # @param [String] esxi_host_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host.
    #
    # @param [OCI::Ocvp::Models::UpdateEsxiHostDetails] update_esxi_host_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::EsxiHost#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::EsxiHostClient#update_esxi_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Ocvp::Models::EsxiHost}
