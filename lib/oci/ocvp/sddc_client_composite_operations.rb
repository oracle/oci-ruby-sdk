...
module OCI
  ...
  class Ocvp::SddcClientCompositeOperations
    ...
    # Calls {OCI::Ocvp::SddcClient#cancel_downgrade_hcx} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::SddcClient#cancel_downgrade_hcx}
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::SddcClient#downgrade_hcx}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Ocvp::SddcClient#refresh_hcx_license_status} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sddc_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the SDDC.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::SddcClient#refresh_hcx_license_status}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Ocvp::SddcClient#upgrade_hcx} and then waits for the {OCI::Ocvp::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sddc_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the SDDC.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Ocvp::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Ocvp::SddcClient#upgrade_hcx}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
