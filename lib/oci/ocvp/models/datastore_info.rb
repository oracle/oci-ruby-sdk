...
module OCI
  ...
  class Ocvp::Models::DatastoreInfo
    ...
    def datastore_type=(datastore_type)
      raise "Invalid value for 'datastore_type': this must be one of the values in DATASTORE_TYPE_ENUM." if datastore_type && !DATASTORE_TYPE_ENUM.include?(datastore_type)
