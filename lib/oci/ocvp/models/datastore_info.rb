...
module OCI
  ...
  #
  class Ocvp::Models::DatastoreInfo
    DATASTORE_TYPE_ENUM = [
    ...
    # @option attributes [String] :datastore_type The value to assign to the {#datastore_type} property
    ...
    # @param [Object] datastore_type Object to be assigned
    def datastore_type=(datastore_type)
      # rubocop:disable Style/ConditionalAssignment
      if datastore_type && !DATASTORE_TYPE_ENUM.include?(datastore_type)
        OCI.logger.debug("Unknown value for 'datastore_type' [" + datastore_type + "]. Mapping to 'DATASTORE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @datastore_type = DATASTORE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [block_volume_ids, datastore_type].hash
    end
