...
module OCI
  ...
  #
  class Ocvp::Models::HcxLicenseSummary
    STATUS_ENUM = [
      STATUS_AVAILABLE = 'AVAILABLE'.freeze,
      STATUS_CONSUMED = 'CONSUMED'.freeze,
      STATUS_DEACTIVATED = 'DEACTIVATED'.freeze,
    ...
    # @option attributes [String] :activation_key The value to assign to the {#activation_key} property
    ...
    def initialize(attributes = {})
      ...
      self.activation_key = attributes[:'activationKey'] if attributes[:'activationKey']

      raise 'You cannot provide both :activationKey and :activation_key' if attributes.key?(:'activationKey') && attributes.key?(:'activation_key')

      self.activation_key = attributes[:'activation_key'] if attributes[:'activation_key']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        activation_key == other.activation_key &&
        status == other.status &&
    ...
    def hash
      [activation_key, status, system_name].hash
    end
