...
module OCI
  ...
  #
  class Ocvp::Models::UpdateClusterDetails
    ...
    def hash
      [display_name, network_configuration, vmware_software_version, esxi_software_version, freeform_tags, defined_tags].hash
    end
