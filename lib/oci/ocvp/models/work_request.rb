...
module OCI
  ...
  class Ocvp::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_SDDC = 'CREATE_SDDC'.freeze,
      OPERATION_TYPE_DELETE_SDDC = 'DELETE_SDDC'.freeze,
      OPERATION_TYPE_CREATE_ESXI_HOST = 'CREATE_ESXI_HOST'.freeze,
      OPERATION_TYPE_DELETE_ESXI_HOST = 'DELETE_ESXI_HOST'.freeze,
      OPERATION_TYPE_UPGRADE_HCX = 'UPGRADE_HCX'.freeze,
      OPERATION_TYPE_DOWNGRADE_HCX = 'DOWNGRADE_HCX'.freeze,
      OPERATION_TYPE_CANCEL_DOWNGRADE_HCX = 'CANCEL_DOWNGRADE_HCX'.freeze,
      OPERATION_TYPE_REFRESH_HCX_LICENSE_STATUS = 'REFRESH_HCX_LICENSE_STATUS'.freeze,
    ...
    # @return [Array<OCI::Ocvp::Models::WorkRequestResource>]
    ...
    # **[Required]** The date and time the work request was created, in the format defined by
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Ocvp::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Ocvp::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
