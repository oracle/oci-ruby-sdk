...
module OCI
  ...
  class Ocvp::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_CLUSTER = 'CREATE_CLUSTER'.freeze,
      OPERATION_TYPE_DELETE_CLUSTER = 'DELETE_CLUSTER'.freeze,
      ...
      OPERATION_TYPE_SWAP_BILLING = 'SWAP_BILLING'.freeze,
      OPERATION_TYPE_REPLACE_HOST = 'REPLACE_HOST'.freeze,
      OPERATION_TYPE_IN_PLACE_UPGRADE = 'IN_PLACE_UPGRADE'.freeze,
