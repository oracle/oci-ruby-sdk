...
module OCI
  ...
  class Ocvp::Models::SupportedSkuSummaryCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Ocvp::Models::SupportedSkuSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Ocvp::Models::SupportedSkuSummary>] :items The value to assign to the {#items} property
