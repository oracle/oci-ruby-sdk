...
module OCI
  ...
  #
  class Ocvp::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** The way in which this resource was affected by the operation that spawned the
    # work request.
    #
    # @return [String]
    attr_reader :action_type

    # **[Required]** An [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) or other unique identifier
    # for the resource.
    #
    # @return [String]
