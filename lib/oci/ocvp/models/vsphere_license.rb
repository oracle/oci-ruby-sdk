...
module OCI
  ...
  #
  class Ocvp::Models::VsphereLicense
    ...
    # @option attributes [String] :license_key The value to assign to the {#license_key} property
    def initialize(attributes = {})
      ...
      self.license_key = attributes[:'licenseKey'] if attributes[:'licenseKey']

      raise 'You cannot provide both :licenseKey and :license_key' if attributes.key?(:'licenseKey') && attributes.key?(:'license_key')

      self.license_key = attributes[:'license_key'] if attributes[:'license_key']
    end
