...
module OCI
  ...
  class Ocvp::Models::SupportedHostShapeSummary
    ...
    # @return [BOOLEAN]
    attr_accessor :is_support_monthly_sku
    ...
    def self.swagger_types
      {
        ...
        'is_support_monthly_sku': :'BOOLEAN'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :is_support_monthly_sku The value to assign to the {#is_support_monthly_sku} property
    def initialize(attributes = {})
      ...
      self.is_support_monthly_sku = attributes[:'isSupportMonthlySku'] unless attributes[:'isSupportMonthlySku'].nil?
      self.is_support_monthly_sku = false if is_support_monthly_sku.nil? && !attributes.key?(:'isSupportMonthlySku') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isSupportMonthlySku and :is_support_monthly_sku' if attributes.key?(:'isSupportMonthlySku') && attributes.key?(:'is_support_monthly_sku')

      self.is_support_monthly_sku = attributes[:'is_support_monthly_sku'] unless attributes[:'is_support_monthly_sku'].nil?
      self.is_support_monthly_sku = false if is_support_monthly_sku.nil? && !attributes.key?(:'isSupportMonthlySku') && !attributes.key?(:'is_support_monthly_sku') # rubocop:disable Style/StringLiterals
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_support_monthly_sku == other.is_support_monthly_sku
    end
    ...
    def hash
      [name, supported_operations, shape_family, default_ocpu_count, supported_ocpu_count, supported_sddc_types, supported_vmware_software_versions, description, is_support_shielded_instances, is_support_monthly_sku].hash
    end
