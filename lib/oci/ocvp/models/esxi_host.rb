...
module OCI
  ...
  class Ocvp::Models::EsxiHost
    ...
    def hash
      [id, display_name, sddc_id, cluster_id, compartment_id, compute_instance_id, time_created, time_updated, lifecycle_state, billing_donor_host_id, swap_billing_host_id, is_billing_continuation_in_progress, is_billing_swapping_in_progress, current_commitment, next_commitment, billing_contract_end_date, failed_esxi_host_id, replacement_esxi_host_id, grace_period_end_date, vmware_software_version, esxi_software_version, non_upgraded_esxi_host_id, upgraded_replacement_esxi_host_id, compute_availability_domain, host_shape_name, host_ocpu_count, capacity_reservation_id, freeform_tags, defined_tags].hash
    end
