...
module OCI
  ...
  class Queue::Models::PutMessages
    # **[Required]** The messages that have been published to a queue.
    # @return [Array<OCI::Queue::Models::PutMessage>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'messages': :'Array<OCI::Queue::Models::PutMessage>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Queue::Models::PutMessage>] :messages The value to assign to the {#messages} property
