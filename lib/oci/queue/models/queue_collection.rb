...
module OCI
  ...
  class Queue::Models::QueueCollection
    # **[Required]** List of queues.
    # @return [Array<OCI::Queue::Models::QueueSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Queue::Models::QueueSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Queue::Models::QueueSummary>] :items The value to assign to the {#items} property
