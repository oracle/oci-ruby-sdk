...
module OCI
  ...
  class Queue::Models::MessageMetadata
    ...
    # @option attributes [Hash<String, String>] :custom_properties The value to assign to the {#custom_properties} property
    ...
    def hash
      [channel_id, custom_properties].hash
    end
