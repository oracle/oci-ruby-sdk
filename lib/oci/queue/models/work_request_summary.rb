...
module OCI
  ...
  class Queue::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the work request. Work requests should be scoped to
    ...
    # @return [Array<OCI::Queue::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Queue::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Queue::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
