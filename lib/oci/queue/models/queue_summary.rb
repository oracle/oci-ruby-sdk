...
module OCI
  ...
  class Queue::Models::QueueSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, messages_endpoint, freeform_tags, defined_tags, system_tags].hash
    end
