...
module OCI
  ...
  class Queue::Models::CreateQueueDetails
    ...
    def hash
      [display_name, compartment_id, retention_in_seconds, visibility_in_seconds, timeout_in_seconds, channel_consumption_limit, dead_letter_queue_delivery_count, custom_encryption_key_id, freeform_tags, defined_tags].hash
    end
