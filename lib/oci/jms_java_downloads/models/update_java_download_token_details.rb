...
module OCI
  ...
  class JmsJavaDownloads::Models::UpdateJavaDownloadTokenDetails
    ...
    def hash
      [display_name, description, is_default, time_expires, license_type, freeform_tags, defined_tags].hash
    end
