...
module OCI
  ...
  class JmsJavaDownloads::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the tenancy scoped to the work request.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The resources affected by this work request.
    # @return [Array<OCI::JmsJavaDownloads::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::JmsJavaDownloads::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::JmsJavaDownloads::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
