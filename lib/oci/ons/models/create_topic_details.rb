...
module OCI
  ...
  #
  class Ons::Models::CreateTopicDetails # rubocop:disable Metrics/LineLength
    # **[Required]** The name of the topic being created. Avoid entering confidential information.
    # @return [String]
    attr_accessor :name

    # **[Required]** The [OCID](https://docs.us-phoenix-1.oraclecloud.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the topic in.
    #
    # @return [String]
