...
module OCI
  ...
  #
  class Ons::Models::DeliveryPolicy # rubocop:disable Metrics/LineLength
    # @return [OCI::Ons::Models::BackoffRetryPolicy]
    attr_accessor :backoff_retry_policy
    ...
    # @option attributes [OCI::Ons::Models::BackoffRetryPolicy] :backoff_retry_policy The value to assign to the {#backoff_retry_policy} property
