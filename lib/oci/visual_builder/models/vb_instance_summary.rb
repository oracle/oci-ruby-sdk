...
module OCI
  ...
  class VisualBuilder::Models::VbInstanceSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, state_message, instance_url, node_count, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, freeform_tags, defined_tags, system_tags].hash
    end
