...
module OCI
  ...
  class VisualBuilder::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_VB_INSTANCE = 'CREATE_VB_INSTANCE'.freeze,
      OPERATION_TYPE_UPDATE_VB_INSTANCE = 'UPDATE_VB_INSTANCE'.freeze,
      OPERATION_TYPE_STOP_VB_INSTANCE = 'STOP_VB_INSTANCE'.freeze,
      OPERATION_TYPE_START_VB_INSTANCE = 'START_VB_INSTANCE'.freeze,
      OPERATION_TYPE_DELETE_VB_INSTANCE = 'DELETE_VB_INSTANCE'.freeze,
    ...
    # @return [Array<OCI::VisualBuilder::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::VisualBuilder::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::VisualBuilder::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
