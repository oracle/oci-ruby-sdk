...
module OCI
  ...
  class VisualBuilder::Models::CreateVbInstanceDetails
    ...
    # @return [OCI::VisualBuilder::Models::CreateCustomEndpointDetails]
    attr_accessor :custom_endpoint

    # A list of alternate custom endpoints to be used for the vb instance URL
    # (contact Oracle for alternateCustomEndpoints availability for a specific instance).
    #
    # @return [Array<OCI::VisualBuilder::Models::CreateCustomEndpointDetails>]
    ...
    def self.swagger_types
      {
        ...
        'custom_endpoint': :'OCI::VisualBuilder::Models::CreateCustomEndpointDetails',
        'alternate_custom_endpoints': :'Array<OCI::VisualBuilder::Models::CreateCustomEndpointDetails>',
    ...
    # @option attributes [OCI::VisualBuilder::Models::CreateCustomEndpointDetails] :custom_endpoint The value to assign to the {#custom_endpoint} property
    # @option attributes [Array<OCI::VisualBuilder::Models::CreateCustomEndpointDetails>] :alternate_custom_endpoints The value to assign to the {#alternate_custom_endpoints} property
    ...
    def hash
      [display_name, compartment_id, freeform_tags, defined_tags, idcs_open_id, node_count, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model].hash
    end
