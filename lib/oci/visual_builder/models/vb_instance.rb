...
module OCI
  ...
  class VisualBuilder::Models::VbInstance
    ...
    # @return [String]
    attr_accessor :service_nat_gateway_ip

    # The NAT gateway IP address for the VB management VCN
    # @return [String]
    attr_accessor :management_nat_gateway_ip

    # The Oracle Cloud ID (OCID) of the Visual Builder service VCN
    # @return [String]
    attr_accessor :service_vcn_id

    # The Oracle Cloud ID (OCID) of the Visual Builder management VCN
    # @return [String]
    attr_accessor :management_vcn_id
    ...
    # @option attributes [String] :service_nat_gateway_ip The value to assign to the {#service_nat_gateway_ip} property
    # @option attributes [String] :management_nat_gateway_ip The value to assign to the {#management_nat_gateway_ip} property
    # @option attributes [String] :service_vcn_id The value to assign to the {#service_vcn_id} property
    # @option attributes [String] :management_vcn_id The value to assign to the {#management_vcn_id} property
    def initialize(attributes = {})
      ...
      self.service_nat_gateway_ip = attributes[:'serviceNatGatewayIp'] if attributes[:'serviceNatGatewayIp']

      raise 'You cannot provide both :serviceNatGatewayIp and :service_nat_gateway_ip' if attributes.key?(:'serviceNatGatewayIp') && attributes.key?(:'service_nat_gateway_ip')

      self.service_nat_gateway_ip = attributes[:'service_nat_gateway_ip'] if attributes[:'service_nat_gateway_ip']

      self.management_nat_gateway_ip = attributes[:'managementNatGatewayIp'] if attributes[:'managementNatGatewayIp']

      raise 'You cannot provide both :managementNatGatewayIp and :management_nat_gateway_ip' if attributes.key?(:'managementNatGatewayIp') && attributes.key?(:'management_nat_gateway_ip')

      self.management_nat_gateway_ip = attributes[:'management_nat_gateway_ip'] if attributes[:'management_nat_gateway_ip']

      self.service_vcn_id = attributes[:'serviceVcnId'] if attributes[:'serviceVcnId']

      raise 'You cannot provide both :serviceVcnId and :service_vcn_id' if attributes.key?(:'serviceVcnId') && attributes.key?(:'service_vcn_id')

      self.service_vcn_id = attributes[:'service_vcn_id'] if attributes[:'service_vcn_id']

      self.management_vcn_id = attributes[:'managementVcnId'] if attributes[:'managementVcnId']

      raise 'You cannot provide both :managementVcnId and :management_vcn_id' if attributes.key?(:'managementVcnId') && attributes.key?(:'management_vcn_id')

      self.management_vcn_id = attributes[:'management_vcn_id'] if attributes[:'management_vcn_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        service_nat_gateway_ip == other.service_nat_gateway_ip &&
        management_nat_gateway_ip == other.management_nat_gateway_ip &&
        service_vcn_id == other.service_vcn_id &&
        management_vcn_id == other.management_vcn_id
    end
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, state_message, freeform_tags, defined_tags, system_tags, instance_url, node_count, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, idcs_info, attachments, service_nat_gateway_ip, management_nat_gateway_ip, service_vcn_id, management_vcn_id].hash
    end
