...
module OCI
  ...
  class VisualBuilder::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_CREATED = 'CREATED'.freeze,
      ACTION_TYPE_UPDATED = 'UPDATED'.freeze,
      ACTION_TYPE_STOPPED = 'STOPPED'.freeze,
      ACTION_TYPE_STARTED = 'STARTED'.freeze,
    ...
    # **[Required]** The way in which this resource is affected by the work tracked in the
