...
module OCI
  ...
  class OspGateway::Models::InvoiceLineSummary
    ...
    # @option attributes [String] :order_no The value to assign to the {#order_no} property
    ...
    # @option attributes [Float] :total_price The value to assign to the {#total_price} property
