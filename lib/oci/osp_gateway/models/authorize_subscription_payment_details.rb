...
module OCI
  ...
  class OspGateway::Models::AuthorizeSubscriptionPaymentDetails
    # This attribute is required.
    # @return [OCI::OspGateway::Models::Subscription]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'subscription': :'OCI::OspGateway::Models::Subscription',
    ...
    # @option attributes [OCI::OspGateway::Models::Subscription] :subscription The value to assign to the {#subscription} property
    ...
    def initialize(attributes = {})
      ...
      self.subscription = attributes[:'subscription'] if attributes[:'subscription']
    ...
    def hash
      [subscription, language_code, email].hash
    end
