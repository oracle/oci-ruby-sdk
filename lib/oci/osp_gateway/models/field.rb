...
module OCI
  ...
  class OspGateway::Models::Field
    ...
    # @return [OCI::OspGateway::Models::Format]
    attr_accessor :format

    # @return [OCI::OspGateway::Models::Label]
    attr_accessor :label
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'is_required': :'BOOLEAN',
        'format': :'OCI::OspGateway::Models::Format',
        'label': :'OCI::OspGateway::Models::Label',
        'language': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OspGateway::Models::Format] :format The value to assign to the {#format} property
    # @option attributes [OCI::OspGateway::Models::Label] :label The value to assign to the {#label} property
    ...
    def hash
      [name, is_required, format, label, language].hash
    end
