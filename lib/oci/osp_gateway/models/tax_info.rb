...
module OCI
  ...
  class OspGateway::Models::TaxInfo
    ...
    # @option attributes [String] :giro The value to assign to the {#giro} property
    def initialize(attributes = {})
      ...
      self.giro = attributes[:'giro'] if attributes[:'giro']
    end
    ...
    def hash
      [tax_payer_id, tax_reg_number, no_tax_reason_code, no_tax_reason_code_details, tax_cnpj, giro].hash
    end
