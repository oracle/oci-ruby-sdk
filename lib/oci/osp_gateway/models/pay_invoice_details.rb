...
module OCI
  ...
  class OspGateway::Models::PayInvoiceDetails
    # Language code
    # @return [String]
    ...
    # @option attributes [String] :return_url The value to assign to the {#return_url} property
    ...
    def initialize(attributes = {})
      ...
      self.return_url = attributes[:'returnUrl'] if attributes[:'returnUrl']

      raise 'You cannot provide both :returnUrl and :return_url' if attributes.key?(:'returnUrl') && attributes.key?(:'return_url')

      self.return_url = attributes[:'return_url'] if attributes[:'return_url']
    ...
    def hash
      [language_code, return_url, email].hash
    end
