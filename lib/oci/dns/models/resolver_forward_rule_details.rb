...
require 'date'
require_relative 'resolver_rule_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # ResolverForwardRuleDetails model.
  class Dns::Models::ResolverForwardRuleDetails < Dns::Models::ResolverRuleDetails
    ...
    # @option attributes [Array<String>] :client_address_conditions The value to assign to the {OCI::Dns::Models::ResolverRuleDetails#client_address_conditions #client_address_conditions} proprety
    # @option attributes [Array<String>] :qname_cover_conditions The value to assign to the {OCI::Dns::Models::ResolverRuleDetails#qname_cover_conditions #qname_cover_conditions} proprety
    # @option attributes [Array<String>] :destination_addresses The value to assign to the {#destination_addresses} property
    # @option attributes [String] :source_endpoint_name The value to assign to the {#source_endpoint_name} property
