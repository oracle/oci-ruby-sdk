...
module OCI
  ...
  #
  class Dns::Models::UpdateResolverDetails
    ...
    # @return [Array<OCI::Dns::Models::AttachedViewDetails>]
    attr_accessor :attached_views

    # Rules for the resolver. Rules are evaluated in order.
    #
    # @return [Array<OCI::Dns::Models::ResolverRuleDetails>]
    attr_accessor :rules
    ...
    def self.swagger_types
      {
        ...
        'attached_views': :'Array<OCI::Dns::Models::AttachedViewDetails>',
        'rules': :'Array<OCI::Dns::Models::ResolverRuleDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Dns::Models::AttachedViewDetails>] :attached_views The value to assign to the {#attached_views} property
    # @option attributes [Array<OCI::Dns::Models::ResolverRuleDetails>] :rules The value to assign to the {#rules} property
    ...
    def hash
      [display_name, freeform_tags, defined_tags, attached_views, rules].hash
    end
