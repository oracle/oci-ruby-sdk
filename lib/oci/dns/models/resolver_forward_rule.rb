...
require 'date'
require_relative 'resolver_rule'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # ResolverForwardRule model.
  class Dns::Models::ResolverForwardRule < Dns::Models::ResolverRule
    ...
    # @option attributes [Array<String>] :client_address_conditions The value to assign to the {OCI::Dns::Models::ResolverRule#client_address_conditions #client_address_conditions} proprety
    # @option attributes [Array<String>] :qname_cover_conditions The value to assign to the {OCI::Dns::Models::ResolverRule#qname_cover_conditions #qname_cover_conditions} proprety
