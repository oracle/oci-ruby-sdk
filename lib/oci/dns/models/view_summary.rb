...
module OCI
  ...
  class Dns::Models::ViewSummary
    ...
    def hash
      [compartment_id, display_name, freeform_tags, defined_tags, id, _self, time_created, time_updated, lifecycle_state, is_protected].hash
    end
