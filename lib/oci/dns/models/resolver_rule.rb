...
module OCI
  ...
  class Dns::Models::ResolverRule
    ACTION_ENUM = [
      ACTION_FORWARD = 'FORWARD'.freeze,
      ACTION_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** A list of CIDR blocks. The query must come from a client within one of the blocks in order for the rule action
    # to apply.
    #
    # @return [Array<String>]
    attr_accessor :client_address_conditions
    ...
    # **[Required]** The action determines the behavior of the rule. If a query matches a supplied condition then the action will
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Dns::Models::ResolverForwardRule' if type == 'FORWARD'
    ...
    # @option attributes [Array<String>] :client_address_conditions The value to assign to the {#client_address_conditions} property
    # @option attributes [Array<String>] :qname_cover_conditions The value to assign to the {#qname_cover_conditions} property
