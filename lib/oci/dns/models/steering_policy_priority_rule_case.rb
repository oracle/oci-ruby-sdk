...
module OCI
  ...
  class Dns::Models::SteeringPolicyPriorityRuleCase
    ...
    def self.swagger_types
      {
        ...
        'answer_data': :'Array<OCI::Dns::Models::SteeringPolicyPriorityAnswerData>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Dns::Models::SteeringPolicyPriorityAnswerData>] :answer_data The value to assign to the {#answer_data} property
