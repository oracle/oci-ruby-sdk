...
module OCI
  ...
  class Dns::Models::SteeringPolicyPriorityRule < Dns::Models::SteeringPolicyRule
    ...
    # @option attributes [Array<OCI::Dns::Models::SteeringPolicyPriorityRuleCase>] :cases The value to assign to the {#cases} property
    # @option attributes [Array<OCI::Dns::Models::SteeringPolicyPriorityAnswerData>] :default_answer_data The value to assign to the {#default_answer_data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['ruleType'] = 'PRIORITY'
