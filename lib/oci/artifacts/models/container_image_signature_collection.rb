...
module OCI
  ...
  class Artifacts::Models::ContainerImageSignatureCollection
    # **[Required]** Page of matching container image signatures.
    # @return [Array<OCI::Artifacts::Models::ContainerImageSignatureSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Artifacts::Models::ContainerImageSignatureSummary>',
    ...
    # @option attributes [Array<OCI::Artifacts::Models::ContainerImageSignatureSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [items, remaining_items_count].hash
    end
