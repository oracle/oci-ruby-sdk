...
module OCI
  ...
  class Artifacts::Models::ContainerRepositorySummary
    ...
    def hash
      [compartment_id, display_name, id, image_count, is_public, layer_count, layers_size_in_bytes, lifecycle_state, time_created, billable_size_in_gbs, namespace, freeform_tags, defined_tags, system_tags].hash
    end
