...
module OCI
  ...
  class Artifacts::Models::ContainerImageCollection
    # **[Required]** Page of matching container images.
    # @return [Array<OCI::Artifacts::Models::ContainerImageSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Artifacts::Models::ContainerImageSummary>',
    ...
    # @option attributes [Array<OCI::Artifacts::Models::ContainerImageSummary>] :items The value to assign to the {#items} property
