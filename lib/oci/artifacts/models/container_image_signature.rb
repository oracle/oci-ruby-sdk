...
module OCI
  ...
  class Artifacts::Models::ContainerImageSignature
    ...
    def hash
      [compartment_id, created_by, display_name, id, image_id, kms_key_id, kms_key_version_id, message, signature, signing_algorithm, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
