...
module OCI
  ...
  class Artifacts::Models::Repository
    REPOSITORY_TYPE_ENUM = [
      REPOSITORY_TYPE_GENERIC = 'GENERIC'.freeze,
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the repository.
    #
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Artifacts::Models::GenericRepository' if type == 'GENERIC'
