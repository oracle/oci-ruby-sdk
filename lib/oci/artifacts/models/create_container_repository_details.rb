...
module OCI
  ...
  class Artifacts::Models::CreateContainerRepositoryDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment in which to create the resource.
    #
    # @return [String]
    ...
    def hash
      [compartment_id, display_name, is_immutable, is_public, readme].hash
    end
