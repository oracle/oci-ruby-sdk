...
module OCI
  ...
  class Artifacts::Models::ContainerRepository
    ...
    def hash
      [compartment_id, created_by, display_name, id, image_count, is_immutable, is_public, layer_count, layers_size_in_bytes, lifecycle_state, readme, time_created, time_last_pushed, billable_size_in_gbs, namespace, freeform_tags, defined_tags, system_tags].hash
    end
