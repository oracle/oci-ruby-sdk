...
module OCI
  ...
  class Logging::Models::UnifiedAgentMultilineGrokParser < Logging::Models::UnifiedAgentParser
    ...
    # @option attributes [String] :grok_name_key The value to assign to the {#grok_name_key} property
    # @option attributes [String] :grok_failure_key The value to assign to the {#grok_failure_key} property
    # @option attributes [String] :multi_line_start_regexp The value to assign to the {#multi_line_start_regexp} property
    # @option attributes [Array<OCI::Logging::Models::GrokPattern>] :patterns The value to assign to the {#patterns} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['parserType'] = 'MULTILINE_GROK'
      ...
      self.grok_name_key = attributes[:'grokNameKey'] if attributes[:'grokNameKey']

      raise 'You cannot provide both :grokNameKey and :grok_name_key' if attributes.key?(:'grokNameKey') && attributes.key?(:'grok_name_key')

      self.grok_name_key = attributes[:'grok_name_key'] if attributes[:'grok_name_key']

      self.grok_failure_key = attributes[:'grokFailureKey'] if attributes[:'grokFailureKey']

      raise 'You cannot provide both :grokFailureKey and :grok_failure_key' if attributes.key?(:'grokFailureKey') && attributes.key?(:'grok_failure_key')

      self.grok_failure_key = attributes[:'grok_failure_key'] if attributes[:'grok_failure_key']

      self.multi_line_start_regexp = attributes[:'multiLineStartRegexp'] if attributes[:'multiLineStartRegexp']

      raise 'You cannot provide both :multiLineStartRegexp and :multi_line_start_regexp' if attributes.key?(:'multiLineStartRegexp') && attributes.key?(:'multi_line_start_regexp')

      self.multi_line_start_regexp = attributes[:'multi_line_start_regexp'] if attributes[:'multi_line_start_regexp']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        grok_name_key == other.grok_name_key &&
        grok_failure_key == other.grok_failure_key &&
        multi_line_start_regexp == other.multi_line_start_regexp &&
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, grok_name_key, grok_failure_key, multi_line_start_regexp, patterns].hash
    end
