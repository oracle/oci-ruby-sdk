...
module OCI
  # grok parser
  class Logging::Models::UnifiedAgentGrokParser < Logging::Models::UnifiedAgentParser
    # @return [String]
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, grok_name_key, grok_failure_key, patterns].hash
    end
