...
module OCI
  ...
  class Logging::Models::Log
    ...
    def hash
      [id, tenancy_id, log_group_id, display_name, log_type, is_enabled, defined_tags, freeform_tags, configuration, lifecycle_state, time_created, time_last_modified, retention_duration, compartment_id].hash
    end
