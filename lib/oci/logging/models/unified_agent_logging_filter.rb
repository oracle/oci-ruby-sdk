...
module OCI
  ...
  class Logging::Models::UnifiedAgentLoggingFilter
    FILTER_TYPE_ENUM = [
      FILTER_TYPE_PARSER_FILTER = 'PARSER_FILTER'.freeze,
      FILTER_TYPE_GREP_FILTER = 'GREP_FILTER'.freeze,
      FILTER_TYPE_RECORD_TRANSFORMER_FILTER = 'RECORD_TRANSFORMER_FILTER'.freeze,
      FILTER_TYPE_CUSTOM_FILTER = 'CUSTOM_FILTER'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'filterType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Logging::Models::UnifiedAgentCustomFilter' if type == 'CUSTOM_FILTER'
      return 'OCI::Logging::Models::UnifiedAgentParserFilter' if type == 'PARSER_FILTER'
      return 'OCI::Logging::Models::UnifiedAgentLoggingGrepFilter' if type == 'GREP_FILTER'
      return 'OCI::Logging::Models::UnifiedAgentLoggingRecordTransformerFilter' if type == 'RECORD_TRANSFORMER_FILTER'
