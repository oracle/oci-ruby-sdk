...
module OCI
  ...
  class Logging::Models::ResourceType
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'name': :'String',
        'categories': :'Array<OCI::Logging::Models::Category>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Logging::Models::Category>] :categories The value to assign to the {#categories} property
