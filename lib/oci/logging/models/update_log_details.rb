...
module OCI
  ...
  class Logging::Models::UpdateLogDetails
    ...
    # @return [OCI::Logging::Models::UpdateConfigurationDetails]
    ...
    # @option attributes [OCI::Logging::Models::UpdateConfigurationDetails] :configuration The value to assign to the {#configuration} property
    ...
    def hash
      [display_name, is_enabled, defined_tags, freeform_tags, retention_duration, configuration].hash
    end
