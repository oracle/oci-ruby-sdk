...
module OCI
  ...
  class Logging::Models::UnifiedAgentConfigurationCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Logging::Models::UnifiedAgentConfigurationSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Logging::Models::UnifiedAgentConfigurationSummary>] :items The value to assign to the {#items} property
