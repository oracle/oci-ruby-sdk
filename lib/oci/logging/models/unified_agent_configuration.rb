...
module OCI
  ...
  class Logging::Models::UnifiedAgentConfiguration
    ...
    # @return [OCI::Logging::Models::UnifiedAgentServiceConfigurationDetails]
    attr_accessor :service_configuration

    # This attribute is required.
    # @return [OCI::Logging::Models::GroupAssociationDetails]
    attr_accessor :group_association
    ...
    def self.swagger_types
      {
        ...
        'service_configuration': :'OCI::Logging::Models::UnifiedAgentServiceConfigurationDetails',
    ...
    # @option attributes [OCI::Logging::Models::UnifiedAgentServiceConfigurationDetails] :service_configuration The value to assign to the {#service_configuration} property
    # @option attributes [OCI::Logging::Models::GroupAssociationDetails] :group_association The value to assign to the {#group_association} property
    def initialize(attributes = {})
      ...
      self.service_configuration = attributes[:'serviceConfiguration'] if attributes[:'serviceConfiguration']

      raise 'You cannot provide both :serviceConfiguration and :service_configuration' if attributes.key?(:'serviceConfiguration') && attributes.key?(:'service_configuration')

      self.service_configuration = attributes[:'service_configuration'] if attributes[:'service_configuration']

      self.group_association = attributes[:'groupAssociation'] if attributes[:'groupAssociation']

      raise 'You cannot provide both :groupAssociation and :group_association' if attributes.key?(:'groupAssociation') && attributes.key?(:'group_association')

      self.group_association = attributes[:'group_association'] if attributes[:'group_association']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        service_configuration == other.service_configuration &&
        group_association == other.group_association
    end
    ...
    def hash
      [id, compartment_id, display_name, description, defined_tags, freeform_tags, time_created, time_last_modified, lifecycle_state, is_enabled, configuration_state, service_configuration, group_association].hash
    end
