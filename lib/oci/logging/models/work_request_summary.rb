...
module OCI
  ...
  class Logging::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_LOG = 'CREATE_LOG'.freeze,
      OPERATION_TYPE_UPDATE_LOG = 'UPDATE_LOG'.freeze,
      OPERATION_TYPE_DELETE_LOG = 'DELETE_LOG'.freeze,
      OPERATION_TYPE_MOVE_LOG = 'MOVE_LOG'.freeze,
      OPERATION_TYPE_CREATE_LOG_GROUP = 'CREATE_LOG_GROUP'.freeze,
      OPERATION_TYPE_UPDATE_LOG_GROUP = 'UPDATE_LOG_GROUP'.freeze,
      OPERATION_TYPE_DELETE_LOG_GROUP = 'DELETE_LOG_GROUP'.freeze,
      OPERATION_TYPE_MOVE_LOG_GROUP = 'MOVE_LOG_GROUP'.freeze,
      OPERATION_TYPE_CREATE_CONFIGURATION = 'CREATE_CONFIGURATION'.freeze,
      OPERATION_TYPE_UPDATE_CONFIGURATION = 'UPDATE_CONFIGURATION'.freeze,
      OPERATION_TYPE_DELETE_CONFIGURATION = 'DELETE_CONFIGURATION'.freeze,
      OPERATION_TYPE_MOVE_CONFIGURATION = 'MOVE_CONFIGURATION'.freeze,
    ...
    # @return [Array<OCI::Logging::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Logging::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Logging::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
