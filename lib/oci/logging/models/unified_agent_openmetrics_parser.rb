...
module OCI
  # Openmetrics parser.
  class Logging::Models::UnifiedAgentOpenmetricsParser < Logging::Models::UnifiedAgentParser
    # @return [OCI::Logging::Models::UnifiedAgentOpenmetricsParserRecord]
    attr_accessor :record_input
    ...
    def self.swagger_types
      {
        ...
        'record_input': :'OCI::Logging::Models::UnifiedAgentOpenmetricsParserRecord'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Logging::Models::UnifiedAgentOpenmetricsParserRecord] :record_input The value to assign to the {#record_input} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['parserType'] = 'OPENMETRICS'
      ...
      self.record_input = attributes[:'recordInput'] if attributes[:'recordInput']

      raise 'You cannot provide both :recordInput and :record_input' if attributes.key?(:'recordInput') && attributes.key?(:'record_input')

      self.record_input = attributes[:'record_input'] if attributes[:'record_input']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        record_input == other.record_input
    end
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, record_input].hash
    end
