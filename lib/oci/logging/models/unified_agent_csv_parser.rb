...
module OCI
  ...
  class Logging::Models::UnifiedAgentCsvParser < Logging::Models::UnifiedAgentParser
    ...
    # @option attributes [Array<String>] :keys The value to assign to the {#keys} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['parserType'] = 'CSV'
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, delimiter, keys].hash
    end
