...
module OCI
  ...
  class Logging::Models::UnifiedJSONParser < Logging::Models::UnifiedAgentParser
    ...
    # @option attributes [BOOLEAN] :parse_nested The value to assign to the {#parse_nested} property
    # @option attributes [String] :separator The value to assign to the {#separator} property
    def initialize(attributes = {})
      ...
      self.parse_nested = attributes[:'parseNested'] unless attributes[:'parseNested'].nil?
      self.parse_nested = false if parse_nested.nil? && !attributes.key?(:'parseNested') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :parseNested and :parse_nested' if attributes.key?(:'parseNested') && attributes.key?(:'parse_nested')

      self.parse_nested = attributes[:'parse_nested'] unless attributes[:'parse_nested'].nil?
      self.parse_nested = false if parse_nested.nil? && !attributes.key?(:'parseNested') && !attributes.key?(:'parse_nested') # rubocop:disable Style/StringLiterals

      self.separator = attributes[:'separator'] if attributes[:'separator']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        parse_nested == other.parse_nested &&
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, time_type, time_format, parse_nested, separator].hash
    end
