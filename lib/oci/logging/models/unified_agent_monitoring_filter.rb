...
module OCI
  ...
  class Logging::Models::UnifiedAgentMonitoringFilter
    FILTER_TYPE_ENUM = [
      FILTER_TYPE_KUBERNETES_FILTER = 'KUBERNETES_FILTER'.freeze,
      FILTER_TYPE_URL_FILTER = 'URL_FILTER'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Logging::Models::UnifiedAgentKubernetesFilter' if type == 'KUBERNETES_FILTER'
      return 'OCI::Logging::Models::UnifiedAgentUrlFilter' if type == 'URL_FILTER'
