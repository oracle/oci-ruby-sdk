...
module OCI
  # Multiline parser.
  class Logging::Models::UnifiedAgentMultilineParser < Logging::Models::UnifiedAgentParser
    # @return [String]
    attr_accessor :format_firstline
    ...
    # @option attributes [String] :format_firstline The value to assign to the {#format_firstline} property
    # @option attributes [Array<String>] :format The value to assign to the {#format} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['parserType'] = 'MULTILINE'
      ...
      self.format_firstline = attributes[:'formatFirstline'] if attributes[:'formatFirstline']

      raise 'You cannot provide both :formatFirstline and :format_firstline' if attributes.key?(:'formatFirstline') && attributes.key?(:'format_firstline')

      self.format_firstline = attributes[:'format_firstline'] if attributes[:'format_firstline']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        format_firstline == other.format_firstline &&
        format == other.format
    end
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, format_firstline, format].hash
    end
