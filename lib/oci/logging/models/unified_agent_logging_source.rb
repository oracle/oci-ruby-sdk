...
module OCI
  ...
  class Logging::Models::UnifiedAgentLoggingSource
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_LOG_TAIL = 'LOG_TAIL'.freeze,
      SOURCE_TYPE_WINDOWS_EVENT_LOG = 'WINDOWS_EVENT_LOG'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Logging::Models::UnifiedAgentWindowsEventSource' if type == 'WINDOWS_EVENT_LOG'
      return 'OCI::Logging::Models::UnifiedAgentTailLogSource' if type == 'LOG_TAIL'
