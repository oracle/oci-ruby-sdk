...
module OCI
  ...
  class Logging::Models::OciService < Logging::Models::Source
    ...
    # @option attributes [String] :resource The value to assign to the {#resource} property
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceType'] = 'OCISERVICE'
    ...
    def hash
      [source_type, service, resource, category, parameters].hash
    end
