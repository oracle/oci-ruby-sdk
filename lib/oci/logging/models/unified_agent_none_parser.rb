...
module OCI
  ...
  class Logging::Models::UnifiedAgentNoneParser < Logging::Models::UnifiedAgentParser
    ...
    def hash
      [parser_type, field_time_key, types, null_value_pattern, is_null_empty_string, is_estimate_current_event, is_keep_time_key, timeout_in_milliseconds, message_key].hash
    end
