...
module OCI
  ...
  #
  class Logging::Models::LogSavedSearch
    ...
    def hash
      [id, compartment_id, name, time_created, time_last_modified, description, query, is_quick_start, defined_tags, freeform_tags].hash
    end
