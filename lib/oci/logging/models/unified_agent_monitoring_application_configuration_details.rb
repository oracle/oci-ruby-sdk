...
module OCI
  ...
  class Logging::Models::UnifiedAgentMonitoringApplicationConfigurationDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_KUBERNETES = 'KUBERNETES'.freeze,
      SOURCE_TYPE_TAIL = 'TAIL'.freeze,
      SOURCE_TYPE_URL = 'URL'.freeze,
      SOURCE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Type of source of metrics
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Logging::Models::UnifiedAgentKubernetesConfigurationDetails' if type == 'KUBERNETES'
      return 'OCI::Logging::Models::UnifiedAgentUrlConfigurationDetails' if type == 'URL'
      return 'OCI::Logging::Models::UnifiedAgentOpenmetricsTailConfigurationDetails' if type == 'TAIL'
