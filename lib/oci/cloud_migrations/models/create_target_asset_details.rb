...
module OCI
  ...
  class CloudMigrations::Models::CreateTargetAssetDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::CreateVmTargetAssetDetails' if type == 'INSTANCE'
    ...
    def hash
      [migration_plan_id, type, is_excluded_from_execution].hash
    end
