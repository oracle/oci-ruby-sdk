...
module OCI
  ...
  class CloudMigrations::Models::AsIsResourceAssessmentStrategy < CloudMigrations::Models::ResourceAssessmentStrategy
    ...
    def hash
      [resource_type, strategy_type, adjustment_multiplier].hash
    end
