...
module OCI
  ...
  class CloudMigrations::Models::DiscoveryScheduleSummary
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
