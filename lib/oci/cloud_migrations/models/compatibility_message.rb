...
module OCI
  ...
  class CloudMigrations::Models::CompatibilityMessage
    SEVERITY_ENUM = [
    ...
    NAME_ENUM = [
      NAME_NOT_ENOUGH_DATA = 'NOT_ENOUGH_DATA'.freeze,
      NAME_INVALID_DATA = 'INVALID_DATA'.freeze,
      NAME_CPU_COMPATIBILITY_WARNING = 'CPU_COMPATIBILITY_WARNING'.freeze,
      NAME_CPU_METRIC_INFO = 'CPU_METRIC_INFO'.freeze,
      NAME_MEMORY_COMPATIBILITY_WARNING = 'MEMORY_COMPATIBILITY_WARNING'.freeze,
      NAME_MEMORY_METRIC_INFO = 'MEMORY_METRIC_INFO'.freeze,
      NAME_VNICS_COMPATIBILITY_WARNING = 'VNICS_COMPATIBILITY_WARNING'.freeze,
      NAME_BANDWIDTH_COMPATIBILITY_WARNING = 'BANDWIDTH_COMPATIBILITY_WARNING'.freeze,
      NAME_GPU_COMPATIBILITY_WARNING = 'GPU_COMPATIBILITY_WARNING'.freeze,
      NAME_OS_WARNING = 'OS_WARNING'.freeze,
