...
module OCI
  ...
  class CloudMigrations::Models::AssetSourceCredentials
    TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the secret in a vault.
