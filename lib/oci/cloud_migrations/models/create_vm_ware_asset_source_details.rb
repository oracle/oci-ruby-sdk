...
require 'date'
require_relative 'create_asset_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Description of an asset source.
  class CloudMigrations::Models::CreateVmWareAssetSourceDetails < CloudMigrations::Models::CreateAssetSourceDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#display_name #display_name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#compartment_id #compartment_id} proprety
    # @option attributes [String] :environment_id The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#environment_id #environment_id} proprety
    # @option attributes [String] :inventory_id The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#inventory_id #inventory_id} proprety
    # @option attributes [String] :assets_compartment_id The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#assets_compartment_id #assets_compartment_id} proprety
    # @option attributes [String] :discovery_schedule_id The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#discovery_schedule_id #discovery_schedule_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#defined_tags #defined_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::CloudMigrations::Models::CreateAssetSourceDetails#system_tags #system_tags} proprety
    ...
    def hash
      [type, display_name, compartment_id, environment_id, inventory_id, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, vcenter_endpoint, discovery_credentials, replication_credentials, are_historical_metrics_collected, are_realtime_metrics_collected].hash
    end
