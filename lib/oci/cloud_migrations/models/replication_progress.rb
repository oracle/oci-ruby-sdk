...
module OCI
  ...
  class CloudMigrations::Models::ReplicationProgress
    STATUS_ENUM = [
    ...
    # @option attributes [DateTime] :time_oflast_replication_start The value to assign to the {#time_oflast_replication_start} property
    # @option attributes [DateTime] :time_of_last_replication_end The value to assign to the {#time_of_last_replication_end} property
    # @option attributes [DateTime] :time_of_last_replication_success The value to assign to the {#time_of_last_replication_success} property
    # @option attributes [String] :last_replication_status The value to assign to the {#last_replication_status} property
    # @option attributes [String] :last_replication_error The value to assign to the {#last_replication_error} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] last_replication_status Object to be assigned
    def last_replication_status=(last_replication_status)
      # rubocop:disable Style/ConditionalAssignment
      if last_replication_status && !LAST_REPLICATION_STATUS_ENUM.include?(last_replication_status)
        OCI.logger.debug("Unknown value for 'last_replication_status' [" + last_replication_status + "]. Mapping to 'LAST_REPLICATION_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @last_replication_status = LAST_REPLICATION_STATUS_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [percentage, status, time_started, time_oflast_replication_start, time_of_last_replication_end, time_of_last_replication_success, last_replication_status, last_replication_error].hash
    end
