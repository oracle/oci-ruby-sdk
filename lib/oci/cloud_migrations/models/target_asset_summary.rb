...
module OCI
  ...
  class CloudMigrations::Models::TargetAssetSummary
    TYPE_ENUM = [
    ...
    # @return [OCI::CloudMigrations::Models::MigrationAssetSummary]
    ...
    # @option attributes [OCI::CloudMigrations::Models::MigrationAssetSummary] :migration_asset The value to assign to the {#migration_asset} property
