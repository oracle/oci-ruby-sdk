...
module OCI
  ...
  class CloudMigrations::Models::UpdateTargetAssetDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::UpdateVmTargetAssetDetails' if type == 'INSTANCE'
    ...
    def hash
      [type, is_excluded_from_execution].hash
    end
