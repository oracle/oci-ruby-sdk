...
module OCI
  ...
  class CloudMigrations::Models::PercentileResourceAssessmentStrategy < CloudMigrations::Models::ResourceAssessmentStrategy
    PERCENTILE_ENUM = [
    ...
    # @option attributes [String] :percentile The value to assign to the {#percentile} property
    ...
    # @param [Object] percentile Object to be assigned
    def percentile=(percentile)
      # rubocop:disable Style/ConditionalAssignment
      if percentile && !PERCENTILE_ENUM.include?(percentile)
        OCI.logger.debug("Unknown value for 'percentile' [" + percentile + "]. Mapping to 'PERCENTILE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @percentile = PERCENTILE_UNKNOWN_ENUM_VALUE
      else
        @percentile = percentile
      end
