...
require 'date'
require_relative 'create_target_asset_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Description of the VM target asset.
  class CloudMigrations::Models::CreateVmTargetAssetDetails < CloudMigrations::Models::CreateTargetAssetDetails
    ...
    # @option attributes [String] :migration_plan_id The value to assign to the {OCI::CloudMigrations::Models::CreateTargetAssetDetails#migration_plan_id #migration_plan_id} proprety
    # @option attributes [BOOLEAN] :is_excluded_from_execution The value to assign to the {OCI::CloudMigrations::Models::CreateTargetAssetDetails#is_excluded_from_execution #is_excluded_from_execution} proprety
