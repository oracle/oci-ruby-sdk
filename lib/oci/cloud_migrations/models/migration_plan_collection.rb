...
module OCI
  ...
  class CloudMigrations::Models::MigrationPlanCollection
    # **[Required]** List of migration plan summaries.
    # @return [Array<OCI::CloudMigrations::Models::MigrationPlanSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudMigrations::Models::MigrationPlanSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::MigrationPlanSummary>] :items The value to assign to the {#items} property
