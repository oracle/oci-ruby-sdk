...
module OCI
  ...
  class CloudMigrations::Models::MigrationSummary
    ...
    # @option attributes [BOOLEAN] :is_completed The value to assign to the {#is_completed} property
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, is_completed, replication_schedule_id, freeform_tags, defined_tags, system_tags].hash
    end
