...
module OCI
  # Discovery schedule.
  class CloudMigrations::Models::DiscoverySchedule
    LIFECYCLE_STATE_ENUM = [
      LIFECYCLE_STATE_ACTIVE = 'ACTIVE'.freeze,
      LIFECYCLE_STATE_DELETED = 'DELETED'.freeze
    ].freeze

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the discovery schedule.
    # @return [String]
    attr_accessor :id

    # **[Required]** A user-friendly name for the discovery schedule. Does not have to be unique, and it's mutable.
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment in which the discovery schedule exists.
    # @return [String]
    ...
    def hash
      [id, display_name, execution_recurrences, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
