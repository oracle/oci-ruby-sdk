...
module OCI
  ...
  class CloudMigrations::Models::InstanceSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudMigrations::Models::InstanceSourceViaImageDetails' if type == 'image'
      return 'OCI::CloudMigrations::Models::InstanceSourceViaBootVolumeDetails' if type == 'bootVolume'

      # TODO: Log a warning when the subtype is not found.
      'OCI::CloudMigrations::Models::InstanceSourceDetails'
    end
