...
module OCI
  ...
  class CloudMigrations::Models::Migration
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, replication_schedule_id, is_completed, freeform_tags, defined_tags, system_tags].hash
    end
