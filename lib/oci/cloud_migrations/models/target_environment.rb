...
module OCI
  ...
  class CloudMigrations::Models::TargetEnvironment
    ...
    # @return [String]
    attr_reader :target_environment_type
    ...
    # @option attributes [String] :target_environment_type The value to assign to the {#target_environment_type} property
    ...
    # @param [Object] target_environment_type Object to be assigned
    def target_environment_type=(target_environment_type)
      # rubocop:disable Style/ConditionalAssignment
      if target_environment_type && !TARGET_ENVIRONMENT_TYPE_ENUM.include?(target_environment_type)
        OCI.logger.debug("Unknown value for 'target_environment_type' [" + target_environment_type + "]. Mapping to 'TARGET_ENVIRONMENT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @target_environment_type = TARGET_ENVIRONMENT_TYPE_UNKNOWN_ENUM_VALUE
      else
