...
module OCI
  ...
  class CloudMigrations::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::CloudMigrations::Models::WorkRequestResource>]
    ...
    # **[Required]** The date and time when the request was created, as described in
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::CloudMigrations::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
