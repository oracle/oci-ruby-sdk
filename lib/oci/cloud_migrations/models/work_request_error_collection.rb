...
module OCI
  ...
  class CloudMigrations::Models::WorkRequestErrorCollection
    # **[Required]** List of work request error objects.
    # @return [Array<OCI::CloudMigrations::Models::WorkRequestError>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::CloudMigrations::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::CloudMigrations::Models::WorkRequestError>] :items The value to assign to the {#items} property
