...
module OCI
  ...
  class CloudMigrations::Models::VmWareAssetSource < CloudMigrations::Models::AssetSource
    ...
    # @option attributes [String] :id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#id #id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#compartment_id #compartment_id} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::CloudMigrations::Models::AssetSource#display_name #display_name} proprety
    # @option attributes [String] :environment_id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#environment_id #environment_id} proprety
    # @option attributes [String] :inventory_id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#inventory_id #inventory_id} proprety
    # @option attributes [String] :assets_compartment_id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#assets_compartment_id #assets_compartment_id} proprety
    # @option attributes [String] :discovery_schedule_id The value to assign to the {OCI::CloudMigrations::Models::AssetSource#discovery_schedule_id #discovery_schedule_id} proprety
    # @option attributes [String] :lifecycle_state The value to assign to the {OCI::CloudMigrations::Models::AssetSource#lifecycle_state #lifecycle_state} proprety
    # @option attributes [String] :lifecycle_details The value to assign to the {OCI::CloudMigrations::Models::AssetSource#lifecycle_details #lifecycle_details} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::CloudMigrations::Models::AssetSource#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::CloudMigrations::Models::AssetSource#time_updated #time_updated} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::CloudMigrations::Models::AssetSource#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::CloudMigrations::Models::AssetSource#defined_tags #defined_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::CloudMigrations::Models::AssetSource#system_tags #system_tags} proprety
