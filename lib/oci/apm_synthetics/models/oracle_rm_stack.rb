...
module OCI
  ...
  class ApmSynthetics::Models::OracleRMStack < ApmSynthetics::Models::DvpStackDetails
    # **[Required]** Stack [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
    # @return [String]
    attr_accessor :dvp_stack_id

    # **[Required]** Stream [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
    # @return [String]
