...
module OCI
  ...
  class ApmSynthetics::Models::ScriptedBrowserMonitorConfiguration < ApmSynthetics::Models::MonitorConfiguration
    ...
    # @return [BOOLEAN]
    attr_accessor :is_default_snapshot_enabled
    ...
    # @option attributes [BOOLEAN] :is_default_snapshot_enabled The value to assign to the {#is_default_snapshot_enabled} property
    ...
    def hash
      [config_type, is_failure_retried, dns_configuration, is_certificate_validation_enabled, is_default_snapshot_enabled, network_configuration].hash
    end
