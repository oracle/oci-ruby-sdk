...
module OCI
  ...
  class ApmSynthetics::Models::DedicatedVantagePointSummary
    STATUS_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the dedicated vantage point.
    # @return [String]
    attr_accessor :id
    ...
    # @return [OCI::ApmSynthetics::Models::DvpStackDetails]
    attr_accessor :dvp_stack_details
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'status': :'String',
        'dvp_stack_details': :'OCI::ApmSynthetics::Models::DvpStackDetails',
        'region': :'String',
    ...
    # @option attributes [OCI::ApmSynthetics::Models::DvpStackDetails] :dvp_stack_details The value to assign to the {#dvp_stack_details} property
    ...
    def initialize(attributes = {})
      ...
      self.dvp_stack_details = attributes[:'dvpStackDetails'] if attributes[:'dvpStackDetails']

      raise 'You cannot provide both :dvpStackDetails and :dvp_stack_details' if attributes.key?(:'dvpStackDetails') && attributes.key?(:'dvp_stack_details')

      self.dvp_stack_details = attributes[:'dvp_stack_details'] if attributes[:'dvp_stack_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        name == other.name &&
        status == other.status &&
        dvp_stack_details == other.dvp_stack_details &&
        region == other.region &&
    ...
    def hash
      [id, display_name, name, status, dvp_stack_details, region, time_created, time_updated, freeform_tags, defined_tags, monitor_status_count_map].hash
    end
