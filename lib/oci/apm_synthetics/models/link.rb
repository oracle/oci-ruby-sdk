...
module OCI
  ...
  class ApmSynthetics::Models::Link
    ...
    # Average packet loss.
    # @return [Float]
    attr_accessor :forwarding_loss

    # Difference of the packet response time between source and destination nodes, in milliseconds.
    # @return [Float]
    attr_accessor :delay_in_milliseconds

    # Minimum delay in milliseconds.
    # @return [Float]
    attr_accessor :min_delay_in_milliseconds

    # Maximum delay in milliseconds.
    # @return [Float]
    attr_accessor :max_delay_in_milliseconds
    ...
    # @option attributes [Float] :forwarding_loss The value to assign to the {#forwarding_loss} property
    # @option attributes [Float] :delay_in_milliseconds The value to assign to the {#delay_in_milliseconds} property
    # @option attributes [Float] :min_delay_in_milliseconds The value to assign to the {#min_delay_in_milliseconds} property
    # @option attributes [Float] :max_delay_in_milliseconds The value to assign to the {#max_delay_in_milliseconds} property
