...
module OCI
  ...
  class ApmSynthetics::Models::DedicatedVantagePoint
    STATUS_ENUM = [
    ...
    def hash
      [id, display_name, name, status, dvp_stack_details, region, monitor_status_count_map, time_created, time_updated, freeform_tags, defined_tags].hash
    end
