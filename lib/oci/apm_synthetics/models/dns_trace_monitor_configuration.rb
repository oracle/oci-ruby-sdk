...
module OCI
  ...
  class ApmSynthetics::Models::DnsTraceMonitorConfiguration < ApmSynthetics::Models::MonitorConfiguration
    RECORD_TYPE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['configType'] = 'DNS_TRACE_CONFIG'
    ...
    def hash
      [config_type, is_failure_retried, dns_configuration, record_type, protocol, verify_response_content].hash
    end
