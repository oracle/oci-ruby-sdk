...
module OCI
  ...
  #
  class ApmSynthetics::Models::CreateScriptDetails
    CONTENT_TYPE_ENUM = [
    ...
    # **[Required]** The content of the script. It may contain custom-defined tags that can be used for setting dynamic parameters.
    ...
    #
    # @return [Array<OCI::ApmSynthetics::Models::ScriptParameter>]
    ...
    # @option attributes [Array<OCI::ApmSynthetics::Models::ScriptParameter>] :parameters The value to assign to the {#parameters} property
    ...
    def initialize(attributes = {})
      ...
      self.content_file_name = "script.side" if content_file_name.nil? && !attributes.key?(:'contentFileName') # rubocop:disable Style/StringLiterals
      ...
      self.content_file_name = "script.side" if content_file_name.nil? && !attributes.key?(:'contentFileName') && !attributes.key?(:'content_file_name') # rubocop:disable Style/StringLiterals
