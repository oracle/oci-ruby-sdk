...
module OCI
  ...
  #
  class ApmSynthetics::Models::ScriptParameter
    ...
    def initialize(attributes = {})
      ...
      self.is_secret = false if is_secret.nil? && !attributes.key?(:'isSecret') # rubocop:disable Style/StringLiterals
      ...
      self.is_secret = false if is_secret.nil? && !attributes.key?(:'isSecret') && !attributes.key?(:'is_secret') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [param_name, param_value, is_secret].hash
    end
