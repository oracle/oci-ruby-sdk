...
module OCI
  ...
  class ApmSynthetics::Models::NetworkMonitorConfiguration < ApmSynthetics::Models::MonitorConfiguration
    ...
    def initialize(attributes = {})
      ...
      attributes['configType'] = 'NETWORK_CONFIG'
    ...
    def hash
      [config_type, is_failure_retried, dns_configuration, network_configuration].hash
    end
