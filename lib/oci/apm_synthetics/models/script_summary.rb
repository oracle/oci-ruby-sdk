...
module OCI
  ...
  class ApmSynthetics::Models::ScriptSummary
    CONTENT_TYPE_ENUM = [
    ...
    def hash
      [id, display_name, content_type, monitor_status_count_map, time_created, time_updated, freeform_tags, defined_tags].hash
    end
