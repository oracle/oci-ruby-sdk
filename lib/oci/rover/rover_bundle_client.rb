...
module OCI
  ...
  class Rover::RoverBundleClient
    ...
    # Creates a new RoverBundleClient.
    # Notes:
    ...
    def region=(new_region)
      ...
      logger.info "RoverBundleClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for timeTaskCreated is descending. If no value is specified timeTaskCreated is default.
    #    (default to timeTaskCreated)
    #   Allowed values are: timeTaskCreated
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleRequestCollection RoverBundleRequestCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/list_rover_cluster_rover_bundle_requests.rb.html) to see an example of how to use list_rover_cluster_rover_bundle_requests API.
    ...
    #   Allowed values are: timeTaskCreated
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleRequestCollection RoverBundleRequestCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/list_rover_node_rover_bundle_requests.rb.html) to see an example of how to use list_rover_node_rover_bundle_requests API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/request_bundle_rover_cluster.rb.html) to see an example of how to use request_bundle_rover_cluster API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/request_bundle_rover_node.rb.html) to see an example of how to use request_bundle_rover_node API.
    ...
    # @param [OCI::Rover::Models::CurrentRoverBundleDetails] current_rover_bundle_details Provide the current rover bundle details.
    # @param [String] rover_cluster_id Unique RoverCluster identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleVersion RoverBundleVersion}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/retrieve_available_bundle_versions_rover_cluster.rb.html) to see an example of how to use retrieve_available_bundle_versions_rover_cluster API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleVersion RoverBundleVersion}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/retrieve_available_bundle_versions_rover_node.rb.html) to see an example of how to use retrieve_available_bundle_versions_rover_node API.
    ...
    # @param [OCI::Rover::Models::RoverBundleStatusDetails] rover_bundle_status_details Provide the rover bundle details that requires to retrieve its status.
    # @param [String] rover_cluster_id Unique RoverCluster identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleStatus RoverBundleStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/retrieve_bundle_status_rover_cluster.rb.html) to see an example of how to use retrieve_bundle_status_rover_cluster API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RoverBundleStatus RoverBundleStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/retrieve_bundle_status_rover_node.rb.html) to see an example of how to use retrieve_bundle_status_rover_node API.
