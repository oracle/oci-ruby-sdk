...
module OCI
  ...
  class Rover::ShapeClient
    ...
    def initialize(config: nil, region: nil, endpoint: nil, signer: nil, proxy_settings: nil, retry_config: nil)
      ...
      logger.info "ShapeClient endpoint set to '#{@endpoint}'." if logger
    end
    ...
    def region=(new_region)
      ...
      logger.info "ShapeClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @return [Response] A Response object with data of type {OCI::Rover::Models::ShapeCollection ShapeCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/list_shapes.rb.html) to see an example of how to use list_shapes API.
    def list_shapes(compartment_id, opts = {})
      logger.debug 'Calling operation ShapeClient#list_shapes.' if logger
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ShapeClient#list_shapes') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          body: post_body,
          return_type: 'OCI::Rover::Models::ShapeCollection'
        )
      end
