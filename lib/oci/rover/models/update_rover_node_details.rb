...
module OCI
  ...
  class Rover::Models::UpdateRoverNodeDetails
    ...
    def cert_key_algorithm=(cert_key_algorithm)
      raise "Invalid value for 'cert_key_algorithm': this must be one of the values in CERT_KEY_ALGORITHM_ENUM." if cert_key_algorithm && !CERT_KEY_ALGORITHM_ENUM.include?(cert_key_algorithm)
    ...
    def cert_signature_algorithm=(cert_signature_algorithm)
      raise "Invalid value for 'cert_signature_algorithm': this must be one of the values in CERT_SIGNATURE_ALGORITHM_ENUM." if cert_signature_algorithm && !CERT_SIGNATURE_ALGORITHM_ENUM.include?(cert_signature_algorithm)
