...
module OCI
  ...
  class Rover::Models::RoverNodeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Rover::Models::RoverNodeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Rover::Models::RoverNodeSummary>] :items The value to assign to the {#items} property
