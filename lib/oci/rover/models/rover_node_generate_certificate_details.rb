...
module OCI
  ...
  class Rover::Models::RoverNodeGenerateCertificateDetails
    ...
    # @option attributes [String] :csr The value to assign to the {#csr} property
    ...
    def initialize(attributes = {})
      ...
      self.csr = attributes[:'csr'] if attributes[:'csr']
    ...
    def hash
      [csr, time_cert_validity_end].hash
    end
