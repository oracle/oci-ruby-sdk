...
module OCI
  ...
  class Rover::Models::RoverNode
    ...
    # @return [DateTime]
    attr_accessor :time_cert_validity_end
    ...
    # @return [String]
    attr_accessor :cert_compartment_id

    # The version number of the leaf certificate.
    # @return [String]
    attr_accessor :certificate_version_number
    ...
    # @option attributes [DateTime] :time_cert_validity_end The value to assign to the {#time_cert_validity_end} property
    # @option attributes [String] :common_name The value to assign to the {#common_name} property
    # @option attributes [String] :cert_compartment_id The value to assign to the {#cert_compartment_id} property
    # @option attributes [String] :certificate_version_number The value to assign to the {#certificate_version_number} property
