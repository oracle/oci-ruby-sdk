...
module OCI
  ...
  class Rover::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_ADD_NODES = 'ADD_NODES'.freeze,
    ...
    # @return [Array<OCI::Rover::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Rover::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Rover::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [operation_type, status, status_details, id, compartment_id, resources, percent_complete, time_accepted, time_started, time_finished].hash
    end
