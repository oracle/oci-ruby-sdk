...
module OCI
  ...
  class Rover::Models::RoverEntitlement
    ...
    # @return [String]
    attr_accessor :entitlement_details
    ...
    # @option attributes [String] :entitlement_details The value to assign to the {#entitlement_details} property
    ...
    def initialize(attributes = {})
      ...
      self.entitlement_details = attributes[:'entitlementDetails'] if attributes[:'entitlementDetails']

      raise 'You cannot provide both :entitlementDetails and :entitlement_details' if attributes.key?(:'entitlementDetails') && attributes.key?(:'entitlement_details')

      self.entitlement_details = attributes[:'entitlement_details'] if attributes[:'entitlement_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        entitlement_details == other.entitlement_details &&
    ...
    def hash
      [tenant_id, id, compartment_id, display_name, requestor_name, requestor_email, lifecycle_state, entitlement_details, lifecycle_state_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
