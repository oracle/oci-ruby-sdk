...
module OCI
  ...
  class Rover::Models::CreateRoverEntitlementDetails
    ...
    def hash
      [compartment_id, display_name, requestor_name, requestor_email, entitlement_details, lifecycle_state, lifecycle_state_details, tenant_id, freeform_tags, defined_tags, system_tags].hash
    end
