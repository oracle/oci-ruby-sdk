...
module OCI
  ...
  class Rover::Models::UpdateRoverEntitlementDetails
    ...
    def hash
      [display_name, tenant_id, requestor_name, requestor_email, entitlement_details, lifecycle_state, lifecycle_state_details, freeform_tags, defined_tags, system_tags].hash
    end
