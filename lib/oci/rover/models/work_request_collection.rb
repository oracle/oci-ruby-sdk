...
module OCI
  ...
  class Rover::Models::WorkRequestCollection
    # **[Required]** List of workRequests.
    # @return [Array<OCI::Rover::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Rover::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Rover::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
