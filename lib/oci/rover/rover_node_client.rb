...
module OCI
  ...
  class Rover::RoverNodeClient
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Rover::Models::CaBundleResponse CaBundleResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/rover_node_action_retrieve_ca_bundle.rb.html) to see an example of how to use rover_node_action_retrieve_ca_bundle API.
    def rover_node_action_retrieve_ca_bundle(rover_node_id, opts = {})
      logger.debug 'Calling operation RoverNodeClient#rover_node_action_retrieve_ca_bundle.' if logger

      raise "Missing the required parameter 'rover_node_id' when calling rover_node_action_retrieve_ca_bundle." if rover_node_id.nil?
      raise "Parameter value for 'rover_node_id' must not be blank" if OCI::Internal::Util.blank_string?(rover_node_id)

      path = '/roverNodes/{roverNodeId}/actions/retrieveCaBundle'.sub('{roverNodeId}', rover_node_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RoverNodeClient#rover_node_action_retrieve_ca_bundle') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Rover::Models::CaBundleResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::Rover::Models::RoverNodeGenerateCertificateDetails] rover_node_generate_certificate_details The information provided to generate certificate.
    # @param [String] rover_node_id Unique RoverNode identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Rover::Models::GenerateCertificateResponse GenerateCertificateResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/rover_node_generate_certificate.rb.html) to see an example of how to use rover_node_generate_certificate API.
    def rover_node_generate_certificate(rover_node_generate_certificate_details, rover_node_id, opts = {})
      logger.debug 'Calling operation RoverNodeClient#rover_node_generate_certificate.' if logger

      raise "Missing the required parameter 'rover_node_generate_certificate_details' when calling rover_node_generate_certificate." if rover_node_generate_certificate_details.nil?
      raise "Missing the required parameter 'rover_node_id' when calling rover_node_generate_certificate." if rover_node_id.nil?
      raise "Parameter value for 'rover_node_id' must not be blank" if OCI::Internal::Util.blank_string?(rover_node_id)

      path = '/roverNodes/{roverNodeId}/actions/generateCertificate'.sub('{roverNodeId}', rover_node_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(rover_node_generate_certificate_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RoverNodeClient#rover_node_generate_certificate') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Rover::Models::GenerateCertificateResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::Rover::Models::RoverNodeRenewCertificateDetails] rover_node_renew_certificate_details The information provided to renew certificate.
    # @param [String] rover_node_id Unique RoverNode identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Rover::Models::RenewCertificateResponse RenewCertificateResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/rover_node_renew_certificate.rb.html) to see an example of how to use rover_node_renew_certificate API.
    def rover_node_renew_certificate(rover_node_renew_certificate_details, rover_node_id, opts = {})
      logger.debug 'Calling operation RoverNodeClient#rover_node_renew_certificate.' if logger

      raise "Missing the required parameter 'rover_node_renew_certificate_details' when calling rover_node_renew_certificate." if rover_node_renew_certificate_details.nil?
      raise "Missing the required parameter 'rover_node_id' when calling rover_node_renew_certificate." if rover_node_id.nil?
      raise "Parameter value for 'rover_node_id' must not be blank" if OCI::Internal::Util.blank_string?(rover_node_id)

      path = '/roverNodes/{roverNodeId}/actions/renewCertificate'.sub('{roverNodeId}', rover_node_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(rover_node_renew_certificate_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RoverNodeClient#rover_node_renew_certificate') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Rover::Models::RenewCertificateResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::Rover::Models::RoverNodeReplaceCertificateAuthorityDetails] rover_node_replace_certificate_authority_details The information provided to replace certificate authority.
    # @param [String] rover_node_id Unique RoverNode identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Rover::Models::ReplaceCertificateAuthorityResponse ReplaceCertificateAuthorityResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/rover_node_replace_certificate_authority.rb.html) to see an example of how to use rover_node_replace_certificate_authority API.
    def rover_node_replace_certificate_authority(rover_node_replace_certificate_authority_details, rover_node_id, opts = {})
      logger.debug 'Calling operation RoverNodeClient#rover_node_replace_certificate_authority.' if logger

      raise "Missing the required parameter 'rover_node_replace_certificate_authority_details' when calling rover_node_replace_certificate_authority." if rover_node_replace_certificate_authority_details.nil?
      raise "Missing the required parameter 'rover_node_id' when calling rover_node_replace_certificate_authority." if rover_node_id.nil?
      raise "Parameter value for 'rover_node_id' must not be blank" if OCI::Internal::Util.blank_string?(rover_node_id)

      path = '/roverNodes/{roverNodeId}/actions/replaceCertificateAuthority'.sub('{roverNodeId}', rover_node_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(rover_node_replace_certificate_authority_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RoverNodeClient#rover_node_replace_certificate_authority') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Rover::Models::ReplaceCertificateAuthorityResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Rover::Models::LeafCertificateResponse LeafCertificateResponse}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/rover/rover_node_retrieve_leaf_certificate.rb.html) to see an example of how to use rover_node_retrieve_leaf_certificate API.
    def rover_node_retrieve_leaf_certificate(rover_node_id, opts = {})
      logger.debug 'Calling operation RoverNodeClient#rover_node_retrieve_leaf_certificate.' if logger

      raise "Missing the required parameter 'rover_node_id' when calling rover_node_retrieve_leaf_certificate." if rover_node_id.nil?
      raise "Parameter value for 'rover_node_id' must not be blank" if OCI::Internal::Util.blank_string?(rover_node_id)

      path = '/roverNodes/{roverNodeId}/actions/retrieveLeafCertificate'.sub('{roverNodeId}', rover_node_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RoverNodeClient#rover_node_retrieve_leaf_certificate') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Rover::Models::LeafCertificateResponse'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
