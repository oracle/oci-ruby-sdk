...
module OCI
  ...
  class WorkRequests::Models::WorkRequest
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::WorkRequests::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::WorkRequests::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
