...
module OCI
  ...
  #
  class Analytics::Models::PrivateEndpointDetails < Analytics::Models::NetworkEndpointDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['networkEndpointType'] = 'PRIVATE'
    ...
    def hash
      [network_endpoint_type, vcn_id, subnet_id].hash
    end
