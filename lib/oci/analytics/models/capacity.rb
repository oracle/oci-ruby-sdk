...
module OCI
  ...
  #
  class Analytics::Models::Capacity
    CAPACITY_TYPE_ENUM = [
    ...
    # **[Required]** The capacity value selected (OLPU count, number of users, ...etc...). This parameter affects the
    ...
    def capacity_type=(capacity_type)
      ...
      if capacity_type && !CAPACITY_TYPE_ENUM.include?(capacity_type)
        OCI.logger.debug("Unknown value for 'capacity_type' [" + capacity_type + "]. Mapping to 'CAPACITY_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @capacity_type = CAPACITY_TYPE_UNKNOWN_ENUM_VALUE
      else
