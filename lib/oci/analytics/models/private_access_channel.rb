...
module OCI
  ...
  class Analytics::Models::PrivateAccessChannel
    ...
    # @option attributes [Array<OCI::Analytics::Models::PrivateSourceScanHost>] :private_source_scan_hosts The value to assign to the {#private_source_scan_hosts} property
    ...
    def hash
      [key, display_name, vcn_id, subnet_id, ip_address, egress_source_ip_addresses, private_source_dns_zones, private_source_scan_hosts, network_security_group_ids].hash
    end
