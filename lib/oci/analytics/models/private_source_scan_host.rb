...
module OCI
  ...
  class Analytics::Models::PrivateSourceScanHost
    ...
    # @option attributes [String] :scan_hostname The value to assign to the {#scan_hostname} property
    ...
    def initialize(attributes = {})
      ...
      self.scan_hostname = attributes[:'scanHostname'] if attributes[:'scanHostname']

      raise 'You cannot provide both :scanHostname and :scan_hostname' if attributes.key?(:'scanHostname') && attributes.key?(:'scan_hostname')

      self.scan_hostname = attributes[:'scan_hostname'] if attributes[:'scan_hostname']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        scan_hostname == other.scan_hostname &&
    ...
    def hash
      [scan_hostname, scan_port, description].hash
    end
