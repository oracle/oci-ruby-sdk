...
module OCI
  ...
  class Secrets::Models::SecretBundleContentDetails
    CONTENT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Secrets::Models::Base64SecretBundleContentDetails' if type == 'BASE64'

      # TODO: Log a warning when the subtype is not found.
      'OCI::Secrets::Models::SecretBundleContentDetails'
    end
