...
module OCI
  ...
  class Autoscaling::Models::UpdateAutoScalingPolicyDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Autoscaling::Models::UpdateScheduledPolicyDetails' if type == 'scheduled'
    ...
    def hash
      [display_name, capacity, policy_type, is_enabled].hash
    end
