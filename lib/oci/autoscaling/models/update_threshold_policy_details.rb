...
module OCI
  ...
  class Autoscaling::Models::UpdateThresholdPolicyDetails < Autoscaling::Models::UpdateAutoScalingPolicyDetails
    ...
    def hash
      [display_name, capacity, policy_type, is_enabled, rules].hash
    end
