...
require 'date'
require_relative 'execution_schedule'
...
module OCI
  ...
  class Autoscaling::Models::CronExecutionSchedule < Autoscaling::Models::ExecutionSchedule
    ...
    # @option attributes [String] :timezone The value to assign to the {OCI::Autoscaling::Models::ExecutionSchedule#timezone #timezone} proprety
    # @option attributes [String] :expression The value to assign to the {#expression} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'cron'
