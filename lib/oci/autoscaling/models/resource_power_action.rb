...
module OCI
  ...
  class Autoscaling::Models::ResourcePowerAction < Autoscaling::Models::ResourceAction
    ACTION_ENUM = [
      ACTION_STOP = 'STOP'.freeze,
      ACTION_START = 'START'.freeze,
      ACTION_SOFTRESET = 'SOFTRESET'.freeze,
