...
module OCI
  ...
  class Autoscaling::Models::ExecutionSchedule
    ...
    def timezone=(timezone)
      ...
      if timezone && !TIMEZONE_ENUM.include?(timezone)
        OCI.logger.debug("Unknown value for 'timezone' [" + timezone + "]. Mapping to 'TIMEZONE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @timezone = TIMEZONE_UNKNOWN_ENUM_VALUE
      else
        @timezone = timezone
      end
