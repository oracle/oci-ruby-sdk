...
module OCI
  ...
  class AiVision::Models::AnalyzeDocumentDetails
    ...
    # @return [OCI::AiVision::Models::DocumentDetails]
    ...
    def self.swagger_types
      {
        ...
        'document': :'OCI::AiVision::Models::DocumentDetails',
    ...
    # @option attributes [OCI::AiVision::Models::DocumentDetails] :document The value to assign to the {#document} property
    ...
    def hash
      [features, document, compartment_id, output_location, language, document_type].hash
    end
