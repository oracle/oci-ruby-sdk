...
module OCI
  ...
  class AiVision::Models::Dimensions
    ...
    # @option attributes [Float] :width The value to assign to the {#width} property
    # @option attributes [Float] :height The value to assign to the {#height} property
