...
module OCI
  ...
  class AiVision::Models::InputLocation
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_OBJECT_LIST_INLINE_INPUT_LOCATION = 'OBJECT_LIST_INLINE_INPUT_LOCATION'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiVision::Models::ObjectListInlineInputLocation' if type == 'OBJECT_LIST_INLINE_INPUT_LOCATION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiVision::Models::InputLocation'
    end
