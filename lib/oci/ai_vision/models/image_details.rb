...
module OCI
  ...
  class AiVision::Models::ImageDetails
    SOURCE_ENUM = [
      SOURCE_INLINE = 'INLINE'.freeze,
      SOURCE_OBJECT_STORAGE = 'OBJECT_STORAGE'.freeze
    ].freeze

    # **[Required]** The location of the image data.
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiVision::Models::ObjectStorageImageDetails' if type == 'OBJECT_STORAGE'
      return 'OCI::AiVision::Models::InlineImageDetails' if type == 'INLINE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiVision::Models::ImageDetails'
    end
