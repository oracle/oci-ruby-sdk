...
module OCI
  ...
  class AiVision::Models::ProjectCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::AiVision::Models::ProjectSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::AiVision::Models::ProjectSummary>] :items The value to assign to the {#items} property
