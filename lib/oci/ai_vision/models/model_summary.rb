...
module OCI
  ...
  class AiVision::Models::ModelSummary
    ...
    def hash
      [id, display_name, description, compartment_id, model_type, model_version, project_id, time_created, time_updated, lifecycle_state, lifecycle_details, precision, training_dataset, testing_dataset, validation_dataset, freeform_tags, defined_tags, system_tags].hash
    end
