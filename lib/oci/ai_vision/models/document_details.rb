...
module OCI
  ...
  class AiVision::Models::DocumentDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiVision::Models::ObjectStorageDocumentDetails' if type == 'OBJECT_STORAGE'
      return 'OCI::AiVision::Models::InlineDocumentDetails' if type == 'INLINE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiVision::Models::DocumentDetails'
    end
