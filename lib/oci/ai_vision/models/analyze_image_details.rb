...
module OCI
  ...
  class AiVision::Models::AnalyzeImageDetails
    ...
    def self.swagger_types
      {
        ...
        'image': :'OCI::AiVision::Models::ImageDetails',
    ...
    # @option attributes [OCI::AiVision::Models::ImageDetails] :image The value to assign to the {#image} property
    ...
    def hash
      [features, image, compartment_id].hash
    end
