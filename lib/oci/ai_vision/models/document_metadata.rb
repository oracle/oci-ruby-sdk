...
module OCI
  ...
  class AiVision::Models::DocumentMetadata
    ...
    # @option attributes [Integer] :page_count The value to assign to the {#page_count} property
    ...
    def initialize(attributes = {})
      ...
      self.page_count = attributes[:'pageCount'] if attributes[:'pageCount']

      raise 'You cannot provide both :pageCount and :page_count' if attributes.key?(:'pageCount') && attributes.key?(:'page_count')

      self.page_count = attributes[:'page_count'] if attributes[:'page_count']
