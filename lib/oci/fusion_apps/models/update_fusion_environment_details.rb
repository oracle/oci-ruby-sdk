...
module OCI
  ...
  class FusionApps::Models::UpdateFusionEnvironmentDetails
    ...
    # Network access control rules to limit internet traffic that can access the environment. For more information, see {#allow_rule allow_rule}.
    ...
    def hash
      [display_name, kms_key_id, maintenance_policy, additional_language_packs, rules, freeform_tags, defined_tags].hash
    end
