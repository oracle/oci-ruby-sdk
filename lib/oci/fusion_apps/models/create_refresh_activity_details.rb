...
module OCI
  ...
  class FusionApps::Models::CreateRefreshActivityDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
    #
    # @return [String]
    ...
    def hash
      [source_fusion_environment_id, time_scheduled_start].hash
    end
