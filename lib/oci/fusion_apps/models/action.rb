...
module OCI
  ...
  class FusionApps::Models::Action
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_QUARTERLY_UPGRADE = 'QUARTERLY_UPGRADE'.freeze,
      ACTION_TYPE_PATCH = 'PATCH'.freeze,
      ACTION_TYPE_VERTEX = 'VERTEX'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FusionApps::Models::PatchAction' if type == 'PATCH'
      return 'OCI::FusionApps::Models::UpgradeAction' if type == 'QUARTERLY_UPGRADE'
      return 'OCI::FusionApps::Models::VertexAction' if type == 'VERTEX'
    ...
    # @option attributes [String] :reference_key The value to assign to the {#reference_key} property
    ...
    def initialize(attributes = {})
      ...
      self.reference_key = attributes[:'referenceKey'] if attributes[:'referenceKey']

      raise 'You cannot provide both :referenceKey and :reference_key' if attributes.key?(:'referenceKey') && attributes.key?(:'reference_key')

      self.reference_key = attributes[:'reference_key'] if attributes[:'reference_key']
    ...
    def hash
      [reference_key, action_type, state, description].hash
    end
