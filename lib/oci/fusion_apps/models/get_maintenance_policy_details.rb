...
module OCI
  ...
  class FusionApps::Models::GetMaintenancePolicyDetails
    # @return [OCI::FusionApps::Models::QuarterlyUpgradeBeginTimes]
    ...
    # @return [String]
    attr_accessor :monthly_patching_override
    ...
    # @return [String]
    attr_accessor :environment_maintenance_override
    ...
    # @option attributes [OCI::FusionApps::Models::QuarterlyUpgradeBeginTimes] :quarterly_upgrade_begin_times The value to assign to the {#quarterly_upgrade_begin_times} property
    ...
    def hash
      [quarterly_upgrade_begin_times, monthly_patching_override, environment_maintenance_override].hash
    end
