...
module OCI
  ...
  #
  class FusionApps::Models::AllowRule < FusionApps::Models::Rule
    # This attribute is required.
    # @return [Array<OCI::FusionApps::Models::RuleCondition>]
    ...
    # @option attributes [Array<OCI::FusionApps::Models::RuleCondition>] :conditions The value to assign to the {#conditions} property
