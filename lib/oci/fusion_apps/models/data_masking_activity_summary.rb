...
module OCI
  ...
  class FusionApps::Models::DataMaskingActivitySummary
    ...
    # @option attributes [DateTime] :time_masking_start The value to assign to the {#time_masking_start} property
    # @option attributes [DateTime] :time_masking_finish The value to assign to the {#time_masking_finish} property
    ...
    def hash
      [id, lifecycle_state, time_masking_start, time_masking_finish].hash
    end
