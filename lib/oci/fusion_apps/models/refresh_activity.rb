...
module OCI
  ...
  class FusionApps::Models::RefreshActivity
    ...
    def hash
      [id, display_name, source_fusion_environment_id, time_of_restoration_point, lifecycle_state, service_availability, time_scheduled_start, time_expected_finish, time_finished, time_accepted, time_updated, refresh_issue_details_list, lifecycle_details].hash
    end
