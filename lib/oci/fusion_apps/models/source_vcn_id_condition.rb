...
module OCI
  ...
  #
  class FusionApps::Models::SourceVcnIdCondition < FusionApps::Models::RuleCondition
    # **[Required]** The OCID of the originating VCN that an incoming packet must match.
