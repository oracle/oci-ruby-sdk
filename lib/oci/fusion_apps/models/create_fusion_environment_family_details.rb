...
module OCI
  ...
  class FusionApps::Models::CreateFusionEnvironmentFamilyDetails
    ...
    def hash
      [display_name, family_maintenance_policy, compartment_id, subscription_ids, freeform_tags, defined_tags].hash
    end
