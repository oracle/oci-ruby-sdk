...
module OCI
  ...
  class FusionApps::Models::FusionEnvironmentStatus
    STATUS_ENUM = [
      STATUS_AVAILABLE = 'AVAILABLE'.freeze,
      STATUS_UNAVAILABLE = 'UNAVAILABLE'.freeze,
      STATUS_NOT_APPLICABLE = 'NOT_APPLICABLE'.freeze,
      STATUS_MAINTENANCE_IN_PROGRESS = 'MAINTENANCE_IN_PROGRESS'.freeze,
      STATUS_REFRESH_IN_PROGRESS = 'REFRESH_IN_PROGRESS'.freeze,
