...
module OCI
  ...
  class FusionApps::Models::UpdateFamilyMaintenancePolicyDetails
    ...
    # @return [String]
    attr_accessor :concurrent_maintenance
    ...
    def hash
      [is_monthly_patching_enabled, concurrent_maintenance].hash
    end
