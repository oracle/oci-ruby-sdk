...
module OCI
  ...
  class FusionApps::Models::UpgradeAction < FusionApps::Models::Action
    # name of the repo
    # @return [String]
    ...
    # @option attributes [String] :qualifier The value to assign to the {#qualifier} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['actionType'] = 'QUARTERLY_UPGRADE'
      ...
      self.qualifier = attributes[:'qualifier'] if attributes[:'qualifier']
    end
    ...
    def hash
      [reference_key, action_type, state, description, version, qualifier].hash
    end
