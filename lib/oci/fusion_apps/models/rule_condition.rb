...
module OCI
  ...
  class FusionApps::Models::RuleCondition
    ATTRIBUTE_NAME_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FusionApps::Models::SourceVcnIdCondition' if type == 'SOURCE_VCN_ID'
      return 'OCI::FusionApps::Models::SourceIpAddressCondition' if type == 'SOURCE_IP_ADDRESS'
      return 'OCI::FusionApps::Models::SourceVcnIpAddressCondition' if type == 'SOURCE_VCN_IP_ADDRESS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FusionApps::Models::RuleCondition'
    end
