...
module OCI
  ...
  class FusionApps::Models::FusionEnvironmentFamily
    ...
    def hash
      [id, display_name, family_maintenance_policy, compartment_id, subscription_ids, is_subscription_update_needed, time_created, lifecycle_state, lifecycle_details, system_name, freeform_tags, defined_tags].hash
    end
