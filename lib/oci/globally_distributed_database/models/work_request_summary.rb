...
module OCI
  ...
  class GloballyDistributedDatabase::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::GloballyDistributedDatabase::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::GloballyDistributedDatabase::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::GloballyDistributedDatabase::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
