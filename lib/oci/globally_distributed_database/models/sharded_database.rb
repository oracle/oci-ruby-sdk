...
module OCI
  ...
  class GloballyDistributedDatabase::Models::ShardedDatabase
    DB_DEPLOYMENT_TYPE_ENUM = [
      DB_DEPLOYMENT_TYPE_DEDICATED = 'DEDICATED'.freeze,
    ...
    # **[Required]** Identifier of the compartment in which sharded database exists.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The database deployment type.
    #
    # @return [String]
    attr_reader :db_deployment_type

    # **[Required]** Oracle sharded database display name.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The time the the Sharded Database was created. An RFC3339 formatted datetime string
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The time the Sharded Database was last updated. An RFC3339 formatted datetime string
    # @return [DateTime]
    attr_accessor :time_updated

    # **[Required]** Lifecycle states for sharded databases.
    # @return [String]
    attr_reader :lifecycle_state

    # **[Required]** Detailed message for the lifecycle state.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'dbDeploymentType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::GloballyDistributedDatabase::Models::DedicatedShardedDatabase' if type == 'DEDICATED'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GloballyDistributedDatabase::Models::ShardedDatabase'
    end
    ...
    def hash
      [id, compartment_id, db_deployment_type, display_name, time_created, time_updated, lifecycle_state, lifecycle_state_details, freeform_tags, defined_tags, system_tags].hash
    end
