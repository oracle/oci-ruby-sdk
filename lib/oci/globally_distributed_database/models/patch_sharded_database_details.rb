...
module OCI
  ...
  # single operation.
  #
  class GloballyDistributedDatabase::Models::PatchShardedDatabaseDetails
    # List of patch instructions.
    # @return [Array<OCI::GloballyDistributedDatabase::Models::PatchInstruction>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::GloballyDistributedDatabase::Models::PatchInstruction>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::GloballyDistributedDatabase::Models::PatchInstruction>] :items The value to assign to the {#items} property
