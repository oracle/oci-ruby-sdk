...
module OCI
  ...
  class GloballyDistributedDatabase::Models::PatchInstruction
    OPERATION_ENUM = [
    ...
    # **[Required]** The operation that need to be performed on an element inside list.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GloballyDistributedDatabase::Models::PatchRemoveInstruction' if type == 'REMOVE'
      return 'OCI::GloballyDistributedDatabase::Models::PatchInsertInstruction' if type == 'INSERT'
      return 'OCI::GloballyDistributedDatabase::Models::PatchMergeInstruction' if type == 'MERGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GloballyDistributedDatabase::Models::PatchInstruction'
    end
