...
module OCI
  ...
  class GloballyDistributedDatabase::Models::CreatePrivateEndpointDetails
    ...
    def hash
      [compartment_id, subnet_id, display_name, description, nsg_ids, freeform_tags, defined_tags].hash
    end
