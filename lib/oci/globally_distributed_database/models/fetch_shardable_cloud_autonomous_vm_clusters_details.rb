...
module OCI
  ...
  class GloballyDistributedDatabase::Models::FetchShardableCloudAutonomousVmClustersDetails
    ...
    # @option attributes [Integer] :minimum_available_cdb_count The value to assign to the {#minimum_available_cdb_count} property
    # @option attributes [BOOLEAN] :are_depleted_clusters_included The value to assign to the {#are_depleted_clusters_included} property
