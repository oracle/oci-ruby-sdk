...
module OCI
  ...
  class GloballyDistributedDatabase::Models::PrivateEndpoint
    ...
    # @return [Array<String>]
    attr_accessor :sharded_databases
    ...
    # @option attributes [Array<String>] :sharded_databases The value to assign to the {#sharded_databases} property
    ...
    def initialize(attributes = {})
      ...
      self.sharded_databases = attributes[:'shardedDatabases'] if attributes[:'shardedDatabases']

      raise 'You cannot provide both :shardedDatabases and :sharded_databases' if attributes.key?(:'shardedDatabases') && attributes.key?(:'sharded_databases')

      self.sharded_databases = attributes[:'sharded_databases'] if attributes[:'sharded_databases']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        sharded_databases == other.sharded_databases &&
    ...
    def hash
      [id, compartment_id, subnet_id, vcn_id, display_name, description, private_ip, nsg_ids, sharded_databases, time_created, time_updated, lifecycle_state, lifecycle_state_details, freeform_tags, defined_tags, system_tags].hash
    end
