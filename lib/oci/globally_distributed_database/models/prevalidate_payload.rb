...
module OCI
  ...
  class GloballyDistributedDatabase::Models::PrevalidatePayload
    OPERATION_ENUM = [
      OPERATION_CREATE = 'CREATE'.freeze,
      OPERATION_PATCH = 'PATCH'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GloballyDistributedDatabase::Models::PrevalidatePatchPayload' if type == 'PATCH'
      return 'OCI::GloballyDistributedDatabase::Models::PrevalidateCreatePayload' if type == 'CREATE'
