...
module OCI
  ...
  class GloballyDistributedDatabase::Models::ShardedDatabaseSummary
    ...
    # **[Required]** Identifier of the compartment where sharded database exists.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GloballyDistributedDatabase::Models::DedicatedShardedDatabaseSummary' if type == 'DEDICATED'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GloballyDistributedDatabase::Models::ShardedDatabaseSummary'
    end
