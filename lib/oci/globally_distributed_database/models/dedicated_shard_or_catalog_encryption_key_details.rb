...
module OCI
  ...
  #
  class GloballyDistributedDatabase::Models::DedicatedShardOrCatalogEncryptionKeyDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the vault in customer tenancy where KMS key is present.
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the KMS key in vault identified by vaultId in customer tenancy
    ...
    def hash
      [vault_id, kms_key_id, kms_key_version_id].hash
    end
