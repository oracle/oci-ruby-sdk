...
module OCI
  ...
  class Redis::Models::NodeCollection
    # **[Required]** Collection of node objects.
    # @return [Array<OCI::Redis::Models::Node>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Redis::Models::Node>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Redis::Models::Node>] :items The value to assign to the {#items} property
