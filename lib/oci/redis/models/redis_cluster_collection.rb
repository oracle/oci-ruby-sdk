...
module OCI
  ...
  class Redis::Models::RedisClusterCollection
    # **[Required]** The list of Redis clusters.
    # @return [Array<OCI::Redis::Models::RedisClusterSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Redis::Models::RedisClusterSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Redis::Models::RedisClusterSummary>] :items The value to assign to the {#items} property
