...
module OCI
  ...
  class Redis::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the work request.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the compartment that contains the work request.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The resources that are affected by the work request.
    # @return [Array<OCI::Redis::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Redis::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Redis::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
