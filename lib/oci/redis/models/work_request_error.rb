...
module OCI
  ...
  class Redis::Models::WorkRequestError
    # **[Required]** A machine-usable code for the error that occured. Error codes are listed at [API Errors](https://docs.cloud.oracle.com/iaas/Content/API/References/apierrors.htm).
    #
    # @return [String]
    attr_accessor :code
