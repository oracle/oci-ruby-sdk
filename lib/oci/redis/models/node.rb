...
module OCI
  ...
  class Redis::Models::Node
    ...
    # @option attributes [String] :private_endpoint_fqdn The value to assign to the {#private_endpoint_fqdn} property
    ...
    def initialize(attributes = {})
      ...
      self.private_endpoint_fqdn = attributes[:'privateEndpointFqdn'] if attributes[:'privateEndpointFqdn']

      raise 'You cannot provide both :privateEndpointFqdn and :private_endpoint_fqdn' if attributes.key?(:'privateEndpointFqdn') && attributes.key?(:'private_endpoint_fqdn')

      self.private_endpoint_fqdn = attributes[:'private_endpoint_fqdn'] if attributes[:'private_endpoint_fqdn']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        private_endpoint_fqdn == other.private_endpoint_fqdn &&
    ...
    def hash
      [private_endpoint_fqdn, private_endpoint_ip_address, display_name].hash
    end
