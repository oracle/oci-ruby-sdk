...
module OCI
  ...
  class Blockchain::Models::BlockchainPlatformSummary
    ...
    def hash
      [id, display_name, compartment_id, description, time_created, time_updated, platform_role, compute_shape, service_endpoint, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
