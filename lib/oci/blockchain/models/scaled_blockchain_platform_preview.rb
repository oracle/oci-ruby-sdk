...
module OCI
  ...
  class Blockchain::Models::ScaledBlockchainPlatformPreview
    ...
    # @return [Float]
    attr_accessor :storage_size_in_tbs_post_scaling
    ...
    # @return [OCI::Blockchain::Models::BlockchainPlatformComponentDetails]
    attr_accessor :component_details_post_scaling

    # @return [OCI::Blockchain::Models::ReplicaDetails]
    attr_accessor :replicas_post_scaling
    ...
    # @option attributes [Float] :storage_size_in_tbs_post_scaling The value to assign to the {#storage_size_in_tbs_post_scaling} property
    ...
    # @option attributes [OCI::Blockchain::Models::BlockchainPlatformComponentDetails] :component_details_post_scaling The value to assign to the {#component_details_post_scaling} property
    # @option attributes [OCI::Blockchain::Models::ReplicaDetails] :replicas_post_scaling The value to assign to the {#replicas_post_scaling} property
    ...
    # @option attributes [Array<OCI::Blockchain::Models::OcpuUtilizationInfo>] :host_ocpu_utilization_info_post_scaling The value to assign to the {#host_ocpu_utilization_info_post_scaling} property
    # @option attributes [Integer] :new_vm_count The value to assign to the {#new_vm_count} property
    # @option attributes [OCI::Blockchain::Models::ScaledPlatformMeteringPreview] :metering_preview The value to assign to the {#metering_preview} property
    # @option attributes [OCI::Blockchain::Models::ScaleBlockchainPlatformDetails] :scale_payload The value to assign to the {#scale_payload} property
