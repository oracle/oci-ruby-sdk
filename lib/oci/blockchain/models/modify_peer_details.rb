...
module OCI
  ...
  class Blockchain::Models::ModifyPeerDetails
    ...
    attr_accessor :ocpu_allocation_param
    ...
    # @option attributes [String] :peer_name The value to assign to the {#peer_name} property
    # @option attributes [OCI::Blockchain::Models::OcpuAllocationNumberParam] :ocpu_allocation_param The value to assign to the {#ocpu_allocation_param} property
    def initialize(attributes = {})
      ...
      self.peer_name = attributes[:'peerName'] if attributes[:'peerName']

      raise 'You cannot provide both :peerName and :peer_name' if attributes.key?(:'peerName') && attributes.key?(:'peer_name')

      self.peer_name = attributes[:'peer_name'] if attributes[:'peer_name']
    ...
    def hash
      [peer_name, ocpu_allocation_param].hash
    end
