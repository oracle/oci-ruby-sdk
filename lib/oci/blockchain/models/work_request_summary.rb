...
module OCI
  ...
  class Blockchain::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Blockchain::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::Blockchain::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
