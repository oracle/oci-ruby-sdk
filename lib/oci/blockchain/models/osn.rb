...
module OCI
  ...
  class Blockchain::Models::Osn
    ...
    # @option attributes [String] :osn_key The value to assign to the {#osn_key} property
    ...
    def initialize(attributes = {})
      ...
      self.osn_key = attributes[:'osnKey'] if attributes[:'osnKey']

      raise 'You cannot provide both :osnKey and :osn_key' if attributes.key?(:'osnKey') && attributes.key?(:'osn_key')

      self.osn_key = attributes[:'osn_key'] if attributes[:'osn_key']
    ...
    def hash
      [osn_key, ad, ocpu_allocation_param, lifecycle_state].hash
    end
