...
module OCI
  ...
  class Blockchain::Models::BlockchainPlatformByHostname
    ...
    def hash
      [id, service_endpoint, display_name, compartment_id, description, time_created, time_updated, platform_role, compute_shape, lifecycle_state, lifecycle_details, freeform_tags, defined_tags].hash
    end
