...
module OCI
  ...
  class Blockchain::Models::ScaleStorageDetails
    ...
    # @option attributes [Integer] :storage_size_in_tbs The value to assign to the {#storage_size_in_tbs} property
