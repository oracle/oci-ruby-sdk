...
module OCI
  ...
  #
  class GoldenGate::Models::GenericConnection < GoldenGate::Models::Connection
    ...
    # **[Required]** Host and port separated by colon.
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'GENERIC'
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, host].hash
    end
