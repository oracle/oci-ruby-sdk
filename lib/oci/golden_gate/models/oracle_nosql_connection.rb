...
module OCI
  ...
  #
  class GoldenGate::Models::OracleNosqlConnection < GoldenGate::Models::Connection
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the OCI user who will access the Oracle NoSQL database.
