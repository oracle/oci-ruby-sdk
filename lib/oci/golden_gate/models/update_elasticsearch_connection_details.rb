...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateElasticsearchConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, servers, security_protocol, authentication_type, username, password, fingerprint].hash
    end
