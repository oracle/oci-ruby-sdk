...
module OCI
  ...
  class GoldenGate::Models::CancelDeploymentBackupDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultCancelDeploymentBackupDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::CancelDeploymentBackupDetails'
    end
