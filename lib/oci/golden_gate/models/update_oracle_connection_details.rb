...
module OCI
  ...
  class GoldenGate::Models::UpdateOracleConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, username, password, connection_string, wallet, session_mode, private_ip, database_id].hash
    end
