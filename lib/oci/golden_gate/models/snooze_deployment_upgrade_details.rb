...
module OCI
  ...
  class GoldenGate::Models::SnoozeDeploymentUpgradeDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultSnoozeDeploymentUpgradeDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::SnoozeDeploymentUpgradeDetails'
    end
