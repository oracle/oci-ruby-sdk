...
module OCI
  ...
  class GoldenGate::Models::CreateDeploymentDetails
    ...
    def hash
      [display_name, license_model, description, compartment_id, freeform_tags, defined_tags, deployment_backup_id, subnet_id, fqdn, nsg_ids, is_public, cpu_core_count, is_auto_scaling_enabled, deployment_type, ogg_data, maintenance_window, maintenance_configuration].hash
    end
