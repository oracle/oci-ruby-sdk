...
module OCI
  ...
  class GoldenGate::Models::CreateDeploymentDetails
    ...
    # @return [OCI::GoldenGate::Models::CreateMaintenanceWindowDetails]
    attr_accessor :maintenance_window

    # @return [OCI::GoldenGate::Models::CreateMaintenanceConfigurationDetails]
    ...
    def self.swagger_types
      {
        ...
        'maintenance_window': :'OCI::GoldenGate::Models::CreateMaintenanceWindowDetails',
        'maintenance_configuration': :'OCI::GoldenGate::Models::CreateMaintenanceConfigurationDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::CreateMaintenanceWindowDetails] :maintenance_window The value to assign to the {#maintenance_window} property
    # @option attributes [OCI::GoldenGate::Models::CreateMaintenanceConfigurationDetails] :maintenance_configuration The value to assign to the {#maintenance_configuration} property
    ...
    def hash
      [display_name, license_model, description, compartment_id, freeform_tags, defined_tags, deployment_backup_id, subnet_id, load_balancer_subnet_id, fqdn, nsg_ids, is_public, cpu_core_count, is_auto_scaling_enabled, deployment_type, ogg_data, maintenance_window, maintenance_configuration].hash
    end
