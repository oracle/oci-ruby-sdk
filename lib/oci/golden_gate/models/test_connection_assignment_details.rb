...
module OCI
  ...
  class GoldenGate::Models::TestConnectionAssignmentDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultTestConnectionAssignmentDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::TestConnectionAssignmentDetails'
    end
