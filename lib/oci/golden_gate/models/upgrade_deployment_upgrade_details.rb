...
module OCI
  ...
  class GoldenGate::Models::UpgradeDeploymentUpgradeDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultUpgradeDeploymentUpgradeDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::UpgradeDeploymentUpgradeDetails'
    end
