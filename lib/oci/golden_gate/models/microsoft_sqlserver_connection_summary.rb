...
module OCI
  ...
  class GoldenGate::Models::MicrosoftSqlserverConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, subnet_id, ingress_ips, nsg_ids, technology_type, database_name, host, port, username, additional_attributes, security_protocol, ssl_ca, should_validate_server_certificate, private_ip].hash
    end
