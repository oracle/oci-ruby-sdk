...
module OCI
  ...
  #
  class GoldenGate::Models::MicrosoftSqlserverConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    # **[Required]** The username Oracle GoldenGate uses to connect to the Microsoft SQL Server.
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :should_validate_server_certificate
    ...
    def self.swagger_types
      {
        ...
        'ssl_ca': :'String',
        'should_validate_server_certificate': :'BOOLEAN',
        'private_ip': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [BOOLEAN] :should_validate_server_certificate The value to assign to the {#should_validate_server_certificate} property
    # @option attributes [String] :private_ip The value to assign to the {#private_ip} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['connectionType'] = 'MICROSOFT_SQLSERVER'
      ...
      self.should_validate_server_certificate = attributes[:'shouldValidateServerCertificate'] unless attributes[:'shouldValidateServerCertificate'].nil?

      raise 'You cannot provide both :shouldValidateServerCertificate and :should_validate_server_certificate' if attributes.key?(:'shouldValidateServerCertificate') && attributes.key?(:'should_validate_server_certificate')

      self.should_validate_server_certificate = attributes[:'should_validate_server_certificate'] unless attributes[:'should_validate_server_certificate'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ssl_ca == other.ssl_ca &&
        should_validate_server_certificate == other.should_validate_server_certificate &&
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, database_name, host, port, username, additional_attributes, security_protocol, ssl_ca, should_validate_server_certificate, private_ip].hash
    end
