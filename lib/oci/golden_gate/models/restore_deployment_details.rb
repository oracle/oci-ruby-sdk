...
module OCI
  ...
  class GoldenGate::Models::RestoreDeploymentDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultRestoreDeploymentDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::RestoreDeploymentDetails'
    end
