...
module OCI
  ...
  #
  class GoldenGate::Models::AzureDataLakeStorageConnection < GoldenGate::Models::Connection
    ...
    AUTHENTICATION_TYPE_ENUM = [
      AUTHENTICATION_TYPE_SHARED_KEY = 'SHARED_KEY'.freeze,
      AUTHENTICATION_TYPE_SHARED_ACCESS_SIGNATURE = 'SHARED_ACCESS_SIGNATURE'.freeze,
      AUTHENTICATION_TYPE_AZURE_ACTIVE_DIRECTORY = 'AZURE_ACTIVE_DIRECTORY'.freeze,
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, subnet_id, ingress_ips, nsg_ids, technology_type, authentication_type, account_name, azure_tenant_id, client_id, endpoint].hash
    end
