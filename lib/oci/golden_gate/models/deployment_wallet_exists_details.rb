...
module OCI
  ...
  class GoldenGate::Models::DeploymentWalletExistsDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultDeploymentWalletExistsDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::DeploymentWalletExistsDetails'
    end
