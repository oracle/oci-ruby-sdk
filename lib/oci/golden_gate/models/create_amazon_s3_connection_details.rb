...
module OCI
  ...
  #
  class GoldenGate::Models::CreateAmazonS3ConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    # **[Required]** Secret access key to access the Amazon S3 bucket.
    # e.g.: \"this-is-not-the-secret\"
    #
    # @return [String]
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, access_key_id, secret_access_key].hash
    end
