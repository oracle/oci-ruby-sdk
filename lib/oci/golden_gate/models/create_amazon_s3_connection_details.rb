...
module OCI
  ...
  class GoldenGate::Models::CreateAmazonS3ConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, technology_type, access_key_id, secret_access_key].hash
    end
