...
module OCI
  ...
  #
  class GoldenGate::Models::CreateDeploymentBackupDetails
    ...
    def hash
      [display_name, compartment_id, deployment_id, namespace_name, bucket_name, object_name, freeform_tags, defined_tags].hash
    end
