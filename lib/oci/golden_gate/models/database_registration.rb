...
module OCI
  ...
  class GoldenGate::Models::DatabaseRegistration
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, fqdn, ip_address, subnet_id, database_id, rce_private_ip, system_tags, username, connection_string, alias_name, vault_id, key_id, secret_compartment_id, secret_id].hash
    end
