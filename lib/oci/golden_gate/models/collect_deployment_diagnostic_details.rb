...
module OCI
  ...
  #
  class GoldenGate::Models::CollectDeploymentDiagnosticDetails
    ...
    # @return [String]
    attr_accessor :diagnostic_name_prefix
    ...
    # @option attributes [String] :diagnostic_name_prefix The value to assign to the {#diagnostic_name_prefix} property
    ...
    def initialize(attributes = {})
      ...
      self.diagnostic_name_prefix = attributes[:'diagnosticNamePrefix'] if attributes[:'diagnosticNamePrefix']

      raise 'You cannot provide both :diagnosticNamePrefix and :diagnostic_name_prefix' if attributes.key?(:'diagnosticNamePrefix') && attributes.key?(:'diagnostic_name_prefix')

      self.diagnostic_name_prefix = attributes[:'diagnostic_name_prefix'] if attributes[:'diagnostic_name_prefix']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        diagnostic_name_prefix == other.diagnostic_name_prefix &&
    ...
    def hash
      [namespace_name, bucket_name, diagnostic_name_prefix, time_diagnostic_start, time_diagnostic_end].hash
    end
