...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateOciObjectStorageConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, tenancy_id, region, user_id, private_key_file, private_key_passphrase, public_key_fingerprint].hash
    end
