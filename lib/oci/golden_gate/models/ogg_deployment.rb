...
module OCI
  ...
  class GoldenGate::Models::OggDeployment
    CREDENTIAL_STORE_ENUM = [
      ...
      CREDENTIAL_STORE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def credential_store=(credential_store)
      ...
      if credential_store && !CREDENTIAL_STORE_ENUM.include?(credential_store)
        OCI.logger.debug("Unknown value for 'credential_store' [" + credential_store + "]. Mapping to 'CREDENTIAL_STORE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @credential_store = CREDENTIAL_STORE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [deployment_name, admin_username, ogg_version, certificate, credential_store, identity_domain_id, password_secret_id].hash
    end
