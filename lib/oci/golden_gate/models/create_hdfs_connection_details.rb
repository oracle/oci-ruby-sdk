...
module OCI
  ...
  #
  class GoldenGate::Models::CreateHdfsConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    # @option attributes [String] :core_site_xml The value to assign to the {#core_site_xml} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['connectionType'] = 'HDFS'
      ...
      self.core_site_xml = attributes[:'coreSiteXml'] if attributes[:'coreSiteXml']

      raise 'You cannot provide both :coreSiteXml and :core_site_xml' if attributes.key?(:'coreSiteXml') && attributes.key?(:'core_site_xml')

      self.core_site_xml = attributes[:'core_site_xml'] if attributes[:'core_site_xml']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        core_site_xml == other.core_site_xml
    end
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, core_site_xml].hash
    end
