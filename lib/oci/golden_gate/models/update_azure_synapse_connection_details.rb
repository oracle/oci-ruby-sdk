...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateAzureSynapseConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, connection_string, username, password].hash
    end
