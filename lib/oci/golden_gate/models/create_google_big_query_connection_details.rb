...
module OCI
  ...
  #
  class GoldenGate::Models::CreateGoogleBigQueryConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, technology_type, service_account_key_file].hash
    end
