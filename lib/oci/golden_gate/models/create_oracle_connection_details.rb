...
module OCI
  ...
  class GoldenGate::Models::CreateOracleConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, technology_type, username, password, connection_string, wallet, session_mode, private_ip, database_id].hash
    end
