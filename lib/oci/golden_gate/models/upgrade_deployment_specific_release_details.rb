...
module OCI
  ...
  class GoldenGate::Models::UpgradeDeploymentSpecificReleaseDetails < GoldenGate::Models::UpgradeDeploymentDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'SPECIFIC_RELEASE'
