...
module OCI
  ...
  class GoldenGate::Models::StopDeploymentDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultStopDeploymentDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::StopDeploymentDetails'
    end
