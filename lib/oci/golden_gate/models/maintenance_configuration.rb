...
module OCI
  ...
  #
  class GoldenGate::Models::MaintenanceConfiguration
    # **[Required]** By default auto upgrade for interim releases are not enabled. If auto-upgrade is enabled for interim release,
    ...
    #
    # @return [Integer]
    attr_accessor :interim_release_upgrade_period_in_days

    # **[Required]** Defines auto upgrade period for bundle releases. Manually configured period cannot be longer than service defined period for bundle releases.
    ...
    #
    # @return [Integer]
    attr_accessor :bundle_release_upgrade_period_in_days

    # **[Required]** Defines auto upgrade period for major releases. Manually configured period cannot be longer than service defined period for major releases.
    # Not passing this field during create will equate to using the service default.
    #
    # @return [Integer]
    attr_accessor :major_release_upgrade_period_in_days

    # **[Required]** Defines auto upgrade period for releases with security fix. Manually configured period cannot be longer than service defined period for security releases.
    # Not passing this field during create will equate to using the service default.
    #
    # @return [Integer]
    attr_accessor :security_patch_upgrade_period_in_days
    ...
    # @option attributes [BOOLEAN] :is_interim_release_auto_upgrade_enabled The value to assign to the {#is_interim_release_auto_upgrade_enabled} property
    # @option attributes [Integer] :interim_release_upgrade_period_in_days The value to assign to the {#interim_release_upgrade_period_in_days} property
    # @option attributes [Integer] :bundle_release_upgrade_period_in_days The value to assign to the {#bundle_release_upgrade_period_in_days} property
    # @option attributes [Integer] :major_release_upgrade_period_in_days The value to assign to the {#major_release_upgrade_period_in_days} property
    # @option attributes [Integer] :security_patch_upgrade_period_in_days The value to assign to the {#security_patch_upgrade_period_in_days} property
