...
module OCI
  ...
  class GoldenGate::Models::CancelSnoozeDeploymentUpgradeDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultCancelSnoozeDeploymentUpgradeDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::CancelSnoozeDeploymentUpgradeDetails'
    end
