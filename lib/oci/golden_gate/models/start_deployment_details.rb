...
module OCI
  ...
  class GoldenGate::Models::StartDeploymentDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultStartDeploymentDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::StartDeploymentDetails'
    end
