...
module OCI
  ...
  class GoldenGate::Models::CancelDeploymentUpgradeDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultCancelDeploymentUpgradeDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::CancelDeploymentUpgradeDetails'
    end
