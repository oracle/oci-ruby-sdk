...
module OCI
  ...
  class GoldenGate::Models::CreateElasticsearchConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, technology_type, servers, security_protocol, authentication_type, username, password, fingerprint].hash
    end
