...
module OCI
  ...
  #
  class GoldenGate::Models::CreateOciObjectStorageConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'OCI_OBJECT_STORAGE'
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, tenancy_id, region, user_id, private_key_file, private_key_passphrase, public_key_fingerprint].hash
    end
