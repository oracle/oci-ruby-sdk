...
module OCI
  ...
  #
  class GoldenGate::Models::KafkaConnection < GoldenGate::Models::Connection
    ...
    SECURITY_PROTOCOL_ENUM = [
      SECURITY_PROTOCOL_SSL = 'SSL'.freeze,
      SECURITY_PROTOCOL_SASL_SSL = 'SASL_SSL'.freeze,
      SECURITY_PROTOCOL_PLAINTEXT = 'PLAINTEXT'.freeze,
      SECURITY_PROTOCOL_SASL_PLAINTEXT = 'SASL_PLAINTEXT'.freeze,
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, stream_pool_id, bootstrap_servers, security_protocol, username].hash
    end
