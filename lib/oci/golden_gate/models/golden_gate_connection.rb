...
module OCI
  ...
  #
  class GoldenGate::Models::GoldenGateConnection < GoldenGate::Models::Connection
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'GOLDENGATE'
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, deployment_id, host, port, username, private_ip].hash
    end
