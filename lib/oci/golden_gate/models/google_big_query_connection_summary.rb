...
module OCI
  ...
  class GoldenGate::Models::GoogleBigQueryConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, technology_type].hash
    end
