...
module OCI
  ...
  #
  class GoldenGate::Models::RedisConnection < GoldenGate::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, servers, security_protocol, authentication_type, username].hash
    end
