...
module OCI
  ...
  class GoldenGate::Models::CreateAzureDataLakeStorageConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, subnet_id, nsg_ids, technology_type, authentication_type, account_name, account_key, sas_token, azure_tenant_id, client_id, client_secret, endpoint].hash
    end
