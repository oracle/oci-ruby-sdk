...
module OCI
  ...
  #
  class GoldenGate::Models::SnowflakeConnection < GoldenGate::Models::Connection
    ...
    AUTHENTICATION_TYPE_ENUM = [
      ...
      AUTHENTICATION_TYPE_KEY_PAIR = 'KEY_PAIR'.freeze,
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, connection_url, authentication_type, username].hash
    end
