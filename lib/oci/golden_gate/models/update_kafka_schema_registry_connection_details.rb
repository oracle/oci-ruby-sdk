...
module OCI
  ...
  class GoldenGate::Models::UpdateKafkaSchemaRegistryConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, url, authentication_type, username, password, trust_store, trust_store_password, key_store, key_store_password, ssl_key_password, private_ip].hash
    end
