...
module OCI
  ...
  #
  class GoldenGate::Models::MongoDbConnection < GoldenGate::Models::Connection
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'MONGODB'
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, technology_type, connection_string, username, database_id].hash
    end
