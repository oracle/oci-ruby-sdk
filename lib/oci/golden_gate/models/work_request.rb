...
module OCI
  ...
  #
  class GoldenGate::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
    ...
    #
    # @return [Array<OCI::GoldenGate::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::GoldenGate::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::GoldenGate::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
