...
module OCI
  ...
  class GoldenGate::Models::WorkRequest
    ...
    # **[Required]** The ocid of the compartment that contains the work request. Work requests should be scoped
    ...
    # **[Required]** The date and time the request was created. The format is defined by
