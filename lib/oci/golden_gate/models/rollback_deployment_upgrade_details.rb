...
module OCI
  ...
  class GoldenGate::Models::RollbackDeploymentUpgradeDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::DefaultRollbackDeploymentUpgradeDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::RollbackDeploymentUpgradeDetails'
    end
