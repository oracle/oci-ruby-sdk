...
module OCI
  ...
  #
  class GoldenGate::Models::TestConnectionAssignmentResult
    RESULT_TYPE_ENUM = [
    ...
    # @return [OCI::GoldenGate::Models::TestConnectionAssignmentError]
    attr_accessor :error
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'result_type': :'String',
        'error': :'OCI::GoldenGate::Models::TestConnectionAssignmentError'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::TestConnectionAssignmentError] :error The value to assign to the {#error} property
