...
module OCI
  ...
  class GoldenGate::Models::DeploymentSummary
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, subnet_id, license_model, fqdn, cpu_core_count, is_auto_scaling_enabled, is_public, public_ip_address, private_ip_address, deployment_url, system_tags, is_latest_version, deployment_type].hash
    end
