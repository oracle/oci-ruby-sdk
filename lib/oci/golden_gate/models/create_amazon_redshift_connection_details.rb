...
module OCI
  ...
  #
  class GoldenGate::Models::CreateAmazonRedshiftConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, connection_url, username, password].hash
    end
