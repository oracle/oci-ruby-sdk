...
module OCI
  ...
  class GoldenGate::Models::UpdateMysqlConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, username, password, host, port, database_name, security_protocol, ssl_mode, ssl_ca, ssl_crl, ssl_cert, ssl_key, private_ip, additional_attributes, db_system_id].hash
    end
