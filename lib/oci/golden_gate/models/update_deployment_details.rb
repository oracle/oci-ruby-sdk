...
module OCI
  ...
  class GoldenGate::Models::UpdateDeploymentDetails
    ...
    # @return [OCI::GoldenGate::Models::UpdateMaintenanceWindowDetails]
    attr_accessor :maintenance_window

    # @return [OCI::GoldenGate::Models::UpdateMaintenanceConfigurationDetails]
    ...
    def self.swagger_types
      {
        ...
        'maintenance_window': :'OCI::GoldenGate::Models::UpdateMaintenanceWindowDetails',
        'maintenance_configuration': :'OCI::GoldenGate::Models::UpdateMaintenanceConfigurationDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::UpdateMaintenanceWindowDetails] :maintenance_window The value to assign to the {#maintenance_window} property
    # @option attributes [OCI::GoldenGate::Models::UpdateMaintenanceConfigurationDetails] :maintenance_configuration The value to assign to the {#maintenance_configuration} property
    ...
    def hash
      [display_name, license_model, description, freeform_tags, defined_tags, nsg_ids, subnet_id, is_public, fqdn, cpu_core_count, is_auto_scaling_enabled, ogg_data, maintenance_window, maintenance_configuration].hash
    end
