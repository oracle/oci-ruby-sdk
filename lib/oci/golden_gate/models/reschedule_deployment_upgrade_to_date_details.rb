...
require 'date'
require_relative 'reschedule_deployment_upgrade_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Definition of the additional attributes for default deployment upgrade cancel.
  class GoldenGate::Models::RescheduleDeploymentUpgradeToDateDetails < GoldenGate::Models::RescheduleDeploymentUpgradeDetails
    # **[Required]** The time of upgrade schedule. The format is defined by
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'RESCHEDULE_TO_DATE'
