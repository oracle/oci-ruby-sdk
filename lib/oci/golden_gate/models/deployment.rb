...
module OCI
  ...
  class GoldenGate::Models::Deployment
    ...
    def hash
      [id, display_name, description, compartment_id, deployment_backup_id, time_created, time_updated, lifecycle_state, lifecycle_sub_state, lifecycle_details, freeform_tags, defined_tags, is_healthy, subnet_id, load_balancer_subnet_id, load_balancer_id, fqdn, license_model, cpu_core_count, is_auto_scaling_enabled, nsg_ids, is_public, public_ip_address, private_ip_address, deployment_url, system_tags, is_latest_version, time_upgrade_required, storage_utilization_in_bytes, is_storage_utilization_limit_exceeded, deployment_type, ogg_data, deployment_diagnostic_data, maintenance_window, time_of_next_maintenance, next_maintenance_action_type, next_maintenance_description, maintenance_configuration, time_ogg_version_supported_until, ingress_ips].hash
    end
