...
module OCI
  ...
  class NetworkFirewall::Models::UpdateServiceDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::UpdateTcpServiceDetails' if type == 'TCP_SERVICE'
      return 'OCI::NetworkFirewall::Models::UpdateUdpServiceDetails' if type == 'UDP_SERVICE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::NetworkFirewall::Models::UpdateServiceDetails'
    end
