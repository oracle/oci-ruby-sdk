...
module OCI
  ...
  class NetworkFirewall::Models::ApplyNetworkFirewallPolicyDetails
    ...
    # @option attributes [Array<String>] :firewalls The value to assign to the {#firewalls} property
    def initialize(attributes = {})
      ...
      self.firewalls = attributes[:'firewalls'] if attributes[:'firewalls']
    end
