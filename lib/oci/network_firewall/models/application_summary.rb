...
module OCI
  ...
  class NetworkFirewall::Models::ApplicationSummary
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::Icmp6ApplicationSummary' if type == 'ICMP_V6'
      return 'OCI::NetworkFirewall::Models::IcmpApplicationSummary' if type == 'ICMP'

      # TODO: Log a warning when the subtype is not found.
      'OCI::NetworkFirewall::Models::ApplicationSummary'
    end
