...
require 'date'
require_relative 'update_decryption_profile_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Update Request for SSLInboundInspection used on the firewall policy rules.
  class NetworkFirewall::Models::UpdateSslInboundInspectionProfileDetails < NetworkFirewall::Models::UpdateDecryptionProfileDetails
