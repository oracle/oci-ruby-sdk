...
module OCI
  ...
  class NetworkFirewall::Models::VaultMappedSecret < NetworkFirewall::Models::MappedSecret
    ...
    # @option attributes [String] :name The value to assign to the {OCI::NetworkFirewall::Models::MappedSecret#name #name} proprety
    # @option attributes [String] :type The value to assign to the {OCI::NetworkFirewall::Models::MappedSecret#type #type} proprety
    # @option attributes [String] :parent_resource_id The value to assign to the {OCI::NetworkFirewall::Models::MappedSecret#parent_resource_id #parent_resource_id} proprety
    ...
    def hash
      [name, source, type, parent_resource_id, vault_secret_id, version_number].hash
    end
