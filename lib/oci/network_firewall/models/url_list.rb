...
module OCI
  ...
  class NetworkFirewall::Models::UrlList
    ...
    # @option attributes [Array<OCI::NetworkFirewall::Models::UrlPattern>] :urls The value to assign to the {#urls} property
    # @option attributes [Integer] :total_urls The value to assign to the {#total_urls} property
    ...
    def initialize(attributes = {})
      ...
      self.total_urls = attributes[:'totalUrls'] if attributes[:'totalUrls']

      raise 'You cannot provide both :totalUrls and :total_urls' if attributes.key?(:'totalUrls') && attributes.key?(:'total_urls')

      self.total_urls = attributes[:'total_urls'] if attributes[:'total_urls']
    ...
    def hash
      [name, urls, total_urls, parent_resource_id].hash
    end
