...
module OCI
  ...
  class NetworkFirewall::Models::CreateNetworkFirewallDetails
    ...
    def hash
      [display_name, compartment_id, subnet_id, availability_domain, network_firewall_policy_id, ipv4_address, ipv6_address, network_security_group_ids, freeform_tags, defined_tags].hash
    end
