...
require 'date'
require_relative 'create_mapped_secret_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The request details to be created in the Vault Mapped Secret for the policy.
  class NetworkFirewall::Models::CreateVaultMappedSecretDetails < NetworkFirewall::Models::CreateMappedSecretDetails
    ...
    # @option attributes [String] :name The value to assign to the {OCI::NetworkFirewall::Models::CreateMappedSecretDetails#name #name} proprety
    # @option attributes [String] :type The value to assign to the {OCI::NetworkFirewall::Models::CreateMappedSecretDetails#type #type} proprety
