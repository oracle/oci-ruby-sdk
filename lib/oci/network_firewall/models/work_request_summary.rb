...
module OCI
  ...
  class NetworkFirewall::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::NetworkFirewall::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::NetworkFirewall::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::NetworkFirewall::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
