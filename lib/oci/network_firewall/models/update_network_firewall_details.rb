...
module OCI
  ...
  class NetworkFirewall::Models::UpdateNetworkFirewallDetails
    ...
    def hash
      [display_name, network_firewall_policy_id, network_security_group_ids, freeform_tags, defined_tags].hash
    end
