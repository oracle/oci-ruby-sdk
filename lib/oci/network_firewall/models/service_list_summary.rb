...
module OCI
  ...
  class NetworkFirewall::Models::ServiceListSummary
    ...
    # @option attributes [Integer] :total_services The value to assign to the {#total_services} property
    ...
    def hash
      [name, total_services, parent_resource_id].hash
    end
