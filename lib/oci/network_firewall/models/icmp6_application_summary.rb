...
require 'date'
require_relative 'application_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Summary object for ICMP V6 application element in the network firewall policy.
  class NetworkFirewall::Models::Icmp6ApplicationSummary < NetworkFirewall::Models::ApplicationSummary
    ...
    # @option attributes [String] :name The value to assign to the {OCI::NetworkFirewall::Models::ApplicationSummary#name #name} proprety
    # @option attributes [String] :parent_resource_id The value to assign to the {OCI::NetworkFirewall::Models::ApplicationSummary#parent_resource_id #parent_resource_id} proprety
