...
module OCI
  ...
  class NetworkFirewall::Models::UpdateNetworkFirewallPolicyDetails
    ...
    def hash
      [display_name, mapped_secrets, application_lists, url_lists, ip_address_lists, security_rules, decryption_rules, decryption_profiles, freeform_tags, defined_tags].hash
    end
