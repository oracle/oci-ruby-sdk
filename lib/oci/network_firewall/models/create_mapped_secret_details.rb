...
module OCI
  ...
  class NetworkFirewall::Models::CreateMappedSecretDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::CreateVaultMappedSecretDetails' if type == 'OCI_VAULT'
