...
require 'date'
require_relative 'create_application_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Request for ICMP6 Application used on the firewall policy rules.
  class NetworkFirewall::Models::CreateIcmp6ApplicationDetails < NetworkFirewall::Models::CreateApplicationDetails
    ...
    # @option attributes [String] :name The value to assign to the {OCI::NetworkFirewall::Models::CreateApplicationDetails#name #name} proprety
    ...
    def hash
      [name, type, icmp_type, icmp_code].hash
    end
