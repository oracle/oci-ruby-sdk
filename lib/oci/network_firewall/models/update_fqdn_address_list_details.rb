...
require 'date'
require_relative 'update_address_list_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The request details to be updated in the address List for the policy.
  class NetworkFirewall::Models::UpdateFqdnAddressListDetails < NetworkFirewall::Models::UpdateAddressListDetails
