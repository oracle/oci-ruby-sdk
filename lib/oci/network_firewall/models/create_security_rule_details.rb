...
module OCI
  ...
  #
  class NetworkFirewall::Models::CreateSecurityRuleDetails
    ACTION_ENUM = [
    ...
    def inspection=(inspection)
      raise "Invalid value for 'inspection': this must be one of the values in INSPECTION_ENUM." if inspection && !INSPECTION_ENUM.include?(inspection)
    ...
    def hash
      [name, condition, action, inspection, position].hash
    end
