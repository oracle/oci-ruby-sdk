...
module OCI
  ...
  class NetworkFirewall::Models::UpdateAddressListDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::UpdateFqdnAddressListDetails' if type == 'FQDN'
      return 'OCI::NetworkFirewall::Models::UpdateIpAddressListDetails' if type == 'IP'

      # TODO: Log a warning when the subtype is not found.
      'OCI::NetworkFirewall::Models::UpdateAddressListDetails'
    end
