...
module OCI
  ...
  class NetworkFirewall::Models::NetworkFirewallPolicySummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
