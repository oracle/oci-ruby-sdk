...
module OCI
  ...
  #
  class NetworkFirewall::Models::ApplicationGroup
    ...
    # @option attributes [Array<String>] :apps The value to assign to the {#apps} property
    # @option attributes [Integer] :total_apps The value to assign to the {#total_apps} property
    ...
    def initialize(attributes = {})
      ...
      self.apps = attributes[:'apps'] if attributes[:'apps']

      self.total_apps = attributes[:'totalApps'] if attributes[:'totalApps']

      raise 'You cannot provide both :totalApps and :total_apps' if attributes.key?(:'totalApps') && attributes.key?(:'total_apps')

      self.total_apps = attributes[:'total_apps'] if attributes[:'total_apps']
    ...
    def hash
      [name, apps, total_apps, parent_resource_id].hash
    end
