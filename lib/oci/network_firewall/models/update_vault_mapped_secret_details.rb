...
require 'date'
require_relative 'update_mapped_secret_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The request details to be updated in the Vault Mapped Secret for the policy.
  class NetworkFirewall::Models::UpdateVaultMappedSecretDetails < NetworkFirewall::Models::UpdateMappedSecretDetails
    ...
    # @option attributes [String] :type The value to assign to the {OCI::NetworkFirewall::Models::UpdateMappedSecretDetails#type #type} proprety
