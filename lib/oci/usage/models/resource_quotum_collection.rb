...
module OCI
  ...
  class Usage::Models::ResourceQuotumCollection
    # **[Required]** The list of resource quota details.
    # @return [Array<OCI::Usage::Models::ResourceQuotumSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Usage::Models::ResourceQuotumSummary>',
        'is_allowed': :'BOOLEAN'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Usage::Models::ResourceQuotumSummary>] :items The value to assign to the {#items} property
