...
module OCI
  ...
  class Usage::Models::RewardDetails
    ...
    def initialize(attributes = {})
      ...
      self.rewards_rate = attributes[:'rewardsRate'] if attributes[:'rewardsRate']

      raise 'You cannot provide both :rewardsRate and :rewards_rate' if attributes.key?(:'rewardsRate') && attributes.key?(:'rewards_rate')

      self.rewards_rate = attributes[:'rewards_rate'] if attributes[:'rewards_rate']

      self.total_rewards_available = attributes[:'totalRewardsAvailable'] if attributes[:'totalRewardsAvailable']
