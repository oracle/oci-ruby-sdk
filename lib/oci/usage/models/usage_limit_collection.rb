...
module OCI
  ...
  class Usage::Models::UsageLimitCollection
    # **[Required]** The list of usage limits.
    # @return [Array<OCI::Usage::Models::UsageLimitSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Usage::Models::UsageLimitSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Usage::Models::UsageLimitSummary>] :items The value to assign to the {#items} property
