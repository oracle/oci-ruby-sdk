...
module OCI
  ...
  class Usage::Models::RedemptionCollection
    # **[Required]** The list of redemption summary.
    # @return [Array<OCI::Usage::Models::RedemptionSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Usage::Models::RedemptionSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Usage::Models::RedemptionSummary>] :items The value to assign to the {#items} property
