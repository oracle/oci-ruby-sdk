...
module OCI
  ...
  class Usage::Models::ProductSummary
    ...
    # @option attributes [String] :product_number The value to assign to the {#product_number} property
    ...
    # @option attributes [BOOLEAN] :is_eligible_to_earn_rewards The value to assign to the {#is_eligible_to_earn_rewards} property
