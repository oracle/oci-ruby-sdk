...
module OCI
  ...
  class Usage::UsagelimitsClient
    ...
    # Creates a new UsagelimitsClient.
    # Notes:
    ...
    def initialize(config: nil, region: nil, endpoint: nil, signer: nil, proxy_settings: nil, retry_config: nil)
      ...
      logger.info "UsagelimitsClient endpoint set to '#{@endpoint}'." if logger
    end
    ...
    def region=(new_region)
      ...
      logger.info "UsagelimitsClient endpoint set to '#{@endpoint} from region #{@region}'." if logger
    end
    ...
    # @option opts [String] :limit_type Hard or soft limit. Hard limits lead to breaches, soft to alerts.
    # @option opts [String] :resource_type Resource Name.
    # @option opts [String] :service_type Service Name.
    ...
    # @return [Response] A Response object with data of type {OCI::Usage::Models::UsageLimitCollection UsageLimitCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/usage/list_usage_limits.rb.html) to see an example of how to use list_usage_limits API.
    def list_usage_limits(compartment_id, subscription_id, opts = {})
      logger.debug 'Calling operation UsagelimitsClient#list_usage_limits.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_usage_limits." if compartment_id.nil?
      raise "Missing the required parameter 'subscription_id' when calling list_usage_limits." if subscription_id.nil?
      ...
      query_params[:limitType] = opts[:limit_type] if opts[:limit_type]
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'UsagelimitsClient#list_usage_limits') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          body: post_body,
          return_type: 'OCI::Usage::Models::UsageLimitCollection'
        )
      end
