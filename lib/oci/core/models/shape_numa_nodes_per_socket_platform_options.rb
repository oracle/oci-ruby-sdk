...
module OCI
  ...
  #
  class Core::Models::ShapeNumaNodesPerSocketPlatformOptions
    ALLOWED_VALUES_ENUM = [
      ALLOWED_VALUES_NPS0 = 'NPS0'.freeze,
      ALLOWED_VALUES_NPS1 = 'NPS1'.freeze,
      ALLOWED_VALUES_NPS2 = 'NPS2'.freeze,
      ALLOWED_VALUES_NPS4 = 'NPS4'.freeze,
      ALLOWED_VALUES_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @param [Object] allowed_values Object to be assigned
    def allowed_values=(allowed_values)
      ...
      if allowed_values.nil?
        ...
        @allowed_values =
          allowed_values.collect do |item|
            if ALLOWED_VALUES_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'allowed_values' [#{item}]. Mapping to 'ALLOWED_VALUES_UNKNOWN_ENUM_VALUE'") if OCI.logger
              ALLOWED_VALUES_UNKNOWN_ENUM_VALUE
            end
          end
      end
    ...
    def hash
      [allowed_values, default_value].hash
    end
