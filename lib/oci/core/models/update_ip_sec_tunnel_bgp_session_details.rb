...
module OCI
  ...
  class Core::Models::UpdateIPSecTunnelBgpSessionDetails
    # The IP address for the Oracle end of the inside tunnel interface.
    #
    # If the tunnel's `routing` attribute is set to `BGP`
    # (see {#update_ip_sec_connection_tunnel_details update_ip_sec_connection_tunnel_details}), this IP address
