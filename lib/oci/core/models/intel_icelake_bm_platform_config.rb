...
module OCI
  ...
  #
  class Core::Models::IntelIcelakeBmPlatformConfig < Core::Models::PlatformConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'INTEL_ICELAKE_BM'
    ...
    def hash
      [type, is_secure_boot_enabled, is_trusted_platform_module_enabled, is_measured_boot_enabled, numa_nodes_per_socket, is_symmetric_multi_threading_enabled, is_input_output_memory_management_unit_enabled, percentage_of_cores_enabled].hash
    end
