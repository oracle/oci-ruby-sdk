...
module OCI
  ...
  #
  class Core::Models::InstanceConfiguration # rubocop:disable Metrics/LineLength
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, id, instance_details, deferred_fields, time_created].hash
    end
