...
module OCI
  ...
  #
  class Core::Models::ComputeCapacityReservationSummary
    ...
    # **[Required]** The date and time the capacity reservation was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    ...
    def hash
      [id, compartment_id, display_name, defined_tags, freeform_tags, lifecycle_state, availability_domain, reserved_instance_count, used_instance_count, is_default_reservation, time_created].hash
    end
