...
module OCI
  # Parameters for the softReset {#instance_action instance_action}. If omitted, default values are used.
  #
  class Core::Models::SoftResetActionDetails < Core::Models::InstancePowerActionDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :allow_dense_reboot_migration
    ...
    # @option attributes [BOOLEAN] :allow_dense_reboot_migration The value to assign to the {#allow_dense_reboot_migration} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['actionType'] = 'softreset'
