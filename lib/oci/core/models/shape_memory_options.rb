...
module OCI
  ...
  class Core::Models::ShapeMemoryOptions
    ...
    #
    # @return [Float]
    attr_accessor :max_per_numa_node_in_gbs
    ...
    # @option attributes [Float] :max_per_numa_node_in_gbs The value to assign to the {#max_per_numa_node_in_gbs} property
    def initialize(attributes = {})
      ...
      self.max_per_numa_node_in_gbs = attributes[:'maxPerNumaNodeInGBs'] if attributes[:'maxPerNumaNodeInGBs']

      raise 'You cannot provide both :maxPerNumaNodeInGBs and :max_per_numa_node_in_gbs' if attributes.key?(:'maxPerNumaNodeInGBs') && attributes.key?(:'max_per_numa_node_in_gbs')

      self.max_per_numa_node_in_gbs = attributes[:'max_per_numa_node_in_gbs'] if attributes[:'max_per_numa_node_in_gbs']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        max_per_numa_node_in_gbs == other.max_per_numa_node_in_gbs
    end
    ...
    def hash
      [min_in_g_bs, max_in_g_bs, default_per_ocpu_in_g_bs, min_per_ocpu_in_gbs, max_per_ocpu_in_gbs, max_per_numa_node_in_gbs].hash
    end
