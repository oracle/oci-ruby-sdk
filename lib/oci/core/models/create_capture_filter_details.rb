...
module OCI
  ...
  #
  class Core::Models::CreateCaptureFilterDetails
    FILTER_TYPE_ENUM = [
    ...
    def filter_type=(filter_type)
      raise "Invalid value for 'filter_type': this must be one of the values in FILTER_TYPE_ENUM." if filter_type && !FILTER_TYPE_ENUM.include?(filter_type)
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, filter_type, vtap_capture_filter_rules].hash
    end
