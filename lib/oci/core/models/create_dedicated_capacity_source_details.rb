...
require 'date'
require_relative 'create_capacity_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A capacity source of bare metal hosts that is dedicated to a customer.
  #
  class Core::Models::CreateDedicatedCapacitySourceDetails < Core::Models::CreateCapacitySourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['capacityType'] = 'DEDICATED'
    ...
    def hash
      [capacity_type, compartment_id].hash
    end
