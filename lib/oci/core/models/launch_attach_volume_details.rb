...
module OCI
  ...
  class Core::Models::LaunchAttachVolumeDetails
    ...
    # @return [OCI::Core::Models::LaunchCreateVolumeDetails]
    attr_accessor :launch_create_volume_details
    ...
    # @option attributes [OCI::Core::Models::LaunchCreateVolumeDetails] :launch_create_volume_details The value to assign to the {#launch_create_volume_details} property
