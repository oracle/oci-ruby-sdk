...
module OCI
  ...
  class Core::Models::UpdateInstancePoolDetails
    ...
    #
    # @return [String]
    attr_accessor :instance_display_name_formatter
    ...
    #
    # @return [String]
    attr_accessor :instance_hostname_formatter
    ...
    # @option attributes [String] :instance_display_name_formatter The value to assign to the {#instance_display_name_formatter} property
    # @option attributes [String] :instance_hostname_formatter The value to assign to the {#instance_hostname_formatter} property
    def initialize(attributes = {})
      ...
      self.instance_display_name_formatter = attributes[:'instanceDisplayNameFormatter'] if attributes[:'instanceDisplayNameFormatter']

      raise 'You cannot provide both :instanceDisplayNameFormatter and :instance_display_name_formatter' if attributes.key?(:'instanceDisplayNameFormatter') && attributes.key?(:'instance_display_name_formatter')

      self.instance_display_name_formatter = attributes[:'instance_display_name_formatter'] if attributes[:'instance_display_name_formatter']

      self.instance_hostname_formatter = attributes[:'instanceHostnameFormatter'] if attributes[:'instanceHostnameFormatter']

      raise 'You cannot provide both :instanceHostnameFormatter and :instance_hostname_formatter' if attributes.key?(:'instanceHostnameFormatter') && attributes.key?(:'instance_hostname_formatter')

      self.instance_hostname_formatter = attributes[:'instance_hostname_formatter'] if attributes[:'instance_hostname_formatter']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        size == other.size &&
        instance_display_name_formatter == other.instance_display_name_formatter &&
        instance_hostname_formatter == other.instance_hostname_formatter
    end
    ...
    def hash
      [defined_tags, display_name, freeform_tags, instance_configuration_id, placement_configurations, size, instance_display_name_formatter, instance_hostname_formatter].hash
    end
