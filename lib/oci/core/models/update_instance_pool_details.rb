...
module OCI
  ...
  class Core::Models::UpdateInstancePoolDetails # rubocop:disable Metrics/LineLength
    ...
    #
    # @return [Array<OCI::Core::Models::UpdateInstancePoolPlacementConfigurationDetails>]
    ...
    # @option attributes [Array<OCI::Core::Models::UpdateInstancePoolPlacementConfigurationDetails>] :placement_configurations The value to assign to the {#placement_configurations} property
    ...
    def hash
      [defined_tags, display_name, freeform_tags, instance_configuration_id, placement_configurations, size].hash
    end
