...
module OCI
  ...
  class Core::Models::BootVolumeReplicaInfo
    # **[Required]** The display name of the boot volume replica
    #
    # @return [String]
    ...
    # @return [String]
    attr_accessor :boot_volume_replica_id
    ...
    # @option attributes [String] :boot_volume_replica_id The value to assign to the {#boot_volume_replica_id} property
    ...
    def hash
      [display_name, boot_volume_replica_id, availability_domain].hash
    end
