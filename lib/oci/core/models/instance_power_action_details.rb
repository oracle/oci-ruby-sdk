...
module OCI
  ...
  class Core::Models::InstancePowerActionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::ResetActionDetails' if type == 'reset'
      return 'OCI::Core::Models::RebootMigrateActionDetails' if type == 'rebootMigrate'
      return 'OCI::Core::Models::SoftResetActionDetails' if type == 'softreset'
