...
module OCI
  ...
  class Core::Models::CreateInstancePoolDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the instance pool.
    #
    # @return [String]
    ...
    # **[Required]** The placement configurations for the instance pool. Provide one placement configuration for
