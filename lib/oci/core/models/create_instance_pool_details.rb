...
module OCI
  ...
  class Core::Models::CreateInstancePoolDetails
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, instance_configuration_id, placement_configurations, size, load_balancers, instance_display_name_formatter, instance_hostname_formatter].hash
    end
