...
module OCI
  ...
  class Core::Models::GetIpInventoryVcnOverlapDetails
    # **[Required]** Lists the selected regions.
    # @return [Array<String>]
    attr_accessor :region_list

    # **[Required]** The list of [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartments.
    # @return [Array<String>]
    ...
    def hash
      [region_list, compartment_list].hash
    end
