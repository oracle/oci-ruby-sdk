...
module OCI
  ...
  class Core::Models::InstancePoolPlacementConfiguration
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the primary subnet to place instances.
    #
    # @return [String]
    ...
    def hash
      [availability_domain, primary_subnet_id, fault_domains, secondary_vnic_subnets].hash
    end
