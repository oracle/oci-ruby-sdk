...
module OCI
  ...
  #
  class Core::Models::VolumeGroupSourceFromVolumeGroupReplicaDetails < Core::Models::VolumeGroupSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'volumeGroupReplicaId'
    ...
    def hash
      [type, volume_group_replica_id].hash
    end
