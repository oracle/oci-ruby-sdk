...
require 'date'
require_relative 'update_instance_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details for updating the instance source from an image.
  class Core::Models::UpdateInstanceSourceViaImageDetails < Core::Models::UpdateInstanceSourceDetails
    ...
    # @option attributes [BOOLEAN] :is_preserve_boot_volume_enabled The value to assign to the {OCI::Core::Models::UpdateInstanceSourceDetails#is_preserve_boot_volume_enabled #is_preserve_boot_volume_enabled} proprety
    ...
    def hash
      [source_type, is_preserve_boot_volume_enabled, boot_volume_size_in_gbs, image_id, kms_key_id].hash
    end
