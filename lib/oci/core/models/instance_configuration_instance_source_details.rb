...
module OCI
  ...
  class Core::Models::InstanceConfigurationInstanceSourceDetails # rubocop:disable Metrics/LineLength
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::InstanceConfigurationInstanceSourceViaImageDetails' if type == 'image'
      return 'OCI::Core::Models::InstanceConfigurationInstanceSourceViaBootVolumeDetails' if type == 'bootVolume'
