...
module OCI
  ...
  class Core::Models::IPSecConnectionTunnelErrorDetails
    ...
    # @option attributes [String] :error_description The value to assign to the {#error_description} property
    # @option attributes [String] :solution The value to assign to the {#solution} property
    # @option attributes [String] :oci_resources_link The value to assign to the {#oci_resources_link} property
    ...
    def initialize(attributes = {})
      ...
      self.error_description = attributes[:'errorDescription'] if attributes[:'errorDescription']

      raise 'You cannot provide both :errorDescription and :error_description' if attributes.key?(:'errorDescription') && attributes.key?(:'error_description')

      self.error_description = attributes[:'error_description'] if attributes[:'error_description']

      self.solution = attributes[:'solution'] if attributes[:'solution']

      self.oci_resources_link = attributes[:'ociResourcesLink'] if attributes[:'ociResourcesLink']

      raise 'You cannot provide both :ociResourcesLink and :oci_resources_link' if attributes.key?(:'ociResourcesLink') && attributes.key?(:'oci_resources_link')

      self.oci_resources_link = attributes[:'oci_resources_link'] if attributes[:'oci_resources_link']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        oci_resources_link == other.oci_resources_link &&
    ...
    def hash
      [id, error_code, error_description, solution, oci_resources_link, timestamp].hash
    end
