...
module OCI
  ...
  #
  class Core::Models::ComputeImageCapabilitySchema
    ...
    #
    # @return [String]
    attr_accessor :compute_global_image_capability_schema_id
    ...
    # **[Required]** A user-friendly name for the compute global image capability schema
    #
    # @return [String]
    ...
    # **[Required]** The date and time the compute image capability schema was created, in the format defined by
    ...
    # @option attributes [String] :compute_global_image_capability_schema_id The value to assign to the {#compute_global_image_capability_schema_id} property
    ...
    def initialize(attributes = {})
      ...
      self.compute_global_image_capability_schema_id = attributes[:'computeGlobalImageCapabilitySchemaId'] if attributes[:'computeGlobalImageCapabilitySchemaId']

      raise 'You cannot provide both :computeGlobalImageCapabilitySchemaId and :compute_global_image_capability_schema_id' if attributes.key?(:'computeGlobalImageCapabilitySchemaId') && attributes.key?(:'compute_global_image_capability_schema_id')

      self.compute_global_image_capability_schema_id = attributes[:'compute_global_image_capability_schema_id'] if attributes[:'compute_global_image_capability_schema_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        compute_global_image_capability_schema_id == other.compute_global_image_capability_schema_id &&
    ...
    def hash
      [id, compartment_id, compute_global_image_capability_schema_id, compute_global_image_capability_schema_version_name, image_id, defined_tags, display_name, freeform_tags, schema_data, time_created].hash
    end
