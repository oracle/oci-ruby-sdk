...
module OCI
  ...
  #
  class Core::Models::CreateComputeClusterDetails
    # **[Required]** The availability domain to place the compute cluster in.
    #
    ...
    def hash
      [availability_domain, compartment_id, display_name, defined_tags, freeform_tags].hash
    end
