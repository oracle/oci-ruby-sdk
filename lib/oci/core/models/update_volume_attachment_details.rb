...
module OCI
  ...
  class Core::Models::UpdateVolumeAttachmentDetails
    ...
    def iscsi_login_state=(iscsi_login_state)
      raise "Invalid value for 'iscsi_login_state': this must be one of the values in ISCSI_LOGIN_STATE_ENUM." if iscsi_login_state && !ISCSI_LOGIN_STATE_ENUM.include?(iscsi_login_state)
