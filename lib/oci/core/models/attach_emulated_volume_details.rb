...
module OCI
  ...
  class Core::Models::AttachEmulatedVolumeDetails < Core::Models::AttachVolumeDetails
    ...
    def hash
      [device, display_name, instance_id, is_read_only, type, volume_id].hash
    end
