...
module OCI
  ...
  class Core::Models::BulkDeleteVirtualCircuitPublicPrefixesDetails # rubocop:disable Metrics/LineLength
    ...
    # @option attributes [Array<OCI::Core::Models::DeleteVirtualCircuitPublicPrefixDetails>] :public_prefixes The value to assign to the {#public_prefixes} property
