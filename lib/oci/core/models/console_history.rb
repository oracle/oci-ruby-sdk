...
module OCI
  ...
  class Core::Models::ConsoleHistory
    LIFECYCLE_STATE_ENUM = [
      ...
      LIFECYCLE_STATE_GETTING_HISTORY = 'GETTING-HISTORY'.freeze,
    ...
    # **[Required]** The date and time the history was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
