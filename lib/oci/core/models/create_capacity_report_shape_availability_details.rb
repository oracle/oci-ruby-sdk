...
module OCI
  ...
  #
  class Core::Models::CreateCapacityReportShapeAvailabilityDetails
    ...
    # **[Required]** The shape that you want to request a capacity report for. You can enumerate all available shapes by calling
    ...
    def hash
      [fault_domain, instance_shape, instance_shape_config].hash
    end
