...
module OCI
  ...
  class Core::Models::CreateCpeDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the CPE.
    # @return [String]
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, ip_address, cpe_device_shape_id].hash
    end
