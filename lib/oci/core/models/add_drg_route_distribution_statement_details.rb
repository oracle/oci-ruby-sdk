...
module OCI
  ...
  #
  class Core::Models::AddDrgRouteDistributionStatementDetails
    ACTION_ENUM = [
    ...
    # @option attributes [Array<OCI::Core::Models::DrgRouteDistributionMatchCriteria>] :match_criteria The value to assign to the {#match_criteria} property
