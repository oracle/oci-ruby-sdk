...
module OCI
  ...
  class Core::Models::InstanceReservationConfig
    ...
    # @return [OCI::Core::Models::ClusterConfigDetails]
    ...
    # @option attributes [OCI::Core::Models::ClusterConfigDetails] :cluster_config The value to assign to the {#cluster_config} property
    ...
    def hash
      [fault_domain, cluster_config, instance_shape, instance_shape_config, reserved_count, used_count, cluster_placement_group_id].hash
    end
