...
module OCI
  ...
  class Core::Models::InstanceReservationConfig
    ...
    # **[Required]** The shape to use when launching instances using compute capacity reservations. The shape determines the number of CPUs, the amount of memory,
    ...
    # @option attributes [OCI::Core::Models::InstanceReservationShapeConfigDetails] :instance_shape_config The value to assign to the {#instance_shape_config} property
    # @option attributes [Integer] :reserved_count The value to assign to the {#reserved_count} property
    # @option attributes [Integer] :used_count The value to assign to the {#used_count} property
    ...
    def hash
      [fault_domain, instance_shape, instance_shape_config, reserved_count, used_count].hash
    end
