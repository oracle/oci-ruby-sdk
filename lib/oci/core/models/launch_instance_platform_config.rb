...
module OCI
  ...
  class Core::Models::LaunchInstancePlatformConfig
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::GenericBmLaunchInstancePlatformConfig' if type == 'GENERIC_BM'
      return 'OCI::Core::Models::AmdMilanBmGpuLaunchInstancePlatformConfig' if type == 'AMD_MILAN_BM_GPU'
    ...
    def initialize(attributes = {})
      ...
      self.is_memory_encryption_enabled = attributes[:'isMemoryEncryptionEnabled'] unless attributes[:'isMemoryEncryptionEnabled'].nil?
      self.is_memory_encryption_enabled = false if is_memory_encryption_enabled.nil? && !attributes.key?(:'isMemoryEncryptionEnabled') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isMemoryEncryptionEnabled and :is_memory_encryption_enabled' if attributes.key?(:'isMemoryEncryptionEnabled') && attributes.key?(:'is_memory_encryption_enabled')
