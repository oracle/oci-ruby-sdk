...
module OCI
  ...
  #
  class Core::Models::InventorySubnetSummary
    RESOURCE_TYPE_ENUM = [
    ...
    #
    # @return [Array<OCI::Core::Models::InventorySubnetCidrBlockSummary>]
    attr_accessor :inventory_subnet_cidr_collection
    ...
    #
    # @return [Array<OCI::Core::Models::InventoryResourceSummary>]
    attr_accessor :inventory_resource_summary
    ...
    # @option attributes [String] :subnet_name The value to assign to the {#subnet_name} property
    # @option attributes [String] :resource_type The value to assign to the {#resource_type} property
    # @option attributes [Array<OCI::Core::Models::InventorySubnetCidrBlockSummary>] :inventory_subnet_cidr_collection The value to assign to the {#inventory_subnet_cidr_collection} property
    ...
    # @option attributes [Array<OCI::Core::Models::InventoryResourceSummary>] :inventory_resource_summary The value to assign to the {#inventory_resource_summary} property
