...
module OCI
  ...
  class Core::Models::UpdateMacsecProperties
    STATE_ENUM = [
    ...
    # @return [OCI::Core::Models::UpdateMacsecKey]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'state': :'String',
        'primary_key': :'OCI::Core::Models::UpdateMacsecKey',
    ...
    # @option attributes [OCI::Core::Models::UpdateMacsecKey] :primary_key The value to assign to the {#primary_key} property
