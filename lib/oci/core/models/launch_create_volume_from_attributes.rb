...
require 'date'
require_relative 'launch_create_volume_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details of the volume to create for CreateVolume operation.
  class Core::Models::LaunchCreateVolumeFromAttributes < Core::Models::LaunchCreateVolumeDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['volumeCreationType'] = 'ATTRIBUTES'
    ...
    def hash
      [volume_creation_type, compartment_id, display_name, kms_key_id, vpus_per_gb, size_in_gbs].hash
    end
