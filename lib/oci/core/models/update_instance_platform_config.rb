...
module OCI
  ...
  class Core::Models::UpdateInstancePlatformConfig
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::AmdVmUpdateInstancePlatformConfig' if type == 'AMD_VM'
      return 'OCI::Core::Models::IntelVmUpdateInstancePlatformConfig' if type == 'INTEL_VM'
