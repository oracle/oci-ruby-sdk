...
module OCI
  ...
  class Core::Models::CreateVnicDetails
    ...
    #
    # @return [Array<OCI::Core::Models::Ipv6AddressIpv6SubnetCidrPairDetails>]
    ...
    # @option attributes [Array<OCI::Core::Models::Ipv6AddressIpv6SubnetCidrPairDetails>] :ipv6_address_ipv6_subnet_cidr_pair_details The value to assign to the {#ipv6_address_ipv6_subnet_cidr_pair_details} property
    ...
    def hash
      [assign_ipv6_ip, assign_public_ip, assign_private_dns_record, defined_tags, display_name, freeform_tags, hostname_label, ipv6_address_ipv6_subnet_cidr_pair_details, nsg_ids, private_ip, skip_source_dest_check, subnet_id, vlan_id].hash
    end
