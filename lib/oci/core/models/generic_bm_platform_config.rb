...
module OCI
  ...
  #
  class Core::Models::GenericBmPlatformConfig < Core::Models::PlatformConfig
    ...
    def hash
      [type, is_secure_boot_enabled, is_trusted_platform_module_enabled, is_measured_boot_enabled, is_memory_encryption_enabled, numa_nodes_per_socket, is_symmetric_multi_threading_enabled, is_access_control_service_enabled, are_virtual_instructions_enabled, is_input_output_memory_management_unit_enabled, percentage_of_cores_enabled, config_map].hash
    end
