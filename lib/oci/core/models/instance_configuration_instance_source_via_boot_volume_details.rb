...
module OCI
  ...
  class Core::Models::InstanceConfigurationInstanceSourceViaBootVolumeDetails < Core::Models::InstanceConfigurationInstanceSourceDetails # rubocop:disable Metrics/LineLength
