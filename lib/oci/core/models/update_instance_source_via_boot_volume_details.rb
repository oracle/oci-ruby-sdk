...
module OCI
  ...
  class Core::Models::UpdateInstanceSourceViaBootVolumeDetails < Core::Models::UpdateInstanceSourceDetails
    ...
    def hash
      [source_type, is_preserve_boot_volume_enabled, boot_volume_id].hash
    end
