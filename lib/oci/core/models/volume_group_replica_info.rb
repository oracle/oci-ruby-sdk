...
module OCI
  ...
  class Core::Models::VolumeGroupReplicaInfo
    ...
    # **[Required]** The availability domain of the boot volume replica replica.
    #
    ...
    def hash
      [display_name, volume_group_replica_id, availability_domain].hash
    end
