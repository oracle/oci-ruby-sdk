...
module OCI
  ...
  class Core::Models::InstanceConfigurationCreateVolumeDetails
    ...
    def hash
      [availability_domain, backup_policy_id, compartment_id, is_auto_tune_enabled, block_volume_replicas, defined_tags, display_name, freeform_tags, kms_key_id, vpus_per_gb, size_in_gbs, source_details, autotune_policies].hash
    end
