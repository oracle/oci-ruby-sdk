...
module OCI
  ...
  class Core::Models::InstanceConfigurationInstanceDetails # rubocop:disable Metrics/LineLength
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'instanceType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Core::Models::ComputeInstanceDetails' if type == 'compute'
