...
module OCI
  ...
  class Core::Models::InstanceConfigurationInstanceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::ComputeInstanceOptions' if type == 'instance_options'
    ...
    def initialize(attributes = {})
      ...
      self.instance_type = "compute" if instance_type.nil? && !attributes.key?(:'instanceType') # rubocop:disable Style/StringLiterals
      ...
      self.instance_type = "compute" if instance_type.nil? && !attributes.key?(:'instanceType') && !attributes.key?(:'instance_type') # rubocop:disable Style/StringLiterals
    end
