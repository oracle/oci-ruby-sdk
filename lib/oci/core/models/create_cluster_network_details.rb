...
module OCI
  ...
  class Core::Models::CreateClusterNetworkDetails
    ...
    # @option attributes [Array<OCI::Core::Models::CreateClusterNetworkInstancePoolDetails>] :instance_pools The value to assign to the {#instance_pools} property
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, instance_pools, placement_configuration].hash
    end
