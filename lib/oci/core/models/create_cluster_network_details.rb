...
module OCI
  ...
  # see {#create_compute_cluster_details create_compute_cluster_details}.
  #
  class Core::Models::CreateClusterNetworkDetails
    ...
    # @return [OCI::Core::Models::ClusterConfigurationDetails]
    ...
    # @option attributes [OCI::Core::Models::ClusterConfigurationDetails] :cluster_configuration The value to assign to the {#cluster_configuration} property
