...
module OCI
  ...
  #
  class Core::Models::CreateComputeImageCapabilitySchemaDetails
    ...
    def hash
      [compartment_id, compute_global_image_capability_schema_version_name, image_id, freeform_tags, display_name, defined_tags, schema_data].hash
    end
