...
module OCI
  # Parameters for the reset {#instance_action instance_action}. If omitted, default values are used.
  #
  class Core::Models::ResetActionDetails < Core::Models::InstancePowerActionDetails
