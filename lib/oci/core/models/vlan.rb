...
module OCI
  ...
  class Core::Models::Vlan
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the VLAN.
    # @return [String]
    ...
    # **[Required]** The VLAN's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the VLAN is in.
    # @return [String]
    ...
    def hash
      [availability_domain, cidr_block, compartment_id, defined_tags, display_name, freeform_tags, id, lifecycle_state, nsg_ids, vlan_tag, route_table_id, time_created, vcn_id].hash
    end
