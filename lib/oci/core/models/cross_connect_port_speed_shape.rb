...
module OCI
  ...
  #
  class Core::Models::CrossConnectPortSpeedShape # rubocop:disable Metrics/LineLength
    # **[Required]** The name of the port speed shape.
    #
    # Example: `10 Gbps`
    #
    # @return [String]
    ...
    # **[Required]** The port speed in Gbps.
    #
    # Example: `10`
    #
    # @return [Integer]
    ...
    def initialize(attributes = {})
      ...
      self.port_speed_in_gbps = attributes[:'portSpeedInGbps'] if attributes[:'portSpeedInGbps']
      ...
      self.port_speed_in_gbps = attributes[:'port_speed_in_gbps'] if attributes[:'port_speed_in_gbps']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        name == other.name &&
        port_speed_in_gbps == other.port_speed_in_gbps
    end
