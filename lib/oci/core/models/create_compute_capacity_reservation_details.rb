...
module OCI
  ...
  #
  class Core::Models::CreateComputeCapacityReservationDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the capacity reservation.
    #
    # @return [String]
    ...
    # **[Required]** The availability domain of this compute capacity reservation.
    #
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, availability_domain, is_default_reservation, instance_reservation_configs].hash
    end
