...
module OCI
  ...
  #
  class Core::Models::LaunchInstanceAvailabilityConfigDetails
    ...
    def recovery_action=(recovery_action)
      raise "Invalid value for 'recovery_action': this must be one of the values in RECOVERY_ACTION_ENUM." if recovery_action && !RECOVERY_ACTION_ENUM.include?(recovery_action)
