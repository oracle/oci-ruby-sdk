...
module OCI
  ...
  class Core::Models::ClusterNetworkSummary
    ...
    # @return [Array<OCI::Core::Models::InstancePoolSummary>]
    ...
    def self.swagger_types
      {
        ...
        'instance_pools': :'Array<OCI::Core::Models::InstancePoolSummary>',
    ...
    # @option attributes [Array<OCI::Core::Models::InstancePoolSummary>] :instance_pools The value to assign to the {#instance_pools} property
    ...
    def hash
      [id, compartment_id, defined_tags, display_name, freeform_tags, instance_pools, lifecycle_state, time_created, time_updated].hash
    end
