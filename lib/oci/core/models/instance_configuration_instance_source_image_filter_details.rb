...
module OCI
  ...
  #
  class Core::Models::InstanceConfigurationInstanceSourceImageFilterDetails
    ...
    attr_accessor :defined_tags_filter
    ...
    def self.swagger_types
      {
        ...
        'defined_tags_filter': :'Hash<String, Hash<String, Object>>',
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags_filter The value to assign to the {#defined_tags_filter} property
    ...
    def initialize(attributes = {})
      ...
      self.defined_tags_filter = attributes[:'definedTagsFilter'] if attributes[:'definedTagsFilter']

      raise 'You cannot provide both :definedTagsFilter and :defined_tags_filter' if attributes.key?(:'definedTagsFilter') && attributes.key?(:'defined_tags_filter')

      self.defined_tags_filter = attributes[:'defined_tags_filter'] if attributes[:'defined_tags_filter']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        defined_tags_filter == other.defined_tags_filter &&
    ...
    def hash
      [compartment_id, defined_tags_filter, operating_system, operating_system_version].hash
    end
