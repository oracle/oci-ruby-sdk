...
require 'date'
require_relative 'update_instance_platform_config'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The platform configuration used when updating a virtual machine instance with the Intel platform.
  #
  class Core::Models::IntelVmUpdateInstancePlatformConfig < Core::Models::UpdateInstancePlatformConfig
    ...
    def hash
      [type, is_symmetric_multi_threading_enabled].hash
    end
