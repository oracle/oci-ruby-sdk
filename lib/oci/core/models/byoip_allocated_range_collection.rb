...
module OCI
  ...
  class Core::Models::ByoipAllocatedRangeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Core::Models::ByoipAllocatedRangeSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Core::Models::ByoipAllocatedRangeSummary>] :items The value to assign to the {#items} property
