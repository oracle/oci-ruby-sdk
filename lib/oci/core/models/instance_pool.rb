...
module OCI
  ...
  class Core::Models::InstancePool
    ...
    def hash
      [id, compartment_id, defined_tags, display_name, freeform_tags, instance_configuration_id, lifecycle_state, placement_configurations, size, time_created, load_balancers, instance_display_name_formatter, instance_hostname_formatter].hash
    end
