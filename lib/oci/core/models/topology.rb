...
module OCI
  ...
  class Core::Models::Topology
    ...
    # @return [Array<OCI::Core::Models::TopologyEntityRelationship>]
    ...
    # @option attributes [Array<Object>] :entities The value to assign to the {#entities} property
    # @option attributes [Array<OCI::Core::Models::TopologyEntityRelationship>] :relationships The value to assign to the {#relationships} property
