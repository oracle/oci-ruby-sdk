...
module OCI
  ...
  class Core::Models::Topology
    ...
    # **[Required]** Lists entities that are limited during ingestion.
    # The values for the items in the list are the entity type names of the limitedEntities.
    # Example: `vcn`
    #
    # @return [Array<String>]
    attr_accessor :limited_entities
    ...
    # @option attributes [Array<String>] :limited_entities The value to assign to the {#limited_entities} property
