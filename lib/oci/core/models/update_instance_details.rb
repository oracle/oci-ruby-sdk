...
module OCI
  ...
  class Core::Models::UpdateInstanceDetails
    ...
    def hash
      [capacity_reservation_id, defined_tags, display_name, freeform_tags, agent_config, shape, shape_config, update_operation_constraint, instance_options, fault_domain, launch_options, availability_config, time_maintenance_reboot_due].hash
    end
