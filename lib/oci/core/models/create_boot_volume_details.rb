...
module OCI
  ...
  class Core::Models::CreateBootVolumeDetails
    ...
    def hash
      [availability_domain, backup_policy_id, compartment_id, defined_tags, display_name, freeform_tags, kms_key_id, size_in_gbs, vpus_per_gb, source_details, is_auto_tune_enabled, boot_volume_replicas, autotune_policies].hash
    end
