...
module OCI
  ...
  #
  class Core::Models::ClusterConfigurationDetails
    # The list of network block OCIDs.
    # @return [Array<String>]
    attr_accessor :network_block_ids

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the HPC island.
    #
    # @return [String]
    ...
    def hash
      [network_block_ids, hpc_island_id].hash
    end
