...
module OCI
  ...
  #
  class Core::Models::DedicatedVmHostShapeSummary
    # The shape's availability domain.
    #
    # @return [String]
    attr_accessor :availability_domain

    # **[Required]** The name of the dedicated vm host shape. You can enumerate all available shapes by calling
    ...
    def hash
      [availability_domain, dedicated_vm_host_shape].hash
    end
