...
module OCI
  ...
  #
  class Core::Models::UpdateDrgRouteRulesDetails
    # The DRG rute rules to update.
    # @return [Array<OCI::Core::Models::UpdateDrgRouteRuleDetails>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'route_rules': :'Array<OCI::Core::Models::UpdateDrgRouteRuleDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Core::Models::UpdateDrgRouteRuleDetails>] :route_rules The value to assign to the {#route_rules} property
