...
module OCI
  ...
  class Core::Models::InstanceConfigurationParavirtualizedAttachVolumeDetails < Core::Models::InstanceConfigurationAttachVolumeDetails # rubocop:disable Metrics/LineLength
