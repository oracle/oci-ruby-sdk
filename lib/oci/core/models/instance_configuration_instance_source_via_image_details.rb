...
module OCI
  ...
  class Core::Models::InstanceConfigurationInstanceSourceViaImageDetails < Core::Models::InstanceConfigurationInstanceSourceDetails # rubocop:disable Metrics/LineLength
