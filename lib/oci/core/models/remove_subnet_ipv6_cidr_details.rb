...
module OCI
  ...
  class Core::Models::RemoveSubnetIpv6CidrDetails
    # **[Required]** This field is not required and should only be specified when removing an IPv6 CIDR
