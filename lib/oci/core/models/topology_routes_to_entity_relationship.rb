...
module OCI
  ...
  #
  class Core::Models::TopologyRoutesToEntityRelationship < Core::Models::TopologyEntityRelationship
    # This attribute is required.
    # @return [OCI::Core::Models::TopologyRoutesToRelationshipDetails]
    ...
    def self.swagger_types
      {
        ...
        'id2': :'String',
        'type': :'String',
        'route_rule_details': :'OCI::Core::Models::TopologyRoutesToRelationshipDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Core::Models::TopologyRoutesToRelationshipDetails] :route_rule_details The value to assign to the {#route_rule_details} property
