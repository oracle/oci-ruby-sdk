...
module OCI
  ...
  class Core::Models::InstanceConfigurationLaunchInstancePlatformConfig
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig' if type == 'AMD_MILAN_BM_GPU'
      return 'OCI::Core::Models::InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig' if type == 'INTEL_ICELAKE_BM'
      return 'OCI::Core::Models::InstanceConfigurationGenericBmLaunchInstancePlatformConfig' if type == 'GENERIC_BM'
