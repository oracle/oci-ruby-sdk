...
module OCI
  ...
  #
  class Core::Models::AmdRomeBmGpuPlatformConfig < Core::Models::PlatformConfig
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'AMD_ROME_BM_GPU'
      ...
      self.numa_nodes_per_socket = "NPS4" if numa_nodes_per_socket.nil? && !attributes.key?(:'numaNodesPerSocket') # rubocop:disable Style/StringLiterals
      ...
      self.numa_nodes_per_socket = "NPS4" if numa_nodes_per_socket.nil? && !attributes.key?(:'numaNodesPerSocket') && !attributes.key?(:'numa_nodes_per_socket') # rubocop:disable Style/StringLiterals
      ...
      self.is_access_control_service_enabled = false if is_access_control_service_enabled.nil? && !attributes.key?(:'isAccessControlServiceEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_access_control_service_enabled = false if is_access_control_service_enabled.nil? && !attributes.key?(:'isAccessControlServiceEnabled') && !attributes.key?(:'is_access_control_service_enabled') # rubocop:disable Style/StringLiterals
      ...
      self.are_virtual_instructions_enabled = false if are_virtual_instructions_enabled.nil? && !attributes.key?(:'areVirtualInstructionsEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.are_virtual_instructions_enabled = false if are_virtual_instructions_enabled.nil? && !attributes.key?(:'areVirtualInstructionsEnabled') && !attributes.key?(:'are_virtual_instructions_enabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_input_output_memory_management_unit_enabled = false if is_input_output_memory_management_unit_enabled.nil? && !attributes.key?(:'isInputOutputMemoryManagementUnitEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_input_output_memory_management_unit_enabled = false if is_input_output_memory_management_unit_enabled.nil? && !attributes.key?(:'isInputOutputMemoryManagementUnitEnabled') && !attributes.key?(:'is_input_output_memory_management_unit_enabled') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [type, is_secure_boot_enabled, is_trusted_platform_module_enabled, is_measured_boot_enabled, numa_nodes_per_socket, is_symmetric_multi_threading_enabled, is_access_control_service_enabled, are_virtual_instructions_enabled, is_input_output_memory_management_unit_enabled].hash
    end
