...
module OCI
  ...
  class Core::Models::InstancePoolSummary # rubocop:disable Metrics/LineLength
    ...
    def hash
      [id, compartment_id, display_name, instance_configuration_id, lifecycle_state, availability_domains, size, time_created].hash
    end
