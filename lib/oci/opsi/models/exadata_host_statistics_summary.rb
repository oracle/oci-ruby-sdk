...
module OCI
  ...
  class Opsi::Models::ExadataHostStatisticsSummary < Opsi::Models::ExadataInsightResourceStatisticsAggregation
    ...
    def self.swagger_types
      {
        ...
        'resource_details': :'OCI::Opsi::Models::HostDetails',
    ...
    # @option attributes [OCI::Opsi::Models::HostDetails] :resource_details The value to assign to the {#resource_details} property
    ...
    def initialize(attributes = {})
      ...
      attributes['exadataResourceType'] = 'HOST'
