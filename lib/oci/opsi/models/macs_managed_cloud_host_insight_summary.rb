...
module OCI
  ...
  class Opsi::Models::MacsManagedCloudHostInsightSummary < Opsi::Models::HostInsightSummary
    PLATFORM_TYPE_ENUM = [
    ...
    def hash
      [entity_source, id, compartment_id, host_name, host_display_name, host_type, processor_count, freeform_tags, defined_tags, system_tags, opsi_private_endpoint_id, status, time_created, time_updated, lifecycle_state, lifecycle_details, compute_id, management_agent_id, platform_type].hash
    end
