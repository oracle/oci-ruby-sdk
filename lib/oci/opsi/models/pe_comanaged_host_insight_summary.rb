...
module OCI
  ...
  class Opsi::Models::PeComanagedHostInsightSummary < Opsi::Models::HostInsightSummary
    PLATFORM_TYPE_ENUM = [
    ...
    def hash
      [entity_source, id, compartment_id, host_name, host_display_name, host_type, processor_count, freeform_tags, defined_tags, system_tags, opsi_private_endpoint_id, status, time_created, time_updated, lifecycle_state, lifecycle_details, platform_type, parent_id, root_id].hash
    end
