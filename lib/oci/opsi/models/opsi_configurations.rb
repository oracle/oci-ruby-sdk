...
module OCI
  ...
  #
  class Opsi::Models::OpsiConfigurations
    # OPSI Configuration Object.
    # @return [Object]
    attr_accessor :opsi_configurations
    ...
    # @option attributes [Object] :opsi_configurations The value to assign to the {#opsi_configurations} property
