...
module OCI
  ...
  class Opsi::Models::SummarizeDatabaseInsightResourceUsageAggregation
    ...
    def hash
      [time_interval_start, time_interval_end, resource_metric, usage_unit, usage, capacity, usage_change_percent].hash
    end
