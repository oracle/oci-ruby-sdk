...
module OCI
  ...
  #
  class Opsi::Models::SummarizeExadataInsightResourceCapacityTrendAggregation
    ...
    # **[Required]** Identifies the units of the current resource metric (CORES, GB).
    #
    # @return [String]
    ...
    #
    # @return [Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendAggregation>]
    attr_accessor :capacity_data
    ...
    def self.swagger_types
      {
        ...
        'capacity_data': :'Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendAggregation>] :capacity_data The value to assign to the {#capacity_data} property
    def initialize(attributes = {})
      ...
      self.capacity_data = attributes[:'capacityData'] if attributes[:'capacityData']

      raise 'You cannot provide both :capacityData and :capacity_data' if attributes.key?(:'capacityData') && attributes.key?(:'capacity_data')

      self.capacity_data = attributes[:'capacity_data'] if attributes[:'capacity_data']
    end
    ...
    def hash
      [time_interval_start, time_interval_end, exadata_resource_metric, exadata_resource_type, usage_unit, item_duration_in_ms, capacity_data].hash
    end
