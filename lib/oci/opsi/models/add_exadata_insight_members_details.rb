...
module OCI
  ...
  class Opsi::Models::AddExadataInsightMembersDetails
    ENTITY_SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::AddEmManagedExternalExadataInsightMembersDetails' if type == 'EM_MANAGED_EXTERNAL_EXADATA'
