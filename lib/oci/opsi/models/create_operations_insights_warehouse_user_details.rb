...
module OCI
  ...
  class Opsi::Models::CreateOperationsInsightsWarehouseUserDetails
    ...
    # @option attributes [String] :connection_password The value to assign to the {#connection_password} property
    # @option attributes [BOOLEAN] :is_awr_data_access The value to assign to the {#is_awr_data_access} property
    # @option attributes [BOOLEAN] :is_em_data_access The value to assign to the {#is_em_data_access} property
    # @option attributes [BOOLEAN] :is_opsi_data_access The value to assign to the {#is_opsi_data_access} property
    ...
    def hash
      [operations_insights_warehouse_id, compartment_id, name, connection_password, is_awr_data_access, is_em_data_access, is_opsi_data_access, freeform_tags, defined_tags].hash
    end
