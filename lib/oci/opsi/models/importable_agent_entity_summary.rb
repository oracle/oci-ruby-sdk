...
module OCI
  ...
  class Opsi::Models::ImportableAgentEntitySummary
    ENTITY_SOURCE_ENUM = [
    ...
    # **[Required]** The [Display Name](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Display) of the Management Agent
    # @return [String]
