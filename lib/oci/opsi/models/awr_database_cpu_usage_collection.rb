...
module OCI
  ...
  class Opsi::Models::AwrDatabaseCpuUsageCollection < Opsi::Models::AwrQueryResult
    ...
    # @return [Integer]
    attr_accessor :database_cpu_count

    # The number of available CPUs or processors.
    # @return [Float]
    attr_accessor :host_cpu_count

    # A list of AWR CPU usage summary data.
    # @return [Array<OCI::Opsi::Models::AwrDatabaseCpuUsageSummary>]
    attr_accessor :items
    ...
    # @option attributes [Integer] :database_cpu_count The value to assign to the {#database_cpu_count} property
    # @option attributes [Float] :host_cpu_count The value to assign to the {#host_cpu_count} property
    # @option attributes [Array<OCI::Opsi::Models::AwrDatabaseCpuUsageSummary>] :items The value to assign to the {#items} property
