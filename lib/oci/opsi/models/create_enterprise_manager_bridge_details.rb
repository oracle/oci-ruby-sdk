...
module OCI
  ...
  class Opsi::Models::CreateEnterpriseManagerBridgeDetails
    ...
    def hash
      [compartment_id, display_name, description, object_storage_bucket_name, freeform_tags, defined_tags].hash
    end
