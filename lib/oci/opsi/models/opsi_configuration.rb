...
module OCI
  ...
  class Opsi::Models::OpsiConfiguration
    OPSI_CONFIG_TYPE_ENUM = [
      OPSI_CONFIG_TYPE_UX_CONFIGURATION = 'UX_CONFIGURATION'.freeze,
      OPSI_CONFIG_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [Array<OCI::Opsi::Models::OpsiConfigurationConfigurationItemSummary>]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::OpsiUxConfiguration' if type == 'UX_CONFIGURATION'
    ...
    # @option attributes [String] :opsi_config_type The value to assign to the {#opsi_config_type} property
    ...
    # @option attributes [Array<OCI::Opsi::Models::OpsiConfigurationConfigurationItemSummary>] :config_items The value to assign to the {#config_items} property
    ...
    # @param [Object] opsi_config_type Object to be assigned
    def opsi_config_type=(opsi_config_type)
      # rubocop:disable Style/ConditionalAssignment
      if opsi_config_type && !OPSI_CONFIG_TYPE_ENUM.include?(opsi_config_type)
        OCI.logger.debug("Unknown value for 'opsi_config_type' [" + opsi_config_type + "]. Mapping to 'OPSI_CONFIG_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @opsi_config_type = OPSI_CONFIG_TYPE_UNKNOWN_ENUM_VALUE
      else
