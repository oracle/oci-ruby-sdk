...
module OCI
  ...
  #
  class Opsi::Models::SqlStatisticsTimeSeriesAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::SqlStatisticsTimeSeriesAggregation>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Opsi::Models::SqlStatisticsTimeSeriesAggregation>] :items The value to assign to the {#items} property
    ...
    def hash
      [sql_identifier, time_interval_start, time_interval_end, item_duration_in_ms, end_timestamps, items].hash
    end
