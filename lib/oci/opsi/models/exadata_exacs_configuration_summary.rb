...
module OCI
  ...
  class Opsi::Models::ExadataExacsConfigurationSummary < Opsi::Models::ExadataConfigurationSummary
    ...
    def hash
      [exadata_insight_id, entity_source, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, defined_tags, freeform_tags, vmcluster_details, opsi_private_endpoint_id, parent_id].hash
    end
