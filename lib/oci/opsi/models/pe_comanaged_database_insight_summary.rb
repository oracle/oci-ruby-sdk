...
module OCI
  ...
  class Opsi::Models::PeComanagedDatabaseInsightSummary < Opsi::Models::DatabaseInsightSummary
    ...
    # @option attributes [String] :root_id The value to assign to the {#root_id} property
    def initialize(attributes = {})
      ...
      self.root_id = attributes[:'rootId'] if attributes[:'rootId']

      raise 'You cannot provide both :rootId and :root_id' if attributes.key?(:'rootId') && attributes.key?(:'root_id')

      self.root_id = attributes[:'root_id'] if attributes[:'root_id']
    end
