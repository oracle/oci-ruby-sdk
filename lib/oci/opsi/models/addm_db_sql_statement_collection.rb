...
module OCI
  ...
  class Opsi::Models::AddmDbSqlStatementCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbSqlStatementSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbSqlStatementSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbSqlStatementSummary>] :items The value to assign to the {#items} property
