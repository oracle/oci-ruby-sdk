...
module OCI
  ...
  class Opsi::Models::UpdateOpsiConfigurationDetails
    ...
    #
    # @return [Array<OCI::Opsi::Models::UpdateConfigurationItemDetails>]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::UpdateOpsiUxConfigurationDetails' if type == 'UX_CONFIGURATION'
    ...
    # @option attributes [Array<OCI::Opsi::Models::UpdateConfigurationItemDetails>] :config_items The value to assign to the {#config_items} property
    ...
    def opsi_config_type=(opsi_config_type)
      raise "Invalid value for 'opsi_config_type': this must be one of the values in OPSI_CONFIG_TYPE_ENUM." if opsi_config_type && !OPSI_CONFIG_TYPE_ENUM.include?(opsi_config_type)
