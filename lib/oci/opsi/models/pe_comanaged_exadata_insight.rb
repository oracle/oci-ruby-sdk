...
module OCI
  ...
  class Opsi::Models::PeComanagedExadataInsight < Opsi::Models::ExadataInsight
    ...
    def hash
      [entity_source, id, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, is_virtualized_exadata, status, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, exadata_infra_id, exadata_infra_resource_type, exadata_shape].hash
    end
