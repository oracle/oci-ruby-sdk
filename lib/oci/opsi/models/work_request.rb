...
module OCI
  ...
  class Opsi::Models::WorkRequest
    ...
    # @return [Array<OCI::Opsi::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Opsi::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Opsi::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
