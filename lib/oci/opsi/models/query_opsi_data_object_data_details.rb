...
module OCI
  ...
  class Opsi::Models::QueryOpsiDataObjectDataDetails
    ...
    # @return [Array<OCI::Opsi::Models::OpsiDataObjectDetailsInQuery>]
    ...
    # @option attributes [Array<OCI::Opsi::Models::OpsiDataObjectDetailsInQuery>] :data_objects The value to assign to the {#data_objects} property
