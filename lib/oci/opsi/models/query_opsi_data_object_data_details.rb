...
module OCI
  ...
  class Opsi::Models::QueryOpsiDataObjectDataDetails
    # Unique OPSI data object identifier.
    # @return [String]
    attr_accessor :data_object_identifier

    # This attribute is required.
    # @return [OCI::Opsi::Models::DataObjectQuery]
    attr_accessor :query

    # @return [OCI::Opsi::Models::ResourceFilters]
    ...
    # @option attributes [String] :data_object_identifier The value to assign to the {#data_object_identifier} property
    # @option attributes [OCI::Opsi::Models::DataObjectQuery] :query The value to assign to the {#query} property
    # @option attributes [OCI::Opsi::Models::ResourceFilters] :resource_filters The value to assign to the {#resource_filters} property
    ...
    def hash
      [data_object_identifier, query, resource_filters].hash
    end
