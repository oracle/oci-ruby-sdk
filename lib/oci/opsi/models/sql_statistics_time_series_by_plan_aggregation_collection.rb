...
module OCI
  ...
  #
  class Opsi::Models::SqlStatisticsTimeSeriesByPlanAggregationCollection
    ...
    attr_accessor :end_timestamps

    # **[Required]** array of SQL performance statistics by plans
    # @return [Array<OCI::Opsi::Models::SqlStatisticsTimeSeriesByPlanAggregation>]
    attr_accessor :items
    ...
    # @option attributes [Array<DateTime>] :end_timestamps The value to assign to the {#end_timestamps} property
    # @option attributes [Array<OCI::Opsi::Models::SqlStatisticsTimeSeriesByPlanAggregation>] :items The value to assign to the {#items} property
    ...
    def hash
      [sql_identifier, database_id, time_interval_start, time_interval_end, item_duration_in_ms, end_timestamps, items].hash
    end
