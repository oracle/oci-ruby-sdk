...
module OCI
  ...
  #
  class Opsi::Models::HostEntities < Opsi::Models::HostConfigurationMetricGroup
    ...
    def initialize(attributes = {})
      ...
      attributes['metricName'] = 'HOST_ENTITIES'
    ...
    def hash
      [metric_name, time_collected, entity_name, entity_type].hash
    end
