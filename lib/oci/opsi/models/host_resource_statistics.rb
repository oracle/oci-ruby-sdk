...
module OCI
  ...
  class Opsi::Models::HostResourceStatistics
    RESOURCE_NAME_ENUM = [
      ...
      RESOURCE_NAME_HOST_STORAGE_STATISTICS = 'HOST_STORAGE_STATISTICS'.freeze,
      RESOURCE_NAME_HOST_NETWORK_STATISTICS = 'HOST_NETWORK_STATISTICS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::HostNetworkStatistics' if type == 'HOST_NETWORK_STATISTICS'
      return 'OCI::Opsi::Models::HostStorageStatistics' if type == 'HOST_STORAGE_STATISTICS'
