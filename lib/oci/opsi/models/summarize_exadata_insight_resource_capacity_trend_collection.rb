...
module OCI
  ...
  class Opsi::Models::SummarizeExadataInsightResourceCapacityTrendCollection
    ...
    #
    # @return [Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'usage_unit': :'String',
        'items': :'Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ExadataInsightResourceCapacityTrendSummary>] :items The value to assign to the {#items} property
