...
require 'date'
require_relative 'update_configuration_item_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Configuration item details for OPSI configuration update.
  class Opsi::Models::UpdateBasicConfigurationItemDetails < Opsi::Models::UpdateConfigurationItemDetails
    ...
    def hash
      [config_item_type, name, value].hash
    end
