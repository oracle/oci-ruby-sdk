...
module OCI
  ...
  class Opsi::Models::CreateOperationsInsightsWarehouseDetails
    ...
    def hash
      [compartment_id, display_name, cpu_allocated, storage_allocated_in_gbs, freeform_tags, defined_tags].hash
    end
