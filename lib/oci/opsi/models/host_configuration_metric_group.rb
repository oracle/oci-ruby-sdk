...
module OCI
  ...
  class Opsi::Models::HostConfigurationMetricGroup
    METRIC_NAME_ENUM = [
      METRIC_NAME_HOST_PRODUCT = 'HOST_PRODUCT'.freeze,
      METRIC_NAME_HOST_RESOURCE_ALLOCATION = 'HOST_RESOURCE_ALLOCATION'.freeze,
      METRIC_NAME_HOST_MEMORY_CONFIGURATION = 'HOST_MEMORY_CONFIGURATION'.freeze,
      METRIC_NAME_HOST_HARDWARE_CONFIGURATION = 'HOST_HARDWARE_CONFIGURATION'.freeze,
      METRIC_NAME_HOST_CPU_HARDWARE_CONFIGURATION = 'HOST_CPU_HARDWARE_CONFIGURATION'.freeze,
      METRIC_NAME_HOST_NETWORK_CONFIGURATION = 'HOST_NETWORK_CONFIGURATION'.freeze,
      METRIC_NAME_HOST_ENTITES = 'HOST_ENTITES'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::HostResourceAllocation' if type == 'HOST_RESOURCE_ALLOCATION'
      return 'OCI::Opsi::Models::HostProduct' if type == 'HOST_PRODUCT'
      return 'OCI::Opsi::Models::HostNetworkConfiguration' if type == 'HOST_NETWORK_CONFIGURATION'
      return 'OCI::Opsi::Models::HostEntities' if type == 'HOST_ENTITIES'
      return 'OCI::Opsi::Models::HostMemoryConfiguration' if type == 'HOST_MEMORY_CONFIGURATION'
      return 'OCI::Opsi::Models::HostCpuHardwareConfiguration' if type == 'HOST_CPU_HARDWARE_CONFIGURATION'
      return 'OCI::Opsi::Models::HostHardwareConfiguration' if type == 'HOST_HARDWARE_CONFIGURATION'
