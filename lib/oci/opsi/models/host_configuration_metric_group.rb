...
module OCI
  ...
  class Opsi::Models::HostConfigurationMetricGroup
    METRIC_NAME_ENUM = [
      ...
      METRIC_NAME_HOST_FILESYSTEM_CONFIGURATION = 'HOST_FILESYSTEM_CONFIGURATION'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::HostFilesystemConfiguration' if type == 'HOST_FILESYSTEM_CONFIGURATION'
