...
module OCI
  ...
  class Opsi::Models::TopProcessesUsageTrendAggregation
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'command': :'String',
        'usage_data': :'Array<OCI::Opsi::Models::TopProcessesUsageTrend>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::TopProcessesUsageTrend>] :usage_data The value to assign to the {#usage_data} property
