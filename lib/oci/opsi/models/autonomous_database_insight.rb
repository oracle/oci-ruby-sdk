...
module OCI
  ...
  class Opsi::Models::AutonomousDatabaseInsight < Opsi::Models::DatabaseInsight
    ...
    def hash
      [entity_source, id, compartment_id, status, database_type, database_version, processor_count, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, database_connection_status_details, database_id, database_name, database_display_name, database_resource_type, db_additional_details, opsi_private_endpoint_id, is_advanced_features_enabled, connection_details, credential_details].hash
    end
