...
module OCI
  ...
  class Opsi::Models::PeComanagedDatabaseInsight < Opsi::Models::DatabaseInsight
    ...
    def hash
      [entity_source, id, compartment_id, status, database_type, database_version, processor_count, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, database_connection_status_details, opsi_private_endpoint_id, connection_details, credential_details, database_id, database_name, database_display_name, database_resource_type, parent_id, root_id].hash
    end
