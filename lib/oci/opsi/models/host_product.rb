...
module OCI
  ...
  #
  class Opsi::Models::HostProduct < Opsi::Models::HostConfigurationMetricGroup
    ...
    def initialize(attributes = {})
      ...
      attributes['metricName'] = 'HOST_PRODUCT'
    ...
    def hash
      [metric_name, time_collected, vendor, name, version].hash
    end
