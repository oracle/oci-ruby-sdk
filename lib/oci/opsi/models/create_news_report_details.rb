...
module OCI
  ...
  class Opsi::Models::CreateNewsReportDetails
    NEWS_FREQUENCY_ENUM = [
    ...
    def hash
      [name, news_frequency, description, ons_topic_id, compartment_id, freeform_tags, defined_tags, content_types, locale, status, day_of_week, are_child_compartments_included].hash
    end
