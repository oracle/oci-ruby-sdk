...
module OCI
  ...
  #
  class Opsi::Models::SqlInsightAggregationCollection
    ...
    # @return [OCI::Opsi::Models::SqlInventory]
    attr_accessor :inventory

    # **[Required]** List of insights.
    # @return [Array<OCI::Opsi::Models::SqlInsightAggregation>]
    attr_accessor :items

    # This attribute is required.
    # @return [OCI::Opsi::Models::SqlInsightThresholds]
    ...
    def self.swagger_types
      {
        ...
        'inventory': :'OCI::Opsi::Models::SqlInventory',
        'items': :'Array<OCI::Opsi::Models::SqlInsightAggregation>',
        'thresholds': :'OCI::Opsi::Models::SqlInsightThresholds'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Opsi::Models::SqlInventory] :inventory The value to assign to the {#inventory} property
    # @option attributes [Array<OCI::Opsi::Models::SqlInsightAggregation>] :items The value to assign to the {#items} property
    # @option attributes [OCI::Opsi::Models::SqlInsightThresholds] :thresholds The value to assign to the {#thresholds} property
    def initialize(attributes = {})
      ...
      self.thresholds = attributes[:'thresholds'] if attributes[:'thresholds']
    end
    ...
    def hash
      [time_interval_start, time_interval_end, inventory, items, thresholds].hash
    end
