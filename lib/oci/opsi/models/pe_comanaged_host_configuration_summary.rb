...
module OCI
  ...
  class Opsi::Models::PeComanagedHostConfigurationSummary < Opsi::Models::HostConfigurationSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OPSI private endpoint
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['entitySource'] = 'PE_COMANAGED_HOST'
    ...
    def hash
      [host_insight_id, entity_source, compartment_id, host_name, platform_type, platform_version, platform_vendor, total_cpus, total_memory_in_gbs, cpu_architecture, cpu_cache_in_mbs, cpu_vendor, cpu_frequency_in_mhz, cpu_implementation, cores_per_socket, total_sockets, threads_per_socket, is_hyper_threading_enabled, defined_tags, freeform_tags, opsi_private_endpoint_id, parent_id].hash
    end
