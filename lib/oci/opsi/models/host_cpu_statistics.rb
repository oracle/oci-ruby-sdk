...
module OCI
  ...
  class Opsi::Models::HostCpuStatistics < Opsi::Models::HostResourceStatistics
    ...
    # @option attributes [Float] :cpu_baseline The value to assign to the {#cpu_baseline} property
    ...
    def hash
      [usage, capacity, utilization_percent, usage_change_percent, resource_name, cpu_baseline, load].hash
    end
