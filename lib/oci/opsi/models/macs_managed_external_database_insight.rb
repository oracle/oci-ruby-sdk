...
module OCI
  ...
  class Opsi::Models::MacsManagedExternalDatabaseInsight < Opsi::Models::DatabaseInsight
    ...
    attr_accessor :connection_credential_details
    ...
    #
    # @return [Object]
    attr_accessor :db_additional_details
    ...
    def self.swagger_types
      {
        ...
        'connection_credential_details': :'OCI::Opsi::Models::CredentialDetails',
        'database_id': :'String',
    ...
    # @option attributes [OCI::Opsi::Models::CredentialDetails] :connection_credential_details The value to assign to the {#connection_credential_details} property
    ...
    # @option attributes [Object] :db_additional_details The value to assign to the {#db_additional_details} property
    def initialize(attributes = {})
      ...
      self.connection_credential_details = attributes[:'connectionCredentialDetails'] if attributes[:'connectionCredentialDetails']

      raise 'You cannot provide both :connectionCredentialDetails and :connection_credential_details' if attributes.key?(:'connectionCredentialDetails') && attributes.key?(:'connection_credential_details')

      self.connection_credential_details = attributes[:'connection_credential_details'] if attributes[:'connection_credential_details']
      ...
      self.db_additional_details = attributes[:'dbAdditionalDetails'] if attributes[:'dbAdditionalDetails']

      raise 'You cannot provide both :dbAdditionalDetails and :db_additional_details' if attributes.key?(:'dbAdditionalDetails') && attributes.key?(:'db_additional_details')

      self.db_additional_details = attributes[:'db_additional_details'] if attributes[:'db_additional_details']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        connection_credential_details == other.connection_credential_details &&
        ...
        db_additional_details == other.db_additional_details
    end
