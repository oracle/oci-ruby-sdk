...
module OCI
  ...
  class Opsi::Models::DataObjectQueryTimeFilters
    ...
    # @option attributes [String] :time_period The value to assign to the {#time_period} property
    ...
    def initialize(attributes = {})
      ...
      self.time_period = attributes[:'timePeriod'] if attributes[:'timePeriod']

      raise 'You cannot provide both :timePeriod and :time_period' if attributes.key?(:'timePeriod') && attributes.key?(:'time_period')

      self.time_period = attributes[:'time_period'] if attributes[:'time_period']
    ...
    def hash
      [time_period, time_start, time_end].hash
    end
