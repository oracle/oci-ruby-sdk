...
module OCI
  ...
  class Opsi::Models::SummarizeDatabaseInsightResourceForecastTrendAggregation
    ...
    def hash
      [time_interval_start, time_interval_end, high_utilization_threshold, low_utilization_threshold, resource_metric, usage_unit, selected_forecast_algorithm, pattern, tablespace_name, historical_data, projected_data].hash
    end
