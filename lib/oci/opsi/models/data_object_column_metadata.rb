...
module OCI
  ...
  class Opsi::Models::DataObjectColumnMetadata
    CATEGORY_ENUM = [
    ...
    # @return [OCI::Opsi::Models::DataObjectColumnUnit]
    attr_accessor :unit_details
    ...
    # @option attributes [OCI::Opsi::Models::DataObjectColumnUnit] :unit_details The value to assign to the {#unit_details} property
    ...
    def hash
      [name, category, data_type_name, display_name, description, group_name, unit_details].hash
    end
