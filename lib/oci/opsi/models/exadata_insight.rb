...
module OCI
  ...
  class Opsi::Models::ExadataInsight
    ENTITY_SOURCE_ENUM = [
    ...
    # @return [BOOLEAN]
    attr_accessor :is_virtualized_exadata
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::EmManagedExternalExadataInsight' if type == 'EM_MANAGED_EXTERNAL_EXADATA'
    ...
    # @option attributes [BOOLEAN] :is_virtualized_exadata The value to assign to the {#is_virtualized_exadata} property
    ...
    def initialize(attributes = {})
      ...
      self.is_virtualized_exadata = attributes[:'isVirtualizedExadata'] unless attributes[:'isVirtualizedExadata'].nil?

      raise 'You cannot provide both :isVirtualizedExadata and :is_virtualized_exadata' if attributes.key?(:'isVirtualizedExadata') && attributes.key?(:'is_virtualized_exadata')

      self.is_virtualized_exadata = attributes[:'is_virtualized_exadata'] unless attributes[:'is_virtualized_exadata'].nil?
    ...
    def hash
      [entity_source, id, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, is_virtualized_exadata, status, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
