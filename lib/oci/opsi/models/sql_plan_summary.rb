...
module OCI
  # SQL Plan details
  #
  class Opsi::Models::SqlPlanSummary
    ...
    # @option attributes [String] :plan_content The value to assign to the {#plan_content} property
    def initialize(attributes = {})
      ...
      self.plan_content = attributes[:'planContent'] if attributes[:'planContent']

      raise 'You cannot provide both :planContent and :plan_content' if attributes.key?(:'planContent') && attributes.key?(:'plan_content')

      self.plan_content = attributes[:'plan_content'] if attributes[:'plan_content']
    end
