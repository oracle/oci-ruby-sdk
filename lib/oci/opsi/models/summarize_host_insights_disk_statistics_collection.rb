...
module OCI
  ...
  #
  class Opsi::Models::SummarizeHostInsightsDiskStatisticsCollection
    USAGE_UNIT_ENUM = [
    ...
    #
    # @return [Array<OCI::Opsi::Models::DiskStatistics>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::DiskStatistics>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::DiskStatistics>] :items The value to assign to the {#items} property
