...
module OCI
  ...
  #
  class Opsi::Models::SummarizeHostInsightHostRecommendationAggregation
    ...
    # @return [OCI::Opsi::Models::HostInsightHostRecommendations]
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::Opsi::Models::HostInsightHostRecommendations'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Opsi::Models::HostInsightHostRecommendations] :details The value to assign to the {#details} property
    ...
    def hash
      [resource_metric, usage_unit, item_duration_in_ms, time_interval_start, time_interval_end, details].hash
    end
