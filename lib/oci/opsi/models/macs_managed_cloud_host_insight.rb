...
module OCI
  ...
  class Opsi::Models::MacsManagedCloudHostInsight < Opsi::Models::HostInsight
    PLATFORM_TYPE_ENUM = [
    ...
    def hash
      [entity_source, id, compartment_id, host_name, host_display_name, host_type, processor_count, freeform_tags, defined_tags, system_tags, status, time_created, time_updated, lifecycle_state, lifecycle_details, compute_id, management_agent_id, platform_name, platform_type, platform_version].hash
    end
