...
module OCI
  ...
  class Opsi::Models::DataObjectPowerColumnUnit < Opsi::Models::DataObjectColumnUnit
    UNIT_ENUM = [
      UNIT_AMP = 'AMP'.freeze,
      UNIT_WATT = 'WATT'.freeze,
      UNIT_KILO_WATT = 'KILO_WATT'.freeze,
      UNIT_MEGA_WATT = 'MEGA_WATT'.freeze,
      UNIT_GIGA_WATT = 'GIGA_WATT'.freeze,
