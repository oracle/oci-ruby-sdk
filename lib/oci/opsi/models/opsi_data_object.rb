...
module OCI
  ...
  class Opsi::Models::OpsiDataObject
    ...
    #
    # @return [String]
    attr_accessor :supported_query_time_period
    ...
    # @return [Array<OCI::Opsi::Models::OpsiDataObjectSupportedQueryParam>]
    attr_accessor :supported_query_params
    ...
    # @option attributes [Array<String>] :group_names The value to assign to the {#group_names} property
    # @option attributes [String] :supported_query_time_period The value to assign to the {#supported_query_time_period} property
    ...
    # @option attributes [Array<OCI::Opsi::Models::OpsiDataObjectSupportedQueryParam>] :supported_query_params The value to assign to the {#supported_query_params} property
    ...
    def hash
      [identifier, data_object_type, display_name, description, name, group_names, supported_query_time_period, columns_metadata, supported_query_params].hash
    end
