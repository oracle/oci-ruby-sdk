...
module OCI
  ...
  class Opsi::Models::OpsiDataObject
    ...
    # @return [Array<OCI::Opsi::Models::DataObjectColumnMetadata>]
    attr_accessor :columns_metadata
    ...
    # @option attributes [String] :data_object_type The value to assign to the {#data_object_type} property
    # @option attributes [String] :display_name The value to assign to the {#display_name} property
    # @option attributes [String] :description The value to assign to the {#description} property
    # @option attributes [Array<OCI::Opsi::Models::DataObjectColumnMetadata>] :columns_metadata The value to assign to the {#columns_metadata} property
    def initialize(attributes = {})
      ...
      self.columns_metadata = attributes[:'columnsMetadata'] if attributes[:'columnsMetadata']
      ...
      self.columns_metadata = attributes[:'columns_metadata'] if attributes[:'columns_metadata']
    end
    # rubocop:enable Metrics/CyclomaticComplexity, Metrics/AbcSize, Metrics/PerceivedComplexity
    # rubocop:enable Metrics/MethodLength, Layout/EmptyLines, Style/SymbolLiteral

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] data_object_type Object to be assigned
    def data_object_type=(data_object_type)
      # rubocop:disable Style/ConditionalAssignment
      if data_object_type && !DATA_OBJECT_TYPE_ENUM.include?(data_object_type)
        OCI.logger.debug("Unknown value for 'data_object_type' [" + data_object_type + "]. Mapping to 'DATA_OBJECT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @data_object_type = DATA_OBJECT_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        columns_metadata == other.columns_metadata
    end
    ...
    def hash
      [identifier, data_object_type, display_name, description, columns_metadata].hash
    end
