...
module OCI
  ...
  #
  class Opsi::Models::HostFilesystemConfiguration < Opsi::Models::HostConfigurationMetricGroup
    ...
    # @return [Float]
    attr_accessor :file_system_size_in_gb
    ...
    # @option attributes [Float] :file_system_size_in_gb The value to assign to the {#file_system_size_in_gb} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['metricName'] = 'HOST_FILESYSTEM_CONFIGURATION'
      ...
      self.file_system_size_in_gb = attributes[:'fileSystemSizeInGB'] if attributes[:'fileSystemSizeInGB']

      raise 'You cannot provide both :fileSystemSizeInGB and :file_system_size_in_gb' if attributes.key?(:'fileSystemSizeInGB') && attributes.key?(:'file_system_size_in_gb')

      self.file_system_size_in_gb = attributes[:'file_system_size_in_gb'] if attributes[:'file_system_size_in_gb']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        file_system_size_in_gb == other.file_system_size_in_gb
    end
    ...
    def hash
      [metric_name, time_collected, file_system_name, mount_point, file_system_size_in_gb].hash
    end
