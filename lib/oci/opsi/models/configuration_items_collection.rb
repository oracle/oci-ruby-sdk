...
module OCI
  ...
  class Opsi::Models::ConfigurationItemsCollection
    ...
    # @return [Array<OCI::Opsi::Models::ConfigurationItemSummary>]
    ...
    def self.swagger_types
      {
        ...
        'config_items': :'Array<OCI::Opsi::Models::ConfigurationItemSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::UxConfigurationItemsCollection' if type == 'UX_CONFIGURATION'
    ...
    # @option attributes [Array<OCI::Opsi::Models::ConfigurationItemSummary>] :config_items The value to assign to the {#config_items} property
    ...
    def hash
      [opsi_config_type, config_items].hash
    end
