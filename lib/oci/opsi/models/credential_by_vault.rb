...
require 'date'
require 'logger'
require_relative 'credential_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Vault Credential Details to connect to the database.
  class Opsi::Models::CredentialByVault < Opsi::Models::CredentialDetails
    ROLE_ENUM = [
    ...
    # @option attributes [String] :credential_source_name The value to assign to the {OCI::Opsi::Models::CredentialDetails#credential_source_name #credential_source_name} proprety
    ...
    def hash
      [credential_source_name, credential_type, user_name, password_secret_id, role].hash
    end
