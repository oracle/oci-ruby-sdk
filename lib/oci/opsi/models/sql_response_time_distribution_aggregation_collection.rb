...
module OCI
  ...
  #
  class Opsi::Models::SqlResponseTimeDistributionAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::SqlResponseTimeDistributionAggregation>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Opsi::Models::SqlResponseTimeDistributionAggregation>] :items The value to assign to the {#items} property
    ...
    def hash
      [sql_identifier, id, database_id, time_interval_start, time_interval_end, items].hash
    end
