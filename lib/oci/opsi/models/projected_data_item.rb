...
module OCI
  ...
  #
  class Opsi::Models::ProjectedDataItem
    ...
    # @option attributes [Float] :high_value The value to assign to the {#high_value} property
    # @option attributes [Float] :low_value The value to assign to the {#low_value} property
