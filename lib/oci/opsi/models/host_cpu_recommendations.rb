...
require 'date'
require 'logger'
require_relative 'host_insight_host_recommendations'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Contains CPU recommendation.
  #
  class Opsi::Models::HostCpuRecommendations < Opsi::Models::HostInsightHostRecommendations
    BURSTABLE_ENUM = [
    ...
    # @option attributes [String] :burstable The value to assign to the {#burstable} property
    ...
    # @param [Object] burstable Object to be assigned
    def burstable=(burstable)
      # rubocop:disable Style/ConditionalAssignment
      if burstable && !BURSTABLE_ENUM.include?(burstable)
        OCI.logger.debug("Unknown value for 'burstable' [" + burstable + "]. Mapping to 'BURSTABLE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @burstable = BURSTABLE_UNKNOWN_ENUM_VALUE
      else
        @burstable = burstable
      end
    ...
    def hash
      [metric_recommendation_name, burstable].hash
    end
