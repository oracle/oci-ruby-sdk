...
require 'date'
require 'logger'
require_relative 'importable_agent_entity_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # An agent host entity that can be imported into Operations Insights.
  class Opsi::Models::HostImportableAgentEntitySummary < Opsi::Models::ImportableAgentEntitySummary
    PLATFORM_TYPE_ENUM = [
    ...
    # @option attributes [String] :management_agent_id The value to assign to the {OCI::Opsi::Models::ImportableAgentEntitySummary#management_agent_id #management_agent_id} proprety
    # @option attributes [String] :management_agent_display_name The value to assign to the {OCI::Opsi::Models::ImportableAgentEntitySummary#management_agent_display_name #management_agent_display_name} proprety
    ...
    def hash
      [entity_source, management_agent_id, management_agent_display_name, host_name, platform_type].hash
    end
