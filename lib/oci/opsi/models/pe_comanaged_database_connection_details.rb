...
module OCI
  ...
  class Opsi::Models::PeComanagedDatabaseConnectionDetails
    PROTOCOL_ENUM = [
    ...
    # @return [Array<OCI::Opsi::Models::PeComanagedDatabaseHostDetails>]
    attr_accessor :hosts
    ...
    # @option attributes [Array<OCI::Opsi::Models::PeComanagedDatabaseHostDetails>] :hosts The value to assign to the {#hosts} property
    ...
    def hash
      [hosts, protocol, service_name].hash
    end
