...
module OCI
  ...
  class Opsi::Models::ExadataDiskgroupStatisticsSummary < Opsi::Models::ExadataInsightResourceStatisticsAggregation
    # This attribute is required.
    # @return [OCI::Opsi::Models::DiskGroupDetails]
    ...
    # @option attributes [OCI::Opsi::Models::DiskGroupDetails] :resource_details The value to assign to the {#resource_details} property
    ...
    def initialize(attributes = {})
      ...
      attributes['exadataResourceType'] = 'DISKGROUP'
