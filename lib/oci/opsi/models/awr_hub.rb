...
module OCI
  ...
  class Opsi::Models::AwrHub
    ...
    # @return [String]
    attr_accessor :hub_dst_timezone_version
    ...
    # @option attributes [String] :hub_dst_timezone_version The value to assign to the {#hub_dst_timezone_version} property
    def initialize(attributes = {})
      ...
      self.hub_dst_timezone_version = attributes[:'hubDstTimezoneVersion'] if attributes[:'hubDstTimezoneVersion']

      raise 'You cannot provide both :hubDstTimezoneVersion and :hub_dst_timezone_version' if attributes.key?(:'hubDstTimezoneVersion') && attributes.key?(:'hub_dst_timezone_version')

      self.hub_dst_timezone_version = attributes[:'hub_dst_timezone_version'] if attributes[:'hub_dst_timezone_version']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        hub_dst_timezone_version == other.hub_dst_timezone_version
    end
    ...
    def hash
      [operations_insights_warehouse_id, id, compartment_id, display_name, object_storage_bucket_name, awr_mailbox_url, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, hub_dst_timezone_version].hash
    end
