...
module OCI
  ...
  #
  class Opsi::Models::SummarizeDatabaseInsightResourceUsageTrendAggregationCollection
    ...
    #
    # @return [Array<OCI::Opsi::Models::ResourceUsageTrendAggregation>]
    ...
    def self.swagger_types
      {
        ...
        'usage_data': :'Array<OCI::Opsi::Models::ResourceUsageTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ResourceUsageTrendAggregation>] :usage_data The value to assign to the {#usage_data} property
    ...
    def hash
      [time_interval_start, time_interval_end, resource_metric, usage_unit, item_duration_in_ms, usage_data].hash
    end
