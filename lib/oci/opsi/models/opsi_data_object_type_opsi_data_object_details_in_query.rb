...
require 'date'
require_relative 'opsi_data_object_details_in_query'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details applicable for all OPSI data objects of a specific OpsiDataObjectType used in a data object query.
  class Opsi::Models::OpsiDataObjectTypeOpsiDataObjectDetailsInQuery < Opsi::Models::OpsiDataObjectDetailsInQuery
    ...
    # @option attributes [Array<OCI::Opsi::Models::OpsiDataObjectQueryParam>] :_query_params The value to assign to the {OCI::Opsi::Models::OpsiDataObjectDetailsInQuery#_query_params #_query_params} proprety
    # @option attributes [String] :data_object_type The value to assign to the {#data_object_type} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['dataObjectDetailsTarget'] = 'OPSIDATAOBJECTTYPE_OPSIDATAOBJECTS'
    ...
    def data_object_type=(data_object_type)
      raise "Invalid value for 'data_object_type': this must be one of the values in DATA_OBJECT_TYPE_ENUM." if data_object_type && !DATA_OBJECT_TYPE_ENUM.include?(data_object_type)
    ...
    def hash
      [data_object_details_target, _query_params, data_object_type].hash
    end
