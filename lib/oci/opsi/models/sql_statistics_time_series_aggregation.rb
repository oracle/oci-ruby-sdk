...
module OCI
  ...
  class Opsi::Models::SqlStatisticsTimeSeriesAggregation
    ...
    #
    # @return [Array<OCI::Opsi::Models::SqlStatisticsTimeSeries>]
    ...
    def self.swagger_types
      {
        ...
        'statistics': :'Array<OCI::Opsi::Models::SqlStatisticsTimeSeries>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::SqlStatisticsTimeSeries>] :statistics The value to assign to the {#statistics} property
    ...
    def hash
      [database_details, statistics].hash
    end
