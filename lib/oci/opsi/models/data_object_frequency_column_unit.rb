...
module OCI
  ...
  class Opsi::Models::DataObjectFrequencyColumnUnit < Opsi::Models::DataObjectColumnUnit
    UNIT_ENUM = [
      UNIT_HERTZ = 'HERTZ'.freeze,
      UNIT_KILO_HERTZ = 'KILO_HERTZ'.freeze,
      UNIT_MEGA_HERTZ = 'MEGA_HERTZ'.freeze,
      UNIT_GIGA_HERTZ = 'GIGA_HERTZ'.freeze,
      UNIT_TERA_HERTZ = 'TERA_HERTZ'.freeze,
    ...
    def initialize(attributes = {})
      ...
      attributes['unitCategory'] = 'FREQUENCY'
