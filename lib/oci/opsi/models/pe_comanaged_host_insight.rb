...
module OCI
  ...
  class Opsi::Models::PeComanagedHostInsight < Opsi::Models::HostInsight
    PLATFORM_TYPE_ENUM = [
      ...
      PLATFORM_TYPE_HP_UX = 'HP_UX'.freeze,
    ...
    def hash
      [entity_source, id, compartment_id, host_name, host_display_name, host_type, processor_count, freeform_tags, defined_tags, system_tags, status, time_created, time_updated, lifecycle_state, lifecycle_details, opsi_private_endpoint_id, platform_type, parent_id, root_id].hash
    end
