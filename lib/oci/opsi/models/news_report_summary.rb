...
module OCI
  ...
  class Opsi::Models::NewsReportSummary
    ...
    def hash
      [news_frequency, content_types, locale, id, description, compartment_id, name, ons_topic_id, freeform_tags, defined_tags, system_tags, status, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
