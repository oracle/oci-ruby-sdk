...
require 'date'
require_relative 'opsi_configuration_configuration_item_summary'
...
module OCI
  ...
  #
  class Opsi::Models::OpsiConfigurationBasicConfigurationItemSummary < Opsi::Models::OpsiConfigurationConfigurationItemSummary
    ...
    def hash
      [config_item_type, name, value, default_value, applicable_contexts, metadata].hash
    end
