...
module OCI
  ...
  #
  class Opsi::Models::HostHardwareConfiguration < Opsi::Models::HostConfigurationMetricGroup
    ...
    def initialize(attributes = {})
      ...
      attributes['metricName'] = 'HOST_HARDWARE_CONFIGURATION'
    ...
    def hash
      [metric_name, time_collected, cpu_architecture].hash
    end
