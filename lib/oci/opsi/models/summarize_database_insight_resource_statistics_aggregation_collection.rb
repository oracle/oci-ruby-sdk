...
module OCI
  ...
  class Opsi::Models::SummarizeDatabaseInsightResourceStatisticsAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::ResourceStatisticsAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'usage_unit': :'String',
        'items': :'Array<OCI::Opsi::Models::ResourceStatisticsAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ResourceStatisticsAggregation>] :items The value to assign to the {#items} property
