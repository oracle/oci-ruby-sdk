...
module OCI
  ...
  class Opsi::Models::SummarizeExadataInsightResourceUsageCollection
    ...
    # @return [Array<OCI::Opsi::Models::ResourceUsageSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'usage_unit': :'String',
        'items': :'Array<OCI::Opsi::Models::ResourceUsageSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ResourceUsageSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [time_interval_start, time_interval_end, exadata_resource_metric, exadata_resource_type, usage_unit, items].hash
    end
