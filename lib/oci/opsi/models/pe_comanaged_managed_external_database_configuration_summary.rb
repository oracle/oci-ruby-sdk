...
module OCI
  ...
  class Opsi::Models::PeComanagedManagedExternalDatabaseConfigurationSummary < Opsi::Models::DatabaseConfigurationSummary
    ...
    def hash
      [database_insight_id, entity_source, compartment_id, database_name, database_display_name, database_type, database_version, cdb_name, defined_tags, freeform_tags, processor_count, database_id, parent_id, opsi_private_endpoint_id, instances].hash
    end
