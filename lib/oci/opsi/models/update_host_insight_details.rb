...
module OCI
  ...
  class Opsi::Models::UpdateHostInsightDetails
    ENTITY_SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::UpdateEmManagedExternalHostInsightDetails' if type == 'EM_MANAGED_EXTERNAL_HOST'
      return 'OCI::Opsi::Models::UpdateMacsManagedExternalHostInsightDetails' if type == 'MACS_MANAGED_EXTERNAL_HOST'
