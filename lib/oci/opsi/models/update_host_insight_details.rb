...
module OCI
  ...
  class Opsi::Models::UpdateHostInsightDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::UpdateMacsManagedCloudHostInsightDetails' if type == 'MACS_MANAGED_CLOUD_HOST'
      return 'OCI::Opsi::Models::UpdatePeComanagedHostInsightDetails' if type == 'PE_COMANAGED_HOST'
