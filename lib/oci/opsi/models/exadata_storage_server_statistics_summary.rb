...
module OCI
  ...
  class Opsi::Models::ExadataStorageServerStatisticsSummary < Opsi::Models::ExadataInsightResourceStatisticsAggregation
    # This attribute is required.
    # @return [OCI::Opsi::Models::StorageServerDetails]
    ...
    def self.swagger_types
      {
        ...
        'resource_details': :'OCI::Opsi::Models::StorageServerDetails',
    ...
    # @option attributes [OCI::Opsi::Models::StorageServerDetails] :resource_details The value to assign to the {#resource_details} property
    ...
    def initialize(attributes = {})
      ...
      attributes['exadataResourceType'] = 'STORAGE_SERVER'
