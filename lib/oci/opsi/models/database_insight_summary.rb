...
module OCI
  ...
  class Opsi::Models::DatabaseInsightSummary
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::PeComanagedDatabaseInsightSummary' if type == 'PE_COMANAGED_DATABASE'
    ...
    def hash
      [id, database_id, compartment_id, database_name, database_display_name, database_type, database_version, database_host_names, freeform_tags, defined_tags, system_tags, entity_source, processor_count, status, time_created, time_updated, lifecycle_state, lifecycle_details, database_connection_status_details].hash
    end
