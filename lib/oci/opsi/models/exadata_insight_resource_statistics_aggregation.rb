...
module OCI
  ...
  class Opsi::Models::ExadataInsightResourceStatisticsAggregation
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'exadataResourceType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Opsi::Models::ExadataStorageServerStatisticsSummary' if type == 'STORAGE_SERVER'
      return 'OCI::Opsi::Models::ExadataHostStatisticsSummary' if type == 'HOST'
      return 'OCI::Opsi::Models::ExadataDatabaseStatisticsSummary' if type == 'DATABASE'
      return 'OCI::Opsi::Models::ExadataDiskgroupStatisticsSummary' if type == 'DISKGROUP'
