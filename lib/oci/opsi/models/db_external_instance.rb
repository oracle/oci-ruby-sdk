...
module OCI
  ...
  class Opsi::Models::DBExternalInstance < Opsi::Models::DatabaseConfigurationMetricGroup
    ...
    # @return [Float]
    attr_accessor :host_memory_capacity
    ...
    # @option attributes [Float] :host_memory_capacity The value to assign to the {#host_memory_capacity} property
    # @option attributes [String] :version The value to assign to the {#version} property
    # @option attributes [String] :parallel The value to assign to the {#parallel} property
    # @option attributes [String] :instance_role The value to assign to the {#instance_role} property
    # @option attributes [String] :logins The value to assign to the {#logins} property
    # @option attributes [String] :database_status The value to assign to the {#database_status} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [String] :edition The value to assign to the {#edition} property
    # @option attributes [DateTime] :startup_time The value to assign to the {#startup_time} property
