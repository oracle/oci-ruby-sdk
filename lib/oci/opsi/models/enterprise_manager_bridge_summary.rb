...
module OCI
  ...
  class Opsi::Models::EnterpriseManagerBridgeSummary
    ...
    # @return [String]
    attr_accessor :object_storage_namespace_name
    ...
    def initialize(attributes = {})
      ...
      self.object_storage_namespace_name = attributes[:'objectStorageNamespaceName'] if attributes[:'objectStorageNamespaceName']

      raise 'You cannot provide both :objectStorageNamespaceName and :object_storage_namespace_name' if attributes.key?(:'objectStorageNamespaceName') && attributes.key?(:'object_storage_namespace_name')

      self.object_storage_namespace_name = attributes[:'object_storage_namespace_name'] if attributes[:'object_storage_namespace_name']
    ...
    def hash
      [id, compartment_id, display_name, object_storage_namespace_name, object_storage_bucket_name, object_storage_bucket_status_details, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
