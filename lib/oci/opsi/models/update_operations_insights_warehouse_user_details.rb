...
module OCI
  ...
  class Opsi::Models::UpdateOperationsInsightsWarehouseUserDetails
    ...
    def hash
      [connection_password, is_awr_data_access, is_em_data_access, is_opsi_data_access, freeform_tags, defined_tags].hash
    end
