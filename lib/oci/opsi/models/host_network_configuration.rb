...
module OCI
  ...
  #
  class Opsi::Models::HostNetworkConfiguration < Opsi::Models::HostConfigurationMetricGroup
    ...
    def initialize(attributes = {})
      ...
      attributes['metricName'] = 'HOST_NETWORK_CONFIGURATION'
      ...
      self.interface_name = attributes[:'interface_name'] if attributes[:'interface_name']
    ...
    def hash
      [metric_name, time_collected, interface_name, ip_address, mac_address].hash
    end
