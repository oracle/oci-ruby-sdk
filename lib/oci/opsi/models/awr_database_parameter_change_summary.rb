...
module OCI
  ...
  class Opsi::Models::AwrDatabaseParameterChangeSummary
    ...
    # **[Required]** The ID of the snapshot with the parameter value changed. The snapshot identifier is not the [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
