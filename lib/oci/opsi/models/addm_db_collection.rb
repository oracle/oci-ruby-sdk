...
module OCI
  ...
  class Opsi::Models::AddmDbCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbSummary>] :items The value to assign to the {#items} property
