...
module OCI
  ...
  class Opsi::Models::IndividualOpsiDataObjectDetailsInQuery < Opsi::Models::OpsiDataObjectDetailsInQuery
    ...
    def initialize(attributes = {})
      ...
      attributes['dataObjectDetailsTarget'] = 'INDIVIDUAL_OPSIDATAOBJECT'
    ...
    def hash
      [data_object_details_target, _query_params, data_object_identifier].hash
    end
