...
module OCI
  ...
  #
  class Opsi::Models::AddmDbParameterChangeAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbParameterChangeAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbParameterChangeAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbParameterChangeAggregation>] :items The value to assign to the {#items} property
