...
module OCI
  ...
  #
  class Opsi::Models::SummarizeDatabaseInsightResourceCapacityTrendAggregationCollection
    ...
    #
    # @return [Array<OCI::Opsi::Models::ResourceCapacityTrendAggregation>]
    ...
    def self.swagger_types
      {
        ...
        'capacity_data': :'Array<OCI::Opsi::Models::ResourceCapacityTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ResourceCapacityTrendAggregation>] :capacity_data The value to assign to the {#capacity_data} property
    ...
    def hash
      [time_interval_start, time_interval_end, resource_metric, usage_unit, item_duration_in_ms, capacity_data].hash
    end
