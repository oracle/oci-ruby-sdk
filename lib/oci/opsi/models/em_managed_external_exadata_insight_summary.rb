...
require 'date'
require_relative 'exadata_insight_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Summary of an Exadata insight resource.
  class Opsi::Models::EmManagedExternalExadataInsightSummary < Opsi::Models::ExadataInsightSummary
    ...
    # @option attributes [String] :id The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#id #id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#compartment_id #compartment_id} proprety
    # @option attributes [String] :exadata_name The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#exadata_name #exadata_name} proprety
    # @option attributes [String] :exadata_display_name The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#exadata_display_name #exadata_display_name} proprety
    # @option attributes [String] :exadata_type The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#exadata_type #exadata_type} proprety
    # @option attributes [String] :exadata_rack_type The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#exadata_rack_type #exadata_rack_type} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#defined_tags #defined_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#system_tags #system_tags} proprety
    # @option attributes [String] :status The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#status #status} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#time_updated #time_updated} proprety
    # @option attributes [String] :lifecycle_state The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#lifecycle_state #lifecycle_state} proprety
    # @option attributes [String] :lifecycle_details The value to assign to the {OCI::Opsi::Models::ExadataInsightSummary#lifecycle_details #lifecycle_details} proprety
    ...
    def hash
      [entity_source, id, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, freeform_tags, defined_tags, system_tags, status, time_created, time_updated, lifecycle_state, lifecycle_details, enterprise_manager_identifier, enterprise_manager_entity_name, enterprise_manager_entity_type, enterprise_manager_entity_identifier, enterprise_manager_entity_display_name, enterprise_manager_bridge_id].hash
    end
