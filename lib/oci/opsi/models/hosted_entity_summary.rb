...
module OCI
  ...
  #
  class Opsi::Models::HostedEntitySummary
    ...
    # @option attributes [String] :entity_identifier The value to assign to the {#entity_identifier} property
    ...
    def initialize(attributes = {})
      ...
      self.entity_identifier = attributes[:'entityIdentifier'] if attributes[:'entityIdentifier']

      raise 'You cannot provide both :entityIdentifier and :entity_identifier' if attributes.key?(:'entityIdentifier') && attributes.key?(:'entity_identifier')

      self.entity_identifier = attributes[:'entity_identifier'] if attributes[:'entity_identifier']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        entity_identifier == other.entity_identifier &&
    ...
    def hash
      [entity_identifier, entity_name, entity_type].hash
    end
