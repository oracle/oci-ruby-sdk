...
module OCI
  ...
  class Opsi::Models::DataObjectCoreColumnUnit < Opsi::Models::DataObjectColumnUnit
    UNIT_ENUM = [
      UNIT_CORE = 'CORE'.freeze,
      UNIT_MILLI_CORE = 'MILLI_CORE'.freeze,
