...
require 'date'
require_relative 'configuration_item_allowed_value_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Allowed value details of configuration item for LIMIT type. Value has to be between minValue and maxValue.
  class Opsi::Models::ConfigurationItemLimitAllowedValueDetails < Opsi::Models::ConfigurationItemAllowedValueDetails
    ...
    # @option attributes [String] :min_value The value to assign to the {#min_value} property
    # @option attributes [String] :max_value The value to assign to the {#max_value} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['allowedValueType'] = 'LIMIT'
    ...
    def hash
      [allowed_value_type, min_value, max_value].hash
    end
