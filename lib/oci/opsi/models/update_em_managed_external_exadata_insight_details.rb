...
require 'date'
require_relative 'update_exadata_insight_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The information to be updated.
  class Opsi::Models::UpdateEmManagedExternalExadataInsightDetails < Opsi::Models::UpdateExadataInsightDetails
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Opsi::Models::UpdateExadataInsightDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Opsi::Models::UpdateExadataInsightDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [entity_source, freeform_tags, defined_tags, is_auto_sync_enabled].hash
    end
