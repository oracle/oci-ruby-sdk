...
module OCI
  ...
  #
  class Opsi::Models::SummarizeHostInsightsTopProcessesUsageTrendCollection
    ...
    # @return [Array<OCI::Opsi::Models::TopProcessesUsageTrendAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::TopProcessesUsageTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::TopProcessesUsageTrendAggregation>] :items The value to assign to the {#items} property
    ...
    def hash
      [time_interval_start, time_interval_end, items].hash
    end
