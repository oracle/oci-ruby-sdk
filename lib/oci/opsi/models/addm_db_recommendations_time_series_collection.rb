...
module OCI
  ...
  class Opsi::Models::AddmDbRecommendationsTimeSeriesCollection
    ...
    # @return [Array<OCI::Opsi::Models::DatabaseDetails>]
    attr_accessor :database_details_items

    # **[Required]** List of ADDM recommendations time series data
    # @return [Array<OCI::Opsi::Models::AddmDbRecommendationsTimeSeriesSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbRecommendationsTimeSeriesSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::DatabaseDetails>] :database_details_items The value to assign to the {#database_details_items} property
    # @option attributes [Array<OCI::Opsi::Models::AddmDbRecommendationsTimeSeriesSummary>] :items The value to assign to the {#items} property
    def initialize(attributes = {})
      ...
      self.database_details_items = attributes[:'databaseDetailsItems'] if attributes[:'databaseDetailsItems']

      raise 'You cannot provide both :databaseDetailsItems and :database_details_items' if attributes.key?(:'databaseDetailsItems') && attributes.key?(:'database_details_items')

      self.database_details_items = attributes[:'database_details_items'] if attributes[:'database_details_items']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        database_details_items == other.database_details_items &&
        items == other.items
    end
    ...
    def hash
      [time_interval_start, time_interval_end, database_details_items, items].hash
    end
