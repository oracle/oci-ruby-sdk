...
module OCI
  ...
  class Opsi::Models::CreateExadataInsightDetails
    ENTITY_SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::CreateEmManagedExternalExadataInsightDetails' if type == 'EM_MANAGED_EXTERNAL_EXADATA'
    ...
    def hash
      [entity_source, compartment_id, freeform_tags, defined_tags].hash
    end
