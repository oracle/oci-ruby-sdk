...
module OCI
  ...
  #
  class Opsi::Models::SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection
    USAGE_UNIT_ENUM = [
    ...
    #
    # @return [Array<OCI::Opsi::Models::TablespaceUsageTrendAggregation>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Opsi::Models::TablespaceUsageTrendAggregation>] :items The value to assign to the {#items} property
