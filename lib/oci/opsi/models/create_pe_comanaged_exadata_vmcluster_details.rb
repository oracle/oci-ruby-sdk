...
module OCI
  ...
  class Opsi::Models::CreatePeComanagedExadataVmclusterDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM Cluster.
    # @return [String]
    attr_accessor :vmcluster_id
    ...
    # @return [Array<OCI::Opsi::Models::CreatePeComanagedDatabaseInsightDetails>]
    attr_accessor :member_database_details
    ...
    # @option attributes [String] :vmcluster_id The value to assign to the {#vmcluster_id} property
    ...
    # @option attributes [Array<OCI::Opsi::Models::CreatePeComanagedDatabaseInsightDetails>] :member_database_details The value to assign to the {#member_database_details} property
    ...
    def initialize(attributes = {})
      ...
      self.vmcluster_id = attributes[:'vmclusterId'] if attributes[:'vmclusterId']

      raise 'You cannot provide both :vmclusterId and :vmcluster_id' if attributes.key?(:'vmclusterId') && attributes.key?(:'vmcluster_id')

      self.vmcluster_id = attributes[:'vmcluster_id'] if attributes[:'vmcluster_id']
      ...
      self.member_database_details = attributes[:'memberDatabaseDetails'] if attributes[:'memberDatabaseDetails']

      raise 'You cannot provide both :memberDatabaseDetails and :member_database_details' if attributes.key?(:'memberDatabaseDetails') && attributes.key?(:'member_database_details')

      self.member_database_details = attributes[:'member_database_details'] if attributes[:'member_database_details']
    ...
    def hash
      [vmcluster_id, opsi_private_endpoint_id, dbm_private_endpoint_id, member_database_details, compartment_id].hash
    end
