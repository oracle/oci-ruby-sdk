...
module OCI
  ...
  class Opsi::Models::AddmDbFindingsTimeSeriesCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbFindingsTimeSeriesSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbFindingsTimeSeriesSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbFindingsTimeSeriesSummary>] :items The value to assign to the {#items} property
