...
module OCI
  ...
  class Opsi::Models::EnablePeComanagedDatabaseInsightDetails < Opsi::Models::EnableDatabaseInsightDetails
    ...
    def hash
      [entity_source, compartment_id, opsi_private_endpoint_id, service_name, credential_details, freeform_tags, defined_tags, system_tags].hash
    end
