...
module OCI
  ...
  class Opsi::Models::SummarizeExadataInsightResourceUsageAggregation
    ...
    def hash
      [time_interval_start, time_interval_end, exadata_resource_metric, exadata_resource_type, usage_unit, usage, capacity, usage_change_percent, total_host_capacity].hash
    end
