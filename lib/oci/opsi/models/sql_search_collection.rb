...
module OCI
  # Search SQL response.
  #
  class Opsi::Models::SqlSearchCollection
    ...
    # @return [Array<OCI::Opsi::Models::SqlSearchSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Opsi::Models::SqlSearchSummary>] :items The value to assign to the {#items} property
    ...
    def hash
      [sql_identifier, sql_text, time_interval_start, time_interval_end, items].hash
    end
