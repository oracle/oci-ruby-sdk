...
module OCI
  ...
  #
  class Opsi::Models::HostedEntityCollection
    ...
    #
    # @return [Array<OCI::Opsi::Models::HostedEntitySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::HostedEntitySummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::HostedEntitySummary>] :items The value to assign to the {#items} property
