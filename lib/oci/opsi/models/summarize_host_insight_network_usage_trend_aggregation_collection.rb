...
module OCI
  ...
  #
  class Opsi::Models::SummarizeHostInsightNetworkUsageTrendAggregationCollection
    USAGE_UNIT_ENUM = [
    ...
    #
    # @return [Array<OCI::Opsi::Models::NetworkUsageTrendAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::NetworkUsageTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::NetworkUsageTrendAggregation>] :items The value to assign to the {#items} property
