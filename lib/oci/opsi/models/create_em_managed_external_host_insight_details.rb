...
require 'date'
require_relative 'create_host_insight_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The information about the EM-managed external host to be analyzed.
  class Opsi::Models::CreateEmManagedExternalHostInsightDetails < Opsi::Models::CreateHostInsightDetails
    ...
    # @option attributes [String] :compartment_id The value to assign to the {OCI::Opsi::Models::CreateHostInsightDetails#compartment_id #compartment_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Opsi::Models::CreateHostInsightDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::Opsi::Models::CreateHostInsightDetails#defined_tags #defined_tags} proprety
