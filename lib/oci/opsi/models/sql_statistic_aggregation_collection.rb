...
module OCI
  ...
  #
  class Opsi::Models::SqlStatisticAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::SqlStatisticAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::SqlStatisticAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::SqlStatisticAggregation>] :items The value to assign to the {#items} property
