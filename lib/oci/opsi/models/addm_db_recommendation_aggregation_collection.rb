...
module OCI
  ...
  class Opsi::Models::AddmDbRecommendationAggregationCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbRecommendationAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::AddmDbRecommendationAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbRecommendationAggregation>] :items The value to assign to the {#items} property
