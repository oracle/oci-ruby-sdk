...
module OCI
  ...
  class Opsi::Models::TablespaceUsageTrendAggregation
    ...
    # @return [String]
    attr_accessor :tablespace_type

    # **[Required]** List of usage data samples for a tablespace
    # @return [Array<OCI::Opsi::Models::TablespaceUsageTrend>]
    ...
    def self.swagger_types
      {
        ...
        'usage_data': :'Array<OCI::Opsi::Models::TablespaceUsageTrend>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :tablespace_type The value to assign to the {#tablespace_type} property
    # @option attributes [Array<OCI::Opsi::Models::TablespaceUsageTrend>] :usage_data The value to assign to the {#usage_data} property
    def initialize(attributes = {})
      ...
      self.tablespace_type = attributes[:'tablespaceType'] if attributes[:'tablespaceType']

      raise 'You cannot provide both :tablespaceType and :tablespace_type' if attributes.key?(:'tablespaceType') && attributes.key?(:'tablespace_type')

      self.tablespace_type = attributes[:'tablespace_type'] if attributes[:'tablespace_type']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tablespace_type == other.tablespace_type &&
    ...
    def hash
      [tablespace_name, tablespace_type, usage_data].hash
    end
