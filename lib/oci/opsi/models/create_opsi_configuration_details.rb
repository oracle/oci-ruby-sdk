...
module OCI
  ...
  class Opsi::Models::CreateOpsiConfigurationDetails
    ...
    #
    # @return [Array<OCI::Opsi::Models::CreateConfigurationItemDetails>]
    ...
    # @option attributes [Array<OCI::Opsi::Models::CreateConfigurationItemDetails>] :config_items The value to assign to the {#config_items} property
