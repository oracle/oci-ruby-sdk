...
module OCI
  ...
  class Opsi::Models::ResourceStatisticsAggregation
    # @return [OCI::Opsi::Models::DatabaseDetails]
    attr_accessor :database_details

    # @return [OCI::Opsi::Models::ResourceStatistics]
    ...
    def self.swagger_types
      {
        ...
        'current_statistics': :'OCI::Opsi::Models::ResourceStatistics'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Opsi::Models::ResourceStatistics] :current_statistics The value to assign to the {#current_statistics} property
    ...
    def hash
      [database_details, current_statistics].hash
    end
