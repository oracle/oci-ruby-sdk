...
module OCI
  ...
  class Opsi::Models::WarehouseDataObjectSummary
    DATA_OBJECT_TYPE_ENUM = [
      DATA_OBJECT_TYPE_VIEW = 'VIEW'.freeze,
      DATA_OBJECT_TYPE_TABLE = 'TABLE'.freeze,
    ...
    # @return [OCI::Opsi::Models::WarehouseDataObjectDetails]
    ...
    # @option attributes [OCI::Opsi::Models::WarehouseDataObjectDetails] :details The value to assign to the {#details} property
    ...
    def hash
      [data_object_type, name, owner, details].hash
    end
