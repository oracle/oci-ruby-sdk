...
require 'date'
require_relative 'add_exadata_insight_members_details'
...
module OCI
  ...
  class Opsi::Models::AddEmManagedExternalExadataInsightMembersDetails < Opsi::Models::AddExadataInsightMembersDetails
    ...
    def hash
      [entity_source, member_entity_details].hash
    end
