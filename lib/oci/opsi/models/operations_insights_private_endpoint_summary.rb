...
module OCI
  ...
  class Opsi::Models::OperationsInsightsPrivateEndpointSummary
    ...
    # @return [String]
    attr_accessor :private_endpoint_status_details
    ...
    # @option attributes [String] :private_endpoint_status_details The value to assign to the {#private_endpoint_status_details} property
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, is_used_for_rac_dbs, description, time_created, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, private_endpoint_status_details].hash
    end
