...
module OCI
  ...
  class Opsi::Models::AwrDatabaseSnapshotSummary
    ...
    # **[Required]** The ID of the snapshot. The snapshot identifier is not the [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # It can be retrieved from the following endpoint:
    ...
    def hash
      [awr_source_database_identifier, instance_number, time_db_startup, time_begin, time_end, snapshot_identifier, error_count].hash
    end
