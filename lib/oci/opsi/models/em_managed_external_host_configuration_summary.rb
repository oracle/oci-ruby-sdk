...
module OCI
  ...
  class Opsi::Models::EmManagedExternalHostConfigurationSummary < Opsi::Models::HostConfigurationSummary
    ...
    def hash
      [host_insight_id, entity_source, compartment_id, host_name, platform_type, platform_version, platform_vendor, total_cpus, total_memory_in_gbs, cpu_architecture, cpu_cache_in_mbs, cpu_vendor, cpu_frequency_in_mhz, cpu_implementation, cores_per_socket, total_sockets, threads_per_socket, is_hyper_threading_enabled, defined_tags, freeform_tags, enterprise_manager_identifier, enterprise_manager_bridge_id, exadata_details].hash
    end
