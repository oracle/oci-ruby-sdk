...
module OCI
  ...
  class Opsi::Models::AddPeComanagedExadataInsightMembersDetails < Opsi::Models::AddExadataInsightMembersDetails
    ...
    def self.swagger_types
      {
        ...
        'member_entity_details': :'Array<OCI::Opsi::Models::CreatePeComanagedExadataVmclusterDetails>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::CreatePeComanagedExadataVmclusterDetails>] :member_entity_details The value to assign to the {#member_entity_details} property
