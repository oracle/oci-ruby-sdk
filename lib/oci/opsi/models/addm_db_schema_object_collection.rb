...
module OCI
  ...
  class Opsi::Models::AddmDbSchemaObjectCollection
    ...
    # @return [Array<OCI::Opsi::Models::AddmDbSchemaObjectSummary>]
    attr_accessor :items
    ...
    # @option attributes [Array<OCI::Opsi::Models::AddmDbSchemaObjectSummary>] :items The value to assign to the {#items} property
