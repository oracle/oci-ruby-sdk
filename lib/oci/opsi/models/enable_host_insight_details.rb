...
module OCI
  ...
  class Opsi::Models::EnableHostInsightDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::EnableMacsManagedExternalHostInsightDetails' if type == 'MACS_MANAGED_EXTERNAL_HOST'
      return 'OCI::Opsi::Models::EnableEmManagedExternalHostInsightDetails' if type == 'EM_MANAGED_EXTERNAL_HOST'
