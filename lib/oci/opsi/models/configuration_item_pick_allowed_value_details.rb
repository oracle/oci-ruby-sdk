...
module OCI
  ...
  #
  class Opsi::Models::ConfigurationItemPickAllowedValueDetails < Opsi::Models::ConfigurationItemAllowedValueDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['allowedValueType'] = 'PICK'
    ...
    def hash
      [allowed_value_type, possible_values].hash
    end
