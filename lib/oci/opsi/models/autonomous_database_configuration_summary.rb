...
module OCI
  ...
  class Opsi::Models::AutonomousDatabaseConfigurationSummary < Opsi::Models::DatabaseConfigurationSummary
    ...
    def hash
      [database_insight_id, entity_source, compartment_id, database_name, database_display_name, database_type, database_version, defined_tags, freeform_tags, processor_count, database_id].hash
    end
