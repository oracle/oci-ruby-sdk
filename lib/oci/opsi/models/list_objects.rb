...
module OCI
  ...
  class Opsi::Models::ListObjects
    ...
    # @return [Array<OCI::Opsi::Models::ObjectSummary>]
    ...
    def self.swagger_types
      {
        ...
        'objects': :'Array<OCI::Opsi::Models::ObjectSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::ObjectSummary>] :objects The value to assign to the {#objects} property
    ...
    def hash
      [prefixes, next_start_with, objects].hash
    end
