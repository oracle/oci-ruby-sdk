...
module OCI
  ...
  class Opsi::Models::CreateAwrHubDetails
    ...
    def hash
      [operations_insights_warehouse_id, compartment_id, display_name, object_storage_bucket_name, freeform_tags, defined_tags].hash
    end
