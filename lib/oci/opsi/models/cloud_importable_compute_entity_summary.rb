...
require 'date'
require 'logger'
require_relative 'importable_compute_entity_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A compute host entity that can be imported into Operations Insights.
  class Opsi::Models::CloudImportableComputeEntitySummary < Opsi::Models::ImportableComputeEntitySummary
    PLATFORM_TYPE_ENUM = [
    ...
    # @option attributes [String] :compute_id The value to assign to the {OCI::Opsi::Models::ImportableComputeEntitySummary#compute_id #compute_id} proprety
    # @option attributes [String] :compute_display_name The value to assign to the {OCI::Opsi::Models::ImportableComputeEntitySummary#compute_display_name #compute_display_name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::Opsi::Models::ImportableComputeEntitySummary#compartment_id #compartment_id} proprety
