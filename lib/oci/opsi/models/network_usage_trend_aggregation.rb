...
module OCI
  ...
  class Opsi::Models::NetworkUsageTrendAggregation
    ...
    # @return [Array<OCI::Opsi::Models::NetworkUsageTrend>]
    ...
    # @option attributes [Array<OCI::Opsi::Models::NetworkUsageTrend>] :usage_data The value to assign to the {#usage_data} property
    ...
    def hash
      [interface_name, ip_address, mac_address, usage_data].hash
    end
