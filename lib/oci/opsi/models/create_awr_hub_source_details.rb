...
module OCI
  ...
  class Opsi::Models::CreateAwrHubSourceDetails
    TYPE_ENUM = [
    ...
    def hash
      [name, awr_hub_id, compartment_id, associated_resource_id, associated_opsi_id, type, freeform_tags, defined_tags].hash
    end
