...
module OCI
  ...
  class Mysql::Models::RestartDbSystemDetails
    SHUTDOWN_TYPE_ENUM = [
      SHUTDOWN_TYPE_IMMEDIATE = 'IMMEDIATE'.freeze,
      SHUTDOWN_TYPE_FAST = 'FAST'.freeze,
      SHUTDOWN_TYPE_SLOW = 'SLOW'.freeze
    ].freeze

    # **[Required]** The InnoDB shutdown mode to use, following the option
    # \"[innodb_fast_shutdown](https://dev.mysql.com/doc/refman/en/innodb-parameters.html#sysvar_innodb_fast_shutdown)\".
    #
    # @return [String]
    attr_reader :shutdown_type
    ...
    # @option attributes [String] :shutdown_type The value to assign to the {#shutdown_type} property
    ...
    # @param [Object] shutdown_type Object to be assigned
    def shutdown_type=(shutdown_type)
      raise "Invalid value for 'shutdown_type': this must be one of the values in SHUTDOWN_TYPE_ENUM." if shutdown_type && !SHUTDOWN_TYPE_ENUM.include?(shutdown_type)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        shutdown_type == other.shutdown_type
    end
