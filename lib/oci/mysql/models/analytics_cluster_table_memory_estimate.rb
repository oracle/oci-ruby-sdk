...
module OCI
  ...
  #
  class Mysql::Models::AnalyticsClusterTableMemoryEstimate
    # **[Required]** The table name.
    # @return [String]
    attr_accessor :table_name

    # **[Required]** The number of columns to be loaded to Analytics Cluster memory.
    # These columns contribute to the analytical memory footprint.
    #
    # @return [Integer]
    attr_accessor :to_load_column_count

    # **[Required]** The number of variable-length columns to be loaded to Analytics Cluster memory.
    # These columns contribute to the analytical memory footprint.
    #
    # @return [Integer]
