...
module OCI
  ...
  class Mysql::Models::AddHeatWaveClusterDetails
    ...
    def initialize(attributes = {})
      ...
      self.is_lakehouse_enabled = false if is_lakehouse_enabled.nil? && !attributes.key?(:'isLakehouseEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_lakehouse_enabled = false if is_lakehouse_enabled.nil? && !attributes.key?(:'isLakehouseEnabled') && !attributes.key?(:'is_lakehouse_enabled') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [shape_name, cluster_size, is_lakehouse_enabled].hash
    end
