...
module OCI
  ...
  class Mysql::Models::CreateDbSystemDetails
    ...
    # **[Required]** The name of the shape. The shape determines the resources allocated
    ...
    # @return [OCI::Mysql::Models::CreateBackupPolicyDetails]
    attr_accessor :backup_policy

    # @return [OCI::Mysql::Models::CreateDbSystemSourceDetails]
    attr_accessor :source

    # @return [OCI::Mysql::Models::CreateMaintenanceDetails]
    ...
    # @option attributes [OCI::Mysql::Models::CreateBackupPolicyDetails] :backup_policy The value to assign to the {#backup_policy} property
    # @option attributes [OCI::Mysql::Models::CreateDbSystemSourceDetails] :source The value to assign to the {#source} property
