...
module OCI
  ...
  class Mysql::Models::Replica
    ...
    def hash
      [secure_connections, id, db_system_id, compartment_id, display_name, description, lifecycle_state, lifecycle_details, time_created, time_updated, mysql_version, availability_domain, fault_domain, ip_address, port, port_x, freeform_tags, defined_tags, is_delete_protected, shape_name, configuration_id, replica_overrides].hash
    end
