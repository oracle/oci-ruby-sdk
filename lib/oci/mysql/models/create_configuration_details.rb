...
module OCI
  ...
  #
  class Mysql::Models::CreateConfigurationDetails
    ...
    def hash
      [compartment_id, description, display_name, shape_name, variables, parent_configuration_id, freeform_tags, defined_tags].hash
    end
