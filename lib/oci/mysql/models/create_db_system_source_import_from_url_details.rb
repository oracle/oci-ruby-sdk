...
module OCI
  ...
  class Mysql::Models::CreateDbSystemSourceImportFromUrlDetails < Mysql::Models::CreateDbSystemSourceDetails
    ...
    # @option attributes [String] :source_url The value to assign to the {#source_url} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['sourceType'] = 'IMPORTURL'
      ...
      self.source_url = attributes[:'sourceUrl'] if attributes[:'sourceUrl']

      raise 'You cannot provide both :sourceUrl and :source_url' if attributes.key?(:'sourceUrl') && attributes.key?(:'source_url')

      self.source_url = attributes[:'source_url'] if attributes[:'source_url']
    end
