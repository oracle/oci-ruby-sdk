...
module OCI
  ...
  class Mysql::Models::AnonymousTransactionsHandling
    POLICY_ENUM = [
      POLICY_ERROR_ON_ANONYMOUS = 'ERROR_ON_ANONYMOUS'.freeze,
      POLICY_ASSIGN_TARGET_UUID = 'ASSIGN_TARGET_UUID'.freeze,
      POLICY_ASSIGN_MANUAL_UUID = 'ASSIGN_MANUAL_UUID'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'policy'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Mysql::Models::ErrorOnAnonymousHandling' if type == 'ERROR_ON_ANONYMOUS'
      return 'OCI::Mysql::Models::AssignManualUuidHandling' if type == 'ASSIGN_MANUAL_UUID'
      return 'OCI::Mysql::Models::AssignTargetUuidHandling' if type == 'ASSIGN_TARGET_UUID'
