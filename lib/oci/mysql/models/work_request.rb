...
module OCI
  ...
  class Mysql::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_REPLICA = 'CREATE_REPLICA'.freeze,
      OPERATION_TYPE_UPDATE_REPLICA = 'UPDATE_REPLICA'.freeze,
      OPERATION_TYPE_DELETE_REPLICA = 'DELETE_REPLICA'.freeze,
      OPERATION_TYPE_CREATE_CHANNEL = 'CREATE_CHANNEL'.freeze,
      OPERATION_TYPE_UPDATE_CHANNEL = 'UPDATE_CHANNEL'.freeze,
      OPERATION_TYPE_RESUME_CHANNEL = 'RESUME_CHANNEL'.freeze,
      OPERATION_TYPE_RESET_CHANNEL = 'RESET_CHANNEL'.freeze,
      OPERATION_TYPE_DELETE_CHANNEL = 'DELETE_CHANNEL'.freeze,
      OPERATION_TYPE_CREATE_BACKUP = 'CREATE_BACKUP'.freeze,
      OPERATION_TYPE_DELETE_BACKUP = 'DELETE_BACKUP'.freeze,
