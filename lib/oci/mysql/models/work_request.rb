...
module OCI
  ...
  #
  class Mysql::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_DBSYSTEM = 'CREATE_DBSYSTEM'.freeze,
      OPERATION_TYPE_UPDATE_DBSYSTEM = 'UPDATE_DBSYSTEM'.freeze,
      OPERATION_TYPE_DELETE_DBSYSTEM = 'DELETE_DBSYSTEM'.freeze,
      OPERATION_TYPE_START_DBSYSTEM = 'START_DBSYSTEM'.freeze,
      OPERATION_TYPE_STOP_DBSYSTEM = 'STOP_DBSYSTEM'.freeze,
      OPERATION_TYPE_RESTART_DBSYSTEM = 'RESTART_DBSYSTEM'.freeze,
      OPERATION_TYPE_ADD_ANALYTICS_CLUSTER = 'ADD_ANALYTICS_CLUSTER'.freeze,
      OPERATION_TYPE_UPDATE_ANALYTICS_CLUSTER = 'UPDATE_ANALYTICS_CLUSTER'.freeze,
      OPERATION_TYPE_DELETE_ANALYTICS_CLUSTER = 'DELETE_ANALYTICS_CLUSTER'.freeze,
      OPERATION_TYPE_START_ANALYTICS_CLUSTER = 'START_ANALYTICS_CLUSTER'.freeze,
    ...
    # **[Required]** The ocid of the compartment that contains the work request. Work
    ...
    # @return [Array<OCI::Mysql::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Mysql::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Mysql::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
