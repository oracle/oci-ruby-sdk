...
module OCI
  ...
  #
  class Mysql::Models::AnalyticsClusterNode
    ...
    # **[Required]** The ID of the node within MySQL Analytics Cluster.
    # @return [String]
    attr_accessor :node_id

    # **[Required]** The current state of the MySQL Analytics Cluster node.
    # @return [String]
    ...
    def hash
      [node_id, lifecycle_state, time_created, time_updated].hash
    end
