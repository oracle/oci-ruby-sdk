...
module OCI
  ...
  #
  class Mysql::Models::HeatWaveClusterMemoryEstimate
    STATUS_ENUM = [
    ...
    #
    # @return [Array<OCI::Mysql::Models::HeatWaveClusterSchemaMemoryEstimate>]
    ...
    def self.swagger_types
      {
        ...
        'table_schemas': :'Array<OCI::Mysql::Models::HeatWaveClusterSchemaMemoryEstimate>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Mysql::Models::HeatWaveClusterSchemaMemoryEstimate>] :table_schemas The value to assign to the {#table_schemas} property
