...
module OCI
  ...
  #
  class Mysql::Models::UpdateDeletionPolicyDetails
    ...
    def automatic_backup_retention=(automatic_backup_retention)
      raise "Invalid value for 'automatic_backup_retention': this must be one of the values in AUTOMATIC_BACKUP_RETENTION_ENUM." if automatic_backup_retention && !AUTOMATIC_BACKUP_RETENTION_ENUM.include?(automatic_backup_retention)
    ...
    def final_backup=(final_backup)
      raise "Invalid value for 'final_backup': this must be one of the values in FINAL_BACKUP_ENUM." if final_backup && !FINAL_BACKUP_ENUM.include?(final_backup)
