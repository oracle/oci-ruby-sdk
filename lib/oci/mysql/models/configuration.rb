...
module OCI
  ...
  #
  class Mysql::Models::Configuration
    TYPE_ENUM = [
    ...
    # @option attributes [OCI::Mysql::Models::ConfigurationVariables] :variables The value to assign to the {#variables} property
    # @option attributes [String] :parent_configuration_id The value to assign to the {#parent_configuration_id} property
    ...
    def initialize(attributes = {})
      ...
      self.parent_configuration_id = attributes[:'parentConfigurationId'] if attributes[:'parentConfigurationId']

      raise 'You cannot provide both :parentConfigurationId and :parent_configuration_id' if attributes.key?(:'parentConfigurationId') && attributes.key?(:'parent_configuration_id')

      self.parent_configuration_id = attributes[:'parent_configuration_id'] if attributes[:'parent_configuration_id']
    ...
    def hash
      [id, compartment_id, description, display_name, shape_name, type, time_created, time_updated, lifecycle_state, variables, parent_configuration_id, freeform_tags, defined_tags].hash
    end
