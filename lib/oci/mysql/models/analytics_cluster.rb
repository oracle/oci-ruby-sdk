...
module OCI
  ...
  #
  class Mysql::Models::AnalyticsCluster
    ...
    # **[Required]** The OCID of the parent DB System this Analytics Cluster is attached to.
    # @return [String]
    attr_accessor :db_system_id

    # **[Required]** The shape determines resources to allocate to the Analytics
    # Cluster nodes - CPU cores, memory.
    #
    # @return [String]
    attr_accessor :shape_name

    # **[Required]** The number of analytics-processing compute instances, of the
    # specified shape, in the Analytics Cluster.
    #
    # @return [Integer]
    attr_accessor :cluster_size

    # **[Required]** An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
    # @return [Array<OCI::Mysql::Models::AnalyticsClusterNode>]
    attr_accessor :cluster_nodes

    # **[Required]** The current state of the Analytics Cluster.
    # @return [String]
    ...
    # **[Required]** The date and time the Analytics Cluster was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The time the Analytics Cluster was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'cluster_nodes': :'Array<OCI::Mysql::Models::AnalyticsClusterNode>',
    ...
    # @option attributes [Array<OCI::Mysql::Models::AnalyticsClusterNode>] :cluster_nodes The value to assign to the {#cluster_nodes} property
    ...
    def initialize(attributes = {})
      ...
      self.cluster_nodes = attributes[:'clusterNodes'] if attributes[:'clusterNodes']

      raise 'You cannot provide both :clusterNodes and :cluster_nodes' if attributes.key?(:'clusterNodes') && attributes.key?(:'cluster_nodes')

      self.cluster_nodes = attributes[:'cluster_nodes'] if attributes[:'cluster_nodes']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        cluster_nodes == other.cluster_nodes &&
    ...
    def hash
      [db_system_id, shape_name, cluster_size, cluster_nodes, lifecycle_state, lifecycle_details, time_created, time_updated].hash
    end
