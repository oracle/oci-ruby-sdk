...
module OCI
  ...
  class Mysql::Models::CreateChannelTargetFromDbSystemDetails < Mysql::Models::CreateChannelTargetDetails
    ...
    #
    # @return [String]
    attr_accessor :tables_without_primary_key_handling
    ...
    def initialize(attributes = {})
      ...
      self.tables_without_primary_key_handling = "ALLOW" if tables_without_primary_key_handling.nil? && !attributes.key?(:'tablesWithoutPrimaryKeyHandling') # rubocop:disable Style/StringLiterals
      ...
      self.tables_without_primary_key_handling = "ALLOW" if tables_without_primary_key_handling.nil? && !attributes.key?(:'tablesWithoutPrimaryKeyHandling') && !attributes.key?(:'tables_without_primary_key_handling') # rubocop:disable Style/StringLiterals
