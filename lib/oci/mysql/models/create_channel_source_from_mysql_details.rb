...
require 'date'
require_relative 'create_channel_source_details'
...
module OCI
  ...
  #
  class Mysql::Models::CreateChannelSourceFromMysqlDetails < Mysql::Models::CreateChannelSourceDetails
    ...
    # **[Required]** The password for the replication user. The password must be
    ...
    def hash
      [source_type, hostname, port, username, password, ssl_mode, ssl_ca_certificate].hash
    end
