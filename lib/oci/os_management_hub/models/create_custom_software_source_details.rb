...
module OCI
  ...
  class OsManagementHub::Models::CreateCustomSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, vendor_software_sources, custom_software_source_filter, is_automatically_updated, is_auto_resolve_dependencies, is_created_from_package_list, packages].hash
    end
