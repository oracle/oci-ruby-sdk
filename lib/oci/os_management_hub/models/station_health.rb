...
module OCI
  ...
  class OsManagementHub::Models::StationHealth
    STATE_ENUM = [
      STATE_HEALTHY = 'HEALTHY'.freeze,
      STATE_UNHEALTHY = 'UNHEALTHY'.freeze,
      STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Overall health status of the management station.
    # @return [String]
    attr_reader :state
