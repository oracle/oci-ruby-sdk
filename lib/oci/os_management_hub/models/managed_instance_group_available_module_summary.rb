...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstanceGroupAvailableModuleSummary
    # **[Required]** The name of the module that is available to the managed instance group.
    # @return [String]
    attr_accessor :name
