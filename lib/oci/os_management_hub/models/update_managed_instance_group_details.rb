...
module OCI
  ...
  class OsManagementHub::Models::UpdateManagedInstanceGroupDetails
    ...
    def hash
      [display_name, description, notification_topic_id, autonomous_settings, freeform_tags, defined_tags].hash
    end
