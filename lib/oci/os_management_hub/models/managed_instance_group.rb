...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstanceGroup
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the managed instance group.
    # @return [String]
    ...
    def hash
      [id, compartment_id, display_name, description, time_created, time_modified, lifecycle_state, os_family, arch_type, vendor_name, software_source_ids, software_sources, managed_instance_ids, managed_instance_count, location, pending_job_count, notification_topic_id, autonomous_settings, is_managed_by_autonomous_linux, freeform_tags, defined_tags, system_tags].hash
    end
