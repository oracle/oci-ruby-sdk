...
module OCI
  ...
  class OsManagementHub::Models::LifecycleEnvironment
    ...
    # **[Required]** The user-friendly name for the lifecycle environment.
    # @return [String]
    ...
    # **[Required]** The time the lifecycle environment was created (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    # @return [DateTime]
    ...
    def hash
      [id, compartment_id, display_name, description, stages, managed_instance_ids, lifecycle_state, os_family, arch_type, vendor_name, location, time_created, time_modified, freeform_tags, defined_tags, system_tags].hash
    end
