...
module OCI
  ...
  class OsManagementHub::Models::CreateLifecycleProfileDetails < OsManagementHub::Models::CreateProfileDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage that the instance will be associated with.
    # @return [String]
    attr_accessor :lifecycle_stage_id
    ...
    # @option attributes [String] :lifecycle_stage_id The value to assign to the {#lifecycle_stage_id} property
    def initialize(attributes = {})
      ...
      self.lifecycle_stage_id = attributes[:'lifecycleStageId'] if attributes[:'lifecycleStageId']

      raise 'You cannot provide both :lifecycleStageId and :lifecycle_stage_id' if attributes.key?(:'lifecycleStageId') && attributes.key?(:'lifecycle_stage_id')

      self.lifecycle_stage_id = attributes[:'lifecycle_stage_id'] if attributes[:'lifecycle_stage_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        lifecycle_stage_id == other.lifecycle_stage_id
    end
    ...
    def hash
      [display_name, compartment_id, description, management_station_id, profile_type, registration_type, is_default_profile, freeform_tags, defined_tags, lifecycle_stage_id].hash
    end
