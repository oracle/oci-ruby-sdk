...
module OCI
  ...
  class OsManagementHub::Models::ProfileSummary
    ...
    def hash
      [id, display_name, description, compartment_id, management_station_id, profile_type, registration_type, vendor_name, os_family, arch_type, time_created, lifecycle_state, is_default_profile, is_service_provided_profile, freeform_tags, defined_tags, system_tags].hash
    end
