...
module OCI
  ...
  class OsManagementHub::Models::CustomSoftwareSourceSummary < OsManagementHub::Models::SoftwareSourceSummary
    ...
    def hash
      [id, compartment_id, display_name, repo_id, url, time_created, time_updated, description, software_source_type, availability, os_family, arch_type, package_count, lifecycle_state, freeform_tags, defined_tags, system_tags, vendor_software_sources].hash
    end
