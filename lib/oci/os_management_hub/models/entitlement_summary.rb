...
module OCI
  ...
  class OsManagementHub::Models::EntitlementSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy containing the entitlement.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The Customer Support Identifier (CSI) which unlocks the software sources. The CSI is is a unique key given to a customer and it uniquely identifies the entitlement.
    # @return [String]
    attr_accessor :csi
    ...
    def hash
      [compartment_id, csi, vendor_name].hash
    end
