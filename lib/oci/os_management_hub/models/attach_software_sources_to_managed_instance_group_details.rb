...
module OCI
  ...
  class OsManagementHub::Models::AttachSoftwareSourcesToManagedInstanceGroupDetails
    # **[Required]** List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the group.
    # @return [Array<String>]
