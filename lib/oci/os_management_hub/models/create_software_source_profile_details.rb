...
module OCI
  ...
  class OsManagementHub::Models::CreateSoftwareSourceProfileDetails < OsManagementHub::Models::CreateProfileDetails
    ...
    def hash
      [display_name, compartment_id, description, management_station_id, profile_type, freeform_tags, defined_tags, vendor_name, os_family, arch_type, software_source_ids].hash
    end
