...
module OCI
  ...
  class OsManagementHub::Models::AttachManagedInstancesToManagedInstanceGroupDetails
    # **[Required]** List of managed instance [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the group.
    # @return [Array<String>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'managed_instances': :'Array<String>',
    ...
    # @option attributes [Array<String>] :managed_instances The value to assign to the {#managed_instances} property
    ...
    def hash
      [managed_instances, work_request_details].hash
    end
