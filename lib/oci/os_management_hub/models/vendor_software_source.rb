...
module OCI
  ...
  class OsManagementHub::Models::VendorSoftwareSource < OsManagementHub::Models::SoftwareSource
    VENDOR_NAME_ENUM = [
    ...
    # @return [String]
    attr_accessor :origin_software_source_id

    # Indicates whether the software source is required for the Autonomous Linux service.
    # @return [BOOLEAN]
    attr_accessor :is_mandatory_for_autonomous_linux
    ...
    # @option attributes [String] :origin_software_source_id The value to assign to the {#origin_software_source_id} property
    # @option attributes [BOOLEAN] :is_mandatory_for_autonomous_linux The value to assign to the {#is_mandatory_for_autonomous_linux} property
    def initialize(attributes = {})
      ...
      self.origin_software_source_id = attributes[:'originSoftwareSourceId'] if attributes[:'originSoftwareSourceId']

      raise 'You cannot provide both :originSoftwareSourceId and :origin_software_source_id' if attributes.key?(:'originSoftwareSourceId') && attributes.key?(:'origin_software_source_id')

      self.origin_software_source_id = attributes[:'origin_software_source_id'] if attributes[:'origin_software_source_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        origin_software_source_id == other.origin_software_source_id &&
    ...
    def hash
      [id, compartment_id, display_name, time_created, description, software_source_type, availability, availability_at_oci, repo_id, os_family, arch_type, lifecycle_state, package_count, url, checksum_type, gpg_key_url, gpg_key_id, gpg_key_fingerprint, size, freeform_tags, defined_tags, system_tags, vendor_name, origin_software_source_id, is_mandatory_for_autonomous_linux].hash
    end
