...
module OCI
  ...
  class OsManagementHub::Models::VendorSoftwareSource < OsManagementHub::Models::SoftwareSource
    ...
    def hash
      [id, compartment_id, display_name, time_created, description, software_source_type, availability, repo_id, os_family, arch_type, lifecycle_state, package_count, url, checksum_type, gpg_key_url, gpg_key_id, gpg_key_fingerprint, freeform_tags, defined_tags, system_tags, vendor_name].hash
    end
