...
module OCI
  ...
  class OsManagementHub::Models::CreateVersionedCustomSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, vendor_software_sources, custom_software_source_filter, software_source_version].hash
    end
