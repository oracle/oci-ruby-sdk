...
module OCI
  ...
  class OsManagementHub::Models::SoftwarePackage
    ARCHITECTURE_ENUM = [
    ...
    # @return [Array<OCI::OsManagementHub::Models::SoftwarePackageDependency>]
    attr_accessor :dependencies

    # List of files for the software package.
    # @return [Array<OCI::OsManagementHub::Models::SoftwarePackageFile>]
    attr_accessor :files
    ...
    def self.swagger_types
      {
        ...
        'dependencies': :'Array<OCI::OsManagementHub::Models::SoftwarePackageDependency>',
        'files': :'Array<OCI::OsManagementHub::Models::SoftwarePackageFile>',
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::SoftwarePackageDependency>] :dependencies The value to assign to the {#dependencies} property
    # @option attributes [Array<OCI::OsManagementHub::Models::SoftwarePackageFile>] :files The value to assign to the {#files} property
    ...
    def hash
      [display_name, name, type, version, architecture, last_modified_date, checksum, checksum_type, description, size_in_bytes, dependencies, files, software_sources, is_latest, os_families].hash
    end
