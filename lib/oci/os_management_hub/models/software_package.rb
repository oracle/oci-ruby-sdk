...
module OCI
  ...
  class OsManagementHub::Models::SoftwarePackage
    ...
    def hash
      [display_name, name, type, version, architecture, last_modified_date, checksum, checksum_type, description, size_in_bytes, dependencies, files, software_sources, is_latest].hash
    end
