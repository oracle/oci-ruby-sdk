...
module OCI
  ...
  class OsManagementHub::Models::CreateGroupProfileDetails < OsManagementHub::Models::CreateProfileDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group that the instance will join after registration.
    # @return [String]
    attr_accessor :managed_instance_group_id
    ...
    # @option attributes [String] :managed_instance_group_id The value to assign to the {#managed_instance_group_id} property
    def initialize(attributes = {})
      ...
      self.managed_instance_group_id = attributes[:'managedInstanceGroupId'] if attributes[:'managedInstanceGroupId']

      raise 'You cannot provide both :managedInstanceGroupId and :managed_instance_group_id' if attributes.key?(:'managedInstanceGroupId') && attributes.key?(:'managed_instance_group_id')

      self.managed_instance_group_id = attributes[:'managed_instance_group_id'] if attributes[:'managed_instance_group_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        managed_instance_group_id == other.managed_instance_group_id
    end
    ...
    def hash
      [display_name, compartment_id, description, management_station_id, profile_type, registration_type, is_default_profile, freeform_tags, defined_tags, managed_instance_group_id].hash
    end
