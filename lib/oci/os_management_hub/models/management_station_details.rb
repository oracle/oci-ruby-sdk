...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station for the instance to use as primary management station.
    #
    # @return [String]
    ...
    def hash
      [primary_management_station_id, secondary_management_station_id, work_request_details].hash
    end
