...
module OCI
  ...
  class OsManagementHub::Models::ModuleSummary
    ...
    # @option attributes [Array<String>] :streams The value to assign to the {#streams} property
    ...
    def hash
      [name, streams, software_source_id].hash
    end
