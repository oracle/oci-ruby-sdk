...
module OCI
  ...
  class OsManagementHub::Models::UpdateLifecycleEnvironmentDetails
    ...
    # @return [Array<OCI::OsManagementHub::Models::UpdateLifecycleStageDetails>]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'description': :'String',
        'stages': :'Array<OCI::OsManagementHub::Models::UpdateLifecycleStageDetails>',
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::UpdateLifecycleStageDetails>] :stages The value to assign to the {#stages} property
    ...
    def hash
      [display_name, description, stages, freeform_tags, defined_tags].hash
    end
