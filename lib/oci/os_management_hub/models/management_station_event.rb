...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationEvent < OsManagementHub::Models::Event
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::ManagementStationEventData]
    attr_accessor :data
    ...
    def self.swagger_types
      {
        ...
        'data': :'OCI::OsManagementHub::Models::ManagementStationEventData'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OsManagementHub::Models::ManagementStationEventData] :data The value to assign to the {#data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'MANAGEMENT_STATION'
