...
module OCI
  ...
  class OsManagementHub::Models::LifecycleStageSummary
    OS_FAMILY_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the lifecycle stage.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The user-friendly name for the lifecycle stage.
    # @return [String]
    ...
    # @return [String]
    attr_accessor :lifecycle_environment_id
    ...
    # @return [String]
    attr_accessor :lifecycle_environment_display_name

    # **[Required]** User-specified rank for the lifecycle stage. Rank determines the hierarchy of the lifecycle stages within the lifecycle environment.
    #
    # @return [Integer]
    attr_accessor :rank
    ...
    # @return [OCI::OsManagementHub::Models::SoftwareSourceDetails]
    ...
    def self.swagger_types
      {
        ...
        'lifecycle_environment_display_name': :'String',
        'rank': :'Integer',
        'os_family': :'String',
        'arch_type': :'String',
        'vendor_name': :'String',
        'managed_instances': :'Integer',
        'location': :'String',
        'software_source_id': :'OCI::OsManagementHub::Models::SoftwareSourceDetails',
    ...
    # @option attributes [String] :lifecycle_environment_id The value to assign to the {#lifecycle_environment_id} property
    # @option attributes [String] :lifecycle_environment_display_name The value to assign to the {#lifecycle_environment_display_name} property
    # @option attributes [Integer] :rank The value to assign to the {#rank} property
    ...
    # @option attributes [Integer] :managed_instances The value to assign to the {#managed_instances} property
    # @option attributes [String] :location The value to assign to the {#location} property
    # @option attributes [OCI::OsManagementHub::Models::SoftwareSourceDetails] :software_source_id The value to assign to the {#software_source_id} property
    ...
    def initialize(attributes = {})
      ...
      self.lifecycle_environment_id = attributes[:'lifecycleEnvironmentId'] if attributes[:'lifecycleEnvironmentId']

      raise 'You cannot provide both :lifecycleEnvironmentId and :lifecycle_environment_id' if attributes.key?(:'lifecycleEnvironmentId') && attributes.key?(:'lifecycle_environment_id')

      self.lifecycle_environment_id = attributes[:'lifecycle_environment_id'] if attributes[:'lifecycle_environment_id']

      self.lifecycle_environment_display_name = attributes[:'lifecycleEnvironmentDisplayName'] if attributes[:'lifecycleEnvironmentDisplayName']

      raise 'You cannot provide both :lifecycleEnvironmentDisplayName and :lifecycle_environment_display_name' if attributes.key?(:'lifecycleEnvironmentDisplayName') && attributes.key?(:'lifecycle_environment_display_name')

      self.lifecycle_environment_display_name = attributes[:'lifecycle_environment_display_name'] if attributes[:'lifecycle_environment_display_name']

      self.rank = attributes[:'rank'] if attributes[:'rank']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        lifecycle_environment_id == other.lifecycle_environment_id &&
        lifecycle_environment_display_name == other.lifecycle_environment_display_name &&
        rank == other.rank &&
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_environment_id, lifecycle_environment_display_name, rank, os_family, arch_type, vendor_name, managed_instances, location, software_source_id, time_created, time_modified, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
