...
module OCI
  ...
  class OsManagementHub::Models::LifecycleStageSummary
    ...
    # **[Required]** User specified rank for the lifecycle stage.
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_environment_id, lifecycle_environment_display_name, rank, os_family, arch_type, vendor_name, managed_instances, software_source_id, time_created, time_modified, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
