...
module OCI
  ...
  class OsManagementHub::Models::PackageGroup
    GROUP_TYPE_ENUM = [
    ...
    def group_type=(group_type)
      ...
      if group_type && !GROUP_TYPE_ENUM.include?(group_type)
        OCI.logger.debug("Unknown value for 'group_type' [" + group_type + "]. Mapping to 'GROUP_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @group_type = GROUP_TYPE_UNKNOWN_ENUM_VALUE
      else
