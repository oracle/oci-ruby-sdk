...
module OCI
  ...
  class OsManagementHub::Models::Erratum
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::SoftwarePackageSummary>] :packages The value to assign to the {#packages} property
