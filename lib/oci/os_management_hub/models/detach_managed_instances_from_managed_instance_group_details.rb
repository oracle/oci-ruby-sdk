...
module OCI
  ...
  class OsManagementHub::Models::DetachManagedInstancesFromManagedInstanceGroupDetails
    # **[Required]** List of managed instance [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to detach from the group.
    # @return [Array<String>]
