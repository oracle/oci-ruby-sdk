...
module OCI
  ...
  class OsManagementHub::Models::MirrorSyncStatus
    # **[Required]** Total of mirrors in 'failed' state
    # @return [Integer]
    attr_accessor :unsynced
    ...
    # @option attributes [Integer] :unsynced The value to assign to the {#unsynced} property
    # @option attributes [Integer] :queued The value to assign to the {#queued} property
    # @option attributes [Integer] :syncing The value to assign to the {#syncing} property
    # @option attributes [Integer] :synced The value to assign to the {#synced} property
