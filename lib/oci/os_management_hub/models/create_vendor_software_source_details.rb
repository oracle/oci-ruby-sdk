...
module OCI
  ...
  class OsManagementHub::Models::CreateVendorSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the vendor software source in the root compartment that is being replicated.
    # @return [String]
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, origin_software_source_id].hash
    end
