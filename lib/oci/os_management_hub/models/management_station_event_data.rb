...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationEventData
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** Type of management station operation.
    # @return [String]
    attr_reader :operation_type

    # **[Required]** Status of the management station operation.
    # @return [String]
    attr_reader :status
