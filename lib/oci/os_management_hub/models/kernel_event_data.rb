...
module OCI
  ...
  class OsManagementHub::Models::KernelEventData
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::KernelEventContent]
    ...
    # @return [OCI::OsManagementHub::Models::KernelEventAdditionalDetails]
    ...
    # @option attributes [OCI::OsManagementHub::Models::KernelEventContent] :content The value to assign to the {#content} property
    ...
    # @option attributes [OCI::OsManagementHub::Models::KernelEventAdditionalDetails] :additional_details The value to assign to the {#additional_details} property
    ...
    def hash
      [content, count, event_fingerprint, reason, time_first_occurred, additional_details].hash
    end
