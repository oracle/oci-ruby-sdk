...
module OCI
  ...
  class OsManagementHub::Models::PackageGroupFilter
    FILTER_TYPE_ENUM = [
    ...
    # @option attributes [Array<String>] :package_groups The value to assign to the {#package_groups} property
    ...
    def initialize(attributes = {})
      ...
      self.package_groups = attributes[:'packageGroups'] if attributes[:'packageGroups']

      raise 'You cannot provide both :packageGroups and :package_groups' if attributes.key?(:'packageGroups') && attributes.key?(:'package_groups')

      self.package_groups = attributes[:'package_groups'] if attributes[:'package_groups']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        package_groups == other.package_groups &&
    ...
    def hash
      [package_groups, filter_type].hash
    end
