...
module OCI
  ...
  class OsManagementHub::Models::AgentEvent < OsManagementHub::Models::Event
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::AgentEventData]
    attr_accessor :data
    ...
    def self.swagger_types
      {
        ...
        'data': :'OCI::OsManagementHub::Models::AgentEventData'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OsManagementHub::Models::AgentEventData] :data The value to assign to the {#data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'AGENT'
