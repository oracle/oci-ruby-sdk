...
module OCI
  ...
  class OsManagementHub::Models::SoftwareSourceEvent < OsManagementHub::Models::Event
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::SoftwareSourceEventData]
    attr_accessor :data
    ...
    def self.swagger_types
      {
        ...
        'data': :'OCI::OsManagementHub::Models::SoftwareSourceEventData'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OsManagementHub::Models::SoftwareSourceEventData] :data The value to assign to the {#data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'SOFTWARE_SOURCE'
