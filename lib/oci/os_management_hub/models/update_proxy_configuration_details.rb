...
module OCI
  ...
  class OsManagementHub::Models::UpdateProxyConfigurationDetails
    ...
    # @option attributes [String] :forward The value to assign to the {#forward} property
    def initialize(attributes = {})
      ...
      self.forward = attributes[:'forward'] if attributes[:'forward']
    end
    ...
    def hash
      [is_enabled, hosts, port, forward].hash
    end
