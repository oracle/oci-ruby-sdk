...
module OCI
  ...
  class OsManagementHub::Models::DetachSoftwareSourcesFromManagedInstanceGroupDetails
    # **[Required]** List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to detach from the group.
    # @return [Array<String>]
    ...
    # @option attributes [Array<String>] :software_sources The value to assign to the {#software_sources} property
    ...
    def hash
      [software_sources, work_request_details].hash
    end
