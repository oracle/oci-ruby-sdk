...
module OCI
  ...
  class OsManagementHub::Models::LifecycleEnvironmentSummary
    ...
    def hash
      [id, compartment_id, display_name, description, stages, lifecycle_state, arch_type, os_family, vendor_name, time_created, time_modified, freeform_tags, defined_tags, system_tags].hash
    end
