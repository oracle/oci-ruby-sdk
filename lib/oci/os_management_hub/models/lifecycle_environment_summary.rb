...
module OCI
  ...
  class OsManagementHub::Models::LifecycleEnvironmentSummary
    ARCH_TYPE_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle environment.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** A user-friendly name for the lifecycle environment.
    # @return [String]
    ...
    # **[Required]** User-specified list of lifecycle stages used within the lifecycle environment.
    # @return [Array<OCI::OsManagementHub::Models::LifecycleStageSummary>]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'description': :'String',
        'stages': :'Array<OCI::OsManagementHub::Models::LifecycleStageSummary>',
    ...
    # @option attributes [Array<OCI::OsManagementHub::Models::LifecycleStageSummary>] :stages The value to assign to the {#stages} property
    ...
    def hash
      [id, compartment_id, display_name, description, stages, lifecycle_state, arch_type, os_family, vendor_name, location, time_created, time_modified, freeform_tags, defined_tags, system_tags].hash
    end
