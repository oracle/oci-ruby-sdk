...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstanceGroupSummary
    ...
    def hash
      [id, compartment_id, display_name, description, managed_instance_count, location, time_created, time_modified, lifecycle_state, os_family, arch_type, vendor_name, notification_topic_id, autonomous_settings, is_managed_by_autonomous_linux, freeform_tags, defined_tags, system_tags].hash
    end
