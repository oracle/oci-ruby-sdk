...
module OCI
  ...
  class OsManagementHub::Models::SoftwareSourceSummary
    ...
    # **[Required]** The date and time the software source was updated (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    #
    # @return [DateTime]
    ...
    def hash
      [id, compartment_id, display_name, repo_id, url, time_created, time_updated, description, software_source_type, availability, availability_at_oci, os_family, arch_type, package_count, lifecycle_state, size, freeform_tags, defined_tags, system_tags].hash
    end
