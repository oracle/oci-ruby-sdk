...
module OCI
  ...
  class OsManagementHub::Models::CreateManagedInstanceGroupDetails
    OS_FAMILY_ENUM = [
    ...
    # **[Required]** A user-friendly name for the managed instance group. Does not have to be unique and you can change the name later. Avoid entering confidential information.
    # @return [String]
    ...
    # **[Required]** The operating system type of the managed instances that will be attached to this group.
    #
    # @return [String]
    attr_reader :os_family

    # **[Required]** The CPU architecture type of the managed instances that will be attached to this group.
    #
    # @return [String]
    attr_reader :arch_type

    # **[Required]** The vendor of the operating system that will be used by the managed instances in the group.
    #
    # @return [String]
    ...
    # @return [OCI::OsManagementHub::Models::UpdatableAutonomousSettings]
    ...
    # @option attributes [OCI::OsManagementHub::Models::UpdatableAutonomousSettings] :autonomous_settings The value to assign to the {#autonomous_settings} property
    ...
    def hash
      [display_name, description, compartment_id, os_family, arch_type, vendor_name, location, software_source_ids, managed_instance_ids, notification_topic_id, autonomous_settings, freeform_tags, defined_tags].hash
    end
