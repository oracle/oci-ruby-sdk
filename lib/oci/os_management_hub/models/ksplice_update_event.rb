...
module OCI
  ...
  class OsManagementHub::Models::KspliceUpdateEvent < OsManagementHub::Models::Event
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::KspliceUpdateEventData]
    attr_accessor :data
    ...
    def self.swagger_types
      {
        ...
        'data': :'OCI::OsManagementHub::Models::KspliceUpdateEventData'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OsManagementHub::Models::KspliceUpdateEventData] :data The value to assign to the {#data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'KSPLICE_UPDATE'
