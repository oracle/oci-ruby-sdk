...
module OCI
  ...
  class OsManagementHub::Models::InstallWindowsUpdatesOnManagedInstanceGroupDetails
    ...
    # **[Required]** The type of Windows updates to be applied.
    # @return [Array<String>]
    ...
    def hash
      [windows_update_types, work_request_details].hash
    end
