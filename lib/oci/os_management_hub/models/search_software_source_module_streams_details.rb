...
module OCI
  ...
  class OsManagementHub::Models::SearchSoftwareSourceModuleStreamsDetails
    SORT_ORDER_ENUM = [
    ...
    SORT_BY_ENUM = [
      SORT_BY_MODULENAME = 'MODULENAME'.freeze
    ].freeze

    # **[Required]** List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    # @return [Array<String>]
    ...
    def hash
      [software_source_ids, sort_order, module_name, sort_by].hash
    end
