...
module OCI
  ...
  class OsManagementHub::Models::KernelCrashEvent < OsManagementHub::Models::Event
    # This attribute is required.
    # @return [OCI::OsManagementHub::Models::KernelEventData]
    attr_accessor :data
    ...
    def self.swagger_types
      {
        ...
        'data': :'OCI::OsManagementHub::Models::KernelEventData'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::OsManagementHub::Models::KernelEventData] :data The value to assign to the {#data} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'KERNEL_CRASH'
