...
module OCI
  ...
  class OsManagementHub::Models::UpdateCustomSoftwareSourceDetails < OsManagementHub::Models::UpdateSoftwareSourceDetails
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, vendor_software_sources, custom_software_source_filter, is_automatically_updated, is_auto_resolve_dependencies].hash
    end
