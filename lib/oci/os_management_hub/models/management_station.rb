...
module OCI
  ...
  class OsManagementHub::Models::ManagementStation
    ...
    # @return [OCI::OsManagementHub::Models::StationHealth]
    ...
    # @option attributes [OCI::OsManagementHub::Models::StationHealth] :health The value to assign to the {#health} property
    ...
    def hash
      [id, managed_instance_id, compartment_id, scheduled_job_id, profile_id, display_name, description, hostname, overall_state, overall_percentage, mirror_capacity, total_mirrors, mirror_sync_status, proxy, mirror, health, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
