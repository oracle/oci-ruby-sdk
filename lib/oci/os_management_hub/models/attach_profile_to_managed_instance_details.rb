...
module OCI
  ...
  class OsManagementHub::Models::AttachProfileToManagedInstanceDetails
    # **[Required]** The profile [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the managed instance.
    # @return [String]
