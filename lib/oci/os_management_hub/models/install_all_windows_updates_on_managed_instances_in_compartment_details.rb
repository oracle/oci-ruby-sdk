...
module OCI
  ...
  #
  class OsManagementHub::Models::InstallAllWindowsUpdatesOnManagedInstancesInCompartmentDetails
    ...
    def hash
      [compartment_id, windows_update_types, work_request_details].hash
    end
