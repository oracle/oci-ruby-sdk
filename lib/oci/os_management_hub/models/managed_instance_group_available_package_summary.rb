...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstanceGroupAvailablePackageSummary
    ARCHITECTURE_ENUM = [
    ...
    # **[Required]** Version of the available package.
    # @return [String]
    ...
    def hash
      [display_name, name, type, version, architecture, software_sources, is_latest].hash
    end
