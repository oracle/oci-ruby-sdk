...
module OCI
  ...
  class OsManagementHub::Models::LifecycleStage
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_environment_id, rank, os_family, arch_type, vendor_name, managed_instance_ids, software_source_id, time_created, time_modified, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
