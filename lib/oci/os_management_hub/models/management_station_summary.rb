...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationSummary
    ...
    def hash
      [id, managed_instance_id, compartment_id, profile_id, scheduled_job_id, time_next_execution, display_name, description, hostname, overall_state, overall_percentage, mirror_capacity, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
