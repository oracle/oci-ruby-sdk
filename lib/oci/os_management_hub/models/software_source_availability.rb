...
module OCI
  ...
  class OsManagementHub::Models::SoftwareSourceAvailability
    AVAILABILITY_ENUM = [
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the vendor software source.
    # @return [String]
    ...
    def availability=(availability)
      raise "Invalid value for 'availability': this must be one of the values in AVAILABILITY_ENUM." if availability && !AVAILABILITY_ENUM.include?(availability)
    ...
    def availability_at_oci=(availability_at_oci)
      raise "Invalid value for 'availability_at_oci': this must be one of the values in AVAILABILITY_AT_OCI_ENUM." if availability_at_oci && !AVAILABILITY_AT_OCI_ENUM.include?(availability_at_oci)
    ...
    def hash
      [software_source_id, availability, availability_at_oci].hash
    end
