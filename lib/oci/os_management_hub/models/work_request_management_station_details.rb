...
module OCI
  ...
  class OsManagementHub::Models::WorkRequestManagementStationDetails
    # Target version to update the management station software.
    # @return [String]
    attr_accessor :management_station_version
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'management_station_version': :'String',
        'config': :'String',
    ...
    # @option attributes [String] :management_station_version The value to assign to the {#management_station_version} property
    # @option attributes [String] :config The value to assign to the {#config} property
    ...
    def initialize(attributes = {})
      ...
      self.management_station_version = attributes[:'managementStationVersion'] if attributes[:'managementStationVersion']

      raise 'You cannot provide both :managementStationVersion and :management_station_version' if attributes.key?(:'managementStationVersion') && attributes.key?(:'management_station_version')

      self.management_station_version = attributes[:'management_station_version'] if attributes[:'management_station_version']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        management_station_version == other.management_station_version &&
        config == other.config &&
    ...
    def hash
      [management_station_version, config, software_source_ids].hash
    end
