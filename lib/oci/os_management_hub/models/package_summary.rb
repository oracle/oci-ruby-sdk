...
module OCI
  ...
  class OsManagementHub::Models::PackageSummary
    ARCHITECTURE_ENUM = [
    ...
    # @return [String]
    attr_reader :package_classification
    ...
    # @option attributes [String] :package_classification The value to assign to the {#package_classification} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] package_classification Object to be assigned
    def package_classification=(package_classification)
      raise "Invalid value for 'package_classification': this must be one of the values in PACKAGE_CLASSIFICATION_ENUM." if package_classification && !PACKAGE_CLASSIFICATION_ENUM.include?(package_classification)
