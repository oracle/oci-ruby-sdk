...
module OCI
  ...
  class OsManagementHub::Models::UpdateSoftwareSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::OsManagementHub::Models::UpdateCustomSoftwareSourceDetails' if type == 'CUSTOM'
      return 'OCI::OsManagementHub::Models::UpdateVersionedCustomSoftwareSourceDetails' if type == 'VERSIONED'
      return 'OCI::OsManagementHub::Models::UpdateVendorSoftwareSourceDetails' if type == 'VENDOR'

      # TODO: Log a warning when the subtype is not found.
      'OCI::OsManagementHub::Models::UpdateSoftwareSourceDetails'
    end
    ...
    def software_source_type=(software_source_type)
      raise "Invalid value for 'software_source_type': this must be one of the values in SOFTWARE_SOURCE_TYPE_ENUM." if software_source_type && !SOFTWARE_SOURCE_TYPE_ENUM.include?(software_source_type)
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags].hash
    end
