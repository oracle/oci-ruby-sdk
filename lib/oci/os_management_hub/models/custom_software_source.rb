...
module OCI
  ...
  class OsManagementHub::Models::CustomSoftwareSource < OsManagementHub::Models::SoftwareSource
    ...
    def hash
      [id, compartment_id, display_name, time_created, description, software_source_type, availability, availability_at_oci, repo_id, os_family, arch_type, lifecycle_state, package_count, url, checksum_type, gpg_key_url, gpg_key_id, gpg_key_fingerprint, size, freeform_tags, defined_tags, system_tags, vendor_software_sources, custom_software_source_filter, is_automatically_updated, is_auto_resolve_dependencies, is_created_from_package_list, packages].hash
    end
