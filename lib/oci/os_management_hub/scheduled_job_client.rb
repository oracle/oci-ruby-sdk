...
module OCI
  ...
  class OsManagementHub::ScheduledJobClient
    ...
    # @param [OCI::OsManagementHub::Models::ChangeScheduledJobCompartmentDetails] change_scheduled_job_compartment_details The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to move the scheduled job to.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/change_scheduled_job_compartment.rb.html) to see an example of how to use change_scheduled_job_compartment API.
    def change_scheduled_job_compartment(scheduled_job_id, change_scheduled_job_compartment_details, opts = {})
      logger.debug 'Calling operation ScheduledJobClient#change_scheduled_job_compartment.' if logger
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ScheduledJobClient#change_scheduled_job_compartment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :lifecycle_state A filter to return only scheduled jobs currently in the given state.
    ...
    # @option opts [String] :managed_compartment_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed compartment. This filter returns resources associated with this compartment.
    ...
    # @option opts [String] :operation_type A filter to return only scheduled jobs with the given operation type.
    # @option opts [String] :schedule_type A filter to return only scheduled jobs of the given scheduling type (one-time or recurring).
    # @option opts [DateTime] :time_start A filter to return only resources with a date on or after the given value, in ISO 8601 format.
    #
    #   Example: 2017-07-14T02:40:00.000Z
    #
    # @option opts [DateTime] :time_end A filter to return only resources with a date on or before the given value, in ISO 8601 format.
    #
    #   Example: 2017-07-14T02:40:00.000Z
    #
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @option opts [BOOLEAN] :is_restricted A filter to return only restricted scheduled jobs.
    # @option opts [String] :id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the scheduled job. A filter to return the specified job.
