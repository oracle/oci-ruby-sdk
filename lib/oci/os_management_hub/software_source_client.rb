...
module OCI
  ...
  class OsManagementHub::SoftwareSourceClient
    ...
    #
    # @param [String] compartment_id The OCID of the compartment that contains the resources to list. This parameter is required.
    # @param [String] name The erratum name (e.g. ELSA-2023-34678).
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    # @option opts [Array<String>] :availability The availabilities of the software source for a tenant.
    ...
    #    (default to timeCreated)
    #   Allowed values are: timeCreated, displayName
    # @option opts [Array<OCI::OsManagementHub::Models::OCI::OsManagementHub::Models::SoftwareSourceLifecycleState>] :lifecycle_state A filter to return only resources whose lifecycleState matches the given lifecycleStates.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
