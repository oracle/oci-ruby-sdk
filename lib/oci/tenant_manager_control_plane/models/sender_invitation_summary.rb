...
module OCI
  ...
  class TenantManagerControlPlane::Models::SenderInvitationSummary
    ...
    def hash
      [id, compartment_id, display_name, subjects, recipient_invitation_id, recipient_tenancy_id, lifecycle_state, status, time_created, time_updated, recipient_email_address, freeform_tags, defined_tags, system_tags].hash
    end
