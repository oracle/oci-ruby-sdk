...
module OCI
  ...
  class TenantManagerControlPlane::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::TenantManagerControlPlane::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::TenantManagerControlPlane::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::TenantManagerControlPlane::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
