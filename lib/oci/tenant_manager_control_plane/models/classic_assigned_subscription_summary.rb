...
require 'date'
require 'logger'
require_relative 'assigned_subscription_summary'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Summary of assigned subscription information.
  class TenantManagerControlPlane::Models::ClassicAssignedSubscriptionSummary < TenantManagerControlPlane::Models::AssignedSubscriptionSummary
    ...
    # @option attributes [String] :id The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#id #id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#compartment_id #compartment_id} proprety
    # @option attributes [String] :service_name The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#service_name #service_name} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#time_updated #time_updated} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#defined_tags #defined_tags} proprety
    ...
    def hash
      [entity_version, id, compartment_id, service_name, time_created, time_updated, freeform_tags, defined_tags, lifecycle_state, classic_subscription_id, is_classic_subscription, region_assignment, start_date, end_date, csi_number].hash
    end
