...
module OCI
  ...
  class TenantManagerControlPlane::Models::Domain
    ...
    STATUS_ENUM = [
      ...
      STATUS_RELEASING = 'RELEASING'.freeze,
      STATUS_RELEASED = 'RELEASED'.freeze,
      STATUS_EXPIRING = 'EXPIRING'.freeze,
      STATUS_REVOKING = 'REVOKING'.freeze,
    ...
    # @option attributes [String] :txt_record The value to assign to the {#txt_record} property
    ...
    def initialize(attributes = {})
      ...
      self.txt_record = attributes[:'txtRecord'] if attributes[:'txtRecord']

      raise 'You cannot provide both :txtRecord and :txt_record' if attributes.key?(:'txtRecord') && attributes.key?(:'txt_record')

      self.txt_record = attributes[:'txt_record'] if attributes[:'txt_record']
    ...
    def hash
      [id, domain_name, owner_id, lifecycle_state, status, txt_record, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
