...
module OCI
  ...
  class TenantManagerControlPlane::Models::CreateChildTenancyDetails
    ...
    def governance_status=(governance_status)
      raise "Invalid value for 'governance_status': this must be one of the values in GOVERNANCE_STATUS_ENUM." if governance_status && !GOVERNANCE_STATUS_ENUM.include?(governance_status)
