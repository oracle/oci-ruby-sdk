...
module OCI
  ...
  class TenantManagerControlPlane::Models::RecipientInvitation
    ...
    def hash
      [id, compartment_id, subjects, sender_invitation_id, sender_tenancy_id, lifecycle_state, status, display_name, time_created, time_updated, recipient_email_address, freeform_tags, defined_tags, system_tags].hash
    end
