...
module OCI
  ...
  class TenantManagerControlPlane::Models::OrganizationTenancySummary
    ...
    GOVERNANCE_STATUS_ENUM = [
      ...
      GOVERNANCE_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :governance_status The value to assign to the {#governance_status} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] governance_status Object to be assigned
    def governance_status=(governance_status)
      # rubocop:disable Style/ConditionalAssignment
      if governance_status && !GOVERNANCE_STATUS_ENUM.include?(governance_status)
        OCI.logger.debug("Unknown value for 'governance_status' [" + governance_status + "]. Mapping to 'GOVERNANCE_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @governance_status = GOVERNANCE_STATUS_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [tenancy_id, name, lifecycle_state, role, time_joined, time_left, is_approved_for_transfer, governance_status].hash
    end
