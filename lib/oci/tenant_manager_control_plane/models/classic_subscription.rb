...
module OCI
  ...
  class TenantManagerControlPlane::Models::ClassicSubscription < TenantManagerControlPlane::Models::Subscription
    ...
    # @option attributes [String] :id The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#id #id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#compartment_id #compartment_id} proprety
    # @option attributes [String] :service_name The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#service_name #service_name} proprety
    # @option attributes [DateTime] :time_created The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#time_created #time_created} proprety
    # @option attributes [DateTime] :time_updated The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#time_updated #time_updated} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::Subscription#defined_tags #defined_tags} proprety
    ...
    def hash
      [entity_version, id, compartment_id, service_name, time_created, time_updated, freeform_tags, defined_tags, classic_subscription_id, is_classic_subscription, payment_model, region_assignment, lifecycle_state, skus, program_type, customer_country_code, cloud_amount_currency, csi_number, subscription_tier, is_government_subscription, promotion, purchase_entitlement_id, start_date, end_date].hash
    end
