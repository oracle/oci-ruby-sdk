...
module OCI
  ...
  class TenantManagerControlPlane::Models::SubscriptionInfo
    ...
    # @option attributes [String] :spm_subscription_id The value to assign to the {#spm_subscription_id} property
    ...
    # @option attributes [Array<OCI::TenantManagerControlPlane::Models::Sku>] :skus The value to assign to the {#skus} property
