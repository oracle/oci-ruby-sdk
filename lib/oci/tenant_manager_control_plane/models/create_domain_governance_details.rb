...
module OCI
  ...
  class TenantManagerControlPlane::Models::CreateDomainGovernanceDetails
    ...
    # **[Required]** The email to notify the user, and that the ONS subscription will be created with.
    # @return [String]
    ...
    def hash
      [compartment_id, domain_id, subscription_email, ons_topic_id, ons_subscription_id, freeform_tags, defined_tags].hash
    end
