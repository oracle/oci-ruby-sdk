...
module OCI
  ...
  class TenantManagerControlPlane::Models::SubscriptionSummary
    ...
    # **[Required]** OCID of the subscription details for a particular root compartment or tenancy.
    # @return [String]
    attr_accessor :id
    ...
    def hash
      [id, classic_subscription_id, compartment_id, service_name, is_classic_subscription, payment_model, region_assignment, lifecycle_state, start_date, end_date, time_updated, time_created].hash
    end
