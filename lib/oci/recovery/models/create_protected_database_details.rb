...
module OCI
  ...
  class Recovery::Models::CreateProtectedDatabaseDetails
    DATABASE_SIZE_ENUM = [
    ...
    # @return [Array<OCI::Recovery::Models::RecoveryServiceSubnetInput>]
    ...
    # @option attributes [Array<OCI::Recovery::Models::RecoveryServiceSubnetInput>] :recovery_service_subnets The value to assign to the {#recovery_service_subnets} property
    ...
    def database_size=(database_size)
      raise "Invalid value for 'database_size': this must be one of the values in DATABASE_SIZE_ENUM." if database_size && !DATABASE_SIZE_ENUM.include?(database_size)
    ...
    def hash
      [display_name, db_unique_name, database_size, password, protection_policy_id, recovery_service_subnets, database_id, compartment_id, database_size_in_gbs, change_rate, compression_ratio, is_redo_logs_shipped, freeform_tags, defined_tags].hash
    end
