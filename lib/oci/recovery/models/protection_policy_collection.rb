...
module OCI
  ...
  class Recovery::Models::ProtectionPolicyCollection
    # **[Required]** List of ProtectionPolicies.
    # @return [Array<OCI::Recovery::Models::ProtectionPolicySummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Recovery::Models::ProtectionPolicySummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Recovery::Models::ProtectionPolicySummary>] :items The value to assign to the {#items} property
