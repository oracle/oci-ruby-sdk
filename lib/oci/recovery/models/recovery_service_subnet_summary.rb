...
module OCI
  ...
  #
  class Recovery::Models::RecoveryServiceSubnetSummary
    ...
    # @option attributes [Array<String>] :subnets The value to assign to the {#subnets} property
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, subnets, nsg_ids, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
