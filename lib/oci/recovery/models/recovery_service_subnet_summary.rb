...
module OCI
  ...
  class Recovery::Models::RecoveryServiceSubnetSummary
    ...
    def hash
      [id, display_name, compartment_id, vcn_id, subnet_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
