...
module OCI
  ...
  class Recovery::Models::FetchProtectedDatabaseConfigurationDetails
    CONFIGURATION_TYPE_ENUM = [
      CONFIGURATION_TYPE_CABUNDLE = 'CABUNDLE'.freeze,
      CONFIGURATION_TYPE_TNSNAMES = 'TNSNAMES'.freeze,
      CONFIGURATION_TYPE_HOSTS = 'HOSTS'.freeze,
      CONFIGURATION_TYPE_RCVCONF = 'RCVCONF'.freeze,
      CONFIGURATION_TYPE_ALL = 'ALL'.freeze
    ].freeze
    ...
    def configuration_type=(configuration_type)
      raise "Invalid value for 'configuration_type': this must be one of the values in CONFIGURATION_TYPE_ENUM." if configuration_type && !CONFIGURATION_TYPE_ENUM.include?(configuration_type)
