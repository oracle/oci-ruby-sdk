...
module OCI
  ...
  class Recovery::Models::CreateProtectionPolicyDetails
    ...
    def hash
      [display_name, backup_retention_period_in_days, compartment_id, policy_locked_date_time, freeform_tags, defined_tags].hash
    end
