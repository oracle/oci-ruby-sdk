...
module OCI
  ...
  class Recovery::Models::ScheduleProtectedDatabaseDeletionDetails
    ...
    # @option attributes [String] :deletion_schedule The value to assign to the {#deletion_schedule} property
    ...
    # @param [Object] deletion_schedule Object to be assigned
    def deletion_schedule=(deletion_schedule)
      raise "Invalid value for 'deletion_schedule': this must be one of the values in DELETION_SCHEDULE_ENUM." if deletion_schedule && !DELETION_SCHEDULE_ENUM.include?(deletion_schedule)
