...
module OCI
  ...
  class Recovery::Models::ProtectedDatabaseSummary
    ...
    def hash
      [id, display_name, compartment_id, db_unique_name, vpc_user_name, database_size, protection_policy_id, recovery_service_subnets, database_id, time_created, time_updated, lifecycle_state, health, lifecycle_details, health_details, is_read_only_resource, metrics, freeform_tags, defined_tags, system_tags].hash
    end
