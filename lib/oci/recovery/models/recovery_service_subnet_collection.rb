...
module OCI
  ...
  class Recovery::Models::RecoveryServiceSubnetCollection
    # **[Required]** List of recovery service subnet resources.
    # @return [Array<OCI::Recovery::Models::RecoveryServiceSubnetSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Recovery::Models::RecoveryServiceSubnetSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Recovery::Models::RecoveryServiceSubnetSummary>] :items The value to assign to the {#items} property
