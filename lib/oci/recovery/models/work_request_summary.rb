...
module OCI
  ...
  class Recovery::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::Recovery::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Recovery::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Recovery::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
