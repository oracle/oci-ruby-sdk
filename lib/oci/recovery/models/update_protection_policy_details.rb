...
module OCI
  ...
  class Recovery::Models::UpdateProtectionPolicyDetails
    ...
    def hash
      [display_name, backup_retention_period_in_days, policy_locked_date_time, freeform_tags, defined_tags].hash
    end
