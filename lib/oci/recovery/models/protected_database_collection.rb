...
module OCI
  ...
  class Recovery::Models::ProtectedDatabaseCollection
    # **[Required]** List of protected databases.
    # @return [Array<OCI::Recovery::Models::ProtectedDatabaseSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Recovery::Models::ProtectedDatabaseSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Recovery::Models::ProtectedDatabaseSummary>] :items The value to assign to the {#items} property
