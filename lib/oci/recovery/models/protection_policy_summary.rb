...
module OCI
  ...
  class Recovery::Models::ProtectionPolicySummary
    ...
    def hash
      [id, display_name, compartment_id, backup_retention_period_in_days, is_predefined_policy, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
