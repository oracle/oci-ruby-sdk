...
module OCI
  ...
  class Budget::Models::CreateAlertRuleDetails # rubocop:disable Metrics/LineLength
    TYPE_ENUM = [
    ...
    def hash
      [display_name, description, type, threshold, threshold_type, recipients, message, freeform_tags, defined_tags].hash
    end
