...
module OCI
  # Details of product.
  class LicenseManager::Models::Product
    CATEGORY_ENUM = [
      CATEGORY_BASE = 'BASE'.freeze,
      CATEGORY_OPTION = 'OPTION'.freeze,
    ...
    def initialize(attributes = {})
      ...
      self.count = 0.0 if count.nil? && !attributes.key?(:'count') # rubocop:disable Style/StringLiterals
