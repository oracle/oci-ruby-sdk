...
module OCI
  ...
  class LicenseManager::Models::CreateProductLicenseDetails
    LICENSE_UNIT_ENUM = [
    ...
    # **[Required]** The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) where product licenses are created.
    # @return [String]
    ...
    # @return [Array<OCI::LicenseManager::Models::ImageDetails>]
    ...
    def self.swagger_types
      {
        ...
        'license_unit': :'String',
        'vendor_name': :'String',
        'images': :'Array<OCI::LicenseManager::Models::ImageDetails>',
    ...
    # @option attributes [Array<OCI::LicenseManager::Models::ImageDetails>] :images The value to assign to the {#images} property
    ...
    def license_unit=(license_unit)
      raise "Invalid value for 'license_unit': this must be one of the values in LICENSE_UNIT_ENUM." if license_unit && !LICENSE_UNIT_ENUM.include?(license_unit)
    ...
    def hash
      [compartment_id, is_vendor_oracle, display_name, license_unit, vendor_name, images, freeform_tags, defined_tags].hash
    end
