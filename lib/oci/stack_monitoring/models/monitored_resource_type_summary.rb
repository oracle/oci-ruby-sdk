...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceTypeSummary
    ...
    def hash
      [id, name, display_name, description, metric_namespace, compartment_id, lifecycle_state, metadata, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
