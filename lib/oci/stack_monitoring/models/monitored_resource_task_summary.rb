...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceTaskSummary
    ...
    def hash
      [id, name, task_details, work_request_ids, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
