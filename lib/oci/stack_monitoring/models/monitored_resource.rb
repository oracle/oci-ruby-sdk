...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResource
    ...
    def hash
      [id, name, display_name, type, compartment_id, tenant_id, host_name, external_id, management_agent_id, resource_time_zone, time_created, time_updated, lifecycle_state, license, source_type, resource_category, properties, database_connection_details, credentials, aliases, freeform_tags, defined_tags, system_tags].hash
    end
