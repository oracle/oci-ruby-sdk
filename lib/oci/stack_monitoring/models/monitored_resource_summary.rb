...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceSummary
    ...
    def hash
      [id, name, display_name, type, compartment_id, host_name, external_id, management_agent_id, time_created, time_updated, lifecycle_state, properties, license, source_type, resource_category, freeform_tags, defined_tags, system_tags].hash
    end
