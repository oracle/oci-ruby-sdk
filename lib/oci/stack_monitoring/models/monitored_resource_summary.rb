...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceSummary
    ...
    def hash
      [id, name, display_name, type, host_name, management_agent_id, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
