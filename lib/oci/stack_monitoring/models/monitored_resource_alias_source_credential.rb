...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceAliasSourceCredential
    ...
    # **[Required]** The name of the pre-existing source credential which alias cred should point to. This should refer to the pre-existing source attribute binded credential name.
    # @return [String]
    attr_accessor :name

    # **[Required]** The name of the service owning the credential. Ex stack-monitoring or dbmgmt
    # @return [String]
