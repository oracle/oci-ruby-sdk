...
module OCI
  ...
  class StackMonitoring::Models::BaselineableMetric
    ...
    def hash
      [created_by, last_updated_by, time_created, time_last_updated, id, lifecycle_state, tenancy_id, compartment_id, name, column, namespace, resource_group, is_out_of_box, freeform_tags, defined_tags, system_tags].hash
    end
