...
module OCI
  ...
  class StackMonitoring::Models::SqlUpdateQueryProperties < StackMonitoring::Models::MetricExtensionUpdateQueryProperties
    SQL_TYPE_ENUM = [
    ...
    def sql_type=(sql_type)
      raise "Invalid value for 'sql_type': this must be one of the values in SQL_TYPE_ENUM." if sql_type && !SQL_TYPE_ENUM.include?(sql_type)
