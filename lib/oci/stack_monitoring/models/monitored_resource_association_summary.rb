...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceAssociationSummary
    ...
    def hash
      [association_type, source_resource_id, destination_resource_id, time_created, source_resource_details, destination_resource_details, freeform_tags, defined_tags, system_tags].hash
    end
