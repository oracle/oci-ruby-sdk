...
module OCI
  ...
  class StackMonitoring::Models::ProcessSetSpecificationDetails
    ...
    # @return [String]
    attr_accessor :process_line_regex_pattern
    ...
    # @option attributes [String] :process_command The value to assign to the {#process_command} property
    # @option attributes [String] :process_user The value to assign to the {#process_user} property
    # @option attributes [String] :process_line_regex_pattern The value to assign to the {#process_line_regex_pattern} property
