...
module OCI
  ...
  class StackMonitoring::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::StackMonitoring::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::StackMonitoring::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::StackMonitoring::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
