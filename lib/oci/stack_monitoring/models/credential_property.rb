...
module OCI
  ...
  class StackMonitoring::Models::CredentialProperty
    # **[Required]** The name of the credential property, should confirm with names of properties of this credential's type.
    # Example: For JMXCreds type, credential property name for weblogic user is 'Username'.
    #
    # @return [String]
    attr_accessor :name

    # **[Required]** The value of the credential property name.
