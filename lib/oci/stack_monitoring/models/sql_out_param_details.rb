...
module OCI
  ...
  class StackMonitoring::Models::SqlOutParamDetails
    OUT_PARAM_TYPE_ENUM = [
    ...
    # @return [Integer]
    attr_accessor :out_param_position

    # **[Required]** SQL Type of PL/SQL procedure OUT parameter
    # @return [String]
    attr_reader :out_param_type
    ...
    # @option attributes [Integer] :out_param_position The value to assign to the {#out_param_position} property
    # @option attributes [String] :out_param_type The value to assign to the {#out_param_type} property
    ...
    # @param [Object] out_param_type Object to be assigned
    def out_param_type=(out_param_type)
      # rubocop:disable Style/ConditionalAssignment
      if out_param_type && !OUT_PARAM_TYPE_ENUM.include?(out_param_type)
        OCI.logger.debug("Unknown value for 'out_param_type' [" + out_param_type + "]. Mapping to 'OUT_PARAM_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @out_param_type = OUT_PARAM_TYPE_UNKNOWN_ENUM_VALUE
      else
