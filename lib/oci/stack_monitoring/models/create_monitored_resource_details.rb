...
module OCI
  ...
  class StackMonitoring::Models::CreateMonitoredResourceDetails
    ...
    def hash
      [name, display_name, type, compartment_id, host_name, management_agent_id, resource_time_zone, properties, database_connection_details, credentials, aliases].hash
    end
