...
module OCI
  ...
  class StackMonitoring::Models::AnomalyDataPoint
    ...
    # @option attributes [Float] :anomaly The value to assign to the {#anomaly} property
    # @option attributes [Float] :low The value to assign to the {#low} property
    # @option attributes [Float] :high The value to assign to the {#high} property
