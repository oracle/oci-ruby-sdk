...
module OCI
  ...
  class StackMonitoring::Models::OsCommandUpdateQueryProperties < StackMonitoring::Models::MetricExtensionUpdateQueryProperties
    ...
    # @return [OCI::StackMonitoring::Models::ScriptFileDetails]
    ...
    # @option attributes [OCI::StackMonitoring::Models::ScriptFileDetails] :script_details The value to assign to the {#script_details} property
    # @option attributes [String] :arguments The value to assign to the {#arguments} property
    # @option attributes [String] :starts_with The value to assign to the {#starts_with} property
