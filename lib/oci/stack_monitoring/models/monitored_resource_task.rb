...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceTask
    ...
    # **[Required]** Task identifier [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment identifier.
    #
    # @return [String]
    ...
    # @return [OCI::StackMonitoring::Models::MonitoredResourceTaskDetails]
    ...
    # @option attributes [OCI::StackMonitoring::Models::MonitoredResourceTaskDetails] :task_details The value to assign to the {#task_details} property
    ...
    def hash
      [id, name, compartment_id, tenant_id, task_details, work_request_ids, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
