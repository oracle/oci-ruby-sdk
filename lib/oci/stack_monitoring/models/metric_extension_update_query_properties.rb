...
module OCI
  ...
  class StackMonitoring::Models::MetricExtensionUpdateQueryProperties
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::StackMonitoring::Models::SqlUpdateQueryProperties' if type == 'SQL'
      return 'OCI::StackMonitoring::Models::JmxUpdateQueryProperties' if type == 'JMX'
      return 'OCI::StackMonitoring::Models::OsCommandUpdateQueryProperties' if type == 'OS_COMMAND'

      # TODO: Log a warning when the subtype is not found.
      'OCI::StackMonitoring::Models::MetricExtensionUpdateQueryProperties'
    end
    ...
    def collection_method=(collection_method)
      raise "Invalid value for 'collection_method': this must be one of the values in COLLECTION_METHOD_ENUM." if collection_method && !COLLECTION_METHOD_ENUM.include?(collection_method)
