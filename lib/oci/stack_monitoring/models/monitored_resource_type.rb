...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceType
    ...
    def hash
      [id, name, display_name, description, metric_namespace, compartment_id, lifecycle_state, time_created, time_updated, metadata, freeform_tags, defined_tags, system_tags].hash
    end
