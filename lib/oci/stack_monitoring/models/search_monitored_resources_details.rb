...
module OCI
  ...
  class StackMonitoring::Models::SearchMonitoredResourcesDetails
    ...
    #
    # @return [Array<OCI::StackMonitoring::Models::ResourceLifecycleState>]
    attr_accessor :lifecycle_states
    ...
    # @option attributes [Array<OCI::StackMonitoring::Models::ResourceLifecycleState>] :lifecycle_states The value to assign to the {#lifecycle_states} property
