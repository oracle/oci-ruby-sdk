...
module OCI
  ...
  class StackMonitoring::Models::CreateDiscoveryJobDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :should_propagate_tags_to_discovered_resources
    ...
    # @option attributes [BOOLEAN] :should_propagate_tags_to_discovered_resources The value to assign to the {#should_propagate_tags_to_discovered_resources} property
    ...
    def initialize(attributes = {})
      ...
      self.should_propagate_tags_to_discovered_resources = attributes[:'shouldPropagateTagsToDiscoveredResources'] unless attributes[:'shouldPropagateTagsToDiscoveredResources'].nil?
      self.should_propagate_tags_to_discovered_resources = true if should_propagate_tags_to_discovered_resources.nil? && !attributes.key?(:'shouldPropagateTagsToDiscoveredResources') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :shouldPropagateTagsToDiscoveredResources and :should_propagate_tags_to_discovered_resources' if attributes.key?(:'shouldPropagateTagsToDiscoveredResources') && attributes.key?(:'should_propagate_tags_to_discovered_resources')

      self.should_propagate_tags_to_discovered_resources = attributes[:'should_propagate_tags_to_discovered_resources'] unless attributes[:'should_propagate_tags_to_discovered_resources'].nil?
      self.should_propagate_tags_to_discovered_resources = true if should_propagate_tags_to_discovered_resources.nil? && !attributes.key?(:'shouldPropagateTagsToDiscoveredResources') && !attributes.key?(:'should_propagate_tags_to_discovered_resources') # rubocop:disable Style/StringLiterals
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        should_propagate_tags_to_discovered_resources == other.should_propagate_tags_to_discovered_resources &&
    ...
    def hash
      [discovery_type, discovery_client, compartment_id, discovery_details, should_propagate_tags_to_discovered_resources, freeform_tags, defined_tags].hash
    end
