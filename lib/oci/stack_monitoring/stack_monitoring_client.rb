...
module OCI
  ...
  class StackMonitoring::StackMonitoringClient
    ...
    # @param [OCI::StackMonitoring::Models::AssociateMonitoredResourcesDetails] associate_monitored_resources_details Associate resources.
    ...
    # @param [OCI::StackMonitoring::Models::SearchMonitoredResourceAssociationsDetails] search_monitored_resource_associations_details Search Criteria for the listing the monitored resource associations.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :limit For list pagination. The maximum number of results per page, or items to return in a
    ...
    # @param [String] monitored_resource_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of monitored resource.
    # @param [OCI::StackMonitoring::Models::SearchMonitoredResourceMembersDetails] search_monitored_resource_members_details Search criteria for the listing the member monitored resources.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    # @param [OCI::StackMonitoring::Models::SearchMonitoredResourcesDetails] search_monitored_resources_details Property Search Criteria for the listing the monitored resources.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :limit For list pagination. The maximum number of results per page, or items to return in a
