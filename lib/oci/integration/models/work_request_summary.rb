...
module OCI
  ...
  class Integration::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CHANGE_PRIVATE_ENDPOINT_OUTBOUND_CONNECTION = 'CHANGE_PRIVATE_ENDPOINT_OUTBOUND_CONNECTION'.freeze,
      OPERATION_TYPE_ENABLE_PROCESS_AUTOMATION = 'ENABLE_PROCESS_AUTOMATION'.freeze,
