...
module OCI
  ...
  class Integration::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_INTEGRATION_INSTANCE = 'CREATE_INTEGRATION_INSTANCE'.freeze,
      OPERATION_TYPE_UPDATE_INTEGRATION_INSTANCE = 'UPDATE_INTEGRATION_INSTANCE'.freeze,
      OPERATION_TYPE_STOP_INTEGRATION_INSTANCE = 'STOP_INTEGRATION_INSTANCE'.freeze,
      OPERATION_TYPE_START_INTEGRATION_INSTANCE = 'START_INTEGRATION_INSTANCE'.freeze,
      OPERATION_TYPE_DELETE_INTEGRATION_INSTANCE = 'DELETE_INTEGRATION_INSTANCE'.freeze,
    ...
    # @return [Array<OCI::Integration::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Integration::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Integration::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
