...
require 'date'
require_relative 'outbound_connection'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details required for creating Private Endpoint Outbound Connection (ReverseConnection).
  #
  class Integration::Models::PrivateEndpointOutboundConnection < Integration::Models::OutboundConnection
    ...
    def initialize(attributes = {})
      ...
      attributes['outboundConnectionType'] = 'PRIVATE_ENDPOINT'
    ...
    def hash
      [outbound_connection_type, subnet_id, nsg_ids].hash
    end
