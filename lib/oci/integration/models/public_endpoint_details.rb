...
module OCI
  ...
  #
  class Integration::Models::PublicEndpointDetails < Integration::Models::NetworkEndpointDetails
    # Source IP addresses or IP address ranges ingress rules.
    #
    # @return [Array<String>]
    attr_accessor :allowlisted_http_ips

    # Virtual Cloud Networks allowed to access this network endpoint.
    #
    # @return [Array<OCI::Integration::Models::VirtualCloudNetwork>]
    attr_accessor :allowlisted_http_vcns

    # The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
    # @return [BOOLEAN]
    attr_accessor :is_integration_vcn_allowlisted
    ...
    # @option attributes [Array<String>] :allowlisted_http_ips The value to assign to the {#allowlisted_http_ips} property
    # @option attributes [Array<OCI::Integration::Models::VirtualCloudNetwork>] :allowlisted_http_vcns The value to assign to the {#allowlisted_http_vcns} property
    # @option attributes [BOOLEAN] :is_integration_vcn_allowlisted The value to assign to the {#is_integration_vcn_allowlisted} property
