...
module OCI
  ...
  class Integration::Models::CreateIntegrationInstanceDetails
    ...
    def hash
      [display_name, compartment_id, integration_instance_type, freeform_tags, defined_tags, is_byol, idcs_at, message_packs].hash
    end
