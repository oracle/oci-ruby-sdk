...
module OCI
  ...
  class Nosql::Models::Schema
    # **[Required]** The columns of a table.
    # @return [Array<OCI::Nosql::Models::Column>]
    ...
    # @option attributes [Array<OCI::Nosql::Models::Column>] :columns The value to assign to the {#columns} property
    # @option attributes [Array<String>] :primary_key The value to assign to the {#primary_key} property
    # @option attributes [Array<String>] :shard_key The value to assign to the {#shard_key} property
    ...
    def hash
      [columns, primary_key, shard_key, ttl].hash
    end
