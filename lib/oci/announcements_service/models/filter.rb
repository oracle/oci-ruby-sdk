...
module OCI
  ...
  class AnnouncementsService::Models::Filter
    TYPE_ENUM = [
      TYPE_COMPARTMENT_ID = 'COMPARTMENT_ID'.freeze,
      TYPE_PLATFORM_TYPE = 'PLATFORM_TYPE'.freeze,
      TYPE_REGION = 'REGION'.freeze,
      TYPE_SERVICE = 'SERVICE'.freeze,
      TYPE_RESOURCE_ID = 'RESOURCE_ID'.freeze,
      TYPE_ANNOUNCEMENT_TYPE = 'ANNOUNCEMENT_TYPE'.freeze,
