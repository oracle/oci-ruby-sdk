...
module OCI
  ...
  class AnnouncementsService::Models::AnnouncementSubscriptionSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, ons_topic_id, freeform_tags, defined_tags, system_tags].hash
    end
