...
module OCI
  ...
  class AnnouncementsService::Models::CreateAnnouncementSubscriptionDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the announcement subscription.
    #
    # @return [String]
    ...
    #
    # @return [Hash<String, OCI::AnnouncementsService::Models::FilterGroupDetails>]
    ...
    def self.swagger_types
      {
        ...
        'ons_topic_id': :'String',
        'filter_groups': :'Hash<String, OCI::AnnouncementsService::Models::FilterGroupDetails>',
    ...
    # @option attributes [Hash<String, OCI::AnnouncementsService::Models::FilterGroupDetails>] :filter_groups The value to assign to the {#filter_groups} property
    ...
    def hash
      [display_name, description, compartment_id, ons_topic_id, filter_groups, freeform_tags, defined_tags].hash
    end
