...
module OCI
  ...
  class AnnouncementsService::Models::AnnouncementSubscription
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, ons_topic_id, filter_groups, preferred_language, preferred_time_zone, freeform_tags, defined_tags, system_tags].hash
    end
