...
module OCI
  ...
  class Identity::Models::BulkEditResource
    # **[Required]** The unique OCID of the resource.
    # @return [String]
    attr_accessor :id

    # **[Required]** The type of resource. See {#list_bulk_edit_tags_resource_types list_bulk_edit_tags_resource_types}.
    # @return [String]
    ...
    def hash
      [id, resource_type, metadata].hash
    end
