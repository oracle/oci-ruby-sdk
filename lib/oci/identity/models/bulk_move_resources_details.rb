...
module OCI
  ...
  class Identity::Models::BulkMoveResourcesDetails
    # **[Required]** The resources to be moved.
    #
    # @return [Array<OCI::Identity::Models::BulkActionResource>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'resources': :'Array<OCI::Identity::Models::BulkActionResource>',
    ...
    # @option attributes [Array<OCI::Identity::Models::BulkActionResource>] :resources The value to assign to the {#resources} property
    ...
    def hash
      [resources, target_compartment_id].hash
    end
