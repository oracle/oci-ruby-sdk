...
module OCI
  ...
  class Identity::Models::CreateDynamicGroupDetails # rubocop:disable Metrics/LineLength
    # **[Required]** The OCID of the tenancy containing the group.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The name you assign to the group during creation. The name must be unique across all groups
