...
module OCI
  ...
  #
  class Identity::Models::IamWorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_DOMAIN = 'CREATE_DOMAIN'.freeze,
      OPERATION_TYPE_REPLICATE_DOMAIN_TO_REGION = 'REPLICATE_DOMAIN_TO_REGION'.freeze,
      OPERATION_TYPE_UPDATE_DOMAIN = 'UPDATE_DOMAIN'.freeze,
      OPERATION_TYPE_ACTIVATE_DOMAIN = 'ACTIVATE_DOMAIN'.freeze,
      OPERATION_TYPE_DEACTIVATE_DOMAIN = 'DEACTIVATE_DOMAIN'.freeze,
      OPERATION_TYPE_DELETE_DOMAIN = 'DELETE_DOMAIN'.freeze,
      OPERATION_TYPE_CHANGE_COMPARTMENT_FOR_DOMAIN = 'CHANGE_COMPARTMENT_FOR_DOMAIN'.freeze,
      OPERATION_TYPE_CHANGE_LICENSE_TYPE_FOR_DOMAIN = 'CHANGE_LICENSE_TYPE_FOR_DOMAIN'.freeze,
    ...
    # @return [Array<OCI::Identity::Models::IamWorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Identity::Models::IamWorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Identity::Models::IamWorkRequestResource>] :resources The value to assign to the {#resources} property
