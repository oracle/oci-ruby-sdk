...
module OCI
  ...
  class Identity::Models::BulkEditOperationDetails
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_ADD_WHERE_ABSENT = 'ADD_WHERE_ABSENT'.freeze,
      OPERATION_TYPE_SET_WHERE_PRESENT = 'SET_WHERE_PRESENT'.freeze,
      OPERATION_TYPE_ADD_OR_SET = 'ADD_OR_SET'.freeze,
    ...
    def hash
      [operation_type, defined_tags].hash
    end
