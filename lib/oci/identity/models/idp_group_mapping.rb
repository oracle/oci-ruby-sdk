...
module OCI
  ...
  #
  class Identity::Models::IdpGroupMapping # rubocop:disable Metrics/LineLength
    ...
    def initialize(attributes = {})
      ...
      self.idp_id = attributes[:'idpId'] if attributes[:'idpId']

      raise 'You cannot provide both :idpId and :idp_id' if attributes.key?(:'idpId') && attributes.key?(:'idp_id')

      self.idp_id = attributes[:'idp_id'] if attributes[:'idp_id']

      self.idp_group_name = attributes[:'idpGroupName'] if attributes[:'idpGroupName']
      ...
      self.idp_group_name = attributes[:'idp_group_name'] if attributes[:'idp_group_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        id == other.id &&
        idp_id == other.idp_id &&
        idp_group_name == other.idp_group_name &&
