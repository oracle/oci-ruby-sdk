...
module OCI
  ...
  #
  class Identity::Models::NetworkSources
    ...
    # **[Required]** The OCID of the tenancy containing the network source.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The name you assign to the network source during creation. The name must be unique across
    ...
    # **[Required]** The network source object's current state. After creating a network source, make sure its `lifecycleState` changes from CREATING to
    ...
    def hash
      [id, compartment_id, name, description, public_source_list, virtual_source_list, services, time_created, lifecycle_state, inactive_status, freeform_tags, defined_tags].hash
    end
