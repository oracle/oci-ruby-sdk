...
module OCI
  ...
  class Identity::Models::BulkEditTagsResourceType
    ...
    # @option attributes [Array<String>] :metadata_keys The value to assign to the {#metadata_keys} property
    def initialize(attributes = {})
      ...
      self.metadata_keys = attributes[:'metadataKeys'] if attributes[:'metadataKeys']

      raise 'You cannot provide both :metadataKeys and :metadata_keys' if attributes.key?(:'metadataKeys') && attributes.key?(:'metadata_keys')

      self.metadata_keys = attributes[:'metadata_keys'] if attributes[:'metadata_keys']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        metadata_keys == other.metadata_keys
    end
    ...
    def hash
      [resource_type, metadata_keys].hash
    end
