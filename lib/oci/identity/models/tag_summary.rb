...
module OCI
  ...
  #
  class Identity::Models::TagSummary # rubocop:disable Metrics/LineLength
    ...
    def hash
      [compartment_id, id, name, description, freeform_tags, defined_tags, is_retired, time_created, is_cost_tracking].hash
    end
