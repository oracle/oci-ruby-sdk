...
module OCI
  ...
  class Identity::Models::BulkActionResourceTypeCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Identity::Models::BulkActionResourceType>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Identity::Models::BulkActionResourceType>] :items The value to assign to the {#items} property
