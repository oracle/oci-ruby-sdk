...
module OCI
  ...
  class Identity::Models::UpdateSaml2IdentityProviderDetails < Identity::Models::UpdateIdentityProviderDetails # rubocop:disable Metrics/LineLength
    ...
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::Identity::Models::UpdateIdentityProviderDetails#freeform_tags #freeform_tags} proprety
