...
module OCI
  ...
  #
  class Identity::Models::DbCredential
    ...
    # @option attributes [Integer] :lifecycle_details The value to assign to the {#lifecycle_details} property
    ...
    def hash
      [id, user_id, time_created, time_expires, lifecycle_state, lifecycle_details].hash
    end
