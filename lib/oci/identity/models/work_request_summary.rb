...
module OCI
  ...
  #
  class Identity::Models::WorkRequestSummary # rubocop:disable Metrics/LineLength
    OPERATION_TYPE_ENUM = [
    ...
    def hash
      [id, operation_type, compartment_id, status, resources, errors, time_accepted, time_started, time_finished, percent_complete].hash
    end
