...
module OCI
  ...
  class Identity::IdentityClientCompositeOperations
    ...
    def activate_domain_and_wait_for_state(domain_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.activate_domain(domain_id, base_operation_opts)
    ...
    # Calls {OCI::Identity::IdentityClient#bulk_delete_resources} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#bulk_delete_resources}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Identity::IdentityClient#bulk_delete_tags} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Identity::Models::BulkDeleteTagsDetails] bulk_delete_tags_details Request object for deleting tags in bulk.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#bulk_delete_tags}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Identity::IdentityClient#bulk_edit_tags} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#bulk_edit_tags}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Identity::IdentityClient#bulk_move_resources} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compartment_id The OCID of the compartment.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#bulk_move_resources}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::Identity::IdentityClient#cascade_delete_tag_namespace} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] tag_namespace_id The OCID of the tag namespace.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#cascade_delete_tag_namespace}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Identity::Models::WorkRequest}
    def change_domain_compartment_and_wait_for_state(domain_id, change_domain_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_domain_compartment(domain_id, change_domain_compartment_details, base_operation_opts)
      use_util = OCI::Identity::Util.respond_to?(:wait_on_work_request)
    ...
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Identity::Models::WorkRequest}
    def change_domain_license_type_and_wait_for_state(domain_id, change_domain_license_type_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_domain_license_type(domain_id, change_domain_license_type_details, base_operation_opts)
      use_util = OCI::Identity::Util.respond_to?(:wait_on_work_request)
    ...
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Identity::Models::WorkRequest}
    def deactivate_domain_and_wait_for_state(domain_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.deactivate_domain(domain_id, base_operation_opts)
      use_util = OCI::Identity::Util.respond_to?(:wait_on_work_request)
    ...
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Identity::Models::WorkRequest}
    def enable_replication_to_region_and_wait_for_state(domain_id, enable_replication_to_region_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.enable_replication_to_region(domain_id, enable_replication_to_region_details, base_operation_opts)
      use_util = OCI::Identity::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Identity::IdentityClient#import_standard_tags} and then waits for the {OCI::Identity::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#import_standard_tags}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Identity::Models::WorkRequest}
    def import_standard_tags_and_wait_for_state(wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.import_standard_tags(base_operation_opts)
      use_util = OCI::Identity::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Identity::IdentityClient#recover_compartment} and then waits for the {OCI::Identity::Models::Compartment} acted upon
    # to enter the given state(s).
    #
    # @param [String] compartment_id The OCID of the compartment.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Identity::Models::Compartment#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Identity::IdentityClient#recover_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
