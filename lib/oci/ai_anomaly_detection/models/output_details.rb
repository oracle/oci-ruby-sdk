...
module OCI
  ...
  class AiAnomalyDetection::Models::OutputDetails
    OUTPUT_TYPE_ENUM = [
      OUTPUT_TYPE_OBJECT_STORAGE = 'OBJECT_STORAGE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiAnomalyDetection::Models::ObjectStoreOutputDetails' if type == 'OBJECT_STORAGE'
    ...
    def output_type=(output_type)
      raise "Invalid value for 'output_type': this must be one of the values in OUTPUT_TYPE_ENUM." if output_type && !OUTPUT_TYPE_ENUM.include?(output_type)
