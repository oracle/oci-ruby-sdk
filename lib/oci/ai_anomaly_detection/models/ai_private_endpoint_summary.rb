...
module OCI
  ...
  class AiAnomalyDetection::Models::AiPrivateEndpointSummary
    ...
    def hash
      [id, subnet_id, dns_zones, compartment_id, time_created, time_updated, display_name, lifecycle_details, freeform_tags, defined_tags, system_tags, lifecycle_state].hash
    end
