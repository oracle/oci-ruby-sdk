...
module OCI
  ...
  class AiAnomalyDetection::Models::Anomaly
    ...
    # @option attributes [Float] :actual_value The value to assign to the {#actual_value} property
    # @option attributes [Float] :estimated_value The value to assign to the {#estimated_value} property
    # @option attributes [Float] :imputed_value The value to assign to the {#imputed_value} property
    # @option attributes [Float] :anomaly_score The value to assign to the {#anomaly_score} property
