...
module OCI
  ...
  class AiAnomalyDetection::Models::InfluxDetailsV2v0 < AiAnomalyDetection::Models::InfluxDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['influxVersion'] = 'V_2_0'
    ...
    def hash
      [influx_version, bucket_name, organization_name].hash
    end
