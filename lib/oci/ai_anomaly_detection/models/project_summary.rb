...
module OCI
  ...
  class AiAnomalyDetection::Models::ProjectSummary
    ...
    def hash
      [id, display_name, compartment_id, description, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
