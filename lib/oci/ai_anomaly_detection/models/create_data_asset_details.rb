...
module OCI
  ...
  #
  class AiAnomalyDetection::Models::CreateDataAssetDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the data asset.
    # @return [String]
    ...
    # @return [OCI::AiAnomalyDetection::Models::DataSourceDetails]
    ...
    # @option attributes [OCI::AiAnomalyDetection::Models::DataSourceDetails] :data_source_details The value to assign to the {#data_source_details} property
    ...
    def hash
      [display_name, compartment_id, project_id, description, data_source_details, private_endpoint_id, freeform_tags, defined_tags].hash
    end
