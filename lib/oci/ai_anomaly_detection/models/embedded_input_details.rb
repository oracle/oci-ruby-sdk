...
module OCI
  ...
  #
  class AiAnomalyDetection::Models::EmbeddedInputDetails < AiAnomalyDetection::Models::InputDetails
    CONTENT_TYPE_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      attributes['inputType'] = 'BASE64_ENCODED'
    ...
    def hash
      [input_type, content_type, content].hash
    end
