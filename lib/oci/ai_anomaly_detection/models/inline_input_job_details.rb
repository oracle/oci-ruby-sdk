...
module OCI
  ...
  #
  class AiAnomalyDetection::Models::InlineInputJobDetails < AiAnomalyDetection::Models::InputJobDetails
    ...
    def initialize(attributes = {})
      ...
      self.message = "Inline input data." if message.nil? && !attributes.key?(:'message') # rubocop:disable Style/StringLiterals
    end
