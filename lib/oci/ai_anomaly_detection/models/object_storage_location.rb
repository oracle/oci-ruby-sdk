...
require 'date'
require_relative 'output_job_details'
...
module OCI
  ...
  #
  class AiAnomalyDetection::Models::ObjectStorageLocation < AiAnomalyDetection::Models::OutputJobDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['outputType'] = 'OBJECT_STORAGE'
    ...
    def hash
      [output_type, namespace_name, bucket_name, prefix].hash
    end
