...
module OCI
  ...
  class AiAnomalyDetection::Models::DataSourceDetailsObjectStorage < AiAnomalyDetection::Models::DataSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['dataSourceType'] = 'ORACLE_OBJECT_STORAGE'
    ...
    def hash
      [data_source_type, namespace, bucket_name, object_name].hash
    end
