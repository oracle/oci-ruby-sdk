...
module OCI
  ...
  class AiAnomalyDetection::Models::DetectAnomalyJob
    ...
    # @return [OCI::AiAnomalyDetection::Models::InputJobDetails]
    attr_accessor :input_details

    # This attribute is required.
    # @return [OCI::AiAnomalyDetection::Models::OutputJobDetails]
    ...
    # @option attributes [OCI::AiAnomalyDetection::Models::InputJobDetails] :input_details The value to assign to the {#input_details} property
    # @option attributes [OCI::AiAnomalyDetection::Models::OutputJobDetails] :output_details The value to assign to the {#output_details} property
