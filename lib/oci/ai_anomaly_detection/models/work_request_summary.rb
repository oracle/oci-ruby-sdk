...
module OCI
  ...
  class AiAnomalyDetection::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::AiAnomalyDetection::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::AiAnomalyDetection::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::AiAnomalyDetection::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
