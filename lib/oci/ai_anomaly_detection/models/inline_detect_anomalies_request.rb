...
module OCI
  ...
  #
  class AiAnomalyDetection::Models::InlineDetectAnomaliesRequest < AiAnomalyDetection::Models::DetectAnomaliesDetails
    # **[Required]** List of signal names.
    # @return [Array<String>]
    attr_accessor :signal_names

    # **[Required]** Array containing data.
    # @return [Array<OCI::AiAnomalyDetection::Models::DataItem>]
    attr_accessor :data
    ...
    # @option attributes [Array<String>] :signal_names The value to assign to the {#signal_names} property
    # @option attributes [Array<OCI::AiAnomalyDetection::Models::DataItem>] :data The value to assign to the {#data} property
