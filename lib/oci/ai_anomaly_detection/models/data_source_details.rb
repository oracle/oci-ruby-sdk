...
module OCI
  ...
  class AiAnomalyDetection::Models::DataSourceDetails
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'dataSourceType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::AiAnomalyDetection::Models::DataSourceDetailsObjectStorage' if type == 'ORACLE_OBJECT_STORAGE'
      return 'OCI::AiAnomalyDetection::Models::DataSourceDetailsInflux' if type == 'INFLUX'
      return 'OCI::AiAnomalyDetection::Models::DataSourceDetailsATP' if type == 'ORACLE_ATP'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiAnomalyDetection::Models::DataSourceDetails'
    end
