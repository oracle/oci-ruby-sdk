...
module OCI
  ...
  class AiAnomalyDetection::Models::InputDetails
    INPUT_TYPE_ENUM = [
      INPUT_TYPE_INLINE = 'INLINE'.freeze,
      INPUT_TYPE_BASE64_ENCODED = 'BASE64_ENCODED'.freeze,
      INPUT_TYPE_OBJECT_LIST = 'OBJECT_LIST'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiAnomalyDetection::Models::EmbeddedInputDetails' if type == 'BASE64_ENCODED'
      return 'OCI::AiAnomalyDetection::Models::ObjectListInputDetails' if type == 'OBJECT_LIST'
      return 'OCI::AiAnomalyDetection::Models::InlineInputDetails' if type == 'INLINE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiAnomalyDetection::Models::InputDetails'
    end
