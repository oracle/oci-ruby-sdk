...
module OCI
  ...
  class AiAnomalyDetection::Models::DetectionResultItem
    ...
    # @return [Array<OCI::AiAnomalyDetection::Models::Anomaly>]
    ...
    # @option attributes [Array<OCI::AiAnomalyDetection::Models::Anomaly>] :anomalies The value to assign to the {#anomalies} property
    def initialize(attributes = {})
      ...
      self.anomalies = attributes[:'anomalies'] if attributes[:'anomalies']
    end
    ...
    def hash
      [timestamp, row_index, score, anomalies].hash
    end
