...
module OCI
  ...
  class AiAnomalyDetection::Models::OutputJobDetails
    OUTPUT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiAnomalyDetection::Models::ObjectStorageLocation' if type == 'OBJECT_STORAGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::AiAnomalyDetection::Models::OutputJobDetails'
    end
