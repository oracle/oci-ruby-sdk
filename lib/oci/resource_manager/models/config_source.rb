...
module OCI
  ...
  class ResourceManager::Models::ConfigSource
    CONFIG_SOURCE_TYPE_ENUM = [
      CONFIG_SOURCE_TYPE_BITBUCKET_CLOUD_CONFIG_SOURCE = 'BITBUCKET_CLOUD_CONFIG_SOURCE'.freeze,
      CONFIG_SOURCE_TYPE_BITBUCKET_SERVER_CONFIG_SOURCE = 'BITBUCKET_SERVER_CONFIG_SOURCE'.freeze,
      CONFIG_SOURCE_TYPE_COMPARTMENT_CONFIG_SOURCE = 'COMPARTMENT_CONFIG_SOURCE'.freeze,
      CONFIG_SOURCE_TYPE_DEVOPS_CONFIG_SOURCE = 'DEVOPS_CONFIG_SOURCE'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ResourceManager::Models::DevOpsConfigSource' if type == 'DEVOPS_CONFIG_SOURCE'
      return 'OCI::ResourceManager::Models::ObjectStorageConfigSource' if type == 'OBJECT_STORAGE_CONFIG_SOURCE'
      return 'OCI::ResourceManager::Models::BitbucketServerConfigSource' if type == 'BITBUCKET_SERVER_CONFIG_SOURCE'
      return 'OCI::ResourceManager::Models::BitbucketCloudConfigSource' if type == 'BITBUCKET_CLOUD_CONFIG_SOURCE'
