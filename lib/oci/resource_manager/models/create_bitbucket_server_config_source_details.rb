...
module OCI
  ...
  #
  class ResourceManager::Models::CreateBitbucketServerConfigSourceDetails < ResourceManager::Models::CreateConfigSourceDetails
    ...
    def hash
      [config_source_type, working_directory, configuration_source_provider_id, repository_url, branch_name, project_id, repository_id].hash
    end
