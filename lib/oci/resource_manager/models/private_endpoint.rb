...
module OCI
  ...
  #
  class ResourceManager::Models::PrivateEndpoint
    ...
    # **[Required]** Unique identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the private endpoint details.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet within the VCN for the private endpoint.
    # @return [String]
    ...
    # @option attributes [Array<String>] :source_ips The value to assign to the {#source_ips} property
    # @option attributes [Array<String>] :nsg_id_list The value to assign to the {#nsg_id_list} property
    ...
    def initialize(attributes = {})
      ...
      self.source_ips = attributes[:'sourceIps'] if attributes[:'sourceIps']

      raise 'You cannot provide both :sourceIps and :source_ips' if attributes.key?(:'sourceIps') && attributes.key?(:'source_ips')

      self.source_ips = attributes[:'source_ips'] if attributes[:'source_ips']
    ...
    def hash
      [id, compartment_id, display_name, description, vcn_id, subnet_id, source_ips, nsg_id_list, is_used_with_configuration_source_provider, dns_zones, time_created, lifecycle_state, freeform_tags, defined_tags].hash
    end
