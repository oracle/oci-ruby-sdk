...
require 'date'
require_relative 'create_template_config_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Property details for uploading the zip file for template.
  #
  class ResourceManager::Models::CreateTemplateZipUploadConfigSourceDetails < ResourceManager::Models::CreateTemplateConfigSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['templateConfigSourceType'] = 'ZIP_UPLOAD'
    ...
    def hash
      [template_config_source_type, zip_file_base64_encoded].hash
    end
