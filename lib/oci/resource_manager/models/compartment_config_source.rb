...
module OCI
  ...
  #
  class ResourceManager::Models::CompartmentConfigSource < ResourceManager::Models::ConfigSource
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to use
