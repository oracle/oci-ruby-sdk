...
module OCI
  ...
  #
  class ResourceManager::Models::CreateTemplateDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing this template.
    # @return [String]
    ...
    # @return [OCI::ResourceManager::Models::CreateTemplateConfigSourceDetails]
    ...
    def self.swagger_types
      {
        ...
        'template_config_source': :'OCI::ResourceManager::Models::CreateTemplateConfigSourceDetails',
    ...
    # @option attributes [OCI::ResourceManager::Models::CreateTemplateConfigSourceDetails] :template_config_source The value to assign to the {#template_config_source} property
    ...
    def hash
      [compartment_id, display_name, description, long_description, logo_file_base64_encoded, template_config_source, freeform_tags, defined_tags].hash
    end
