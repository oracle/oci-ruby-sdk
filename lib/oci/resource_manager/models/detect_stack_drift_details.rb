...
module OCI
  ...
  class ResourceManager::Models::DetectStackDriftDetails
    ...
    #
    # @return [Array<String>]
    attr_accessor :resource_addresses
    ...
    # @option attributes [Array<String>] :resource_addresses The value to assign to the {#resource_addresses} property
    def initialize(attributes = {})
      ...
      self.resource_addresses = attributes[:'resourceAddresses'] if attributes[:'resourceAddresses']

      raise 'You cannot provide both :resourceAddresses and :resource_addresses' if attributes.key?(:'resourceAddresses') && attributes.key?(:'resource_addresses')

      self.resource_addresses = attributes[:'resource_addresses'] if attributes[:'resource_addresses']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        resource_addresses == other.resource_addresses
    end
