...
module OCI
  ...
  #
  class ResourceManager::Models::PlanRollbackJobOperationDetails < ResourceManager::Models::JobOperationDetails
    ...
    def hash
      [operation, terraform_advanced_options, target_rollback_job_id].hash
    end
