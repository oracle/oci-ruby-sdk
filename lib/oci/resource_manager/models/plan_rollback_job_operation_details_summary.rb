...
module OCI
  ...
  #
  class ResourceManager::Models::PlanRollbackJobOperationDetailsSummary < ResourceManager::Models::JobOperationDetailsSummary
    ...
    def hash
      [operation, target_rollback_job_id].hash
    end
