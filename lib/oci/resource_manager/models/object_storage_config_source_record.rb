...
module OCI
  ...
  #
  class ResourceManager::Models::ObjectStorageConfigSourceRecord < ResourceManager::Models::ConfigSourceRecord
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceRecordType'] = 'OBJECT_STORAGE_CONFIG_SOURCE'
    ...
    def hash
      [config_source_record_type, region, namespace, bucket_name].hash
    end
