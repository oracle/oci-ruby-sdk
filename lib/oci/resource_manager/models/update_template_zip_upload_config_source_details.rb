...
require 'date'
require_relative 'update_template_config_source_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Updates property details for the configuration .zip file.
  class ResourceManager::Models::UpdateTemplateZipUploadConfigSourceDetails < ResourceManager::Models::UpdateTemplateConfigSourceDetails
    # @return [String]
