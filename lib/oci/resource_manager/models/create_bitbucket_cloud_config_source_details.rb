...
module OCI
  ...
  #
  class ResourceManager::Models::CreateBitbucketCloudConfigSourceDetails < ResourceManager::Models::CreateConfigSourceDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Bitbucket Cloud configuration source.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceType'] = 'BITBUCKET_CLOUD_CONFIG_SOURCE'
    ...
    def hash
      [config_source_type, working_directory, configuration_source_provider_id, repository_url, branch_name, workspace_id].hash
    end
