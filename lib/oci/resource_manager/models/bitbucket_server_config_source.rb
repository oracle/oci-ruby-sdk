...
module OCI
  ...
  #
  class ResourceManager::Models::BitbucketServerConfigSource < ResourceManager::Models::ConfigSource
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Bitbucket Server configuration source.
    #
    # @return [String]
    ...
    # @option attributes [String] :clone_url The value to assign to the {#clone_url} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['configSourceType'] = 'BITBUCKET_SERVER_CONFIG_SOURCE'
      ...
      self.clone_url = attributes[:'cloneUrl'] if attributes[:'cloneUrl']

      raise 'You cannot provide both :cloneUrl and :clone_url' if attributes.key?(:'cloneUrl') && attributes.key?(:'clone_url')

      self.clone_url = attributes[:'clone_url'] if attributes[:'clone_url']
    end
    ...
    def hash
      [config_source_type, working_directory, configuration_source_provider_id, repository_url, branch_name, project_id, repository_id, clone_url].hash
    end
