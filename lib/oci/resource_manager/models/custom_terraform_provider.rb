...
module OCI
  ...
  # See {#update_stack update_stack}. For more information, see
  ...
  #
  class ResourceManager::Models::CustomTerraformProvider
    # **[Required]** The name of the region that contains the bucket you want.
    ...
    # **[Required]** The Object Storage namespace that contains the bucket you want.
    ...
    # **[Required]** The name of the bucket that contains the binary files for the custom Terraform providers.
