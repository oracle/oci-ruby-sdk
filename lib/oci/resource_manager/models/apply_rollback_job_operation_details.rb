...
module OCI
  ...
  #
  class ResourceManager::Models::ApplyRollbackJobOperationDetails < ResourceManager::Models::JobOperationDetails
    ...
    #
    # @return [String]
    attr_reader :execution_plan_rollback_strategy
    ...
    # @param [Object] execution_plan_rollback_strategy Object to be assigned
    def execution_plan_rollback_strategy=(execution_plan_rollback_strategy)
      # rubocop:disable Style/ConditionalAssignment
      if execution_plan_rollback_strategy && !EXECUTION_PLAN_ROLLBACK_STRATEGY_ENUM.include?(execution_plan_rollback_strategy)
        OCI.logger.debug("Unknown value for 'execution_plan_rollback_strategy' [" + execution_plan_rollback_strategy + "]. Mapping to 'EXECUTION_PLAN_ROLLBACK_STRATEGY_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @execution_plan_rollback_strategy = EXECUTION_PLAN_ROLLBACK_STRATEGY_UNKNOWN_ENUM_VALUE
      else
        @execution_plan_rollback_strategy = execution_plan_rollback_strategy
      end
