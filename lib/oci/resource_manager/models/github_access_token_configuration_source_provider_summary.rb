...
require 'date'
require_relative 'configuration_source_provider_summary'
...
module OCI
  ...
  #
  class ResourceManager::Models::GithubAccessTokenConfigurationSourceProviderSummary < ResourceManager::Models::ConfigurationSourceProviderSummary
    ...
    # @option attributes [String] :id The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProviderSummary#id #id} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProviderSummary#compartment_id #compartment_id} proprety
    # @option attributes [String] :display_name The value to assign to the {OCI::ResourceManager::Models::ConfigurationSourceProviderSummary#display_name #display_name} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceProviderType'] = 'GITHUB_ACCESS_TOKEN'
