...
module OCI
  ...
  class ResourceManager::Models::UpdateStackDetails
    ...
    def hash
      [display_name, description, config_source, custom_terraform_provider, is_third_party_provider_experience_enabled, variables, terraform_version, freeform_tags, defined_tags].hash
    end
