...
module OCI
  ...
  #
  class ResourceManager::Models::BitbucketCloudConfigSourceRecord < ResourceManager::Models::ConfigSourceRecord
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceRecordType'] = 'BITBUCKET_CLOUD_CONFIG_SOURCE'
    ...
    def hash
      [config_source_record_type, configuration_source_provider_id, repository_url, branch_name, workspace_id, commit_id].hash
    end
