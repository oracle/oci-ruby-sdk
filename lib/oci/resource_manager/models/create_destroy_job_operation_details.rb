...
module OCI
  ...
  #
  class ResourceManager::Models::CreateDestroyJobOperationDetails < ResourceManager::Models::CreateJobOperationDetails
    ...
    #
    # @return [String]
    attr_accessor :execution_plan_strategy
    ...
    def hash
      [operation, terraform_advanced_options, execution_plan_strategy].hash
    end
