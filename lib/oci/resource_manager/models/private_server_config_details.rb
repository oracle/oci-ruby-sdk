...
module OCI
  ...
  class ResourceManager::Models::PrivateServerConfigDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a certificate associated with the configuration source provider.
    #
    # @return [String]
