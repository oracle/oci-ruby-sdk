...
module OCI
  ...
  #
  class ResourceManager::Models::PrivateServerConfigDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a private endpoint associated with the configuration source provider.
    #
    # @return [String]
    ...
    def hash
      [private_endpoint_id, certificate_id].hash
    end
