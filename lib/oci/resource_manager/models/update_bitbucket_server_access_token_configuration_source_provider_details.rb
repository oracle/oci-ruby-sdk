...
module OCI
  ...
  #
  class ResourceManager::Models::UpdateBitbucketServerAccessTokenConfigurationSourceProviderDetails < ResourceManager::Models::UpdateConfigurationSourceProviderDetails
    ...
    def hash
      [display_name, description, config_source_provider_type, private_server_config_details, freeform_tags, defined_tags, secret_id, api_endpoint].hash
    end
