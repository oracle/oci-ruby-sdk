...
module OCI
  ...
  #
  class ResourceManager::Models::CreatePlanRollbackJobOperationDetails < ResourceManager::Models::CreateJobOperationDetails
    # @return [OCI::ResourceManager::Models::TerraformAdvancedOptions]
    attr_accessor :terraform_advanced_options

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a successful apply job to use for the plan rollback job.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['operation'] = 'PLAN_ROLLBACK'
    ...
    def hash
      [operation, is_provider_upgrade_required, terraform_advanced_options, target_rollback_job_id].hash
    end
