...
module OCI
  ...
  #
  class ResourceManager::Models::CreateObjectStorageConfigSourceDetails < ResourceManager::Models::CreateConfigSourceDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceType'] = 'OBJECT_STORAGE_CONFIG_SOURCE'
    ...
    def hash
      [config_source_type, working_directory, region, namespace, bucket_name].hash
    end
