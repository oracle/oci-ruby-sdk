...
module OCI
  ...
  #
  class ResourceManager::Models::CreateBitbucketServerAccessTokenConfigurationSourceProviderDetails < ResourceManager::Models::CreateConfigurationSourceProviderDetails
    # **[Required]** The secret ocid which is used to authorize the user.
    #
    # @return [String]
    attr_accessor :secret_id

    # **[Required]** The Bitbucket Server service endpoint
