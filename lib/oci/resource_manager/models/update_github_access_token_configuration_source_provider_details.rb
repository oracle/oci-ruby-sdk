...
module OCI
  ...
  #
  class ResourceManager::Models::UpdateGithubAccessTokenConfigurationSourceProviderDetails < ResourceManager::Models::UpdateConfigurationSourceProviderDetails
    ...
    def hash
      [display_name, description, config_source_provider_type, private_server_config_details, freeform_tags, defined_tags, api_endpoint, access_token].hash
    end
