...
module OCI
  ...
  class ResourceManager::Models::FailureDetails
    CODE_ENUM = [
      ...
      CODE_CUSTOM_TERRAFORM_PROVIDER_BUCKET_NOT_FOUND = 'CUSTOM_TERRAFORM_PROVIDER_BUCKET_NOT_FOUND'.freeze,
      CODE_CUSTOM_TERRAFORM_PROVIDER_UNSUPPORTED_OBJECT_SIZE = 'CUSTOM_TERRAFORM_PROVIDER_UNSUPPORTED_OBJECT_SIZE'.freeze,
