...
module OCI
  ...
  #
  class ResourceManager::Models::GitConfigSource < ResourceManager::Models::ConfigSource
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Git configuration source.
    #
    # @return [String]
