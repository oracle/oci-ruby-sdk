...
module OCI
  ...
  class ResourceManager::Models::StackResourceDriftCollection
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::ResourceManager::Models::StackResourceDriftSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ResourceManager::Models::StackResourceDriftSummary>] :items The value to assign to the {#items} property
